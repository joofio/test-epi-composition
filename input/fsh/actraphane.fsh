...
► 
Actraphane Penfill is only suitable for injecting under the skin using a reusable pen. Speak to 
...
► 
There are no restrictions on treatment with Actraphane during breast-feeding. </p>
...
► 
Actraphane Penfill cartridges are designed to be used with Novo Nordisk insulin delivery 
systems and NovoFine or NovoTwist needles. 
► 
If you are treated with Actraphane Penfill and another insulin Penfill cartridge, you should use 
...
► 
After each injection, be sure to remove and discard the needle and store Actraphane without the 
...
* Drink alcohol, see Actraphane with alcohol in section 2.<br />
