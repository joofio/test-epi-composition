...
<li>What Cubicin is and what it is used for
...
antibacterials while you are receiving treatment with Cubicin.</li>
</ol>         </div>"""   
...
- If you have ever developed a severe skin rash or skin peeling, blistering and/or mouth sores, or
36
serious kidney problems after taking daptomycin.
...
breathing, swelling of the face, neck and throat, rashes and hives, or fever. 
- Serious skin disorders have been reported with the use of Cubicin. The symptoms that occur
with these skin disorders can include:
- a new or worsening fever,
- red raised or fluid-filled skin spots which may start in your armpits or on your chest or
groin areas and which can spread over a large area of your body,
- blisters or sores in your mouth or on your genitals.
- A serious kidney problem has been reported with the use of Cubicin. The symptoms can include
fever and rash.
...
- A rare but potentially serious lung disorder called eosinophilic pneumonia, mostly after more
than 2 weeks of treatment. The symptoms can include difficulty breathing, new or worsening
cough, or new or worsening fever.
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>stopper. Wipe the top of the rubber stopper with an alcohol swab or other antiseptic solution
...
towards the wall of the vial.</p>         </div>"""      
