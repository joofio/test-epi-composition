...
- tightness of the chest, coughing, wheezing or breathlessness immediately after using Enerzair 
...
depression). 
- any medicines that may be similar to Enerzair Breezhaler (contain similar active substances); 
