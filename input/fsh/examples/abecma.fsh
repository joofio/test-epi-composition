...
It is given when previous treatments for your cancer have not worked or the cancer has come back. </p>
<p>How Abecma works 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>You should not be given Abecma 
...
* if you are allergic to any of the ingredients in the medicines you will be given for 
lymphodepleting chemotherapy, which is used to prepare your body for Abecma treatment. </p>
...
* you have signs or symptoms of graft-versus-host disease. This happens when transplanted cells 
...
* you notice the symptoms of your cancer getting worse. In myeloma these might include fever, 
feeling weak, bone pain, unexplained weight loss. 
...
months. </p>
<p>If any of the above apply to you (or you are not sure), talk to your doctor before being given Abecma. </p>
<p>Tests and checks 
...
Abecma should not be given to children and adolescents below 18 years of age. </p>
<p>Other medicines and Abecma 
Tell your doctor or nurse if you are taking, have recently taken or might take any other medicines, 
including medicines obtained without a prescription. </p>
<p>Medicines that affect your immune system 
Before you are given Abecma, tell your doctor or nurse if you are taking any medicines that weaken 
your immune system such as corticosteroids. This is because these medicines may interfere with the 
effect of Abecma. </p>
<p>See section 3 for information about the medicines you will be given before having Abecma. </p>
<p>Vaccinations 
You must not be given certain vaccines called live vaccines: 
* in the 6 weeks before you are given a short course of chemotherapy (called lympodepleting 
...
child. 
* If you are pregnant or think you may be pregnant after treatment with Abecma, talk to your 
doctor immediately. 
* You will be given a pregnancy test before treatment starts. Abecma should only be given if the 
...
treatment or until your doctor tells you that you have completely recovered. Abecma may make you 
feel sleepy, may cause confusion or fits (seizures). </p>
<p>Abecma contains sodium, potassium and dimethly sulfoxide (DMSO) 
This medicine contains up to 752 mg sodium (main component of cooking/ table salt) per dose. This is 
equivalent to 37.6% of the recommended maximum daily intake of sodium for an adult. </p>
...
* A few days before you receive Abecma, you will be given a short course of chemotherapy. This 
is to clear away your existing white blood cells. 
* Shortly before you receive Abecma, you will be given paracetamol and an antihistamine 
medicine. This is to reduce the risk of infusion reactions and fever. </p>
<p>How Abecma is given 
* Your doctor will check that the Abecma was prepared from your own blood by checking the 
patient identity information on the medicine labels matches your details. 
* Abecma is given as an infusion drip through a tube into your vein. </p>
<p>After Abecma is given 
...
They usually happen in the first 8 weeks after the infusion, but can also develop later: </p>
<ul>
<li>fever, chills, difficulty breathing, dizziness or light-headedness, nausea, headache, fast heartbeat, 
low blood pressure or fatigue - these may be symptoms of cytokine release syndrome or CRS, a 
serious and potentially fatal condition. </li>
<li>confusion, difficulty with memory, difficulty speaking or slowed speech, difficulty 
understanding speech, loss of balance or coordination, disorientation, being less alert (decreased 
consciousness) or excessive sleepiness, loss of consciousness, delirious, fits (seizures), shaking 
or weakness with loss of movement on one side of the body. Symptoms of parkinsonism, such 
as tremor, slow movements and stiffness. </li>
<li>any signs of an infection, which may include fever, chills or shivering, cough, shortness of 
breath, rapid breathing and rapid pulse. </li>
<li>feeling very tired or weak or short of breath -which may be signs of low levels of red blood cells 
(anaemia). </li>
<li>bleeding or bruising more easily without cause, including nosebleeds or bleeding from the 
mouth or bowels, which may be a sign of low levels of platelet cells in your blood. </li>
</ul>
<p>Tell your doctor immediately if you get any of the side effects above, as you may need urgent medical 
treatment. </p>
...
* infections including pneumonia or infections of the respiratory tract, mouth, skin, urinary tract 
or blood, which may be bacterial, viral or fungal 
...
* laboratory test results showing decreased levels of calcium, sodium, magnesium, potassium, 
phosphate or albumin, which may cause fatigue, muscle weakness or cramps or an irregular 
heartbeat 
* laboratory test results showing increased levels of liver enzymes (abnormal liver function test) 
or a higher level of a protein (C-reactive protein) in blood that may indicate inflammation. </p>
<p>Common: may affect up to 1 in 10 people 
* severe inflammation due to activation of your immune system which could lead to serious 
damage in the body 
* difficulty sleeping 
* muscle pain 
* abnormal body movements or lack of coordination<br />
* uneven or irregular heartbeat 
* fluid in the lungs 
* low oxygen level in the blood, which may cause shortness of breath, confusion or drowsiness. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Abecma contains<br />
...
Det gives, når tidligere behandlinger for din kræft ikke har virket eller kræften er vendt tilbage efter 
tidligere behandlinger. </p>
<p>Sådan fungerer Abecma 
...
<ul>
<li>
<p>hvis du er allergisk over for et eller flere af de øvrige indholdsstoffer i dette lægemiddel (angivet 
i punkt 6). Hvis du tror, at du kan være allergisk, skal du spørge din læge til råds. </p>
</li>
<li>
<p>hvis du er allergisk over for et eller flere af indholdsstofferne i det lægemiddel, du vil modtage 
til lymfocytdepleterende kemoterapi, som bruges til at forberede din krop til Abecma-
behandling. </p>
</li>
</ul>
<p>Advarsler og forsigtighedsregler 
Kontakt lægen, før du får Abecma, hvis </p>
<ul>
<li>
...
<li>
<p>du har fået en stamcelletransplantation inden for de sidste 4 måneder. </p>
</li>
<li>
<p>du har tegn eller symptomer på graft-versus-host-sygdom. Dette sker, når transplanterede celler 
angriber din krop og forårsager symptomer som udslæt, kvalme, opkastning, diarré og blodig 
afføring. </p>
</li>
<li>
<p>du har en infektion. Infektionen vil blive behandlet inden du får Abecma. </p>
</li>
<li>
<p>du bemærker, at symptomerne på din kræft bliver værre. Ved myelomatose kan dette omfatte 
feber, følelse af svaghed, knoglesmerter, uforklarligt vægttab. </p>
</li>
<li>
<p>du har haft cytomegalovirus (CMV) infektion, hepatitis B eller C eller infektion med human 
immundefekt virus (hiv). </p>
</li>
<li>
<p>du har fået en vaccination i de sidste 6 uger eller planlægger at få en i de næste par måneder. </p>
</li>
</ul>
<p>Hvis noget af ovenstående gælder for dig (eller hvis du er i tvivl), skal du tale med lægen, før du får 
Abecma. </p>
<p>Undersøgelser og kontroller 
Før du får Abecma, vil din læge: </p>
<ul>
<li>
<p>Kontrollere dine lunger, dit hjerte og dit blodtryk. </p>
</li>
<li>
<p>Se efter tegn på infektion. Enhver infektion vil blive behandlet, før du får Abecma. </p>
</li>
<li>
<p>Kontrollere, om din kræft bliver værre. </p>
</li>
<li>
<p>Kontrollere for CMV-, hepatitis B-, hepatitis C- eller hiv-infektion. </p>
</li>
</ul>
...
<p>Børn og unge 
Abecma må ikke gives til børn og unge under 18 år. </p>
<p>Brug af andre lægemidler sammen med Abecma 
Fortæl altid lægen eller sygeplejersken, hvis du tager andre lægemidler, for nylig har taget andre 
lægemidler eller planlægger at tage andre lægemidler, inklusive håndkøbslægemidler. </p>
<p>Lægemidler, der påvirker dit immunforsvar 
Før du får Abecma, skal du fortælle lægen eller sygeplejersken, hvis du tager lægemidler, der svækker 
dit immunforsvar, såsom cortikosteroider. Dette skyldes, at disse lægemidler kan påvirke virkningen af 
Abecma. </p>
<p>Se punkt 3 for oplysninger om de lægemidler, du vil få, før du får Abecma. </p>
<p>Vaccinationer 
Du må ikke få visse vacciner, der kaldes levende vacciner: </p>
<ul>
<li>
<p>i de 6 uger inden du får en kort behandling med kemoterapi (kaldet lympocytdepleterende 
kemoterapi) for at forberede din krop på Abecma. </p>
</li>
<li>
<p>under behandling med Abecma. </p>
</li>
<li>
<p>efter behandling, mens immunforsvaret er ved at restituere. </p>
</li>
</ul>
<p>Tal med din læge, hvis du eventuelt skal vaccineres. </p>
<p>Graviditet og amning 
Hvis du er gravid eller ammer, har mistanke om, at du er gravid, eller planlægger at blive gravid, skal 
du spørge din læge til råds, før du får dette lægemiddel. Det skyldes, at virkningerne af Abecma hos 
gravide eller ammende kvinder ikke kendes, og det muligvis kan skade dit ufødte eller ammede barn. </p>
<ul>
<li>
<p>Hvis du er gravid eller tror, at du kan være gravid, efter du er blevet behandlet med Abecma, 
skal du straks tale med din læge. </p>
</li>
<li>
<p>Du vil få foretaget en graviditetstest, før behandlingen starter. Abecma bør kun gives, hvis 
resultatet viser, at du ikke er gravid. </p>
</li>
</ul>
<p>Tal med din læge om graviditet, hvis du har fået Abecma. </p>
<p>Trafik- og arbejdssikkerhed 
Undlad at føre motorkøretøj, bruge maskiner eller deltage i aktiviteter, der kræver at du er 
opmærksom, i mindst 8 uger efter behandlingen eller indtil din læge fortæller dig, at du fuldstændig er 
kommet dig. Abecma kan gøre dig søvnig, forårsage forvirring eller anfald (krampeanfald). </p>
<p>Abecma indeholder natrium, kalium og dimethylsulfoxid (DMSO) 
Dette lægemiddel indeholder op til 752 mg natrium (hovedkomponent af madlavnings-/bordsalt) pr. 
dosis. Dette svarer til 37,6 % af den anbefalede maksimale daglige indtagelse af natrium for en 
voksen. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Afgivelse af blod til fremstilling af Abecma fra dine hvide blodlegemer </p>
<ul>
<li>
...
<li>
<p>Dine hvide blodlegemer nedfryses derefter og sendes væk for at fremstille Abecma. </p>
</li>
</ul>
<p>Andre lægemidler, som du får, før Abecma </p>
<ul>
<li>
<p>Et par dage før du får Abecma, vil du få et kort forløb med kemoterapi. Det er for at fjerne dine 
eksisterende hvide blodlegemer. </p>
</li>
<li>
<p>Kort før du får Abecma, vil du få paracetamol og et lægemiddel med antihistamin. Det er for at 
...
<ul>
<li>
<p>Din læge vil kontrollere, at Abecma blev klargjort ud fra dit eget blod ved at kontrollere, at 
patientidentitetsoplysningerne på lægemiddeletiketterne svarer til dine oplysninger. </p>
</li>
<li>
<p>Abecma gives som et infusionsdrop gennem en slange ind i en vene.  </p>
</li>
</ul>
<p>Når Abecma er givet </p>
<ul>
<li>
<p>Bliv tæt på det sygehus, hvor du fik Abecma, i mindst 4 uger. </p>
</li>
<li>
<p>Du kan blive overvåget dagligt på sygehuset i mindst 10 dage, for at kontrollere om din 
behandling virker - og hjælpe dig, hvis du har bivirkninger. Se punkt 2 og 4. * Du må ikke donere blod, organer, væv eller celler til transplantation. </p>
</li>
</ul>
...
Fortæl det straks til lægen, hvis du får en eller flere af følgende bivirkninger, efter du har fået Abecma. 
De sker normalt i de første 8 uger efter infusionen, men kan også udvikle sig senere: </p>
<ul>
<li>
<p>feber, kulderystelser, åndedrætsbesvær, svimmelhed eller ørhed, kvalme, hovedpine, hurtig puls, 
lavt blodtryk eller træthed - disse kan være symptomer på cytokinfrigivelsessyndrom eller CRS, 
en alvorlig og potentiel dødelig tilstand. </p>
</li>
<li>
<p>forvirring, hukommelsesbesvær, talebesvær eller nedsat taleevne, besvær med at forstå tale, tab 
af balance eller koordination, desorientering, mindre årvågenhed (nedsat bevidsthed) eller 
overdreven søvnighed, bevidsthedstab, uklarhed, anfald (krampeanfald), rysten eller svaghed 
med tab af bevægelse på den ene side af kroppen. Symptomer på parkinsonisme, såsom rysten, 
langsomme bevægelser og stivhed. </p>
</li>
<li>
<p>ethvert tegn på en infektion, som kan omfatte feber, kulderystelser eller skælven, hoste, 
åndenød, hurtig vejrtrækning og hurtig puls. </p>
</li>
<li>
<p>følelse af at være meget træt, svag eller have åndenød, hvilket kan være tegn på et lavt niveau af 
røde blodlegemer (anæmi). </p>
</li>
<li>
<p>blødning eller have lettere ved at få blå mærker uden årsag, herunder næseblod eller blødning fra 
munden eller tarmene, som kan være et tegn på et lavt niveau af blodpladeceller i blodet. </p>
</li>
</ul>
<p>Fortæl det straks til lægen, hvis du får nogen af ovenstående bivirkninger, da du kan få brug for akut 
lægebehandling. </p>
...
<li>
<p>lavt antal hvide blodlegemer (neutrofiler, leukocytter og lymfocytter), hvilket kan øge din risiko 
for infektion </p>
</li>
<li>
<p>infektioner, herunder lungebetændelse eller infektioner i luftvejene, munden, huden, urinvejene 
eller blodet, som kan skyldes bakterier, virus eller svampe </p>
</li>
<li>
<p>laboratorietestresultater, der viser et lavt niveau af antistoffer, kaldet immunglobuliner 
(hypogammaglobulinæmi), som er vigtige ved bekæmpelse af infektioner </p>
</li>
<li>
<p>laboratorietestresultater, der viser reducerede niveauer af calcium, natrium, magnesium, kalium, 
fosfat eller albumin, hvilket kan forårsage træthed, muskelsvaghed eller kramper eller en 
uregelmæssig hjerterytme </p>
</li>
<li>
<p>laboratorietestresultater, der viser forhøjede niveauer af leverenzymer (unormal 
leverfunktionstest) eller et højere niveau af et protein (C-reaktivt protein) i blodet, som kan tyde 
på betændelse (inflammation). </p>
</li>
</ul>
<p>Almindelig: kan forekomme hos op til 1 ud af 10 personer </p>
<ul>
<li>
<p>alvorlig inflammation på grund af aktivering af dit immunsystem, hvilket kan føre til alvorlig 
skade i kroppen </p>
</li>
<li>
<p>muskelsmerter </p>
...
<li>
<p>unormale kropsbevægelser eller manglende koordination </p>
</li>
<li>
<p>ujævn eller uregelmæssig hjerterytme </p>
</li>
<li>
<p>væske i lungerne </p>
</li>
<li>
<p>lavt iltniveau i blodet, hvilket kan forårsage åndenød, forvirring eller døsighed. </p>
</li>
</ul>
...
<ul>
<li>
<p>Aktivt stof: idecabtagen vicleucel. Hver Abecma-infusionspose indeholder idecabtagen 
vicleucel-celledispersion i en batchafhængig koncentration af autologe T-celler, der er genetisk 
modificeret til at udtrykke en anti-BCMA-kimær antigenreceptor (CAR-positive levedygtige T-
celler). En eller flere infusionsposer indeholder i alt 260 til 500 × 106 CAR-positive levedygtige 
T-celler. </p>
</li>
<li>
...
Abecma er en farveløs infusionsvæske, celledispersion, der leveres i en eller flere infusionsposer, der 
er pakket individuelt i en metalkassette. Hver pose indeholder 10 ml til 100 ml celledispersion. </p>
...
<p>Det er vigtigt, at du læser hele indholdet af denne procedure, inden du administrerer Abecma. </p>
<p>Sikkerhedsforanstaltninger, der skal træffes før håndtering og administration af lægemidlet </p>
<ul>
<li>
<p>Abecma skal transporteres inden for behandlingsstedet i lukkede, brudsikre, lækagesikre 
beholdere. </p>
</li>
<li>
<p>Dette lægemiddel indeholder humane blodceller. Sundhedspersoner, der håndterer Abecma, skal 
træffe passende forholdsregler (bære handsker og øjenværn) for at undgå potentiel overførsel af 
...
<ul>
<li>
<p>Før Abecma-infusion skal det bekræftes, at patientens identitet stemmer overens med 
patientidentifikatorerne på Abecma-kassetten/-kassetterne, infusionsposen/-poserne og 
certifikatet for frigivelse til infusion (RfIC). </p>
</li>
<li>
<p>Abecma-infusionsposen må ikke fjernes fra kassetten, hvis oplysningerne på den 
patientspecifikke etiket ikke stemmer overens med den tilsigtede patient. Virksomheden skal 
straks kontaktes, hvis der er uoverensstemmelser mellem etiketterne og patientidentifikatorerne. </p>
</li>
<li>
<p>Hvis der er modtaget mere end én infusionspose til behandling, skal hver infusionspose optøs én 
ad gangen. Tidspunktet for optøning af Abecma og infusion skal koordineres. Starttidspunktet 
for infusionen skal bekræftes på forhånd og justeres til optøning, så Abecma er tilgængelig for 
infusion, når patienten er klar. </p>
</li>
</ul>
<p>Optøning </p>
<ul>
<li>
<p>Tag Abecma-infusionsposen ud af kassetten, og efterse infusionsposen for brud på beholderens 
integritet, såsom brud eller revner, inden den optøs. Hvis infusionsposen ser ud til at være 
beskadiget eller lække, må den ikke infunderes, og den skal bortskaffes i henhold til lokale 
retningslinjer for håndtering af affald af materiale af human oprindelse. </p>
</li>
<li>
<p>Anbring infusionsposen inden i en anden steril pose. </p>
</li>
<li>
<p>Optø Abecma ved ca. 37 °C med en godkendt optøningsanordning eller vandbad, indtil der ikke 
er synlig is i infusionsposen. Bland forsigtigt posens indhold for at opløse klumper af 
cellemateriale. Hvis der stadig er synlige celleklumper, blandes posens indhold fortsat forsigtigt. 
Små klumper af cellemateriale skal opløses ved forsigtig, manuel blanding. Abecma må ikke 
vaskes, centrifugeres og/eller resuspenderes i nye medier inden infusion. </p>
</li>
</ul>
<p>Administration </p>
<ul>
<li>
<p>Der må IKKE anvendes et leukodepleterende filter. </p>
</li>
<li>
<p>Intravenøs infusion af Abecma bør kun administreres af sundhedspersoner med erfaring i 
immunsupprimerede patienter og uddannet til at håndtere anafylaksi. </p>
</li>
<li>
<p>Sørg for at tocilizumab og nødudstyr er til rådighed før infusion og under restitutionsperioden. I 
det ekstraordinære tilfælde, hvor tocilizumab ikke er tilgængeligt grundet 
forsyningsvanskeligheder, der er opført i Det Europæiske Lægemiddelagenturs oversigt over 
forsyningsvanskeligheder, skal det sikres at passende alternative foranstaltninger til behandling 
af CRS, i stedet for tocilizumab, er tilgængelig på behandlingscentret. </p>
</li>
<li>
<p>Der kan anvendes central veneadgang til infusion af Abecma, og det anbefales til patienter med 
dårlig perifer adgang. </p>
</li>
<li>
<p>Inden administration skal det bekræftes, at patientens identitet svarer til den unikke 
patientinformation på Abecma-infusionsposen og den ledsagende dokumentation. Det samlede 
antal infusionsposer, der skal administreres, skal også bekræftes med de patientspecifikke 
oplysninger i certifikatet for frigivelse til infusion (RfIC). </p>
</li>
<li>
<p>Klargør infusionssættets slange med natriumchlorid 9 mg/ml (0,9 %) injektionsvæske, 
opløsning inden infusion. </p>
</li>
<li>
<p>Infundér Abecma inden for 1 time fra optøningsstart, så hurtigt som det tolereres, ved hjælp af 
tyngdekraften. </p>
</li>
<li>
<p>Når hele indholdet af infusionsposen er infunderet, skylles slangen med natriumchlorid 9 mg/ml 
(0,9 %) injektionsvæske, opløsning ved samme infusionshastighed for at sikre, at alt produkt 
administreres. </p>
</li>
<li>
<p>Følg samme procedure for alle efterfølgende infusionsposer til den identificerede patient. </p>
</li>
</ul>
<p>Foranstaltninger, der skal træffes i tilfælde af utilsigtet eksponering </p>
<ul>
<li>Ved utilsigtet eksponering skal de lokale retningslinjer for håndtering af humant materiale 
følges. Arbejdsflader og materialer, som potentielt har været i kontakt med Abecma, skal 
dekontamineres med passende desinfektionsmiddel. </li>
</ul>
<p>Forholdsregler, der skal træffes i forbindelse med bortskaffelse af lægemidlet </p>
<ul>
<li>Ikke anvendt lægemiddel og alt materiale, der har været i kontakt med Abecma (fast og 
flydende affald), skal håndteres og bortskaffes som potentielt infektiøst affald i 
overensstemmelse med lokale retningslinjer om håndtering af humant materiale. </li>
</ul>
<p>BILAG IV 
KONKLUSIONER VEDRØRENDE ANMODNING OM 
MARKEDSFØRINGSBESKYTTELSE FREMLAGT AF DET EUROPÆISKE 
LÆGEMIDDELAGENTUR 
Konklusioner fremlagt af Det Europæiske Lægemiddelagentur vedrørende: </p>
<ul>
