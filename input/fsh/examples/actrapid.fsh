...
Instance: composition-en-5e0fa5924c243f84290194737af8a73f
...
* title = "TEST PURPOSES ONLY - actrapid"
...
<ol>
<li>What Actrapid is and what it is used for </li>
<li>What you need to know before you use Actrapid </li>
<li>How to use Actrapid </li>
<li>Possible side effects </li>
<li>How to store Actrapid </li>
<li>Contents of the pack and other information </li>
</ol>         </div>"""   
          

* section[=].section[+]
  * title =  "1. What actrapid is and what it is used for"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text =  "1. What actrapid is and what it is used for"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Actrapid is human insulin with a fast-acting effect.  </p>
<p>Actrapid is used to reduce the high blood sugar level in patients with diabetes mellitus (diabetes). 
Diabetes is a disease where your body does not produce enough insulin to control the level of your 
blood sugar. Treatment with Actrapid helps to prevent complications from your diabetes.  </p>
<p>Actrapid will start to lower your blood sugar about half an hour after you inject it, and the effect will 
last for approximately 8 hours. Actrapid is often given in combination with intermediate-acting or 
long-acting insulin preparations. </p>         </div>"""   
          

             
* section[=].section[+]
  * title = "2. What you need to know before you take actrapid"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
...
<p>Other medicines and Actrapid </p>
...
blood pressure) 
* Salicylates (used to relieve pain and lower fever)<br />
...
<p>Actrapid can be used in children and adolescents. </p>
...
<p>Actrapid is administered by injection under the skin (subcutaneously). You must never inject yourself 
directly into a vein (intravenously) or muscle (intramuscularly). Actrapid Penfill is only suitable for 
...
* Drink alcohol, see Actrapid with alcohol in section 2. Signs of low blood sugar: Cold sweat; cool pale skin; headache; rapid heartbeat; feeling sick; feeling 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Actrapid contains </p>
<p>The active substance is human insulin. Each ml contains 100 IU of human insulin. Each 
cartridge contains 300 IU of human insulin in 3 ml solution for injection. </p>
<p>The other ingredients are zinc chloride, glycerol, metacresol, sodium hydroxide, hydrochloric 
acid and water for injections. </p>
<p>What Actrapid looks like and contents of the pack </p>
<p>Actrapid is presented as a solution for injection.<br />
...
<p>Actrapid InnoLet 100 IU/ml (international units/ml) solution for injection in pre-filled pen 
human insulin </p>
...
Instance: composition-da-5e0fa5924c243f84290194737af8a73f
InstanceOf: CompositionUvEpi
Title: "Composition for actrapid Package Leaflet"
Description:  "Composition for actrapid Package Leaflet"
Usage: #inline
...
<li>Det skal du vide, før du begynder at tage Actrapid </li>
<li>Sådan skal du tage Actrapid </li>
<li>Bivirkninger </li>
<li>Opbevaring </li>
...
* section[=].section[+]
  ...
  * code.text =  "1. What actrapid is and what it is used for"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Actrapid er et humant insulin med en hurtigtvirkende effekt. </p>
<p>Actrapid anvendes til at sænke det høje blodsukkerniveau hos patienter med sukkersyge (diabetes 
...
diabetes. </p>
<p>Actrapid begynder at nedsætte blodsukkeret ca. ½ time efter, at du har injiceret det, og virkningen varer i 
ca. 8 timer. Actrapid gives ofte i kombination med insulin med middellang virkningstid eller 
langtidsvirkende insulin. </p>         </div>"""   
...
* section[=].section[+]
  ...
  * code.text = "2. What you need to know before you take actrapid"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Tag ikke Actrapid </p>
<p>► 
...
<p>Hvis noget af ovenstående gør sig gældende, må du ikke tage Actrapid. Tal med lægen, apotekspersonalet 
eller sygeplejersken for rådgivning.  </p>
<p>Før du tager Actrapid </p>
<p>► 
...
<p>Brug af anden medicin sammen med Actrapid </p>
...
<p>Betablokkere (til behandling af for højt blodtryk) kan svække eller fuldstændigt undertrykke de første 
...
medicin.  </p>
<p>Brug af Actrapid sammen med alkohol </p>
<p>► 
...
barns helbred.<br />
► 
Der er ingen begrænsninger ved behandling med Actrapid under amning. </p>
...
andre i fare. </p>
<p>Actrapid indeholder natrium </p>
<p>Actrapid indeholder mindre end 1 mmol natrium (23 mg) per dosis, dvs. Actrapid er stort set natriumfrit. </p>         </div>"""   
...
<p>Indtag et måltid eller et mellemmåltid indeholdende kulhydrater inden for 30 minutter efter injektionen for 
...
<p>Actrapid kan anvendes til børn og unge. </p>
...
<p>Actrapid administreres ved injektion under huden (subkutant). Du må aldrig selv injicere direkte i en vene 
...
virkning, hvis insulinet injiceres i maveskindet. Du skal altid måle dit blodsukker regelmæssigt. </p>
<p>► 
...
skal du anvende to forskellige insulindispenseringssystemer, ét til hver insulintype.<br />
► 
Medbring altid en Penfill cylinderampul i reserve i tilfælde af, at den ene bliver væk eller bliver 
beskadiget. </p>
<p>Sådan injiceres Actrapid </p>
<p>► 
...
► 
Efter injektionen skal nålen forblive under huden i mindst 6 sekunder. Hold trykknappen helt nede, 
...
► 
Husk at fjerne og kassere nålen efter hver injektion og opbevar Actrapid uden nålen påsat. Ellers 
...
og meget almindelige bivirkninger under punkt 4. Hvis du har glemt at tage insulin 
...
<li>
<p>Drikker alkohol, se Brug af Actrapid sammen med alkohol under punkt 2. Tegn på lavt blodsukker: Koldsved, kold bleg hud, hovedpine, hjertebanken, kvalme, usædvanlig stor 
...
<p>Alvorlige allergiske reaktioner over for Actrapid eller et af indholdsstofferne (kaldet systemisk allergisk 
...
<p>Hudforandringer på injektionsstedet: Hvis du injicerer insulin for ofte på samme sted, kan fedtvævet 
enten skrumpe (lipoartrofi) eller fortykkes (lipohypertrofi) (kan forekomme hos færre end 1 ud af behandlede). Knuder under huden kan også skyldes ophobning af et protein, der kaldes amyloid (kutan 
...
<p>Smertefuld neuropati (smerte på grund af nerveskade): Hvis dit blodsukkerniveau forbedres meget 
...
urinen for ketonstoffer og søg straks lægehjælp.<br />
►<br />
...
<p>Actrapid InnoLet 100 IE/ml (internationale enheder/ml) injektionsvæske, opløsning i fyldt pen 
humant insulin </p>
...
// MPD
* entry[+].fullUrl = "MedicinalProductDefinition/mp5e0fa5924c243f84290194737af8a73f"
* entry[=].resource = mp5e0fa5924c243f84290194737af8a73f
                            
                    
Instance: bundlepackageleaflet-da-5e0fa5924c243f84290194737af8a73f
InstanceOf: BundleUvEpi
Title: "ePI document Bundle for actrapid Package Leaflet for language da"
Description: "ePI document Bundle for actrapid Package Leaflet for language da"
Usage: #example
...
// Composition
* entry[0].fullUrl = "Composition/composition-da-5e0fa5924c243f84290194737af8a73f"
* entry[0].resource = composition-da-5e0fa5924c243f84290194737af8a73f
...
RuleSet: 5e0fa5924c243f84290194737af8a73fListRuleset
...
* entry
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-en-5e0fa5924c243f84290194737af8a73f) // actrapid en
...
* entry
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-da-5e0fa5924c243f84290194737af8a73f) // actrapid da
  * item.extension[0].url = "http://ema.europa.eu/fhir/extension/documentType"
  * item.extension[=].valueCoding = $100000155531#100000155538 "B. PACKAGE LEAFLET"
  * item.extension[+].url = "http://ema.europa.eu/fhir/extension/language"
...
Instance: List-5e0fa5924c243f84290194737af8a73f
InstanceOf: List

* insert 5e0fa5924c243f84290194737af8a73fListRuleset
