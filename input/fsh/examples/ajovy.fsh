...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What AJOVY is 
AJOVY is a medicine containing the active substance fremanezumab, a monoclonal antibody, a type 
of protein that recognises and attaches to a specific target in the body.  </p>
<p>How AJOVY works 
...
activity reduces migraine attacks. </p>
<p>What AJOVY is used for 
AJOVY is used to prevent migraine in adults who have at least 4 migraine days per month. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not use AJOVY 
...
Talk to your doctor, pharmacist or nurse immediately if you get any signs of a serious allergic 
reaction, e.g. trouble breathing, swelling of the lips and tongue, or severe rash, after injecting AJOVY. 
These reactions can occur within 24 hours after using AJOVY but can sometimes be delayed. </p>
<p>Tell your doctor if you have or have had cardiovascular disease (problems affecting the heart and 
...
this medicine. You and your doctor should decide if you will use AJOVY while breast-feeding.  </p>
...
caregiver have been trained by your doctor or nurse. </p>
<p>Use a reminder method such as notes in a calendar or diary to help you remember your next dose so 
that you do not miss a dose or have a dose too soon after the last one. </p>
<p>If you use more AJOVY than you should 
If you have used more AJOVY than you should, tell your doctor. </p>
<p>If you forget or miss to use AJOVY 
...
Pain, hardening or redness at the injection site </p>
<p>Common (may affect up to 1 in 10 people) 
Itching at the injection site </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What AJOVY contains<br />
- The active substance is fremanezumab.<br />
