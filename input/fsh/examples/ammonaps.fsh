...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>AMMONAPS is prescribed to patients with urea cycle disorders. Patients with these rare disorders 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not take AMMONAPS 
- if you are pregnant. 
...
milk and harm your baby. </p>
<p>Driving and using machines 
No studies on the effects on the ability to drive and use machines have been performed. </p>
...
times per day). You should take AMMONAPS with a large volume of water. </p>
<p>AMMONAPS must be taken with a special diet reduced in protein. </p>
<p>AMMONAPS tablets should not be given to children who are not able to swallow tablets. It is 
recommended that AMMONAPS granules are used instead. </p>
...
<p>Very common side effects: irregular menstrual periods and cessation of menstrual periods.<br />
...
may be caused by pregnancy (see Pregnancy and breast-feeding section above). </p>
<p>Common side effects: changes in number of blood cells (red cells, white cells and platelets), reduced 
...
function, weight gain, altered laboratory test values. </p>
<p>Uncommon side effects: deficiency in red blood cells due to bone marrow depression, bruising, altered 
heart rhythm, rectal bleeding, stomach irritation, stomach ulcer, inflammation of the pancreas. </p>
...
<li>The other ingredients are microcrystalline cellulose, magnesium stearate and colloidal 
anhydrous silica. </li>
</ul>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>AMMONAPS ordineres til patienter, der lider af forstyrrelser i urinstofcyklus. Patienter med disse 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Tag ikke AMMONAPS 
- hvis du er gravid 
- hvis du ammer 
...
Det anbefales at bruge AMMONAPS granulat i stedet. </p>
<p>AMMONAPS skal kombineres med en lavproteindiæt, som udarbejdes specielt til dig af en læge eller 
en kostvejleder. Du skal følge denne diæt nøje. </p>
<p>AMMONAPS forhindrer ikke fuldstændigt, at en akut tilstand med for meget ammoniak i blodet 
opstår, og AMMONAPS er ikke egnet til behandling af en sådan nødsituation. </p>
<p>Hvis du skal have taget laboratorieprøver, er det vigtigt, at du fortæller det til lægen, at du tager 
AMMONAPS, da natriumphenylbutyrat kan påvirke resultaterne af bestemte laboratorieprøver.  </p>
<p>Brug af anden medicin sammen med AMMONAPS 
Fortæl altid lægen eller apotekspersonalet, hvis du tager anden medicin eller har gjort det for nylig.  </p>
<p>Det er især vigtigt, at du fortæller det til din læge, hvis du tager medicin, som indeholder:</p>
<ul>
<li>valproinsyre (et antiepileptisk lægemiddel) </li>
<li>haloperidol (der anvendes til behandling af visse psykotiske lidelser) </li>
<li>kortikosteroider (kortisonlignende lægemidler, som anvendes til at lindre betændelsestilstande i 
kroppen) </li>
<li>probenecid (til behandling af forhøjet indhold af urinsyre i blodet i forbindelse med gigt 
(hyperurikæmi)) </li>
</ul>
<p>Disse lægemidler kan ændre virkningen af AMMONAPS, og du vil have behov for hyppigere kontrol 
...
<p>Tag ikke AMMONAPS, hvis du ammer, da denne medicin kan passere over i modermælken og skade 
dit barn. </p>
...
daglige dosis. Din læge vil fortælle dig, hvor mange tabletter du skal tage. </p>
<p>Indgivelsesmåde 
Du skal tage AMMONAPS gennem munden i ligeligt inddelte doser og sammen med hvert måltid (for 
eksempel tre gange om dagen). Du skal tage AMMONAPS sammen med en stor mængde vand. </p>
<p>AMMONAPS skal tages sammen med en særlig lavproteindiæt. </p>
<p>AMMONAPS tabletter bør ikke gives til børn, som ikke er i stand til at sluge tabletter. Det anbefales 
at anvende AMMONAPS granulat i stedet. </p>
<p>Du vil hele livet skulle have behandling og følge en særlig kostplan, medmindre du får foretaget en 
vellykket levertransplantation.   </p>
<p>Hvis du har taget for meget AMMONAPS 
Patienter, der har taget meget store doser AMMONAPS, oplever:</p>
<ul>
...
<p>Hvis du oplever et af de nævnte symptomer, bør du straks kontakte din læge eller skadestuen på 
nærmeste hospital for at få understøttende behandling. </p>
...
<p>Meget almindelig: Forekommer hos mere end 1 bruger ud af Almindelig:<br />
Rammer fra 1 til 10 brugere ud af Ikke almindelig: 
Rammer fra 1 til 10 brugere ud af 1Sjælden: </p>
<p>Rammer fra 1 til 10 brugere ud af 10.Meget sjælden: 
Rammer færre end 1 bruger ud af 10.Ikke kendt:<br />
Hyppigheden kan ikke estimeres ud fra de tilgængelige data </p>
<p>Meget almindelige bivirkninger: uregelmæssige menstruationer og ophør af menstruationer. 
...
gravid (se afsnittet herover om graviditet og amning).  </p>
<p>Almindelige bivirkninger: ændringer i antallet af blodlegemer (røde blodlegemer, hvide blodlegemer 
...
udslæt, unormal nyrefunktion, vægtstigning, ændrede resultater af laboratorieanalyser. </p>
<p>Ikke almindelige bivirkninger: mangel på røde blodlegemer som følge af knoglemarvsundertrykkelse, 
...
<p>Du kan finde yderligere oplysninger om AMMONAPS på det Europæiske Lægemiddelagenturs<br />
hjemmeside http://www.ema.europa.eu/.  </p>
<p>Indlægsseddel: Information til brugeren </p>
<p>AMMONAPS 940 mg/g granulat 
