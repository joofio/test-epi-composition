...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What ANORO ELLIPTA is  </p>
<p>ANORO ELLIPTA contains two active substances umeclidinium bromide and vilanterol. These belong to a 
group of medicines called bronchodilators. </p>
<p>What ANORO ELLIPTA is used for  </p>
<p>ANORO ELLIPTA is used to treat chronic obstructive pulmonary disease (COPD) in adults. COPD is a 
long-term condition characterised by breathing difficulties that slowly get worse.  </p>
...
<p>ANORO ELLIPTA should not be used to relieve a sudden attack of breathlessness or wheezing.<br />
...
tiotropium, indacaterol. Do not use ANORO ELLIPTA if you already use these medicines. </li>
</ul>
<p>Tell your doctor or pharmacist if you are taking any of these. Your doctor may wish to monitor you 
carefully if you are taking any of these medicines as they may increase the side effects of ANORO 
ELLIPTA. </p>
...
<p>It is not known whether the ingredients of ANORO ELLIPTA can pass into breast milk. If you are breast-
feeding, you must check with your doctor before you use ANORO ELLIPTA. Do not use this medicine if 
you are breast-feeding unless your doctor tells you that you can. </p>
<p>Driving and using machines<br />
It is unlikely that ANORO ELLIPTA will affect your ability to drive or use machines. </p>
<p>ANORO ELLIPTA contains lactose 
...
<p>Use ANORO ELLIPTA regularly 
It is very important that you use ANORO ELLIPTA every day, as instructed by your doctor. This will help to 
...
<p>If you use more ANORO ELLIPTA than you should 
...
<p>If you forget to use ANORO ELLIPTA<br />
...
medical advice. </p>
<p>If you stop using ANORO ELLIPTA 
...
If you have any of the following symptoms after taking ANORO ELLIPTA stop using this medicine and 
...
<p>Immediate breathing difficulties 
Immediate breathing difficulties after using ANORO ELLIPTA are rare. If you get tightness of the chest, 
coughing, wheezing or breathlessness immediately after using this medicine: 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What ANORO ELLIPTA contains<br />
...
<p>The active substances are present as a white powder in separate blisters inside the inhaler.<br />
ANORO ELLIPTA is available in packs of 1 inhaler containing either 7 or 30 doses and in multipacks 
