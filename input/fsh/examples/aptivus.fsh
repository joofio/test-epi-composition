...
Instance: composition-en-a8020a852a9fed523fd88e0aa8dbc86d
...
<ol>
<li>What Aptivus is and what it is used for</li>
<li>What you need to know before you take Aptivus</li>
<li>How to take Aptivus</li>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Aptivus contains the active substance tipranavir. It belongs to a group of medicines called protease 
...
with:</p>
<p>low dose ritonavir (this helps Aptivus to reach a high enough level in your blood)</p>
<p>other HIV medicines. Your doctor, together with you, will decide which other medicines you 
should take. This will depend on, for example:</p>
<p>which other medicines you have already taken for HIV</p>
<p>which medicines your HIV is resistant to. If your HIV is resistant to some HIV 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>You must take Aptivus in combination with low dose ritonavir and other antiretroviral 
...
pharmacist for advice before taking this medicine. It is not known whether Aptivus may be used safely 
during pregnancy.
...
soon as possible. See also Section 2, under  Oral contraceptives/hormone replacement therapy 
(HRT) .
...
Aptivus contains 100 mg of alcohol (ethanol) in each capsule. The amount in 250 mg of this medicine 
...
The recommended dose for an adult or an adolescent 12 years and above who have a Body Surface 
Area (BSA) of  1.3 m2 or weight  36 kg is:
-
...
Bleeding
-
<em>Bleeding in the brain. This can lead to permanent disability or death, and has 
...
-
Bleeding in the brain</em> (see above)
-
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <h2>What Aptivus contains</h2>
<h2>The active substance is tipranavir. Each capsule contains 250 mg tipranavir.</h2>
<p>The other ingredients are macrogolglycerol ricinoleate, ethanol (alcohol), mono/diglycerides 
...
Instance: composition-da-a8020a852a9fed523fd88e0aa8dbc86d
InstanceOf: CompositionUvEpi
Title: "Composition for aptivus Package Leaflet"
Description:  "Composition for aptivus Package Leaflet"
Usage: #inline
...
2. Det skal du vide, før du begynder at tage Aptivus
...
-
unge fra 12 års alderen, som har et kropsoverfladeareal (BSA) på ≥1,3 m2 eller en vægt på 
≥36 kg
-
voksne
47</p>         </div>"""   
...
Knogleproblemer: Nogle af de patienter, der får en kombination af antiretrovirale lægemidler, kan 
...
-
raltegravir (til behandling af hiv-infektion).
-
dolutegravir (til behandling af hiv-infektion).
...
din læge eller apotekspersonalet til råds, før du tager dette lægemiddel. Det er uvist, om det er sikkert 
at tage Aptivus under graviditet.
...
Aptivus indeholder 100 mg alkohol (ethanol) pr. kapsel. Mængden i 250 mg af dette lægemiddel (dvs. 
...
Den anbefalede daglige dosis for voksne eller unge fra 12 år, som har et kropsoverfladeareal (BSA) på 
≥1,3 m2 eller en vægt på ≥36 kg, er:
-
500 mg (2 kapsler a 250 mg) Aptivus taget sammen med 
-
200 mg (2 kapsler a 100 mg) ritonavir 2 gange dagligt sammen med mad. 
Til oral anvendelse.
Aptivus kaspler skal tages sammen med mad, sluges hele, og må ikke åbnes eller tygges.
...
Tager du alle doser på det rigtige tidspunkt:</p>
<ul>
<li>så øger det i høj grad effekten af kombinationsbehandlingen</li>
<li>mindsker det risikoen for, at din hiv udvikler resistens overfor din antiretrovirale behandling. 
...
kan være vanskeligt at skelne mellem:
-
...
Blødninger
-</p>
<p><em>blødninger i hjernen. Sådanne blødninger kan føre til varig invaliditet eller dødsfald, og er set 
...
vægttab i ansigtet
-
blødning i hjernen </em>(se ovenfor)
-
...
Aptivus bløde kapsler er lyserøde, aflange bløde gelatinekapsler med et sort påtrykt mærke TPV 250. Hver Aptivus-kapsel indeholder 250 mg af den aktive substans tipranavir. Aptivus bliver leveret i 
...
// MPD
* entry[+].fullUrl = "MedicinalProductDefinition/mpa8020a852a9fed523fd88e0aa8dbc86d"
* entry[=].resource = mpa8020a852a9fed523fd88e0aa8dbc86d
                            
                    
Instance: bundlepackageleaflet-da-a8020a852a9fed523fd88e0aa8dbc86d
InstanceOf: BundleUvEpi
Title: "ePI document Bundle for aptivus Package Leaflet for language da"
Description: "ePI document Bundle for aptivus Package Leaflet for language da"
Usage: #example
...
// Composition
* entry[0].fullUrl = "Composition/composition-da-a8020a852a9fed523fd88e0aa8dbc86d"
* entry[0].resource = composition-da-a8020a852a9fed523fd88e0aa8dbc86d
...
RuleSet: a8020a852a9fed523fd88e0aa8dbc86dListRuleset

* identifier.system = "http://ema.europa.eu/identifier" 
* identifier.value = "None"
* identifier[+].system = "http://spor.ema.europa.eu/v2/medicine-name"
* identifier[=].value = "aptivus"
...
* entry
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-en-a8020a852a9fed523fd88e0aa8dbc86d) // aptivus en
...
* entry
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-da-a8020a852a9fed523fd88e0aa8dbc86d) // aptivus da
  * item.extension[0].url = "http://ema.europa.eu/fhir/extension/documentType"
  * item.extension[=].valueCoding = $100000155531#100000155538 "B. PACKAGE LEAFLET"
  * item.extension[+].url = "http://ema.europa.eu/fhir/extension/language"
