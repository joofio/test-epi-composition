...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>ARIKAYCE liposomal is an antibiotic that contains the active ingredient amikacin. Amikacin 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not use ARIKAYCE liposomal 
...
- if you have very poor kidney function </p>
<p>Warnings and precautions 
Talk to your doctor or pharmacist before using ARIKAYCE liposomal if:</p>
<ul>
<li>you use a bronchodilator ( reliever ) for breathing problems, as you will be asked to use that 
first, before using ARIKAYCE liposomal; </li>
<li>you have kidney problems; you may need to have a kidney test before starting treatment; </li>
<li>you have hearing difficulties, ringing or buzzing in the ears (tinnitus) or balance problems 
...
any hearing problems; </li>
<li>you suffer from other lung diseases;  </li>
<li>you have a disease that causes muscle weakness and fatigue, such as myasthenia gravis; </li>
<li>you have, or have a maternal history of mitochondrial mutation disease (a genetic condition) or 
loss of hearing due to antibiotic medicines, you are advised to inform your doctor or pharmacist 
before you take an aminoglycoside; certain mitochondrial mutations may increase your risk of 
hearing loss with this product. Your doctor may recommend genetic testing before 
administration of ARIKAYCE liposomal. </li>
</ul>
<p>Talk to your doctor immediately if, whilst using ARIKAYCE liposomal you experience any of the 
below:</p>
<ul>
<li>loss of consciousness, skin rash, fever, worsening or new problems with your breathing; </li>
<li>worsening of kidney problems;  </li>
<li>ear problems like ringing in your ears or loss of hearing.<br />
See section 4. Children and adolescents 
ARIKAYCE liposomal should not be given to children and adolescents less than 18 years old. </li>
</ul>
<p>Other medicines and ARIKAYCE liposomal 
Tell your doctor or pharmacist if you are taking, have recently taken or might take any other 
medicines. </p>
<p>Special care is needed if you are taking other medicines, as some could interact with ARIKAYCE 
liposomal, for example:</p>
<ul>
<li>diuretics ( water tablets ) such as ethacrynic acid, furosemide, or mannitol </li>
<li>other medicines that can affect your kidneys, hearing, balance or reduce muscle strength  </li>
</ul>
...
<p>If you become pregnant while using ARIKAYCE liposomal, inform your doctor. He will advise 
whether to stop using ARIKAYCE liposomal. </p>
<p>It is not known if amikacin passes into breast milk in humans. If you are breastfeeding, your doctor 
will advise you whether to stop breast-feeding or stop treatment with this medicine. </p>
...
sure. </p>
<p>The recommended dose is one vial of ARIKAYCE liposomal inhaled in your mouth once a day, using 
the Lamira Nebuliser. After 6 months of treatment your doctor will advise whether to continue or to 
stop treatment. The maximum duration of treatment is 18 months.  </p>
<p>Taking ARIKAYCE liposomal </p>
<p>If you use a bronchodilator ( reliever ), use that first, before using ARIKAYCE liposomal. 
...
- Read the instructions for use, which are provided at the end of this leaflet. </p>
<p>How and when do you replace the Lamira Nebuliser Handset? 
...
Please refer to the manufacturer s instructions for use for cleaning and storage advice. </p>
<p>If you use more ARIKAYCE liposomal than you should 
Tell your doctor immediately if you are concerned that you may have used too much of this medicine. </p>
<p>If you forget to use ARIKAYCE liposomal 
...
<ul>
<li>you experience any hypersensitivity or severe allergic reactions when taking ARIKAYCE 
liposomal (e.g. with low blood pressure, loss of consciousness, severe skin rash or severe 
wheezing and breathlessness). The frequency of these side effects is not known. </li>
<li>you experience worsening of your usual lung problems or new problems with your breathing 
...
of these severe side effects is common to very common. </li>
</ul>
<p>Other side effects: 
Tell your doctor or pharmacist if you experience any of the following: </p>
...
<p>Store in a refrigerator (2  C   8  C). Do not freeze, discard any vial that has been frozen.  </p>
<p>If the dose you want to use is refrigerated, remove the vial from the refrigerator and allow it to come to 
room temperature before using it.  </p>
<p>Alternatively, ARIKAYCE liposomal can be stored at room temperature below 25  C, but only for up 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What ARIKAYCE liposomal contains 
...
sodium hydroxide and water for injections. </p>
<p>What ARIKAYCE liposomal looks like and contents of the pack 
ARIKAYCE liposomal is a white to off-white, milky nebuliser dispersion in a 10 mL glass vial sealed 
with a rubber stopper and a metal seal with a flip tear-off cap. </p>
<p>The 28 vials are provided in a carton for a 28-day supply; one vial per day. One ARIKAYCE 
liposomal carton contains 4 inner cartons, each containing 7 vials and one aerosol head. The 28-day 
supply pack also contains 1 Lamira Nebuliser Handset. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>ARIKAYCE liposomal er et antibiotikum, der indeholder det aktive indholdsstof amikacin. Amikacin 
tilhører en gruppe af antibiotika, der kaldes aminoglycosider, som stopper væksten af visse bakterier, 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Brug ikke ARIKAYCE liposomal 
- hvis du er allergisk over for amikacin eller andre aminoglycosider, soja eller et af de øvrige 
indholdsstoffer i ARIKAYCE liposomal (angivet i punkt 6) 
- hvis du tager andre aminoglycosider (via munden eller ved injektion) 
- hvis du har en meget dårlig nyrefunktion </p>
...
behandlingen; </li>
<li>du har høreproblemer, ringen eller summen i ørerne (tinnitus) eller balanceproblemer, 
herunder en fornemmelse af, at det snurrer rundt, manglende koordinerede muskelbevægelser, 
svimmelhed eller uklarhed. Det kan være, du skal have lavet en høretest, før du starter eller 
under behandlingen, hvis du har høreproblemer; </li>
<li>du lider af andre lungesygdomme;  </li>
<li>du har en sygdom, der medfører muskelsvaghed og træthed, såsom myasthenia gravis; </li>
<li>du eller et eller flere familiemedlemmer til din mors side har en mitokondriel mutationssygdom 
(en genetisk lidelse) eller tab af hørelse som følge af antibiotiske lægemidler, i så fald tilrådes 
du at informere din læge eller apotekspersonalet, før du tager et aminoglycosid. Visse 
mitokondrielle mutationer kan øge din risiko for høretab med dette lægemiddel. Din læge kan 
anbefale en gentest, før du bruger ARIKAYCE liposomal. </li>
</ul>
<p>Kontakt straks lægen, hvis du, mens du bruger ARIKAYCE liposomal, oplever et eller flere af 
følgende:</p>
<ul>
<li>bevidsthedstab, hududslæt, feber, forværrede eller nye problemer med vejrtrækningen; </li>
<li>forværring af nyreproblemer; </li>
<li>øreproblemer, som ringen i ørerne eller tab af hørelse. 
Se punkt 4. Børn og unge 
ARIKAYCE liposomal bør ikke gives til børn og unge under 18 år. </li>
</ul>
<p>Brug af anden medicin sammen med ARIKAYCE liposomal 
...
anvendelse af ARIKAYCE liposomal undgås. Spørg din læge eller apotekspersonalet til råds, før du 
bruger dette lægemiddel. </p>
<p>Hvis du bliver gravid, mens du bruger ARIKAYCE liposomal, skal du informere lægen. Han vil 
rådgive dig om, hvorvidt du skal stoppe med at bruge ARIKAYCE liposomal. </p>
<p>Det er uvist, om amikacin udskilles i brystmælk hos mennesker. Hvis du ammer, vil lægen rådgive dig 
om, hvorvidt du skal stoppe med amningen eller stoppe behandlingen med dette lægemiddel. </p>
...
<p>Den anbefalede dosis er ét hætteglas af ARIKAYCE liposomal, der inhaleres i munden én gang om 
dagen ved anvendelse af Lamira -forstøveren. Efter 6 måneders behandling vil lægen informere dig 
...
til en Lamira-styreenhed. Se punkt 7 for oplysninger om, hvordan lægemidlet anvendes sammen 
med Lamira Nebuliser System. 
...
- Læs brugsanvisningen, der findes i slutningen af indlægssedlen. </p>
<p>Hvordan og hvornår skal Lamira-forstøverenheden udskiftes? 
Én Lamira-forstøverenhed skal bruges til ét 28 dages behandlingsforløb. Aerosolhovedet skal 
udskiftes ugentligt. Der er 4 aerosolhoveder i hver ARIKAYCE liposomal-pakning. Der henvises til 
fremstillerens brugsanvisning for råd vedrørende rengøring og opbevaring. </p>
<p>Hvis du har brugt for meget ARIKAYCE liposomal 
Du skal straks fortælle det til lægen, hvis du er bekymret for, om du har taget for meget af dette 
lægemiddel. </p>
<p>Hvis du har glemt at bruge ARIKAYCE liposomal 
Hvis du har glemt at tage din medicin, skal du tage den så hurtigt som muligt på dagen for den 
manglende dosis. Du må ikke tage mere end én dosis samme dag som erstatning for den glemte dosis. </p>
...
<ul>
<li>du oplever en overfølsomhedsreaktion eller svær allergisk reaktion, når du tager ARIKAYCE 
liposomal (f.eks. med lavt blodtryk, bevidsthedstab, kraftigt hududslæt eller en svær grad af 
pibende vejrtrækning og stakåndethed). Hyppigheden af disse bivirkninger er ikke kendt; </li>
<li>du oplever en forværring af dine sædvanlige lungeproblemer eller nye problemer med din 
vejrtrækning (f.eks. stakåndethed eller pibende vejrtrækning). Dette kan være et tegn på en svær 
inflammation i lungerne, der kræver behandling og kan betyde, at du må stoppe med at tage 
ARIKAYCE liposomal. Hyppigheden af disse svære bivirkninger er almindelig til meget 
almindelig.  </li>
</ul>
<p>Andre bivirkninger: 
Fortæl det til lægen eller apotekspersonalet, hvis du oplever et eller flere af følgende: </p>
...
- Feber 
- Vægttab </p>
<p>Ikke almindelig bivirkning (kan forekomme hos op til 1 ud af 100 personer) 
- Angst </p>
...
4 uger. Eventuelt ubrugt lægemiddel, der opbevares ved stuetemperatur, skal kasseres  efter 4 uger. </p>
...
<ul>
<li>Aktivt stof: amikacin. Hvert hætteglas indeholder amikacinsulfat svarende til 590 mg amikacin i 
en liposomal formulering. Den gennemsnitlige leverede dosis pr. hætteglas er ca. 312 mg 
amikacin. </li>
<li>Øvrige indholdsstoffer: cholesterol, dipalmitoylphosphatidylcholin (DPPC), natriumchlorid, 
natriumhydroxid og vand til injektionsvæsker. </li>
</ul>
<p>Udseende og pakningsstørrelser 
ARIKAYCE liposomal er en hvid til off-white, mælkeagtig inhalationsvæske til nebulisator, 
dispersion i et 10 ml glas-hætteglas forseglet med en gummiprop og en metalforsegling med en 
aftrækningshætte. </p>
<p>De 28 hætteglas leveres i en pakning til 28 dages behandling, et hætteglas pr. dag. Én ARIKAYCE 
liposomal-pakning indeholder 4 indre pakninger, der hver indeholder 7 hætteglas og ét aerosolhoved. 
Pakningen til 28 dages behandling indeholder også én Lamira-forstøverenhed. </p>
...
<p>ARIKAYCE liposomal er til oral inhalation med Lamira Nebuliser System. 
Før du bruger dit Lamira Nebuliser System, skal du sørge for at læse og forstå den detaljede 
information i den fulde brugsanvisning, der følger med Lamira Nebuliser System. Denne vil give 
dig en mere fuldstændig information om, hvordan du samler, klargør, bruger, rengør og 
desinficerer dit Lamira Nebuliser System.  </p>
<p>Vask hænderne med vand og sæbe, og tør dem grundigt. </p>
<p>Saml enheden, herunder forbindelsen til styreenheden som illustreret i den fulde brugsanvisning. </p>
<p>Klargøring af medicinen til brug: </p>
<ol>
<li>
<p>Det anbefales, at hætteglasset tages ud af køleskabet mindst 45 minutter før brug, så det kan få 
mulighed for at opnå stuetemperatur. Du må ikke bruge andre lægemidler i Lamira-
forstøverenheden. </p>
</li>
<li>
<p>Ryst hætteglasset med ARIKAYCE liposomal kraftigt, indtil lægemidlet ser ensartet ud og 
fremstår godt blandet. </p>
</li>
<li>
<p>Løft den orange hætte af hætteglasset og læg den til side (Figur 1). </p>
</li>
</ol>
<p>Figur 1 </p>
<ol>
<li>Tag fat i metalringen oven på hætteglasset, og træk den forsigtigt ned, indtil den ene side 
brækker væk fra hætteglasset (Figur 2). </li>
</ol>
<p>Figur 2 </p>
<ol>
<li>Træk metalbåndet omkring hætteglassets top af i en cirkulær bevægelse, indtil det er 
fuldstændigt fri af hætteglasset (Figur 3). </li>
</ol>
<p>Figur 3 </p>
<ol>
<li>Læg metalringen til side, når den er frigjort. Fjern forsigtigt gummiproppen (Figur 4). </li>
</ol>
<p>Figur 4 </p>
<ol>
<li>Hæld indholdet af hætteglasset med ARIKAYCE liposomal i medicinbeholderen på Lamira-
forstøverenheden (Figur 5).  </li>
</ol>
<p>Figur 5 </p>
<ol>
...
<ol>
<li>
<p>Sid i en afslappet opretsiddende stilling. Dette gør inhaleringen lettere og hjælper med til, at 
medicinen når ned i lungerne.  </p>
</li>
<li>
<p>Sæt mundstykket i munden, og tag langsomme, dybe vejrtrækninger. Herefter skal du trække 
vejret normalt ind og ud gennem mundstykket, indtil din behandling er færdig. Behandlingen 
tager ca. 14 minutter, men kan tage op til 20 minutter. Sørg for at fastholde forstøverenheden i 
niveau gennem hele behandlingen (Figur 7). </p>
</li>
</ol>
<p>Figur 7 </p>
<p>BILAG IV </p>
...
<p>Under hensyntagen til PRAC's vurderingsrapport om PSUR'en/PSUR'erne for amikacin (kun centralt 
godkendt produkt) er CHMP nået frem til følgende videnskabelige konklusioner: </p>
<p>På baggrund af foreliggende data fra litteraturen om den øgede risiko for ototoksicitet hos patienter 
med bestemte mitokondrielle rRNA-mutationer og på baggrund af en plausibel virkningsmekanisme 
vurderer PRAC, at et kausalt sammenhæng mellem amikacin (kun centralt godkendt produkt) og en 
øget risiko for aminoglycosid-forbundet ototoksicitet hos patienter med mitokondrielle mutationer er 
mindst en rimelig sandsynlighed. PRAC konkluderede, at produktinformationen for produkter, der 
indeholder amikacin (kun centralt godkendt produkt), skal ændres i overensstemmelse hermed. </p>
...
<p>På baggrund af de videnskabelige konklusioner for amikacin (kun centralt godkendt produkt) er 
