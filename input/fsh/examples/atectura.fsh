...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Instructions for use of Atectura Breezhaler inhaler </p>  </div>"""   
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Atectura Breezhaler is and how it works 
Atectura Breezhaler contains two active substances called indacaterol and mometasone furoate. </p>
<p>Indacaterol belongs to a group of medicines called bronchodilators. It relaxes the muscles of the small 
airways in the lungs. This helps to open the airways and makes it easier for air to get in and out of the 
lungs. When it is taken regularly, it helps the small airways to remain open. </p>
...
<p>What Atectura Breezhaler is used for 
...
breath, wheezing, chest tightness and cough. </p>
<p>You should use Atectura Breezhaler every day and not only when you have breathing problems or 
...
<p>If you have any questions about how Atectura Breezhaler works or why this medicine has been 
...
<p>Do not use Atectura Breezhaler 
...
<p>During treatment with Atectura Breezhaler 
Stop using this medicine and get medical help immediately if you have any of the following:</p>
<ul>
<li>tightness of the chest, coughing, wheezing or breathlessness immediately after using Atectura 
...
group. </p>
<p>Other medicines and Atectura Breezhaler 
...
depression). </li>
<li>any medicines that may be similar to Atectura Breezhaler (contain similar active substances); 
...
<p>How much Atectura Breezhaler to inhale 
There are three different strengths of Atectura Breezhaler capsules. Your doctor will decide which is 
best for you. </p>
<p>The usual dose is to inhale the content of one capsule each day. You only need to use the medicine 
once a day. Do not use more than your doctor tells you to use. </p>
<p>You should use Atectura Breezhaler every day, even when your asthma is not troubling you. </p>
<p>When to inhale Atectura Breezhaler 
...
<p>How to inhale Atectura Breezhaler 
...
<p>If your pack contains a sensor for Atectura Breezhaler 
- The sensor for Atectura Breezhaler is for adult use only. It should not be used in adolescents 
(12 years of age and older) as the App does not have patient consent verification or caregiver 
...
- The electronic sensor for Atectura Breezhaler is to be attached to the base of the Atectura 
Breezhaler inhaler. 
- The sensor confirms that you have used the Atectura Breezhaler inhaler by recording and 
...
information on how to use the sensor for Atectura Breezhaler and the App. 
- After all Atectura Breezhaler capsules in a pack have been used, move the sensor to the new 
inhaler in the next Atectura Breezhaler pack. </p>
...
<p>If you forget to use Atectura Breezhaler 
...
<p>If you stop using Atectura Breezhaler 
...
Stop using Atectura Breezhaler and get medical help immediately if you have any of the following: </p>
...
- swelling mainly of the tongue, lips, face or throat (possible signs of angioedema). </p>
...
- sneezing, cough 
- headache 
- pain in muscles, bones or joints (signs of musculoskeletal pain) </p>
<p>Uncommon: may affect up to 1 in every 100 people 
- fast heart beat 
...
<li>If your pack contains an electronic sensor for Atectura Breezhaler, see the Instructions for Use 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Atectura Breezhaler contains 
- The active substances are indacaterol (as acetate) and mometasone furoate. </p>
<p>Atectura Breezhaler 125 micrograms/62.5 micrograms 
...
62.5 micrograms of mometasone furoate. </p>
<p>Atectura Breezhaler 125 micrograms/127.5 micrograms 
Each capsule contains 173 micrograms of indacaterol acetate (equivalent to 150 micrograms of 
indacaterol) and 160 micrograms of mometasone furoate. The delivered dose (the dose that 
leaves the mouthpiece of the inhaler) is equivalent to 125 micrograms of indacaterol and 
127.5 micrograms of mometasone furoate. </p>
<p>Atectura Breezhaler 125 micrograms/260 micrograms 
Each capsule contains 173 micrograms of indacaterol acetate (equivalent to 150 micrograms of 
...
<ul>
<li>The other ingredient is lactose monohydrate (see  Atectura Breezhaler contains lactose  in 
section 2). </li>
</ul>
<p>What Atectura Breezhaler looks like and content of the pack 
In this pack, you will find an inhaler together with capsules in blisters. Some packs also contain a 
sensor device. The capsules are transparent and contain a white powder. 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Brugsanvisning til Atectura Breezhaler inhalator </p>  </div>"""   
...
Atectura Breezhaler indeholder to aktive stoffer, der kaldes indacaterol og mometasonfuroat. </p>
...
<p>Anvendelse 
Atectura Breezhaler anvendes regelmæssigt som behandling ved astma hos voksne og unge (12 år og 
derover). </p>
...
<p>Du bør tage Atectura Breezhaler hver dag og ikke kun, når du har problemer med at trække vejret eller 
...
<p>Tal med lægen, hvis du har spørgsmål til, hvordan Atectura Breezhaler virker, eller hvorfor denne 
...
<p>Tag ikke Atectura Breezhaler 
- hvis du er allergisk over for indacaterol, mometasonfuroat eller et af de øvrige indholdsstoffer i 
Atectura Breezhaler (angivet i punkt 6). Rådfør dig med lægen, hvis du tror, at du kan være 
allergisk. </p>
<p>Advarsler og forsigtighedsregler 
Kontakt lægen, apotekspersonalet eller sygeplejersken, før du tager Atectura Breezhaler, hvis noget af 
...
<p>Under behandling med Atectura Breezhaler 
...
brugt Atectura Breezhaler (tegn på at lægemidlet mod forventning trækker luftvejene sammen, 
...
aldersgruppe. </p>
<p>Brug af anden medicin sammen med Atectura Breezhaler 
...
<li>lægemidler, der kan ligne Atectura Breezhaler (indeholder lignende aktive stoffer); tages de 
sammen med Atectura Breezhaler, kan der være større risiko for bivirkninger. </li>
...
<p>Så meget Atectura Breezhaler skal du inhalere 
Der findes tre forskellige styrker af Atectura Breezhaler kapsler. Lægen vil afgøre, hvilken styrke der 
er bedst til dig. </p>
...
<p>Du bør tage Atectura Breezhaler hver dag, også selvom din astma ikke generer dig. </p>
<p>Tidspunkt for inhalering af Atectura Breezhaler 
Inhaler Atectura Breezhaler på samme tidspunkt hver dag. Dette vil hjælpe med at styre dine 
symptomer igennem dagen og natten. Det vil også hjælpe dig med at huske at tage medicinen. </p>
<p>Sådan skal du inhalere Atectura Breezhaler 
...
<p>Hvis din pakning indeholder en sensor til Atectura Breezhaler 
- Sensoren til Atectura Breezhaler må kun bruges til voksne. Den bør ikke blive brugt til unge (i 
alderen 12 år eller derover), da appen ikke har mulighed for, at patienten kan give samtykke 
eller funktionalitet til en omsorgsperson-profil. 
...
- Den elektroniske sensor til Atectura Breezhaler, skal fastgøres på underdelen af 
Atectura Breezhaler inhalatoren. 
- Sensoren bekræfter, at du har brugt Atectura Breezhaler inhalatoren ved at registrere og 
...
oplysninger om, hvordan sensoren til Atectura Breezhaler og appen skal bruges. 
- Når alle Atectura Breezhaler-kapsler i en pakning er brugt, skal sensoren flyttes til den nye 
inhalator i den næste Atectura Breezhaler-pakning. </p>
...
Atectura Breezhaler, skal du tale med lægen. </p>
<p>Hvis du har taget for meget Atectura Breezhaler 
...
<p>Hvis du har glemt at tage Atectura Breezhaler 
...
<p>Hvis du holder op med at tage Atectura Breezhaler 
Du må ikke holde op med at tage Atectura Breezhaler, medmindre lægen siger, at du skal stoppe. Dine 
...
Stop med at tage Atectura Breezhaler, og søg lægehjælp øjeblikkeligt, hvis du oplever en af følgende 
tilstande: </p>
...
<li>Hvis din pakning indeholder en elektronisk sensor til Atectura Breezhaler, kan du finde 
nærmere oplysninger om, hvordan den skal opbevares, og hvornår den skal kasseres, i 
brugsanvisningen, der følger med sensor-pakningen. </li>
</ul> </div>"""      
...
<p>Atectura Breezhaler 125 mikrogram/62,5 mikrogram 
...
mometasonfuroat. </p>
<p>Atectura Breezhaler 125 mikrogram/127,5 mikrogram 
Hver kapsel indeholder 173 mikrogram indacaterolacetat (svarende til 150 mikrogram 
...
mometasonfuroat. </p>
<p>Atectura Breezhaler 125 mikrogram/260 mikrogram 
Hver kapsel indeholder 173 mikrogram indacaterolacetat (svarende til 150 mikrogram 
...
Novartis Pharma B.V. 
Tel: +31 88 04 52 Norge 
Novartis Norge AS 
Tlf: +47 23 05 20 Österreich 
Novartis Pharma GmbH 
Tel: +43 1 86 6Polska 
Novartis Poland Sp. z o.o. 
Tel.: +48 22 375 4België/Belgique/Belgien 
Novartis Pharma N.V. 
...
Tel: +49 2173 8955 4Eesti 
SIA Novartis Baltics Eesti 
filiaal Tel: +372 66 30 Ελλάδα 
Novartis (Hellas) A.E.B.E. Τηλ: 
+30 210 281 17 España 
Laboratorios Menarini, S.A. 
Tel: +34 93 462 88 France 
Novartis Pharma S.A.S. 
...
<p>Læs hele brugsanvisningen til Atectura Breezhaler inhalatoren før brug. Denne brugsanvisning 
kan også fås ved at scanne QR-koden eller besøge www.breezhaler-asthma.eu/atectura. </p>
...
<p>Trin 1e: 
Luk inhalatoren </p>
<p>Din Atectura Breezhaler inhalator-pakning 
indeholder: </p>
<ul>
<li>
<p>En Atectura Breezhaler inhalator </p>
</li>
<li>
<p>Et eller flere blisterkort, som hver indeholder 
10 Atectura Breezhaler kapsler til brug i 
inhalatoren. </p>
</li>
</ul>
