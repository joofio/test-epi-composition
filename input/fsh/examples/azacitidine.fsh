...
* subject = Reference(mp5896050c095891d33a9c824703cf15e5)
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Azacitidine betapharm is 
Azacitidine betapharm is an anti-cancer agent which belongs to a group of medicines called  anti-
metabolites . Azacitidine betapharm contains the active substance  azacitidine . </p>
<p>What Azacitidine betapharm is used for 
...
production. </p>
<p>How Azacitidine betapharm works 
Azacitidine betapharm works by preventing cancer cells from growing. Azacitidine becomes 
incorporated into the genetic material of cells (ribonucleic acid (RNA) and deoxyribonucleic acid 
(DNA)). It is thought to work by altering the way the cell turns genes on and off and also by 
interfering with the production of new RNA and DNA. These actions are thought to correct problems 
with the maturation and growth of young blood cells in the bone marrow that cause myelodysplastic 
disorders, and to kill cancerous cells in leukaemia. </p>
<p>Talk to your doctor or nurse if you have any questions about how Azacitidine betapharm works or why 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not use Azacitidine betapharm 
...
<p>Azacitidine betapharm can cause a serious immune reaction called  differentiation syndrome  (see 
section 4). </p>
<p>Blood test 
You will have blood tests before you begin treatment with Azacitidine betapharm and at the start of 
...
while taking Azacitidine betapharm and for 6 months after stopping treatment with Azacitidine 
betapharm. Tell your doctor straight away if you become pregnant during treatment. </p>
<p>Breast-feeding 
You should not breast-feed when using Azacitidine betapharm. It is not known if this medicine passes 
into human milk. </p>
<p>Fertility 
Men should not father a child while receiving treatment with Azacitidine betapharm. Men should use 
an effective method of contraception while taking Azacitidine betapharm and for 3 months after 
...
<ul>
<li>
<p>The recommended dose is 75 mg per m2 body surface area. Your doctor will decide your dose of 
this medicine, depending on your general condition, height and weight. Your doctor will check 
your progress and may change your dose if necessary. </p>
</li>
<li>
<p>Azacitidine betapharm is given every day for one week, followed by a rest period of 3 weeks. 
This  treatment cycle  will be repeated every 4 weeks. You will usually receive at least 
6 treatment cycles. </p>
</li>
</ul>
...
If the Azacitidine betapharm suspension is prepared using water for injections that has not been 
refrigerated, the suspension must be placed in the refrigerator (2  C to 8  C) immediately after it is 
prepared and kept refrigerated for up to a maximum of 8 hours. 
If the Azacitidine betapharm suspension is prepared using water for injections that has been stored in 
the refrigerator (2  C to 8  C), the suspension must be placed in the refrigerator (2  C to 8  C) 
immediately after it is prepared and kept refrigerated for up to a maximum of 22 hours. </p>
...
Instance: mp5896050c095891d33a9c824703cf15e5
InstanceOf: MedicinalProductDefinitionUvEpi
Title: "Medicinal Product Azacitidine betapharm 25 mg/mL powder for suspension for injection"
Description: "Azacitidine betapharm 25 mg/mL powder for suspension for injection"
Usage: #inline

 
* identifier[+].system = "http://ema.europa.eu/identifier"
* identifier[=].value = "EU/1/19/1416/001"
...
* indication = "Azacitidine betapharm is indicated for the treatment of adult patients who are not eligible for"
...
* name
  * productName = "Azacitidine betapharm 25 mg/mL powder for suspension for injection"
...
// MPD
* entry[+].fullUrl = "MedicinalProductDefinition/mp5896050c095891d33a9c824703cf15e5"
* entry[=].resource = mp5896050c095891d33a9c824703cf15e5
