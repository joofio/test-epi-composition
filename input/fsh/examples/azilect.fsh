...
* subject = Reference(mp156b61ce1985095bf62d895909c686c6)
...
<ol>
<li>What AZILECT is and what it is used for </li>
<li>What you need to know before you take AZILECT </li>
<li>How to take AZILECT </li>
<li>Possible side effects </li>
<li>How to store AZILECT </li>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>AZILECT contains the active substance rasagiline and it is used for the treatment of Parkinson s 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not take AZILECT 
...
<p>Do not take the following medicines while taking AZILECT:</p>
<ul>
...
with AZILECT may possibly increase the risk of skin cancer. </p>
...
or stop your dose (see section 4). </p>
<p>AZILECT may cause drowsiness and may cause you to suddenly fall asleep during day 
...
The use of AZILECT together with the antidepressants containing fluoxetine or fluvoxamine should 
be avoided. 
...
<p>You should avoid taking AZILECT if you are pregnant, as the effects of AZILECT on pregnancy and 
the unborn child are not known. </p>
...
<p>The recommended dose of AZILECT is 1 tablet of 1 mg taken by mouth once daily. AZILECT may 
be taken with or without food.  </p>
<p>If you take more AZILECT than you should 
If you think that you may have taken too many AZILECT tablets, contact your doctor or pharmacist 
immediately. Take the AZILECT carton/ blister or bottle with you to show the doctor or pharmacist. </p>
<p>Symptoms reported following overdose of AZILECT included slightly euphoric mood (light form of 
mania), extremely high blood pressure and serotonin syndrome (see section 4). </p>
<p>If you forget to take AZILECT 
...
<ul>
<li>If you develop unusual behaviours such as compulsions, obsessive thoughts, addictive 
gambling, excessive shopping or spending, impulsive behaviour and an abnormally high sex 
drive or an increase in sexual thoughts (impulse control disorders) (see section 2). </li>
...
<p>Contact your doctor if you notice any suspicious skin changes because there may be an increased 
risk of skin cancer (melanoma) with the use of this medicine (see section 2). </p>
...
<li>Numbness and muscle weakness of the hand (carpal tunnel syndrome) </li>
