...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Bemrist Breezhaler is and how it works 
Bemrist Breezhaler contains two active substances called indacaterol and mometasone furoate. </p>
...
<p>What Bemrist Breezhaler is used for 
Bemrist Breezhaler is used regularly as treatment for asthma in adults and adolescents (12 years of age 
and older). </p>
...
<p>You should use Bemrist Breezhaler every day and not only when you have breathing problems or 
...
<p>How much Bemrist Breezhaler to inhale 
There are three different strengths of Bemrist Breezhaler capsules. Your doctor will decide which is 
best for you. </p>
...
<p>You should use Bemrist Breezhaler every day, even when your asthma is not troubling you. </p>
<p>When to inhale Bemrist Breezhaler 
Inhale Bemrist Breezhaler at the same time each day. This will help control your symptoms 
throughout the day and night. It will also help you to remember to use it. </p>
<p>How to inhale Bemrist Breezhaler 
...
If your asthma is not getting better or if it gets worse after you have started using Bemrist Breezhaler, 
talk to your doctor. </p>
<p>If you use more Bemrist Breezhaler than you should 
...
<p>If you forget to use Bemrist Breezhaler 
...
Stop using Bemrist Breezhaler and get medical help immediately if you have any of the following: </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Bemrist Breezhaler contains 
- The active substances are indacaterol (as acetate) and mometasone furoate. </p>
<p>Bemrist Breezhaler 125 micrograms/62.5 micrograms 
...
<p>Bemrist Breezhaler 125 micrograms/127.5 micrograms 
Each capsule contains 173 micrograms of indacaterol acetate (equivalent to 150 micrograms of 
...
<p>Bemrist Breezhaler 125 micrograms/260 micrograms 
Each capsule contains 173 micrograms of indacaterol acetate (equivalent to 150 micrograms of 
