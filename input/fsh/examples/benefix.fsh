...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>BeneFIX is an injectable clotting (coagulation) factor IX product that is produced by recombinant 
DNA technology. The active ingredient in BeneFIX is nonacog alfa. People who are born with 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <h2>Do not take BeneFIX</h2>
<p>if you are allergic to nonacog alfa or any of the other ingredients of this medicine (listed in 
section 6).
-
...
-
Allergic reactions are possible. The product may contain traces of hamster proteins (see Do not 
take BeneFIX). Potentially life-threatening anaphylactic reactions (severe allergic reactions)
have occurred with factor IX products, including BeneFIX. Early signs of allergic reactions 
include difficulty breathing, shortness of breath, swelling, hives, itching, generalised urticaria, 
tightness of the chest, wheezing, low blood pressure, blurred vision and anaphylaxis (severe 
allergic reaction that can cause difficulty in swallowing and/or breathing, red or swollen face 
and/or hands). 
-
If allergic or anaphylactic-type reactions occur, stop the infusion immediately and contact a 
doctor or seek emergency medical care immediately. In case of severe allergic reactions, 
alternative therapy should be considered. 
-
Activity-neutralizing antibodies (inhibitors) are an uncommon event in patients who have 
received previous treatment with factor IX-containing products. However, as with all factor IX 
products you should be carefully monitored for the development of factor IX inhibitors while 
being treated with BeneFIX. 
-
Research has shown a link between the occurrence of a factor IX inhibitor and allergic 
reactions. Therefore, if you experience allergic reactions such as those described above, you 
should be tested for the presence of an inhibitor. It should be noted that patients with a factor 
IX inhibitor may be at an increased risk of anaphylaxis during future treatment with BeneFIX.
-
The production of factor IX in the body is controlled by the factor IX gene. Patients who have 
specific mutations of their factor IX gene such as major deletion may be more likely to develop 
an inhibitor to factor IX and/or experience allergic reactions. Therefore if you are known to 
have such a mutation your doctor may monitor you more closely for signs of an allergic 
reaction particularly when you first start to take BeneFIX.
-
Because of the risk of allergic reactions with factor IX, your initial administrations of BeneFIX
should be performed under medical observation where proper medical care for allergic 
reactions can be provided.
-
Even in the absence of factor IX inhibitor, higher doses of BeneFIX may be needed than 
required for other plasma-derived factor IX products that you may have taken previously. 
Therefore, close monitoring of factor IX plasma activity (which measures the ability of your 
blood to form clots) has to be performed to adjust doses as appropriate. If bleeding is not 
controlled with the recommended dose, contact your doctor.
-
If you suffer from liver or heart disease or if you have recently had surgery, there is an 
increased risk for blood clotting (coagulation) complications.
-
A kidney disorder (nephrotic syndrome) has been reported following high doses of 
plasma-derived factor IX in haemophilia B patients with factor IX inhibitors and a history of 
allergic reactions.
-
Sufficient data have not been obtained from clinical studies on the treatment of previously 
untreated patients (patients who have never received a previous infusion of factor IX), with 
BeneFIX.
-
It is recommended that evey time you use BeneFIX, you record the name and batch number of 
the product. You can use one of the peel-off labels found on the vial to document the batch 
...
should only take BeneFIX upon specific instructions from your doctor. It is not known whether 
BeneFIX can cause harm to an unborn baby when given to pregnant women. Your doctor may advise 
you to stop treatment with BeneFIX if you are breast-feeding or become pregnant.
...
Your doctor will decide the dose of BeneFIX you will receive. This dose and duration will depend 
upon your individual needs for replacement factor IX therapy and how quickly your body uses up 
factor IX, which will be checked regularly. You may notice a difference in the dose you receive if you 
are changing from a plasma-derived factor IX product to BeneFIX.
Your doctor may decide to change the dose of BeneFIX you receive during your treatment.
Reconstitution and administration 
The procedures below are provided as guidelines for the reconstitution and administration of 
BeneFIX. Patients should follow the specific venipuncture procedures provided by their doctor.
BeneFIX is administered by intravenous (IV) infusion after reconstitution of the powder for injection 
with the supplied solvent (a sodium chloride (salt) solution) in the pre-filled syringe.
Always wash your hands prior to performing the following procedures. Aseptic technique (meaning 
clean and germ free) should be used during the reconstitution procedure.
Reconstitution:
BeneFIX will be administered by intravenous infusion (IV) after reconstitution with sterile solvent for 
injection.
1. Allow the vial of lyophilised (freeze-dried) BeneFIX and the pre-filled syringe to reach room 
temperature.
2. Remove the plastic flip-top cap from the BeneFIX vial to expose the central portion of the
rubber stopper.
3. Wipe the top of the vial with an alcohol swab provided, or use another antiseptic solution and 
allow to dry. After cleaning do not touch the rubber stopper with your hand or allow it to touch 
any surface.
4. Peel back the lid from the clear plastic vial adapter package. Do not remove the adapter from 
the package.
5. Place the vial on a flat surface. While holding the adapter in the package, place the vial adapter 
over the vial. Press down firmly on the package until the adapter snaps into place on top of the 
vial, with the adapter spike penetrating the vial stopper.
...
8. Break off the tamper-resistant plastic tip cap from the solvent syringe by snapping the 
...
(if not administering reconstituted BeneFIX immediately), so set it aside by placing it on its 
top.
9. Place the vial on a flat surface. Connect the solvent syringe to the vial adapter by inserting the 
...
11. With the syringe still connected to the adapter, gently rotate the vial until the powder is
dissolved.
12. The final solution should be inspected visually for fine particles before administration. The 
solution should appear clear and colourless.
Note: If you use more than one vial of BeneFIX per infusion, each vial should be reconstituted 
as per the previous instructions. The solvent syringe should be removed, leaving the vial 
adapter in place, and a separate large luer lock (a device that connects the syringe to the vial) 
syringe may be used to draw back the reconstituted contents of each individual vial.
13. Ensuring that the syringe plunger rod is still fully depressed, invert the vial. Slowly draw back 
all the solution into the syringe.
14. Detach the syringe from the vial adapter by gently pulling and turning the syringe 
counter-clockwise. Discard the vial with the adapter attached.
...
BeneFIX should be administered immediately or within 3 hours after reconstitution. The reconstituted 
solution may be stored at room temperature prior to administration.
Administration (Intravenous Injection):
BeneFIX should be administered using the pre-filled solvent syringe provided or a single sterile 
disposable plastic luer lock syringe. In addition, the solution should be withdrawn from the vial using 
the vial adapter.
BeneFIX should be injected intravenously over several minutes. Your doctor may change your
recommended infusion rate to make the infusion more comfortable.
There have been reports of clumping (agglutination) of red blood cells in the tube/syringe with the
administration of BeneFIX. No side effects have been reported in association with this observation. 
To minimize the possibility of agglutination, it is important to limit the amount of blood entering the 
tubing. Blood should not enter the syringe. If clumping of red blood cells in the tubing/syringe is
observed, discard all this material (tubing, syringe and BeneFIX solution) and resume administration 
with a new package.
Because the use of BeneFIX by continuous infusion (drip) has not been evaluated, BeneFIX should 
not be mixed with infusion solutions or be given in a drip.
Please dispose of all unused solution, empty vials and used needles and syringes in an appropriate 
container for throwing away waste as it may hurt others if not handled properly.
...
Allergic-type hypersensitivity reactions are possible with BeneFIX. Such reactions may include 
swelling of the face or throat, burning and stinging at the infusion site, chills, flushing, itching,
headache, hives, low blood pressure, lethargy, nausea, restlessness, fast heart rate, tightness of the 
chest, tingling, vomiting, wheezing). In some cases, these reactions have progressed to severe 
anaphylaxis. Allergic reactions may occur together with the development of factor IX inhibitor (see 
also  Warnings and precautions ).
These reactions are potentially life-threatening. If allergic/anaphylactic reactions occur, stop the 
infusion immediately and contact your doctor or seek emergency medical care immediately. The 
treatment required depends on the nature and severity of side-effects (see also  Warnings and
precautions ). 
Inhibitor development
Patients with haemophilia B may develop neutralising antibodies (inhibitors) to factor IX. If such
inhibitors occur, a sign may be an increase in the amount of BeneFIX typically required to treat a
bleed and or continued bleeding after treatment. In such cases, it is recommended that a specialised 
haemophilia centre be contacted. Your doctor may want to monitor you for inhibitor development 
(see  Warnings and precautions ).
A kidney disorder has been reported following high doses of plasma-derived factor IX to induce 
immune tolerance in haemophilia B patients with factor IX inhibitors and a history of allergic 
reactions (see also  Warnings and precautions ).
Thrombotic events
BeneFIX may increase the risk of thrombosis (abnormal blood clots) in your body if you have risk 
factors for developing blood clots, including an indwelling venous catheter. There have been reports 
of severe blood clotting events, including life-threatening blood clots in critically ill babies, while 
receiving continuous-infusion BeneFIX through a central venous catheter. Cases of peripheral
thrombophlebitis (pain and redness of the veins) and deep venous thrombosis (blood clots in the 
extremities) have also been reported; in most of these cases, BeneFIX was administered via
continuous infusion, which is not an approved method of administration. 
...
<p>Infusion-site reaction (including itching and redness at the infusion site), infusion-site pain 
and discomfort
...
<p>Vision impairment (including blurred vision, appearance of spots/lights)</p>
<p>Fast heart rate, low blood pressure</p>
<p>Renal infarct (interruption to the blood supply to the kidney)
Side effects with unknown frequency (frequency cannot be estimated from the available data)</p>
<p>Anaphylactic reaction</p>
<p>Thrombotic events (abnormal blood clots)</p>
<p>Lack of response to treatment (failure to stop or prevent bleeding episodes)
...
Do not use this medicine after the expiry date which is stated on the outer box and vial label. The 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <h2>What BeneFIX contains</h2>
<p>The active substance is nonacog alfa (recombinant coagulation factor IX). Each vial of 
BeneFIX contains nominally 250, 500, 1000, 1500, 2000 or 3000 IU of nonacog alfa.
-
The other ingredients are sucrose, glycine, L-histidine, polysorbate 80. A solvent (0.234% 
sodium chloride solution) is also supplied for reconstitution.
-
After reconstitution with the supplied solvent (0.234% sodium chloride solution), each vial 
contains 50, 100, 200, 300, 400 or 600 IU/ml (see Table 1).
Table 1. Strength of BeneFIX per ml prepared solution
Amount of BeneFIX per Vial 
Amount of BeneFIX per 1 ml 
of prepared solution for 
injection
250 IU
50 IU
500 IU
...
BeneFIX is provided as a powder for injection in a glass vial and a solvent provided in pre-filled 
syringe.
The contents of the pack are:</p>
<p>one vial of BeneFIX 250, 500, 1000, 1500, 2000 or 3000 IU powder</p>
<p>one pre-filled syringe of solvent, 5 ml sterile 0.234% sodium chloride solution for injection for
reconstitution, with one plunger rod</p>
...
2. Det skal du vide, før du begynder at tage BeneFIX
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>BeneFIX er et koagulationsfaktor IX produkt til indsprøjtning, der er fremstillet ved rekombinant 
DNA-teknologi. Det aktive stof i BeneFIX er nonacog alfa. Personer, der er født med hæmofili B 
(Christmas sygdom) mangler tilstrækkelig med koagulationsfaktor IX til at kunne stoppe blødning. 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Tag ikke BeneFIX

hvis du er allergisk over for nonacog alfa eller et af de øvrige indholdsstoffer i BeneFIX 
(angivet i punkt 6).

hvis du er allergisk over for hamsterproteiner.
Advarsler og forsigtighedsregler

Kontakt lægen eller apotekspersonalet, før du tager BeneFIX.

Kontakt straks din læge, hvis dine blødninger ikke stopper som forventet. 
25

Allergiske reaktioner er mulige. Produktet kan indeholde spor af hamsterproteiner (se afsnittet 
Tag ikke BeneFIX). Potentielt livstruende anafylaktiske reaktioner (alvorlige allergiske 
reaktioner) er set med faktor IX-produkter, inklusive BeneFIX. Tidlige tegn på 
overfølsomhedsreaktioner omfatter besværet vejrtrækning, kortåndethed, hævelse, nældefeber, 
kløe, nældefeber over hele kroppen, trykken for brystet, hiven efter vejret, for lavt blodtryk, 
sløret syn og anafylaksi (alvorlig allergisk reaktion, som kan medføre besvær med at synke 
og/eller trække vejret, rødt eller opsvulmet ansigt og/eller hænder).<br />

Hvis allergiske eller anafylaktiske reaktioner indtræffer, skal indgivelsen straks stoppes og du 
skal straks kontakte en læge eller skadestuen. I tilfælde af alvorlige allergiske reaktioner bør 
alternativ behandling overvejes.

Aktivitets-neutraliserende antistoffer (inhibitorer) er en ikke almindelig hændelse hos tidligere 
behandlede patienter, som behandles med produkter, der indeholder faktor IX, men som for alle 
faktor IX-produkter skal du under behandling med BeneFIX omhyggeligt overvåges for 
udviklingen af faktor IX-inhibitorer.

Der har været rapporter i litteraturen, som viser en sammenhæng mellem forekomsten af faktor 
IX-inhibitor og allergiske reaktioner. Hvis du derfor fornemmer allergiske reaktioner, som dem 
beskrevet ovenfor, bør du undersøges for tilstedeværelse af en inhibitor. Det bør bemærkes, at 
patienter med faktor IX-inhibitor kan have øget risiko for anafylaksi ved efterfølgende 
behandling med BeneFIX. 

Dannelsen af faktor IX i kroppen kontrolleres af faktor IX genet. Patienter, der har specifikke
mutationer i deres faktor IX-gen, f.eks. omfattende deletionsmutationer, kan have større 
sandsynlighed for at udvikle en hæmmer af faktor IX og/eller få allergiske reaktioner. Derfor, 
hvis du ved, at du har en sådan mutation, kan din læge overvåge dig nøje for tegn på allergiske 
reaktioner, især når du begynder at tage BeneFIX for første gang.

På grund af risikoen for allergiske reaktioner med faktor IX, skal dine første indsprøjtninger af 
faktor IX udføres under medicinsk overvågning, hvor der kan ydes medicinsk behandling af 
allergiske reaktioner på forsvarlig vis.

Selv når faktor IX inhibitor ikke er til stede, kan det være nødvendigt med højere doser af 
BeneFIX end krævet for andre plasmabaserede faktor IX-produkter, som du måtte have fået 
tidligere. Derfor skal faktor IX-plasmaaktiviteten (som måler dit blods evne til at størkne) 
undersøges omhyggeligt for at justere doserne passende. Kontakt din læge, hvis blødning ikke 
er under kontrol med den anbefalede dosis.

Hvis du lider af en lever- eller hjertesygdom, eller hvis du fornylig er blevet opereret, er der en 
øget risiko for problemer med at få blodet til at størkne (koagulationskomplikationer).

En sygdom i nyrerne (nefrotisk syndrom) har været rapporteret efter høje doser af plasma-
fremstillet faktor IX hos hæmofili B patienter med faktor IX-inhibitorer og som tidligere har 
oplevet allergiske reaktioner.

Der er ikke tilstrækkelige oplysninger fra kliniske studier om behandling af tidligere 
ubehandlede patienter (patienter, som aldrig har fået indsprøjtet faktor IX) med BeneFIX. 

Det anbefales, at du noterer navn og batchnummer på lægemidlet, hver gang du tager BeneFIX. 
Du kan bruge en af de aftagelige etiketter, der sidder på hætteglasset, til at dokumentere 
batchnummeret i din kalender eller i en indberetning af eventuelle bivirkninger.
26
...
du kun tage BeneFIX hvis din læge har sagt det til dig. Det vides ikke, om BeneFIX kan skade 
fosteret, når det gives til gravide kvinder. Din læge kan råde dig til at stoppe behandlingen med 
BeneFIX, hvis du ammer eller bliver gravid.
...
Din læge bestemmer hvilken dosis af BeneFIX du vil få. Denne dosis og hvor længe, du skal have den, 
vil afhænge af dine individuelle behov for tilførsel af faktor IX og hvor hurtigt, din krop bruger faktor 
IX, hvilket skal undersøges jævnligt. Du vil eventuelt bemærke en forskel i den dosis, du får, hvis du 
skifter fra et plasmaderiveret faktor IX produkt til BeneFIX.
...
Patienterne bør følge den specifikke vejledning for venepunktur, som er foreskrevet af lægen.
BeneFIX gives som en intravenøs infusion efter opløsning af pulver til injektionsvæske, opløsning 
med det medfølgende opløsningsmiddel (en natriumchloridopløsning) i den fyldte sprøjte.
Vask altid hænder, før du udfører følgende fremgangsmåde. Aseptisk teknik (det vil sige rent og 
kimfrit) skal anvendes under hele opblandingsprocessen.
Opblanding:
...
3. Aftør toppen på hætteglasset med en de medfølgende alkoholkompresser eller anvend en anden 
antiseptisk opløsning og lad dem tørre. Efter rensning må du ikke røre gummiproppen med 
...
5. Placér hætteglasset på en plan overflade. Mens du holder adapteræsken, sættes adapteren over 
hætteglasset. Tryk hårdt ned på æsken, indtil adapteren klikker på plads oven på hætteglasset, 
idet adapterspidsen trænger igennem hætteglassets prop.
...
8. Fjern sikkerhedsplastikkappen på sprøjten med opløsningsmiddel ved at brække perforeringen 
på kappen. Dette gøres ved at bøje den op og ned, indtil perforeringen brækker. Rør ikke den 
indvendige side af kappen eller sprøjtespidsen. Kappen skal måske sættes på igen (hvis ikke den 
færdige opløsning af BeneFIX skal bruges straks), så sæt den til side ved at placere den på 
toppen.
28
9. Placér hætteglasset på en plan overflade. Sæt sprøjten med opløsningsmiddel sammen med 
adapteren ved at sætte spidsen af sprøjten ind i adapteråbningen, mens du med fast hånd 
skubber og drejer sprøjten med uret, indtil den sidder fast.
10. Tryk langsomt stempelstangen ned for at sprøjte al opløsningsmidlet ned i BeneFIX-
hætteglasset.
11. Lad sprøjten sidde sammen med adapteren mens hætteglasset forsigtigt roteres, indtil pulveret er 
opløst.
12. Den færdige opløsning undersøges visuelt for små partikler inden indgivelse. Opløsningen skal 
være klar og farveløs.
Bemærk: Hvis du anvender mere end et hætteglas BeneFIX per indsprøjtning, skal hvert 
hætteglas tilberedes ifølge ovenstående instruktioner. Sprøjten med opløsningsmiddel skal 
fjernes, så adapteren til hætteglasset er på plads, og en separat stor luer-locksprøjte (som 
forbinder sprøjten med hætteglasset) kan bruges til at trække det færdige indhold fra hvert 
hætteglas op.
13. Vær sikker på at sprøjtens stempelstang er trykket helt i bund, og vend hætteglasset. Træk 
langsomt hele opløsningen tilbage i sprøjten.
14. Tag sprøjten af adapteren ved forsigtigt at trække og dreje sprøjten mod uret. Smid hætteglasset 
med adapteren væk.
...
29
BeneFIX skal indgives straks efter opløsning eller i løbet af 3 timer. Den færdige opløsning kan 
opbevares ved stuetemperatur indtil indgivelse.
Indgivelse (intravenøs indsprøjtning):
BeneFIX skal indgives ved anvendelse af den medfølgende fyldte sprøjte eller en steril luer-lock-
engangssprøjte af plastik. Endvidere skal opløsningen trækkes ud af hætteglasset ved anvendelse af 
hætteglasadapteren.
BeneFIX skal indsprøjtes intravenøst over adskillige minutter. Din læge kan eventuelt ændre den 
anbefalede indsprøjtningshastighed for at gøre indsprøjtningen mere behagelig.
Der har været rapporter om sammenklumpning af røde blodceller i slangen/sprøjten ved indgivelse af 
BeneFIX. Indtil videre har der ikke været rapporteret bivirkninger i forbindelse med denne iagttagelse. 
For at mindske risikoen for sammenklumpning er det vigtigt at begrænse mængden af blod, der 
kommer ind i slangen. Der må ikke komme blod i sprøjten. Hvis der observeres sammenklumpning af 
røde blodceller i slangen ellersprøjten, kasseres alt dette materiale (slange, sprøjte og BeneFIX-
injektionsvæske), og der fortsættes med indgivelse af en ny pakning.
Da anvendelsen af BeneFIX ved vedvarende infusioner (drop) ikke har været undersøgt, bør BeneFIX 
ikke blandes i infusionsvæsker eller gives i drop.
Bortskaf al ikke anvendt injektionsvæske, tomme hætteglas og anvendte kanyler og sprøjter på 
forsvarlig vis. Det kan skade andre, hvis det ikke håndteres korrekt.
...
Allergiske overfølsomhedsreaktioner er mulige med BeneFIX. Reaktionerne kan omfatte hævelse i 
ansigtet eller halsen, brænden og svien på infusionsstedet, kuldegysninger, ansigtsrødme, kløe, 
...
indberetninger om alvorlige tilfælde af blodpropper, herunder livstruende blodpropper hos kritisk syge 
nyfødte børn, som fik kontinuerlig infusion af BeneFIX gennem et centralt venekateter. Tilfælde af 
årebetændelse (smerter og rødme af blodårene) med dannelse af blodprop og blodpropper i 
dybtliggende vener (oftest i benene) er også blevet indberettet. I de fleste af disse tilfælde blev 
BeneFIX indgivet ved kontinuerlig infusion, hvilket ikke er en godkendt indgivelsesmåde.
...

Reaktioner på injektionsstedet (inklusive kløe og rødme på infusionsstedet), smerter og ubehag 
på infusionsstedet
...
Bivirkninger, hvis hyppighed ikke er kendt (hyppigheden  kan ikke beregnes ud fra tilgængelige 
data):

...
BeneFIX skal opbevares ved temperaturer under 30C, og det skal anvendes før udløbsdatoen på 
etiketten. 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>BeneFIX indeholder:

Aktivt stof: Nonacog alfa (rekombinant koagulationsfaktor IX). Hvert hætteglas indeholder 
nominelt 250, 500, 1000, 1500, 2000 eller 3000 IE nonacog alfa.

Øvrige indholdsstoffer: Saccharose, glycin, L-histidin, polysorbat 80. Opløsningsmiddel 
(0,234% natriumchlorid) medfølger også til brug ved opløsning.

Efter opløsning i det medfølgende opløsningsmiddel (0,234% natriumchlorid) indeholder hvert 
hætteglas 50, 100, 200, 300, 400 eller 600 IE/ml (se tabel 1).
Tabel 1. BeneFIX’s styrke pr. ml færdig opløsning
Mængde BeneFIX per hætteglas
Mængde BeneFIX per ml 
færdig opløsning til 
indsprøjtning
250 IE
50 IE
500 IE
...
32

en fyldt sprøjte med stempelstang og opløsningsmiddel, 5 ml steril 0,234% 
