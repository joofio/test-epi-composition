...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not use Beromun 
- if you are allergic to tasonermin or any of the other ingredients of this medicine (listed in 
section 6). 
...
- if you cannot use vasopressors (used to increase low blood pressure), anticoagulants (used to 
prevent blood clotting) or radioactive tracers 
- if you are also using medicines with heart toxicity<br />
- if you have raised levels of calcium in your blood 
- if you have certain infections which do not respond to antibiotics 
- if you have severe swelling of the affected arm or leg due to local fluid build-up, or severe fluid 
build-up in the abdomen 
- if you are pregnant or planning to become pregnant. 
- if you are breast-feeding, you must stop for at least seven days after receiving Beromun </p>
<p>Warnings and precautions<br />
Beromun will be administered by a doctor who is experienced and skilled in isolated limb perfusion 
(ILP). This technique ensures that Beromun is kept within the affected arm or leg. It is important that 
it does not reach other parts of your body, because this so-called systemic leakage could cause serious 
side effects on the main organs of the body.  </p>
...
<p>Other medicines and Beromun 
Tell your doctor if you are using,  have recently used or might use any other medicines. In particular, 
you should tell your doctor if you are using medicines to lower blood pressure (to treat hypertension). </p>
<p>For ILP, you will also receive other medicines to control pain, fever, blood pressure and blood 
clotting, as well as general anaesthesia. </p>
<p>Pregnancy and breast-feeding 
You must not use Beromun if you are pregnant. 
You must not breast-feed for at least seven days after treatment with Beromun. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Beromun will be administered by isolated limb perfusion (ILP), together with the anti-tumour agent 
melphalan. This will occur whilst you are unconscious, under the influence of a general anaesthetic. </p>
<p>The blood flow to and from your affected limb will be stopped using a tourniquet. Blood, supplied 
with oxygen by a heart and lung machine, is pumped into your affected limb via a catheter in the main 
artery, while it is drained (pumped out) from the main vein. Beromun and then melphalan are injected 
into this circuit, over a total of 90 minutes the affected limb will be exposed to Beromun. </p>
<p>The recommended dose of Beromun depends on the affected limb, usually 3 mg for the arm and 4 mg 
for the leg. Beromun powder has to be dissolved before use. The resulting solution will be 
administered into an artery in your affected arm or leg by ILP for an initial period of 30 minutes.<br />
After that, melphalan will be added and the ILP continued for another 60 minutes.<br />
Finally, your limb will be washed out to remove the rest of Beromun and melphalan. </p>
<p>ILP allows that tumour cells in your limb can be exposed to a very high dose of Beromun and 
melphalan, enhancing their anti-tumour effect, but without reaching the rest of the body, where they 
could cause serious side effects.  </p>
<p>You will usually not receive a second ILP with Beromun. If you do, this will not be until at least six 
weeks after your first ILP. </p>
<p>If you use more Beromun than you should 
As Beromun is always administered by experienced and qualified hospital doctors, accidental 
overdose is extremely unlikely. However, should this occur, your doctor will immediately wash out 
your affected limb to remove Beromun, and the ILP will be stopped. If there is any risk of serious side 
effects, your doctor will immediately transfer you to an intensive care unit to closely monitor you and 
start adequate treatment. </p>
...
<p>Side effects may be caused by Beromun, melphalan, the ILP technique or a combination of these 
factors. Some of the side effects can be serious, particularly if Beromun reaches other parts of your 
body (systemic leakage). In approximately 2% of cases, Beromun may cause tissue damage in your 
affected arm or leg which is severe enough to require amputation. If there is any risk of serious side 
effects, your doctor will immediately transfer you to an intensive care unit to closely monitor you and 
start adequate treatment. </p>
<p>The following side effects were observed during treatment with this medicine (grouped by how likely 
they are to happen). </p>
...
- protein in urine 
- night sweats 
- tissue necrosis (death of tissue cells) in the affected arm or leg, which is severe enough to 
require amputation </p>
<p>Uncommon (may affect up to 1 in 100 people) 
- blood poisoning (sepsis) 
- fluid in the lungs 
- stomach ache 
- inflammation of the gastric mucosa (gastritis)<br />
...
- narrowing or closing of limb vessels carrying blood from the heart </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Beromun contains 
- The active substance is tasonermin. Each vial contains 1 mg tasonermin. The content of one vial 
of Beromun powder should be reconstituted with 5.3 ml sterile 0.9% sodium chloride solution 
for injection<br />
- The other ingredients (excipient(s)) are sodium dihydrogen phosphate dihydrate, disodium 
phosphate dodecahydrate and human serum albumin. </p>
<p>What Beromun looks like and contents of the pack 
Beromun is a white to off-white powder for solution for infusion (powder for infusion) supplied in a 
glass vial with rubber stopper and sealed with aluminium flip-off cap. 
Each pack contains 4 vials of powder. </p>
...
immunstimulanter. Disse hjælper dit immunsystem med at bekæmpe kræftceller. </p>
...
<ul>
<li>hvis du er allergisk over for tasonermin eller et af de øvrige indholdsstoffer i Beromun (angivet 
i punkt 6) </li>
...
<li>hvis antallet af blodlegemer er for lav eller der er andre blødningsproblemer </li>
<li>hvis du lider af lever- eller nyresygdomme i moderat til svær grad </li>
<li>hvis du ikke må tage lægemidler mod for lavt blodtryk (karkontraherende medicin), 
antikoagulanter (lægemidler, der bruges til at forhindre blodstørkning) eller radioaktive 
sporstoffer </li>
<li>hvis du samtidig behandles med lægemidler, som påvirker hjertet toksisk (f.eks. antracykliner) </li>
<li>hvis du har en forhøjet koncentration af kalcium i blodet </li>
<li>hvis du lider af infektioner, som ikke reagerer på behandling med antibiotika </li>
<li>hvis dures syge arm eller ben er hævet på grund af lokal væskeansamling, eller du har en svær 
væskeansamling i bughulen </li>
<li>hvis du er gravid eller planlægger at blive gravid  </li>
<li>Du må ikke amme i mindst 7 dage efter Beromun-behandlingen 
Advarsler og forsigtighedsregler 
Beromun vil blive givet af en læge, som har viden og erfaring i isoleret ekstremitetsperfusion (ILP).<br />
Denne teknik sørger for, at Beromun forbliver i den syge arm eller det syge ben. Det er vigtigt, at 
stoffet ikke kommer ud i andre dele af kroppen, da denne såkaldte systemiske lækage kan give 
alvorlige bivirkninger i kroppens organer. </li>
</ul>
...
<p>Brug af anden medicin sammen med Beromun 
Fortæl det altid til lægen, hvis du bruger anden medicin eller har gjort det for nylig. Det gælder især, 
hvis du tager medicin, der sænker blodtrykket. </p>
<p>Ved behandlingen med ILP vil du også få lægemidler, der virker på smerter, feber, blodtryk og 
blodets størkningsevne, og du vil komme i fuld bedøvelse. </p>
<p>Graviditet og amning 
Du må ikke få Beromun, hvis du er gravid.<br />
Du må ikke amme i mindst 7 dage efter behandling med Beromun. </p>
<p>Trafik- og arbejdssikkerhed 
Ikke relevant. </p>
<p>Beromun indeholder natrium 
...
<p>Blodforsyningen fra og til den syge arm/det sygeben vil blive standset ved hjælp af en årepresse. 
...
<p>Herefter indgives også melfalan, og ILP-behandlingen vil fortsætte i yderligere 60 minutter.  </p>
<p>Behandlingen afsluttes med, at arm eller ben skylles igennem for at fjerne rester af Beromun og 
melfalan i årerne.  </p>
<p>ILP-teknikken gør, at tumorcellerne i armen eller benet kan udsættes for en meget høj dosis Beromun 
og melfalan, hvilket øger deres anti-tumor-virkning, og det på en sådan måde, at stofferne ikke 
kommer ud i resten af kroppen, hvor de kunne forårsage alvorlige bivirkninger.   </p>
<p>Sædvanligvis får man kun én behandling med ILP. Hvis du skal behandles mere end én gang, går der 
mindst 6 uger fra din første ILP-behandling. </p>
<p>Hvis du har brugt for meget Beromun 
...
påbegyndelse af en passende behandling. </p>
...
starte passende behandling. </p>
<p>Følgende bivirkninger blev observeret under behandlingen med denne medicin (grupperet efter hvor 
sandsynlige de er). </p>
...
- leverskade 
- blærer på huden 
- feber (normalt let til moderat), kulderystelser<br />
...
<ul>
<li>Aktivt stof: tasonermin. Hvert hætteglas indeholder 1 mg tasonermin. Indholdet af et hætteglas 
med Beromun-pulver skal rekonstitueres med 5,3 ml steril 0,9 % natriumchlorid injektionsvæske, 
opløsning. </li>
<li>Øvrige indholdsstoffer (hjælpestoffer): natriumdihydrogenphosphatdihydrat, dinatriumphosphat-
dodecahydrat  og human serumalbumin. </li>
</ul>
...
2, Rue Albert 1er<br />
L-1117 Luxembourg 
Storhertugdømmet Luxembourg </p>
<p>Fremstiller 
Eumedica NV 
Chemin de Nauwelette 1 
B-7170 Manage <br />
Belgien  </p>
<p>Med hensyn til yderligere oplysninger om dette lægemiddel bedes man rette henvendelse til 
