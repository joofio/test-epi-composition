...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Beyfortus is 
Beyfortus is a medicine given as an injection to protect babies against respiratory syncytial virus
(RSV). RSV is a common respiratory virus that usually causes mild symptoms comparable to the 
common cold. However, especially in babies and older adults, RSV can cause severe illness, including 
bronchiolitis (inflammation of the small airways in the lung) and pneumonia (infection of the lungs) 
that may lead to hospitalisation or even death. The virus is usually more common during the winter.
Beyfortus contains the active ingredient nirsevimab which is an antibody (a protein designed to attach 
to a specific target) that attaches to a protein that RSV needs to infect the body. By attaching to this 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Your child should not use Beyfortus if he or she is allergic to nirsevimab or any of the other 
ingredients of this medicine (listed in section 6).
Inform your child s doctor, pharmacist or nurse if this applies to your child. If you are not sure, check 
with your child s doctor, pharmacist or nurse before the medicine is given.
If your child shows signs of a severe allergic reaction contact the doctor immediately.
Warnings and precautions 
Tell your doctor or seek medical help immediately if you notice any signs of an allergic reaction, 
such as:</p>
...
Talk to your healthcare provider before your child is given Beyfortus if they have low numbers of 
blood platelets (which help blood clotting), a bleeding problem or bruise easily or if they are taking an 
anticoagulant (a medicine to prevent blood clots).
Children and adolescents
Do not give this medicine to children between the age of 2 and 18 years of age because it has not been 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Beyfortus is given by a doctor, pharmacist or nurse as a single injection in the muscle. It is usually 
given in the outer part of the thigh. 
The recommended dose is 50 mg for children weighing less than 5 kg and 100 mg for children 
weighing 5 kg or more. 
Beyfortus should be given before the RSV season. The virus is usually more common during the 
winter (known as the RSV season). If your child is born during the winter, Beyfortus should be given 
after birth.
...
Uncommon (may affect up to 1 in 100 children)</p>
<p>rash</p>
<p>injection site reaction (i.e. redness, swelling, and pain where the injection is given)</p>
<p>fever
...
Store in a refrigerator (2 C - 8 C). After removal from the refrigerator, Beyfortus must be protected 
...
<h2>The active substance is nirsevimab.</h2>
<h2>One pre-filled syringe of 0.5 mL solution contains 50 mg nirsevimab.</h2>
<p>One pre-filled syringe of 1 mL solution contains 100 mg nirsevimab.</p>
<p>The other ingredients are L-histidine, L-histidine hydrochloride, L-arginine hydrochloride, 
sucrose, polysorbate 80, and water for injections.
What Beyfortus looks like and contents of the pack
Beyfortus is a colourless to yellow solution for injection.
Beyfortus is available as: </p>
<p>1 or 5 pre-filled syringe(s) without needles.</p>
<p>1 pre-filled syringe packaged with two separate needles of different sizes. 
...
Swixx Biopharma EOOD
 .: +359 2 4942 Luxembourg/Luxemburg
Sanofi Belgium
T l/Tel: +32 2 710.54. esk  republika
Sanofi Pasteur
divize. vakc n sanofi-aventis, s.r.o.
...
T l: 0800 42 43 Appel depuis l tranger : +33 1 57 63 67 Portugal
...
Sanofi S.r.l.
Tel: 800536Tel dall'estero: +39 02 39394Suomi/Finland
Sanofi Oy
