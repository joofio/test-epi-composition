...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>BiResp Spiromax contains two different active substances: budesonide and formoterol fumarate dihydrate. </p>
<ul>
...
<p>BiResp Spiromax is indicated for use in adults and adolescents 12 years of age and older only.  </p>
<p>Your doctor has prescribed this medicine to treat asthma or chronic obstructive pulmonary disease (COPD).  </p>
<p>Asthma 
BiResp Spiromax can be prescribed for asthma in two different ways. </p>
<p>a)  You may be prescribed two asthma inhalers: BiResp Spiromax together with a separate  reliever 
inhaler  such as salbutamol. 
* Use BiResp Spiromax every day.  This helps to prevent asthma symptoms such as breathlessness and 
wheezing from occurring.<br />
* Use the  reliever inhaler  when you get asthma symptoms, to make it easier to breathe again.  </p>
<p>b)  You may be prescribed BiResp Spiromax as your only asthma inhaler. 
* Use BiResp Spiromax every day.  This helps to prevent asthma symptoms such as breathlessness and 
wheezing from occurring.<br />
* Use BiResp Spiromax when you need to take extra inhalations or puffs for relief of  asthma symptoms, 
to make it easier to breathe again and if agreed with the doctor also to prevent asthma symptoms from 
...
Symptoms include shortness of breath, cough, chest discomfort and coughing up mucus. BiResp Spiromax 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not use BiResp Spiromax if 
...
<p>If you have been taking steroid tablets for your asthma or COPD, your doctor may reduce the number of 
tablets that you take, once you start to use BiResp Spiromax. If you have been taking steroid tablets for a 
...
to use BiResp Spiromax. </p>
<p>Your doctor may consider adding steroid tablets to your usual treatment if you have an illness such as a chest 
infection or before an operation. </p>
<p>Contact your doctor if you experience blurred vision or other visual disturbances. </p>
<p>Children 
Do not give this medicine to children under the age of 12 years. </p>
<p>Other medicines and BiResp Spiromax 
...
* Antidepressant medicines such as monoamine oxidase inhibitors and those with similar properties (such 
as the antibiotic furazolidone and the chemotherapy medicine procarbazine). <br />
<em> Antipsychotic phenothiazine medicines (such as chlorpromazine and prochlorperazine).<br />
...
<p>Some medicines may increase the effects of BiResp Spiromax and your doctor may wish to monitor you 
carefully if you are taking these medicines (including some medicines for HIV: ritonavir, cobicistat). </p>
<p>If any of the above applies to you, or if you are not sure, talk to your doctor, pharmacist or nurse before using 
BiResp Spiromax. </p>
<p>Also tell your doctor, pharmacist or nurse if you are going to have a general anaesthetic for an operation or 
for dental work to help lower any risk of interaction with the anesthetic you receive.  </p>
<p>Pregnancy and breast-feeding<br />
<em> If you are pregnant or breast-feeding, think you may be pregnant or are planning to have a baby, ask 
your doctor, pharmacist or nurse for advice before taking BiResp Spiromax  do NOT use this medicine 
unless your doctor tells you to.<br />
</em> If you get pregnant while using BiResp Spiromax, do NOT stop using BiResp Spiromax but talk to your 
doctor immediately. </p>
<p>Driving and using machines 
BiResp Spiromax is not likely to affect your ability to drive or to use tools or machines. </p>
...
<ul>
<li>It is important to use BiResp Spiromax every day, even if you have no asthma or COPD symptoms at the 
time.  </li>
<li>If you are using BiResp Spiromax for asthma, your doctor will want to regularly check your symptoms.  </li>
</ul>
<p>Asthma<br />
BiResp Spiromax can be prescribed for asthma in two different ways. The amount of BiResp Spiromax to 
use and when to use it depends on how it has been prescribed for you.  </p>
<ul>
<li>If you have been prescribed BiResp Spiromax and a separate reliever inhaler, read the section called (A) 
Using BiResp Spiromax and a separate  reliever inhaler .  </li>
<li>If you have been prescribed BiResp Spiromax as your only inhaler, read the section called (B) Using 
BiResp Spiromax as your only asthma inhaler. </li>
</ul>
<p>(A) Using BiResp Spiromax and a separate  reliever inhaler <br />
Use your BiResp Spiromax every day. This helps to prevent asthma symptoms from occurring. </p>
...
<p>Adolescents (12 years and older) 
1 or 2 inhalations twice daily. </p>
<p>Your doctor will help you to manage your asthma and will adjust the dose of this medicine to the lowest dose 
that controls your asthma.  If your doctor feels that you need a lower dose than is available from your BiResp 
Spiromax, your doctor may prescribe an alternative inhaler containing the same active substances as your 
BiResp Spiromax but with a lower dose of the corticosteroid. If your symptoms are well controlled, your 
doctor may ask you to take your medicine once a day. However, do not adjust the number of inhalations your 
...
wheezing.  Do not use BiResp Spiromax to treat these asthma symptoms. </p>
<p>(B) Using BiResp Spiromax as your only asthma inhaler </p>
<p>Only use BiResp Spiromax in this way if your doctor has told you to.  </p>
<p>Use your BiResp Spiromax every day. This helps to prevent asthma symptoms from occurring. </p>
<p>Recommended dose<br />
...
<p>Also use BiResp Spiromax as a  reliever inhaler  to treat asthma symptoms when they happen and to 
prevent asthma symptoms from happening (for example, when exercising or on exposure to allergens).<br />
<em> If you get asthma symptoms, take 1 inhalation and wait a few minutes.<br />
</em> If you do not feel better, take another inhalation.<br />
* Do not take more than 6 inhalations at a single time. </p>
<p>Always keep your BiResp Spiromax with you and use it to relieve sudden attacks of breathlessness and 
wheezing. </p>
<p>A total daily dose of more than 8 inhalations is not normally needed.  However, your doctor may allow you 
to take up to 12 inhalations a day for a limited period.  </p>
<p>If you regularly need to use 8 or more inhalations a day, make an appointment to see your doctor.  They may 
need to change your treatment.  </p>
<p>Do NOT use more than 12 inhalations in total in 24 hours. </p>
<p>If you are doing exercise and you get asthma symptoms, use BiResp Spiromax as described here.  However, 
do not use BiResp Spiromax just before exercise to stop asthma symptoms from happening. </p>
<p>It is important that you discuss with your doctor the use of BiResp Spiromax to prevent asthma symptoms 
...
<p>Your doctor may also prescribe another bronchodilator medicine, for example an anticholinergic (such as 
tiotropium or ipratropium bromide) for your COPD disease. </p>
<p>Preparing your new BiResp Spiromax  </p>
<p>Before using your new BiResp Spiromax for the first time, you need to prepare it for use as follows: 
...
<ol>
<li>Remove your inhaler from your mouth.  You may notice a taste when you take your inhalation.  </li>
...
<p>If you feel you are getting breathless or wheezy while using BiResp Spiromax, you should continue to use 
BiResp Spiromax but go to see your doctor as soon as possible, as you may need additional treatment. </p>
...
BiResp Spiromax. </p>
<p>If you use more BiResp Spiromax than you should 
It is important that you take your dose as advised by your doctor. You should not exceed your prescribed dose 
without seeking medical advice. </p>
<p>If you use more BiResp Spiromax than you should, contact your doctor, pharmacist or nurse for advice. 
The most common symptoms that may occur after when you use more BiResp Spiromax than you should are 
trembling, headache or a rapid heartbeat.  </p>
<p>If you forget to use BiResp Spiromax 
...
(also referred to as  paradoxical bronchospasm ). If either of these symptoms occur, stop using BiResp 
Spiromax straightaway and use your  reliever inhaler  if you have one. Contact your doctor 
...
usually mild and usually disappear as you continue to use BiResp Spiromax. 
...
<p>Tell your doctor if you have any of the following while taking BiResp Spiromax they could be symptoms of 
a lung infection: 
* Fever or chills 
...
<p>Very rare:<br />
<em> Depression<br />
</em> Changes in behaviour, especially in children 
...
<em> Taste changes, such as an unpleasant taste in the mouth 
* Changes in your blood pressure.<br />
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>BiResp Spiromax contém duas substâncias ativas diferentes: budesonida e fumarato de formoterol di-
hidratado. </p>
<ul>
<li>
...
<p>BiResp Spiromax está indicado para utilização apenas em adultos e adolescentes com idade igual 
ou superior a 12 anos.  </p>
<p>O seu médico receitou este medicamento para tratar a asma ou a doença pulmonar obstrutiva crónica 
(DPOC). 
Asma 
BiResp Spiromax pode ser receitado para a asma de duas formas diferentes: </p>
<p>a) Podem ser-lhe receitados dois inaladores da asma: BiResp Spiromax juntamente com um 
“inalador de alívio" como, por exemplo, o salbutamol. </p>
<ul>
<li>
<p>Utilize o BiResp Spiromax todos os dias. Isto ajuda a prevenir o aparecimento dos sintomas da 
asma tais como, falta de ar e pieira. </p>
</li>
<li>
...
<p>b) Pode ser-lhe receitado BiResp Spiromax como o seu único inalador da asma. </p>
<ul>
<li>
<p>Utilize o BiResp Spiromax todos os dias. Isto ajuda a prevenir o aparecimento dos sintomas da 
asma tais como, falta de ar e pieira. </p>
...
<li>
<p>Utilize o BiResp Spiromax quando necessitar de fazer inalações ou sopros adicionais para o 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Não utilize BiResp Spiromax se 
...
Fale com o seu médico, farmacêutico ou enfermeiro antes de utilizar BiResp Spiromax se: </p>
<ul>
<li>
<p>é diabético. </p>
</li>
...
dúvidas se deve continuar ou não a utilizar o BiResp Spiromax. </p>
...
<p>Outros medicamentos e BiResp Spiromax 
...
<ul>
<li>
<p>Bloqueadores β (tais como o atenolol ou propranolol para o tratamento da tensão arterial 
...
<li>
<p>Medicamentos à base de xantina (tais como a teofilina ou a aminofilina). Estes medicamentos 
são frequentemente utilizados para o tratamento da asma. </p>
</li>
<li>
...
<li>
<p>Medicamentos chamados “inibidores da protease do VIH (Vírus da Imunodeficiência 
Humana)") (tais como o ritonavir) para o tratamento da infeção pelo VIH. </p>
</li>
<li>
...
<p>Alguns medicamentos podem potenciar os efeitos de BiResp Spiromax e o seu médico poderá querer 
...
médico, farmacêutico ou enfermeiro antes de utilizar o BiResp Spiromax. </p>
...
<li>
<p>Se engravidar enquanto estiver a utilizar o BiResp Spiromax, NÃO pare de utilizar o BiResp 
...
<ul>
<li>
<p>É importante utilizar BiResp Spiromax todos os dias, mesmo que não tenha sintomas de asma ou 
DPOC nessa altura. </p>
</li>
<li>
<p>Se estiver a utilizar BiResp Spiromax para a asma, o seu médico vai querer avaliar os seus 
...
<ul>
<li>
<p>Se lhe foi receitado BiResp Spiromax e um inalador de alívio separado, leia a secção intitulada 
“(A) Utilizar BiResp Spiromax e um inalador de alívio separado".  </p>
</li>
<li>
<p>Se lhe foi receitado BiResp Spiromax como único inalador, leia a secção intitulada “(B) 
Utilizar BiResp Spiromax como único inalador da asma". </p>
</li>
</ul>
<p>(A) Utilizar BiResp Spiromax e um inalador de alívio separado 
...
pieira. Não utilize o BiResp Spiromax para tratar estes sintomas da asma. </p>
<p>(B) Utilizar BiResp Spiromax como único inalador da asma 
Utilize o BiResp Spiromax desta forma apenas se o seu médico lhe tiver dito para o fazer. </p>
<p>Utilize o seu BiResp Spiromax todos os dias. Isto ajuda a prevenir o aparecimento dos sintomas da 
asma. </p>
<p>Dose recomendada 
...
<p>Utilize igualmente o BiResp Spiromax como “inalador de alívio" para tratar os sintomas da asma 
...
<p>Tenha sempre consigo o BiResp Spiromax e utilize-o para aliviar ataques súbitos de falta de ar e 
pieira. </p>
...
<p>Se estiver a praticar exercício e desenvolver sintomas de asma, utilize o BiResp Spiromax tal como 
...
está exposto a alergénios pode influenciar o tratamento que lhe é prescrito. </p>
...
<p>Antes de utilizar o seu BiResp Spiromax novo pela primeira vez, tem de o preparar da seguinte 
forma: </p>
<ul>
<li>
...
<li>Em seguida expire suavemente (não expire através do inalador). Feche a cobertura do aplicador 
bucal. </li>
</ol>
...
<p>Se sentir dificuldade em respirar ou pieira enquanto estiver a utilizar o BiResp Spiromax, deverá 
...
gradualmente a dose de BiResp Spiromax. </p>
<p>Se utilizar mais BiResp Spiromax do que deveria 
...
<p>Se utilizar mais BiResp Spiromax do que deveria, contacte o seu médico, farmacêutico ou enfermeiro 
para obter aconselhamento. Os sintomas mais frequentes que podem ocorrer depois, quando utiliza 
mais BiResp Spiromax do que deveria são tremores, dores de cabeça ou batimento do coração rápido.  </p>
<p>Caso se tenha esquecido de utilizar o BiResp Spiromax 
...
<p>Se parar de utilizar BiResp Spiromax 
...
<p>Se lhe acontecer qualquer uma das situações a seguir descritas, pare de utilizar o BiResp 
...
Contacte o seu médico imediatamente, pois poderá necessitar de alterar o seu tratamento. </li>
</ul>
...
<p>Informe o seu médico se tiver qualquer uma das seguintes situações enquanto está a tomar BiResp 
...
<li>
<p>Alterações da tensão arterial 
Os corticosteroides inalados podem afetar a produção normal de hormonas esteroides no seu 
organismo, particularmente se utilizar doses elevadas durante um longo período. Os efeitos incluem: </p>
</li>
<li>
...
<li>O outro componente é a lactose mono-hidratada, que contém proteínas do leite) (ver “BiResp 
Spiromax contém lactose" na secção 2). </li>
</ul>
<p>Qual o aspeto de BiResp Spiromax e conteúdo da embalagem </p>
<p>BiResp Spiromax é um pó para inalação. 
