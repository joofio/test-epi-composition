...
<ol>
<li>What Blitzima is and what it is used for </li>
<li>What you need to know before you use Blitzima </li>
<li>How to use Blitzima </li>
<li>Possible side effects </li>
<li>How to store Blitzima </li>
...
may have. Blitzima in combination with chemotherapy destroys these cells which are gradually 
...
<p>d) 
Pemphigus vulgaris 
Blitzima is used for the treatment of patients with moderate to severe pemphigus vulgaris. Pemphigus 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not take Blitzima if 
...
polyangiitis, microscopic polyangiitis or pemphigus vulgaris. </p>
<p>Do not have Blitzima if any of the above apply to you. If you are not sure, talk to your doctor, 
pharmacist or nurse before you are given Blitzima. </p>
<p>Warnings and precautions 
Talk to your doctor, pharmacist or nurse before you are given Blitzima if: </p>
<ul>
<li>you have ever had or might now have a hepatitis infection. This is because in a few cases, 
Blitzima could cause hepatitis B to become active again, which can be fatal in very rare cases. 
...
you are given Blitzima. Your doctor may need to take special care of you during your treatment with 
Blitzima. </p>
<p>If you have granulomatosis with polyangiitis, microscopic polyangiitis or pemphigus vulgaris 
also tell your doctor 
* if you think you may have an infection, even a mild one like a cold. The cells that are affected 
by Blitzima help to fight infection and you should wait until the infection has passed before you 
are given Blitzima. Also please tell your doctor if you had a lot of infections in the past or suffer 
from severe infections. 
* if you think you may need any vaccinations in the near future, including vaccinations needed to 
travel to other countries. Some vaccines should not be given at the same time as Blitzima or in 
...
Talk to your doctor, pharmacist or nurse before you are given this medicine if you, or your child, are 
under 18 years of age. </p>
<p>Other medicines and Blitzima 
...
because Blitzima can affect the way some other medicines work. Also some other medicines can affect 
the way Blitzima works. </p>
...
planning to become pregnant. This is because Blitzima can across the placenta and may affect 
your baby. </p>
<p>If you can get pregnant, you and your partner must use an effective method of contraception 
while using Blitzima. You must also do this for 12 months after your last treatment with 
Blitzima. </p>
<p>Blitzima passes into breast milk in very small amounts. As the long-term effects on breastfed infants 
are not known, for precautionary reasons, breast-feeding is not recommended during treatment with 
Blitzima and for 6 months after the treatment. </p>
<p>Driving and using machines 
Rituximab has no or negligible influence on the ability to drive and use machines.  </p>
<p>Blitzima contains sodium 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>How Blitzima is given 
...
side effects. 
You will always be given Blitzima as a drip (intravenous infusion). </p>
...
Blitzima will be given to you on the same day as your chemotherapy. This is usually given 
...
28 days. The chemotherapy should be given after the Blitzima infusion. Your doctor will decide if 
...
Treatment with Blitzima uses four separate infusions given at weekly intervals. Corticosteroids will 
usually be given by injection before the start of Blitzima treatment. Corticosteroids given by mouth 
may be started at any time by your doctor to treat your condition. If you are 18 years of age and 
older and respond well to treatment, you may be given Blitzima as a maintenance treatment. This 
will be administered as 2 separate infusions which are given 2 weeks apart, followed by 1 infusion 
every 6 months for at least 2 years. Your doctor may decide to treat you longer with Blitzima (up to 
...
respond well to treatment, you may be given Blitzima as a maintenance treatment. This will be 
...
<p>c) 
If you are being treated for pemphigus vulgaris </p>
<p>Very common side effects (may affect more than 1 in 10 people): 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Blitzima contains 
* The active ingredient in Blitzima is called rituximab.<br />
