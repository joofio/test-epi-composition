...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Bretaris Genuair is 
The active ingredient of Bretaris Genuair is aclidinium bromide, which belongs to a group of 
medicines called bronchodilators. Bronchodilators relax airways and help keep bronchioles open. 
Bretaris Genuair is a dry powder inhaler that uses your breath to deliver the medicine directly into 
your lungs. This makes it easier for chronic obstructive pulmonary disease (COPD) patients to breathe. </p>
<p>What Bretaris Genuair is used for 
Bretaris Genuair is indicated to help open the airways and relieve symptoms of COPD, a serious, long-
term lung disease characterised by breathing difficulties. Regular use of Bretaris Genuair can help you 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not use Bretaris Genuair 
...
medicines. </p>
<p>Inform your doctor if you have been or are using similar medicines for breathing problems, such as 
medicines containing tiotropium, ipratropium. Ask your doctor or pharmacist if you are not sure. The 
use of Bretaris Genuair with these medicines is not recommended. </p>
<p>Pregnancy and breast-feeding 
If you are pregnant or breast-feeding, think you may be pregnant or are planning to have a baby, ask 
your doctor or pharmacist for advice before taking this medicine. You should not use Bretaris Genuair 
if you are pregnant or are breast-feeding unless your doctor tells you so. </p>
<p>Driving and using machines 
Bretaris Genuair may have minor influence on the ability to drive and use machines. This medicine 
may cause headache, dizziness or blurred vision. If you are affected by any of these side effects do not 
...
<p>Bretaris Genuair contains lactose 
...
<p>The recommended dose is one inhalation twice a day in the morning and evening. 
The effects of Bretaris Genuair last for 12 hours; therefore, you should try to use your Bretaris Genuair 
...
you to remember to use it. </p>
<p>The recommended dose can be used for elderly patients and for patients with kidney or liver problems. 
No dose adjustments are necessary. </p>
<p>COPD is a long-term disease; therefore, it is recommended that Bretaris Genuair is used every day, 
twice a day and not only when breathing problems or other symptoms of COPD are experienced. </p>
<p>Route of administration 
The medicine is for inhalation use. </p>
<p>Refer to the Instructions for Use for instructions on how to use the Genuair inhaler. If you are not sure 
of how to use Bretaris Genuair, contact your doctor or pharmacist. </p>
<p>You can use Bretaris Genuair any time before or after food or drink. </p>
<p>If you use more Bretaris Genuair than you should 
If you think you may have used more Bretaris Genuair than you should, contact your doctor or 
pharmacist. </p>
<p>If you forget to use Bretaris Genuair 
If you forget a dose of Bretaris Genuair, inhale the dose as soon as you remember. However, if it is 
nearly time for your next dose, skip the missed dose. 
Do not take a double dose to make up for a forgotten dose. </p>
<p>If you stop using Bretaris Genuair 
...
<p>Allergic reactions may rarely occur (may affect up to 1 in 1,000 people). Stop using the medicine and 
...
severely itchy bumps on your skin (hives) as these may be symptoms of an allergic reaction. </p>
...
Det gør det lettere for patienter med kronisk obstruktiv lungesygdom (KOL) at trække vejret. </p>
<p>Anvendelse 
...
Bretaris Genuair kan hjælpe dig, når du oplever vedvarende åndenød relateret til din sygdom, ved at 
minimere sygdommens påvirkning af din hverdag og reducere antallet af opblusninger (forværring af 
dine KOL-symptomer i flere dage). </p> </div>"""   
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Brug ikke Bretaris Genuair 
- hvis du er allergisk over for aclidiniumbromid eller et af de øvrige indholdsstoffer (angivet i 
punkt 6).  </p>
<p>Advarsler og forsigtighedsregler 
Kontakt lægen, apotekspersonalet eller sygeplejersken, før du bruger Bretaris Genuair:</p>
<ul>
<li>hvis du for nylig har haft hjerteproblemer. </li>
<li>hvis du har regnbuesyn, dvs. ser en regnbuefarvet ring omkring lys eller farvede billeder 
(glaukom). </li>
<li>hvis du har en forstørret prostata, problemer med vandladning eller blokering i blæren. </li>
</ul>
<p>Bretaris Genuair anvendes som vedligeholdelsesbehandling og skal ikke anvendes til at behandle et 
...
råds. </p>
<p>Tør mund, som er blevet set med lægemidler såsom Bretaris Genuair, kan efter langvarig brug af 
...
<ul>
<li>hvis du oplever trykken for brystet, hoste, hvæsende vejrtrækning eller kortåndethed 
umiddelbart efter brug af lægemidlet. Dette kan være tegn på en tilstand betegnet 
bronkospasme. </li>
</ul>
<p>Børn og unge 
Bretaris Genuair er ikke beregnet til brug hos børn eller unge under 18 år. </p>
<p>Brug af anden medicin sammen med Bretaris Genuair 
...
<p>Fortæl lægen, hvis du har taget eller aktuelt tager andre lignende lægemidler for 
...
Bretaris Genuair, hvis du er gravid eller ammer, medmindre din læge fortæller dig, at du skal gøre det. </p>
...
<p>Bretaris Genuair indeholder lactose 
...
<p>Den anbefalede dosis er én inhalation to gange dagligt, morgen og aften. 
...
med at huske at bruge den. </p>
<p>Den anbefalede dosis kan anvendes til ældre patienter og til patienter med nedsat nyre- eller 
leverfunktion. Det er ikke nødvendigt at justere dosen. </p>
<p>KOL er en langvarig sygdom. Det anbefales derfor, at Bretaris Genuair anvendes hver dag, to gange 
om dagen og ikke kun, når du oplever vejrtrækningsproblemer eller andre symptomer på KOL. </p>
<p>Anvendelsesmåde 
Medicinen er til inhalation. </p>
<p>Se Brugsanvisning for vejledning i brug af Genuair-inhalatoren. Er du i tvivl om, hvordan du skal 
bruge Bretaris Genuair, så spørg lægen eller apotekspersonalet. 
Du kan bruge Bretaris Genuair på ethvert tidspunkt før eller efter indtagelse af mad eller drikke. </p>
<p>Hvis du har brugt for meget Bretaris Genuair 
Spørg lægen eller apotekspersonalet, hvis du mener, at du har brugt mere Bretaris Genuair, end du 
burde. </p>
<p>Hvis du har glemt at bruge Bretaris Genuair 
Hvis du glemmer en dosis af Bretaris Genuair, skal du inhalere dosen, så snart du husker det. Hvis det 
næsten er tid til din næste dosis, skal du dog springe den manglende dosis over.<br />
Du må ikke tage en dobbeltdosis som erstatning for den glemte dosis. </p>
<p>Hvis du holder op med at bruge Bretaris Genuair 
...
<p>Allergiske reaktioner kan forekomme i sjældne tilfælde (kan påvirke op til 1 ud af 1.000 personer). 
...
<p>Brug ikke lægemidlet efter den udløbsdato, der står på inhalatorens etiket og karton efter "EXP". 
Udløbsdatoen er den sidste dag i den nævnte måned. </p>
<p>Lad inhalatoren forblive i posen, indtil administrationsperioden begynder. </p>
<p>Skal anvendes inden for 90 dage, efter posen åbnes.  </p>
<p>Brug ikke Bretaris Genuair, hvis du bemærker, at pakningen er beskadiget, eller der er synlige tegn på 
manipulering. </p>
...
<ul>
<li>Aktivt stof: aclidiniumbromid. Hver leveret dosis indeholder 375 mikrogram aclidiniumbromid 
svarende til 322 mikrogram aclidinium.  </li>
<li>Øvrige indholdsstoffer: lactosemonohydrat (se punkt 2 "Bretaris Genuair indeholder lactose"). </li>
</ul>
<p>Udseende og pakningsstørrelser 
Bretaris Genuair er et hvidt eller næsten hvidt pulver.<br />
Genuair-inhalatoren er hvid med en indbygget dosisindikator og en grøn doseringsknap. Mundstykket 
er dækket med en aftagelig grøn beskyttelseshætte. Den leveres i en plastikpose. </p>
<p>Leverede pakningsstørrelser: 
...
<p>Brugsanvisning </p>
<p>Dette afsnit indeholder information om, hvordan du skal anvende din Genuair inhalator. Det er vigtigt, 
...
spørgsmål om, hvordan du skal bruge din inhalator. </p>
...
ud. 
b)  Tryk ikke på den grønne knap, før du er klar til at tage en dosis.<br />
...
1.1 Se ind i åbningen på mundstykket for at sikre dig, at det ikke er blokeret (Figur C).<br />
1.2 Se på kontrolvinduet (skal være rødt, Figur C).  </p>
<p>Figur C 
1.3 Hold inhalatoren vandret med mundstykket mod dig og den grønne knap opad (Figur D). </p>
<pre><code> Figur D
</code></pre>
<p>1.4 Tryk den grønne knap helt i bund for at klargøre din dosis (Figur E). 
Når du trykker knappen helt ned, skifter kontrolvinduet fra rødt til grønt. 
Du skal sikre dig, at den grønne knap er opad. Hold inhalatoren lige.<br />
...
(Figur J). 
Hold ikke den grønne knap nede mens du inhalerer.  </p>
<p>Figur J 
...
Dosisindikator </p>
<p>Rødt bånd </p>
<p>Dosisindikator flytter langsomt fra 
60 til 0: 60, 50, 40, 30, 20, 10, 0. Hvordan skal du rengøre din inhalator? </p>
<p>Brug ALDRIG vand til at rengøre inhalatoren, da det kan ødelægge medicinen. </p>
