...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>BRUKINSA is an anticancer medicine that contains the active substance zanubrutinib. It belongs to a 
...
medicine is used when the disease has come back, or treatment has not worked.  </p>
<p>BRUKINSA is also used to treat chronic lymphocytic leukaemia (CLL), another type of cancer 
affecting B cells that involves the lymph nodes. This medicine is used in patients who have not 
previously been treated for CLL or when the disease has come back or has not responded to previous 
treatment. 
...
<ul>
<li>if you are allergic to zanubrutinib or any of the other ingredients of this medicine (listed in 
section 6). </li>
</ul>
...
failure, or if you have any of the following: shortness of breath, weakness, dizziness, light-
headedness, fainting or near fainting, chest pain or swollen legs 
* if you have ever been advised that you are at higher risk of infections. You may experience 
viral, bacterial, or fungal infections during treatment with BRUKINSA with the following 
possible symptoms: fever, chills, weakness, confusion, body aches, cold or flu symptoms, feel 
tired or feel short of breath, yellowing of the skin or eyes (jaundice). 
* if you have ever had or might have hepatitis B. This is because BRUKINSA could cause 
hepatitis B to become active again. Patients will be carefully checked by their doctor for signs 
of this infection before treatment is started 
* if you have liver or kidney problems 
* if you have recently had any surgery, especially if it might affect how you absorb food or 
medicines from your stomach or gut 
* if you recently had low counts of red blood cells, infection-fighting cells or platelets in your 
blood 
* if you had other carcinomas in the past including skin cancer (e.g., basal cell carcinoma or 
squamous cell carcinoma). Please use sun protection </p>
...
Laboratory tests may show lymphocytosis, an increase in white blood cells (lymphocytes) in your 
blood in the first few weeks of treatment. This is expected and may last for a few months. This does 
not necessarily mean that your blood cancer is getting worse. Your doctor will check your blood 
counts before and during the treatment and in rare cases the doctor may give you another medicine. 
...
supplements. This is because BRUKINSA may affect the way some medicines work. Also, some 
medicines can affect the way BRUKINSA works. </p>
<p>BRUKINSA may make you bleed more easily. This means you should tell your doctor if you take 
other medicines that increase your risk of bleeding. This includes medicines such as: 
* acetylsalicylic acid (aspirin) and non-steroidal anti-inflammatories (NSAIDs) such as 
ibuprofen and naproxen, 
* anticoagulants such as warfarin, heparin and other medicines for treating or preventing blood 
clots, 
...
<p>Do not get pregnant while you are taking this medicine. BRUKINSA should not be used during 
pregnancy. It is not known if BRUKINSA will harm your unborn baby. </p>
<p>Women of childbearing age must use a highly effective method of birth control during treatment with 
BRUKINSA and for least one month after treatment. A barrier method of contraception (e.g., 
condoms) must be used with hormonal contraceptives such as birth control pills or devices.  </p>
<ul>
<li>Tell your doctor immediately if you become pregnant. </li>
<li>Do not breast-feed while you are taking this medicine. BRUKINSA may pass into breast milk. </li>
</ul>
...
<p>The recommended dose is 320 mg (4 capsules) each day, either as 4 capsules once daily or 2 capsules 
...
BRUKINSA works best when it is swallowed whole. Therefore, swallow the capsules whole. Do not 
open, break or chew them. </p>
<p>If you take more BRUKINSA than you should  </p>
<p>If you take more BRUKINSA than you should, talk to a doctor straight away. Take the capsule 
packet and this leaflet with you. </p>
<p>If you forget to take BRUKINSA  </p>
<p>If you miss a dose, take it at the next scheduled time with a return to the normal schedule. If you take 
BRUKINSA once per day, take your next dose the following day. If you take the medicine twice a 
day, in the morning and in the evening and you forgot to take it in the morning, take your next dose in 
the evening. Do not take a double dose to make up for a forgotten dose. If you are not sure, talk to 
...
* skin rash 
* infection of the lung (lower respiratory tract infection)<br />
* dizziness 
...
* Dizziness 
* blood in urine 
* blood tests showing a reduced number of blood cells. Your doctor should do blood tests during 
treatment with BRUKINSA to check the number of your blood cells. </p>
<p>Common (may affect up to 1 in 10 people): 
* swollen hands, ankles or feet 
* nosebleed 
* itching of the skin 
* small bleeding spots under the skin<br />
* fast heart rate, missed heart beats, weak or uneven pulse, lightheadedness, shortness of 
breath, chest discomfort (symptoms of heart rhythm problems) 
* weakness 
* low white blood cell count with fever (febrile neutropenia) </p>
...
* unusual levels of chemicals in the blood caused by the fast breakdown of cancer cells have 
occurred during treatment of cancer and sometimes even without treatment (tumour lysis 
syndrome) </p>
<p>Unknown: 
* redness and shedding of skin over a large area of the body, which may be itchy or painful 
(exfoliative dermatitis generalized) </p>
...
2. Det skal du vide, før du begynder at tage BRUKINSA 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>BRUKINSA er et lægemiddel mod kræft, som indeholder det aktive stof zanubrutinib. Det tilhører en 
klasse af lægemidler, der kaldes proteinkinasehæmmere. Dette lægemiddel virker ved at blokere 
Brutons tyrosinkinase, et protein i kroppen, der hjælper disse kræftceller med at vokse og overleve. 
Ved at blokere dette protein hjælper BRUKINSA med at reducere antallet af kræftceller. Det hæmmer 
også udviklingen af kræftsygdommen. </p>
<p>BRUKINSA anvendes til at behandle Waldenstrøms makroglobulinæmi (også kaldet 
lymfoplasmacytisk lymfom). Det er en kræft, der påvirker en type hvide blodlegemer kaldet B-
lymfocytter, der producerer for meget af et protein kaldet IgM.  </p>
<p>Denne medicin bruges, når sygdommen er kommet tilbage, eller behandlingen ikke har fungeret, eller 
hos patienter, der ikke kan få kemoterapi sammen med et antistof. </p>
<p>BRUKINSA bruges også til behandling af marginal zone lymfom. Dette er en type kræft, der også 
påvirker B-lymfocytter eller B-celler. Ved marginal zone lymfom formerer de unormale B-celler sig 
for hurtigt og lever for længe. Dette kan forårsage forstørrelse af organer, der er en del af kroppens 
naturlige forsvar, såsom lymfeknuder og milt. De unormale B-celler kan også påvirke forskellige 
organer, såsom mave, spytkirtel, skjoldbruskkirtel, øjne, lunger, knoglemarv og blod. Patienterne kan 
have feber, vægttab, træthed og svedeture om natten, men også symptomer, der afhænger af, hvor 
lymfomet udvikler sig. Denne medicin bruges, når sygdommen er vendt tilbage, eller behandlingen 
ikke har fungeret. </p>
<p>BRUKINSA bruges også til behandling af kronisk lymfatisk leukæmi (CLL), en anden type kræft, der 
rammer B-celler, og som involverer lymfeknuderne. Denne medicin anvendes til patienter, der ikke 
tidligere er blevet behandlet for CLL, eller når sygdommen er kommet tilbage eller ikke har reageret 
på tidligere behandling. </p>
<p>BRUKINSA bruges også til behandling af follikulært lymfom (FL). FL er en langsomt voksende 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Tag ikke BRUKINSA 
...
Kontakt lægen, apotekspersonalet eller sygeplejersken, før du tager BRUKINSA: </p>
<ul>
<li>
<p>hvis du nogensinde har haft usædvanlige blå mærker eller blødning, eller hvis du tager andre 
lægemidler eller kosttilskud, der øger din risiko for blødning (Se punktet "Brug af anden 
medicin sammen med BRUKINSA"). Hvis du for nylig er blevet opereret, eller der er 
planlagt operation for dig, kan din læge bede dig om at stoppe med at tage BRUKINSA i kort 
tid (3-7 dage) før og efter operationen eller tandlægeindgrebet </p>
</li>
<li>
<p>hvis du har uregelmæssige hjerteslag eller tidligere har haft uregelmæssige hjerteslag eller 
alvorligt hjertesvigt, eller hvis du oplever noget af det følgende: åndenød, svaghed, uklarhed, 
besvimelse eller nær-besvimelse, smerter i brystet eller hævede ben </p>
</li>
<li>
<p>hvis du nogen sinde er blevet gjort opmærksom på, at du har højere risiko for infektioner. Du 
kan få virus-, bakterie- eller svampeinfektioner under behandling med BRUKINSA med 
følgende mulige symptomer: feber, kulderystelser, svaghed, forvirring, kropssmerter, 
forkølelses- eller influenzasymptomer, føle dig træt eller åndenød, gulfarvning af huden eller 
øjnene (gulsot). </p>
</li>
<li>
<p>hvis du nogensinde har haft eller muligvis har hepatitis B. Dette skyldes, at BRUKINSA kan 
reaktivere hepatitis B-virus. Patienterne vil blive undersøgt nøje af deres læge for tegn på 
denne infektion, før behandling startes </p>
</li>
<li>
<p>hvis du har lever- eller nyreproblemer </p>
</li>
<li>
<p>hvis du for nylig er blevet opereret, specielt hvis det kan påvirke, hvordan din mave eller dine 
tarme absorberer mad eller medicin </p>
</li>
<li>
<p>hvis du for nylig havde et lavt antal røde blodlegemer, infektionsbekæmpende celler eller 
blodplader i blodet </p>
</li>
<li>
<p>hvis du tidligere har haft andre karcinomer, herunder hudkræft (f.eks. basalcellekræft eller 
pladeepitelkræft). Sørg for at beskytte dig mod solen </p>
</li>
</ul>
<p>Kontakt lægen, apotekspersonalet eller sygeplejersken, før du tager dette lægemiddel, hvis noget af 
ovenstående gælder for dig (eller hvis du er i tvivl). </p>
<p>Undersøgelser og kontrol før og under behandling 
Laboratorietests kan vise lymfocytose, en stigning i hvide blodlegemer (lymfocytter) i dit blod i de 
første par uger af behandlingen. Dette er forventeligt og kan vare et par måneder. Det betyder ikke 
nødvendigvis, at din blodkræft bliver værre. Din læge vil undersøge dit blodtal før og under 
behandlingen, og i sjældne tilfælde kan lægen blive nødt til at give dig anden medicin. Din læge vil 
fortælle dig, hvad dine testresultater betyder. </p>
<p>Tumorlysissyndrom (TLS): Usædvanlige niveauer af kemikalier i blodet forårsaget af hurtig 
nedbrydning af kræftceller er sket under behandling af kræft og nogle gange endda uden behandling. 
Dette kan føre til ændringer i nyrefunktionen, unormal hjerterytme eller anfald. Din læge eller en 
anden sundhedsudbyder kan tage blodprøver for at tjekke for TLS. </p>
<p>Børn og unge 
BRUKINSA bør ikke anvendes til børn og unge, da det er usandsynligt at det ville kunne fungere. </p>
<p>Brug af anden medicin sammen med BRUKINSA 
Fortæl det altid til lægen eller apotekspersonalet, hvis du tager anden medicin, for nylig har taget 
anden medicin eller planlægger at tage anden medicin. Det gælder også håndkøbsmedicin, 
naturlægemidler og kosttilskud. Dette skyldes, at BRUKINSA kan påvirke den måde, lægemidler 
virker på. Nogle lægemidler kan også påvirke den måde, BRUKINSA virker på. </p>
<p>BRUKINSA kan gøre dig tilbøjelig til at bløde lettere. Det betyder, at du skal fortælle din læge, 
hvis du tager anden medicin, som kan øge din risiko for blødning. Dette inkluderer lægemidler 
såsom: </p>
<ul>
<li>
<p>acetylsalicylsyre (aspirin) og non-steroide anti-inflammatoriske midler (NSAID'er), såsom 
ibuprofen og naproxen, </p>
</li>
<li>
<p>antikoagulanter såsom warfarin, heparin eller andre midler til behandling eller forebyggelse af 
blodpropper, </p>
</li>
<li>
<p>kosttilskud, som kan øge din risiko for blødning, såsom fiskeolie, vitamin E eller hørfrø. </p>
</li>
</ul>
...
<p>BRUKINSA med mad 
Grapefrugt eller pomerans (bitre appelsiner) skal indtages med forsigtighed omkring  det tidspunkt, du 
tager BRUKINSA. Dette skyldes, at de kan øge mængden af BRUKINSA i dit blod. </p>
<p>Graviditet og amning 
Du må ikke blive gravid, mens du tager dette lægemiddel. BRUKINSA må ikke anvendes under 
graviditet. Det vides ikke, om BRUKINSA vil skade dit ufødte barn. </p>
<p>Fertile kvinder skal anvende en højeffektiv præventionsmetode under behandling med BRUKINSA og 
i mindst en måned efter behandlingen. En barrieremetode (f.eks. kondomer) skal bruges sammen med 
hormonelle præventionsmidler, som f.eks. p-piller, p-sprøjte eller p-stav. </p>
<ul>
<li>
<p>Fortæl det straks til lægen, hvis du bliver gravid. </p>
</li>
<li>
<p>Du må ikke amme, mens du tager dette lægemiddel. BRUKSINA kan overføres til 
modermælken. </p>
</li>
</ul>
...
<p>Den anbefalede dosis er 320 mg(4 kapsler) hver dag, enten som 4 kapsler én gang dagligt 
eller 2 kapsler om morgenen og 2 om aftenen. </p>
<p>Din læge vil muligvis justere dosen. 
Kapslerne skal tages gennem munden med et glas vand sammen med mad eller mellem måltider. 
Kapslerne skal tages på cirka samme tidspunkt hver dag. 
BRUKINSA virker bedst, når den synkes hele. Synk derfor kapslerne hel. De må ikke åbnes, brækkes 
eller tygges. </p>
<p>Hvis du har taget for meget BRUKINSA 
Kontakt straks en læge, hvis du har taget for meget BRUKINSA. Medbring kapselpakken og denne 
indlægsseddel. </p>
<p>Hvis du har glemt at tage BRUKINSA 
Hvis du glemmer en dosis, skal du tage den på det næste planlagte tidspunkt og derefter vende tilbage 
til den normale tidsplan. Hvis du tager BRUKINSA en gang dagligt, skal du tage din næste dosis den 
følgende dag. Hvis du tager medicinen to gange om dagen, om morgenen og om aftenen, og du har 
glemt at tage den om morgenen, skal du tage din næste dosis om aftenen. Du må ikke tage en 
dobbeltdosis som erstatning for den glemte kapsel. Spørg lægen, apotekspersonalet eller 
...
<ul>
<li>
<p>blodudtrædninger eller øget tilbøjelighed til blodudtrædninger, blå mærker </p>
</li>
<li>
<p>blødning </p>
</li>
<li>
<p>ømme muskler og knogler </p>
</li>
<li>
<p>hududslæt </p>
</li>
<li>
<p>infektion i lungerne (infektion i de nedre luftveje) </p>
</li>
<li>
<p>svimmelhed </p>
</li>
<li>
<p>diarré, din læge bliver muligvis nødt til at give dig væske og salterstatning eller et andet 
lægemiddel </p>
</li>
<li>
<p>hoste </p>
...
<li>
<p>blodprøver viser et reduceret antal blodlegemer. Din læge vil tage blodprøver under behandling 
med BRUKINSA for at kontrollere antallet af dine blodlegemer. </p>
</li>
</ul>
...
<li>
<p>små blødende pletter under huden  </p>
</li>
<li>
<p>hurtig hjertefrekvens, oversprunget hjerteslag, svag eller ujævn puls, følelse af at være uklar, 
kortåndethed, ubehag i brystet (symptomer på hjerterytmeproblemer) </p>
</li>
<li>
<p>svaghed </p>
</li>
<li>
<p>lavt antal hvide blodlegemer med feber (febril neutropeni) </p>
</li>
</ul>
<p>Ikke almindelige bivirkninger (kan forekomme hos op til 1 ud af 100 personer): </p>
<ul>
<li>
<p>reaktivering af hepatitis B (hvis du tidligere har haft hepatitis B, kan sygdommen komme igen) </p>
</li>
<li>
<p>blødning i tarmene (blod i afføringen) </p>
</li>
<li>
<p>usædvanlige niveauer af kemikalier i blodet forårsaget af den hurtige nedbrydning af 
kræftceller er sket under behandling af kræft og nogle gange endda uden behandling 
(tumorlysesyndrom) </p>
</li>
</ul>
<p>Ikke kendt:  </p>
<ul>
<li>Rødme og afskalning af huden over et stort område af kroppen, som kan være kløende eller 
smertefuldt (generaliseret eksfoliativ dermatitis) </li>
</ul>
...
<ul>
<li>
<p>Aktivt stof/aktive stoffer: zanubrutinib. Hver kapsel, hård, indeholder 80 mg zanubrutinib. </p>
</li>
<li>
...
BRUKINSA er en hvid til offwhite, hård kapsel med "ZANU 80" påtrykt med sort blæk på den ene 
side. Kapslerne leveres i en plastbeholder med børnesikret lukning. Hver beholder 
