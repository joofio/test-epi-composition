...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>The active substance of CAMCEVI is leuprorelin which is a GnRH-agonist (a synthetic version of a 
natural homone called gonadotropin releasing hormone) and acts in the same way as the natural 
...
- have heart or blood vessel conditions, including heart rhythm problems (arrhythmia), or 
are taking medicines for these conditions. The risk of these heart rhythm problems may 
get worse when using CAMCEVI. Your doctor may monitor your heart using an 
electrocardiogram (ECG); 
- have prostate cancer which has spread into your spine or brain. Your doctor will monitor 
you more closely during first few weeks of treatment; 
- suffer from diabetes mellitus (high blood sugar levels). CAMCEVI can make existing 
diabetes worse and therefore people with diabetes need more frequent testing of blood 
glucose levels. </p>
<p>Talk to your doctor, pharmacist or nurse during treatment with CAMCEVI if you 
- experience a heart attack. Symptoms include chest pain, shortness of breath, dizziness and 
sweating; 
- suffer from a stroke. Symptoms include your face dropping on one side, not being able to lift 
your arms and slurred speech; 
- develop a bone fracture. Treatment with CAMCEVI can increase the risk for fractures due to 
osteoporosis (decrease in bone density); 
- have a fit (convulsions); 
- notice your blood sugar levels go up. Your doctor will monitor your blood glucose levels during 
treatment; 
- have difficulty urinating. There could be a blockage in your urinary tube. Your doctor will 
closely monitor you during the first weeks of treatment; 
- develop symptoms of spinal compression such as pain, numbness, or weakness in the arms, 
hands, legs, or feet. Your doctor will closely monitor you during your first few weeks of 
treatment. </p>
...
treatment. </p>
<p>If CAMCEVI does not help 
Some patients have tumours, that are not sensitive to lower levels of testosterone. Please talk to your 
doctor if you think that the effect of CAMCEVI is too weak. </p>
<p>Other medicines and CAMCEVI 
Tell your doctor or pharmacist if you are taking, have recently taken or might take any other 
medicines. </p>
<p>CAMCEVI might interfere with some medicines used to treat heart rhythm problems (e.g. quinidine, 
procainamide, amiodarone, sotalol, dofetilide and ibutilide) or might increase the risk of heart rhythm 
problems when used with some other medicines, such as methadone (used for pain relief and used as 
heroin substitute when treating drug addicts), moxifloxacin (an antibiotic), and antipsychotic 
medicines used for serious mental illnesses. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>You will be given CAMCEVI as a single injection under your skin (subcutaneous), 
once every 6 months, by your doctor or nurse. </p>
<p>This medicine should only be given to you by your doctor or a nurse, who will ensure it is injected 
properly under the skin and not into a vein. </p>
<p>After injection the medicine becomes solid, and then slowly releases leuprorelin into your body over a 
6-month period. </p>
<p>In combination with radiotherapy 
This medicine can be used before or at the same time as radiotherapy treatment for high-risk localised 
and locally advanced prostate cancer. High-risk localised means that the cancer is likely to spread 
beyond the prostate gland to nearby tissues, becoming locally advanced. Locally advanced means that 
the cancer has spread beyond the pelvis to nearby tissues such as lymph nodes. </p>
<p>Monitoring your treatment 
Your doctor will monitor your response to treatment with blood tests, including prostate-specific 
antigen (PSA). </p>
<p>If you receive more CAMCEVI than you should 
Since the injection is given to you by your doctor or appropriately trained staff, an overdose is 
...
<p>If a dose of CAMCEVI is forgotten 
Talk to you doctor if you believe that your six monthly dose of CAMCEVI has been forgotten. </p>
<p>Effects when treatment with CAMCEVI is stopped 
As a general rule, the therapy for prostate cancer with CAMCEVI requires long-term treatment. 
...
- feeling sick (nausea), diarrhoea, inflammation of the stomach and intestines 
(gastroenteritis/colitis) 
- itching 
- night sweats 
- joint pain, pain in arms and legs, muscle aches and pains 
- needing to urinate more than normal, including during the night, difficulty in urinating, pain 
when urinating, not urinating enough or needing to urinate less frequently; 
- tenderness and/or swelling of the breast, shrinking of testicles, pain in testicles, infertility, 
erectile dysfunction, reduced penis size; 
- episodes of exaggerated shaking with high fever (rigors), weakness, generally feeling 
unwell (malaise) 
- changes in blood laboratory results (prolonged bleeding time, changes in blood values, 
decreased red blood cells/low red blood cell count). </p>
...
- dizziness, headache, partial or total loss of sensation in a part of your body, insomnia, 
abnormal change in taste and/or smell 
...
- constipation, dry mouth, disturbed digestion, with symptoms as full stomach, pain in the 
stomach, belching, nausea, vomiting, burning feeling in the stomach (dyspepsia),, being sick 
(vomiting) 
- feeling clammy and sweaty; 
- back pain, muscle cramps; 
- bladder spasms, blood in urine, over-active bladder (need to urinate before your bladder is 
full), unable to urinate; 
- enlarged breasts, impotence, problems with testicles (e.g. swollen, red or warm scrotum, 
pain or discomfort in pelvic area<br />
- sleepiness (lethargy), pain, fever 
- changes in blood laboratory tests weight gain </p>
...
characterised by headache, double vision and other visual symptoms and ringing or buzzing 
in one or both ears). </p>
<p>The following serious allergic reactions have been reported with medicines in the same group of 
medicines as CAMCEVI 
- difficulty in breathing or dizziness (rarely). </p>
<p>The following side effects have been reported with other medicines containing leuprorelin 
- swelling of hands and feet (oedema); 
- symptoms of a pulmonary embolism (a blood clot in the vessels supplying the lungs), including 
chest pain, breathlessness, difficulty breathing and coughing up blood; 
...
- medical condition in which the bones become brittle and fragile called osteoporosis, and 
therefore there is a higher risk of bone fractures. </p>
<p>The following side effect has been reported with medicines in the same group of medicines as 
CAMCEVI 
- seizures. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What CAMCEVI contains 
- The active substance is leuprorelin. One pre-filled syringe with prolonged-release suspension 
for injection contains leuprorelin mesilate equivalent to 42 mg leuprorelin. 
- The other ingredients are Poly(D,L-lactide) and N-methylpyrrolidone. </p>
<p>What CAMCEVI looks like and contents of the pack 
CAMCEVI is a prolonged-release suspension for injection. The pre-filled syringe has an off-white to 
pale yellow viscous and opalescent suspension. </p>
<p>CAMCEVI is available in a pack containing: 1 pre-filled syringe, 1 needle and 1 Point-Lok needle 
protection device. </p>
...
<p>Der er indberettet alvorlige hududslæt, heriblandt Stevens-Johnsons syndrom, toksisk epidermal 
...
behandling. </p>
<p>Problemer som kan opstå i løbet af de første ugers behandling 
...
indledende stigning af testosteron i dit blod. Du skal muligvis fortsætte med dette andet lægemiddel i 
et par uger i starten af CAMCEVI-behandlingen. </p>
<p>Hvis CAMCEVI ikke hjælper 
Nogle patienter har tumorer, der ikke er følsomme over for lavere niveauer af testosteron. Tal med 
lægen, hvis du tror, at virkningen af CAMCEVI er for svag. </p>
<p>Brug af andre lægemidler sammen med CAMCEVI 
...
<p>CAMCEVI kan påvirke nogle lægemidler mod hjerterytmeproblemer (f.eks. quinidin, procainamid, 
amiodaron, sotalol, dofetilid og ibutilid), eller det kan øge risikoen for hjerterytmeproblemer, når det 
anvendes sammen med andre lægemidler som f.eks. methadon (anvendes ved smertelindring eller som 
heroin-erstatning ved behandling af narkomaner), moxifloxacin (mod infektioner), antipsykotika, der 
anvendes ved alvorlige psykiske sygdomme. </p>
...
<p>Dette lægemiddel må kun gives til dig af din læge eller en sygeplejerske, der vil sikre, at lægemidlet 
indsprøjtes korrekt under huden og ikke i en vene (blodåre). </p>
<p>Det indsprøjtede lægemiddel danner et depot, som derefter langsomt frigiver leuprorelin i din krop 
over en 6-måneders periode. </p>
<p>I kombination med strålebehandling 
Dette lægemiddel kan bruges før eller samtidig med strålebehandling af højrisiko lokaliseret og lokalt 
fremskreden prostatakræft. Højrisiko lokaliseret betyder, at kræften sandsynligvis vil sprede sig ud 
over prostatakirtlen til nærliggende væv og blive lokalt fremskreden. Lokalt fremskreden betyder, at 
kræften har spredt sig ud over bækkenet til nærliggende væv, såsom lymfeknuder. </p>
<p>Overvågning af din behandling 
...
<p>Hvis du har fået for meget CAMCEVI 
Da indsprøjtningen bliver givet til dig af din læge eller behørigt uddannet personale, er en overdosis 
usandsynlig. Hvis du utilsigtet får for meget lægemiddel, vil din læge overvåge dig og give dig 
yderligere behandling efter behov. </p>
<p>Hvis du har glemt at få en dosis CAMCEVI 
Kontakt din læge, hvis du mener, at din halvårlige dosis CAMCEVI er blevet glemt. </p>
<p>Virkninger, når behandling med CAMCEVI ophører 
...
<p>CAMCEVI fås i en pakning med: 1 fyldt sprøjte, 1 kanyle og 1 Point-Lok® kanylebeskyttelsesenhed. </p>
...
<p>Du kan finde yderligere oplysninger om CAMCEVI på Det Europæiske Lægemiddelagenturs 
...
 
Lad CAMCEVI opnå stuetemperatur (15 °C til 25 °C) 
før brug. Dette tager ca. 15 til 20 minutter.<br />
 
Kartonen åbnes på en ren, tør overflade og den fyldte 
CAMCEVI-sprøjte (A) og den hættebeskyttede kanyle 
(B) tages ud af blisterbeholderen. Undersøg alt indholdet 
før brug. Må ikke anvendes, hvis der er ødelagte 
komponenter. 
 
Placér Point-Lok kanylebeskyttelsesenheden, der leveres 
sammen med CAMCEVI, på en sikret, flad overflade. 
 
Tjek udløbsdatoen på sprøjten. Må ikke anvendes, hvis 
udløbsdatoen er overskredet. 
 
Inspicér lægemidlet visuelt før brug. Den fyldte sprøjte 
...
 
Drej den gennemsigtige hætte af kanylens bund (B).<br />
 
Fastgør kanylen (B) til enden af sprøjten (A) ved at 
trykke og dreje, indtil den er fast forbundet. Undgå at 
dreje kanylen for hårdt, så den drejer over gevind for at 
...
<p> 
Vælg et injektionssted på det øvre eller midterste 
abdominale område med tilstrækkeligt blødt eller løst 
subkutant væv, som ikke har været brugt for nylig. 
Injektionsstedet skal varieres med mellemrum. 
 
Injektionsstedet rengøres med en spritserviet. Der må 
IKKE injiceres i områder med muskelvæv eller fibrøst 
subkutant væv eller steder, der kan gnides eller 
komprimeres (dvs. med et bælte eller en 
beklædningslinning). 
 
Træk det blå overtræk af kanylen (B). Tag fat og lav en 
hudfold omkring injektionsstedet med den ene hånd. 
Indsæt kanylen i en vinkel på 90°, og slip derefter 
hudfolden. 
 
Injicér det fulde indhold af sprøjten med et langsomt og 
støt tryk, og træk derefter kanylen ud i den samme 90° 
vinkel, som blev brugt til indsættelse. </p>
<p>Det er vigtigt at undgå intraarteriel eller intravenøs injektion. </p>
<p>Trin 4 - Kassér kanylen og sprøjten 
Kanylebeskyttelse </p>
<p> 
Fjern ikke kanylen fra sprøjten. Brug den vedlagte Point-
Lok® enhed til at undgå kanylestik.<br />
 
Umiddelbart efter brug af kanylen, stikkes den blottede 
kanyle forsigtigt ind i Point-Lok® enhedsåbningen øverst 
på enheden. 
 
Skub kanylen ind i den øverste åbning, indtil den er sat 
ordentligt ind i Point-Lok® enheden. Dette vil forsegle 
kanylespidsen og fastlåse kanylen i enheden. 
 
Efter brug placeres den brugte sprøjte med beskyttet 
kanyle i en passende beholder til skarpe genstande.  </p>
<p>Ikke anvendt lægemiddel samt affald heraf skal bortskaffes i 
...
<p>Under hensyntagen til PRAC's vurderingsrapport om PSUR'en/PSUR'erne for leuprorelin 
(depotformuleringer), er der nået frem til følgende videnskabelige konklusioner:  </p>
<p>I lyset af tilgængelige data om fedtlever fra litteraturen og non-kliniske data og om svære kutane 
bivirkninger (SCAR) fra litteraturen og indberetninger efter markedsføring, vurderer PRAC, at der i 
det mindste er en rimelig mulighed for en kausal sammenhæng mellem leuprorelin og fedtlever og 
SCAR. PRAC har konkluderet, at produktinformationen for produkter, der indeholder leuprorelin, 
...
<p>På baggrund af de videnskabelige konklusioner for leuprorelin (depotformuleringer) er CHMP af 
