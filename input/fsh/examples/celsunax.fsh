...
<ol>
<li>What Celsunax is and what it is used for </li>
<li>What you need to know before Celsunax is used </li>
<li>How Celsunax is used </li>
...
short time. </li>
<li>Because it contains a small amount of radioactivity it can be detected from outside the body using 
special cameras. </li>
<li>A picture, known as a scan, can be taken. This scan will show exactly where the radioactivity is 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Celsunax must not be used 
- if you are allergic to ioflupane or any of the other ingredients of this medicine (listed in 
section 6). 
- if you are pregnant. </p>
<p>Warnings and precautions 
Talk to your nuclear medicine doctor before using this medicine if you have a moderate or severe 
problem with your kidneys or liver. </p>
<p>Before you are given Celsunax you should drink plenty of water before the start of the examination 
in order to urinate as often as possible during the first hours after the study. </p>
<p>Children and adolescents 
Celsunax is not recommended for children and adolescents below 18 years. </p>
...
<p>Do not use Celsunax if you are pregnant or think you may possibly be pregnant. This is because the 
child may receive some of the radioactivity. Alternative techniques which do not involve radioactivity 
should be considered. </p>
<p>If you are breast-feeding, your nuclear medicine doctor may delay the use of Celsunax, or ask you to 
stop breast-feeding. It is not known whether ioflupane (123I) is passed into breast milk. </p>
<ul>
<li>You should not breast-feed your child for 3 days after Celsunax is given. </li>
<li>Instead use formula feed for your child. Express your breast milk regularly and throw away any 
breast milk you have expressed. </li>
<li>You will need to continue to do this for 3 days, until the radioactivity is no longer in your body. </li>
</ul>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>There are strict laws on the use, handling and disposal of radiopharmaceutical medicines. Celsunax will 
always be used in a hospital or a similar place. It will only be handled and given to you by people who 
are trained and qualified to use it safely. They should tell you anything you need to do for the safe use of 
this medicine. </p>
<p>Your nuclear medicine doctor will decide which dose of Celsunax is best for you. It will be the smallest 
quantity necessary to get the desired information. </p>
<p>Before you receive Celsunax, your nuclear medicine doctor will ask you to take some tablets or liquid 
...
<p>Administration of Celsunax and conduct of the procedure<br />
Celsunax is given to you as an injection, usually into a vein in your arm. The recommended 
radioactivity given by injection is between 110 to 185 MBq (megabequerel or MBq is a unit used to 
measure radioactivity). A single injection is enough. </p>
<p>Duration of the procedure 
The camera pictures are usually taken 3 to 6 hours after the injection of this medicine. Your nuclear 
medicine doctor will inform you about the usual duration of the procedure. </p>
<p>After administration of Celsunax, you should urinate frequently in order to eliminate the medicine 
from your body. </p>
...
<p>If you are given more Celsunax than you should 
Since Celsunax is given by a doctor under controlled conditions, it is unlikely that you will get an 
...
<p>The frequency of side effects is: </p>
...
<li>Dry mouth </li>
<li>Vertigo </li>
<li>A brief irritating feeling similar to ants crawling over your skin (formication) </li>
<li>Intense pain (or burning sensation) at the injection site. This has been reported among patients 
receiving Celsunax into a small vein. </li>
</ul>
...
<p>The amount of radioactivity in the body from Celsunax is very small. This low amount of ionising 
radiation is associated with the least risk of cancer and hereditary abnormalities. It will be passed out of 
the body in a few days without need for you to take special precautions. </p>
...
Description: "ePI document Bundle for celsunax Package Leaflet for language en"
Usage: #example
