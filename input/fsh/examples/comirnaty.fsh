...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Comirnaty should not be given 
...
injection or after you were given this vaccine in the past. 
...
such as corticosteroid that affects your immune system. </p>
<p>There is an increased risk of myocarditis (inflammation of the heart muscle) and pericarditis 
...
males. The risk of myocarditis and pericarditis seems lower in children ages 5 to 11 years compared 
with ages 12 to 17 years. Most cases of myocarditis and pericarditis recover. Some cases required 
intensive care support and fatal cases have been seen. Following vaccination, you should be alert to 
signs of myocarditis and pericarditis, such as breathlessness, palpitations and chest pain, and seek 
immediate medical attention should these occur.  </p>
<p>As with any vaccine, Comirnaty may not fully protect all those who receive it and it is not known how 
long you will be protected. </p>
<p>The efficacy of Comirnaty may be lower in people who are immunocompromised. If you are 
immunocompromised, you may receive additional doses of Comirnaty. In these cases, you should 
continue to maintain physical precautions to help prevent COVID-19. In addition, your close contacts 
should be vaccinated as appropriate. Discuss appropriate individual recommendations with your 
doctor. </p>
<p>Children 
Comirnaty 30 micrograms/dose concentrate for dispersion for injection is not recommended for 
children aged under 12 years. </p>
<p>There are paediatric formulations available for infants aged 6 months and above and children below 
12 years of age. For details, please refer to the Package Leaflet for other formulations. </p>
<p>The vaccine is not recommended for infants aged under 6 months. </p>
<p>Other medicines and Comirnaty 
...
receive this vaccine. </p>
<p>Comirnaty can be used during pregnancy. A large amount of information from pregnant women 
...
use machines. </p>
<p>Comirnaty contains potassium and sodium 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Comirnaty is given after dilution as an injection of 0.3 mL into a muscle of your upper arm. </p>
<p>You will receive 1 injection, regardless whether you have received a COVID-19 vaccine before. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Like all vaccines, Comirnaty can cause side effects, although not everybody gets them. </p>
<p>Very common side effects: may affect more than 1 in 10 people 
* injection site: pain, swelling<br />
* tiredness, headache 
* muscle pain, joint pain 
* chills, fever 
* diarrhoea 
Some of these side effects were slightly more frequent in adolescents 12 to 15 years than in adults.  </p>
<p>Common side effects: may affect up to 1 in 10 people 
* injection site redness<br />
* nausea, vomiting 
* enlarged lymph nodes (more frequently observed after a booster dose) </p>
...
* decreased appetite 
* dizziness 
* excessive sweating, night sweats </p>
<p>Rare side effects: may affect up to 1 in 1 000 people 
* temporary one sided facial drooping 
* allergic reactions such as hives or swelling of the face </p>
...
(pericarditis) which can result in breathlessness, palpitations or chest pain  </p>
<p>Not known (cannot be estimated from the available data)<br />
<em> severe allergic reaction<br />
</em> extensive swelling of the vaccinated limb 
...
* heavy menstrual bleeding (most cases appeared to be non-serious and temporary in nature) </p>
...
<p>The following information about storage, expiry and use and handling is intended for healthcare 
professionals. </p>
<p>Do not use this medicine after the expiry date which is stated on the carton and label after EXP. The 
expiry date refers to the last day of that month. </p>
<p>Store in freezer at -90  C to -60  C. Unopened vials may be stored and transported at -25  C to -15  C 
for a single period of up to 2 weeks and can be returned to -90  C to -60  C; not exceeding the printed 
expiry date (EXP). </p>
<p>Store in the original package in order to protect from light. </p>
<p>When stored frozen at -90  C to -60  C, 195-vial packs of the vaccine can be thawed at 2  C to 8  C 
for 3 hours or individual vials can be thawed at room temperature (up to 30  C) for 30 minutes. </p>
<p>Transfers of frozen vials stored at ultra-low temperature (&lt; -60  C)<br />
<em> Closed-lid vial trays containing 195 vials removed from ultra-low temperature frozen storage 
(&lt; -60  C) may be at temperatures up to 25  C for up to 5 minutes.<br />
</em> Open-lid vial trays, or vial trays containing less than 195 vials, removed from ultra-low 
...
must remain in frozen storage for at least 2 hours before they can be removed again. </p>
<p>Transfers of frozen vials stored at -25  C to -15  C 
* Closed-lid vial trays containing 195 vials removed from frozen storage (-25  C to -15  C) may 
be at temperatures up to 25  C for up to 3 minutes.<br />
* Open-lid vial trays, or vial trays containing less than 195 vials, removed from frozen storage 
(-25  C to -15  C) may be at temperatures up to 25  C for up to 1 minute. </p>
<p>Once a vial is removed from the vial tray, it should be thawed for use. </p>
<p>After thawing, the vaccine should be diluted and used immediately. However, in-use stability data 
have demonstrated that once removed from freezer, the undiluted vaccine can be stored for up to 
1 month at 2  C to 8  C; not exceeding the printed expiry date (EXP). Within the 1-month shelf life at 
2  C to 8  C, up to 48 hours may be used for transportation. Prior to use, the unopened vaccine can be 
stored for up to 2 hours at temperatures up to 30  C. </p>
<p>Thawed vials can be handled in room light conditions. </p>
<p>After dilution, store and transport the vaccine at 2  C to 30  C and use within 6 hours. Discard any 
unused vaccine. </p>
<p>Once removed from the freezer and diluted, the vials should be marked with the new discard date and 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Comirnaty contains<br />
* The active substance of COVID-19 mRNA Vaccine (nucleoside modified) is called 
tozinameran. After dilution, the vial contains 6 doses of 0.3 mL with 30 micrograms 
tozinameran each. 
...
<p>What Comirnaty looks like and contents of the pack 
...
* Belgi /Belgique/Belgien, Luxembourg/Luxemburg: Pfizer S.A./N.V., 
T l/Tel: +32 (0)2 554 62 *  :      ,  ,  , Te : +359 2 970 4<em>  esk  republika: Pfizer, spol. s r.o., Tel: +420 283 004 * Danmark: Pfizer ApS, Tlf: +45 44 201 * Deutschland: BioNTech Manufacturing GmbH, Tel: +49 6131 90</em> Eesti: Pfizer Luxembourg SARL Eesti filiaal, Tel: +372 666 7<em>  : Pfizer   A.E.,  .: +30 210 6785 * Espa a: Pfizer, S.L., Tel: +34914909</em> France: Pfizer, T l +33 1 58 07 34 * Hrvatska: Pfizer Croatia d.o.o., Tel: +385 1 3908 * Ireland: Pfizer Healthcare Ireland, Tel: 1800 633 363 (toll free), +44 (0)1304 616<em>  sland: Icepharma hf, Simi: +354 540 8</em> Italia: Pfizer S.r.l., Tel: +39 06 33 18 *  : Pfizer    . . (Cyprus Branch), T : +357 22 817<em> Latvija: Pfizer Luxembourg SARL fili le Latvij ,Tel.: +371 670 35 * Lietuva: Pfizer Luxembourg SARL filialas Lietuvoje, Tel. +370 52 51 4</em> Magyarorsz g: Pfizer Kft, Tel: +36 1 488 3<em> Malta: Vivian Corporation Ltd., Tel: +35621 344</em> Norge: Pfizer AS, Tlf: +47 67 526 * Nederland: Pfizer BV, Tel: +31 (0)10 406 43 *  sterreich: Pfizer Corporation Austria Ges.m.b.H, Tel: +43 (0)1 521 15-0<br />
<em> Polska: Pfizer Polska Sp. z o.o., Tel.: +48 22 335 61 * Portugal: Laborat rios Pfizer, Lda., Tel: +351 21 423 5</em> Rom nia: Pfizer Romania S.R.L, Tel: +40 (0) 21 207 28 * Slovenija: Pfizer Luxembourg SARL, Pfizer, podru nica za svetovanje s podro ja farmacevtske 
dejavnosti, Ljubljana, Tel.: +386 (0) 1 52 11 * Slovensk  republika: Pfizer Luxembourg SARL, organiza n  zlo ka, Tel: +421 2 3355 5* Suomi/Finland: Pfizer Oy, Puh/Tel: +358 (0)9 430 * Sverige: Pfizer AB, Tel: +46 (0)8 550 520 * United Kingdom (Northern Ireland): Pfizer Limited, Tel: +44 (0) 1304 616This leaflet was last revised in  </p>
<p>Scan the code with a mobile device to get the package leaflet in different languages. </p>
<p>URL: www.comirnatyglobal.com  </p>
<p>Detailed information on this medicine is available on the European Medicines Agency website: 
http://www.ema.europa.eu.  </p>
<hr />
<p>The following information is intended for healthcare professionals only: 
Administer Comirnaty intramuscularly after dilution as a single dose of 0.3 mL regardless of prior 
COVID-19 vaccination status.  </p>
<p>For individuals who have previously been vaccinated with a COVID-19 vaccine, Comirnaty should be 
administered at least 3 months after the most recent dose of a COVID-19 vaccine.<br />
Additional doses may be given to individuals who are severely immunocompromised. </p>
<p>Traceability<br />
...
<p>Handling instructions prior to use 
...
* Verify that the vial has a purple plastic cap and the product name is Comirnaty 
30 micrograms/dose concentrate for dispersion for injection (12 years and older).<br />
<em> If the vial has another product name on the label, please make reference to the Summary of 
Product Characteristics for that formulation. 
* The vial is stored frozen and must be thawed prior to dilution. Frozen vials should be transferred 
to an environment of 2  C to 8  C to thaw; a 195-vial pack may take 3 hours to thaw. 
Alternatively, frozen vials may also be thawed for 30 minutes at temperatures up to 30  C for 
immediate use. 
* The unopened vial can be stored for up to 1 month at 2  C to 8  C; not exceeding the printed 
expiry date (EXP). Within the 1-month shelf life at 2  C to 8  C, up to 48 hours may be used for 
transportation.<br />
</em> Allow the thawed vial to come to room temperature. Prior to use, the unopened vial can be 
stored for up to 2 hours at temperatures up to 30  C. Thawed vials can be handled in room light 
conditions. </p>
<p>Dilution 
* Gently invert the vial 10 times prior to dilution. Do not shake. 
* Prior to dilution, the thawed dispersion may contain white to off-white opaque amorphous 
particles.<br />
<em> The thawed vaccine must be diluted in its original vial with 1.8 mL of sodium chloride 
9 mg/mL (0.9%) solution for injection, using a 21 gauge or narrower needle and aseptic 
techniques.<br />
</em> Equalise vial pressure before removing the needle from the vial stopper by withdrawing 1.8 mL 
air into the empty diluent syringe. 
* Gently invert the diluted dispersion 10 times. Do not shake. 
* The diluted vaccine should present as an off-white dispersion with no particulates visible. Do 
not use the diluted vaccine if particulates or discolouration are present. 
* The diluted vials should be marked with the appropriate discard date and time. 
* After dilution, store at 2  C to 30  C and use within 6 hours, including any transportation time.<br />
* Do not freeze or shake the diluted dispersion. If refrigerated, allow the diluted dispersion to 
come to room temperature prior to use. </p>
<p>Preparation of 0.3 mL doses 
* After dilution, the vial contains 2.25 mL from which 6 doses of 0.3 mL can be extracted.<br />
<em> Using aseptic technique, cleanse the vial stopper with a single-use antiseptic swab. 
* Withdraw 0.3 mL of Comirnaty.<br />
Low dead-volume syringes and/or needles should be used in order to extract 6 doses from a 
single vial. The low dead-volume syringe and needle combination should have a dead volume of 
no more than 35 microlitres. If standard syringes and needles are used, there may not be 
sufficient volume to extract a sixth dose from a single vial. 
* Each dose must contain 0.3 mL of vaccine. 
* If the amount of vaccine remaining in the vial cannot provide a full dose of 0.3 mL, discard the 
vial and any excess volume.<br />
</em> Discard any unused vaccine within 6 hours after dilution. </p>
<p>Disposal 
Any unused medicinal product or waste material should be disposed of in accordance with local 
requirements.  </p>
<p>Package leaflet: Information for the user </p>
<p>Comirnaty 30 micrograms/dose dispersion for injection 
Adults and adolescents from 12 years 
COVID-19 mRNA Vaccine<br />
tozinameran </p>
...
<p>Read all of this leaflet carefully before you receive this vaccine because it contains important 
information for you. 
...
2. Det skal du vide, før du begynder at få Comirnaty 
...
<ul>
<li>Hvis du er allergisk over for det aktive stof eller et af de øvrige indholdsstoffer i Comirnaty 
(angivet i punkt 6) </li>
</ul>
<p>Advarsler og forsigtighedsregler 
Kontakt lægen, apotekspersonalet eller sygeplejersken, før du får vaccinen: </p>
<ul>
<li>
<p>du nogensinde har haft en svær allergisk reaktion eller åndedrætsbesvær efter nogen andre 
vaccineinjektioner, eller efter du fik denne vaccine tidligere. </p>
</li>
<li>
<p>du er nervøs for vaccinationsprocessen eller nogensinde er besvimet efter en injektion med en 
kanyle. </p>
</li>
<li>
<p>du har en alvorlig sygdom eller infektion med høj feber. Du kan imidlertid få din vaccination, 
hvis du har let feber eller let infektion i de øvre luftveje, såsom en forkølelse. </p>
</li>
<li>
<p>du har en blødningsforstyrrelse, du let får blå mærker eller du bruger et lægemiddel, der 
forebygger blodpropper. </p>
</li>
<li>
<p>du har et svækket immunsystem, som følge af en sygdom som f.eks. hiv-infektion, eller et 
lægemiddel, såsom kortikosteroid, der påvirker dit immunsystem. </p>
</li>
</ul>
<p>Det er en øget risiko for myokarditis (betændelse i hjertemusklen) og perikarditis (betændelse i hinden 
omkring hjertet) efter vaccination med Comirnaty (se pkt. 4). Disse sygdomme kan udvikle sig inden 
for få dage efter vaccinationen og er primært forekommet inden for 14 dage. De er observeret oftest 
efter den anden vaccination og oftest hos drenge og yngre mænd. Risikoen for myokarditis og 
perikarditis synes at være lavere hos børn i alderen fra 5 til 11 år sammenlignet med alderen fra 12 til 
17 år. De fleste tilfælde af myokarditis og perikarditis går væk. Nogle tilfælde krævede behandling på 
intensivafsnit og der er blevet observeret dødelige tilfælde. Efter vaccinationen skal du være 
opmærksom på tegn på myokarditis og perikarditis, såsom åndenød, hjertebanken og brystsmerter, og 
øjeblikkeligt søge lægehjælp, hvis disse forekommer. </p>
<p>Som for alle vacciner kan det være, at Comirnaty ikke yder fuld beskyttelse til alle dem, der får det, 
og det vides ikke, hvor længe du vil være beskyttet. </p>
<p>Effekten af Comirnaty, selv efter en booster-dosis, kan være lavere hos personer, der er 
immunkompromitterede. Hvis du er immunkompromitteret, kan du få yderligere doser af Comirnaty. 
I disse tilfælde bør du fortsætte med at tage fysiske forholdsregler for at hjælpe med at forebygge 
COVID-19. Desuden bør dine nære kontakter blive vaccineret efter behov. Tal med din læge om de 
anbefalinger, der er hensigtsmæssige for dig. </p>
<p>Børn 
Comirnaty 30 mikrogram/dosis koncentrat til injektionsvæske, dispersion bør ikke anvendes til børn i 
alderen under 12 år. </p>
<p>Pædiatriske formuleringer er tilgængelige til spædbørn i alderen 6 måneder og ældre og til børn under 
12 år. Se indlægssedlen for andre formuleringer for detaljer. </p>
<p>Vaccinen bør ikke anvendes til spædbørn under 6 måneder. </p>
<p>Brug af andre lægemidler sammen med Comirnaty 
Fortæl det altid til lægen eller apotekspersonalet, hvis du bruger andre lægemidler, for nylig har brugt 
andre lægemidler eller planlægger at bruge andre lægemidler, eller hvis du har fået en anden vaccine 
for nylig. </p>
<p>Graviditet og amning 
Hvis du er gravid eller har mistanke om, at du er gravid, skal du fortælle det til din læge, 
sygeplejersken eller apotekspersonalet, før du får denne vaccine. </p>
<p>Comirnaty kan anvendes under graviditeten. En stor mængde information fra gravide kvinder 
vaccineret med Comirnaty i løbet af det andet og tredje trimester har ikke vist nogen negative 
virkninger på graviditeten eller på det nyfødte barn. Selvom der aktuelt er begrænset information om 
virkninger på graviditeten eller på det nyfødte barn efter vaccination i løbet af det første trimester, er 
der ikke observeret nogen ændring i risikoen for spontan abort. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Comirnaty gives som en injektion på 0,3 ml i en muskel i din overarm. </p>
<p>Du vil få 1 injektion, uanset om du tidligere har fået en COVID-19-vaccine. </p>
<p>Hvis du tidligere er vaccineret med en COVID-19-vaccine, bør du ikke få en dosis Comirnaty før 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Comirnaty kan som alle andre vacciner give bivirkninger, men ikke alle får bivirkninger. </p>
<p>Meget almindelige bivirkninger: kan forekomme hos flere end 1 ud af 10 personer </p>
<ul>
<li>
<p>smerter på injektionsstedet, hævelse på injektionsstedet </p>
</li>
<li>
<p>træthed, hovedpine </p>
</li>
<li>
<p>muskelsmerter, ledsmerter </p>
</li>
<li>
<p>kulderystelser, feber </p>
</li>
<li>
<p>diarré 
Nogle af disse bivirkninger var lidt hyppigere hos unge i alderen 12 til 15 år end hos voksne. </p>
</li>
</ul>
...
<li>
<p>forstørrede lymfekirtler (observeret hyppigere efter en booster-dosis) </p>
</li>
</ul>
<p>Ikke almindelige bivirkninger: kan forekomme hos op til 1 ud af 100 personer </p>
<ul>
<li>
<p>utilpashed, følelse af slaphed eller mangel på energi, søvnighed </p>
</li>
<li>
<p>armsmerter </p>
</li>
...
<li>
<p>allergiske reaktioner, såsom udslæt eller kløe </p>
</li>
<li>
<p>nedsat appetit </p>
</li>
...
<li>
<p>overdreven svedtendens, nattesved </p>
</li>
</ul>
<p>Sjældne bivirkninger: kan forekomme hos op til 1 ud af 1 000 personer </p>
<ul>
<li>
<p>den ene side af ansigtet hænger midlertidigt </p>
</li>
<li>
<p>allergiske reaktioner, såsom nældefeber eller hævet ansigt </p>
</li>
</ul>
<p>Meget sjældne bivirkninger: kan forekomme hos op til 1 ud af 10 000 personer </p>
<ul>
<li>betændelse i hjertemusklen (myokarditis) eller betændelse i hinden omkring hjertet 
(perikarditis), som kan medføre åndenød, hjertebanken eller brystsmerter </li>
</ul>
<p>Ikke kendt (kan ikke estimeres ud fra forhåndenværende data)  </p>
<ul>
<li>
<p>svær allergisk reaktion  </p>
</li>
<li>
<p>udbredt hævelse i den vaccinerede arm </p>
</li>
<li>
<p>ansigtshævelse (hævelse af ansigtet kan forekomme hos patienter, der har fået kosmetiske 
ansigtsindsprøjtninger (fillers)) </p>
</li>
<li>
<p>en hudreaktion med røde pletter eller mærker på huden, som kan ligne en skydeskive, da de er 
mørkerøde i midten og omgivet af mere afdæmpede røde ringe (erythema multiforme) </p>
</li>
<li>
<p>usædvanlig følelse i huden, såsom prikkende fornemmelse eller myrekryb (paræstesi) </p>
</li>
<li>
<p>nedsat følelse eller følsomhed, især i huden (hypoæstesi) </p>
</li>
<li>
<p>kraftig menstruationsblødning (de fleste tilfælde syntes at være af ikke alvorlig og midlertidig 
karakter) </p>
</li>
</ul>
...
<p>De følgende oplysninger om opbevaring, udløbsdato og håndtering er til sundhedspersoner. </p>
...
<p>Vaccinen vil blive modtaget frossen ved temperaturer på -90 °C til -60 °C. Frossen vaccine kan 
opbevares ved temperaturer fra enten -90 °C til -60 °C eller ved 2 °C til 8 °C ved modtagelsen. </p>
<p>Enkeltdosis-hætteglas: Når pakninger med 10 enkeltdosis-hætteglas af vaccinen opbevares på frost 
ved temperaturer fra -90 °C til -60 °C, kan de optøs ved 2 °C til 8 °C i 2 timer, eller enkelte hætteglas 
kan optøs ved stuetemperatur (op til 30 °C) i 30 minutter. </p>
<p>Flerdosis-hætteglas: Når pakninger med 10 hætteglas af vaccinen opbevares på frost ved temperaturer 
fra -90 °C til -60 °C, kan de optøs ved 2 °C til 8 °C i 6 timer, eller enkelte hætteglas kan optøs ved 
stuetemperatur (op til 30 °C) i 30 minutter. </p>
<p>Optøede hætteglas: Når vaccinen er blevet fjernet fra fryseren, kan det uåbnede hætteglas opbevares 
og transporteres på køl ved 2 °C til 8 °C i op til 10 uger, forudsat udløbsdatoen (EXP) trykt på pakken 
ikke overskrides. Den ydre æske skal mærkes med den nye udløbsdato ved 2 °C til 8 °C. Efter 
optøning kan vaccinen ikke nedfryses igen. </p>
<p>Inden brug kan de uåbnede hætteglas opbevares i op til 12 timer ved temperaturer på mellem 8 °C og 
30 °C. </p>
<p>Optøede hætteglas kan håndteres i lokalets normale lysforhold. </p>
<p>Åbnede hætteglas: Efter første punktur opbevares vaccinen ved 2 °C til 30 °C, og anvendes inden for 
...
<ul>
<li>
<p>Aktivt stof af COVID-19 mRNA-vaccine (nukleosidmodificeret): kaldes tozinameran. 
− 
Et enkeltdosis-hætteglas indeholder 1 dosis a 0,3 ml, hver med 30 mikrogram 
tozinameran. 
− 
Et flerdosis-hætteglas indeholder 6 doser a 0,3 ml, hver med 30 mikrogram tozinameran. </p>
</li>
<li>
<p>Øvrige indholdsstoffer:</p>
</li>
<li>
<p>((4-hydroxybutyl)azandiyl)bis(hexan-6,1-diyl)bis(2-hexyldecanoat) (ALC-0315) </p>
</li>
<li>2-[(polyethylenglycol)-2000]-N,N-ditetradecylacetamid (ALC-0159) </li>
...
Vaccinen er en hvid til off-white dispersion (pH: 6,9-7,9), der leveres i enten: </p>
<ul>
<li>
<p>et enkeltdosis-hætteglas med 1 dosis i et 2 ml klart hætteglas (type 1-glas), med en gummiprop 
og et gråt ’flip-off’ plasticlåg med aluminiumsforsegling, eller </p>
</li>
<li>
<p>et flerdosis-hætteglas med 6 doser i et 2 ml klart hætteglas (type I-glas), med en gummiprop og 
et gråt ’flip-off’ plasticlåg med aluminiumsforsegling. </p>
</li>
</ul>
...
Rijksweg Puurs-Sint-Amands, 2Belgien </p>
...
<p>Scan koden med mobiludstyr for at få indlægssedlen på forskellige sprog. </p>
<p>URL: www.comirnatyglobal.com  </p>
<p>Du kan finde yderligere oplysninger om dette lægemiddel på Det Europæiske Lægemiddelagenturs 
hjemmeside: http://www.ema.europa.eu. </p>
<hr />
<p>Nedenstående oplysninger er kun til sundhedspersoner: 
Administrer Comirnaty intramuskulært som en enkeltdosis på 0,3 ml uanset tidligere COVID-19-
vaccinationsstatus. </p>
<p>Hvis personen tidligere er vaccineret med en COVID-19-vaccine, bør vedkommende ikke få en dosis 
Comirnaty før mindst 3 måneder efter den seneste dosis.  </p>
<p>Hvis personen er svært immunkompromitteret, vil vedkommende muligvis få yderligere doser. </p>
<p>Sporbarhed 
For at forbedre sporbarheden af biologiske lægemidler, skal det administrerede produkts navn og 
batchnummer tydeligt registreres. </p>
<p>Håndteringsanvisninger før brug 
Comirnaty skal forberedes af en sundhedsperson ved anvendelse af aseptisk teknik for at sikre 
steriliteten af den forberedte dispersion. </p>
<ul>
<li>
<p>Kontrollér, at hætteglasset har et gråt plasticlåg og at produktnavnet er Comirnaty 
30 mikrogram/dosis injektionsvæske, dispersion (12 år og ældre). </p>
</li>
<li>
<p>Hvis hætteglasset har et andet produktnavn på etiketten henvises til produktresuméet for den 
formulering. </p>
</li>
<li>
<p>Hvis hætteglasset opbevares nedfrosset skal det optøs før brug. Frosne hætteglas skal overføres 
til omgivelser på 2 °C til 8 °C for at optø. Sørg for, at hætteglassene er helt optøede inden brug. 
− 
Enkeltdosis-hætteglas: Det kan tage 2 timer at tø en pakning med 10 enkeltdosis-
hætteglas op. 
− 
Flerdosis-hætteglas: Det kan tage 6 timer at tø en pakning med 10 flerdosis-hætteglas op. </p>
</li>
<li>
<p>Når hætteglas flyttes til opbevaring ved 2 °C til 8 °C, skal udløbsdatoen på æsken opdateres. </p>
</li>
<li>
<p>Uåbnede hætteglas kan opbevares i op til 10 uger ved 2 °C til 8 °C, forudsat udløbsdatoen 
(EXP) trykt på pakken ikke overskrides. </p>
</li>
<li>
<p>Alternativt kan individuelle nedfrosne hætteglas optøs i 30 minutter ved temperaturer på op til 
30 °C. Inden brug kan det uåbnede hætteglas opbevares i op til 12 timer ved temperaturer op til 
30 °C. Optøede hætteglas kan håndteres i lokalets normale lysforhold. </p>
</li>
</ul>
<p>Forberedelse af 0,3 ml doser </p>
<ul>
<li>
<p>Bland hætteglassene ved at vende dem forsigtigt rundt 10 gange inden brug. Må ikke omrystes. </p>
</li>
<li>
<p>Inden blanding kan den optøede dispersion indeholde hvide til off-white uigennemsigtige, 
amorfe partikler. </p>
</li>
<li>
<p>Efter blanding skal den fortyndede vaccine være en hvid til off-white dispersion uden synlige 
partikler. Brug ikke vaccinen, hvis den indeholder partikler eller er misfarvet. </p>
</li>
<li>
<p>Tjek om hætteglasset er et enkeltdosis-hætteglas eller et flerdosis-hætteglas og følg de relevante 
håndteringsinstruktioner herunder: 
− 
Enkeltdosis-hætteglas </p>
</li>
<li>
<p>Udtræk en enkelt 0,3 ml dosis vaccine. </p>
</li>
<li>
<p>Kasser hætteglasset og eventuelt overskydende volumen. 
− 
Flerdosis-hætteglas </p>
</li>
<li>
<p>Flerdosis-hætteglas indeholder 6 doser a 0,3 ml. </p>
</li>
<li>
<p>Med en aseptisk teknik rengøres hætteglassets prop med en antiseptisk serviet til 
engangsbrug. </p>
</li>
<li>
<p>Udtræk 0,3 ml Comirnaty. 
Der skal anvendes sprøjter og/eller kanyler med et lille død-volumen for at udtrække 6 doser 
fra et enkelt hætteglas. Kombinationen af sprøjter og kanyler med et lille død-volumen skal 
have et død-volumen på ikke over 35 mikroliter. Hvis der anvendes standardsprøjter og -
kanyler, er der muligvis ikke tilstrækkeligt volumen til at udtrække den 6. dosis fra et enkelt 
hætteglas. </p>
</li>
<li>
<p>Hver dosis skal indeholde 0,3 ml vaccine. </p>
</li>
<li>
<p>Hvis den resterende mængde vaccine i hætteglasset ikke kan levere en fuld dosis på 0,3 ml, skal 
hætteglasset og al overskydende volumen kasseres. </p>
</li>
<li>
<p>Notér den/det pågældende dato/tidspunkt på hætteglasset. Al ikke anvendt vaccine skal kasseres 
inden for 12 timer efter første punktur. </p>
</li>
</ul>
<p>Bortskaffelse 
Ikke anvendt lægemiddel samt affald heraf skal bortskaffes i henhold til lokale retningslinjer. 
Indlægsseddel: Information til brugeren </p>
<p>Comirnaty 10 mikrogram/dosis koncentrat til injektionsvæske, dispersion 
Børn fra 5 til 11 år<br />
...
<p>Læs denne indlægsseddel grundigt, inden dit barn begynder at få denne vaccine, da den 
...
<li>
<p>Spørg dit barns læge, apotekspersonalet eller sygeplejersken, hvis der er mere, du vil vide. </p>
</li>
<li>
