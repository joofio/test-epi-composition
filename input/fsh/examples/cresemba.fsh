...
Instance: composition-en-061484b9147260e88c643074459451f5
...
* identifier.value = "EU/1/15/1036/001"
* status = #final
...
<ol>
<li>What Cresemba is and what it is used for </li>
<li>What you need to know before you use Cresemba</li>
<li>How to use Cresemba</li>
...
* section[=].section[+]
  * title =  "1. What cresemba is and what it is used for"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text =  "1. What cresemba is and what it is used for"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Cresemba is
...
* section[=].section[+]
  * title = "2. What you need to know before you take cresemba"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "2. What you need to know before you take cresemba"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <h2>Do not use Cresemba:</h2>
<p>if you are allergic to isavuconazole or any of the other ingredients of this medicine (listed in 
section 6),
-
...
-
if you have had an allergic reaction to other  azole  anti-fungal treatments in the past, such as 
ketoconazole, fluconazole, itraconazole, voriconazole or posaconazole,
-
if you are suffering from severe liver disease. Your doctor should monitor you for possible side 
effects.
Look out for side effects
Stop using Cresemba and tell your doctor straight away if you notice any of the following 
side effects:
-
sudden wheezing, difficulty breathing, swelling of the face, lips, mouth or tongue, severe 
itching, sweating, dizziness or fainting, fast heartbeat or pounding in the chest   these 
may be signs of a severe allergic reaction (anaphylaxis).
...
-
nafcillin, used for bacterial infections.
Unless your doctor tells you otherwise, do not take this medicine and tell your doctor or pharmacist if 
...
Tell your doctor or pharmacist if you are taking any of the following medicines, as a dose adjustment 
or monitoring may be required to check that the medicines are still having the desired effect: 
-
...
-
daunorubicin, doxorubicin, imatinib, irinotecan, lapatinib, mitoxantrone, topotecan, used for 
...
* section[=].section[+]
  ...
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "3. How to take cresemba"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Cresemba will be given to you by a doctor or nurse.
Starting dose for the first two days (48 hours)
The recommended dose is one vial every 8 hours.
...
If you think you have been given too much Cresemba, talk to your doctor or nurse straight away. You 
...
swelling of the face, lips, mouth or tongue, severe itching, sweating, dizziness or fainting, fast 
heartbeat or pounding in the chest. 
Tell your doctor straight away if you notice any of the following side effects:
-
...
-
severe reduction in blood cells - can make you feel weak, cause bruising or make infections 
more likely,
-
...
-
heart beat problems - may be too fast or uneven, or extra heart beats   this may show in your 
heart tracing (electrocardiogram or ECG),
-
...
-
problems with the skin, red or purple spots on the skin (petechiae), inflamed skin (dermatitis), 
hair loss, 
-
back pain,
-
...
* section[=].section[+]
  ...
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "5. How to store cresemba"
  * text.status = #additional
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <h2>What Cresemba contains</h2>
<p>The active substance is isavuconazole. Each vial contains 372.6 mg isavuconazonium sulfate, 
corresponding to 200 mg isavuconazole.
-
...
Unimedic Pharma AB
Tlf: +46 (0) 10-130 99 Malta
Vivian Corporation Ltd.
Tel: +35621 344Deutschland
PFIZER PHARMA GmbH
...
Instance: composition-da-061484b9147260e88c643074459451f5
InstanceOf: CompositionUvEpi
Title: "Composition for cresemba Package Leaflet"
Description:  "Composition for cresemba Package Leaflet"
Usage: #inline
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Hvad er Cresemba?
...
* section[=].section[+]
  * title = "2. Det skal du vide, før du begynder at tage  cresemba"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "2. Det skal du vide, før du begynder at tage  cresemba"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <h2>Brug ikke Cresemba:</h2>
<p>hvis du er allergisk over for isavuconazol eller et af de øvrige indholdsstoffer i dette lægemiddel 
...
<ul>
<li>lavt blodtryk, stakåndethed, kvalme, svimmelhed, hovedpine, prikken. Din læge vil muligvis 
...
anden medicin eller planlægger at bruge anden medicin. Nogle lægemidler kan påvirke den måde, 
Cresemba virker på, eller Cresemba kan påvirke den måde, lægemidlerne virke på, hvis de tages 
samtidigt.
...
-
saquinavir, fosamprenavir, indinavir, nevirapin, lopinavir/ritonavir-kombination, der bruges til 
behandling af hiv
-
...
* section[=].section[+]
  * title =  "3. Sådan skal du tage cresemba"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "3. Sådan skal du tage cresemba"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Cresemba vil blive givet til dig af en læge eller sygeplejerske.
...
-
en alvorlig allergisk reaktion (anafylaksi) såsom pludselig forekomst af hvæsende vejrtrækning, 
vejrtrækningsbesvær, hævelse i ansigtet, på læberne, i munden eller på tungen, alvorlig kløe, 
sveden, svimmelhed eller besvimelse, hurtig hjerterytme eller hamren i brystet.
...
Bivirkninger for hvilke hyppigheden ikke er kendt:
-
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <h2>Cresemba indeholder</h2>
<p>Aktivt stof: isavuconazol. Hvert hætteglas indeholder 372,6 mg isavuconazoniumsulfat, 
...
injektionsvæske eller 50 mg/ml (5%) dextroseopløsning. Infusionsvæsken indeholder cirka 0,8 mg 
isavuconazol pr. ml. Når det rekonstituerede koncentrat er yderligere fortyndet, kan den fortyndede 
opløsning fremstå med fine hvide til gennemsigtige partikler af isavuconazol, der ikke sedimenterer 
(men fjernes med et rækkefilter). Den fortyndede opløsning skal blandes forsigtigt, eller posen skal 
rulles for at minimere dannelsen af partikler. Unødvendige vibrationer eller kraftig omrystning af 
opløsningen skal undgås. Infusionsvæsken skal administreres via et infusionssæt med et rækkefilter 
...
opbevaringstider og -betingelser efter åbning brugerens eget ansvar og bør ikke være mere end timer ved 2 °C til 8 °C, medmindre rekonstitution og fortynding er sket under kontrollerede og 
...
Instance: bundlepackageleaflet-da-061484b9147260e88c643074459451f5
InstanceOf: BundleUvEpi
Title: "ePI document Bundle for cresemba Package Leaflet for language da"
Description: "ePI document Bundle for cresemba Package Leaflet for language da"
Usage: #example
...
RuleSet: 061484b9147260e88c643074459451f5ListRuleset

* identifier.system = "http://ema.europa.eu/identifier" 
* identifier.value = "None"
* identifier[+].system = "http://spor.ema.europa.eu/v2/medicine-name"
* identifier[=].value = "cresemba"
...
* entry[+]
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-en-061484b9147260e88c643074459451f5) // cresemba en
...
* entry[+]
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-da-061484b9147260e88c643074459451f5) // cresemba da
  * item.extension[0].url = "http://ema.europa.eu/fhir/extension/documentType"
  * item.extension[=].valueCoding = $100000155531#100000155538 "B. PACKAGE LEAFLET"
  * item.extension[+].url = "http://ema.europa.eu/fhir/extension/language"
