...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Cyanokit contains the active substance hydroxocobalamin. 
...
<p>Detailed information for your doctor or other health care professional regarding simultaneous 
administration of Cyanokit with other medicines can be found at the end of this package leaflet (see 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Your doctor or health care professional will give you Cyanokit by infusion into a vein. You may need 
one or two infusions. </p>
<p>You will have the first infusion of Cyanokit over 15 minutes. For adults, the initial dose is 5 g. For 
children, it is 70 mg/kg body weight, up to a maximum dose of 5 g. If you need a second infusion, you 
will have it over 15 minutes to 2 hours. It depends on how serious the poisoning is. The maximum 
total recommended dose is 10 g for adults, and 140 mg/kg in children up to a maximum of 10 g. </p>
...
<p>Each pack contains two vials (each vial packed in one cardboard box), two sterile transfer devices, 
