...
blodforsyningen til hjernen. </p>
<p>Advarsler og forsigtighedsregler 
Før du får denne medicin, skal du fortælle det til din læge eller sygeplejerske, hvis noget af det 
følgende gælder for dig, fordi Dexmedetomidine Accord skal anvendes med forsigtighed:</p>
<ul>
<li>hvis du har en unormalt langsom puls (enten på grund af sygdom eller et højt niveau af fysisk 
kondition), da det kan øge risikoen for hjertestop </li>
...
<li>hvis du har neurologiske forstyrrelser (for eksempel beskadigelse af hovedet eller rygmarven 
eller slagtilfælde) </li>
<li>hvis du har alvorlige leverproblemer </li>
<li>hvis du på noget tidspunkt har udviklet alvorlig feber efter nogle lægemidler, især 
narkosemidler </li>
</ul>
<p>Dette lægemiddel kan forårsage en stor mængde urin og overdreven tørst. Kontakt en læge, hvis disse 
bivirkninger opstår. Se afsnit 4 for mere information. </p>
<p>Der er blevet set en øget dødelighedsrisiko hos patienter på 65 år og derunder ved brug af denne 
...
andre sedativa (beroligende midler). </p>
<p>Brug af anden medicin sammen med Dexmedetomidine Accord 
Fortæl altid lægen eller sygeplejersken, hvis du bruger anden medicin eller har gjort det for nylig.  </p>
<p>De følgende typer af medicin kan forstærke virkningen af Dexmedetomidine Accord:</p>
<ul>
<li>medicin, som hjælper dig med at falde i søvn eller medfører en let bedøvelse (f.eks. midazolam, 
propofol) </li>
<li>stærkt smertestillende medicin (f.eks. opioider såsom morphin, codein) </li>
<li>narkosemidler (f.eks. sevofluran, isofluran). </li>
</ul>
<p>Hvis du tager medicin, som nedsætter dit blodtryk og din puls, kan samtidig anvendelse af 
Dexmedetomidine Accord forstærke denne virkning. Dexmedetomidine Accord må ikke anvendes 
sammen med medicin, der medfører forbigående lammelse.  </p>
<p>Graviditet og amning </p>
<p>Dexmedetomidine Accord bør ikke anvendes under graviditet eller amning, medmindre det er klart 
nødvendigt.  </p>
<p>Spørg din læge til råds, før du får dette lægemiddel. </p>
<p>Trafik- og arbejdssikkerhed </p>
<p>Dexmedetomidine Accord har stor indflydelse på evnen til at føre motorkøretøj og betjene maskiner. 
Når du har fået Dexmedetomidine Accord, må du ikke køre, betjene maskiner eller arbejde i farlige 
situationer, før virkningen er helt væk. Spørg din læge, hvornår du kan begynde på disse aktiviteter, og 
...
<p>Vågen bedøvelse 
En læge eller sygeplejerske giver dig Dexmedetomidine Accord inden og/eller under et diagnostisk 
eller kirurgisk indgreb, det vil sige vågen bedøvelse.  </p>
<p>Din læge bestemmer hvilken dosis der er egnet for dig. Hvor meget Dexmedetomidine Accord du får, 
afhænger af din alder, størrelse, generel helbredstilstand, hvilket bedøvelsesniveau, der er behov for og 
hvordan du reagerer på denne medicin. Din læge kan ændre din dosis, hvis det er nødvendigt, og vil 
kontrollere dit hjerte og blodtryk under behandlingen. </p>
<p>Dexmedetomidine Accord fortyndes, og du får det som infusion (drop) i en blodåre.  </p>
<p>Efter bedøvelse/ved opvågning </p>
<ul>
<li>Lægen vil holde dig under medicinsk overvågning i nogle timer efter bedøvelsen for at sikre sig, 
at du har det godt. </li>
<li>Du skal ikke gå hjem uledsaget. </li>
<li>Medicin, der hjælper dig med at sove, virker bedøvende og stærke smertestillende midler, kan 
være uhensigtsmæssige i nogen tid efter du har fået Dexmedetomidine Accord. Tal med din 
læge om brugen af disse lægemidler og om brugen af alkohol. </li>
</ul>
...
- ændring i vejrtrækningsmønster eller vejrtrækningsstop. </p>
...
- rastløshed 
- høj temperatur 
- symptomer efter at behandling med medicinen er stoppet. </p>
...
- åndenød 
- hallucinationer 
- medicinen har en utilstrækkelig virkning. </p>
...
diabetes insipidus. Kontakt en læge, hvis disse opstår. </p>
...
<p>Der er ingen særlige krav vedrørende opbevaringstemperatur for dette lægemiddel. Opbevar 
hætteglassene i den ydre karton for at beskytte mod lys. </p>
<p>Efter fortynding: 
...
dexmedetomidinhydrochlorid svarende til 100,0 mikrogram dexmedetomidin. </li>
<li>Øvrige indholdsstoffer: natriumchlorid og vand til injektionsvæsker. </li>
</ul>
<p>Hvert 2 ml hætteglas indeholder 200 mikrogram dexmedetomidin (som hydrochlorid). 
Hvert 4 ml hætteglas indeholder 400 mikrogram dexmedetomidin (som hydrochlorid). 
Hvert 10 ml hætteglas indeholder 1.000 mikrogram dexmedetomidin (som hydrochlorid). </p>
<p>Koncentrationen af den færdige infusionsvæske efter fortynding bør være enten 4 mikrogram/ml 
eller 8 mikrogram/ml. </p>
<p>Udseende og pakningsstørrelser 
Koncentrat til infusionsvæske, opløsning<br />
Koncentratet er en klar, farveløs opløsning. </p>
<p>Beholdere 
2, 6 eller 10 ml hætteglas  </p>
...
<p>Dexmedetomidine Accord 100 mikrogram/ml, koncentrat til infusionsvæske, opløsning  </p>
<p>Anvendelsesmåde </p>
<p>Dexmedetomidine Accord må kun administreres af sundhedspersoner, der er kvalificeret til at 
...
<p>Dexmedetomidine Accord kan fortyndes med glucose 50 mg/ml (5 %), Ringerlaktat, mannitol eller 
natriumchlorid 9 mg/ml (0,9 %) injektionsvæske, opløsning for at opnå den ønskede koncentration på 
enten 4 mikrogram/ml eller 8 mikrogram/ml før administrationen. I tabellen nedenfor ses hvilke 
volumina, der er nødvendige for tilberedning af infusionen. </p>
<p>Såfremt den ønskede koncentration er 4 mikrogram/ml: </p>
<p>Volumen af Dexmedetomidine Accord 
100 mikrogram/ml koncentrat til 
infusionsvæske, opløsning 
Volumen af diluent 
Totalt infusionsvolumen<br />
2 ml 
48 ml 
50 ml 
4 ml 
...
<p>Dexmedetomidine Accord skal inspiceres visuelt for partikler og misfarvning før administration. </p>
<p>Dexmedetomidine Accord har vist kompatibilitet ved administrationen sammen med følgende 
intravenøse væsker og lægemidler:  </p>
<p>Ringer laktat, glucoseopløsning 50 mg/ml (5 %), natriumchlorid 9 mg/ml (0,9 %) injektionsvæske, 
...
morphinsulfat, fentanylcitrat og plasmaerstatning.  </p>
<p>Kompatibilitetsstudier har vist et potentiale for adsorption af dexmedetomidin til nogle typer af 
naturgummi. Selvom demedetomidin doseres til virkning, tilrådes det at anvende komponenter med 
syntetiske pakninger eller overtrukne naturgummipakninger. </p>
<p>Opbevaring 
Kemisk og fysisk stabilitet efter åbning er dokumenteret i 72 timer ved 25C og 2° til 8°C. </p>
<p>Ud fra et mikrobiologisk synspunkt skal præparatet bruges med det samme. Anvendelse af andre 
