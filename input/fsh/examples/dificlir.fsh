...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>DIFICLIR is an antibiotic which contains the active substance fidaxomicin. </p>
...
<p>If you feel that you might have a severe allergic reaction such as trouble breathing (dyspnea), swelling 
of the face or throat (angioedema), severe rash, severe itching (pruritus) or severe hives (urticaria), 
stop taking DIFICLIR and seek medical advice urgently from your doctor, pharmacist or at your local 
hospital emergency department (see section 4). </p>
<p>If you are allergic to macrolides (a class of antibiotics), ask your doctor for advice before using this 
medicine. Your doctor will tell you whether this medicine is suitable for you. </p>
<p>If you have kidney or liver problems, ask your doctor for advice before using this medicine. Your 
doctor will tell you whether this medicine is suitable for you. </p>
<p>There are limited data available on the use of fidaxomicin in severe cases of the disease (e.g. 
pseudomembranous colitis). Your doctor will know whether your disease falls in the severe categories 
and will tell you whether this medicine is suitable for you. </p>
<p>Children and adolescents 
Do not give this medicine to children with a body weight below 12.5 kg, because these children 
require a reduced dose. For appropriate dosing in these patients, DIFICLIR granules for oral 
suspension may be used. </p>
...
You should not take DIFICLIR if you are pregnant, unless your doctor tells you otherwise.<br />
This is because it is not known whether fidaxomicin can harm your baby.<br />
If you are pregnant or think you may be pregnant, ask your doctor or pharmacist for advice before 
taking this medicine. </p>
<p>It is not known whether fidaxomicin passes into breast milk, but it is not expected to do so. 
If you are breastfeeding ask your doctor or pharmacist for advice before taking this medicine. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Always take this medicine exactly as your doctor or pharmacist has told you. You should check with 
your doctor or pharmacist if you are not sure. </p>
<p>The standard dosing for patients weighing at least 12.5 kg is one tablet (200 mg) twice daily (one 
tablet every 12 hours) for 10 days (see scheme 1 below). </p>
<p>It is possible that your doctor has prescribed an alternate dosing. The recommendation for an alternate 
dosing is twice daily administration for days 1-5. Do not take a tablet on day 6, then once daily every 
other day for the days 7-25 (see also scheme 2 below). </p>
<p>Scheme 1 - Standard dosing 
DAY 
1 
2 
3 
...
200 mg 
200 mg </p>
<p>Scheme 2 - Alternate dosing 
200 mg - Dificlir 200 mg film-coated tablet 
-      No tablet </p>
<p>Swallow the tablets whole with a glass of water. You can take DIFICLIR before, during or after meals. </p>
<p>DIFICLIR granules for oral suspension should be used for patients with a body weight of less than 
12.5 kg. This form of this medicine (oral suspension) may also be more suitable for patients above 
12.5 kg; ask your doctor or pharmacist. </p>
<p>If you take more DIFICLIR than you should 
If you have taken more tablets than you should have, talk to a doctor. Take the medicine pack with 
you so the doctor knows what you have taken. </p>
<p>If you forget to take DIFICLIR 
Take the tablet as soon as you remember, unless it is time for the next dose. In that case, skip the 
missed dose. Do not take a double dose to make up for a forgotten dose. </p>
<p>If you stop taking DIFICLIR 
...
<p>A severe allergic reaction may occur, including trouble breathing (dyspnea), swelling of the face or 
...
<p>DIFICLIR is also available in the form of granules for oral suspension. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>DIFICLIR er et antibiotikum, som indeholder det aktive stof fidaxomicin.  </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Tag ikke DIFICLIR 
- hvis De er allergisk over for fidaxomicin eller et af de øvrige indholdsstoffer i dette lægemiddel 
(angivet i punkt 6). </p>
<p>Advarsler og forsigtighedsregler 
Kontakt lægen eller apotekspersonalet, før De tager DIFICLIR. </p>
<p>Hvis De føler, at De måske får en alvorlig allergisk reaktion, såsom åndedrætsbesvær, hævelse af 
ansigt eller svælg (angioødem), alvorligt udslæt, svær kløe eller svær nældefeber, skal De stoppe med 
at tage DIFICLIR og straks kontakte Deres læge eller Deres lokale skadestue (se punkt 4). </p>
<p>Hvis De er overfølsom overfor makrolider (en type af antibiotika), skal De spørge Deres læge til råds, 
inden De tager denne medicin. Deres læge vil fortælle Dem, om denne medicin er den rette behandling 
for Dem.  </p>
<p>Hvis De har nyreproblemer eller leverproblemer, skal De spørge Deres læge til råds, inden De bruger 
denne medicin. Deres læge vil fortælle Dem, om denne medicin er den rette behandling for Dem.  </p>
<p>Den aktuelle viden om brug af fidaxomicin i svære sygdomstilfælde (f.eks. pseudomembranøs kolitis) 
...
dosis. For relevant dosering til disse patienter kan DIFICLIR-granulat til oral suspension anvendes. </p>
<p>Brug af anden medicin sammen med DIFICLIR 
...
<p>Blodets indhold af DIFICLIR kan påvirkes af anden medicin De tager, og blodets indhold af anden 
medicin kan blive påvirket ved at tage DIFICLIR. Disse lægemidler er blandt andre:</p>
<ul>
<li>ciclosporin (et lægemiddel, der anvendes til at dæmpe kroppens immunforsvar, og som f.eks. 
...
<li>ketoconazol (et lægemiddel, der anvendes til behandling af svampeinfektioner) </li>
<li>erythromycin (et lægemiddel, der anvendes til behandling af infektioner i øre, næse, hals, 
brystkasse og hud) </li>
<li>clarithromycin (et lægemiddel, der anvendes til at behandle infektioner i brystkasse, hals, 
bihuler, hud og væv samt infektioner med Helicobacter pylori i forbindelse med sår på 
tolvfingertarmen eller mavesår) </li>
<li>verapamil (et lægemiddel, der anvendes til behandling af for højt blodtryk eller til at forebygge 
anfald af brystsmerter eller anvendes efter et hjerteanfald for at forebygge et nyt) </li>
<li>dronedaron og amiodaron (lægemidler, der anvendes til at styre hjerterytmen) </li>
<li>dabigatranetexilat (et lægemiddel, der anvendes til at forebygge blodpropper efter operationer til 
...
bruger denne medicin.  </li>
</ul>
<p>Graviditet og amning 
De bør ikke tage DIFICLIR, hvis De er gravid, medmindre De har aftalt andet med Deres læge.<br />
...
Deres læge eller apotekspersonalet til råds, før De bruger dette lægemiddel.  </p>
<p>Man ved ikke, om fidaxomicin kan passere over i mælk, men det forventes ikke.<br />
...
<p>Standarddoseringen for patienter, der vejer mindst 12,5 kg, er én tablet (200 mg) to gange dagligt (én 
tablet hver 12. time) i 10 dage (se skema 1 nedenfor). </p>
<p>Det er muligt, at Deres læge har ordineret en alternativ dosering, hvor lægemidlet skal tages to gange 
dagligt på dag 1-5. På dag 6 skal lægemidlet ikke tages. Herefter skal lægemidlet tages én gang dagligt 
hver anden dag, på dag 7-25 (se også skema 2 nedenfor). </p>
<p>Skema 1 - Standarddosering 
DAG 
1 
2 
3 
...
<p>200 mg - Dificlir 200 mg filmovertrukket tablet 
-    Ingen tablet </p>
<p>Tabletterne sluges hele sammen med et helt glas vand. De kan tage DIFICLIR før, under og efter 
måltider. </p>
<p>DIFICLIR-granulat til oral suspension skal anvendes til patienter med en vægt under 12,5 kg. Denne 
...
<p>Hvis De har taget for meget DIFICLIR 
Hvis De har taget flere tabletter end De burde, så spørg Deres læge til råds. Tag medicinpakningen 
med til lægen, så lægen ved præcis, hvad De har taget. </p>
<p>Hvis De har glemt at tage DIFICLIR 
Tag én tablet, så snart De husker det, medmindre det er tidspunktet for næste dosis. I så fald, skal den 
glemte tablet springes over. De må ikke tage en dobbeltdosis som erstatning for den glemte tablet. </p>
<p>Hvis De holder op med at tage DIFICLIR 
...
<p>En alvorlig allergisk reaktion kan forekomme, herunder problemer med at trække vejret (dyspnø), 
hævelse af ansigt eller svælg (angioødem), alvorligt udslæt eller svær kløe (pruritus) (se punkt 2). Stop 
med at tage DIFICLIR, hvis en sådan reaktion opstår og kontakt straks Deres læge, apotekspersonalet 
eller Deres lokale skadestue. </p>
<p>DAG 
1 
2 
3 
...
<p>Af andre mulige bivirkninger kan nævnes: 
...
− 
Udslæt, kløe. </p>
<p>Ikke kendt (kan ikke vurderes ud fra forhåndenværende data) 
− 
Hævelse af ansigt og svælg (angioødem), åndedrætsbesvær. </p>
...
<ul>
<li>Aktivt stof: fidaxomicin. Hver filmovertrukken tablet indeholder 200 mg fidaxomicin. </li>
...
<p>DIFICLIR 40 mg/ml granulat til oral suspension 
fidaxomicin </p>
