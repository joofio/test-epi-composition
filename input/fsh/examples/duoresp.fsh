...
* Use DuoResp Spiromax every day.  This helps to prevent asthma symptoms such as breathlessness and 
wheezing from occurring.<br />
* Use DuoResp Spiromax when you need to take extra inhalations or puffs for relief of asthma symptoms, 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not use DuoResp Spiromax if 
...
* you have high blood pressure or you have ever had a heart problem (including an uneven heartbeat, a very 
...
your doctor, pharmacist or nurse for advice before taking DuoResp Spiromax - do NOT use this 
medicine unless your doctor tells you to.<br />
</em> If you get pregnant while using DuoResp Spiromax, do NOT stop using DuoResp Spiromax but talk to 
...
<ul>
<li>It is important to use DuoResp Spiromax every day, even if you have no asthma or COPD symptoms at 
the time.  </li>
<li>If you are using DuoResp Spiromax for asthma, your doctor will want to regularly check your 
symptoms.  </li>
</ul>
<p>Asthma<br />
...
<p>Always keep your DuoResp Spiromax with you and use it to relieve sudden attacks of breathlessness and 
wheezing. </p>
...
<p>If you are doing exercise and you get asthma symptoms, use DuoResp Spiromax as described here.<br />
However, do not use DuoResp Spiromax just before exercise to stop asthma symptoms from happening. It is 
important that you discuss with your doctor the use of DuoResp Spiromax to prevent asthma symptoms from 
happening; how often you exercise or how often you are exposed to allergens could impact the treatment that 
is prescribed to you. </p>
...
<p>Before using your new DuoResp Spiromax for the first time, you need to prepare it for use as follows: 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What DuoResp Spiromax contains<br />
...
dihydrate.<br />
- The other ingredient is lactose monohydrate, which contains milk proteins (see section 2 under 
 DuoResp Spiromax contains lactose ) </p>
<p>What DuoResp Spiromax looks like and contents of the pack 
DuoResp Spiromax is an inhalation powder.<br />
...
T l: +34 91 387 32 Tel.: +48 22 345 93 France 
Teva Sant<br />
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>DuoResp Spiromax indeholder to aktive stoffer: budesonid og formoterolfumaratdihydrat. </p>
<ul>
<li>
...
<p>DuoResp Spiromax er udelukkende beregnet til brug hos voksne og unge i alderen 12 år og 
derover.  </p>
<p>Din læge har ordineret denne medicin til behandling af astma eller kronisk obstruktiv lungesygdom 
(KOL).  </p>
<p>Astma 
DuoResp Spiromax kan ordineres for astma på to måder. </p>
<p>a) Du kan få ordineret to astma-inhalatorer: DuoResp Spiromax sammen med en separat 
inhalator med anfaldsmedicin, såsom salbutamol. </p>
<ul>
<li>
<p>Brug DuoResp Spiromax hver dag. Dette hjælper med at forebygge astmasymptomer som 
åndenød og hvæsen.  </p>
</li>
<li>
...
<p>b) Du kan få ordineret DuoResp Spiromax som din eneste astma-inhalator. </p>
<ul>
<li>
<p>Brug DuoResp Spiromax hver dag. Dette hjælper med at forebygge astmasymptomer som 
åndenød og hvæsen.  </p>
...
<li>
<p>Brug også DuoResp Spiromax, når du har brug for ekstra inhalationer eller pust til lindring af 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Brug ikke DuoResp Spiromax 
Hvis du er allergisk over for budesonid, formoterolfumaratdihydrat eller det øvrige indholdsstof i 
DuoResp Spiromax (angivet i punkt 6). </p>
<p>Advarsler og forsigtighedsregler<br />
Kontakt lægen, apotekspersonalet eller sundhedspersonalet, før du bruger DuoResp Spiromax, hvis </p>
<ul>
<li>
...
tager, når du begynder at bruge DuoResp Spiromax. Hvis du har taget steroidtabletter i lang tid, vil din 
...
er i tvivl om, hvorvidt du skal fortsætte med at bruge DuoResp Spiromax. </p>
...
<p>Brug af anden medicin sammen med DuoResp Spiromax 
...
<p>Nogle lægemidler kan øge virkningen af DuoResp Spiromax, og din læge vil overvåge dig 
omhyggeligt, hvis du tager sådanne lægemidler (inklusive visse former for HIV-medicin, herunder 
ritonavir og cobicistat). </p>
<p>Hvis noget af ovenstående gælder for dig, eller hvis du ikke er sikker, så tal med din læge, 
apotekspersonalet eller sundhedspersonalet, før du bruger DuoResp Spiromax. </p>
...
DuoResp Spiromax - brug IKKE denne medicin, medmindre din læge beder dig om det.  </p>
</li>
<li>
<p>Hvis du bliver gravid, mens du bruger DuoResp Spiromax, skal du IKKE holde op med at bruge 
DuoResp Spiromax, men straks tale med din læge. </p>
</li>
</ul>
<p>Trafik- og arbejdssikkerhed 
Det er ikke sandsynligt, at DuoResp Spiromax vil påvirke din evne til at køre motorkøretøj eller 
betjene maskiner. </p>
...
<ul>
<li>
<p>Det er vigtigt, at du bruger DuoResp Spiromax hver dag, også selvom du ikke har nogen astma- eller KOL-symptomer på det pågældende tidspunkt.  </p>
</li>
<li>
<p>Hvis du bruger DuoResp Spiromax mod astma, vil din læge ønske at kontrollere dine 
symptomer med jævne mellemrum.  </p>
</li>
</ul>
<p>Astma<br />
DuoResp Spiromax kan ordineres for astma på to måder. Den mængde DuoResp Spiromax, du skal 
bruge, og hvornår du skal bruge den, afhænger af, hvordan den er ordineret til dig.  </p>
<ul>
<li>
<p>Hvis du har fået ordineret DuoResp Spiromax og en særskilt inhalator med anfaldsmedicin, skal 
du læse afsnittet (A) Brug af DuoResp Spiromax og en særskilt inhalator med 
anfaldsmedicin.  </p>
</li>
<li>
<p>Hvis du har fået ordineret DuoResp Spiromax som din eneste inhalator, skal du læse afsnittet 
(B) Brug af DuoResp Spiromax som din eneste astma-inhalator. </p>
</li>
</ul>
<p>(A) Brug af DuoResp Spiromax og en særskilt inhalator med anfaldsmedicin.<br />
Brug DuoResp Spiromax hver dag. Dette hjælper med at forebygge astmasymptomer.  </p>
...
er tilgængelig med din DuoResp Spiromax, kan din læge ordinere en anden inhalator, som indeholder 
de samme aktive stoffer som DuoResp Spiromax, men med en lavere dosis kortikosteroid. Hvis dine 
symptomer er helt under kontrol, vil din læge muligvis bede dig om at tage din medicin en gang 
dagligt. Men husk, du må ikke justere antallet af inhalationer, som din læge har ordineret, uden først at 
have talt med din læge. </p>
...
åndenød og hvæsen. Brug ikke DuoResp Spiromax til at behandle disse astmasymptomer. </p>
<p>(B) Brug af DuoResp Spiromax som din eneste astmainhalator 
Brug kun DuoResp Spiromax på denne måde, hvis lægen har bedt dig om det.  </p>
<p>Brug DuoResp Spiromax hver dag. Dette hjælper med at forebygge astmasymptomer. </p>
<p>Anbefalet dosis<br />
...
<p>Brug også DuoResp Spiromax som anfaldsmedicin til behandling af astmasymptomer, når de opstår, 
og til at forebygge, at der opstår astmasymptomer (f.eks. under motion eller hvis du udsættes for 
allergener).  </p>
<ul>
<li>
...
<p>Hav altid din DuoResp Spiromax på dig og brug den til at afhjælpe pludselige anfald af åndenød og 
hvæsen.  </p>
...
<p>Hvis du dyrker motion, og du får astmasymptomer, skal du bruge DuoResp Spiromax som beskrevet 
her. Du må imidlertid ikke bruge DuoResp Spiromax lige før, du dyrker motion, for at forhindre, at 
der opstår astmasymptomer. Det er vigtigt, at du diskuterer din brug af DuoResp Spiromax med lægen 
til at forebygge, at der opstår astmasymptomer. Hvor ofte du dyrker motion, og hvor ofte du udsættes 
for allergener kan evt. påvirke den behandling, du har fået ordineret. </p>
...
<p>Inden du bruger din nye DuoResp Spiromax første gang, skal du gøre den klar til brug på følgende 
måde: </p>
<ul>
<li>
...
<ol>
<li>
<p>Åbn mundstykkets låg ved at folde det ned, indtil der høres et højt klik. Din medicin afmåles 
automatisk. Din inhalator er nu klar til brug. </p>
</li>
<li>
...
<li>
<p>Dosisindikatoren på bagsiden af enheden viser de lige antal resterende inhalationer. </p>
</li>
<li>
<p>Mellemrummene mellem de lige numre viser de ulige antal resterende inhalationer. </p>
</li>
<li>
...
<p>Hvis du føler, at du bliver forpustet eller trækker vejret med en hvæsende lyd, mens du bruger 
DuoResp Spiromax, skal du fortsætte med at bruge DuoResp Spiromax, men søge læge så hurtigt som 
muligt, da du måske har brug for yderligere behandling. </p>
...
<p>Når din astma er velkontrolleret, kan din læge finde det hensigtsmæssigt gradvist at reducere DuoResp 
Spiromax-dosen. </p>
<p>Hvis du har taget for meget DuoResp Spiromax 
...
<p>Hvis du har brugt for meget DuoResp Spiromax, skal du kontakte lægen, apotekspersonalet eller 
sundhedspersonalet. 
De hyppigste symptomer, der kan opstå efter, du har taget for meget DuoResp Spiromax, er rysten, 
hovedpine eller hurtig hjerterytme (puls).  </p>
<p>Hvis du har glemt at bruge DuoResp Spiromax 
...
<p>Hvis noget af følgende sker for dig, skal du holde op med at bruge DuoResp Spiromax og straks 
tale med din læge:  </p>
...
skal du straks holde op med at bruge DuoResp Spiromax og bruge din inhalator med 
...
<p>Kontakt lægen, hvis du oplever nogle af følgende symptomer, mens du tager DuoResp Spiromax. Det 
...
<li>
<p>Forhøjet sukker (glucose) i blodet </p>
</li>
<li>
<p>Smagsændringer, såsom en ubehagelig smag i munden, når du får taget en blodprøve </p>
</li>
<li>
...
<li>Øvrige indholdsstoffer: lactosemonohydrat, som indeholder mælkeproteiner (se punkt 2 under 
’DuoResp Spiromax indeholder lactose’)  </li>
</ul>
<p>Udseende og pakningsstørrelser </p>
<p>DuoResp Spiromax er et inhalationspulver.<br />
Hver DuoResp Spiromax inhalator indeholder 120 inhalationer og har en hvid hoveddel med et 
...
Mogilska 80 Str. 31-546 Kraków<br />
Polen </p>
