...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>ECALTA contains the active substance anidulafungin and is prescribed in adults and in paediatric 
patients aged 1 month to less than 18 years to treat a type of fungal infection of the blood or other 
internal organs called invasive candidiasis. The infection is caused by fungal cells (yeasts) called 
Candida. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not use ECALTA 
- if you are allergic to anidulafungin, other echinocandins (e.g. caspofungin acetate), or any of the 
...
<p>Your doctor may decide to monitor you 
- for liver function more closely if you develop liver problems during your treatment 
- if you are given anaesthetics during your treatment with ECALTA<br />
...
- for shortness of breath/breathing difficulties, dizziness or lightheadedness </p>
...
<p>The effect of ECALTA in pregnant women is not known. Therefore, ECALTA is not recommended 
during pregnancy. Effective contraception should be used in women of childbearing age. Contact your 
doctor immediately if you become pregnant while taking ECALTA. </p>
<p>The effect of ECALTA in breast-feeding women is not known. Ask your doctor or pharmacist for 
advice before taking ECALTA while breast-feeding. </p>
<p>Ask your doctor or pharmacist for advice before taking any medicines. </p>
<p>ECALTA contains fructose </p>
<p>This medicine contains 119 mg fructose (a type of sugar) in each vial. If you have been told by your 
doctor that you have an intolerance to some sugars, contact your doctor before taking this medicinal 
product. </p>
<p>If you (or your child) have hereditary fructose intolerance (HFI), a rare genetic disorder, you (or your 
child) must not receive this medicine. Patients with HFI cannot break down fructose in this medicine, 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>ECALTA will always be prepared and given to you or your child by a doctor or a healthcare 
professional (there is more information about the method of preparation at the end of the leaflet in the 
section for medical and healthcare professionals only). </p>
<p>For use in adults, the treatment starts with 200 mg on the first day (loading dose). This will be 
followed by a daily dose of 100 mg (maintenance dose). </p>
<p>For use in children and adolescents (age from 1 month to less than 18 years), the treatment starts with 
3.0 mg/kg (not to exceed 200 mg) on the first day (loading dose). This will be followed by a daily dose 
of 1.5 mg/kg (not to exceed 100 mg) (maintenance dose). The dose that is given depends on the 
patient s weight. </p>
<p>ECALTA should be given to you once a day, by slow infusion (a drip) into your vein. For adults, this 
will take at least 1.5 hours for the maintenance dose and 3 hours for the loading dose. For children and 
adolescents, the infusion may take less time depending on the patient s weight. </p>
<p>Your doctor will determine the duration of your treatment and how much ECALTA you will receive 
each day and will monitor your response and condition. </p>
<p>In general, your treatment should continue for at least 14 days after the last day Candida was found in 
your blood. </p>
<p>If you receive more ECALTA than you should </p>
<p>If you are concerned that you may have been given too much ECALTA, tell your doctor or another 
healthcare professional immediately. </p>
<p>If you forgot to use ECALTA </p>
<p>As you will be given this medicine under close medical supervision, it is unlikely that a dose would be 
...
<p>You should not experience any effects from ECALTA if your doctor stops ECALTA treatment. </p>
...
these side effects will be noted by your doctor while monitoring your response and condition. </p>
<p>Life-threatening allergic reactions that might include difficulty breathing with wheezing or worsening 
of an existing rash have been rarely reported during administration of ECALTA. </p>
<p>Serious side effects   tell your doctor or another healthcare professional immediately should any 
...
<li>Hot flush </li>
<li>Hives </li>
<li>Sudden contraction of the muscles around the airways resulting in wheezing or coughing </li>
...
<li>Abnormal flow of bile from the gallbladder into the intestine (cholestasis) </li>
...
<p>Not known (frequency cannot be estimated from the available data) are:</p>
<ul>
...
<ul>
<li>The active substance is anidulafungin. Each vial of powder contains 100 mg anidulafungin.  </li>
<li>The other ingredients are: fructose (see section 2  ECALTA contains fructose ), mannitol, 
polysorbate 80, tartaric acid, sodium hydroxide (for pH-adjustment) (see section 2  ECALTA 
contains sodium ), hydrochloric acid (for pH-adjustment) </li>
</ul>
<p>What ECALTA looks like and contents of the pack </p>
<p>ECALTA is supplied as a box containing 1 vial of 100 mg powder for concentrate for solution for 
infusion. </p>
<p>The powder is white to off-white. </p>
<p>Marketing Authorisation Holder </p>
<p>Pfizer Europe MA EEIG, Boulevard de la Plaine 17, 1050 Bruxelles, Belgium </p>
<p>Manufacturer </p>
<p>Pfizer Manufacturing Belgium NV, Rijksweg 12, 2870 Puurs-Sint-Amands, Belgium </p>
