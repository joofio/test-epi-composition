...
Instance: composition-en-9601a69cc77fa33a3d0e2e4ba9d747e9
...
* identifier.value = "EU/1/11/736/001"
* status = #final
...
<ol>
<li>What EDURANT is and what it is used for</li>
<li>What you need to know before you take EDURANT</li>
<li>How to take EDURANT</li>
...
* section[=].section[+]
  * title =  "1. What edurant is and what it is used for"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text =  "1. What edurant is and what it is used for"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>EDURANT contains rilpivirine that is used for the treatment of Human Immunodeficiency Virus 
(HIV) infection. It belongs to a group of HIV medicines called non-nucleoside reverse transcriptase 
inhibitors (NNRTIs). EDURANT works by reducing the amount of HIV in your body.
...
* section[=].section[+]
  * title = "2. What you need to know before you take edurant"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "2. What you need to know before you take edurant"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not take EDURANT if you are allergic to rilpivirine or any of the other ingredients of this 
medicine (listed in section 6).
Do not take EDURANT in combination with any of the following medicines as they may affect the 
...
that are medicines to prevent and treat stomach ulcers, heartburn or acid reflux disease)
-
dexamethasone (a corticosteroid used in a variety of conditions such as inflammation and 
allergic reactions) when taken by mouth or injected, except as a single dose treatment
-
...
EDURANT is not a cure for HIV infection. It is part of a treatment reducing the amount of virus in the 
blood. 
EDURANT has only been used in a limited number of patients of 65 years or older. If you belong to 
this age group, please discuss the use of EDURANT with your doctor.
...
-
Tell your doctor if you have or have had problems with your liver, including 
...
chills, sweats). In some patients with advanced HIV infection and a history of opportunistic
infection, signs and symptoms of inflammation from previous infections may occur soon after 
HIV treatment is started. It is believed that these symptoms are due to an improvement in the 
...
necessary treatment.
-
Tell your doctor if you are taking any medicines that may cause a life-threatening irregular 
heartbeat (Torsade de Pointes).
Children
EDURANT is not for use in children less than 12 years of age, because it has not been sufficiently 
studied in these patients.
Other medicines and EDURANT
You must take EDURANT together with other HIV medicines. Your doctor will advise on which HIV 
medicines can be combined with EDURANT and together you will decide which combination fits 
your needs best. Follow your doctor s instruction carefully.
Some medicines may affect the levels of EDURANT in the blood when they are taken at the same 
time as EDURANT.
Tell your doctor or pharmacist if you are taking, have recently taken or might take any other 
medicines.
It is not recommended to combine EDURANT with other non-nucleoside reverse transcriptase 
inhibitors (NNRTIs) such as delavirdine, efavirenz, etravirine, and nevirapine.
The effects of EDURANT or other medicines might be influenced if you take EDURANT together 
with any of the following medicines. Tell your doctor if you take:
-
rifabutin (a medicine to treat some bacterial infections). If you take this medicine while taking 
EDURANT, please carefully read how to take EDURANT in section 3  Instructions for proper 
use in adults and adolescents (12 to less than 18 years of age) .
-
clarithromycin, erythromycin (antibiotics)
-
cimetidine, famotidine, nizatidine, ranitidine (H2-receptor antagonists used to treat stomach or 
intestinal ulcers or used to relieve heartburn due to acid reflux). If you take these medicines, 
please carefully read how to take them in section 3  Instructions for proper use in adults and 
adolescents (12 to less than 18 years of age) .
-
antacids (used to treat diseases related to the acid in the stomach; for example, 
aluminium/magnesium hydroxide, calcium carbonate). If you take these medicines, please 
carefully read how to take them in section 3  Instructions for proper use in adults and 
adolescents (12 to less than 18 years of age) .
-
...
Tell your doctor immediately if you are pregnant or if you plan to become pregnant. Pregnant women 
should discuss the use of EDURANT with their doctor.
...
* section[=].section[+]
  ...
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "3. How to take edurant"
  * text.status = #additional
...
EDURANT must be taken with a meal. A meal is important to get the right levels of active 
substance in your body. A nutritional drink (e.g. protein-rich) alone does not replace a meal.
There are four situations that require special attention:
1. If you take rifabutin (a medicine to treat some bacterial infections), take two tablets of 
EDURANT once a day. When you stop taking rifabutin, take one tablet of EDURANT once a 
day. Talk to your doctor or pharmacist if you are not sure.
2. If you take an antacid (a medicine to treat diseases related to the acid in the stomach such as 
aluminium / magnesium hydroxide, calcium carbonate). Take the antacid either at least 2 hours 
before or at least 4 hours after EDURANT (see section 2  Other medicines and EDURANT ).
3. If you take an H2-receptor antagonist (medicines used to treat stomach or intestinal ulcers or 
used to relieve heartburn due to acid reflux (such as cimetidine, famotidine, nizatidine or 
ranitidine). Take the H2-receptor antagonist at least 12 hours before or at least 4 hours after 
EDURANT (see section 2  Other medicines and EDURANT ). H2-receptor antagonists should 
not be taken in a twice a day regimen. Talk to your doctor about an alternative regimen.
4. If you take didanosine (a medicine to treat HIV infection), no dose adjustment is required. 
Didanosine should be administered on an empty stomach at least two hours before or at least 
four hours after EDURANT (which must be taken with a meal).
Removing the child resistant cap
The bottle comes with a child resistant cap. It can be opened by pushing the screw 
cap down while turning it anti-clockwise.
If you take more EDURANT than you should
Contact your doctor or pharmacist immediately. In case of overdose, you may have a headache, 
nausea, dizziness, and/or abnormal dreams.
If you forget to take EDURANT
If you notice within 12 hours of the time you usually take EDURANT, you must take the tablet as 
soon as possible. The EDURANT tablet must be taken with a meal. Then take the next dose as usual. 
If you notice after 12 hours, then skip that dose and take the next doses as usual.
Do not take a double dose to make up for a forgotten dose.
If you vomit less than 4 hours after taking EDURANT, take another tablet with a meal. If you vomit 
more than 4 hours after taking EDURANT you do not need to take another tablet until your next 
...
dizziness
-
changes in one of your routine liver tests (transaminase)
-
...
triglycerides, lipase and/or bilirubin in your blood
Uncommon:
-
...
* section[=].section[+]
  ...
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "5. How to store edurant"
  * text.status = #additional
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <h2>What EDURANT contains</h2>
<p>The active substance is rilpivirine in the form of rilpivirine hydrochloride. Each tablet of 
EDURANT contains rilpivirine hydrochloride equivalent to 25 mg rilpivirine.
-
The other ingredients of the film-coated tablet core are lactose monohydrate, croscarmellose 
sodium, povidone K30, polysorbate 20, silicified microcrystalline cellulose and magnesium 
stearate. The film-coating contains lactose monohydrate, hypromellose 2910 6 mPa.s, titanium 
dioxide E171, macrogol 3000 and triacetin.
What EDURANT looks like and contents of the pack
White to off-white, film-coated, round, biconvex tablet, with  TMC  on one side and  25  on the 
other side.
...
Instance: composition-da-9601a69cc77fa33a3d0e2e4ba9d747e9
InstanceOf: CompositionUvEpi
Title: "Composition for edurant Package Leaflet"
Description:  "Composition for edurant Package Leaflet"
Usage: #inline
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>EDURANT indeholder rilpivirin, der anvendes til behandling af hiv-infektion (dvs. smitte med 
...
* section[=].section[+]
  ...
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "2. Det skal du vide, før du begynder at tage  edurant"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Tag ikke EDURANT, hvis du er allergisk over for rilpivirin eller et af de øvrige indholdsstoffer i 
...
34
-
cimetidin, famotidin, nizatidin, ranitidin (H2-receptorantagonister til behandling af mavesår eller 
...
* section[=].section[+]
  ...
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "3. Sådan skal du tage edurant"
  * text.status = #additional
...
1. Hvis du tager ribabutin (medicin til behandling af visse infektioner, der skyldes bakterier): 
...
tvivl.
2. Hvis du tager et antacidum (medicin, der bruges til behandling af sygdomme, der forbindes 
...
3. Hvis du tager en H2-receptorantagonist (medicin, der bruges til behandling af mavesår eller 
sår på tarmen eller til lindring af halsbrand, der skyldes tilbageløb af syre (f.eks. cimetidin, 
35
famotidin, nizatidin eller ranitidin)). Tag H2-receptorantagonisten mindst 12 timer før eller 
mindst 4 timer efter EDURANT (se "Brug af anden medicin sammen med EDURANT" under
pkt. 2). H2-receptorantagonister bør ikke tages to gange dagligt. Spørg lægen, om du kan 
anvende et andet doseringsmønster.
4. Hvis du tager didanosin (medicin til behandling af hiv-infektion), er der ikke behov for 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <h2>EDURANT indeholder:</h2>
<p>Aktivt stof: rilpivirin i form af rilpivirinhydrochlorid. Hver EDURANT tablet indeholder 
...
Instance: bundlepackageleaflet-en-9601a69cc77fa33a3d0e2e4ba9d747e9
InstanceOf: BundleUvEpi
Title: "ePI document Bundle for edurant Package Leaflet for language en"
Description: "ePI document Bundle for edurant Package Leaflet for language en"
Usage: #example
...
// Composition
* entry[0].fullUrl = "Composition/composition-en-9601a69cc77fa33a3d0e2e4ba9d747e9"
* entry[0].resource = composition-en-9601a69cc77fa33a3d0e2e4ba9d747e9
...
Instance: bundlepackageleaflet-da-9601a69cc77fa33a3d0e2e4ba9d747e9
InstanceOf: BundleUvEpi
Title: "ePI document Bundle for edurant Package Leaflet for language da"
Description: "ePI document Bundle for edurant Package Leaflet for language da"
Usage: #example
...
RuleSet: 9601a69cc77fa33a3d0e2e4ba9d747e9ListRuleset

* identifier.system = "http://ema.europa.eu/identifier" 
* identifier.value = "None"
* identifier[+].system = "http://spor.ema.europa.eu/v2/medicine-name"
* identifier[=].value = "edurant"
...
* entry[+]
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-en-9601a69cc77fa33a3d0e2e4ba9d747e9) // edurant en
...
* entry[+]
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-da-9601a69cc77fa33a3d0e2e4ba9d747e9) // edurant da
  * item.extension[0].url = "http://ema.europa.eu/fhir/extension/documentType"
  * item.extension[=].valueCoding = $100000155531#100000155538 "B. PACKAGE LEAFLET"
  * item.extension[+].url = "http://ema.europa.eu/fhir/extension/language"
