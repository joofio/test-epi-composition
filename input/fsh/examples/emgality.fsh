...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Emgality contains galcanezumab, a medicine that stops the activity of a naturally occurring substance 
in the body called calcitonin gene-related peptide (CGRP). People with migraine may have increased 
levels of CGRP.  </p>
...
<ul>
<li>if you are allergic to galcanezumab or any of the other ingredients of this medicine (listed in 
section 6).   </li>
</ul>
<p>Warnings and precautions<br />
Talk to your doctor, pharmacist or nurse before or during treatment with Emgality if:</p>
<ul>
<li>you have a serious cardiovascular disease. Emgality has not been studied in patients with 
serious cardiovascular diseases. </li>
</ul>
<p>Look out for allergic reactions 
Emgality can potentially cause serious allergic reactions. Serious allergic reactions happen mainly 
within 1 day after having taken Emgality, but some reactions can be delayed (happen more than 1 day 
to 4 weeks after having taken Emgality). Some allergic reactions can be prolonged in duration. You 
must look out for signs of these reactions while you are using Emgality. Stop using Emgality and tell 
your doctor or seek medical help immediately if you notice any signs of a serious allergic reaction. 
Such signs are listed under  Serious side effects  in section 4. Children and adolescents 
...
If you are a woman able to have children, you are advised to avoid becoming pregnant while using 
Emgality.  </p>
<p>If you are pregnant, think you may be pregnant or are planning to have a baby, ask your doctor for 
advice before taking this medicine. It is preferable to avoid the use of Emgality in pregnancy as the 
effects of this medicine in pregnant women are not known.  </p>
<p>If you are breast-feeding or are planning to breast-feed, talk to your doctor before using this medicine. 
You and your doctor should decide if you should breast feed and use Emgality .    </p>
<p>Driving and using machines<br />
Galcanezumab could have a minor effect on your ability to drive and use machines. Some patients 
...
<p>Emgality pre-filled pen is for single use only and contains one dose of Emgality (120 mg).  <br />
- The first time you receive Emgality your doctor or nurse will inject two pens (total 240 mg).<br />
- After the first dose, you will use one pen (120 mg) every month. </p>
<p>Your doctor will decide for how long you should use Emgality. </p>
<p>Emgality is given by injection under your skin (subcutaneous injection). You and your doctor or nurse 
should decide if you can inject Emgality yourself. </p>
<p>It is important not to try to inject yourself until you have been trained by your doctor or nurse. A 
caregiver may also give you your Emgality injection after proper training.  </p>
<p>The pen must not be shaken. </p>
<p>Read the  Instructions for Use  for the pen carefully before using Emgality. </p>
<p>If you use more Emgality than you should<br />
If you have injected more Emgality than you should, e.g. if after the first dose of 240 mg, you have 
injected it twice in a single month, or if anyone else has accidentally used Emgality, contact your 
doctor immediately. </p>
<p>If you forget to use Emgality<br />
Do not take a double dose to make up for forgotten injection   </p>
<p>If you have forgotten to inject a dose of Emgality, inject the missed dose as soon as possible and then 
...
<p>Allergic reactions with Emgality are usually mild to moderate (such as rash or itching). Serious 
allergic reactions may occur rarely (may affect up to 1 in 1 000 people) and the signs may include:<br />
...
<p>Tell your doctor or get emergency medical help straight away if you notice any of those signs. </p>
...
<li>Injection site reactions (e.g. red skin, itching, bruising, swelling)  </li>
</ul>
...
<p>Do not use this medicine after the expiry date which is stated on the label and on the carton after 
...
<p>Emgality may be stored unrefrigerated for a single period up to 7 days when stored at temperatures up 
to 30  C. If the pen is stored at a higher temperature or for a longer period it must be discarded.  </p>
<p>Do not use this medicine if you notice that the pen is damaged, or the medicine is cloudy or has 
particles in it.   </p>
...
The active substance is galcanezumab.  Each pre-filled pen contains 120 mg of galcanezumab in 1 mL 
solution.  </p>
<p>The other ingredients are: L-histidine, L-histidine hydrochloride monohydrate, polysorbate 80, sodium 
chloride and water for injections. </p>
<p>What Emgality looks like and contents of the pack 
Emgality is a solution for injection in a clear glass syringe.  Its colour may vary from colourless to 
slightly yellow. </p>
<p>The syringe is encased in a disposable, single-dose pen. Pack sizes of 1, 2 or 3 pre-filled pens.   </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Emgality indeholder lægemidlet galcanezumab, der stopper aktiviteten af et naturligt forekommende 
stof i kroppen kaldet calcitonin gen-relateret peptid (CGRP). Personer med migræne kan have øget 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Brug ikke Emgality 
- hvis du er allergisk over for galcanezumab eller et af de øvrige indholdsstoffer i dette 
lægemiddel (angivet i afsnit 6).   </p>
<p>Advarsler og forsigtighedsregler<br />
Kontakt lægen, apotekspersonalet eller sygeplejersken, før eller mens du tager Emgality, hvis:</p>
<ul>
<li>du har en alvorlig hjertekarsygdom. Emgality er ikke blevet undersøgt hos patienter med 
alvorlige hjertekarsygdomme. </li>
</ul>
<p>Hold øje med allergiske reaktioner 
Emgality kan potentielt forårsage alvorlige allergiske reaktioner. Alvorlige allergiske reaktioner sker 
hovedsageligt inden for 1 dag efter at have taget Emgality, men nogle reaktioner kan forsinkes 
(indtræder mere end 1 dag til 4 uger efter at have taget Emgality). Nogle allergiske reaktioner kan 
være af forlænget varighed. Du skal holde øje med tegn på disse reaktioner, mens du bruger Emgality. 
Stop brugen af Emgality og fortæl det til lægen eller søg straks lægehjælp, hvis du oplever tegn på en 
alvorlig allergisk reaktion. Sådanne tegn er anført under "alvorlige bivirkninger" i afsnit 4. Børn og unge 
...
nyligt har brugt anden medicin eller planlægger at bruge anden medicin. </p>
<p>Graviditet og amning<br />
Hvis du er en kvinde, der er i stand til at blive gravid, frarådes du at blive gravid, mens du bruger 
Emgality. </p>
<p>Hvis du er gravid, har mistanke om, at du er gravid, eller planlægger at blive gravid, skal du spørge 
din læge til råds, før du bruger dette lægemiddel. Det er bedst at undgå brug af Emgality under 
graviditet, da virkningerne af dette lægemiddel hos gravide kvinder ikke kendes.  </p>
<p>Tal med lægen, inden du bruger dette lægemiddel, hvis du ammer eller planlægger at amme. Du og din 
læge skal beslutte, om du skal amme og bruge Emgality.    </p>
<p>Trafik- og arbejdssikkerhed 
Galcanezumab kan have en mindre påvirkning på din evne til at føre motorkøretøj og betjene 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Brug altid lægemidlet nøjagtigt efter lægens, apotekspersonalet eller sygeplejerskens anvisning. Er du 
i tvivl, så spørg lægen, apotekspersonalet eller sygeplejersken.  </p>
<p>Emgality fyldt pen er kun til engangsbrug og indeholder 1 dosis Emgality (120 mg).  <br />
- Første gang du får Emgality, indsprøjter lægen eller sygeplejersken to penne (i alt 240 mg).<br />
- Efter den første dosis skal du bruge 1 pen (120 mg) hver måned. </p>
<p>Lægen vil afgøre, hvor længe du skal bruge Emgality. </p>
<p>Emgality gives som en indsprøjtning under huden (subkutan injektion). Du og lægen eller 
sygeplejersken skal sammen afgøre, om du selv kan indsprøjte Emgality. </p>
<p>Det er vigtigt, at du ikke selv prøver at foretage indsprøjtningerne, før du er blevet oplært af lægen 
eller sygeplejersken. En omsorgsperson kan også give dig din indsprøjtning med Emgality efter 
grundig oplæring.  </p>
<p>Pennen må ikke omrystes. </p>
<p>Læs omhyggeligt "Brugervejledningen" til pennen, inden du bruger Emgality. </p>
<p>Hvis du har brugt for meget Emgality 
Kontakt straks lægen, hvis du har indsprøjtet mere Emgality, end du skal, for eksempel hvis du efter 
den første dosis på 240 mg har indsprøjtet den to gange inden for samme måned, eller hvis andre ved 
et uheld har brugt Emgality. </p>
<p>Hvis du har glemt at bruge Emgality 
Du må ikke tage en dobbeltdosis som erstatning for den glemte dosis.   </p>
<p>Hvis du har glemt at indsprøjte en dosis Emgality, skal du indsprøjte den glemte dosis hurtigst muligt 
...
<p>Allergiske reaktioner over for Emgality er som regel lette til moderate i sværhedsgrad (f.eks. udslæt 
eller kløe). Alvorlige allergiske reaktioner forekommer sjældent (kan forekomme hos op til 1 ud af 
1.000 personer) og tegn på dette kan være:</p>
<ul>
<li>vejrtrækningsbesvær eller synkebesvær, </li>
<li>lavt blodtryk, som kan medføre svimmelhed eller ørhedsfølelse, </li>
<li>hævelse af nakken, ansigtet, munden, læberne, tungen eller svælget som kan udvikle sig 
hurtigt, </li>
<li>voldsom hudkløe med rødt udslæt eller knopper. </li>
</ul>
<p>Fortæl det straks til lægen eller søg akut lægehjælp, hvis du oplever et eller flere af disse tegn. </p>
...
<li>Reaktioner på injektionsstedet (f.eks. rødme i huden, kløe, blå mærker, hævelse) </li>
</ul>
<p>Almindelige bivirkninger (kan forekomme hos op til 1 ud af 10 personer):</p>
<ul>
<li>Vertigo (en følelse af svimmelhed eller “det hele snurrer rundt") </li>
<li>Forstoppelse </li>
<li>Kløe </li>
<li>Udslæt </li>
</ul>
...
<p>Brug ikke lægemidlet efter den udløbsdato, der står på etiketten og på æsken efter "EXP".<br />
...
<p>Emgality kan opbevares uden for køleskab i et enkelt tidsrum på op til 7 dage ved temperaturer op til 
30ºC. Hvis pennen opbevares ved en højere temperatur eller i en længere periode, skal den kasseres.  </p>
...
<ul>
<li>Aktivt stof: galcanezumab. Hver fyldt pen indeholder 120 mg galcanezumab i 1 ml opløsning. </li>
<li>Øvrige indholdsstoffer: L-histidin, L-histidinhydrochloridmonohydrat, polysorbat 80, 
natriumchlorid og vand til injektionsvæsker. </li>
</ul>
<p>Udseende og pakningsstørrelser 
Emgality er en opløsning i en klar glassprøjte. Farven kan variere fra farveløs til svagt gul. 
Injektionssprøjten er indkapslet i en pen til engangsbrug med en enkelt dosis. Pakningsstørrelser på 1, 
2 eller 3 fyldte penne.  </p>
...
<ul>
<li>
<p>Din læge eller sygeplejerske skal vise dig, hvordan du forbereder og indsprøjter Emgality 
ved hjælp af pennen. Du må ikke foretage en indsprøjtning på dig selv eller andre, før du 
har fået vist, hvordan du skal indsprøjte Emgality. </p>
</li>
<li>
<p>Gem brugervejledningen og brug den ved behov. </p>
</li>
<li>
<p>Hver pen må KUN BRUGES ÉN GANG. Du må ikke genbruge eller dele pennen med 
andre. Du kan give, eller selv få en infektion. </p>
</li>
<li>
<p>Pennen indeholder dele af glas. Håndtér den med forsigtighed. Hvis du taber den på en 
hård overflade, må du ikke bruge den. Brug en ny pen til din indsprøjtning. </p>
</li>
<li>
<p>Din læge, apotekspersonalet eller sundhedspersonalet kan hjælpe dig med at afgøre, hvor 
på kroppen du skal indsprøjte din dosis. Du kan også læse afsnittet “Vælg et 
injektionssted" i denne brugervejledning, når du skal afgøre, hvilket område der fungerer 
bedst for dig. </p>
</li>
<li>
<p>Hvis du har problemer med dit syn eller din hørelse, må du ikke bruge pennen uden hjælp 
fra en person, som er oplært i brugen af pennen. </p>
</li>
</ul>
<p>BRUGERVEJLEDNING </p>
<p>Før du bruger pennen med EMGALITY, skal du læse og omhyggeligt følge alle 
...
Tag pennen ud af 
køleskabet 
Læg den originale pakning med eventuelle ubrugte penne tilbage i 
køleskabet. 
Lad hætten sidde på, indtil du er klar til at foretage 
indsprøjtningen. </p>
<p>Må ikke omrystes. 
Lad pennen ligge ved stuetemperatur i 30 minutter inden 
indsprøjtning for at gøre indsprøjtningen mere behagelig. 
Du må ikke lægge pennen i mikrobølgeovnen, placere den under 
rindende varmt vand eller lægge den i direkte sollys. </p>
<p>Kontrollér pennen og 
medicinen 
Sørg for, at du har den rette medicin. Medicinen indeni skal være 
klar. Den kan være farveløs til svagt gult. </p>
...
• medicinen er frosset </p>
<p>Udløbsdato </p>
<p>1 
Drej hætten af </p>
<p>Sørg for at pennen er 'låst'. Lad hætten 
sidde på, indtil du er klar til at indsprøjte. 
• Når du er klar til at indsprøjte, skal du dreje 
hætten af og smide den i affaldsspanden. 
• Du må ikke sætte hætten på igen - det kan 
beskadige nålen. 
• Rør ikke ved nålen. </p>
<p>2 
Placér og lås op </p>
<p>• Placér og hold den klare endeflade fladt og fast 
mod huden. </p>
<p>Drej låseringen til position 'ulåst'. </p>
<p>Forbered indsprøjtningen 
Vask hænderne med sæbe og vand inden indsprøjtning 
af Emgality. Sørg for at have en kanyleboks i nærheden. </p>
<p>Vælg et injektionssted 
Din læge, apotekspersonalet eller sygeplejersken kan 
hjælpe dig med at vælge det bedste injektionssted for 
dig. </p>
<p>• Du kan indsprøjte medicinen i maveregionen 
(abdomen) eller låret. Indsprøjt ikke inden for 5 
cm fra navlen. 
• En anden person kan eventuelt give dig 
indsprøjtningen bag på overarmen eller i balden. 
• Foretag ikke indsprøjtning på samme sted som 
før. Hvis den første indsprøjtning for eksempel 
var i abdomen, kan den næste indsprøjtning være 
i et andet området af abdomen. 
• Rengør og tør injektionsstedet før 
indsprøjtning. </p>
<p>Balden 
Lår 
Abdomen 
...
<p>3 
Tryk og hold nede  </p>
<p>• Tryk på og hold den blågrønne injektionsknap 
nede; du vil høre et højt klik. </p>
<p>• Fortsæt med at holde den klare endeflade 
fast ind mod huden. Du vil høre endnu et klik 
ca. 5-10 sekunder efter det første. Dette andet 
klik fortæller dig, at indsprøjtningen er 
gennemført.  </p>
<p>• Fjern pennen fra huden. 
Du ved, at 
indsprøjtningen er gennemført, når du 
kan se det grå stempel. </p>
<p>Efter indsprøjtning  </p>
<p>Bortskaf pennen 
Sæt IKKE hætten på igen. Læg pennen i en 
kanyleboks, eller bortskaf den som anvist af<br />
...
<li>
<p>Spørg lægen, apotekspersonalet eller sygeplejersken, hvordan du skal bortskaffe 
medicinrester. </p>
</li>
</ul>
...
Sv. 
Det er helt normalt, at der er luftbobler i pennen. Emgality indsprøjtes under huden (subkutan 
injektion). </p>
<p>Spm. 
Hvad nu hvis der er en dråbe væske på spidsen af nålen, når jeg drejer hætten af? 
Sv. 
Det gør ikke noget, hvis der er en dråbe væske på spidsen af nålen. </p>
<p>Spm. 
Hvad nu hvis jeg låser pennen op og trykker på den blågrønne injektionsknap, før jeg 
drejer hætten af? 
Sv. 
Lad hætten sidde på. Bortskaf pennen og brug en ny. 
sekunder 
Klik </p>
<p>Spm. 
Skal jeg holde injektionsknappen nede, indtil indsprøjtningen er gennemført? 
Sv. 
Det er ikke nødvendigt, men det kan gøre det lettere at holde pennen roligt og fast mod huden. </p>
<p>Spm. 
Hvad nu hvis nålen ikke trækker sig tilbage efter min indsprøjtning? 
Sv. 
Lad være med at røre ved nålen og sæt ikke hætten på igen. Opbevar nålen et sikkert sted for at 
undgå utilsigtede nålestik. Kontakt lægen, apotekspersonalet eller sygeplejersken for at få at 
vide, hvordan du skal aflevere pennen. </p>
<p>Spm. 
Hvad nu hvis der er en dråbe væske eller blod på min hud efter indsprøjtningen? 
Sv. 
Det er helt normalt. Pres et stykke vat eller gaze mod injektionsstedet. Gnid ikke på 
injektionsstedet. </p>
<p>Spm. 
Hvad nu hvis jeg hører mere end 2 klik under indsprøjtningen - 2 høje klik og et lavt 
klik. Har jeg fået hele min dosis? 
Sv. 
Nogle personer kan høre et lavt klik lige før det andet høje klik. Det skyldes pennens normale 
funktionsmekanik. Tag ikke pennen væk fra huden, før du hører det andet høje klik. </p>
<p>Spm. 
Hvordan kan jeg se, om indsprøjtningen er gennemført? 
Sv. 
Når du har trykket på den blågrønne injektionsknap, vil du høre 2 høje klik. Det andet klik 
fortæller dig, at indsprøjtningen er gennemført. Du vil også se det grå stempel i toppen af det 
klare bundstykke. </p>
<p>Læs hele indlægssedlen til Emgality, der er vedlagt pakningen, for at lære mere om din medicin.  </p>
<p>Revisionsdato: </p>
<p>Indlægsseddel: Information til patienten </p>
<p>Emgality 120 mg injektionsvæske, opløsning i fyldt injektionssprøjte  </p>
<p>galcanezumab </p>
