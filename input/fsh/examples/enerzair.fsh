...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Instructions for use of Enerzair Breezhaler inhaler </p>  </div>"""   
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Enerzair Breezhaler is and how it works 
Enerzair Breezhaler contains three active substances:</p>
<ul>
<li>indacaterol </li>
...
small airways to remain open. </p>
<p>Mometasone furoate belongs to a group of medicines called corticosteroids (or steroids). 
Corticosteroids reduce the swelling and irritation (inflammation) in the small airways in the lungs and 
so gradually ease breathing problems. Corticosteroids also help to prevent attacks of asthma. </p>
<p>What Enerzair Breezhaler is used for 
Enerzair Breezhaler is used regularly as treatment for asthma in adults. </p>
<p>Asthma is a serious, long-term lung disease where the muscles around the smaller airways become 
tight (bronchoconstriction) and inflamed. Symptoms come and go and include shortness of breath, 
wheezing, chest tightness and cough. </p>
<p>You should use Enerzair Breezhaler every day and not only when you have breathing problems or 
...
<p>If you have any questions about how Enerzair Breezhaler works or why this medicine has been 
...
<p>Do not use Enerzair Breezhaler 
...
<p>During treatment with Enerzair Breezhaler 
Stop using this medicine and get medical help immediately if you have any of the following:</p>
<ul>
<li>tightness of the chest, coughing, wheezing or breathlessness immediately after using Enerzair 
...
<p>Other medicines and Enerzair Breezhaler 
...
depression). </li>
<li>any medicines that may be similar to Enerzair Breezhaler (contain similar active substances); 
...
<p>How much Enerzair Breezhaler to inhale 
...
<p>You should use Enerzair Breezhaler every day, even when your asthma is not troubling you. </p>
<p>When to inhale Enerzair Breezhaler 
Inhale Enerzair Breezhaler at the same time each day. This will help control your symptoms 
throughout the day and night. It will also help you to remember to use it. </p>
<p>How to inhale Enerzair Breezhaler 
...
on how to use the inhaler. </p>
<p>If your pack contains a sensor for Enerzair Breezhaler 
...
- The electronic sensor for Enerzair Breezhaler is to be attached to the base of the Enerzair 
Breezhaler inhaler. 
- The sensor confirms that you have used the Enerzair Breezhaler inhaler by recording and 
monitoring its actuations and the whirring noise of the spinning capsule during inhalation but it 
will not monitor whether you have received the dose of your medicine. 
...
information on how to use the sensor for Enerzair Breezhaler and the App. 
- After all Enerzair Breezhaler capsules in a pack have been used, move the sensor to the new 
inhaler in the next Enerzair Breezhaler pack. </p>
<p>If your symptoms do not improve 
If your asthma is not getting better or if it gets worse after you have started using Enerzair Breezhaler, 
talk to your doctor. </p>
<p>If you use more Enerzair Breezhaler than you should 
If you accidently inhale too much of this medicine, contact your doctor or hospital for advice 
immediately. You may need medical attention. </p>
<p>If you forget to use Enerzair Breezhaler 
If you forget to inhale a dose at the usual time, inhale one as soon as possible on that day. Then inhale 
the next dose at the usual time on the next day. Do not inhale two doses on the same day. </p>
<p>If you stop using Enerzair Breezhaler 
Do not stop using Enerzair Breezhaler unless your doctor tells you to. Your asthma symptoms may 
...
Stop using Enerzair Breezhaler and get medical help immediately if you have any of the following: </p>
...
- sore throat 
- runny nose 
- sudden difficulty breathing and feeling of tightness in chest with wheezing or coughing </p>
<p>Common: may affect up to 1 in every 10 people 
...
- clouding of the lens of your eyes (signs of cataract) </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Enerzair Breezhaler contains 
- The active substances are indacaterol (as acetate), glycopyrronium (as bromide) and 
mometasone furoate. Each capsule contains 150 micrograms of indacaterol (as acetate), 
63 micrograms of glycopyrronium bromide (equivalent to 50 micrograms of glycopyrronium) 
and 160 micrograms of mometasone furoate. Each delivered dose (the dose that leaves the 
...
- The other ingredients are lactose monohydrate and magnesium stearate (see  Enerzair 
Breezhaler contains lactose  in section 2). </p>
<p>What Enerzair Breezhaler looks like and contents of the pack 
...
Multipacks comprising 15 cartons, each containing 10 x 1 hard capsules together with 1 inhaler. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Brugsanvisning til Enerzair Breezhaler-inhalator </p>  </div>"""   
...
Enerzair Breezhaler indeholder tre aktive stoffer:</p>
<ul>
<li>indacaterol </li>
<li>glycopyrronium </li>
<li>mometasonfuroat </li>
</ul>
<p>Indacaterol og glycopyrronium tilhører en gruppe af lægemidler, der kaldes bronkodilatatorer. De 
virker på forskellige måder for at afslappe musklerne i de små luftveje i lungerne. Dette er med til at 
åbne luftvejene og gør det nemmere for luften at komme ind i og ud af lungerne. Når de tages 
regelmæssigt, hjælper de med at holde de små luftveje åbne. </p>
...
hjælper på denne måde gradvist ved vejrtrækningsproblemer. Kortikosteroider hjælper også med at 
forhindre astmaanfald. </p>
<p>Anvendelse 
Enerzair Breezhaler anvendes regelmæssigt som behandling ved astma hos voksne. </p>
...
<p>Du bør tage Enerzair Breezhaler hver dag og ikke kun, når du har problemer med at trække vejret eller 
...
<p>Tal med lægen, hvis du har spørgsmål til, hvordan Enerzair Breezhaler virker, eller hvorfor denne 
...
<p>Tag ikke Enerzair Breezhaler 
- hvis du er allergisk over for indacaterol, glycopyrronium, mometasonfuroat eller et af de øvrige 
indholdsstoffer i Enerzair Breezhaler (angivet i punkt 6). Rådfør dig med lægen, hvis du tror, at 
du kan være allergisk. </p>
<p>Advarsler og forsigtighedsregler 
Kontakt lægen, apotekspersonalet eller sygeplejersken, før du tager Enerzair Breezhaler, hvis noget af 
...
<li>hvis du har lungetuberkulose (TB) eller længerevarende eller ubehandlede infektioner. </li>
</ul>
<p>Under behandling med Enerzair Breezhaler 
...
brugt Enerzair Breezhaler (tegn på at lægemiddlet mod forventning trækker luftvejene sammen, 
...
<li>øjensmerter eller -ubehag, midlertidig sløring af synet, visuelle ringe (du ser lyse ringe rundt om 
lys) eller farvet syn i forbindelse med røde øjne (tegn på et anfald af lukketvinklet glaukom). </li>
</ul>
<p>Børn og unge 
Denne medicin må ikke gives til børn eller unge (under 18 år) fordi det ikke er blevet undersøgt i 
denne aldersgruppe. </p>
<p>Brug af anden medicin sammen med Enerzair Breezhaler 
...
<li>lægemidler, der kan ligne Enerzair Breezhaler (indeholder lignende aktive stoffer); tages de 
sammen med Enerzair Breezhaler, kan der være større risiko for bivirkninger. </li>
...
<p>Så meget Enerzair Breezhaler skal du inhalere 
Den sædvanlige dosis er inhalation af indholdet fra én kapsel hver dag. Du skal kun tage medicinen én 
gang dagligt. Tag ikke mere end den dosis, lægen anbefaler dig at bruge. </p>
<p>Du bør tage Enerzair Breezhaler hver dag, også selvom din astma ikke generer dig. </p>
<p>Tidspunkt for inhalering af Enerzair Breezhaler 
Inhaler Enerzair Breezhaler på samme tidspunkt hver dag. Dette vil hjælpe med at styre dine 
symptomer igennem dagen og natten. Det vil også hjælpe dig med at huske at tage medicinen. </p>
<p>Sådan skal du inhalere Enerzair Breezhaler 
...
<p>Hvis din pakning indeholder en sensor til Enerzair Breezhaler 
- Sensoren og appen er ikke nødvendige, for at du kan tage din medicin. Sensoren behøver ikke at 
have forbindelse til appen, når du tager din medicin. 
- Din læge vil beslutte om brug af sensoren og appen er relevant for dig. 
- Den elektroniske sensor til Enerzair Breezhaler, skal fastgøres på underdelen af 
Enerzair Breezhaler inhalatoren. 
- Sensoren bekræfter at du har brugt Enerzair Breezhaler inhalatoren ved at registrere og 
monitorere aktiveringerne af inhalatoren og den snurrende lyd, når kapslen snurrer rundt under 
inhalation. Den vil dog ikke monitorere hvorvidt du har fået dosen af din medicin. 
- Sensoren skal bruges sammen med appen Propeller på din mobiltelefon (smart phone) eller et 
andet passende udstyr. Sensoren forbinder med Propeller-appen via Bluetooth. 
- Læs brugsanvisningen, der følger med sensor-pakningen og appen, for at få nærmere 
oplysninger om, hvordan sensoren til Enerzair Breezhaler og appen skal bruges. 
- Når alle Enerzair Breezhaler-kapsler i en pakning er brugt, skal sensoren flyttes til den nye 
inhalator i den næste Enerzair Breezhaler-pakning. </p>
...
Enerzair Breezhaler, skal du tale med lægen. </p>
<p>Hvis du har taget for meget Enerzair Breezhaler 
...
<p>Hvis du har glemt at tage Enerzair Breezhaler 
Hvis du har glemt at inhalere en dosis til sædvanlig tid, så inhaler én så hurtigt som muligt samme dag. 
Inhalér herefter næste dosis til sædvanlig tid næste dag. Du må ikke inhalere to doser på samme dag. </p>
<p>Hvis du holder op med at tage Enerzair Breezhaler 
Du må ikke holde op med at tage Enerzair Breezhaler, medmindre lægen siger, at du skal stoppe. Dine 
...
Stop med at tage Enerzair Breezhaler, og søg lægehjælp øjeblikkeligt, hvis du har en af følgende 
tilstande: </p>
...
nældefeber (tegn på allergisk reaktion). </p>
...
- ondt i halsen 
- løbende næse 
- pludselig vejrtrækningsbesvær og en følelse af trykken for brystet med hvæsen eller hoste </p>
<p>Almindelige: kan forekomme hos op til 1 ud af 10 personer 
- svamp i munden (tegn på candidiasis). Når du er færdig med at tage din dosis skal du skylle din 
mund med vand eller mundskyllevæske og derefter spytte væsken ud. Dette vil hjælpe med at 
forebygge svampeinfektion. 
- hyppig vandladningstrang og smerter eller sviende fornemmelse ved vandladning (tegn på 
urinvejsinfektion) 
- hovedpine 
- hurtig hjerterytme 
- hoste 
...
- uklarheder i øjets linse (tegn på grå stær) </p>
...
<li>Hvis din pakning indeholder en elektronisk sensor til Enerzair Breezhaler, kan du finde nærmere 
oplysninger om, hvordan den skal opbevares, og hvornår den skal kasseres, i brugsanvisningen, 
der følger med sensor-pakningen. </li>
</ul> </div>"""      
...
<ul>
<li>Aktive stoffer: indacaterol (som acetat), glycopyrronium (som bromid) og mometasonfuroat. 
Hver kapsel indeholder 150 mikrogram indacaterol (som acetat), 63 mikrogram 
glycopyrroniumbromid (svarende til 50 mikrogram glycopyrronium) og 160 mikrogram 
mometasonfuroat. Hver leveret dosis (den dosis, der afgives fra mundstykket af inhalatoren) 
indeholder 114 mikrogram indacaterol (som acetat), 58 mikrogram glycopyrroniumbromid 
(svarende til 46 mikrogram glycopyrronium) og 136 mikrogram mometasonfuroat. </li>
<li>Øvrige indholdsstoffer: lactosemonohydrat og magnesiumstearat (se “Enerzair Breezhaler 
indeholder lactose" under punkt 2). 
Udseende og pakningsstørrelser 
I denne pakning vil du finde en inhalator sammen med kapsler i blistere. Nogle pakninger vil også 
indeholde en sensor. Kapslerne er gennemsigtige og indeholder et hvidt pulver. De har produktkoden 
“IGM150-50-160" trykt med sort over to sorte streger på underdelen og et logo trykt med sort og 
omgivet af en sort streg på hætten. 
...
Multipakninger bestående af 15 pakninger, som hver indeholder 10 x 1 hårde kapsler sammen med 
1 inhalator. 
...
Novartis Pharma Services Inc. 
Tel: +356 2122 2België/Belgique/Belgien 
Novartis Pharma N.V.           <br />
Tél/Tel: +32 2 246 16 България 
Novartis Bulgaria EOOD     <br />
Тел: +359 2 489 98 Česká republika Novartis s.r.o. 
Tel: +420 225 775 Danmark 
Novartis Healthcare A/S        <br />
Tlf: +45 39 16 84 Deutschland 
APONTIS PHARMA 
Deutschland GmbH &amp; Co. KG 
Tel: +49 2173 8955 4Nederland 
Novartis Pharma B.V. 
Tel: +31 88 04 52 Eesti 
SIA Novartis Baltics Eesti filiaal 
Tel: +372 66 30 Norge 
...
<p>Læs hele brugsanvisningen til Enerzair Breezhaler inhalatoren før brug. Denne brugsanvisning 
kan også fås ved at scanne QR-koden eller besøge: www.breezhaler-asthma.eu/enerzair. </p>
...
• Brug ikke 
Enerzair Breezhaler 
inhalatoren til at tage 
anden kapsel-medicin. 
• Læg aldrig kapslen 
...
<p>Trin 1e: 
Luk inhalatoren </p>
<p>Din Enerzair Breezhaler-inhalator-pakning 
indeholder: </p>
<ul>
<li>
<p>En Enerzair Breezhaler inhalator </p>
</li>
<li>
<p>Et eller flere blisterkort, som hver indeholder 
10 Enerzair Breezhaler-kapsler til brug i 
inhalatoren. </p>
</li>
</ul>
