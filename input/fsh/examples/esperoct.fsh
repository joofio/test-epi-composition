...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Esperoct is 
Esperoct contains the active substance turoctocog alfa pegol and is a long-acting recombinant 
coagulation factor VIII product. Factor VIII is a protein found in the blood that helps to prevent and 
stop bleeding. </p>
<p>What Esperoct is used for 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not use Esperoct 
* if you are allergic to the active substance or to any of the other ingredients of this medicine 
(listed in section 6) 
* if you are allergic to hamster proteins. </p>
<p>Do not use Esperoct if either of the above applies to you. If you are not sure, talk to your doctor before 
using this medicine. </p>
<p>Warnings and precautions  </p>
<p>Previous use of factor VIII medicine<br />
Tell your doctor if you have used factor VIII medicines before, especially if you developed inhibitors 
(antibodies) against the medicine, since there might be a risk that it happens again. </p>
<p>Allergic reactions 
There is a risk that you may experience a severe and sudden allergic reaction (e.g. anaphylactic 
reaction) to Esperoct. </p>
<p>Stop the injection and contact your doctor or an emergency unit immediately if you have early signs of 
allergic reactions. These early signs may include rash, hives, weals, itching on large areas of skin, 
redness and/or swelling of lips, tongue, face or hands, difficulty in swallowing or breathing, wheezing, 
tightness of the chest, pale and cold skin, fast heartbeat, or dizziness, headache, nausea and vomiting. </p>
...
* Do not increase the total dose of Esperoct to control your bleed without talking to your doctor. </p>
<p>Catheter-related problems 
If you have a catheter where medicines can be injected into your blood (central venous access device), 
you may develop infections or blood clots at the site of the catheter. </p>
<p>Heart disease 
Talk to your doctor or pharmacist if you have heart disease or you are at risk of heart disease. </p>
<p>Children 
Esperoct can not be used in children below 12 years of age. </p>
<p>Other medicines and Esperoct 
...
Esperoct has no influence on your ability to drive and use machines. </p>
<p>Esperoct contains sodium 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Treatment with Esperoct will be started by a doctor who is experienced in the care of people with 
haemophilia A. 
Always use this medicine exactly as your doctor has told you. Check with your doctor if you are not 
sure about how to use Esperoct. </p>
<p>How Esperoct is given 
Esperoct is given as an injection into a vein (intravenously), see  Instructions on how to use Esperoct<br />
for more information. </p>
<p>How much to use 
Your doctor will calculate your dose for you. This will depend on your body weight and whether it is 
used to prevent or to treat a bleeding. </p>
<p>To prevent bleeding 
Adults and adolescents (12 years of age and above): The recommended dose is 50 IU of Esperoct per 
kg body weight every 4 days. Your doctor may choose another dose or how often the injections should 
be given, based on your need. </p>
<p>To treat bleeding 
The dose of Esperoct is calculated depending on your body weight and the factor VIII levels to be 
achieved. The target factor VIII levels will depend on the severity and location of the bleeding. If you 
experience that the effect of Esperoct is insufficient, talk to your doctor. </p>
<p>Use in children and adolescents 
Adolescents (12 years of age and above) can use the same dose as adults. </p>
<p>If you use more Esperoct than you should 
...
Stop the injection immediately if you develop severe and sudden allergic reactions (anaphylactic 
reactions). You must contact your doctor or an emergency unit immediately if you have signs of an 
...
* allergic reactions (hypersensitivity). These may become severe and could be life-threatening, see 
 Allergic reactions (hypersensitivity)  above for more information 
* factor VIII inhibitors (antibodies) in patients previously treated with factor VIII. </p>
<p>Other possible side effects (unknown frequency) 
Decreased factor VIII activity in the absence of factor VIII inhibitors. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Hvad er Esperoct 
Esperoct indeholder det aktive stof turoctocog alfa pegol, som er et langtidsvirkende rekombinant 
koagulationsfaktor VIII-præparat. Faktor VIII er et protein, som findes i blodet, og som hjælper med at 
forebygge og stoppe blødning. </p>
<p>Hvad anvendes Esperoct til 
...
<ul>
<li>
<p>Hvis du er allergisk over for det aktive stof eller et af de øvrige indholdsstoffer i dette 
...
<p>Brug ikke Esperoct hvis noget af ovenstående gælder for dig. Hvis du er i tvivl, så kontakt lægen før 
du bruger dette lægemiddel. </p>
<p>Advarsler og forsigtighedsregler  </p>
<p>Tidligere brug af faktor VIII-medicin<br />
Fortæl lægen, hvis du tidligere har brugt faktor VIII-medicin, især hvis du udviklede inhibitorer 
(antistoffer) over for medicinen, da der kan være en risiko for, at dette sker igen. </p>
<p>Allergiske reaktioner 
Der er risiko for, at du kan få en alvorlig og pludselig allergisk reaktion (f.eks. en anafylaktisk 
reaktion) over for Esperoct. </p>
<p>Hvis du får tidlige tegn på en allergisk reaktion, skal injektionen stoppes med det samme, og du skal 
omgående søge læge eller tage på skadestuen. Disse tidlige tegn kan være udslæt, nældefeber, blærer, 
kløe på store områder af huden, rødme og/eller hævelse af læber, tunge, ansigt eller hænder, synke- eller vejrtrækningsbesvær, hvæsende vejrtrækning, trykken for brystet, bleg og kold hud, hurtig 
hjerterytme (puls) eller svimmelhed, hovedpine, kvalme og opkastning. </p>
<p>Udvikling af 'faktor VIII-inhibitorer' (antistoffer) 
Der kan udvikles inhibitorer (antistoffer) under behandling med alle former for faktor VIII-medicin </p>
<ul>
<li>
<p>Disse inhibitorer, specielt ved høje koncentrationer, forhindrer, at behandlingen virker korrekt </p>
</li>
<li>
<p>Du vil blive overvåget nøje for udvikling af disse inhibitorer </p>
</li>
<li>
<p>Fortæl det straks til lægen, hvis din blødning ikke er under kontrol med Esperoct </p>
</li>
<li>
<p>Den samlede dosis Esperoct må ikke øges for at få din blødning under kontrol, uden at du har 
talt med lægen først. </p>
</li>
</ul>
<p>Problemer ved brug af kateter 
Hvis du har kateter, hvor medicin kan indsprøjtes i blodet (centralt venekateter), kan du få infektioner 
eller blodpropper på kateterstedet. </p>
<p>Hjertesygdom 
Tal med din læge eller apotekspersonalet hvis du har en hjertesygdom, eller du har en risiko for at få 
en hjertesygdom. </p>
<p>Børn 
Esperoct kan ikke anvendes til børn under 12 år. </p>
<p>Brug af andre lægemidler sammen med Esperoct 
Fortæl det altid til lægen, hvis du bruger andre lægemidler eller har gjort det for nylig. </p>
<p>Graviditet og amning 
Hvis du er gravid eller ammer, har mistanke om, at du er gravid, eller planlægger at blive gravid, skal 
du spørge lægen til råds, før du bruger dette lægemiddel. </p>
<p>Trafik- og arbejdssikkerhed 
Esperoct påvirker ikke din evne til at føre motorkøretøj eller betjene maskiner. </p>
<p>Esperoct indeholder natrium 
Dette lægemiddel indeholder 30,5 mg natrium (hovedkomponenten i køkken-/bordsalt) pr. opblandet 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Behandlingen med Esperoct bliver igangsat af en læge, der har erfaring med at behandle patienter med 
hæmofili A. </p>
<p>Brug altid lægemidlet nøjagtigt efter lægens anvisning. Er du i tvivl, om hvordan Esperoct skal bruges, 
så spørg lægen. </p>
<p>Sådan gives Esperoct 
Esperoct gives som en injektion i en blodåre (intravenøst), se "Esperoct brugervejledning" for 
yderligere oplysninger. </p>
<p>Så meget skal du bruge 
Lægen vil beregne din dosis. Dosis afhænger af din legemsvægt og om Esperoct bruges til at 
forebygge eller til at behandle en blødning. </p>
<p>Forebyggelse af blødning 
Voksne og unge (børn i alderen 12 år og derover): Den anbefalede dosis er 50 IE Esperoct pr. kg 
legemsvægt hver 4. dag. Din læge kan vælge en anden dosis eller hvor ofte injektionerne skal indgives 
afhængigt af dine behov. </p>
<p>Behandling af blødning 
Dosis af Esperoct beregnes ud fra din legemsvægt, og det niveau af faktor VIII, der skal opnås. Det 
nødvendige niveau af faktor VIII afhænger af, hvor alvorlig blødningen er, og hvor den er. Hvis du 
oplever, at Esperoct har utilstrækkelig virkning, skal du tale med lægen. </p>
<p>Brug til børn og unge 
Unge (i alderen 12 år og derover) kan bruge samme dosis som voksne. </p>
<p>Hvis du har brugt for meget Esperoct 
Hvis du har brugt for meget Esperoct, skal du straks kontakte lægen. </p>
<p>Hvis du er nødt til at bruge betydeligt mere Esperoct for at stoppe en blødning, skal du straks kontakte 
lægen. For yderligere oplysninger, se "Udvikling af 'faktor VIII-inhibitorer' (antistoffer)" i punkt 2. Hvis du har glemt at bruge Esperoct 
Hvis du har glemt en dosis, skal du injicere den glemte dosis, så snart du kommer i tanke om det. Du 
må ikke injicere en dobbeltdosis som erstatning for den glemte dosis. Tag den næste injektion som 
planlagt, og fortsæt derefter som anvist af lægen. Spørg lægen, hvis du er i tvivl. </p>
...
<p>Allergiske reaktioner (overfølsomhed) 
Stop injektionen med det samme, hvis du får alvorlige og pludselige allergiske reaktioner 
(anafylaktiske reaktioner). Du skal omgående søge læge eller tage på skadestuen, hvis du får tegn på 
en allergisk reaktion, såsom: </p>
<ul>
<li>
...
<li>
<p>udslæt, nældefeber, blærer eller kløe </p>
</li>
<li>
<p>bleg og kold hud, hurtig hjerterytme (puls) eller svimmelhed (lavt blodtryk) </p>
</li>
<li>
<p>hovedpine, kvalme eller opkastning. </p>
</li>
</ul>
<p>Udvikling af 'faktor VIII-inhibitorer' (antistoffer) 
Hvis du tidligere har fået behandling med faktor VIII i over 150 dage, kan der udvikles inhibitorer 
(antistoffer) (kan forekomme hos 1 ud af 100 patienter). Hvis dette sker for dig, kan medicinen holde 
op med at virke korrekt, og du kan opleve vedvarende blødning. Kontakt straks lægen, hvis dette sker. 
Se "Udvikling af 'faktor VIII-inhibitorer' (antistoffer)" i punkt 2. Følgende bivirkninger er observeret med Esperoct </p>
<p>Meget almindelige bivirkninger (kan forekomme hos flere end 1 ud af 10 patienter) </p>
<ul>
<li>faktor VIII-inhibitorer (antistoffer) hos patienter, der ikke tidligere er behandlet med faktor VIII </li>
</ul>
...
<ul>
<li>
<p>allergiske reaktioner (overfølsomhed). Disse kan blive alvorlige og eventuelt livstruende, se 
"Allergiske reaktioner (overfølsomhed)" ovenfor for yderligere oplysninger </p>
</li>
<li>
<p>faktor VIII-inhibitorer (antistoffer) hos patienter, som tidligere har fået behandling med 
faktor VIII. </p>
</li>
</ul>
<p>Andre mulige bivirkninger (ukendt hyppighed) 
Nedsat aktivitet af faktor VIII når faktor VIII inhibitorer ikke er til stede.  </p>
...
<p>Brug ikke lægemidlet efter den udløbsdato, der står efter 'EXP' på kartonen, på hætteglasset og den 
fyldte sprøjte. Udløbsdatoen er den sidste dag i den nævnte måned. </p>
<p>Før opblanding (før pulveret blandes med solvensen): 
Opbevares i køleskab (2°C - 8°C). Esperoct må opbevares  </p>
<ul>
<li>
<p>ved stuetemperatur (op til 30°C) i én sammenhængende periode i op til 12 måneder inden for 
produktets udløbsdato eller </p>
</li>
<li>
<p>over stuetemperatur (over 30°C op til 40°C) i én sammenhængende periode på højst 3 måneder 
inden for produktets udløbsdato. </p>
</li>
</ul>
<p>Når du tager Esperoct ud af køleskabet for opbevaring, notér da datoen, og sæt kryds i boksen for 
opbevaringstemperatur på kartonen.<br />
Når først produktet er taget ud af køleskabet for opbevaring, må det ikke sættes tilbage i køleskabet. 
Må ikke fryses. Opbevares i den originale pakning for at beskytte mod lys. </p>
<p>Efter opblanding (efter pulveret er blandet med solvensen - 500 IE, 1000 IE, 1500 IE, 2000 IE, 
3000 IE): 
Brug Esperoct straks efter opblanding. Hvis du ikke anvender den opblandede opløsning med det 
samme, skal den bruges inden for  </p>
<ul>
<li>
<p>24 timer hvis den opbevares i køleskab (2°C - 8°C) eller </p>
</li>
<li>
<p>4 timer ved temperaturer op til 30°C eller </p>
</li>
<li>
<p>1 time ved temperaturer mellem 30°C og 40°C, men kun hvis produktet har været opbevaret over 
stuetemperatur (over 30°C op til 40°C) før opblanding i højst 3 måneder. </p>
</li>
</ul>
<p>Efter opblanding (efter pulveret er blandet med solvensen - 4000 IE, 5000 IE): 
Der er påvist kemisk og fysisk stabilitet under brug i:  </p>
<ul>
<li>
<p>24 timer ved opbevaring i køleskab (2°C - 8°C) eller </p>
</li>
<li>
<p>4 timer ved temperaturer op til 30°C 
Pulveret i hætteglasset fremstår som et hvidt eller off-white pulver. Brug ikke pulveret hvis farven er 
ændret. 
Den opblandede injektionsvæske skal være klar og farveløs. Brug ikke injektionsvæsken, hvis du kan 
se partikler eller misfarvning. 
...
<ul>
<li>
<p>Aktivt stof: Turoctocog alfa pegol (pegyleret human koagulationsfaktor VIII (rDNA)). Hvert 
hætteglas med Esperoct indeholder nominelt 500, 1000, 1500, 2000, 3000, 4000 eller 5000 IE 
turoctocog alfa pegol. </p>
</li>
<li>
<p>Øvrige indholdsstoffer: L-histidin, saccharose, polysorbat 80, natriumchlorid, L-methionin, 
calciumchloriddihydrat, natriumhydroxid og saltsyre. </p>
</li>
<li>
<p>Indholdsstoffer i solvensen: Natriumchlorid 9 mg/ml (0,9%) injektionsvæske, opløsning samt 
vand til injektionsvæsker. </p>
</li>
</ul>
<p>Efter opblanding med den medfølgende solvens (natriumchlorid 9 mg/ml (0,9%) injektionsvæske, 
opløsning), indeholder den klargjorte injektionsvæske henholdsvis 125, 250, 375, 500,750, 1000 eller 
1250 IE turoctocog alfa pegol pr. ml (baseret på styrken af turoctocog alfa pegol dvs. 500, 1000, 1500, 
2000, 3000, 4000 eller 5000 IE). </p>
<p>Udseende og pakningsstørrelser 
Esperoct fås i pakninger med 500 IE, 1000 IE, 1500 IE, 2000 IE, 3000 IE, 4000 IE eller 5000 IE. Hver 
pakning med Esperoct indeholder et hætteglas med hvidt eller off-white pulver, en 4 ml fyldt sprøjte 
med en klar, farveløs solvens, en stempelstang og en hætteglasadapter. </p>
...
<p>Esperoct leveres som pulver. Før injektion skal det opblandes med den solvens, der medfølger i 
sprøjten. Solvensen er en natriumchlorid 9 mg/ml (0,9%) injektionsvæske, opløsning. Det 
opblandede præparat skal injiceres i en vene (intravenøs (i.v.) injektion). Udstyret i denne pakning 
er beregnet til opblanding og injektion af Esperoct. </p>
<p>Du skal også bruge: </p>
<ul>
<li>
<p>et infusionssæt (sommerfuglenål med slange) </p>
</li>
<li>
<p>sterile alkoholservietter </p>
</li>
<li>
<p>gazestykker og plastre. 
Disse dele medfølger ikke i pakken med Esperoct. </p>
</li>
</ul>
<p>Brug ikke udstyret uden grundig undervisning fra lægen eller sygeplejersken. </p>
<p>Vask altid dine hænder og sørg for at området omkring dig er rent. </p>
<p>Når du klargør og injicerer lægemidlet direkte ind i en vene, er det vigtigt at bruge en ren og 
...
<p>Anvend ikke udstyret, hvis det har været tabt, eller det er beskadiget. Tag i stedet en ny 
pakning i brug. </p>
<p>Anvend ikke udstyret, hvis udløbsdatoen er overskredet. Tag i stedet en ny pakning i brug. 
Udløbsdatoen står på den ydre karton, på hætteglasset, på hætteglasadapteren og på den fyldte 
sprøjte. </p>
<p>Anvend ikke udstyret, hvis du har mistanke om, at det er forurenet. Tag i stedet en ny pakning 
i brug. </p>
<p>Smid ikke nogen af tingene ud, før du har injiceret den opblandede opløsning. </p>
<p>Udstyret er kun til engangsbrug. 
Indhold 
Pakningen indeholder: </p>
<ul>
<li>
<p>1 hætteglas med Esperoct pulver </p>
</li>
<li>
...
<li>
<p>Tag det antal af pakninger med Esperoct som 
du har brug for. </p>
</li>
<li>
...
pakningen for at sikre, at den indeholder det 
rigtige produkt. </p>
</li>
<li>
<p>Vask dine hænder og tør dem af i et rent 
håndklæde eller lad dem lufttørre. </p>
</li>
<li>
<p>Tag hætteglasset, hætteglasadapteren og den 
fyldte sprøjte ud af kartonen. Lad 
stempelstangen være urørt i kartonen. </p>
</li>
<li>
<p>Lad hætteglas og den fyldte sprøjte opnå 
stuetemperatur. Du kan gøre dette ved at holde 
dem i dine hænder, indtil de føles ligeså varme 
som dine hænder, se figur A. </p>
</li>
</ol>
<p>Anvend ikke andre metoder til at opvarme 
hætteglasset og den fyldte sprøjte. 
 A </p>
<ul>
<li>
<p>Fjern plastikhætten fra hætteglasset. Brug ikke 
hætteglasset, hvis plastikhætten sidder løst 
eller mangler. </p>
</li>
<li>
<p>Tør gummiproppen af med en steril 
alkoholserviet, og lad den lufttørre i nogle 
sekunder før brug, for at sikre at den er så fri for 
bakterier som muligt. </p>
</li>
</ul>
<p>Rør ikke ved gummiproppen med dine fingre, 
...
beskyttelsespapiret ikke er helt forseglet, eller 
hvis det er ødelagt. </p>
<p>Tag ikke hætteglasadapteren ud af 
beskyttelseshætten med dine fingre. 
Hvis du rører spidsen på hætteglasadapteren, kan 
der blive overført bakterier fra dine fingre. 
 C </p>
<ul>
<li>
<p>Anbring hætteglasset på en flad og solid 
overflade. </p>
</li>
<li>
<p>Drej beskyttelseshætten, og klik 
...
<ul>
<li>
<p>Tryk let på beskyttelseshætten med tommel- og 
pegefinger som vist på figuren. </p>
</li>
<li>
...
hætteglasset, når du fjerner beskyttelseshætten. 
 E </p>
<ol>
<li>
...
<li>
<p>Tag fat i stempelstangen i den brede ende og tag 
den ud af kartonen. Rør ikke ved siderne eller 
gevindet på stempelstangen. Hvis du rører ved 
siderne eller gevindet, kan der blive overført 
bakterier fra dine fingre. </p>
</li>
<li>
<p>Påfør straks stempelstangen til sprøjten ved at 
dreje den med urets retning ind i stemplet indeni 
den fyldte sprøjte, indtil der mærkes modstand. 
 F </p>
</li>
<li>
<p>Fjern sprøjtehætten fra den fyldte sprøjte ved at 
bøje den ned, indtil perforeringen knækker. </p>
</li>
</ol>
<p>Rør ikke ved sprøjtens spids under 
sprøjtehætten. Hvis du rører ved sprøjtens spids, 
kan der blive overført bakterier fra dine fingre. </p>
<p>Brug ikke den fyldte sprøjte, hvis hætten er 
løs eller mangler. 
 G </p>
<ul>
<li>
<p>Skru den fyldte sprøjte stramt på 
hætteglasadapteren, indtil der mærkes modstand. 
 H </p>
</li>
<li>
<p>Opblanding af pulveret med solvensen </p>
</li>
<li>
<p>Hold den fyldte sprøjte en smule skråt med 
hætteglasset nedad. </p>
</li>
<li>
...
<li>
<p>Hold stempelstangen nede, mens hætteglasset 
hvirvles forsigtigt rundt, indtil alt pulveret er 
opløst. </p>
</li>
</ul>
<p>Ryst ikke hætteglasset, da dette vil medføre 
skumdannelse. </p>
<ul>
<li>Kontrollér den opblandede opløsning. Den skal 
være klar og farveløs, og der må ikke være nogen 
synlige partikler. Brug den ikke, hvis der er 
partikler eller misfarvning. Tag i stedet en ny 
pakning i brug. 
 J </li>
</ul>
<p>Det anbefales, at Esperoct bruges straks efter opblanding. </p>
<p>Hvis du ikke kan bruge den opblandede opløsning med Esperoct med det samme(gælder for 
500 IE, 1000 IE, 1500 IE, 2000 IE, 3000 IE, skal den bruges inden for </p>
<ul>
<li>
<p>24 timer når den opbevares i køleskab (2°C - 8°C) eller </p>
</li>
<li>
<p>4 timer (op til 30°C) eller </p>
</li>
<li>
<p>1 time ved temperaturer mellem 30°C og 40°C, men kun hvis produktet har været opbevaret 
over stuetemperatur (over 30°C op til 40°C) før opblanding i højst 3 måneder.  </p>
</li>
</ul>
<p>Hvis du ikke kan bruge den opblandede opløsning med Esperoct med det samme (gælder for 
4000 IE, 5000 IE), skal den bruges inden for </p>
<ul>
<li>
<p>24 timer når den opbevares i køleskab (2°C - 8°C) eller </p>
</li>
<li>
<p>4 timer (op til 30°C) </p>
</li>
</ul>
...
<p>Hvis din dosis kræver mere end ét hætteglas, gentages trinene A til J med yderligere hætteglas, 
hætteglasadaptere og fyldte sprøjter, indtil du opnår den nødvendige dosis. </p>
<ul>
<li>
...
<li>
<p>Giv slip på stempelstangen og lad den 
trække sig tilbage af sig selv, mens den 
opblandede opløsning fyldes i sprøjten. </p>
</li>
<li>
<p>Træk stempelstangen lidt nedad for at 
trække den opblandede opløsning ind i 
sprøjten. </p>
</li>
<li>
<p>Hvis du ikke skal bruge al den 
opblandede medicin fra hætteglasset, 
benyttes skalaen på sprøjten for at se, hvor 
meget opblandet opløsning du trækker op, 
som anvist af lægen eller sygeplejersken. </p>
</li>
</ul>
...
<ul>
<li>
<p>Injicér injektionsvæsken som anvist af lægen eller sygeplejersken. </p>
</li>
<li>
<p>Injicér langsomt over en periode på ca. 2 minutter. </p>
</li>
</ul>
<p>Bland ikke Esperoct med andre intravenøse injektionsvæsker eller lægemidler. </p>
<p>Injektion af Esperoct via forbindelser uden nål til intravenøse (i.v.) katetre </p>
<p>Advarsel: Den fyldte sprøjte er lavet af glas og er designet til at kunne passe sammen med standard 
luer-lock forbindelser. Nogle forbindelser uden nål har en indvendig spids, og passer ikke sammen 
med den fyldte sprøjte. Når forbindelse og sprøjte ikke passer sammen, kan det forhindre 
indgivelsen af lægemidlet og resultere i, at forbindelsen uden nål beskadiges. </p>
<p>Injektion af opløsningen gennem et udstyr til central venøs adgang (CVAD), såsom et centralt 
venekateter eller en subkutan port: </p>
<ul>
<li>
<p>Anvend en ren og bakteriefri (aseptisk) metode. Følg instruktionen i brug af din forbindelse 
og CVAD i samråd med lægen eller sygeplejersken. </p>
</li>
<li>
<p>Injektion ind i et CVAD kræver muligvis en steril 10 ml plastiksprøjte til udtræk af den 
opblandede opløsning. Dette skal gøres lige efter trin J. </p>
</li>
<li>
<p>Hvis slangen til CVAD skal skylles igennem enten før eller efter injektion af Esperoct, skal 
du bruge natriumchlorid 9 mg/ml (0,9%) injektionsvæske, opløsning. 
Bortskaffelse </p>
</li>
<li>
<p>Efter injektion kasseres alt ikke anvendt 
opløsning med Esperoct, sprøjten med 
infusionssættet, hætteglasset med 
hætteglasadapteren samt andet affald 
forsvarligt, som anvist af 
apotekspersonalet. </p>
</li>
</ul>
<p>Bortskaf det ikke med 
