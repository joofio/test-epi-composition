...
Instance: composition-en-e34df9b486f1338f47595519afb12a7d
...
* identifier.value = "EU/1/98/066/001-3"
* status = #final
...
<ol>
<li>What Exelon is and what it is used for </li>
<li>What you need to know before you take Exelon </li>
<li>How to take Exelon </li>
<li>Possible side effects </li>
<li>How to store Exelon </li>
<li>Contents of the pack and other information </li>
</ol> </div>"""   
          

* section[=].section[+]
  * title =  "1. What exelon is and what it is used for"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text =  "1. What exelon is and what it is used for"
  * text.status = #additional
...
* section[=].section[+]
  * title = "2. What you need to know before you take exelon"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "2. What you need to know before you take exelon"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not take Exelon 
- if you are allergic to rivastigmine (the active substance in Exelon) or any of the other ingredients 
...
trembling hands. </p>
<p>If you have to undergo surgery whilst taking Exelon, tell your doctor before you are given any 
anaesthetics, because Exelon may exaggerate the effects of some muscle relaxants during anaesthesia. </p>
<p>Caution when Exelon is taken together with beta-blockers (medicines such as atenolol used to treat 
...
<p>Caution when Exelon is taken together with other medicines that can affect your heart rhythm or the 
...
<p>If you are pregnant, the benefits of using Exelon must be assessed against the possible effects on your 
unborn child. Exelon should not be used during pregnancy unless clearly necessary. </p>
<p>You should not breast-feed during treatment with Exelon. </p>
<p>Driving and using machines 
Your doctor will tell you whether your illness allows you to drive vehicles and use machines safely. 
Exelon may cause dizziness and somnolence, mainly at the start of treatment or when increasing the 
dose. If you feel dizzy or sleepy, do not drive, use machines or perform any tasks that require your 
attention. </p> </div>"""   
                    
* section[=].section[+]
  * title =  "3. How to take exelon"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "3. How to take exelon"
  * text.status = #additional
...
<p>If you take more Exelon than you should 
If you accidentally take more Exelon than you should, inform your doctor. You may require medical 
attention. Some people who have accidentally taken too much Exelon have experienced feeling sick 
(nausea), being sick (vomiting), diarrhoea, high blood pressure and hallucinations. Slow heartbeat and 
fainting may also occur. </p>
<p>If you forget to take Exelon 
If you find you have forgotten to take your dose of Exelon, wait and take the next dose at the usual 
...
<p>Other side effects seen with Exelon transdermal patches and which may occur with the hard 
capsules: </p>
<p>Common (may affect up to 1 in 10 people) 
* Fever 
* Severe confusion 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Exelon contains 
...
<p>Each Exelon 1.5 mg capsule contains 1.5 mg of rivastigmine. 
...
<p>Exelon 2 mg/ml oral solution 
rivastigmine </p>
...
Instance: composition-da-e34df9b486f1338f47595519afb12a7d
InstanceOf: CompositionUvEpi
Title: "Composition for exelon Package Leaflet"
Description:  "Composition for exelon Package Leaflet"
Usage: #inline
...
<li>Det skal du vide, før du begynder at tage Exelon </li>
<li>Sådan skal du tage Exelon </li>
<li>Bivirkninger </li>
<li>Opbevaring </li>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Det aktive stof i Exelon er rivastigmin. </p>
...
<p>Exelon anvendes til behandling af voksne patienter med mild til moderat svær Alzheimers demens, en 
...
* section[=].section[+]
  * title = "2. Det skal du vide, før du begynder at tage  exelon"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "2. Det skal du vide, før du begynder at tage  exelon"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Tag ikke Exelon 
...
Kontakt lægen, før du bruger Exelon:</p>
<ul>
...
<p>Hvis du ikke har taget Exelon i mere end tre dage, må du ikke tage den næste dosis, før du har talt med 
din læge. </p>
<p>Børn og unge 
Der er ingen relevante indikationer for brug af Exelon til behandling af Alzheimers sygdom hos børn 
og teenagere. </p>
<p>Brug af anden medicin sammen med Exelon 
...
<p>Du må ikke tage Exelon samtidig med andre lægemidler, der har en virkning, der ligner Exelons. 
...
<p>Exelon bør ikke gives sammen med metoclopramid (et lægemiddel som bruges til at lindre eller 
...
<p>Hvis du skal opereres, mens du er i behandling med Exelon, skal du fortælle det til din læge, inden du 
får nogen form for bedøvende medicin, da Exelon kan forstærke effekten af muskelafslappende midler 
under bedøvelse. </p>
<p>Vær forsigtig, hvis du tager Exelon sammen med betablokkere (lægemidler som atenolol, som bruges 
...
til besvimelse eller bevidstløshed. </p>
<p>Vær forsigtig, hvis du tager Exelon sammen med anden medicin, som kan påvirke din hjerterytme 
...
<p>Hvis du er gravid, skal fordelene ved at bruge Exelon vurderes i forhold til mulige bivirkninger på 
fosteret. Exelon må ikke tages under graviditet, medmindre det er strengt nødvendigt. </p>
<p>Du må ikke amme, mens du er i behandling med Exelon. </p>
...
som kræver opmærksomhed. </p> </div>"""   
                    
* section[=].section[+]
  * title =  "3. Sådan skal du tage exelon"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "3. Sådan skal du tage exelon"
  * text.status = #additional
...
Din læge vil fortælle dig, hvilken dosis Exelon du skal tage. </p>
<ul>
<li>
...
<p>Hvis du ikke har taget Exelon i mere end tre dage, skal du tale med din læge, før du tager den næste 
dosis. </p>
<p>Brug af denne medicin </p>
<ul>
<li>
<p>Fortæl dine nærmeste, at du er i behandling med Exelon. </p>
</li>
<li>
<p>Du skal tage medicinen hver dag for at få gavn af den. </p>
</li>
<li>
<p>Tag Exelon to gange om dagen (morgen og aften) sammen med mad. </p>
</li>
<li>
...
<p>Hvis du har taget for meget Exelon 
...
<p>Hvis du har glemt at tage Exelon 
Hvis du finder ud af, at du har glemt at tage en dosis Exelon, skal du blot vente og tage næste dosis på 
det sædvanlige tidspunkt. Du må ikke tage en dobbeltdosis som erstatning for den glemte dosis. </p>
...
<p>Andre bivirkninger, der er set med Exelon depotplaster, og som kan forekomme ved brug af 
hårde kapsler: </p>
<p>Almindelig (kan forekomme hos op til 1 ud af 10 patienter) </p>
<ul>
<li>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Exelon indeholder 
...
<p>Hver Exelon 1,5 mg kapsel indeholder 1,5 mg rivastigmin. 
Hver Exelon 3,0 mg kapsel indeholder 3,0 mg rivastigmin. 
Hver Exelon 4,5 mg kapsel indeholder 4,5 mg rivastigmin. 
Hver Exelon 6,0 mg kapsel indeholder 6,0 mg rivastigmin. </p>
...
<p>Exelon 2 mg/ml oral opløsning 
rivastigmin </p>
...
Instance: bundlepackageleaflet-da-e34df9b486f1338f47595519afb12a7d
InstanceOf: BundleUvEpi
Title: "ePI document Bundle for exelon Package Leaflet for language da"
Description: "ePI document Bundle for exelon Package Leaflet for language da"
Usage: #example
...
Instance: mpe34df9b486f1338f47595519afb12a7d
InstanceOf: MedicinalProductDefinitionUvEpi
Title: "Medicinal Product Exelon 1.5 mg hard capsules"
Description: "Exelon 1.5 mg hard capsules"
Usage: #inline
...
* name
  * productName = "Exelon 1.5 mg hard capsules"
...
RuleSet: e34df9b486f1338f47595519afb12a7dListRuleset

* identifier.system = "http://ema.europa.eu/identifier" 
* identifier.value = "None"
* identifier[+].system = "http://spor.ema.europa.eu/v2/medicine-name"
* identifier[=].value = "exelon"
...
* entry[+]
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-en-e34df9b486f1338f47595519afb12a7d) // exelon en
...
* entry[+]
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-da-e34df9b486f1338f47595519afb12a7d) // exelon da
  * item.extension[0].url = "http://ema.europa.eu/fhir/extension/documentType"
  * item.extension[=].valueCoding = $100000155531#100000155538 "B. PACKAGE LEAFLET"
  * item.extension[+].url = "http://ema.europa.eu/fhir/extension/language"
