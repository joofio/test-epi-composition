...
Eylea indeholder det aktive stof aflibercept. Det tilhører en gruppe lægemidler, der kaldes 
antineovaskulariseringsmidler. </p>
<p>Din læge vil indsprøjte Eylea i dit øje for at behandle øjensygdomme hos voksne, som kaldes:</p>
<ul>
<li>våd aldersrelateret makulær degeneration (våd AMD)  </li>
<li>nedsat syn på grund af diabetisk makulaødem (DME). </li>
</ul>
<p>Disse sygdomme rammer makula. Makula er den centrale del af den lysfølsomme membran bagest i 
øjet. Den er ansvarlig for et skarpt syn. 
Våd AMD forårsages når unormale blodkar dannes og vokser under og i makula. De unormale blodkar 
kan lække væske eller blod ind i øjet. Lækkende blodkar, der medfører hævelse af makula, forårsager 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Du vil ikke få Eylea hvis du 
...
- har smerter eller rødme i øjet (alvorlig øjenbetændelse). </p>
<p>Advarsler og forsigtighedsregler 
Kontakt lægen, før du får Eylea, hvis du:</p>
<ul>
<li>
<p>har grøn stær - en øjensygdom forårsaget af højt tryk i øjet </p>
</li>
<li>
<p>tidligere har set blinkende lyse eller mørke "flyvende fluer", og hvis størrelsen og antallet af 
dem pludselig øges </p>
</li>
<li>er blevet opereret i dit øje i de sidste 4 uger, eller der planlægges operation i dit øje i de næste 
4 uger. </li>
</ul>
...
<li>øget lysfølsomhed 
Disse kan være symptomer på en inflammation eller infektion, og lægen kan holde op med at give dig 
Eylea. </li>
</ul>
<p>Desuden er det vigtigt for dig at vide, at:</p>
<ul>
<li>Eyleas sikkerhed og virkning ved administration i begge øjne samtidigt ikke er blevet undersøgt, 
og sådan anvendelse kan øge risikoen for bivirkninger. </li>
<li>injektioner med Eylea kan medføre et øget tryk i øjet hos nogle patienter inden for 60 minutter 
efter injektionen. Dette vil blive kontrolleret efter hver injektion. </li>
<li>din øjenlæge vil undersøge andre risikofaktorer, der kan øge risikoen for rifter i eller løsning af 
et af lagene bagest i øjet. I sådanne tilfælde vil din læge give dig Eylea med forsigtighed. </li>
<li>kvinder, som kan blive gravide, skal anvende sikker prævention under behandlingen og i mindst 
4 måneder efter den sidste injektion af Eylea. </li>
</ul>
<p>Brugen af stoffer, der ligner dem, der findes i Eylea, er muligvis forbundet med risiko for blodpropper, 
hvilket kan føre til hjerteanfald eller slagtilfælde. Teoretisk kunne dette også finde sted efter at Eylea 
er blevet indsprøjtet i øjet. Hvis du har haft et slagtilfælde eller mini-slagtilfælde eller hjerteanfald 
inden for de sidste 6 måneder, vil din læge give dig Eylea med forsigtighed. </p>
<p>Børn og unge 
Anvendelsen af Eylea til børn eller unge under 18 år er ikke blevet undersøgt, da de indikerede 
sygdomme hovedsageligt forekommer hos voksne. Dets brug er derfor ikke relevant til denne 
aldersgruppe. </p>
<p>Brug af andre lægemidler sammen med Eylea 
Fortæl altid øjenlægen, hvis du bruger andre lægemidler, for nylig har brugt andre lægemidler eller 
planlægger at bruge andre lægemidler. </p>
<p>Graviditet og amning 
- Kvinder, som kan blive gravide, skal anvende sikker prævention under behandlingen og i 
mindst 4 måneder efter den sidste injektion af Eylea. 
- Der er ingen erfaring med at bruge Eylea til gravide kvinder. Kvinder må ikke få Eylea under 
graviditeten, medmindre den potentielle fordel for kvinden opvejer den potentielle risiko for det 
ufødte barn. 
- Små mængder af Eylea kan udskilles i modermælk. Virkningen på nyfødte/spædbørn som bliver 
ammet er ukendt . Eylea bør ikke anvendes samtidig med amning. 
Derfor skal du spørge din øjenlæge til råds, før du får lægemidlet, hvis du er gravid eller ammer, har 
...
<li>Derefter kan du få injektioner op til hver 5. måned. Lægen vil beslutte hyppigheden baseret på 
dit øjes tilstand. </li>
</ul>
<p>Administration 
Din øjenlæge vil indsprøjte Eylea i dit øje (intravitreal injektion). </p>
<p>Før injektionen vil din øjenlæge anvende et desinficerende øjenbad, så dit øje bliver renset grundigt, 
for at forebygge en infektion. Din øjenlæge vil give dig øjendråber (lokalbedøvende middel) for at 
bedøve øjet og reducere eller forhindre smerter fra injektionen. </p>
<p>Hvis du har glemt en dosis af Eylea 
Aftal et nyt besøg med øjenlægen snarest muligt. </p>
...
Bivirkningerne af Eylea-injektionen er enten fra selve lægemidlet eller fra injektionsproceduren, og 
forekommer hyppigst i øjet.  </p>
<p>Nogle bivirkninger kan være alvorlige 
Kontakt straks lægen, hvis du har noget af følgende:</p>
<ul>
<li>almindelig bivirkning, som kan forekomme hos op til 1 ud af 10 behandlede </li>
...
<li>ikke almindelig bivirkning, som kan forekomme hos op til 1 ud af 100 behandlede </li>
<li>visse former for uklarhed af linsen (grå stær subkapsulær) </li>
<li>løsning af nethinden eller rift eller blødning i nethinden, det lysfølsomme lag bag i øjet, 
hvilket fører til lysglimt med flydere, der undertiden udvikler sig til synstab 
(nethindeløsning eller rift i nethinden) </li>
</ul>
...
<li>beskadigelse af øjenæblets klare lag foran iris (keratitis punctata) </li>
</ul>
<p>Ikke almindelig (kan forekomme hos op til 1 ud af 100 behandlede):</p>
<ul>
<li>allergiske reaktioner </li>
<li>
<p>løsning af eller rift i et af lagene bag i øjet, hvilket medfører lysglimt, der bevæger sig som 
"flyvende fluer" og nogle gange udvikler sig til synstab (rift/løsning i nethinde-pigment-
epitelet) </p>
</li>
<li>
<p>inflammation (betændelseslignende reaktion) i iris, i andre dele af øjet eller i den geléagtige 
substans i øjet (iritis, iridocyklitis, vitritis) </p>
</li>
<li>visse former for uklarhed af linsen (katarakt kortikal/nukleær) </li>
<li>beskadigelse af øjeæblets yderste lag (hornhindeabrasion/erosion) </li>
<li>sløret syn </li>
<li>øjensmerter på injektionsstedet </li>
...
<ul>
<li>blindhed </li>
<li>inflammation (betændelseslignende reaktion) i andre dele af øjet (uveitis) </li>
<li>hævelse af øjenlåget </li>
<li>irritation på injektionsstedet </li>
<li>hævelse i det forreste lag af øjet (hornehindeødem) </li>
</ul>
<p>Udover de ovenfor nævnte bivirkninger kan følgende bivirkninger forekomme , selvom de ikke er 
blevet rapporteret i kliniske studier:</p>
<ul>
<li>rødme i øjet (okulær hyperæmi) </li>
<li>degeneration af den lysfølsomme membran bagest i øjet (retinal degeneration) </li>
<li>unormal fornemmelse i øjet </li>
<li>uklarhed i linsen (linseuklarheder), uklarhed i linsen på grund af en skade (traumatisk katarakt) </li>
<li>beskadigelse af overfladen af den klare del foran i øjet (korneal epiteldefekt) </li>
<li>betændelse i andre dele af øjet (reaktion i forreste kammer) </li>
<li>irritation af øjenlåget </li>
<li>alvorlig inflammation (betændelseslignende reaktion) eller betændelse inden i øjet 
(endoftalmitis) </li>
...
<ul>
<li>Aktivt stof: aflibercept. 1 ml opløsning indeholder 114,3 mg aflibercept. Hvert hætteglas 
indeholder 0,263 ml. Dette giver en anvendelig mængde til at administrere en enkelt dosis på 
0,07 ml, der indeholder 8 mg aflibercept. </li>
<li>Øvrige indholdsstoffer: saccharose, argininhydrochlorid, histidinhydrochloridmonohydrat, 
histidin, polysorbat 20, vand til injektionsvæsker. </li>
</ul>
<p>Udseende og pakningsstørrelser 
Eylea er en injektionsvæske, opløsning (injektion). Opløsningen er farveløs til let gul. 
Pakningsstørrelse: 1 stk hætteglas + 1 stk filterkanyle. </p>
...
<p>Hætteglasset er kun til engangsbrug og kun til ét øje. Udtrækning af flere doser fra ét hætteglas kan 
øge risikoen for forurening og efterfølgende infektion. </p>
<p>Må ikke bruges, hvis pakningen eller dets komponenter er udløbet, beskadiget eller er blevet 
manipuleret med. 
Kontroller etiketten på hætteglasset for at sikre, at du har den styrke af Eylea, som du har til hensigt at 
bruge. Det er nødvendigt at bruge Eylea 114,3 mg/ml hætteglas til dosen på 8 mg. </p>
<p>Den intravitreale injektion skal udføres med en 30 G x ½"-kanyle (medfølger ikke). </p>
<ol>
<li>Inden administration inspiceres injektionsvæsken, opløsningen, visuelt. 
Hætteglasset må ikke bruges, hvis der er synlige partikler, uklarheder eller misfarvning. </li>
<li>
<p>Plastiklåget fjernes, og den ydre del af 
hætteglassets gummiprop desinficeres.  </p>
</li>
<li>
<p>Brug en aseptisk teknik til at udføre trin 
3-10. Den filterkanyle, som leveres i æsken sættes 
på en 1 ml steril Luer-lock-injektionssprøjte. </p>
</li>
<li>
<p>Pres filternålen ned midt i hætteglassets gummiprop, indtil kanylen er stukket helt ned i 
hætteglasset og spidsen berører bunden af hætteglasset. </p>
</li>
<li>
<p>Træk hele indholdet af hætteglasset med Eylea ind i injektionssprøjten, mens hætteglasset 
holdes lodret og en smule på skrå, så alt indholdet trækkes op. For at undgå, at der kommer luft 
med, skal du sikre dig, at nålens skråspids er neddyppet i væsken. Fortsæt med at holde 
hætteglasset vippet mens væsken trækkes op, samtidig med at du holder filternålens skråspids 
neddyppet i væsken.  </p>
</li>
<li>
<p>Sørg for, at stempelstangen er trukket tilstrækkeligt tilbage, når hætteglasset tømmes, for at 
tømme filterkanylen helt. Efter injektion skal alt ubrugt præparat bortskaffes. </p>
</li>
<li>Fjern filterkanylen og bortskaf den på korrekt vis. 
Bemærk: Filterkanylen må ikke bruges til den intravitreale injektion. </li>
<li>
<p>Drej 30 G × ½"-kanylen godt fast på spidsen 
af Luer-lock-injektionssprøjten. </p>
</li>
<li>
<p>Kontroller, om det er bobler i 
injektionssprøjten, ved at holde 
injektionssprøjten med kanylen pegende 
opad. Hvis der er bobler, banker du let på 
injektionssprøjten med fingeren, indtil 
boblerne stiger opad. </p>
</li>
<li>
<p>For at fjerne alle bobler og overskydende lægemiddel trykkes stemplet langsomt ned, så den 
flade kant af stemplet er på linje med 0,07 ml-markeringen på injektionssprøjten. 
Opløsning 
Kanyleaffasningen 
peger nedad </p>
</li>
