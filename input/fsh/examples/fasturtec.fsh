...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Fasturtec contains the active ingredient rasburicase. 
Rasburicase is used to treat or prevent high blood levels of uric acid from occurring in adults, children 
and adolescents (aged 0 to 17 years) with disorders of the blood cells (haematological diseases) who 
...
cause allergic-type reactions, such as severe anaphylaxis including anaphylactic shock (sudden life-
threatening or fatal allergic reactions).  </p>
<p>Tell your doctor immediately if you notice any of the following as you may need to stop treatment: 
* swelling of the face, lips, tongue or throat 
* coughing or wheezing 
* difficulty in breathing or swallowing 
* rash, itching or hives (nettle-type rash) on the skin </p>
<p>These may be the first signs that a severe allergic reaction is happening. Your treatment with 
Fasturtec may need to be stopped, and you may need further treatment. 
It is not known whether the chance of developing an allergic reaction is increased if treatment with 
Fasturtec is repeated. </p>
<p>In case of disorders of the blood in which red blood cells are abnormally broken down (haemolysis) or 
abnormal blood pigment levels (methaemoglobinaemia), your doctor will immediately and 
permanently discontinue treatment with Fasturtec. </p>
...
Tell your doctor if you are, or think you may be pregnant, or if you are breast-feeding. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Fasturtec is to be given to you before or during the start of your course of chemotherapy. </p>
<p>Fasturtec is injected slowly into a vein, which should take about 30 minutes. </p>
<p>Your dose will be calculated according to your body weight.<br />
The recommended dose is 0.20 mg per kg of body weight per day in both children and adults. </p>
<p>It will be given once a day, for up to 7 days.<br />
During treatment with Fasturtec, your doctor will carry out blood tests to check the levels of uric acid 
and decide how long you will be treated for.<br />
Your doctor may also test your blood to make sure that you do not develop any blood disorders. </p>
<p>If you are given more Fasturtec than you should be 
...
<ul>
<li>The active substance is rasburicase 1.5 mg/ml. Rasburicase is produced by gene technology in a 
microorganism named Saccharomyces cerevisiae. </li>
<li>The other ingredients of the powder are: alanine, mannitol, disodium phosphate dodecahydrate, 
disodium phosphate dihydrate, sodium dihydrogen phosphate dihydrate.  </li>
<li>The other ingredients of the solvent are: poloxamer 188, water for injection. </li>
</ul>
<p>What Fasturtec looks like and contents of the pack </p>
<p>Fasturtec is provided as a powder for concentrate for solution for infusion (powder for sterile 
concentrate) with a solvent.<br />
The powder is an entire or broken white to off white pellet. 
The solvent is a colourless and clear liquid. </p>
<p>Pack of 3 vials of 1.5 mg rasburicase and 3 ampoules of 1 ml solvent. The powder is supplied in 2 ml 
or 3 ml clear glass vial with a rubber stopper and the solvent in a 2 ml clear glass ampoule. </p>
<p>Pack of 1 vial of 7.5 mg rasburicase and 1 ampoule of 5 ml solvent. The powder is supplied in 10 ml 
clear glass vial with a rubber stopper and the solvent in a 5 ml clear glass ampoule. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Fasturtec indeholder den aktive ingrediens rasburikase. 
...
<ul>
<li>er allergisk (overfølsom) over for rasburikase, andre urikaser eller et af de øvrige indholdsstoffer i 
Fasturtec (angivet i punkt 6). </li>
<li>lider af hæmolytisk anæmi (en blodsygdom med unormal nedbrydning af røde blodlegemer). </li>
</ul>
...
anafylaktisk shock (pludselig livstruende eller dødelig allergisk reaktion). </p>
<p>Kontakt straks din læge, hvis du bemærker et eller flere af følgende symptomer, da det kan være 
...
<li>
<p>hoste eller hvæsende vejrtrækning  </p>
</li>
<li>
<p>besvær med at trække vejret eller synke  </p>
</li>
<li>
<p>udslæt, kløe eller nældefeber på huden </p>
</li>
</ul>
<p>Dette kan være de første tegn på en alvorlig allergisk reaktion. Det kan være nødvendigt at stoppe 
behandlingen med Fasturtec, og du kan have brug for anden behandling. </p>
<p>26/ 
Det vides ikke, om risikoen for at udvikle en allergisk reaktion øges, hvis behandlingen med Fasturtec 
gentages.  </p>
<p>I tilfælde af blodsygdomme, hvor de røde blodlegemer unormalt bliver nedbrudte (hæmolyse), eller 
unormale blodpigmentniveauer (methæmoglobinæmi), vil din læge øjeblikkeligt og permanent stoppe 
behandlingen med Fasturtec.  </p>
<p>Brug af anden medicin sammen med Fasturtec 
Fortæl altid lægen, hvis du tager anden medicin eller har gjort det for nylig. Dette gælder også 
medicin, som ikke er købt på recept, f.eks. naturlægemidler og vitaminer og mineraler. </p>
<p>Graviditet og amning 
Fortæl din læge hvis du er, eller tror du er gravid, eller hvis du ammer. </p>
<p>Trafik- og arbejdssikkerhed 
Der findes ingen tilgængelig information om evnen til at køre eller betjene maskiner. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Fasturtec skal gives inden eller i begyndelsen af dit kemoterapiforløb. </p>
<p>Lægemidlet indgives i en vene (intravenøst) som en infusion, der i gennemsnit varer 30 minutter. </p>
<p>Dosis beregnes ud fra din legemsvægt.<br />
Den anbefalede dosis er 0,20 mg pr. kg legemsvægt pr. dag både til børn og voksne. </p>
...
behandlingen. Lægen kan også teste dit blod for at sikre sig, at du ikke udvikler blodsygdomme. </p>
<p>Hvis du har fået for meget Fasturtec 
...
Fasturtec gives sammen med andre lægemidler, som også kan give bivirkninger.  </p>
<p>Hvis du pludselig opdager: 
 
...
på en alvorlig allergisk reaktion (anafylaksi). Disse er sjældne (kan påvirke op til 1 ud af 1.personer). </p>
<p>27/ 
...
 
Løbenæse, stoppet næse, nysen, trykken i ansigtet eller smerter (rhinitis). </p>
<p>Ikke kendt (hyppigheden kan ikke vurderes ud fra tilgængelige data): 
 
Ufrivillige muskelsammentrækninger. </p>
<p>Hvis du opdager nogle af disse bivirkninger, skal du fortælle det til lægen, sygeplejersken eller 
sygehusfarmaceuten. </p>
...
<ul>
<li>Aktivt stof: rasburikase 1,5 mg/ml. Rasburikase produceres ved hjælp af genteknologi i en 
mikroorganisme der hedder Saccharomyces cervisiae<br />
28/ </li>
<li>Øvrige indholdsstoffer i pulveret: alanin, mannitol, dinatriumphosphatdodecahydrat, 
dinatriumphosphatdihydrat, natriumdihydrogenphosphatdihydrat. </li>
<li>Øvrige indholdsstoffer i solvensen: poloxamer 188, vand til injektionvæske. </li>
</ul>
...
<p>Pakninger med 3 hætteglas á 1,5 mg rasburikase og 3 ampuller med 1 ml solvens. Pulveret leveres i 2 
ml eller 3 ml klare hætteglas med gummilukker og solvensen i en 2 ml klar glas ampul (type I). </p>
<p>Pakning med 1 hætteglas á 7,5 mg rasburikase og 1 ampul med 5 ml solvens. Pulveret leveres i 10 ml 
klare hætteglas med gummilukker og solvensen i en 5 ml klar glas ampul (type I). </p>
...
03012 Anagni (FR) 
Italien </p>
<p>Hvis du vil have yderligere oplysninger om Fasturtec, skal du henvende dig til den lokale 
repræsentant: </p>
...
nedenfor. </p>
<p>Fasturtec skal fremstilles (rekonstitueres) med hele voluminet af den medfølgende solvens (f.eks. skal 
indholdet af en 1,5 mg rasburikaseampul opløses i 1 ml fra solvensampullen; og 7,5 mg rasburikase 
fra en ampul skal opløses i de 5 ml solvens fra 5 ml solvensampullen). Rekonstitutionen resulterer i en 
30/ 
opløsning på 1,5 mg/ml, der skal fortyndes yderligere med natriumchlorid 9 mg/ml (0,9%).   </p>
<p>Fremstilling (rekonstitution) af opløsning: 
Et hætteglas med rasburikase tilsættes indholdet fra en solvensampul under kontrollerede og 
validerede aseptiske forhold, hvorefter glasset vippes forsigtigt.<br />
Må ikke rystes. 
...
af rasburikase i den færdige infusionsopløsning afhænger af patientens legemsvægt. </p>
<p>Den rekonstituerede opløsning indeholder ikke konserveringsmiddel, derfor skal den fortyndede 
infusionsopløsning indgives omgående. </p>
<p>Infusion: 
Den fortyndede infusionsopløsning skal indgives som infusion over 30 minutter. </p>
<p>Håndtering af prøver: 
