...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Filgrastim HEXAL is a white blood cell growth factor (granulocyte colony stimulating factor) and 
belongs to a group of proteins called cytokines. Growth factors are proteins that are produced naturally 
in the body but they can also be made using biotechnology for use as a medicine. Filgrastim HEXAL 
...
your body less able to fight infection. Filgrastim HEXAL stimulates the bone marrow to produce new 
white cells quickly.
Filgrastim HEXAL can be used:</p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <h2>Do not use Filgrastim HEXAL</h2>
...
develop cancers of the blood, you should not use Filgrastim HEXAL unless instructed by your doctor.
...
Filgrastim HEXAL may have a minor influence on your ability to drive and use machines. This 
medicine may cause dizziness. It is advisable to wait and see how you feel after taking Filgrastim 
HEXAL and before driving or operating machinery.
...
Filgrastim HEXAL is usually given as a daily injection into the tissue just under the skin (known as a 
...
tell you how much Filgrastim HEXAL you should take.
Patients having a bone marrow transplant after chemotherapy:
You will normally receive your first dose of Filgrastim HEXAL at least 24 hours after your 
...
You will need to take Filgrastim HEXAL until your white blood cell count is normal. Regular blood 
tests will be taken to monitor the number of white blood cells in your body. Your doctor will tell you 
how long you will need to take Filgrastim HEXAL.
Use in children
Filgrastim HEXAL is used to treat children who are receiving chemotherapy or who suffer from 
severe low white blood cell count (neutropenia). The dosing in children receiving chemotherapy is the 
same as for adults.
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <h2>What Filgrastim HEXAL contains</h2>
<p>The active substance is filgrastim.
Filgrastim HEXAL 30 MU/0.5 mL solution for injection or infusion in pre-filled syringe: Each 
pre-filled syringe contains 30 MU filgrastim in 0.5 mL, corresponding to 60 MU/mL.
Filgrastim HEXAL 48 MU/0.5 mL solution for injection or infusion in pre-filled syringe: Each 
pre-filled syringe contains 48 MU filgrastim in 0.5 mL, corresponding to 96 MU/mL.
-
The other ingredients are glutamic acid, sorbitol (E420), polysorbate 80, sodium hydroxide and 
water for injections. See section 2  Filgrastim HEXAL contains sorbitol and sodium .
What Filgrastim HEXAL looks like and contents of the pack
Filgrastim HEXAL is a clear, colourless to slightly yellowish solution for injection or infusion in pre-
filled syringe.
Filgrastim HEXAL is available in packs containing 1, 3, 5 or 10 pre-filled syringes with injection 
needle and a needle safety guard.
