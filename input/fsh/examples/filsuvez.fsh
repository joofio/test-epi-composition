...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not use Filsuvez 
- if you are allergic to birch bark or any of the other ingredients of this medicine (listed in 
section 6). </p>
<p>Warnings and precautions<br />
Talk to your doctor, pharmacist or nurse before using Filsuvez. </p>
<p>If you get an allergic reaction, stop using Filsuvez immediately and see your doctor or nurse. Signs 
of an allergic reaction include: 
* itching, swelling and redness of the skin that is more severe on the area where the medicine has 
been applied. </p>
<p>Wound infection is a serious complication that can occur during the healing process. Possible signs of 
a wound infection are: 
* yellow or greenish fluid (pus) draining from the wound,<br />
...
<p>Avoid getting Filsuvez in your eyes. If this does happen, rinse your eyes well with clean water. 
Contact your doctor or nurse if any discomfort continues. </p>
<p>Children 
Do not give this medicine to children below 6 months. </p>
<p>Other medicines and Filsuvez 
Tell your doctor, pharmacist or nurse if you are using, have recently used or might use any other 
medicines. </p>
<p>There is no information on how Filsuvez could react with other medicines applied to the skin, taken by 
mouth or injected. Do not apply other products to the wound area at the same time as applying 
Filsuvez. If you need to use more than one product talk to your doctor or nurse. </p>
<p>Pregnancy, breast-feeding and fertility 
No studies have been done on the effects of Filsuvez on pregnant women, but since the absorption of 
this medicine into the body is extremely low, the risk to the unborn baby is negligible. Filsuvez can be 
used during pregnancy. </p>
<p>It is not known whether Filsuvez passes into human breast milk, but since the absorption of this 
medicine into the body is extremely low, the risk to the baby is negligible. Filsuvez can be used during 
...
Step 3 - Cover </p>
<ul>
<li>Re-apply the gel each time your dressing is changed, until the wound is healed. </li>
<li>Filsuvez is not for internal use. Avoid contact with the eyes, mouth or nostrils. If accidental 
contact does occur, immediately wash with clean water. </li>
<li>This tube of sterile gel is for a single application. Once opened, the gel should be used 
immediately and the tube thrown away, even if there is some gel left. A new tube should be 
used at each dressing change. </li>
</ul>
<p>Duration of use 
Your doctor, pharmacist or nurse will tell you for how long you should use the gel. If symptoms 
continue or worsen after use, or if wound complications occur, speak to your doctor, pharmacist or 
nurse. </p>
<p>If you use more Filsuvez than you should 
Filsuvez is applied to the skin and the absorption into the body is extremely low. This makes overdose 
very unlikely, even if applied to large skin areas and for a long period of time. </p>
<p>If you forget to use Filsuvez 
Apply Filsuvez at the next planned change of wound dressing, continuing with your normal routine. </p>
...
* wound complication (e.g. increase in wound size, wound re-opening, wound pain) </p>
<p>Common (may affect up to 1 in 10 people) 
* wound infection 
* allergic reaction (hypersensitivity) 
* itchy skin 
* pain and itching where the medicine is applied 
* complications of wound healing </p>
