...
Rheumatoid arthritis is an inflammatory disease of the joints. If you have active rheumatoid arthritis you will 
first be given other medicines. If these medicines do not work well enough, you will be given Flixabi which 
you will take in combination with another medicine called methotrexate to: 
...
work well enough, you will be given Flixabi to reduce the signs and symptoms of your disease. </p>
...
Talk to your doctor before or during treatment with Flixabi if you have: </p>
<p>Had treatment with any medicine containing infliximab before 
* Tell your doctor if you have had treatment with medicines containing infliximab in the past and are 
now starting Flixabi treatment again. 
...
* Your doctor will test you to see if you have TB. Cases of TB have been reported in patients treated 
with Flixabi, even in patients who have already been treated with medicines for TB. Your doctor 
will record these tests on your patient reminder card. 
* If your doctor feels that you are at risk for TB, you may be treated with medicines for TB before 
you are given Flixabi. 
Tell your doctor straight away if you get signs of TB during treatment with Flixabi. Signs include 
persistent cough, weight loss, feeling tired, fever, night sweats. </p>
<p>Hepatitis B virus<br />
...
* Treatment with TNF blockers such as Flixabi may result in reactivation of hepatitis B virus in 
patients who carry this virus, which can be life-threatening in some cases. </p>
<p>Heart problems 
...
Flixabi. Signs include shortness of breath or swelling of your feet. </p>
<p>Cancer and lymphoma 
* Tell your doctor before you are given Flixabi if you have or have ever had lymphoma (a type of 
blood cancer) or any other cancer. 
...
* Children and adults taking Flixabi may have an increased risk of developing lymphoma or another 
cancer. 
...
changes in your skin or growths on the skin during or after therapy, tell your doctor. 
...
your body. </p>
<p>Abnormal skin openings 
* Tell your doctor if you have any abnormal skin openings (fistulae) before you are given Flixabi. </p>
<p>Vaccinations 
* Talk to your doctor if you recently have had or are due to have a vaccine. 
* You should receive recommended vaccinations before starting Flixabi treatment. You may receive 
some vaccines during treatment with Flixabi but you should not receive live vaccines (vaccines that 
contain a living but weakened infectious agent) while using Flixabi because they may cause 
infections. 
* If you received Flixabi while you were pregnant, your baby may also be at higher risk for getting 
an infection as a result of receiving a live vaccine during the first year of life. It is important that 
...
therapeutic infectious agent (such as BCG instillation used for the treatment of cancer). </p>
...
<p>Low blood counts 
* In some patients receiving infliximab, the body may not make enough of the blood cells that help 
fight infections or help stop bleeding. 
...
cancers, including unusual types, which sometimes resulted in death. 
* More children taking Flixabi developed infections as compared to adults. 
* Children should receive recommended vaccinations before starting Flixabi treatment.<br />
Children may receive some vaccines during treatment with Flixabi but should not receive live vaccines 
while using Flixabi. </p>
<p>If you are not sure if any of the above applies to you, talk to your doctor before you are given Flixabi. </p>
<p>Other medicines and Flixabi 
Tell your doctor if you are using, have recently used or might use any other medicines. 
Patients who have inflammatory diseases already take medicines to treat their problem. These medicines may 
...
infection (neutropenia), bone fracture, bacterial infection and allergic reactions of the breathing tract. </p>
...
is white. 
Flixabi is produced in packs of 1, 2, 3, 4, or 5 vial(s). Not all pack sizes may be marketed. </p>
...
2. Det skal du vide, før du begynder at få Flixabi 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Flixabi indeholder det aktive stof infliximab. Infliximab er et monoklonalt antistof - en type protein, der 
binder sig til et specifikt mål i kroppen kaldet TNF (tumor nekrose faktor) alfa. </p>
<p>Flixabi tilhører en medicingruppe kaldet "TNF-blokkere". Det bruges til voksne til behandling af 
følgende betændelsessygdomme: </p>
<ul>
<li>
<p>Reumatoid arthritis </p>
</li>
<li>
<p>Psoriasisarthritis </p>
</li>
<li>
...
<p>Flixabi bruges også til voksne og børn fra 6 år og opefter til behandling af: </p>
<ul>
<li>
<p>Crohns sygdom </p>
</li>
...
<p>Flixabi virker ved selektivt at binde sig til TNF alfa og blokere dets virkning. TNF alfa er involveret i 
kroppens betændelsesprocesser, så blokering af dette kan mindske betændelsen i din krop. </p>
...
virker godt nok, vil du få Flixabi for at reducere tegn og symptomer på din sygdom. </p>
<p>Colitis ulcerosa 
Colitis ulcerosa er en betændelsessygdom i tarmen. Hvis du lider af colitis ulcerosa, vil du først få andre 
lægemidler. Hvis disse lægemidler ikke virker godt nok, vil du få Flixabi til behandling af din sygdom. </p>
<p>Crohns sygdom 
Crohns sygdom er en betændelsessygdom i tarmen. Hvis du lider af Crohns sygdom, vil du først få 
andre lægemidler. Hvis disse lægemidler ikke virker godt nok, vil du få Flixabi for at: </p>
<ul>
<li>
...
<ul>
<li>
<p>hvis du er allergisk over for infliximab (det aktive indholdsstof i Flixabi) eller et af de øvrige 
indholdsstoffer i Flixabi (angivet i punkt 6), </p>
</li>
<li>
<p>hvis du er allergisk over for proteiner, som stammer fra mus, </p>
</li>
<li>
<p>hvis du har tuberkulose (TB) eller en anden alvorlig infektion, såsom lungebetændelse eller 
blodforgiftning (sepsis), </p>
</li>
<li>
<p>hvis du har hjertesvigt i moderat eller svær grad. </p>
</li>
</ul>
<p>Du må ikke få Flixabi, hvis noget af ovenstående passer på dig. Hvis du er i tvivl, så kontakt lægen, før 
du får Flixabi. </p>
<p>Advarsler og forsigtighedsregler 
Kontakt lægen, før eller under behandlingen med Flixabi, hvis du har: </p>
<p>Været i behandling med lægemidler indeholdende infliximab tidligere </p>
<ul>
<li>Fortæl din læge, hvis du tidligere har været i behandling med lægemidler indeholdende 
...
allergisk reaktion, når du starter behandlingen igen. </li>
</ul>
<p>Infektioner </p>
<ul>
<li>
<p>Fortæl din læge, før du får Flixabi, hvis du har en infektion, også selvom det er en meget let 
infektion. </p>
</li>
<li>
<p>Fortæl din læge, før du får Flixabi, hvis du nogensinde har boet eller rejst i et område, hvor 
...
<li>
<p>Du har lettere ved at få infektioner, når du er i behandling med Flixabi. Du har en højere risiko, 
hvis du er 65 år eller derover. </p>
</li>
<li>
...
tænderne. Din læge kan anbefale en midlertidig pause med Flixabi. </p>
</li>
</ul>
<p>Tuberkulose (TB) </p>
<ul>
...
<li>
<p>Din læge vil teste dig for at se, om du har TB. Tilfælde af TB har været rapporteret hos patienter i 
behandling med Flixabi, også hos patienter, der allerede har været i behandling med medicin mod 
TB. Din læge vil notere disse tests på dit patientinformationskort. </p>
</li>
<li>
<p>Hvis din læge tror, at du har risiko for at få TB, kan du blive behandlet med lægemidler mod TB, 
...
<ul>
<li>
<p>Fortæl din læge, før du får Flixabi, hvis du er bærer af hepatitis B, eller hvis du nogensinde har 
haft det. </p>
</li>
<li>
...
<li>
<p>Behandling med TNF-blokkere, såsom Flixabi, kan medføre, at hepatitis B igen bliver aktiv hos 
patienter, som bærer denne virus. Dette kan i nogle tilfælde være livstruende. </p>
</li>
</ul>
<p>Hjerteproblemer </p>
<ul>
...
<li>
<p>Din læge vil nøje overvåge dit hjerte. 
Fortæl straks din læge, hvis du får nye eller forværrede tegn på hjertesvigt under behandlingen med 
Flixabi. Tegn inkluderer åndenød eller hævede fødder. </p>
</li>
</ul>
<p>Kræft og lymfom </p>
<ul>
<li>
<p>Fortæl din læge, før du får Flixabi, hvis du har eller nogensinde har haft lymfom (en type 
blodkræft) eller enhver anden form for kræft. </p>
</li>
<li>
<p>Patienter med alvorlig reumatoid arthritis, som har haft sygdommen i lang tid, kan have en større 
risiko for at udvikle lymfom. </p>
</li>
<li>
<p>Børn og voksne i behandling med Flixabi kan have en øget risiko for at udvikle lymfom eller 
anden form for kræft. </p>
</li>
<li>
<p>Nogle patienter, som har fået TNF-blokerende behandling, herunder Flixabi, har udviklet en 
...
bliver regelmæssigt screenet for livmoderhalskræft. </p>
</li>
</ul>
<p>Lungesygdom eller højt tobaksforbrug </p>
<ul>
<li>
<p>Fortæl din læge, før du får Flixabi, hvis du har en lungesygdom kaldet kronisk obstruktiv 
...
under behandling med Flixabi. </p>
</li>
</ul>
<p>Sygdom i nervesystemet </p>
<ul>
<li>Fortæl din læge, hvis du har eller nogensinde har haft en lidelse, som påvirker dit nervesystem, 
...
<ul>
<li>Fortæl din læge, hvis du har nogen unormale hudåbninger (fistler), før du får Flixabi. </li>
</ul>
<p>Vaccinationer </p>
<ul>
<li>
...
<li>
<p>Du skal have de anbefalede vaccinationer, før du starter behandling med Flixabi. Der er visse 
...
<li>
<p>Hvis du har fået Flixabi, mens du var gravid, kan dit barn også have en større risiko for at få en 
infektion som et resultat af at have fået en levende vaccine i løbet af det første leveår. Det er 
vigtigt, at du fortæller dit barns læger og andet sundhedspersonale, at du får Flixabi, så de kan 
...
har fået Flixabi, før barnet bliver vaccineret. Se afsnittet om Graviditet, amning og frugtbarhed 
...
et terapeutisk smitstof (fx instillation af BCG til behandling af kræft). </li>
</ul>
...
<li>
<p>Fortæl kirurgen eller tandlægen, at du er i behandling med Flixabi ved at vise dem dit 
patientinformationskort. </p>
</li>
</ul>
<p>Leverproblemer </p>
<ul>
<li>Nogle patienter, der får infliximab, har udviklet alvorlige leverproblemer. 
...
maven, ledsmerter, hududslæt eller feber. </li>
</ul>
<p>Lave blodtal </p>
<ul>
<li>Hos nogle patienter, som får infliximab, kan kroppen måske ikke lave nok af de blodlegemer, der 
skal hjælpe med at bekæmpe infektioner eller stoppe blødning.<br />
...
der skyldes blødning under huden, eller bleghed. </li>
</ul>
<p>Sygdomme i immunsystemet </p>
<ul>
<li>Nogle patienter, der får infliximab, har udviklet symptomer på en sygdom i immunsystemet 
kaldet lupus.<br />
Fortæl det straks til lægen, hvis du får symptomer på lupus under behandlingen med Flixabi. Tegn 
omfatter ledsmerter eller udslæt på kinder eller arme, som er følsomme over for solen. </li>
</ul>
<p>Børn og unge </p>
<p>Ovenstående oplysninger gælder også for børn og unge. Derudover gælder, at: </p>
<ul>
<li>
<p>Nogle børn og unge, som har fået TNF-blokkere såsom Flixabi, har udviklet kræft inklusive 
usædvanlige typer kræft, som i visse tilfælde har været dødelige. </p>
</li>
<li>
<p>Flere børn end voksne, der får Flixabi, fik infektioner. </p>
</li>
<li>
<p>Børn skal have de anbefalede vaccinationer, før behandling med Flixabi påbegyndes.  </p>
</li>
<li>
<p>Børn kan få visse vacciner under behandlingen med Flixabi, men må ikke få levende vacciner, 
mens de får Flixabi. </p>
</li>
</ul>
<p>Hvis du er i tvivl, om noget af ovenstående passer på dig, skal du kontakte lægen, før du får Flixabi. </p>
<p>Brug af andre lægemidler sammen med Flixabi 
Patienter, som har betændelsessygdomme, tager allerede lægemidler for at behandle deres lidelse. Disse 
lægemidler kan give bivirkninger. Din læge vil rådgive dig om, hvilke andre lægemidler du skal blive 
ved med at tage, mens du er i behandling med Flixabi. </p>
<p>Fortæl altid lægen, hvis du bruger andre lægemidler, for nylig har brugt andre lægemidler eller 
planlægger at bruge andre lægemidler. Dette gælder også lægemidler til behandling af Crohns sygdom, 
colitis ulcerosa, reumatoid arthritis, ankyloserende spondylitis, psoriasisarthritis eller psoriasis eller 
lægemidler, som ikke er købt på recept, fx naturlægemidler og vitaminer og mineraler </p>
...
<li>
<p>Kineret (som indeholder anakinra). Du må ikke få Flixabi og Kineret samtidig. </p>
</li>
<li>
<p>Orencia (som indeholder abatacept). Du må ikke få Flixabi og Orencia samtidig. </p>
</li>
</ul>
<p>Du må ikke få levende vacciner (f.eks. BCG-vaccine), mens du får Flixabi. Hvis du har fået Flixabi, 
mens du var gravid, eller hvis du får Flixabi, mens du ammer, skal du fortælle dit barns læge og andet 
sundhedspersonale, der tager sig af dit barn, at du har fået Flixabi, før barnet bliver vaccineret. </p>
<p>Hvis du er i tvivl, om noget af ovenstående passer på dig, skal du kontakte lægen eller 
apotekspersonalet, før du får Flixabi. </p>
...
skal du spørge din læge til råds, før du tager dette lægemiddel. Du må kun få Flixabi under 
graviditeten, eller mens du ammer, hvis lægen finder det nødvendigt. </p>
</li>
<li>
<p>Du skal undgå at blive gravid, mens du er i behandling med Flixabi, og i mindst 6 måneder efter 
du er stoppet med behandlingen. Tal med lægen om anvendelse af prævention i denne 
tidsperiode. </p>
</li>
<li>
<p>Hvis du fik Flixabi under graviditeten, kan dit barn have en øget risiko for at få en infektion. </p>
</li>
<li>
<p>Det er vigtigt, at du fortæller dit barns læger og andet sundhedspersonale, at du har fået Flixabi, 
før barnet bliver vaccineret (for mere information, se afsnit om vaccination). Hvis du har fået 
Flixabi under graviditeten, kan vaccination af dit barn med BCG-vaccine (bruges til at forebygge 
tuberkulose) inden for 12 måneder efter fødslen medføre infektion med alvorlige komplikationer 
herunder død. Dit barn bør ikke få levende vacciner som BCG-vaccinen inden for 12 måneder 
efter fødslen, medmindre barnets læge anbefaler noget andet. For mere information, se afsnit om 
vaccination. </p>
</li>
<li>
<p>Hvis du ammer, er det vigtigt, at du fortæller dit barns læge eller andet sundhedspersonale, at du 
har fået Flixabi, før barnet bliver vaccineret. Dit barn må ikke få levende vacciner, mens du 
...
du omgående kontakte barnets læge. </p>
</li>
</ul>
<p>Trafik- og arbejdssikkerhed 
Flixabi påvirker i mindre grad evnen til at føre motorkøretøj og betjene maskiner, f.eks. svimmelhed, 
vertigo. </p>
...
<p>Psoriasisarthritis, ankyloserende spondylitis (Bekhterevs sygdom), psoriasis, colitis ulcerosa og 
Crohns sygdom 
Den sædvanlige dosis er 5 mg pr. kg kropsvægt. </p>
<p>Sådan får du Flixabi </p>
<ul>
<li>
<p>Du vil få Flixabi af din læge eller sygeplejerske. </p>
</li>
<li>
<p>Din læge eller sygeplejerske vil klargøre medicinen til infusion, opløsningen. </p>
</li>
<li>
<p>Medicinenvil blive givet som en infusion (drop) (over 2 timer) i en af dine blodårer (vener), 
sædvanligvis i din arm. Efter den tredje behandling kan din læge beslutte at give dig din dosis 
Flixabi over 1 time. </p>
</li>
<li>
<p>Du vil blive overvåget, mens du får Flixabi og i 1-2 timer derefter. </p>
</li>
</ul>
<p>Så meget Flixabi vil du få </p>
<ul>
<li>
<p>Lægen vil bestemme din dosis og hvor ofte, du skal have Flixabi. Dette vil afhænge af din 
sygdom, vægt og hvor godt, du reagerer på Flixabi. </p>
</li>
<li>
...
<p>Hvis du får for meget Flixabi 
Da du får denne medicin af din læge eller sygeplejerske, er det usandsynligt, at du vil få for meget. Der 
kendes ikke til nogen bivirkninger efter at have fået for meget Flixabi. </p>
...
kræve behandling. Bivirkninger kan også opstå efter ophør af din behandling med Flixabi. </p>
...
led- eller kæbesmerter, ondt i halsen eller hovedpine </p>
</li>
<li>
...
<li>
<p>Tegn på infektion (inklusive tuberkulose (TB)) såsom feber, træthedsfølelse, hoste, der kan 
...
i synet såsom dobbeltsyn eller andre øjenproblemer. </p>
</li>
<li>
...
<li>
<p>Tegn på en sygdom i immunsystemet såsom ledsmerter, udslæt på kinderne eller arme, som er 
følsomme over for solen (lupus) eller hoste, åndenød, feber eller hududslæt (sarkoidose) </p>
</li>
<li>
<p>Tegn på lave blodtal såsom vedvarende feber, blødningstendens, tendens til lettere at få blå 
mærker, små røde eller lilla pletter, der skyldes blødning under huden, eller bleghed. </p>
</li>
<li>
<p>Tegn på alvorlige hudproblemer såsom rødlige, målskivelignende pletter eller runde områder 
ofte med blærer centralt på kroppen, store områder med afskalning (eksfoliation) samt sår i mund, 
svælg, næse, kønsorganer og øjne eller små pusholdige blærer, som kan sprede sig over hele 
kroppen. Disse hudreaktioner kan være ledsaget af feber. </p>
</li>
</ul>
<p>Fortæl straks din læge, hvis du bemærker noget af ovenstående. </p>
<p>Følgende bivirkninger er observeret med infliximab: </p>
<p>De kendte bivirkninger ved Flixabi omfatter følgende, grupperet efter faldende hyppighed: </p>
...
<li>
<p>Hævelse af lever (hepatitis) eller galdeblæren, leverskade </p>
</li>
<li>
...
<li>
<p>Lungehindebetændelse, der giver skarpe smerter, som forværres ved vejrtrækning (pleuritis) </p>
</li>
<li>
<p>Tuberkulose </p>
</li>
...
<li>
<p>Vægtstigning (for de fleste patienter var vægtstigningen lille). </p>
</li>
</ul>
...
<li>
<p>Betændelsestilstand i leveren forårsaget af et problem med immunsystemet (autoimmun hepatitis) </p>
</li>
<li>
...
<li>
<p>Andre hudproblemer såsom erythema multiforme, lichenoide reaktioner (kløende, rødligt-lilla 
hududslæt og/eller trådlignende gråhvide linjer på slimhinderne), blærer og afskalning af huden 
eller bylder (furunkulose) </p>
</li>
<li>
<p>Alvorlige lidelser i nervesystemet såsom transversel myelitis, multipel sklerose-lignende sygdom, 
optisk neuritis og Guillain-Barré syndrom </p>
</li>
<li>
...
<li>
<p>Forværring af en sygdom, der kaldes dermatomyositis (observeres som hududslæt ledsaget af 
muskelsvaghed) </p>
</li>
<li>
<p>Hjerteanfald </p>
...
virusinfektioner, lavt indhold af hvide blodlegemer, der bekæmper infektion, (neutropeni), knoglebrud, 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Flixabi opbevares af sundhedspersonalet på hospitalet eller klinikken. Skulle du få brug for information 
omkring opbevaring, gælder følgende: </p>
<ul>
<li>
...
<li>
<p>Dette lægemiddel kan også opbevares i den originale karton uden for køleskab ved maksimalt 
25 °C i en enkelt periode på op til seks måneder, men den oprindelige udløbsdato må ikke 
overskrides. I tilfælde heraf må lægemidlet ikke sættes tilbage på køl. Skriv den ny udløbsdato på 
kartonen, herunder dag/måned/år. 
Kassér lægemidlet, hvis det ikke er anvendt ved den nye udløbsdato eller udløbsdatoen, der er 
trykt på kartonen, alt efter hvad der kommer først. </p>
</li>
<li>
<p>Det anbefales, at Flixabi anvendes så hurtigt som muligt (inden for 3 timer), efter det er klargjort 
til infusion. Hvis opløsningen er klargjort under aseptiske betingelser, kan den dog opbevares i 
køleskab ved 2 °C til 8 °C i op til 34 dage og i yderligere 24 timer ved 25 °C efter at være taget 
ud af køleskabet. </p>
</li>
<li>
...
<li>
<p>Øvrige indholdsstoffer: saccharose, polysorbat 80 (E 433), monobasisk 
natriumphosphatmonohydrat og dibasisk natriumphosphatheptahydrat. </p>
</li>
</ul>
<p>Udseende og pakningsstørrelser 
Flixabi leveres som et hætteglas (glasflaske) indeholdende et pulver til koncentrat til infusionsvæske, 
opløsning. Pulveret er hvidt. 
...
<p>Patientinformationskortet skal udleveres til patienter, som er i behandling med Flixabi. </p>
...
<p>Flixabi kan opbevares ved temperaturer på maksimalt 25 °C i en enkelt periode på op til 6 måneder, 
som ikke må overskride den oprindelige udløbsdato. Den nye udløbsdato skal skrives på kartonen. Efter 
udtagning fra opbevaring på køl må Flixabi ikke sættes tilbage til opbevaring på køl. </p>
<p>Instruktion i anvendelse og håndtering - rekonstitution, fortynding og administration </p>
<p>For at forbedre sporbarheden af biologiske lægemidler skal det administrerede produkts navn og 
batchnummer tydeligt registreres. </p>
<ol>
<li>
<p>Beregn dosis og det nødvendige antal Flixabi-hætteglas. Hvert Flixabi-hætteglas indeholder 
100 mg infliximab. Beregn det samlede påkrævede volumen rekonstitueret Flixabi-opløsning. </p>
</li>
<li>
<p>Rekonstituer under aseptiske forhold hvert Flixabi-hætteglas med 10 ml vand til injektionsvæsker 
ved hjælp af en sprøjte med en gauge 21 (0,8 mm) kanyle eller en mindre kanyle. Fjern plastiklåget 
fra hætteglasset og tør toppen med en 70 % alkoholvatpind. Indsæt sprøjtekanylen i hætteglasset 
gennem midten af gummiproppen og ret strålen med vand til injektionsvæsker mod glasvæggen i 
hætteglasset. Bland forsigtigt opløsningen ved forsigtigt at slynge hætteglasset rundt for at opløse 
det lyofiliserede pulver. Undgå at svinge for længe eller for kraftigt. MÅ IKKE RYSTES. 
Opskumning af opløsningen ved rekonstitution er ikke usædvanligt. Lad det rekonstituerede 
opløsning stå i 5 minutter. Kontroller at opløsningen er farveløs til lysegul og opaliserende. Der 
kan opstå nogle få fine gennemsigtige partikler i koncentratet, da infliximab er et protein. 
Opløsningen må ikke anvendes, hvis det indeholder uigennemsigtige partikler, er misfarvet eller 
indeholder andre fremmedlegemer. </p>
</li>
<li>
<p>Fortynd det samlede volumen af den rekonstituerede dosis Flixabi-opløsning til 250 ml med 
natriumchlorid 9 mg/ml (0,9 %) infusionsvæske, opløsning. Fortynd ikke det rekonstituerede 
Flixabi-koncentrat med andre infusionsvæsker. Fortyndingen kan opnås ved at udtrække et 
volumen af natriumchlorid 9 mg/ml (0,9 %) infusionsvæske, opløsning, fra 250 ml glasflasken 
eller infusionsposen svarende til voluminet af den rekonstituerede Flixabi-opløsning. Tilsæt 
langsomt det samlede volumen af rekonstitueret Flixabi-opløsning til 250 ml infusionsflasken eller 
-posen. Bland forsigtigt. Brug enten en større infusionspose (fx 500 ml, 1.000 ml) til voluminer 
...
forud for trin 4 (infusion). Opbevaring i mere end 24 timer ved 2 °C til 8 °C gælder udelukkende 
for klargøring af Flixabi i infusionsposen. </p>
</li>
<li>
<p>Indgiv infusionsvæsken over en periode på ikke mindre end den anbefalede infusionstid. Anvend 
kun et infusionssæt med et in-line, sterilt, ikke-pyrogent, minimalt proteinbindende filter 
(porestørrelse 1,2 μm eller derunder). Da der ikke er anvendt konserveringsmiddel, anbefales det, 
at indgivelsen af infusionsvæsken, opløsningen, påbegyndes så hurtigt som muligt og inden for 
...
ikke overskride 24 timer ved 2 °C til 8 °C, medmindre rekonstitution/fortynding har fundet sted 
under kontrollerede og validerede aseptiske forhold. Opbevar ikke rester af den ikke anvendte 
infusionsvæske til fornyet brug. </p>
</li>
<li>
<p>Der er ikke gennemført biokemiske forligelighedsstudier for at vurdere samtidig indgivelse af 
Flixabi med andre midler. Infunder ikke Flixabi i den samme intravenøse slange med andre midler. </p>
</li>
<li>
<p>Undersøg Flixabi visuelt for partikler eller misfarvning før indgivelsen. Anvendes ikke, hvis der 
observeres synligt uigennemsigtige partikler, misfarvning eller fremmedlegemer. </p>
</li>
<li>
