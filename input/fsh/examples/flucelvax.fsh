...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>You should not receive Flucelvax Tetra: 
...
residues from the manufacturing process. </p>
<p>Warnings and precautions<br />
Talk to your doctor, pharmacist or nurse before receiving Flucelvax Tetra. </p>
...
administration. This reaction may occur with Flucelvax Tetra as with all vaccines that are injected. 
* You should tell your doctor if you have an acute illness associated with fever. Your doctor may 
decide to delay your vaccination until your fever is gone. </p>
<ul>
...
<p>Children aged less than 2 years 
This vaccine is currently not recommended in children aged less than 2 years as safety and efficacy in 
this age group have not been established. </p>
<p>Other medicines and Flucelvax Tetra<br />
Tell your doctor or nurse if you are using, have recently used or might use any other medicines, 
including medicines obtained without a prescription or if you have recently received any other 
vaccine. </p>
<p>Flucelvax Tetra may be given at the same time as other vaccines. </p>
...
Influenza vaccines may be given in any trimester of pregnancy.  </p>
<p>Breast-feeding 
Use of Flucelvax Tetra during breast-feeding has not been studied. No effects on breast fed babies are 
expected. Flucelvax Tetra may be given during breast-feeding. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Flucelvax Tetra is given to you by your doctor or nurse as an injection into the muscle at the top of the 
upper arm (deltoid muscle) or into the muscle of the upper and outer part of the thigh in young 
children depending on the muscle size. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Flucelvax Tetra contains  </p>
<p>The active substances are influenza virus surface antigens (haemagglutinin and neuraminidase), 
inactivated, of the following strains*: </p>
<p>A/Wisconsin/67/2022 (H1N1)pdm09-like strain (A/Georgia/12/2022 CVR-167) 15 micrograms HA<strong> 
A/Darwin/6/2021 (H3N2)-like strain (A/Darwin/11/2021, wild type) 15 micrograms HA</strong> 
...
Flucelvax Tetra is available in packs containing 1 pre-filled syringe with or without needle or 10 pre-
filled syringes with or without needles. 
...
* section[=].section[+]
  * title = "2. Det skal du vide, før du begynder at tage  flucelvax"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "2. Det skal du vide, før du begynder at tage  flucelvax"
  * text.status = #additional
...
* section[=].section[+]
  * title =  "3. Sådan skal du tage flucelvax"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "3. Sådan skal du tage flucelvax"
  * text.status = #additional
