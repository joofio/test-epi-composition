...
Instance: composition-en-622a07d3e5a04e7612a8bd99c6c58083
...
* identifier.value = "EU/1/09/594/001-005"
* status = #final
...
* title = "TEST PURPOSES ONLY - hirobriz"
...
<ol>
<li>What Hirobriz Breezhaler is and what it is used for </li>
<li>What you need to know before you use Hirobriz Breezhaler </li>
<li>How to use Hirobriz Breezhaler </li>
...
* section[=].section[+]
  * title =  "1. What hirobriz is and what it is used for"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text =  "1. What hirobriz is and what it is used for"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Hirobriz Breezhaler is 
Hirobriz Breezhaler contains the active substance indacaterol which belongs to a group of medicines 
called bronchodilators. When you inhale it, it relaxes the muscles in the walls of the small air passages 
in the lungs. This helps open up the airways, making it easier to get air in and out. </p>
<p>What Hirobriz Breezhaler is used for 
...
* section[=].section[+]
  * title = "2. What you need to know before you take hirobriz"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "2. What you need to know before you take hirobriz"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not use Hirobriz Breezhaler 
- if you are allergic to indacaterol or any of the other ingredients of this medicine (listed in 
section 6). </p>
<p>Warnings and precautions 
Talk to your doctor or pharmacist before using Hirobriz Breezhaler </p>
<p>if you have asthma (in this case you should not use Hirobriz Breezhaler). </p>
...
<p>During treatment with Hirobriz Breezhaler, </p>
<p>Stop using the medicine and tell your doctor immediately if you get tightness of the chest, 
coughing, wheezing or breathlessness immediately after using the medicine. These may be signs 
of a condition called bronchospasm. </p>
<p>Tell your doctor immediately if your COPD symptoms (breathlessness, wheezing, cough) do 
not improve or get worse. 
Children and adolescents 
Hirobriz Breezhaler should not be given to children or adolescents below the age of 18 years. </p>
<p>Other medicines and Hirobriz Breezhaler 
Tell your doctor or pharmacist if you are taking, have recently taken or might take any other 
medicines. 
In particular, please tell your doctor if you are using: </p>
<p>medicines for breathing problems that are similar to Hirobriz Breezhaler (i.e. medicines such as 
salmeterol and formoterol). You may be more likely to get side effects. </p>
<p>medicines called beta blockers that are used for high blood pressure or other heart problems 
(such as propranolol), or for the eye problem called glaucoma (such as timolol). </p>
<p>medicines that lower the amount of potassium in your blood. These include: * 
...
<p>You should not use Hirobriz Breezhaler unless your doctor tells you so. </p>
...
* section[=].section[+]
  ...
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "3. How to take hirobriz"
  * text.status = #additional
...
you are not sure. </p>
<p>How much Hirobriz Breezhaler to use </p>
<p>The usual dose is to inhale the content of one capsule each day. Your doctor may tell you to use 
the 150 microgram capsule or the 300 microgram capsule depending on your condition and on 
how you respond to the treatment. Do not use more than your doctor tells you to use. </p>
<p>Use your inhaler at the same time each day, the effects last for 24 hours. This ensures that there 
is always enough medicine in your body to help you breathe more easily throughout the day and 
night. It will also help you to remember to use it. </p>
<p>How to use Hirobriz Breezhaler </p>
<p>In this pack, you will find an inhaler and capsules (in blister) that contain the medicine as 
inhalation powder. The Hirobriz Breezhaler inhaler enables you to inhale the medicine 
contained in a capsule. </p>
<p>Only use the capsules with the inhaler provided in this pack (Hirobriz Breezhaler inhaler). The 
capsules should remain in the blister until you need to use them. </p>
<p>When you start a new pack, use the new Hirobriz Breezhaler inhaler that is supplied in the pack. </p>
...
may have a headache, feel drowsy, feel nauseous or have to vomit. </p>
<p>If you forget to use Hirobriz Breezhaler 
...
<p>How long to continue your treatment with Hirobriz Breezhaler </p>
<p>Keep using your treatment with Hirobriz Breezhaler for as long as your doctor tells you. </p>
<p>COPD is a long-term disease and you should use Hirobriz Breezhaler every day and not only 
...
<p>if you get high levels of sugar in your blood (diabetes). You will feel tired, very thirsty and 
hungry (without gaining weight) and will pass more urine than usual (common). </p>
<p>if you get irregular heart beat (uncommon). </p>
<p>if you get symptoms of an allergic reaction such as rash, itching, hives, difficulty breathing or 
swallowing, dizziness (uncommon). </p>
<p>if you have difficulty breathing with wheezing or coughing (uncommon). </p>
<p>Other side effects may include: </p>
<p>Very common side effects (may affect more than 1 in 10 people) </p>
<p>cold-like symptoms. You may get all or most of the following: sore throat, runny nose, blocked 
nose, sneezing, coughing, headache. </p>
<p>Common side effects (may affect up to 1 in 10 people) </p>
<p>feeling of pressure or pain in the cheeks and forehead (inflammation of the sinuses) </p>
<p>runny nose </p>
<p>cough </p>
<p>sore throat </p>
<p>headache </p>
...
<p>muscle pain </p>
<p>Some people occasionally cough soon after inhaling the medicine. Cough is a common symptom in 
...
there is no need for concern. If the capsule is not empty then inhale again as directed. </p>
...
* section[=].section[+]
  ...
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "5. How to store hirobriz"
  * text.status = #additional
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Hirobriz Breezhaler contains 
- Each Hirobriz Breezhaler 150 microgram capsule contains 150 microgram indacaterol as 
...
indacaterol maleate. The other ingredients include lactose and the capsule is made of gelatin. </p>
<p>What Hirobriz Breezhaler looks like and content of the pack 
In this pack, you will find an inhaler, together with capsules in blister. The capsules are transparent 
(uncoloured) and contain a white powder. </p>
<p>Hirobriz Breezhaler 150 microgram capsules have a black product code  IDL 150  printed 
above a black bar and a black company logo (
) printed below the black bar. </p>
<p>Hirobriz Breezhaler 300 microgram capsules have a blue product code  IDL 300  printed 
above a blue bar and a blue company logo (
) printed below the blue bar. </p>
...
INSTRUCTIONS FOR USE OF HIROBRIZ BREEZHALER INHALER </p>
<p>Please read the full Instructions for Use before using the Hirobriz Breezhaler. </p>
<p>Insert 
Pierce and release 
Inhale deeply 
...
<p>Step 1e: 
Close inhaler </p>
<p>Your Hirobriz Breezhaler Inhaler pack contains: 
  One Hirobriz Breezhaler inhaler 
  One or more blister cards, each containing either 
6 or 10 Hirobriz Breezhaler capsules to be used 
in the inhaler </p>
<p>Frequently Asked 
Questions </p>
...
Instance: composition-da-622a07d3e5a04e7612a8bd99c6c58083
InstanceOf: CompositionUvEpi
Title: "Composition for hirobriz Package Leaflet"
Description:  "Composition for hirobriz Package Leaflet"
Usage: #inline
...
små luftpassager). Dette hjælper med at åbne luftvejene, hvilket gør det nemmere at trække vejret. </p>
<p>Anvendelse 
...
* section[=].section[+]
  * title = "2. Det skal du vide, før du begynder at tage  hirobriz"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "2. Det skal du vide, før du begynder at tage  hirobriz"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Tag ikke Hirobriz Breezhaler 
- hvis du er allergisk over for indacaterol eller et af de øvrige indholdsstoffer i Hirobriz 
Breezhaler (angivet i punkt 6). </p>
...
<p>Under behandling med Hirobriz Breezhaler: 
 
Stop med at tage medicinen og fortæl det øjeblikkeligt til din læge, hvis du oplever trykken 
...
 
Fortæl det øjeblikkeligt til lægen, hvis dine KOL-symptomer (stakåndethed, hvæsen, hoste) 
ikke forbedres eller bliver værre. </p>
<p>Børn og unge 
Hirobriz Breezhaler må ikke gives til børn eller unge under 18 år. </p>
<p>Brug af anden medicin sammen med Hirobriz Breezhaler 
...
hydrochlorthiazid, * 
medicin mod åndedrætsbesvær, som fx theofyllin. </p>
<p>Graviditet og amning 
Hvis du er gravid eller ammer, har mistanke om, at du er gravid, eller planlægger at blive gravid skal 
du spørge din læge eller apotekspersonalet til råds, før du tager dette lægemiddel. </p>
<p>Du må ikke tage Hirobriz Breezhaler, medmindre du har aftalt det med din læge. </p>
...
* section[=].section[+]
  * title =  "3. Sådan skal du tage hirobriz"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "3. Sådan skal du tage hirobriz"
  * text.status = #additional
...
apotekspersonalet. </p>
<p>Så meget Hirobriz Breezhaler skal du tage 
 
...
løbet af dagen og natten. Det hjælper dig også til at huske at tage medicinen. </p>
<p>Sådan skal du tage Hirobriz Breezhaler 
 
...
hvordan du bruger inhalatoren. </p>
<p>Hvis du har taget for meget Hirobriz Breezhaler 
...
hjerte slår hurtigere end normalt, eller du kan få hovedpine, føle dig sløv, have kvalme eller kaste op. </p>
<p>Hvis du har glemt at tage Hirobriz Breezhaler 
Hvis du glemmer at inhalere en dosis, skal du blot inhalere en dosis til sædvanlig tid næste dag. Du må 
ikke inhalere en dobbeltdosis som erstatning for den glemte dosis. </p>
<p>Så længe skal du fortsætte med Hirobriz Breezhaler-behandling 
 
Fortsæt med Hirobriz Breezhaler-behandlingen, så længe din læge siger, at du skal gøre det. 
 
KOL er en langtidssygdom, og du skal bruge Hirobriz Breezhaler hver dag og ikke blot, når du 
...
<p>Nogle bivirkninger kan være alvorlige. Kontakt øjeblikkeligt din læge: 
 
...
 
hvis du har besværet vejrtrækning med hvæsen eller hoste (ikke almindelig bivirkning). </p>
...
halsen, løbende næse, tilstoppet næse, nysen, hoste, hovedpine. </p>
...
brystsmerter 
 
Smerter i muskler, knogler eller led </p>
...
 
muskelsmerter </p>
<p>Nogle patienter hoster engang imellem lige efter inhalation af medicinen. Hoste er et typisk symptom 
...
henhold til brugsanvisningen. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Hirobriz Breezhaler indeholder:</p>
<ul>
<li>Hver Hirobriz Breezhaler 150 mikrogram kapsel indeholder 150 mikrogram indacaterol i form 
af indacaterolmaleat. Øvrige indholdsstoffer: lactose og kapslen er lavet af gelatine. </li>
<li>Hver Hirobriz Breezhaler 300 mikrogram kapsel indeholder 300 mikrogram indacaterol i form 
af indacaterolmaleat. Øvrige indholdsstoffer: lactose og kapslen er lavet af gelatine. </li>
</ul>
<p>Udseende og pakningsstørrelser 
Denne pakning indeholder en inhalator samt kapsler i blister. Kapslerne er gennemsigtige (farveløse) 
og indeholder et hvidt pulver. </p>
<p> 
Hirobriz Breezhaler 150 mikrogram kapsler har påtrykt en sort produktkode "IDL 150" over en 
sort bjælke og et sort virksomhedslogo (
) påtrykt under den sorte bjælke. 
 
Hirobriz Breezhaler 300 mikrogram kapsler har påtrykt en blå produktkode "IDL 300" over en 
blå bjælke og et blåt virksomhedslogo (
) påtrykt under den blå bjælke. </p>
...
Multipakning bestående af 30 pakninger (hver pakning indeholder 10 kapsler og 1 inhalator). </p>
...
<p>BRUGSANVISNING TIL HIROBRIZ BREEZHALER-INHALATOR </p>
<p>Læs venligst den fulde anvisning for brug inden du bruger Hirobriz Breezhaler. </p>
<p>Læg en kapsel i 
Perforer og slip 
Inhaler dybt 
...
med almindeligt 
husholdningsaffald. Luk 
inhalatoren, og sæt hætten 
på igen. </p>
<p>Trin 1d: 
Læg kapslen i 
kapselkammeret 
...
<p>Trin 1e: 
Luk inhalatoren </p>
<p>Din Hirobriz Breezhaler inhalatorpakning 
indeholder: 
 
En Hirobriz Breezhaler inhalator 
 
Et eller flere blisterkort, som hver indeholder 
enten 6 eller 10 Hirobriz Breezhaler kapsler til 
...
ved at banke let på 
kapslens underdel. Inhaler 
medicinen igen ved at 
gentage trin 3a til 3c. </p>
...
længe kaplsen er tom, har 
du fået tilstrækkelig 
...
Instance: composition-pt-622a07d3e5a04e7612a8bd99c6c58083
InstanceOf: CompositionUvEpi
Title: "Composition for hirobriz Package Leaflet"
Description:  "Composition for hirobriz Package Leaflet"
Usage: #inline
...
1. O que é Hirobriz Breezhaler e para que é utilizado 
2. O que precisa de saber antes de utilizar Hirobriz Breezhaler 
...
* section[=].section[+]
  * title =  "1. O que é hirobriz e para que é utilizado"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text =  "1. O que é hirobriz e para que é utilizado"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>O que é Hirobriz Breezhaler 
Hirobriz Breezhaler contém a substância ativa indacaterol que pertence a um grupo de medicamentos 
...
saída de ar. </p>
<p>Para que é utilizado Hirobriz Breezhaler 
Hirobriz Breezhaler é utilizado para facilitar a respiração em doentes adultos que tenham dificuldades 
...
* section[=].section[+]
  * title = "2. O que precisa de saber antes de tomar hirobriz"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "2. O que precisa de saber antes de tomar hirobriz"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Não utilize Hirobriz Breezhaler 
...
 
se tem diabetes. </p>
<p>Durante o tratamento com Hirobriz Breezhaler, 
 
...
Hirobriz Breezhaler não deve ser dado a crianças ou adolescentes com menos de 18 anos de idade. </p>
<p>Outros medicamentos e Hirobriz Breezhaler 
Informe o seu médico ou farmacêutico se estiver a tomar, tiver tomado recentemente, ou se vier a 
tomar outros medicamentos. 
Em particular, por favor informe o seu médico se está a tomar: 
 
medicamentos para problemas respiratórios que sejam semelhantes a Hirobriz Breezhaler (ou 
seja, medicamentos como salmeterol e formoterol). Terá maior probabilidade de ter efeitos 
indesejáveis. 
 
...
<p>Não deve utilizar Hirobriz Breezhaler a não ser que o seu médico lhe diga para tal. </p>
...
* section[=].section[+]
  ...
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "3. Como tomar hirobriz"
  * text.status = #additional
...
<p>Que quantidade de Hirobriz Breezhaler utilizar 
 
...
<p>Como utilizar Hirobriz Breezhaler 
 
Nesta embalagem encontrará um inalador e cápsulas (em blisters) que contêm o medicamento 
na forma de pó para inalação. O inalador Hirobriz Breezhaler permite-lhe inalar o medicamento 
contido nas cápsulas. 
 
Utilize apenas as cápsulas com o inalador fornecido na embalagem (inalador Hirobriz 
Breezhaler). As cápsulas devem manter-se no blister até que necessite de as utilizar. 
 
Quando iniciar uma nova embalagem, utilize o novo inalador Hirobriz Breezhaler fornecido na 
embalagem. 
 
...
<p>Se utilizar mais Hirobriz Breezhaler do que deveria 
Se tiver inalado demasiado Hirobriz Breezhaler ou se alguém utilizar as suas cápsulas, informe o seu 
médico imediatamente ou dirija-se à urgência hospitalar mais próxima. Mostre a embalagem de 
Hirobriz Breezhaler. Podem ser necessários cuidados médicos. Pode reparar que o seu coração bate 
mais rapidamente que o normal, ou pode ter uma dor de cabeça, sentir-se sonolento, enjoado ou ter 
que vomitar. </p>
<p>Caso se tenha esquecido de utilizar Hirobriz Breezhaler 
...
<p>Durante quanto tempo deve continuar o seu tratamento com Hirobriz Breezhaler 
 
Continue o seu tratamento com Hirobriz Breezhaler enquanto o médico lhe disser para tal. 
 
A DPOC é uma doença crónica e deve utilizar Hirobriz Breezhaler diariamente e não apenas 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Qual a composição de Hirobriz Breezhaler 
- Cada cápsula de 150 microgramas de Hirobriz Breezhaler contém 150 microgramas de 
indacaterol, como maleato de indacaterol. Os outros componentes incluem lactose e a cápsula é 
feita de gelatina. 
- Cada cápsula de 300 microgramas de Hirobriz Breezhaler contém 300 microgramas de 
indacaterol, como maleato de indacaterol. Os outros componentes incluem lactose e a cápsula é 
feita de gelatina. </p>
<p>Qual o aspeto de Hirobriz Breezhaler e conteúdo da embalagem 
...
<p> 
As cápsulas de 150 microgramas de Hirobriz Breezhaler são transparentes e incolores. Têm um 
código de produto “IDL 150" impresso em preto acima de uma barra preta e o logótipo da 
companhia (
) impresso em preto sob a barra preta. 
 
As cápsulas de 300 microgramas de Hirobriz Breezhaler são transparentes e incolores. Têm um 
...
// MPD
* entry[+].fullUrl = "MedicinalProductDefinition/mp622a07d3e5a04e7612a8bd99c6c58083"
* entry[=].resource = mp622a07d3e5a04e7612a8bd99c6c58083
                            
                    
Instance: bundlepackageleaflet-da-622a07d3e5a04e7612a8bd99c6c58083
InstanceOf: BundleUvEpi
Title: "ePI document Bundle for hirobriz Package Leaflet for language da"
Description: "ePI document Bundle for hirobriz Package Leaflet for language da"
Usage: #example
...
// Composition
* entry[0].fullUrl = "Composition/composition-da-622a07d3e5a04e7612a8bd99c6c58083"
* entry[0].resource = composition-da-622a07d3e5a04e7612a8bd99c6c58083
...
Instance: bundlepackageleaflet-pt-622a07d3e5a04e7612a8bd99c6c58083
InstanceOf: BundleUvEpi
Title: "ePI document Bundle for hirobriz Package Leaflet for language pt"
Description: "ePI document Bundle for hirobriz Package Leaflet for language pt"
Usage: #example
...
// Composition
* entry[0].fullUrl = "Composition/composition-pt-622a07d3e5a04e7612a8bd99c6c58083"
* entry[0].resource = composition-pt-622a07d3e5a04e7612a8bd99c6c58083
...
RuleSet: 622a07d3e5a04e7612a8bd99c6c58083ListRuleset

* identifier.system = "http://ema.europa.eu/identifier" 
* identifier.value = "None"
* identifier[+].system = "http://spor.ema.europa.eu/v2/medicine-name"
* identifier[=].value = "hirobriz"
...
* entry[+]
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-en-622a07d3e5a04e7612a8bd99c6c58083) // hirobriz en
...
* entry[+]
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-da-622a07d3e5a04e7612a8bd99c6c58083) // hirobriz da
  * item.extension[0].url = "http://ema.europa.eu/fhir/extension/documentType"
  * item.extension[=].valueCoding = $100000155531#100000155538 "B. PACKAGE LEAFLET"
  * item.extension[+].url = "http://ema.europa.eu/fhir/extension/language"
...
* entry[+]
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-pt-622a07d3e5a04e7612a8bd99c6c58083) // hirobriz pt
  * item.extension[0].url = "http://ema.europa.eu/fhir/extension/documentType"
  * item.extension[=].valueCoding = $100000155531#100000155538 "B. PACKAGE LEAFLET"
  * item.extension[+].url = "http://ema.europa.eu/fhir/extension/language"
