...
* identifier.value = "EU/1/14/987/001"
* status = #final

* type = https://spor.ema.europa.eu/rmswi/#100000155538
* type.text = "Package Leaflet"

* subject = Reference(mp9435ec03e40e267b4ae7d35097656572)
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Holoclar is a medicine used for replacing damaged cells of the cornea (the clear layer that covers the 
coloured iris at the front of the eye) including limbal cells which normally help to maintain the health 
of your eye. </p>
<p>Holoclar consists of a layer of your own cells which have been grown (ex vivo expanded) from a 
...
be repeated. The cells used to make Holoclar are known as autologous limbal cells: </p>
<ul>
<li>Autologous means that they are your own cells. </li>
<li>The limbus is part of the eye. It is the rim surrounding the coloured centre (iris) of your 
eye. The picture shows where the limbus is in your eye. </li>
<li>The limbus contains limbal cells which normally help to maintain the health of your 
eye and some of these are stem cells which can make new cells. These new cells can 
replace the damaged cells in your eye. </li>
</ul>
<p>Holoclar is implanted to repair the damaged surface of the eye in adults. When the eye is badly 
...
than yourself. </p>
<p>If you have an acute eye infection or swollen, red (inflamed) eyes, your treatment should be delayed 
until you have recovered. </p>
...
cells do not meet all the quality requirements. Your surgeon will inform you about this. </p>
<p>Children and adolescents 
Only a very small number of children have been treated so far, so it is not known whether the 
medicine is safe for use in children or how effective it may be. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Holoclar can only be prescribed and given by an eye surgeon in a hospital.<br />
Treatment with Holoclar is a two-step procedure. </p>
<p>Visit 1: Biopsy taken 
On the first visit, the surgeon will carry out a biopsy, which means removing a very small amount of 
tissue containing limbal cells (from your eye). Before the biopsy, the surgeon will give you eye-
drops to anaesthetise your eye and surgically take the biopsy. This biopsy will then be used to make 
Holoclar. After biopsy has been taken, your surgeon will prescribe a course of antibiotics for you to 
reduce the chance of an infection.<br />
It will take several weeks to produce Holoclar. </p>
<p>Visit 2: Holoclar implantation 
On the second visit the surgeon will: 
* Anaesthetise your eye<br />
...
three days and your eye will be bandaged for 10 to 15 days after the implantation. </p>
<p>After surgery, you will be prescribed a course of medicines to ensure full healing: antibiotics to reduce 
...
<p>Most side effects affect the eye, some of which are caused by the surgery. Most side effects are 
mild and disappear in the weeks after surgery. </p>
<p>The most serious side effects are problem with cornea (erosion) and perforation of the cornea, 
which may occur within the 3 months from Holoclar implantation. In such a case, please contact 
your surgeon. </p>
<p>Very common: may affect more than 1 in 10 people 
* Inflammation of the eyelids (blepharitis)  </p>
<p>Common: may affect up to 1 in 10 people 
* Bleeding around the site of the operation where Holoclar was inserted 
* Problems with cornea (erosion) 
* Increased pressure in the eye (glaucoma) 
* Eye pain 
* Inflammation of the cornea  </p>
<p>Uncommon: may affect up to 1 in 100 people 
* Eye disorders - stickiness of the eyelid, bloodshot eyes, swelling of the eye, perforation of 
the cornea and eye irritation 
* Sensitivity to light 
* Overgrowth around the implant (metaplasia) 
* Infection of the cornea 
* The stitches break 
* Fainting 
* Bleeding from the eye lid skin </p>
...
* section[=].section[+]
  ...
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "2. Det skal du vide, før du begynder at tage  holoclar"
  * text.status = #additional
...
* section[=].section[+]
  ...
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "3. Sådan skal du tage holoclar"
  * text.status = #additional
