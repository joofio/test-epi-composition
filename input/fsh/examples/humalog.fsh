...
Instance: composition-en-35570a7ffa4ad1ddf8a920b1728d4cd2
...
<ol>
<li>What Humalog is and what it is used for </li>
<li>What you need to know before you use Humalog </li>
<li>How to use Humalog </li>
<li>Possible side effects </li>
<li>How to store Humalog </li>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do NOT use Humalog 
- if you think hypoglycaemia (low blood sugar) is starting. Further in this leaflet it tells you how 
to deal with mild hypoglycaemia (see Section 3: If you use more Humalog than you should). 
...
* If your blood sugar levels are well controlled by your current insulin therapy, you may not 
feel the warning symptoms when your blood sugar is falling too low. Warning signs are listed 
later in this leaflet. You must think carefully about when to have your meals, how often to 
exercise and how much to do. You must also keep a close watch on your blood sugar levels by 
testing your blood glucose often. 
...
may not work very well if you inject into a lumpy area (See How to use Humalog). Contact your 
...
<p>Other medicines and Humalog 
Your insulin needs may change if you are taking<br />
<em> the contraceptive pill,<br />
</em> steroids,<br />
<em> thyroid hormone replacement therapy,<br />
</em> oral hypoglycaemics,<br />
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Always use Humalog exactly as your doctor has told you. You should check with your doctor if you 
are not sure. </p>
<p>Dose 
...
first injection or it may be a gradual change over several weeks or months.<br />
* Inject Humalog under the skin. You should only inject it into a muscle if your doctor has told 
you to. </p>
<p>Preparing Humalog 
* Humalog is already dissolved in water, so you do not need to mix it. But you must use it only if 
...
Humalog you want. Your doctor or clinic will tell you how to do this. Do not share your 
...
glucose levels are too high. </p>
<p>Using Humalog in an infusion pump 
...
* When used with an insulin infusion pump, Humalog should not be mixed with any other insulin. </p>
<p>If you use more Humalog than you should<br />
If you use more Humalog than you need or are unsure how much you have injected, a low blood sugar 
may occur.  Check your blood sugar.  </p>
<p>If your blood sugar is low (mild hypoglycaemia), eat glucose tablets, sugar or drink a sugary drink. 
...
<p>If you forget to use Humalog 
If you take less Humalog than you need or are unsure how much you have injected, a high blood sugar 
may occur.  Check your blood sugar. </p>
...
<li>
<p>fruity smell on the breath </p>
</li>
<li>
<p>thirst  </p>
</li>
<li>
<p>feeling or being sick </p>
</li>
</ul>
...
acidity.  </p>
<p>What Humalog looks like and contents of the pack 
...
Instance: composition-da-35570a7ffa4ad1ddf8a920b1728d4cd2
InstanceOf: CompositionUvEpi
Title: "Composition for humalog Package Leaflet"
Description:  "Composition for humalog Package Leaflet"
Usage: #inline
...
* section[=].section[+]
  ...
  * code.text =  "1. What humalog is and what it is used for"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Humalog anvendes til at behandle diabetes. Humalog virker hurtigere end almindelig human insulin, 
...
* section[=].section[+]
  ...
  * code.text = "2. What you need to know before you take humalog"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Brug IKKE Humalog 
...
* section[=].section[+]
  ...
  * code.text = "5. How to store humalog"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Humalog opbevares i køleskab (2ºC - 8ºC), indtil det tages i brug for første gang. Må ikke nedfryses. 
...
* section[=].section[+]
  ...
  * code.text = "6. Contents of the pack and other information"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Humalog 100 enheder/ml injektionsvæske, opløsning, i hætteglas indeholder:</p>
<ul>
...
Instance: bundlepackageleaflet-en-35570a7ffa4ad1ddf8a920b1728d4cd2
InstanceOf: BundleUvEpi
Title: "ePI document Bundle for humalog Package Leaflet for language en"
Description: "ePI document Bundle for humalog Package Leaflet for language en"
Usage: #example
...
// Composition
* entry[0].fullUrl = "Composition/composition-en-35570a7ffa4ad1ddf8a920b1728d4cd2"
* entry[0].resource = composition-en-35570a7ffa4ad1ddf8a920b1728d4cd2

// MPD
* entry[+].fullUrl = "MedicinalProductDefinition/mp35570a7ffa4ad1ddf8a920b1728d4cd2"
* entry[=].resource = mp35570a7ffa4ad1ddf8a920b1728d4cd2
                            
                    
Instance: bundlepackageleaflet-da-35570a7ffa4ad1ddf8a920b1728d4cd2
InstanceOf: BundleUvEpi
Title: "ePI document Bundle for humalog Package Leaflet for language da"
Description: "ePI document Bundle for humalog Package Leaflet for language da"
Usage: #example
...
// Composition
* entry[0].fullUrl = "Composition/composition-da-35570a7ffa4ad1ddf8a920b1728d4cd2"
* entry[0].resource = composition-da-35570a7ffa4ad1ddf8a920b1728d4cd2
...
Instance: mp35570a7ffa4ad1ddf8a920b1728d4cd2
InstanceOf: MedicinalProductDefinitionUvEpi
Title: "Medicinal Product Humalog 100 units/ml solution for injection in vial"
Description: "Humalog 100 units/ml solution for injection in vial"
Usage: #inline

 
* identifier[+].system = "http://ema.europa.eu/identifier"
* identifier[=].value = "EU/1/96/007/002"
...
* name
  * productName = "Humalog 100 units/ml solution for injection in vial"
...
* entry
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-en-35570a7ffa4ad1ddf8a920b1728d4cd2) // humalog en
...
* entry
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-da-35570a7ffa4ad1ddf8a920b1728d4cd2) // humalog da
  * item.extension[0].url = "http://ema.europa.eu/fhir/extension/documentType"
  * item.extension[=].valueCoding = $100000155531#100000155538 "B. PACKAGE LEAFLET"
  * item.extension[+].url = "http://ema.europa.eu/fhir/extension/language"
...
Instance: List-35570a7ffa4ad1ddf8a920b1728d4cd2
InstanceOf: List
