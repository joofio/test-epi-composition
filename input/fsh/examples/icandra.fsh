...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>The active substances of Icandra, vildagliptin and metformin, belong to a group of medicines called 
 oral antidiabetics . </p>
<p>Icandra is used to treat adult patients with type 2 diabetes. This type of diabetes is also known as non-
insulin-dependent diabetes mellitus. Icandra is used when diabetes cannot be controlled by diet and 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not take Icandra 
...
<p>Stop taking Icandra for a short time if you have a condition that may be associated with 
...
<p>Stop taking Icandra and contact a doctor or the nearest hospital immediately if you experience 
...
<p>Icandra is not a substitute for insulin. Therefore, you should not receive Icandra for the treatment of 
type 1 diabetes. </p>
<p>Talk to your doctor, pharmacist or nurse before taking Icandra if you have or have had a disease of the 
pancreas. </p>
<p>Talk to your doctor, pharmacist or nurse before taking Icandra if you are taking an anti-diabetic 
medicine known as a sulphonylurea. Your doctor may want to reduce your dose of the sulphonylurea 
when you take it together with Icandra in order to avoid low blood glucose (hypoglycaemia). </p>
...
<p>If you need to have major surgery you must stop taking Icandra during and for some time after the 
procedure. Your doctor will decide when you must stop and when to restart your treatment with 
Icandra. </p>
<p>A test to determine your liver function will be performed before the start of Icandra treatment, at three-
...
<p>During treatment with Icandra, your doctor will check your kidney function at least once a year or 
...
The use of Icandra in children and adolescents up to 18 years of age is not recommended. </p>
<p>Other medicines and Icandra 
If you need to have an injection of a contrast medium that contains iodine into your bloodstream, for 
example in the context of an X-ray or scan, you must stop taking Icandra before or at the time of the 
...
dosage of Icandra. It is especially important to mention the following:</p>
<ul>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>The amount of Icandra that people have to take varies depending on their condition. Your doctor will 
tell you exactly the dose of Icandra to take. </p>
...
<p>Your doctor may prescribe this medicine alone or with certain other medicines that lower the level of 
sugar in your blood. </p>
<p>When and how to take Icandra 
...
following a diabetic weight control diet, continue with this while you are taking Icandra. </p>
<p>If you take more Icandra than you should 
...
<p>If you forget to take Icandra 
...
<p>You should stop taking Icandra and see your doctor immediately if you experience the following 
side effects: 
* Lactic acidosis (very rare: may affect up to 1 in 10 000 poeple): Icandra may cause a very rare, 
but very serious side effect called lactic acidosis (see section  Warnings and precautions ). If 
this happens you must stop taking Icandra and contact a doctor or the nearest hospital 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Icandra contains 
...
<p>What Icandra looks like and contents of the pack 
Icandra 50 mg/850 mg film-coated tablets are yellow, oval tablets with  NVR  on one side and  SEH<br />
on the other. 
Icandra 50 mg/1000 mg film-coated tablets are dark yellow, oval tablets with  NVR  on one side and 
 FLO  on the other. </p>
<p>Icandra is available in packs containing 10, 30, 60, 120, 180 or 360 film-coated tablets and in multi-
...
Laborat rio Normal   Produtos Farmac uticos Lda. 
...
2. Det skal du vide, før du begynder at tage Icandra 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>De aktive stoffer i Icandra, vildagliptin og metformin, tilhører en gruppe lægemidler, der kaldes "orale 
antidiabetika". </p>
<p>Icandra bruges til at behandle voksne patienter med type 2-diabetes (sukkersyge). Denne type diabetes 
kaldes også ikke-insulinkrævende diabetes mellitus. Icandra bruges når diabetes ikke er tilstrækkeligt 
kontrolleret ved hjælp af kost og motion alene og/eller med andre lægemidler til behandling af 
diabetes (insulin eller sulfonylurinstoffer). </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Tag ikke Icandra 
...
din læge, før du begynder at tage Icandra. 
...
Icandra kan forårsage en meget sjælden, men meget alvorlig bivirkning, som kaldes laktatacidose, især 
...
iltforsyning til en legemsdel (såsom akut alvorlig hjertesygdom).<br />
Kontakt lægen for at få yderligere vejledning, hvis noget af ovennævnte gælder for dig. </p>
<p>Stop med at tage Icandra i en kort periode, hvis du har en tilstand, som kan være forbundet med 
dehydrering (betydeligt tab af kropsvæsker), såsom alvorlig opkastning, diarré, feber, udsættelse for 
varme eller indtagelse af mindre væske end normalt. Kontakt lægen for at få yderligere rådgivning. </p>
<p>Stop med at tage Icandra og kontakt omgående læge eller nærmeste hospital, hvis du får et eller 
flere af nedenstående symptomer på laktatacidose, da denne tilstand kan føre til koma.<br />
...
<p>Icandra kan ikke erstatte insulin. Du bør derfor ikke få Icandra til behandling af type 1-diabetes. </p>
<p>Kontakt lægen, apotekspersonalet eller sundhedspersonalet før du tager Icandra, hvis du har eller har 
haft en sygdom i bugspytkirtlen. </p>
<p>Kontakt lægen, apoteket eller sundhedspersonalet, før du tager Icandra, hvis du tager medicin mod 
diabetes, kaldet sulfonylurinstof. For at undgå at du får lavt blodsukker [hypoglykæmi], vil din læge 
måske nedsætte din dosis af sulfonylurinstoffet, når du tager det sammen med Icandra. </p>
...
opmærksom på nye frembrud af blærer eller sår, mens du tager Icandra. Skulle dette ske, skal du straks 
kontakte din læge. </p>
<p>Hvis du skal have en større operation, skal du stoppe med at tage Icandra under indgrebet og i nogen 
tid herefter. Lægen vil beslutte, hvornår du skal stoppe behandlingen med Icandra, og hvornår du kan 
genoptage den igen. </p>
<p>Du vil få taget en blodprøve til undersøgelse af din leverfunktion, før du starter med Icandra-
...
<p>Under behandlingen med Icandra vil lægen kontrollere din nyrefunktion mindst en gang om året eller 
...
<p>Børn og unge 
Icandra anbefales ikke til børn og unge under 18 år. </p>
<p>Brug af anden medicin sammen med Icandra 
Hvis du skal have sprøjtet et kontrastmiddel, som indeholder jod, ind i dit blod, for eksempel i 
forbindelse med en røntgenundersøgelse eller scanning, skal du stoppe med at tage Icandra forud for 
eller på tidspunktet for injektionen. Lægen vil beslutte, hvornår du skal stoppe behandlingen med 
Icandra, og hvornår du kan genoptage den igen. </p>
...
eller din nyrefunktion hyppigere, eller lægen kan ændre din dosis af Icandra. Det er især vigtigt, at du 
nævner følgende:</p>
<ul>
...
<p>Brug af Icandra sammen med alkohol 
Undgå at indtage store mængder alkohol, mens du tager Icandra, da det kan øge risikoen for 
...
risici ved at tage Icandra under graviditet. 
- Tag ikke Icandra, hvis du er gravid eller ammer (se også "Tag ikke Icandra"). </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Det afhænger af din sygdom, hvor mange Icandra-tabletter du skal tage. Din læge vil fortælle dig helt 
nøjagtigt, hvor mange tabletter du skal tage. </p>
<p>Tag altid dette lægemidlet nøjagtigt efter lægens anvisning. Er du i tvivl, så spørg lægen eller 
apotekspersonalet. </p>
...
blodsukkeret. </p>
<p>Hvornår og hvordan du skal tage Icandra 
...
diabetesdiæt med vægtkontrol, skal du fortsat følge denne, mens du tager Icandra. </p>
<p>Hvis du har taget for meget Icandra 
Du skal straks kontakte en læge eller apoteket, hvis du har taget for mange Icandra-tabletter, eller 
...
<p>Hvis du har glemt at tage Icandra 
...
<p>Hvis du holder op med at tage Icandra 
...
<p>Du skal stoppe med at tage Icandra og kontakte din læge omgående, hvis du oplever en eller flere 
af følgende bivirkninger: </p>
<ul>
<li>
<p>Laktatacidose (meget sjælden: kan forekomme hos op til 1 ud af 10 000 personer): 
Icandra kan forårsage en meget sjælden, men meget alvorlig bivirkning, der kaldes laktatacidose 
(se afsnittet "Advarsler og forsigtighedsregler"). Hvis dette sker for dig, skal du omgående 
stoppe med at tage Icandra og kontakte læge eller nærmeste hospital, da laktatacidose kan 
føre til koma. </p>
</li>
<li>
...
<li>
<p>Leversygdom (hepatitis) (Ikke almindelige: kan forekomme hos op til 1 ud af 100 personer): 
symptomer inkluderer gul hud og øjne, kvalme, nedsat appetit eller mørk urin, hvilket kan tyde 
på en leversygdom (hepatitis). </p>
</li>
<li>
<p>Betændelse i bugspytkirtlen (pankreatitis) (Ikke almindelige: kan forekomme hos op til 1 ud af 
...
Nogle patienter har oplevet følgende bivirkninger, mens de har taget Icandra: </p>
<ul>
<li>
...
<li>Hver Icandra 50 mg/850 mg filmovertrukket tablet indeholder 50 mg vildagliptin og 850 mg 
metforminhydrochlorid (svarende til 660 mg metformin). </li>
<li>Hver Icandra 50 mg/1000 mg filmovertrukket tablet indeholder 50 mg vildagliptin og 1000 mg 
...
Icandra 50 mg/850 mg filmovertrukne tabletter er gule, ovale tabletter med "NVR" på den ene side og 
"SEH" på den anden. 
Icandra 50 mg/1000 mg filmovertrukne tabletter er mørkegule, ovale tabletter med "NVR" på den ene 
side og "FLO" på den anden. </p>
<p>Icandra fås i pakninger med 10, 30, 60, 120, 180 eller 360 filmovertrukne tabletter og i multipakninger 
med 120 (2x60), 180 (3x60) eller 360 (6x60) filmovertrukne tabletter. Ikke alle pakningsstørrelser og 
tabletstyrker er nødvendigvis markedsført. </p>
