...
* identifier.value = "14 tablets: EU/1/08/480/001"
* status = #final
...
<ol>
<li>What Ifirmasta is and what it is used for</li>
<li>What you need to know before you take Ifirmasta</li>
<li>How to take Ifirmasta</li>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Ifirmasta belongs to a group of medicines known as angiotensin-II receptor antagonists. Angiotensin-
II is a substance produced in the body which binds to receptors in blood vessels causing them to 
tighten. This results in an increase in blood pressure. Ifirmasta prevents the binding of angiotensin-II 
to these receptors, causing the blood vessels to relax and the blood pressure to lower. Ifirmasta slows 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <h2>Do not take Ifirmasta</h2>
...
You must tell your doctor if you think you are (or might become) pregnant. Ifirmasta is not 
...
This medicine should not be used in children and adolescents (&lt; 18 years) because the safety and 
...
advise you to stop taking Ifirmasta before you become pregnant or as soon as you know you are 
pregnant and will advise you to take another medicine instead of Ifirmasta. Ifirmasta is not 
...
Breast-feeding
Tell your doctor if you are breast-feeding or about to start breast-feeding. Ifirmasta is not 
...
Ifirmasta is for oral use. Swallow the tablets with a sufficient amount of fluid (e.g. one glass of water). 
You can take Ifirmasta with or without food. Try to take your daily dose at about the same time each 
day. It is important that you continue to take Ifirmasta until your doctor tells you otherwise.
-
...
Ifirmasta should not be given to children under 18 years of age. If a child swallows some tablets, 
...
of these symptoms or get short of breath, stop taking irbesartan and contact your doctor 
immediately.
...
(creatine kinase enzyme). In patients with high blood pressure and type 2 diabetes with renal 
disease, dizziness when getting up from a lying or sitting position, low blood pressure when 
getting up from a lying or sitting position, pain in joints or muscles and decreased levels of a 
protein in the red blood cells (haemoglobin) were also reported.
-
...
Some undesirable effects have been reported since marketing of irbesartan. Undesirable effects where 
...
reduced number of platelets, abnormal liver function, increased blood potassium levels, impaired renal 
function, inflammation of small blood vessels mainly affecting the skin (a condition known as 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <h2>What Ifirmasta contains</h2>
<p>The active substance is irbesartan. Each film-coated tablet contains 75 mg irbesartan (as 
hydrochloride).
-
The other ingredients are mannitol, hydroxypropylcellulose, low-substituted hydroxypropyl
cellulose (LH-21), low-substituted hydroxypropyl cellulose (LH-11), talc, macrogol 6000, 
castor oil, hydrogenated in the core of tablet and polyvinyl alcohol, titanium dioxide (E171), 
macrogol 3000 and talc in film-coating.
What Ifirmasta looks like and contents of the pack
Ifirmasta 75 mg film-coated tablets are: white, oval film-coated tablets.
Ifirmasta 75 mg film-coated tablets are available in boxes of 14, 28, 30, 56, 84, 90 and 98 film-coated 
tablets in blisters and in boxes of 56 x 1 film-coated tablets in perforated unit dose blisters.
...
* section[=].section[+]
  * title = "2. Det skal du vide, før du begynder at tage  ifirmasta"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "2. Det skal du vide, før du begynder at tage  ifirmasta"
  * text.status = #additional
...
* section[=].section[+]
  * title =  "3. Sådan skal du tage ifirmasta"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "3. Sådan skal du tage ifirmasta"
  * text.status = #additional
