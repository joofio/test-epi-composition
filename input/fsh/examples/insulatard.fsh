...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Insulatard is human insulin with a gradual onset and long duration of action. </p>
<p>Insulatard is used to reduce the high blood sugar level in patients with diabetes mellitus (diabetes). 
Diabetes is a disease where your body does not produce enough insulin to control the level of your 
blood sugar. Treatment with Insulatard helps to prevent complications from your diabetes.  </p>
<p>Insulatard will start to lower your blood sugar about 1  hours after you inject it, and the effect will 
...
<p>Insulatard Penfill is only suitable for injecting under the skin using a reusable pen. Speak to 
...
<p>There are no restrictions on treatment with Insulatard during breast-feeding. </p>
...
<p>Insulatard is administered by injection under the skin (subcutaneously). You must never inject yourself 
...
<p>Insulatard Penfill cartridges are designed to be used with Novo Nordisk insulin delivery systems 
and NovoFine or NovoTwist needles. </p>
<p>If you are treated with Insulatard Penfill and another insulin Penfill cartridge, you should use 
...
instructions. </p>
<p>Every time you use a new Insulatard Penfill (before you put the cartridge into the insulin 
delivery system). 
...
* The movement must always be repeated until the liquid appears uniformly white and cloudy.<br />
...
<p>After each injection, be sure to remove and discard the needle and store Insulatard without the 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Insulatard er et humant insulin med gradvist indsættende effekt og lang virkningsvarighed. </p>
<p>Insulatard anvendes til at sænke det høje blodsukkerniveau hos patienter med sukkersyge (diabetes 
...
<p>Insulatard begynder at nedsætte blodsukkeret ca. 1½ time efter, at du har injiceret det, og virkningen 
varer i ca. 24 timer. Insulatard gives ofte i kombination med hurtigtvirkende insulinpræparater. </p> </div>"""   
...
<p>Hvis nogle af disse tilfælde gør sig gældende, må du ikke bruge Insulatard. Spørg lægen, 
...
den ikke hvis den er beskadiget, eller hvis gummistemplet er trukket ud over det hvide bånd i 
bunden af cylinderampullen. Dette kan være forårsaget af insulinlækage. Hvis du mistænker, at 
cylinderampullen er beskadiget, skal den returneres til apoteket. Se brugervejledningen til din 
pen for yderligere information. 
► 
Brug altid en ny nål til hver injektion for at beskytte mod forurening. 
► 
Nåle og Insulatard Penfill må ikke deles med andre. 
► 
Insulatard Penfill er kun egnet til indsprøjtning under huden ved hjælp af en genanvendelig pen. 
...
barns helbred. 
► 
Der er ingen begrænsninger ved behandling med Insulatard, mens du ammer. </p>
...
<p>Insulatard indeholder mindre end 1 mmol natrium (23 mg) per dosis, dvs. Insulatard er stort set 
natriumfrit. </p> </div>"""   
...
<p>Insulatard administreres ved injektion under huden (subkutant). Du må aldrig selv injicere direkte i en 
vene (intravenøst) eller muskel (intramuskulært). Insulatard Penfill er kun egnet til indsprøjtning under 
huden ved hjælp af en genanvendelig pen. Tal med lægen, hvis du har behov for at indsprøjte din 
insulin på en anden måde. </p>
...
skal du anvende to injektionssystemer, ét system til hver insulintype. 
► 
...
<p>► 
Hver gang du bruger en ny Insulatard Penfill (inden du anbringer cylinderampullen i 
...
► 
Husk at fjerne og kassere nålen efter hver injektion og opbevare Insulatard uden nålen påsat. 
...
<li>
<p>Drikker alkohol, se Brug af Insulatard sammen med alkohol under punkt 2. Tegn på lavt blodsukker: Koldsved, kold bleg hud, hovedpine, hjertebanken, kvalme, usædvanlig stor 
...
<p>Alvorlig allergisk reaktion på Insulatard eller et af de øvrige indholdsstoffer (også kaldet systemisk 
...
lider af diabetisk retinopati, kan dette forværres, hvis dit blodsukkerniveau forbedres meget hurtigt. 
...
<ul>
<li>Aktivt stof: Humant insulin. Insulatard er en isophan (NPH) humant insulin suspension. 
Hver ml indeholder 100 IE humant insulin. Hver cylinderampul indeholder 300 IE humant 
insulin i 3 ml injektionsvæske, suspension. </li>
...
<p>Insulatard er en injektionsvæske, suspension. Efter opblanding skal væsken fremstå ensartet hvid og 
uklar. 
...
<p>Fremstiller </p>
<h2>Fremstilleren kan identificeres ved batchnummeret, som er trykt på kartonens slip og på etiketten:</h2>
...
<ul>
<li>Hvis andet og tredje skrifttegn er H7 eller T6, så er fremstilleren Novo Nordisk Production 
SAS, 45 Avenue d’Orléans, F-28000 Chartres, Frankrig. </li>
</ul>
...
<p>Insulatard InnoLet 100 IE/ml (internationale enheder/ml) injektionsvæske, suspension i en fyldt 
pen 
humant insulin </p>
