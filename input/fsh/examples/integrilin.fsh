...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Integrilin is an inhibitor of platelet aggregation. This means that it helps to prevent blood clots from 
forming.  </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Integrilin is given into the vein by direct injection followed by an infusion (drip solution). The dose 
...
72 hours. If you have kidney disease, the infusion dose may be reduced to 1 microgram/kg/minute. </p>
<p>If percutaneous coronary intervention (PCI) is performed during Integrilin therapy, the intravenous 
...
stopper and sealed with a crimped aluminium seal. </p>
<p>Marketing Authorisation Holder and manufacturer </p>
<p>Marketing Authorisation Holder: </p>
<p>GlaxoSmithKline (Ireland) Limited, 12 Riverwalk, Citywest Business Campus, Dublin 24, Ireland </p>
<p>Manufacturer: </p>
<p>GlaxoSmithKline Manufacturing S.P.A., Strada Provinciale Asolana No. 90, San Polo di Torrile 
43056, Parma, Italy </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Integrilin hæmmer sammenklumpning af blodplader. Det betyder, at det hjælper med at forebygge 
blodpropper. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Du må ikke få Integrilin 
...
- hvis du er blevet behandlet med anden medicin af samme type som Integrilin. </p>
<p>Fortæl det til lægen, hvis du lider af en af disse tilstande. Kontakt lægen eller sygeplejersken, hvis du har 
spørgsmål. </p>
...
- Under brugen af Integrilin vil du blive omhyggeligt undersøgt for tegn på usædvanlig eller </p>
<p>uventet blødning. </p>
<p>Brug af anden medicin sammen med Integrilin 
For at undgå interaktioner med anden medicin, skal du altid fortælle det til lægen eller sygeplejersken, 
hvis du bruger anden medicin, for nylig har brugt anden medicin eller planlægger at bruge anden 
medicin. Dette gælder også medicin, som ikke er købt på recept. Især:</p>
<ul>
...
(undtagen den medicin, du kan få som en del af behandlingen med Integrilin). </li>
</ul>
...
få Integrilin, mens du er gravid, op mod risikoen for dit ufødte barn. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Integrilin gives i en blodåre ved direkte injektion efterfulgt af infusion (drop). Den givne dosis er baseret 
...
<p>Hvis du bemærker nogen tegn på blødning, så kontakt straks lægen eller sygeplejersken. Blødning har i 
sjældne tilfælde vist sig at være meget alvorlig eller endog livstruende. De forholdsregler, der tages for at 
undgå blødning, inkluderer blodprøver og omhyggelige lægeundersøgelser.  </p>
...
<p>Brug ikke lægemidlet efter den udløbsdato, der står på æsken og på hætteglasset efter EXP. 
...
Integrilin mod lys under behandlingen. </p>
...
<ul>
<li>Aktivt stof: eptifibatid. Hver ml opløsning indeholder 0,75 mg eptifibatid. Et hætteglas med ml infusionsvæske indeholder 75 mg eptifibatid. </li>
<li>Øvrige indholdsstoffer: citronsyremonohydrat, natriumhydroxid og vand til injektionsvæske. </li>
</ul>
<p>Udseende og pakningstørrelser 
Integrilin infusionsvæske, opløsning: 100 ml hætteglas, pakning med 1 hætteglas.  </p>
<p>Klar, farveløs opløsning i 100 ml hætteglas, lukket med butylgummiprop og forseglet med krympesegl 
i aluminium. </p>
<p>Indehaver af markedsføringstilladelsen og fremstiller </p>
<p>Indehaver af markedsføringstilladelsen: </p>
<p>GlaxoSmithKline (Ireland) Limited, 12 Riverwalk, Citywest Business Campus, Dublin 24, Irland </p>
<p>Fremstiller: </p>
<p>GlaxoSmithKline Manufacturing S.P.A., Strada Provinciale Asolana No. 90, San Polo di Torrile 
43056, Parma, Italien </p>
...
<p>Integrilin 2 mg/ml injektionsvæske, opløsning 
eptifibatid </p>
