...
<p>Intrarosa is used to treat postmenopausal women having moderate to severe symptoms of vulvar and 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>The use of Hormone Replacement Therapy (HRT) carries risks which need to be considered when 
deciding whether to start taking it, or whether to carry on taking it.  </p>
...
<p>When to take special care with Intrarosa 
...
<li>a disease of the immune system that affects many organs of the body (systemic lupus 
erythematosus, SLE); </li>
<li>epilepsy; </li>
<li>asthma; </li>
...
<p>HRT and cancer 
Intrarosa has not been studied in women with current or history of cancers.<br />
...
the lining of the womb in all women treated with Intrarosa for one year during the clinical study. </p>
...
should see your doctor if you are concerned. </p>
<p>Breast cancer 
...
<p>Regularly check your breasts. See your doctor if you notice any changes such as: 
<em><br />
...
<p>Additionally, you are advised to join mammography screening programs when offered to you. </p>
<p>Ovarian cancer 
...
prasterone for 52 weeks. </p>
<p>Effect of HRT on heart and circulation 
...
fainting or even death.  </p>
<p>You are more likely to get a blood clot in your veins as you get older and if any of the following 
...
placebo group. </p>
<p>Compare 
Looking at women in their 50s who are not taking HRT, on average, over a 5-year period, 4 to 7 in 1would be expected to get a blood clot in a vein.  </p>
<p>Heart disease (heart attack) / Hypertension 
For women taking oestrogen-only therapy there is no increased risk of developing a heart disease. </p>
<p>Stroke 
The risk of getting stroke is about 1.5 times higher in HRT users than in non-users. The number of 
extra cases of stroke due to use of HRT will increase with age.<br />
No case of stroke has been observed with Intrarosa during clinical studies. </p>
<p>Compare 
...
in 1000 users, over 5 years (i.e. an extra 3 cases). </p>
<p>Other conditions 
...
* If you have a vaginal infection you will need a course of antibiotics before taking Intrarosa. </p>
<p>Children and adolescents 
Intrarosa is only used in adult women.  </p>
<p>Other medicines and Intrarosa<br />
Tell your doctor or pharmacist if you are taking, have recently taken or might take any other 
medicines. </p>
<p>No data on efficacy and safety are available in women currently treated with hormonal therapy such 
as: androgens, HRT (oestrogen alone or combined with progestogens).  </p>
<p>The use of Intraorsa in combination with HRT (oestrogen-only or oestrogen-progestagen combination 
or androgen treatment) or vaginal oestrogens is not recommended. </p>
<p>Pregnancy, breast feeding and fertility 
Pregnancy and breast feeding </p>
<p>Intrarosa is for use in postmenopausal women only. If you become pregnant, stop using Intrarosa and 
...
or pharmacist if you are not sure.<br />
Your doctor will aim to prescribe the lowest dose to treat your symptom for as short as necessary. 
Speak to your doctor if you think this dose is too strong or not strong enough. </p>
<p>How much to use </p>
<p>Use one pessary once a day, at bedtime. </p>
<p>How to use </p>
<p>Insert the pessary into the vagina with your finger or with an applicator provided in the pack. </p>
<p>Read the instructions on how to use Intrarosa at the end of the leaflet carefully before using this 
medicine. </p>
<p>How long to use </p>
<p>After initial use, see your doctor at least every 6 months to check if you need to keep using Intrarosa. </p>
<p>If you use more Intrarosa than you should 
Vaginal douching is recommended. </p>
<p>If you forget to use Intrarosa 
If you forget to use a pessary, insert one as soon as you remember. However, if the next dose is due in 
less than 8 hours, skip the missed pessary. </p>
...
<p>The following diseases are reported more often in women using HRT medicines which circulate in the 
...
<p>Anvendelse </p>
<p>Intrarosa anvendes til behandling af kvinder i overgangsalderen med moderate til svære symptomer på 
...
østrogen i kroppen. Dette sker naturligt efter overgangsalderen. </p>
<p>Virkning </p>
...
<p>Der er kun begrænset erfaring med behandling af kvinder, der er gået i overgangsalderen før tid (som 
følge af problemer med æggestokkene eller operation). Hvis du er gået i overgangsalderen før tid, kan 
brug af hormonerstatningsbehandling være forbundet med andre risici. Tal med lægen om det.  </p>
<p>Før du påbegynder (eller genoptager) hormonerstatningsbehandling, vil lægen spørge til din egen og 
din families sygehistorie. Lægen kan beslutte at undersøge dig fysisk. Dette kan omfatte en 
undersøgelse af brysterne og/eller om nødvendigt en indvendig gynækologisk undersøgelse.  </p>
<p>Når du først er startet på behandling med Intrarosa, bør du regelmæssigt blive undersøgt af lægen 
(mindst én gang hver 6. måned). I forbindelse med denne opfølgning kan du drøfte fordele og risici 
ved at fortsætte på Intrarosa med lægen. </p>
<p>Få brysterne undersøgt regelmæssigt som anbefalet af lægen. </p>
<p>Brug ikke Intrarosa 
Du bør ikke bruge Intrarosa, hvis noget af nedenstående gælder for dig. Hvis du er usikker på noget af 
det, skal du tale med lægen, inden du tager Intrarosa: </p>
<ul>
<li>
<p>Hvis du har eller tidligere har haft brystkræft, eller hvis der er mistanke om, at du har det. </p>
</li>
<li>
<p>Hvis du har en østrogenfølsom kræftsygdom som f.eks. livmoderkræft (corpuscancer), eller 
hvis der er mistanke om, at du har det. </p>
</li>
<li>
<p>Hvis du har blødning fra skeden af ukendt årsag. </p>
</li>
<li>
<p>Hvis du har fortykkelse af livmoderslimhinden (endometriehyperplasi), der ikke bliver 
behandlet. </p>
</li>
<li>
<p>Hvis du har eller tidligere har haft en blodprop i en vene (trombose), f.eks. i benene (dyb 
venetrombose) eller i lungerne (lungeemboli). </p>
</li>
<li>
<p>Hvis du har en forstyrrelse i blodets koagulation (som f.eks. mangel på protein C, protein S eller 
antitrombin). </p>
</li>
<li>
<p>Hvis du har eller for nylig har haft en sygdom forårsaget af blodpropper i arterierne, f.eks. 
hjerteanfald, slagtilfælde eller hjertekrampe (angina). </p>
</li>
<li>
<p>Hvis du har eller tidligere har haft en leversygdom, og dine leverfunktionsværdier ikke er 
blevet normale igen. </p>
</li>
<li>
<p>Hvis du har den sjældne blodsygdom "porfyri", der er en arvelig sygdom. </p>
</li>
<li>
<p>Hvis du er allergisk over for prasteron eller et af de andre indholdsstoffer i dette lægemiddel 
(angivet i punkt 6 "Pakningstørrelser og yderligere oplysninger"). </p>
</li>
</ul>
<p>Hvis nogen af ovennævnte sygdomme viser sig for første gang, mens du tager Intrarosa, skal du straks 
holde op med at tage det og kontakte lægen. </p>
<p>Advarsler og forsigtighedsregler </p>
<p>Vær ekstra forsigtig med at tage Intrarosa 
...
tilfældet, bør du lade lægen undersøge dig oftere: </p>
<ul>
<li>
<p>knuder i livmoderen (uterusfibromer)  </p>
</li>
<li>
<p>vækst af livmoderslimhinden uden for livmoderen (endometriose) eller fortykkelse af 
livmoderslimhinden (endometriehyperplasi) </p>
</li>
<li>
<p>øget risiko for en blodprop (se "Blodpropper i en vene (trombose)")  </p>
</li>
<li>
<p>øget risiko for en østrogenfølsom kræfttype (f.eks. hvis din mor, søster eller bedstemor har haft 
brystkræft) </p>
</li>
<li>
...
<li>
<p>leversygdomme som f.eks. en godartet leversvulst </p>
</li>
<li>
<p>diabetes </p>
</li>
...
<li>
<p>migræne eller (svær) hovedpine </p>
</li>
<li>
<p>systemisk lupus erythematosus (en immunsygdom, der berører mange organer, SLE) </p>
</li>
<li>
<p>epilepsi </p>
</li>
...
<li>
<p>otosklerose (en sygdom, der rammer trommehinden og giver nedsat hørelse) </p>
</li>
<li>
<p>meget højt indhold af fedtstoffer (triglycerider) i blodet </p>
</li>
<li>
<p>væskeophobning som følge af hjerte- og/eller nyreproblemer. </p>
</li>
</ul>
<p>Du skal holde op med at bruge Intrarosa og straks kontakte lægen,<br />
hvis du bemærker noget af følgende betingelser, når du bruger HRT: </p>
<ul>
<li>
<p>Hvis du har nogen af de sygdomme, der er nævnt under "Brug ikke Intrarosa". </p>
</li>
<li>
<p>Gulfarvning af huden eller det hvide i øjnene (gulsot). Dette kan være tegn på en leversygdom. </p>
</li>
<li>
<p>Hvis du bliver gravid. </p>
</li>
<li>
<p>Kraftig blodtryksstigning (symptomerne kan være hovedpine, træthed og svimmelhed). </p>
</li>
<li>
<p>Migrænelignende hovedpine, der optræder for første gang. </p>
</li>
<li>
<p>Hvis du bemærker tegn på en blodprop som f.eks.:</p>
</li>
<li>
<p>ømme, hævede og røde ben </p>
</li>
<li>pludselige smerter i brystet </li>
<li>vejrtrækningsbesvær. 
Yderligere oplysninger findes under "Blodpropper i en vene (trombose)". </li>
</ul>
<p>Bemærk: Intrarosa er ikke et præventionsmiddel. Hvis det er mindre end 12 måneder siden, at du sidst 
havde menstruation, eller hvis du er under 50 år, kan du stadig have behov for yderligere prævention 
for at beskytte dig mod graviditet. Søg råd hos lægen. </p>
<p>Hormonerstatningsbehandling og kræft 
Intrarosa er ikke undersøgt hos kvinder med aktuel eller tidligere kræft.<br />
...
et år i de kliniske undersøgelser. </p>
<p>Det er uvist, hvorvidt der er en risiko ved brug af Intrarosa i lang tid (mere end et år). Det er dog 
påvist, at Intrarosa kun optages i blodet i meget lav grad, og det er derfor ikke nødvendigt at tilføje et 
progestagen. </p>
<p>Hvis du får blødning eller pletblødning, er det normalt ikke noget at bekymre sig om, men du bør dog 
bestille en tid hos lægen. Det kan være et tegn på, at din livmoderslimhinde er fortykket. </p>
<p>Nedenstående risici er knyttet til hormonerstatningsbehandling, når de pågældende stoffer findes i 
...
under behandlingen med Intrarosa, men du bør kontakte lægen, hvis du er bekymret. </p>
<p>Brystkræft 
...
dog tilbage til det normale niveau i løbet af få år (højst 5), efter at man er holdt op med behandlingen.  </p>
<p>Kontrollér dine bryster regelmæssigt. Gå til lægen, hvis du bemærker forandringer såsom: </p>
<ul>
<li>
<p>fordybninger i huden </p>
</li>
<li>
<p>forandringer i brystvorterne </p>
</li>
<li>
<p>enhver knude, der kan ses eller mærkes. </p>
</li>
</ul>
<p>Derudover bør du deltage i mammografiscreeningsprogrammer, når du bliver tilbudt dette. </p>
<p>Kræft i æggestokkene 
...
i æggestokkene.  </p>
<p>Risikoen for kræft i æggestokkene afhænger af kvindens alder. For kvinder i alderen 50-54 år, der ikke 
...
Intrarosa er ikke undersøgt hos kvinder med tidligere tromboembolisk sygdom, ikke-kontrolleret 
forhøjet blodtryk eller hjertesygdom.  </p>
<p>Blodpropper i en vene (trombose) 
Der er 1,3-3 gange højere risiko for blodpropper i venerne hos brugere af 
hormonerstatningsbehandling end hos ikke-brugere, især i det første år af behandlingen.  </p>
<p>Blodpropper kan være alvorlige, og hvis en af dem vandrer til lungerne, kan det medføre smerter i 
brystet, stakåndethed, besvimelse eller endda død.  </p>
<p>Efterhånden som du bliver ældre, stiger risikoen for en blodprop i venerne; risikoen er desuden øget, 
hvis noget af nedenstående gælder for dig. Sig det til lægen, hvis noget af følgende gælder for dig: </p>
<ul>
<li>
<p>Du kan ikke gå i længere tid på grund af en stor operation, skade eller sygdom (se også punkt 3 
"Hvis du skal opereres"). </p>
</li>
<li>
<p>Du er svært overvægtig (BMI &gt;30 kg/m2). </p>
</li>
<li>
<p>Du er tilbøjelig til at danne blodpropper og er derfor i langvarig behandling med medicin til 
forebyggelse af blodpropper. </p>
</li>
<li>
<p>Nære slægtninge til dig har på et tidspunkt haft en blodprop i benet, lungerne eller et andet 
organ. </p>
</li>
<li>
<p>Du har systemisk lupus erythematosus (SLE). </p>
</li>
<li>
<p>Du har kræft. </p>
</li>
</ul>
<p>Vedrørende tegn på blodprop bør du læse afsnittet "Du skal holde op med at bruge Intrarosa og straks 
kontakte lægen". 
...
i en vene i løbet af en periode på 5 år.  </p>
<p>Hjertesygdomme (hjerteanfald)/forhøjet blodtryk 
Kvinder, der bliver behandlet med østrogen alene, har ingen øget risiko for at udvikle hjertesygdom. </p>
<p>Slagtilfælde 
...
Der er ikke observeret slagtilfælde med Intrarosa under de kliniske undersøgelser. </p>
<p>Sammenligning 
...
løbet af en periode på 5 år. </p>
<p>Andre tilstande </p>
<ul>
<li>
<p>Hormonerstatningsbehandling forebygger ikke hukommelsestab. Der er i et vist omfang 
dokumentation for højere risiko for hukommelsestab hos kvinder, der begynder at bruge 
hormonerstatningsbehandling, efter at de er fyldt 65 år. Søg råd hos lægen. </p>
</li>
<li>
<p>Du kan opleve udflåd fra skeden som følge af, at det hårde fedtstof smelter, i tillæg til den øgede 
skedesekretion som følge af behandlingen. Det er ikke nødvendigt at holde op med at bruge 
Intrarosa, hvis der ses udflåd.  </p>
</li>
<li>
<p>Intrarosa kan svække virkningen af kondomer og pessarer (vaginalpessarer/cervixpessarer), der 
er lavet af latex. </p>
</li>
<li>
<p>Hvis du har infektion i skeden, skal du tage en antibiotikakur, inden du begynder at tage 
Intrarosa. </p>
</li>
</ul>
<p>Børn og unge </p>
...
nylig. </p>
<p>Der er ingen tilgængelige data om virkning og sikkerhed hos kvinder, der aktuelt er i 
hormonbehandling med f.eks. androgener eller HRT (østrogen alene eller kombineret med 
progestogener).  </p>
<p>Brug af Intrarosa i kombination med HRT (østrogenbehandling alene, kombineret 
østrogen/progestagenbehandling eller androgenbehandling) eller vaginale østrogenpræparater frarådes. </p>
<p>Graviditet, amning og frugtbarhed </p>
<p>Graviditet og amning  </p>
<p>Intrarosa er kun til brug hos kvinder efter overgangsalderen. Hvis du bliver gravid, skal du holde op 
med at bruge Intrarosa og kontakte din læge. </p>
<p>Fertilitet </p>
...
tid som muligt. Tal med lægen, hvis du mener, at dosen er for høj eller ikke høj nok. </p>
<p>Hvor meget skal du tage </p>
<p>Du skal tage ét vagitorie hver dag ved sengetid. </p>
<p>Sådan skal du bruge Intrarosa </p>
<p>Før vagitoriet ind i skeden med pegefingeren eller ved hjælp af den medfølgende applikator. </p>
<p>Læs vejledningen i brug af Intrarosa til sidst i denne indlægsseddel, før du tager lægemidlet i brug. </p>
<p>Hvor længe skal du tage Intrarosa </p>
<p>Efter start på behandlingen bør lægen undersøge dig mindst én gang hver 6. måned for at se, om du 
stadig har brug for Intrarosa. </p>
<p>Hvis du har brugt for meget Intrarosa </p>
<p>Skedeskylning anbefales. </p>
<p>Hvis du har glemt at bruge Intrarosa </p>
<p>Hvis du har glemt at tage et vagitorie, skal du tage det så snart, du kommer i tanke om det. Hvis den 
næste dosis er planlagt til mindre end 8 timer senere, bør du dog springe det glemte vagitorie over. </p>
...
er ikke lige så stor ved vaginale østrogenbehandlinger: </p>
<ul>
<li>
<p>brystkræft </p>
</li>
...
<li>
<p>blodpropper i venerne i benene og i lungerne (venøs tromboemboli)  </p>
</li>
<li>
<p>slagtilfælde </p>
</li>
<li>
<p>mulig hukommelsessvækkelse, hvis hormonerstatningsbehandlingen påbegyndes efter det 65. år. 
Du kan læse mere om disse bivirkninger i punkt 2. Den bivirkning, der blev hyppigst rapporteret i de kliniske undersøgelser, var udflåd fra skeden. Det 
skyldes sandsynligvis smeltning af det hårde fedtstof samt øget vaginal sekretion på grund af 
behandlingen. Det er ikke nødvendigt at holde op med at bruge Intrarosa, hvis der ses udflåd. </p>
</li>
</ul>
<p>Desuden er følgende bivirkninger indberettet:</p>
<ul>
<li>Almindelige bivirkninger (kan forekomme hos op til 1 ud af 10 behandlede): unormal smear-test 
(som oftest ASCUS eller LGSIL), vægtstigning eller vægttab </li>
<li>Ikke almindelige bivirkninger (kan forekomme hos op til 1 ud af 100 behandlede): godartede 
livmoder- og livmoderhalspolypper, godartet brysttumor.  </li>
</ul>
<p>Følgende bivirkninger er rapporteret med hormonerstatningsbehandling, der indeholder østrogener, 
men ikke med Intrarosa i de kliniske undersøgelser: </p>
<ul>
<li>
<p>galdeblæresygdom </p>
</li>
<li>
<p>forskellige hudlidelser:</p>
</li>
<li>
<p>misfarvning af huden, navnlig på ansigt og hals (graviditetsmaske, kloasma) </p>
</li>
<li>smertefuld knudeformet rødme af huden (erythema nodosum) </li>
<li>udslæt med skydeskiveformet rødme eller sår (erythema multiforme). </li>
</ul>
...
<ul>
<li>Aktivt stof: prasteron. Hvert vagitorie indeholder 6,5 mg prasteron. </li>
<li>Det eneste andet indholdsstof er hårdt fedtstof (Hårdfedt (adeps solidus)).  </li>
</ul>
<p>Udseende og pakningsstørrelser </p>
<p>Intrarosa er et hvidt til offwhite projektilformet vagitorie med en længde på ca. 28 mm og en diameter 
på ca. 9 mm i den brede ende. </p>
<p>Applikatoren er fremstillet af LDPE og 1 % farvestof (titaniumdioxid). </p>
<p>Intrarosa fås i blisterpakninger med 28 vagitorier og 6 applikatorer. </p>
<p>Indehaver af markedsføringstilladelsen  </p>
<p>Endoceutics S.A. 
Rue Belliard 1040 Bruxelles 
Belgien </p>
<p>Fremstiller </p>
<p>Basic Pharma Manufacturing B.V. 
Burgemeester Lemmensstraat 6163 JT Geleen 
...
<p>Vejledning i brug af Intrarosa 
Sådan skal du bruge Intrarosa </p>
<ul>
<li>
<p>Indfør ét prasteronholdigt vagitorie i skeden én gang dagligt ved sengetid ved hjælp af den medfølgende 
applikator eller med en finger. 
Før du går i gang  </p>
</li>
<li>
<p>Tøm din blære, og vask dine hænder, før du tager fat i vagitoriet og applikatoren.  </p>
</li>
<li>
<p>Tryk ét indpakket vagitorie ud af blisterpakningen med 7 vagitorier. 
A. Brug af applikatoren </p>
</li>
</ul>
<p>Trin 1 
...
indsætning af vagitoriet, som 
er mest komfortabel for dig. 
5a. Liggende stilling </p>
<p>Trin 2 
• Træk forsigtigt 
plastikflapperne omkring 
vagitoriet fra hinanden, 
mens du holder vagitoriet 
mellem dine fingre. 
• Fjern forsigtigt vagitoriet fra 
plasticindpakningen.<br />
• Hvis et vagitorie tabes på en 
ikke rengjort overflade, skal 
du erstatte det med et nyt. </p>
<p>5b. Stående stilling </p>
<p>Trin 3 
• Den flade ende af 
vagitoriet skal placeres i 
den åbne ende af den 
aktiverede applikator som 
vist på figuren. Du er nu 
klar til at indføre vagitoriet 
i skeden. </p>
<p>Trin 6 
• Før forsigtigt den ende af 
applikatoren, hvor vagitoriet 
sidder, så langt ind i skeden, 
som du føler er komfortabelt. </p>
<p>Du må ikke trykke for hårdt. </p>
<p>Trin 4 
• Hold applikatoren mellem 
tommel- og langfingeren.<br />
• Din pegefinger skal være 
fri til at trykke 
applikatorens stempel ned, 
når du har ført applikatoren 
ind i skeden. </p>
<p>Trin 7 
• Tryk stemplet i bund med 
pegefingeren for at frigøre 
vagitoriet. 
• Træk applikatoren ud. Vask 
den, eller smid den ud efter 
brug i en uge (to ekstra 
applikatorer medfølger). 
• For at vaske applikatoren: 
− Skil den i to dele; 
− Skyl de 2 dele i sekunder under rindende 
vand; 
− Tør delene med 
køkkenrulle og saml dem 
igen. 
Opbevar den på et rent sted. 
B. Brug af pegefingeren 
Følg vejledningen i trin 2, og før vagitoriet så langt ind i skeden med din pegefinger, som du føler er komfortabelt. 
Du må ikke trykke for hårdt. </p>
<p>BILAG IV 
VIDENSKABELIGE KONKLUSIONER OG BEGRUNDELSER FOR ÆNDRING AF 
BETINGELSERNE 
FOR MARKEDSFØRINGSTILLADELSEN/-TILLADELSERNE 
Videnskabelige konklusioner 
Under hensyntagen til PRAC's vurderingsrapport for den ikke-interventionspålagte PASS endelige 
undersøgelsesrapport for det eller de ovenfor nævnte lægemidler, er CHMP nået frem til følgende 
videnskabelige konklusioner: 
Intrarosa (prasteron) fjernes fra den supplerende overvågningsliste, da betingelsen til 
markedsføringstilladelsen er opfyldt. Dette vedrører den ikke-interventionelle PASS - Drug Utilization 
Study (DUS) for at beskrive baseline-karakteristika, brugsmønstre for EU-postmenopausale kvinder, 
der påbegynder behandling med Intrarosa, og for at vurdere, om EU-ordinerende læger overholder 
kontraindikationerne angivet i EU's produktresumé. 
Derfor fjernes erklæringen om, at dette lægemiddel er underlagt yderligere overvågning, og at dette vil 
muliggøre hurtig identifikation af ny sikkerhedsinformation, efterfulgt af en omvendt ligesidet sort 
trekant, fra produktresuméet og indlægssedlen. 
Derudover benyttede MAH lejligheden til at indføre en ændring af listen over lokale repræsentanter. 
CHMP tilslutter sig PRAC's videnskabelige konklusioner. 
Begrundelser for ændring af betingelserne for markedsføringstilladelsen/-tilladelserne 
På baggrund af de videnskabelige konklusioner for resultaterne af undersøgelsen for det eller de 
ovennævnte lægemidler, er CHMP af den opfattelse, at benefit/risk-forholdet for disse lægemidler er 
