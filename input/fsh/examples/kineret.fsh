...
the same way as your natural interleukin-1 blocking protein. Anakinra is produced by DNA 
technology using the micro-organism E. coli. </p>
<p>For RA, Kineret is used to treat the signs and symptoms of the disease in adults (age 18 years and 
over) in combination with another medicine called methotrexate. Kineret is for patients whose 
response to methotrexate on its own is not good enough to control the rheumatoid arthritis. </p>
<p>For COVID-19, Kineret is used to treat the hyperinflammation (stronger than the usual inflammation) 
associated with the disease in adults (age 18 years and over) who have pneumonia, need extra oxygen 
to help them breathe (low- or high-flow oxygen) and are at risk of lung failure. </p>
<p>For CAPS, Kineret is used to treat the signs and symptoms of inflammation associated with the 
disease such as rash, joint pain, fever, headache and fatigue in adults and children (age 8 months and 
older). </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not use Kineret 
- if you are allergic to anakinra or any of the other ingredients of this medicine, listed in section 6; 
- if you are allergic to other products that are produced by DNA technology using the micro-
organism E. coli; 
- if you have neutropenia (low white blood cell count) determined after a blood test. </p>
<p>Contact your doctor immediately 
- if you get a rash all over your body, shortness of breath, wheezing, fast pulse or sweating after 
...
- The serious skin reaction, DRESS (drug reaction with eosinophilia and systemic symptoms), 
has rarely been reported in association with Kineret treatment, predominantly in patients with 
systemic juvenile idiopathic arthritis (SJIA). Seek medical attention immediately if you notice 
an atypical, widespread rash, which may occur in conjunction with high body temperature and 
enlarged lymph nodes. </p>
<p>Children and adolescents 
- RA: Use of Kineret in children and adolescents with Rheumatoid Arthritis has not been fully 
...
<p>Kineret has not been tested in pregnant women. Use of Kineret is not recommended during pregnancy 
and in women of childbearing potential not using contraception. It is important to tell your doctor if 
you are pregnant, if you think you may be pregnant or are planning to have a baby. Your doctor will 
discuss with you the potential risks of taking Kineret during pregnancy. </p>
<p>It is not known whether anakinra is excreted in human milk. You must not breast-feed if you use 
Kineret. </p>
...
you are not sure. Kineret must be injected under your skin (subcutaneous) daily. You should try to 
have the injection at the same time each day. </p>
<p>The recommended dose is either 20 to 90 mg or 100 mg. Your doctor will tell you the dose that you 
need or whether you need a dose higher than 100 mg. </p>
<p>COVID-19: The recommended dose is 100 mg injected under your skin (subcutaneous) daily for 
10 days. </p>
<p>Injecting Kineret yourself 
...
during Kineret treatment. Symptoms might be persistent high fever, shivers, cough, headache, 
and redness and tenderness of the skin. Also persistent low-grade fever, weight loss, and 
persistent cough can be signs of an infection. </p>
</li>
<li>
<p>Serious allergic reactions are uncommon. However, any of the following symptoms may 
indicate an allergic reaction to Kineret, so you should seek immediate medical attention. Do not 
inject more Kineret. </p>
</li>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Kineret indeholder det aktive stof anakinra. Dette er en slags cytokin (et immunundertrykkende 
lægemiddel), der anvendes til behandling af:</p>
<ul>
<li>Reumatoid artrit (RA) </li>
<li>COVID-19 hos patienter, som har lungebetændelse, har behov for ekstra ilt og har risiko for 
lungesvigt </li>
<li>
<p>Periodiske febersyndromer:</p>
</li>
<li>
<p>Kryopyrin-associerede periodiske syndromer (CAPS) - en gruppe af sygdomme, hvor 
...
Familiært kulde autoinflammatorisk syndrom (FCAS) </p>
</li>
<li>Familiær middelhavsfeber (FMF) </li>
<li>Stills sygdom, herunder systemisk juvenil idiopatisk artrit (SJIA) og Stills sygdom startende i 
voksenalderen (AOSD) </li>
</ul>
<p>Cytokiner er proteiner, der dannes i kroppen, og som koordinerer kommunikationen mellem cellerne 
og hjælper med at kontrollere celleaktiviteten. Ved RA, CAPS, FMF, Stills sygdom og ved 
COVID-19-lungebetændelse producerer kroppen for meget af det cytokin, som hedder interleukin-1. Dette har skadelige virkninger, der fører til betændelsestilstande (inflammation), der forårsager 
sygdommens symptomer. Normalt producerer kroppen et protein, som blokerer for interleukin-1's 
skadelige virkning. Det aktive stof i Kineret er anakinra, der virker på samme måde som det naturlige 
blokeringsprotein interleukin-1. Anakinra fremstilles med DNA-teknologi ved brug af 
mikroorganismen E. coli. </p>
<p>Ved RA anvendes Kineret til behandling af tegn og symptomer på sygdom hos voksne (fra 18 år og 
...
methotrexat alene. </p>
<p>Ved COVID-19 anvendes Kineret til behandling af hyperinflammation (en inflammation, der er 
stærkere end normalt) i forbindelse med sygdommen hos voksne (fra 18 år og derover), som har 
lungebetændelse, har behov for ekstra ilt for at hjælpe dem med at trække vejret (oxygen ved lavt eller 
højt flow) og har risiko for lungesvigt. </p>
<p>Ved CAPS anvendes Kineret til behandling af tegn og symptomer på inflammation, der ses i 
forbindelse med sygdommen, som f.eks. udslæt, ledsmerte, feber, hovedpine og træthed hos voksne og 
børn (i alderen 8 måneder og ældre). </p>
<p>Ved FMF anvendes Kineret til behandling af tegn og symptomer på inflammation, der ses i 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Brug ikke Kineret 
...
- hvis en blodprøve viser, at De har nedsat antal hvide blodlegemer (neutropeni). </p>
<p>De skal kontakte Deres læge med det samme 
- hvis De får udslæt over hele kroppen, bliver forpustet, får åndenød, hurtig puls eller begynder at 
svede, efter De har injiceret Kineret. Dette kan være tegn på, at De er allergisk overfor Kineret. 
- hvis De tidligere har oplevet atypisk, udbredt udslæt eller hudafskalning efter at have taget 
Kineret. </p>
<p>Advarsler og forsigtighedsregler 
Kontakt lægen, før De bruger Kineret:</p>
<ul>
<li>hvis De har oplevet tilbagevendende infektioner, eller hvis De lider af astma. Kineret kan 
forværre disse tilstande; </li>
<li>hvis De har kræft. Deres læge vil afgøre, om De kan anvende Kineret; </li>
<li>hvis De tidligere har haft forhøjede leverenzymer; </li>
<li>hvis De har behov for at blive vaccineret. De må aldrig få levende vacciner, mens De bliver 
behandlet med Kineret. </li>
</ul>
<p>Stills sygdom 
...
udslæt med eosinofili og systemiske symptomer) ved behandling med Kineret, fortrinsvis hos 
patienter med systemisk juvenil idiopatisk artritis (SJIA). Søg læge med det samme, hvis De 
bemærker atypisk, udbredt udslæt, evt. ledsaget af feber og hævede lymfeknuder. </p>
<p>Børn og unge 
- RA: Brugen af Kineret hos børn og unge med reumatoid artrit er ikke fuldt undersøgt og kan 
derfor ikke anbefales. 
- COVID-19: Brugen af Kineret hos børn og unge med COVID-19 er ikke undersøgt og kan 
derfor ikke anbefales. 
- CAPS, FMF, Stills sygdom: Kineret frarådes til børn, der er yngre end 8 måneder, da der ikke 
findes nogen data for denne aldersgruppe. </p>
<p>Brug af anden medicin sammen med Kineret 
Fortæl altid lægen, hvis De tager anden medicin, for nylig har taget anden medicin eller planlægger at 
tage anden medicin. </p>
<p>Visse lægemidler, som kaldes TNF-α-hæmmere (tumornekrosefaktorhæmmere), som f.eks. etanercept, 
må ikke anvendes sammen med Kineret, fordi dette kan øge risikoen for infektioner. </p>
<p>Når De begynder at tage Kineret, reduceres den kroniske inflammation. Dette kan medføre, at 
doseringen af visse andre lægemidler som f.eks. warfarin skal justeres. </p>
<p>Graviditet og amning 
Hvis De er gravid eller ammer, har mistanke om, at De er gravid, eller planlægger at blive gravid, skal 
De spørge Deres læge til råds, før De tager dette lægemiddel. </p>
<p>Kineret er ikke blevet afprøvet hos gravide kvinder. Kineret bør ikke anvendes under graviditet, og til 
kvinder i den fertile alder, som ikke anvender sikker prævention. Det er vigtigt at fortælle det til 
lægen, hvis De er gravid, har mistanke om, at De er gravid eller planlægger at blive gravid. Lægen vil 
diskutere de mulige risici ved at tage Kineret under graviditeten med Dem. </p>
<p>Det er ukendt, om anakinra udskilles i human mælk. De skal derfor ikke amme, hvis De bruger 
Kineret. </p>
...
injicere Kineret på cirka samme tidspunkt hver dag. </p>
<p>Den anbefalede dosis er enten 20 til 90 mg eller 100 mg. Deres læge vil fortælle Dem, hvilken dosis, 
De behøver, og hvorvidt De har behov for en dosis, der er større end 100 mg. </p>
<p>COVID-19: Den anbefalede dosis er 100 mg injiceret under huden (subkutant) dagligt i 10 dage. </p>
<p>Injicering af Kineret 
...
gøre. </p>
<p>De kan finde instruktioner om, hvorledes De injicerer Dem selv eller Deres barn i afsnittet 
"Vejledning i klargøring og injektion af Kineret" til sidst i denne indlægsseddel. </p>
<p>Hvis De har brugt for meget Kineret 
...
<p>Bivirkningerne er de samme, uanset om De bliver behandlet med Kineret for RA, CAPS, FMF, Stills 
sygdom eller COVID-19. Hvis en af følgende bivirkninger opstår, skal De kontakte Deres læge omgående:</p>
<ul>
<li>Alvorlige infektioner såsom lungebetændelse eller infektioner i huden kan opstå under 
...
hoste kan også være tegn på en infektion. </li>
<li>Alvorlige allergiske reaktioner er ikke almindelige. Følgende kan dog være symptomer på en 
...
<ul>
<li>Rødme, hævelse, blåt mærke eller kløe på injektionsstedet. Disse symptomer er ofte lette til 
moderate og forekommer oftest i begyndelsen af behandlingen. </li>
<li>Hovedpine. </li>
<li>Forhøjet kolesterol i blodet. </li>
</ul>
<p>Almindelige bivirkninger (kan ramme op til 1 ud af 10 personer):</p>
<ul>
<li>Lavt antal hvide blodlegemer bestemt efter blodprøve. Det kan øge risikoen for, at De får en 
infektion. Symptomer på infektion kan inkludere feber eller ondt i halsen. </li>
<li>Alvorlig infektion såsom lungebetændelse eller infektioner i huden. </li>
<li>Lavt antal blodplader (trombocytopeni) </li>
</ul>
<p>Ikke almindelige bivirkninger (kan ramme op til 1 ud af 100 personer):</p>
<ul>
<li>Alvorlige allergiske reaktioner inklusive hævelse i ansigtet, tungen eller halsen, synkebesvær 
...
<p>Bivirkninger, hvis hyppighed ikke er kendt (hyppigheden kan ikke estimeres ud fra 
forhåndenværende data):</p>
<ul>
<li>Tegn på leverlidelser som f.eks. gul hud og gule øjne, kvalme, appetitløshed, mørkfarvet urin, 
og lys afføring. </li>
<li>Hvis Kineret injiceres gentagne gange på samme sted, er der risiko for, at der dannes en knude 
(amyloidaflejring) under huden. Skift injektionssted for at undgå dette. </li>
</ul>
...
<p>Brug ikke Kineret, hvis De har mistanke om, at det har været frosset. I det øjeblik en injektionssprøjte 
...
<ul>
<li>Aktivt stof: anakinra. Hver gradueret fyldt injektionssprøjte indeholder 100 mg anakinra. </li>
<li>Øvrige indholdsstoffer: vandfri citronsyre, natriumchlorid, dinatriumedetatdihydrat, 
polysorbat 80, natriumhydroxid og vand til injektionsvæsker. </li>
</ul>
...
partikler har ingen betydning for produktets kvalitet. </p>
<p>Pakningsstørrelser med 1, 7 eller 28 (multipakning indeholdende 4 pakninger med 7 fyldte 
...
<p>Dette afsnit indeholder information om, hvorledes De injicerer Kineret til Dem selv eller Deres barn. 
...
injicerer Dem selv, så spørg Deres læge, sygeplejerske eller apotekspersonalet om hjælp. </p>
<p>Sådan skal De eller den person, der giver Dem injektionen, anvende den fyldte injektionssprøjte 
med Kineret </p>
<p>Det er vigtigt, at De injicerer Dem selv eller Deres barn på samme tidspunkt hver dag. Kineret 
injiceres lige under huden. Dette kaldes en subkutan injektion. </p>
<p>Udstyr: </p>
<p>For at give Dem selv eller Deres barn en subkutan injektion skal De bruge: </p>
<ul>
<li>
<p>en fyldt injektionssprøjte med Kineret </p>
</li>
<li>
<p>desinficerende servietter eller lignende, og </p>
</li>
<li>
<p>steril gaze eller serviet </p>
</li>
</ul>
<p>Sådan skal De gøre, før De injicerer Dem selv eller Deres barn subkutant med Kineret </p>
<ol>
<li>
<p>Tage den fyldte injektionssprøjte med Kineret ud af køleskabet. </p>
</li>
<li>
<p>Den fyldte injektionssprøjte må ikke omrystes. </p>
</li>
<li>
<p>Kontroller udløbsdatoen på den fyldte injektionssprøjtes etiket (EXP). Anvend ikke den fyldte 
injektionssprøjte, hvis den sidste dato i den angivne måned er passeret. </p>
</li>
<li>
<p>Kontroller Kinerets udseende. Opløsningen skal være klar, farveløs til hvid. Den kan evt. 
...
indeholder andre partikler end de delvist gennemsigtige eller hvidlige, må den ikke anvendes. </p>
</li>
<li>
<p>For at gøre indsprøjtningen mere behagelig kan De lade den fyldte injektionssprøjte ligge ved 
stuetemperatur i ca. 30 minutter, eller De kan holde den fyldte injektionssprøjte forsigtigt i 
hånden et par minutter. Opvarm ikke Kineret på nogen anden måde (De må ikke opvarme i 
mikrobølgeovn eller i varmt vand). </p>
</li>
<li>
<p>Fjern ikke hætten fra sprøjten, før De er klar til at foretage injektionen. </p>
</li>
<li>
<p>Vask Deres hænder grundigt. </p>
</li>
</ol>
<p>Kanylebeskyttelse (hætte)
Kanyle
Injektionssprøjtens cylinder
Stempelstang
8. Find en behagelig og godt oplyst, ren overflade, og placer alt det udstyr, De skal bruge i Deres 
umiddelbare nærhed. </p>
<ol>
<li>
<p>Sørg for, at De er klar over, hvilken Kineret-dosis, Deres læge har ordineret: 20 til 90 mg, 
100 mg eller derover. </p>
</li>
<li>
<p>Hvis Deres læge har ordineret en dosis på 100 mg, skal De gå videre til afsnittet "Sådan 
klargøres en 100 mg dosis". </p>
</li>
<li>
<p>Hvis Deres læge har ordineret en lavere dosis, skal De gå videre til afsnittet "Sådan klargøres 
en 20 til 90 mg dosis". </p>
</li>
</ol>
...
<ol>
<li>
<p>Hold på injektionssprøjtens cylinder og tag 
forsigtigt hætten af kanylen uden at vride. Træk 
lige som vist i figur A. Rør ikke ved kanylen og 
skub ikke til stemplet. Bortskaf kanylehætten 
med det samme. </p>
</li>
<li>
<p>Der kan være små luftbobler i den fyldte 
...
<li>
<p>De er nu klar til at anvende den fyldte injektionssprøjte som beskrevet i afsnittet "Hvor skal 
injektionen gives?" og afsnittet "Sådan giver De injektionen". </p>
</li>
</ol>
...
<ol>
<li>
<p>Hold på injektionssprøjtens cylinder og tag forsigtigt hætten 
af kanylen uden at vride. Træk lige som vist i figur A. Rør 
ikke ved kanylen og skub ikke til stemplet. Bortskaf 
kanylehætten med det samme. </p>
</li>
<li>
<p>Tag fat om sprøjten med den ene hånd med kanylen opad 
som vist i figur B. Placér tommelfingeren på stemplet, og 
tryk langsomt, indtil De kan se en lille væskedråbe ved 
kanylens spids. </p>
</li>
<li>
<p>Drej sprøjten så kanylen nu vender nedad. Placér et 
...
vist i figur C. Sørg for, at kanylen ikke berører gazen 
eller servietten. </p>
</li>
<li>
<p>Placér tommelfingeren på stempelstangen, og tryk 
...
eller servietten som vist i figur C. </p>
</li>
</ol>
<p>Kanylebeskyttelse (hætte)
Kanyle
...
Figur B
Figur C
5. Hvis De ikke kan indstille den rette dosis, skal De kassere sprøjten og bruge en ny.  </p>
<ol>
<li>De er nu klar til at anvende den fyldte injektionssprøjte som beskrevet i afsnittet "Hvor skal 
injektionen gives?" og afsnittet "Sådan giver De injektionen". </li>
</ol>
<p>Hvor skal injektionen gives? </p>
<p>De bedste steder at give indsprøjtningen til Dem selv eller Deres barn er (se figur D): </p>
<ul>
<li>
<p>på maven (bortset fra området omkring navlen)  </p>
</li>
<li>
<p>øverst på lårene </p>
</li>
<li>
<p>øverst på den udvendige side af ballerne, og </p>
</li>
<li>
<p>ydersiden af overarmene </p>
</li>
</ul>
<p>Voksen 
Barn </p>
<p>Skift injektionssted hver gang, så et område ikke bliver ømt. Hvis andre injicerer Dem, kan bagsiden 
af overarmene også anvendes. </p>
<p>Sådan giver De injektionen </p>
<ol>
<li>
<p>Desinficer huden med desinfektionsservietten, og klem huden med Deres pege- og 
tommelfinger uden at klemme hårdt til. </p>
</li>
<li>
<p>Stik kanylen helt ind i huden, som Deres læge eller sygeplejerske har vist det. </p>
</li>
<li>
<p>Sprøjt væsken ind i langsomt og jævnt tempo, hele tiden med huden imellem de to fingre som 
vist i figur E. </p>
</li>
<li>
<p>Efter injektion af væsken fjernes kanylen, og huden slippes. </p>
</li>
</ol>
<p>For
Bag
...
Figur E 
Figur D 
5. Eventuelt ubrugt lægemiddel skal bortskaffes. Anvend kun injektionssprøjten til én injektion. 
Sprøjten må ikke genbruges, idet dette kan give anledning til infektion. </p>
<p>Husk </p>
<p>Spørg Deres læge eller sygeplejerske om råd og vejledning, hvis De har problemer. </p>
<p>Bortskaffelse af brugte sprøjter og forbrugsartikler </p>
<ul>
<li>
<p>Sæt ikke hætten på brugte kanyler. </p>
</li>
<li>
<p>Brugte sprøjter skal opbevares utilgængeligt for børn. </p>
</li>
<li>
<p>Brugte, fyldte injektionssprøjter må ikke bortskaffes med det almindelige husholdningsaffald. </p>
</li>
<li>
<p>Hvis Deres dosis er lavere end 100 mg, har De fået besked på at tømme væske ud af sprøjten på 
et stykke gaze eller en serviet. Den våde gaze eller serviet skal bortskaffes sammen med 
sprøjten efter injektionen, hvorefter overfladen gøres ren med en ny serviet. </p>
</li>
<li>
<p>Den brugte fyldte injektionssprøjte og eventuel gaze eller serviet med Kineret-opløsning skal 
bortskaffes i henhold til lokale retningslinjer. Spørg apotekspersonalet, hvordan De skal aflevere 
