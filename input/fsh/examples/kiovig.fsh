...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>KIOVIG belongs to a class of medications called immunoglobulins. These medicines contain human 
...
(PSAF)<em> or serum IgG level of &lt;4 g/l.
</em>PSAF = failure to mount at least a 2-fold rise in IgG antibody titre to pneumococcal polysaccharide 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not use KIOVIG
...
How long monitoring is required during the infusion</p>
<p>You will be carefully observed during the infusion period with KIOVIG to make sure that you 
do not suffer a reaction. Your doctor will make sure that the rate at which KIOVIG is infused is 
suitable for you.</p>
<p>If KIOVIG is administered at a high rate, if you suffer from a condition with low antibody 
...
infusion and for an hour after your infusion has stopped.</p>
<p>If you have already received KIOVIG previously and received the last treatment recently, then 
...
Special patient groups</p>
<p>Your doctor will take special care if you are overweight, elderly, diabetic, or if you suffer from 
...
diluted with a special sugar solution (5% glucose), which could affect your blood sugar level.</p>
<p>Your doctor will also take special care if you have or had previously problems with your 
...
<p>No clinical trials have been made with KIOVIG in pregnant or breast-feeding women. However, 
...
expected.</p>
<p>If you are breast-feeding and receive KIOVIG, the antibodies of the medicine can also be found 
...
Below is a list of side effects reported with KIOVIG:</p>
...
reactions at the infusion site), fever, tiredness.</p>
...
in the chest, lack of strength or feeling of weakness, indisposition, shaking chills.</p>
...
swelling, increased rate of breathing, changes to blood test results.</p>
...
2. Det skal du vide, før du begynder at bruge KIOVIG
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>KIOVIG hører til en klasse af medicin, der kaldes immunglobuliner. Disse lægemidler indeholder
...
KIOVIG anvendes til
Behandling af patienter, som ikke har antistoffer nok (erstatningsbehandling). Der er to 
grupper:
1. Patienter med medfødt manglende produktion af antistoffer (primære immundefekt-syndromer).
2. Patienter med sekundære immundefekter (SID), som lider af svære eller tilbagevendende 
infektioner, ineffektiv antimikrobiel behandling og enten bevist specifikt antistofsvigt 
(PSAF)* eller med en IgG serumværdi på &lt;4 g/l. </p>
<ul>
<li>PSAF = manglende evne til at opnå mindst en stigning til det dobbelte i IgG-antistoftiter for 
pneumokok polysaccharid- og polypeptid antigen-vacciner. 
Behandling af patienter med bestemte inflammatoriske lidelser (immunmodulation). Der er fem 
grupper:</li>
<li>Patienter, som ikke har nok blodplader (primær immun trombocytopeni, ITP), og som er udsat 
for en stor risiko for blødning, eller som skal opereres i nær fremtid.</li>
<li>Patienter med en sygdom, som er forbundet med mange betændelser i nerverne i hele kroppen 
(Guillian Barré syndrome).</li>
<li>Patienter med en sygdom, der forårsager mange betændelser i adskillige af kroppens organer 
(Kawasakis sygdom).
29</li>
<li>Patienter, der lider af en sjælden sygdom, der er kendetegnet ved langsomt fremadskridende 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Brug ikke KIOVIG
...
infektion med hepatitis A virus og parvovirus B19. Brug af anden medicin sammen med KIOVIG
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>KIOVIG er bestemt til at anvendes intravenøst (infusion i en vene). Din læge eller sygeplejerske giver 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Dette lægemiddel kan som al anden medicin give bivirkninger, men ikke alle får bivirkninger. Visse 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>KIOVIG indeholder

...
Erstatningsterapi ved sekundær 
immundefekt
0,2-0,4 g/kg
hver 3.-4. uge for at opnå 
IgG-dalkoncentration på mindst 5-6 g/l
Immunmodulation:
Primær immune trombocytopeni
0,8-1 g/kg
eller
0,4 g/kg/døgn
på dag 1, muligvis gentaget en gang i 
løbet af 3 dage
i 2-5 dage
