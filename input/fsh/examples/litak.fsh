...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not use LITAK 
...
Talk to your doctor or pharmacist before using LITAK. </p>
<p>At any time during or after your treatment, tell your doctor or nurse immediately if you: 
...
your kidneys will be checked.  </p>
<p>If you want to father a child, please tell your doctor before treatment with LITAK is started. You 
should not father a child during treatment and up to 6 months after treatment with LITAK. Your 
doctor may advise you about the possibility to store deep-frozen sperm (cryoconservation). </p>
...
treatment, you must immediately inform your doctor. </p>
<p>You must not breast-feed while you are treated with LITAK and for at least six months after your last 
LITAK dose. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Always use LITAK as your doctor has told you. You should check with your doctor or pharmacist if 
you are not sure.  </p>
<p>Your doctor will calculate your dose according to your body weight and explain the treatment 
schedule in detail. The recommended daily dose is 0.14 mg per kg body weight for five consecutive 
days (single treatment course). </p>
<p>LITAK has to be injected under your skin (subcutaneous injection), at about the same time each day. 
If you are injecting LITAK yourself, first you must receive adequate training by your doctor or nurse. 
You will find detailed instructions for injection at the end of this leaflet. </p>
<p>You may also receive an additional medicine containing the active substance allopurinol in order to 
reduce excess of uric acid.  </p>
<p>If you use more LITAK than you should 
In case you inject an incorrect dose, tell your doctor immediately. </p>
...
* Low number of platelets, which can cause unusual bleeding (for example nose or skin bleeds).<br />
...
* Swelling in tissues (oedema), not feeling well, pain (muscle pain, joint pain, and bone pain). </p>
...
* Serious allergic skin reaction (Stevens-Johnson syndrome or Lyell syndrome). </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What LITAK contains 
...
<p>What LITAK looks like and contents of the pack 
LITAK is available in glass vials containing 5 ml of clear, colourless solution for injection.<br />
...
<p>This section contains information on how to give an injection of LITAK. It is important that you do 
...
question with regard to giving the injection, please ask your doctor or nurse for help. </p>
<p>LITAK is a cytotoxic and should therefore be handled with caution. When LITAK is not 
...
Do not use vials which are damaged, or if the solution is not clear or if it contains any particles. </p>
</li>
<li>
...
2. Det skal De vide, før De begynder at bruge LITAK 
...
punkt 6) 
- hvis De er gravid eller ammer<br />
...
Kontakt lægen eller apotekspersonalet, før De bruger LITAK. </p>
<p>Hvis De oplever følgende, når som helst under eller efter Deres behandling, skal De øjeblikkeligt 
...
føleevne, hukommelsestab eller forvirring. Alle disse reaktioner kan være symptomer på en alvorlig 
og potentielt dødelig hjernelidelse, der kaldes progressiv multifokal leukoencefalopati (PML). </p>
<p>Hvis De havde disse symptomer før behandlingen med cladribin, skal De fortælle det til lægen, hvis 
De oplever en ændring af dem. </p>
...
<ul>
<li>
<p>hvis de lider af en infektion, skal den behandles, inden De begynder at bruge LITAK. </p>
</li>
<li>
<p>hvis De opdager nogen tegn på infektion (som fx influenzalignende symptomer eller feber) 
under eller efter behandlingen med LITAK, skal De informere Deres læge med det samme. </p>
</li>
<li>feber </li>
</ul>
<p>Inden De starter på behandlingen med LITAK, og under selve behandlingen, vil De regelmæssigt få 
...
Desuden vil det blive kontrolleret, om Deres lever og nyrer fungerer rigtigt. , </p>
<p>Hvis De ønsker at blive far til et barn, skal De fortælle det til Deres læge, inden behandlingen med 
...
<p>Brug af anden medicin sammen med LITAK 
...
<ul>
<li>kortikosteroider, som er almindelige ved behandling af betændelse </li>
<li>antivirale midler, som anvendes til behandling af virusinfektioner </li>
</ul>
<p>De må IKKE bruge LITAK sammen med andre lægemider, som påvirker produktionen af blodlegemer 
i knoglemarven (myelosuppression). </p>
...
behandlingen, skal De omgående kontakte Deres læge.  </p>
<p>De må ikke amme, mens De får behandling med LITAK og i mindst seks måneder efter den sidste 
dosis LITAK. </p>
...
apotekspersonalet.  </p>
<p>Deres læge vil udregne den dosis, De skal have, efter Deres legemsvægt og forklare 
behandlingsplanen i detaljer. Den anbefalede daglige dosis er 0,14 mg pr. kg legemsvægt i fem på 
hinanden følgende dage (enkelt behandlingsforløb). </p>
<p>LITAK skal indsprøjtes under huden (subkutan injektion) på nogenlunde samme tidspunkt hver dag.<br />
Hvis De selv indsprøjter LITAK, skal De først have tilstrækkelig instruktion af Deres læge eller 
sygeplejerske. De finder en detaljeret vejledning i indsprøjtning til sidst i denne indlægsseddel.  </p>
<p>De kan også få et supplerende lægemiddel, som indeholder det aktive stof allopurinol, for at nedsætte 
et forhøjet urinsyreniveau. </p>
<p>Hvis De har brugt for meget LITAK 
Hvis De indsprøjter en forkert dosis, skal De straks fortælle det til lægen. </p>
...
behandling med LITAK:</p>
<ul>
<li>tegn på infektioner (som fx influenzalignende symptomer)  </li>
<li>feber </li>
</ul>
<p>Det kan ikke udelukkes, at den ondartede (cancer)-sygdom kommer igen. Det betyder, at risikoen for, 
...
sygdommen, inklusive LITAK. </p>
<p>De følgende bivirkninger kan forekomme: </p>
<p>Meget almindelige bivirkninger (kan påvirke mere end 1 ud af 10 personer) </p>
<ul>
<li>
<p>Infektioner. </p>
</li>
...
<li>
<p>Lavt antal af visse hvide blodceller (neutrofiler og lymfocytter) og blodplader i blodprøver. </p>
</li>
<li>
<p>Lavt antal røde blodlegemer, som kan medføre anæmi (blodmangel) med symptomer som 
træthed og døsighed. </p>
</li>
<li>
<p>Nedsat immunforsvar. </p>
</li>
<li>
<p>Hovedpine, svimmelhed. </p>
</li>
<li>
<p>Unormale åndedrætslyde, unormale brystlyde, hoste. </p>
</li>
<li>
<p>Kvalme, opkastning, forstoppelse og diaré. </p>
</li>
<li>
<p>Hududslæt, hævelse, rødme samt ømhed omkring injektionsstedet, svedafsondring. 
Hudreaktioner er som regel lette til moderate og forsvinder normalt i løbet af få dage. </p>
</li>
<li>
<p>Træthed, kuldegysninger, nedsat appetit. </p>
</li>
<li>
<p>Svaghed/afmatning. </p>
</li>
</ul>
<p>Almindelige bivirkninger (kan påvirke op til 1 ud af 10 personer) </p>
<ul>
<li>
<p>Den ondartede (cancer-) sygdom opstår igen. </p>
</li>
<li>
<p>Lavt antal blodplader, hvilket kan forårsage usædvanlige blødninger (for eksempel næseblod 
eller blødninger i huden). </p>
</li>
<li>
<p>Søvnløshed, angst. </p>
</li>
<li>
<p>Øget hjerterytme, unormal hjertelyd, lavt blodtryk, nedsat blodforsyning til hjertemusklen. </p>
</li>
<li>
<p>Kortåndethed, hævet lungevæv på grund af infektion, betændelse i mund og tunge. </p>
</li>
<li>
<p>Smerter i underlivet og store mængder luft i mave og tarme/indvolde, for det meste lette 
stigninger i laboratoriemålte leverværdier (bilirubin, transaminase), som falder til normale 
værdier, når behandlingen er afsluttet. </p>
</li>
<li>
<p>Kløe, kløende udslæt (nældefeber), rødme af huden og smerter i huden. </p>
</li>
<li>
<p>Hævelser i vævet (ødemer), følelse af utilpashed, smerter (muskelsmerter, ledsmerter og 
knoglesmerter). </p>
</li>
</ul>
...
<ul>
<li>
<p>Anæmi, som skyldes destruktion af røde blodlegemer. </p>
</li>
<li>
<p>Søvnløshed, følelsesløshed og prikken i huden, svækkelse, inaktivitet, lidelse i det perifere 
nervesystem, forvirring, nedsat evne til at koordinere bevægelser. </p>
</li>
<li>
<p>Øjenbetændelse. </p>
</li>
...
<ul>
<li>
<p>Nedsat leverfunktion. </p>
</li>
<li>
<p>Nedsat nyrefunktion. </p>
</li>
<li>
<p>Komplikationer forårsaget af cancerbehandling på grund af nedbrydning af cancerceller. </p>
</li>
<li>
<p>Afstødningsrespons på blodtransfusioner. </p>
</li>
<li>
<p>Øget antal af hvide hvide blodlegemer (eosinofiler). </p>
</li>
<li>
<p>Slagtilfælde. </p>
</li>
<li>
<p>Besvær med at tale og synke. </p>
</li>
<li>
<p>Hjertesvigt. </p>
</li>
...
<li>
<p>Hjertet kan ikke opretholde tilstrækkelig blodcirkulation. </p>
</li>
<li>
<p>Forstoppelse. </p>
</li>
<li>
<p>Alvorlig allergisk reaktion (Stevens-Johnson-syndrom eller Lyell-syndrom). </p>
</li>
</ul>
<p>Meget sjældne bivirkninger (kan påvirke op til 1 ud af 10,000 personer) </p>
<ul>
<li>
<p>Depression, epileptisk anfald. </p>
</li>
<li>
<p>Hævelse af øjenlåget. </p>
</li>
<li>
<p>Blodprop i lungen. </p>
</li>
<li>
<p>Betændelse i galdeblæren. </p>
</li>
<li>
<p>Nedsat organfunktion på grund af stor mængde af et specifikt stof produceret af kroppen (et 
glycoprotein). </p>
</li>
</ul>
...
<p>Brug ikke LITAK efter den udløbsdato, der står på etiketten på hætteglasset og den ydre karton efter 
EXP. Udløbsdatoen er den sidste dag i den nævnte måned. </p>
<p>Medmindre åbningen fra et mikrobielt synspunkt udelukker risikoen for mikrobiel kontaminering, skal 
...
<ul>
<li>Aktivt stof: cladribin. Hvert hætteglas indeholder 2 mg cladribin. Hvert hætteglas indeholder 
10 mg cladibrine i 5 ml opløsning. </li>
<li>Øvrige indholdsstoffer: natriumklorid, natriumhydroxid (til pH-justering), saltsyre (til 
pH-justering) og vand til injektionsvæsker. </li>
</ul>
<p>Udseende og pakningsstørrelser 
LITAK fås i hætteglas, som indeholder 5 ml klar, farveløs injektionsvæske, opløsning. 
Pakningsstørrelser på 1 eller 5 hætteglas. Ikke alle pakningsstørrelser er nødvendigvis markedsført. </p>
<p>Indehaver af markedsføringstilladelsen og fremstiller 
Lipomed GmbH 
Hegenheimer Strasse 2 
D-79576 Weil/Rhein 
Tyskland </p>
<p>Hvis De ønsker yderligere oplysninger om dette lægemiddel, skal De henvende Dem til indehaveren af 
...
<p>Dette afsnit indeholder information om, hvordan man giver en indsprøjtning med LITAK. Det er 
...
<p>LITAK er et celledræbende (cytotoksisk) middel og skal derfor håndteres med forsigtighed. Når 
...
undgå kontakt med LITAK. </p>
<p>Hvad skal jeg bruge til indsprøjtningen? </p>
<p>For at give Dem selv en subkutan indsprøjtning skal De bruge følgende:</p>
<ul>
<li>
<p>Et hætteglas LITAK (eller to hætteglas, hvis De skal indsprøjte mere end 5 ml), 
...
<li>
<p>en steril sprøjte (fx en 10 ml LUER-sprøjte), </p>
</li>
<li>
<p>en steril kanyle (fx 0,5 x 19 mm, 25 G x ¾’’), </p>
</li>
<li>
<p>renseservietter, </p>
</li>
<li>
<p>en beholder som ikke kan stikkes hul i, til at smide de brugte sprøjter væk i.  </p>
</li>
</ul>
<p>Hvad skal jeg gøre før jeg giver mig selv en subkutan indsprøjtning med LITAK? </p>
<ol>
<li>
<p>Før indsprøjtning skal LITAK have lov til at opnå stuetemperatur. </p>
</li>
<li>
<p>Vask hænderne grundigt. </p>
</li>
<li>
<p>Find et behageligt sted med god belysning og stil alt så du kan nå det.  </p>
</li>
</ol>
...
<ol>
<li>
<p>Fjern det røde beskyttelseslåg fra LITAK-hætteglasset. Undgå at fjerne hætteglassets 
...
spidsen af sprøjten. Fjern kanylens beskyttelseskappe uden at røre kanylen. </p>
</li>
<li>
<p>Pres kanylen ned gennem hætteglassets gummiprop og vend hætteglasset og sprøjten på 
hovedet. Vær sikker på at spidsen af kanylen er nede i opløsningen. </p>
</li>
<li>
<p>Træk den rigtige mængde LITAK ned i sprøjten ved at trække stemplet ud (din læge vil oplyse 
dig om hvor mange ml LITAK du skal indsprøjte). </p>
</li>
<li>
<p>Træk kanylen ud af hætteglasset. </p>
</li>
<li>
<p>Vær sikker på at der ikke er noget luft i sprøjten; vend kanylen opad og tryk luften ud. </p>
</li>
<li>
<p>Kontroller at du har den rigtige mængde. </p>
</li>
<li>
<p>Injicer med det samme. </p>
</li>
</ol>
...
<ol>
<li>
<p>Træk lidt i stemplet for at kontrollere at der ikke er gået hul på et blodkar. Hvis du ser blod i 
sprøjten, tag kanylen ud og stik den ind et andet sted.  </p>
</li>
<li>
<p>Sprøjt væsken langsomt og jævnt ind i løbet af cirka et minut, mens du holder huden trykket 
sammen.  </p>
</li>
<li>
<p>Efter at du har sprøjtet væsken ind, fjernes kanylen. </p>
</li>
<li>
<p>Smid sprøjten væk i en beholder, der ikke kan prikkes hul i. Brug en ny sprøjte og kanyle til den 
næste indsprøjtning. Hætteglassene er kun til engangsbrug. Hvis der er noget tilbage, bør du 
aflevere det til din læge eller apotekspersonalet, så det kan blive bortskaffet på passende måde.  </p>
</li>
</ol>
<p>Bortskaffelse af brugte sprøjter </p>
<p>Smid brugte sprøjter væk i en beholder, der ikke kan prikkes hul i. Opbevar beholderen utilgængeligt 
for børn. </p>
<p>Beholderen bortskaffes efter lægens, sygeplejersken eller apotekspersonalets instrukser.  </p>
<p>Undgå at smide brugte sprøjter i det almindelige husholdningsaffald. </p>
<ol>
<li>
<p>Desinficer huden med en renseserviet, vent 
på at området tørrer og tryk huden sammen 
med tommelfingeren og pegefingeren uden at 
klemme det. </p>
</li>
<li>
<p>Put kanylen helt ind i huden i en vinkel på 
omkring 45°, som vist på billedet. </p>
</li>
</ol>
<p>De bedste steder at foretage en indsprøjtning på 
