...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Lonquex is 
Lonquex contains the active substance lipegfilgrastim. Lipegfilgrastim is a long-acting modified 
protein produced by biotechnology in bacteria called Escherichia coli. It belongs to a group of proteins 
called cytokines and is similar to a natural protein (granulocyte-colony stimulating factor [G-CSF]) 
produced by your own body. </p>
<p>What Lonquex is used for 
Lonquex is used in adults and in children aged 2 years and older. </p>
<p>Your doctor has prescribed Lonquex for you or for your child in order to reduce the duration of a 
condition called neutropenia (low white blood cell count) and the occurrence of febrile neutropenia 
(low white blood cell count with a fever). These can be caused by the use of cytotoxic chemotherapy 
(medicines that destroy rapidly-growing cells). </p>
<p>How Lonquex works 
Lipegfilgrastim stimulates the bone marrow (the tissue where new blood cells are made) to produce 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not use Lonquex 
* if you or your child are allergic to lipegfilgrastim or any of the other ingredients of this 
...
one (e.g. filgrastim, lenograstim or pegfilgrastim of the group of G-CSFs). There could be a risk 
of reacting to Lonquex too. </p>
...
condition called myelodysplastic syndrome (MDS) or of a blood cancer called acute myeloid 
leukaemia (AML) which have been associated with another medicine like this one (pegfilgrastim 
of the group of G-CSFs). </p>
<p>Inflammation of the aorta (the large blood vessel which transports blood from the heart to the body) 
has been reported rarely with other medicines like this one (e.g. filgrastim, lenograstim or 
pegfilgrastim of the group of G-CSFs). The symptoms can include fever, abdominal pain, malaise, 
back pain and increased inflammatory markers. Tell your doctor if you experience these symptoms. </p>
<p>Children and adolescents 
Lonquex is not recommended for children younger than 2 years of age. </p>
<p>Other medicines and Lonquex 
Tell your doctor or pharmacist if you or your child are using, have recently used or might use any 
other medicines. </p>
<p>Pregnancy and breast-feeding 
Lonquex has not been tested in pregnant women. It is important to tell your doctor if you are pregnant, 
think you may be pregnant or are planning to have a baby, as the doctor may decide that you should 
not use this medicine. </p>
<p>It is unknown whether the active substance in this medicine passes into the breast milk. You should 
therefore interrupt breast-feeding during treatment. </p>
<p>Driving and using machines 
Lonquex has no or negligible influence on your ability to drive and use machines. </p>
<p>Lonquex contains sorbitol 
...
<p>What the recommended dose is 
The recommended dose is one pre-filled syringe (6 mg lipegfilgrastim) once per chemotherapy cycle. </p>
<p>The pre-filled syringe is only suitable for adults or for children weighing 45 kg and more. </p>
<p>Lonquex is also available in a vial presentation for children weighing less than 45 kg. The 
recommended dose will be based on their body weight and the adequate dose will be given by a doctor 
or a nurse. </p>
<p>When to use Lonquex 
The Lonquex dose will normally be injected approximately 24 hours after the last dose of 
chemotherapy at the end of each chemotherapy cycle. </p>
<p>How are the injections given? 
This medicine is given as an injection using a pre-filled syringe. The injection is given into the tissue 
just under the skin (subcutaneous injection). </p>
...
received special training from your doctor or nurse. If you are not sure about giving yourself or your 
child the injection or you have any questions, please ask your doctor or nurse for help. </p>
...
protein, der fremstilles ved bioteknologi i bakterier kaldet Escherichia coli. Det hører til en gruppe 
proteiner, der kaldes cytokiner, og som er magen til et naturligt protein 
(granulocyt-kolonistimulerende faktor [G-CSF]), der produceres af din egen krop. </p>
<p>Anvendelse 
Lonquex anvendes til voksne og børn i alderen 2 år og ældre. </p>
<p>Din læge har ordineret Lonquex til dig eller til dit barn for at reducere varigheden af en tilstand, der 
kaldes neutropeni (lavt antal hvide blodlegemer) og forekomsten af febril neutropeni (lavt antal hvide 
blodlegemer med feber). Disse tilstande kan skyldes anvendelse af cytotoksisk kemoterapi (medicin, 
der nedbryder hurtigvoksende celler). </p>
<p>Sådan virker Lonquex 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Brug ikke Lonquex 
- hvis du eller dit barn er allergisk over for lipegfilgrastim eller et af de øvrige indholdsstoffer i 
Lonquex (angivet i punkt 6). </p>
<p>Advarsler og forsigtighedsregler 
Kontakt lægen, apotekspersonalet eller sygeplejersken, før du bruger Lonquex </p>
<ul>
<li>
<p>hvis du eller dit barn får ondt øverst til venstre i maven eller under skulderbladet. Det kan 
skyldes en lidelse i milten (se punkt 4. "Bivirkninger"). </p>
</li>
<li>
<p>hvis du eller dit barn hoster, har feber og vejrtrækningsbesvær. Det kan skyldes en lungelidelse 
(se punkt 4. "Bivirkninger"). </p>
</li>
<li>
<p>hvis du eller dit barn har seglcelleanæmi, som er en arvelig sygdom karakteriseret ved 
seglcelle-formede røde blodlegemer. </p>
</li>
<li>
<p>hvis du eller dit barn tidligere har haft allergiske reaktioner over for andre lægemidler som dette 
(f.eks. filgrastim, lenograstim eller pegfilgrastim i gruppen af G-CSF’er). Der kunne også være 
en risiko for en reaktion over for Lonquex. </p>
</li>
</ul>
<p>Din læge vil udføre regelmæssige blodprøver for at overvåge forskellige bestanddele i blodet og 
niveauerne af disse. Din læge vil også kontrollere din eller dit barns urin regelmæssigt, da andre 
lægemidler, der ligner dette (f.eks. andre granulocyt-kolonistimulerende faktorer, såsom filgrastim, 
lenograstim eller pegfilgrastim) muligvis kan beskadige de bittesmå filtre i dine nyrer 
(glomerulonefritis, se punkt 4 "Bivirkninger"). </p>
<p>Fortæl det til lægen, hvis du eller dit barn behandles for bryst- eller lungekræft i kombination med 
kemoterapi og/eller stråleterapi, og oplever symptomer såsom træthed, feber og tendens til blå mærker 
eller blødning. Disse symptomer kan være et resultat af en blodsygdom, som er et forstadie til kræft, 
og som kaldes myelodysplastisk syndrom (MDS), eller en form for blodkræft, som kaldes akut 
myeloid leukæmi (AML), som er blevet forbundet med et andet lægemiddel, der ligner dette 
(pegfilgrastim i gruppen af G-CSF’er). </p>
<p>Der er indberettet sjældne tilfælde af betændelse i aorta (den store pulsåre, der transporterer blod fra 
...
rygsmerter og øgede betændelsesmarkører. Fortæl det til lægen, hvis du oplever disse symptomer. </p>
<p>Børn og unge 
Lonquex bør ikke anvendes til børn under 2 år. </p>
<p>Brug af andre lægemidler sammen med Lonquex 
Fortæl altid lægen eller apotekspersonalet, hvis du eller dit barn bruger andre lægemidler, for nylig har 
...
ikke må bruge dette lægemiddel. </p>
<p>Det er ukendt, om det aktive stof i dette lægemiddel udskilles i mælken hos mennesker. Amning skal 
ophøre under behandling med Lonquex. </p>
<p>Trafik- og arbejdssikkerhed 
Lonquex påvirker ikke eller kun i ubetydelig grad evnen til at føre motorkøretøj og betjene maskiner. </p>
<p>Lonquex indeholder sorbitol 
...
<p>Anbefalet dosis 
Den anbefalede dosis er en fyldt injektionssprøjte (6 mg lipegfilgrastim) én gang pr. 
kemoterapicyklus. </p>
<p>Den fyldte injektionssprøjte er kun egnet til voksne eller til børn, der vejer 45 kg og derover. </p>
<p>Lonquex fås også i et hætteglas til børn, der vejer under 45 kg. Den anbefalede dosis vil være baseret 
på barnets legemsvægt, og den tilstrækkelige dosis vil blive givet af en læge eller en sygeplejerske. </p>
<p>Hvornår skal du bruge Lonquex? 
Lonquex-dosen vil normalt blive injiceret ca. 24 timer efter den sidste dosis kemoterapi, ved 
slutningen af hver kemoterapicyklus. </p>
...
under huden (subkutan injektion). </p>
<p>Din læge kan foreslå, at du selv lærer at injicere dig med dette lægemiddel, eller hvordan du skal give 
injektionen til dit barn. Din læge eller sygeplejersken vil vejlede dig i, hvordan du skal gøre det. 
Forsøg ikke at injicere dig selv eller dit barn med Lonquex uden denne træning. Oplysninger, der 
kræves ved brug af den fyldte injektionssprøjte, kan findes under "Oplysninger til injektion af dig selv 
eller dit barn"). En korrekt behandling af din eller dit barns sygdom kræver imidlertid nøje og konstant 
samarbejde med lægen. </p>
<p>Oplysninger til injektion af dig selv eller dit barn </p>
<p>Dette afsnit indeholder oplysninger om, hvordan du kan give dig selv eller dit barn en injektion af 
Lonquex under huden. Det er vigtigt, at du ikke forsøger at give dig selv eller dit barn en injektion, 
medmindre du har fået særlig træning fra lægen eller sygeplejersken. Spørg lægen eller sygeplejersken 
til råds, hvis du ikke er sikker på, at du kan injicere dig selv eller dit barn, eller du har spørgsmål. </p>
<p>Sådan bruges Lonquex 
Du skal give dig selv eller dit barn injektionen i væv lige under huden. Det kaldes en subkutan 
injektion. </p>
<p>Nødvendigt udstyr 
For at give dig selv eller dit barn en injektion i vævet under huden, skal du bruge: </p>
<ul>
<li>
<p>en fyldt injektionssprøjte med Lonquex, </p>
</li>
<li>
<p>en spritserviet, </p>
</li>
<li>
<p>et stykke gazebind eller en steril gazeserviet, </p>
</li>
<li>
<p>en punkterfri beholder (plasticbeholder, der udleveres af hospitalet eller apoteket), så du kan 
bortskaffe dine brugte sprøjter på sikker vis. </p>
</li>
</ul>
<p>Det skal du gøre før injektionen 
1. Tag medicinen ud af køleskabet. 
2. Åbn blisteren og tag den fyldte injektionssprøjte ud af blisteren (se figur 1). Løft ikke den fyldte 
injektionssprøjte i stemplet eller kanylebeskyttelsen. 
3. Kontroller udløbsdatoen på etiketten på den fyldte injektionssprøjte (EXP). Brug ikke, hvis den 
sidste dato i den nævnte måned er overskredet. 
4. Kontroller Lonquex’ udseende. Det skal være en klar og farveløs væske. Hvis den indeholder 
partikler eller er uklar, må du ikke bruge den. 
5. Omryst ikke Lonquex kraftigt, da det kan påvirke aktiviteten. 
6. For at gøre injektionen mere bekvem: </p>
<ul>
<li>
<p>bør du lade den fyldte injektionssprøjte nå til stuetemperatur ved at vente i 30 minutter 
(ikke ved temperaturer over 25 °C), eller  </p>
</li>
<li>
<p>du kan forsigtigt holde den fyldte injektionssprøjte i hånden i nogle få minutter.<br />
Du må ikke opvarme Lonquex på nogen anden vis (for eksempel må du ikke varme den i en 
mikrobølgeovn eller i varmt vand). </p>
</li>
<li>Du må ikke fjerne kanylebeskyttelsen fra sprøjten, før du er klar til injektion. </li>
<li>Find et behageligt, veloplyst sted. Anbring alt udstyret inden for rækkevidde (den fyldte 
injektionssprøjte med Lonquex, en spritserviet, et stykke gazebind eller en steril gazeserviet og 
den punkterfri beholder). </li>
<li>Vask hænderne grundigt. </li>
</ul>
<p>1 </p>
<p>Hvor skal injektionen gives? 
De mest velegnede injektionssteder er: </p>
<ul>
<li>
<p>øverst på lårene, </p>
</li>
<li>
<p>i maven (se de grå områder på figur 2). Undgå huden omkring navlen. </p>
</li>
</ul>
<p>2 </p>
<p>Hvis andre giver dig injektionen, eller hvis du injicerer dit barn, kan de følgende steder også bruges: </p>
<ul>
<li>bagsiden af overarmene (se de grå områder på figur 3 og 4). </li>
</ul>
<p>3 
4 </p>
<p>Sådan forbereder du injektionen 
Før du giver dig selv eller dit barn en injektion med Lonquex, skal du foretage følgende: 
1. Desinficer injektionsstedet på huden med en spritserviet. 
2. Hold sprøjten og fjern forsigtigt kanylebeskyttelsen fra kanylen uden at vride den. Træk lige ud 
som vist på figur 5 og 6. Kanylen må ikke berøres, og der må ikke skubbes til stemplet. </p>
<p>5 
6 </p>
<ol>
<li>Du kan bemærke små luftbobler i den fyldte injektionssprøjte. Hvis der er bobler, holder du 
sprøjten med kanylen pegende opad (se figur 7), og du banker let på sprøjten med fingrene, 
indtil luftboblerne stiger opad i sprøjten. Mens sprøjten peger opad, fjernes al luften fra sprøjten 
ved langsomt at skubbe stemplet opad. </li>
</ol>
<p>7 </p>
<ol>
<li>Du kan nu bruge den fyldte injektionssprøjte. </li>
</ol>
<p>Sådan skal du injicere dig selv eller dit barn 
1. Pres den desinficerede hud sammen mellem tommel- og pegefinger uden at klemme til (se 
figur 8). 
2. Før kanylen helt ind i huden, som lægen eller sygeplejersken har vist dig. Vinklen mellem 
sprøjten og huden bør ikke være for lille (mindst 45°, se figur 9). 
3. Injicer væsken støt og roligt, mens du stadig presser huden sammen. 
4. Efter væsken injiceres, fjernes kanylen, og du kan slippe huden. 
5. Tryk ned på injektionsstedet med et stykke gazebind eller en steril gazeserviet i flere sekunder. 
6. Brug kun hver sprøjte til én injektion. Brug ikke overskydende Lonquex i sprøjten. </p>
<p>8 
9 </p>
<p>OBS! 
Hvis du har problemer, bedes du spørge lægen eller sygeplejersken om hjælp og rådgivning. </p>
<p>Bortskaffelse af brugte sprøjter </p>
<ul>
<li>
<p>Sæt ikke beskyttelsen tilbage på de brugte kanyler. </p>
</li>
<li>
<p>Anbring de brugte sprøjter i den punkterfri beholder, og opbevar beholderen utilgængeligt for 
børn. </p>
</li>
<li>
<p>Bortskaf den fyldte punkterfri beholder efter lægens, apotekspersonalets eller sygeplejerskens 
anvisninger. </p>
</li>
<li>
<p>Brugte sprøjter må aldrig smides i affaldsspande til normalt husholdningsaffald. </p>
</li>
</ul>
<p>Oplysninger til injektion af dig selv eller dit barn </p>
<p>Dette afsnit indeholder oplysninger om, hvordan du kan give dig selv eller dit barn en injektion af 
Lonquex under huden. Det er vigtigt, at du ikke forsøger at give dig selv eller dit barn en injektion, 
medmindre du har fået særlig træning fra lægen eller sygeplejersken. Spørg lægen eller sygeplejersken 
til råds, hvis du ikke er sikker på, at du kan injicere dig selv, eller du har spørgsmål. </p>
<p>Sådan bruges Lonquex 
Du skal give dig selv eller dit barn injektionen i væv lige under huden. Det kaldes en subkutan 
injektion. </p>
<p>Nødvendigt udstyr 
...
<li>
<p>du kan forsigtigt holde den fyldte injektionssprøjte i hånden i nogle få minutter.  </p>
</li>
</ul>
<p>Du må ikke opvarme Lonquex på nogen anden vis (for eksempel må du ikke varme den i en 
mikrobølgeovn eller i varmt vand). 
7. Du må ikke fjerne kanylebeskyttelsen fra sprøjten, før du er klar til injektion. 
8. Find et behageligt, veloplyst sted. Anbring alt udstyret inden for rækkevidde (den fyldte 
injektionssprøjte med Lonquex, en spritserviet og et stykke gazebind eller en steril gazeserviet). 
9. Vask hænderne grundigt. </p>
<p>1 </p>
<p>Hvor skal injektionen gives? 
De mest velegnede injektionssteder er: </p>
<ul>
...
2. Før kanylen helt ind i huden, som lægen eller sygeplejersken har vist dig. Vinklen mellem 
sprøjten og huden bør ikke være for lille (mindst 45°, se figur 9). 
3. Injicer væsken støt og roligt, mens du stadig presser huden sammen (se figur 10). 
4. Tryk stemplet ned, indtil det ikke kan trykkes længere ned, for at injicere al væsken. Fjern 
kanylen fra huden, mens stemplet stadig er trykket helt ned (se figur 11). Derefter slippes 
stemplet. Sikkerhedsanordningen vil straks aktiveres. Hele kanylen og sprøjten vil automatisk 
trækkes tilbage og dækkes, så du ikke kan stikke dig selv (se figur 12). 
5. Tryk ned på injektionsstedet med et stykke gazebind eller en steril gazeserviet i flere sekunder. 
6. Hver fyldt injektionssprøjte er kun til engangsbrug. </p>
<p>8 
9 </p>
<p>OBS! 
Hvis du har problemer, bedes du spørge lægen eller sygeplejersken om hjælp og rådgivning. </p>
<p>Hvis du har brugt for meget Lonquex 
Hvis du har brugt for meget Lonquex, skal du kontakte lægen. </p>
...
<ul>
<li>
<p>Allergiske reaktioner som hududslæt, kløende hævede hudområder og alvorlige allergiske 
...
Lonquex og straks søge lægehjælp. </p>
</li>
<li>
<p>Der er rapporteret forstørret milt med hyppigheden ikke almindelig og tilfælde af miltruptur 
(bristning af milten) med andre lægemidler, der ligner Lonquex. Nogle tilfælde af miltruptur var 
dødelige. Det er vigtigt, at du straks kontakter lægen, hvis du får smerter øverst i venstre side af 
maven eller i venstre skulder, da det kan skyldes et problem med milten. </p>
</li>
<li>
<p>Hoste, feber og besværlig eller smertefuld vejrtrækning kan være tegn på ikke almindelige 
alvorlige lungebivirkninger, såsom lungebetændelse og akut lungesvigtsyndrom, som kan være 
dødeligt. Hvis du har feber eller et af disse symptomer, er det vigtigt straks at kontakte lægen. </p>
</li>
<li>
<p>Det er vigtigt, at du straks kontakter din læge, hvis du får nogle af følgende symptomer: hævelse 
...
<ul>
<li>
<p>Knogle- og muskelsmerter, såsom knoglesmerter og smerter i leddene, musklerne, arme og ben, 
...
<ul>
<li>
<p>Et nedsat antal blodplader, hvilket forhøjer risikoen for blødning og blå mærker. </p>
</li>
<li>
<p>Hovedpine. </p>
</li>
<li>
<p>Hudreaktioner som rødme eller udslæt. </p>
</li>
<li>
<p>Lavt niveau af kalium i blodet, hvilket kan forårsage muskelsvaghed, trækninger eller unormal 
hjerterytme. </p>
</li>
<li>
<p>Brystsmerter. </p>
...
<li>
<p>Lokale reaktioner på injektionsstedet, såsom smerte eller hærdning. </p>
</li>
<li>
<p>Der kan forekomme ændringer af blodet, men det vil opdages under rutinemæssige blodprøver. </p>
</li>
<li>
<p>Blødning i lungerne. </p>
</li>
</ul>
<p>Ikke kendte (hyppighed kan ikke beregnes ud fra forhåndenværende data) </p>
<ul>
<li>
<p>betændelse i aorta (den store pulsåre, der transporterer blod fra hjertet ud i kroppen), se punkt 2. Bivirkninger, som er blevet observeret med lægemidler, der ligner Lonquex, men endnu ikke 
med Lonquex </p>
</li>
<li>
<p>Seglcellekriser hos patienter med seglcelleanæmi. </p>
</li>
<li>
<p>Blommefarvede, hævede, smertefulde sår på arme og ben, sommetider i ansigtet og på halsen, 
med feber (Sweets syndrom). </p>
</li>
<li>
<p>Betændelse af hudens blodkar. </p>
</li>
<li>
<p>Beskadigelse af de bittesmå filtre i dine nyrer (glomerulonefritis, se punkt 2 under "Advarsler 
og forsigtighedsregler"). </p>
</li>
</ul>
...
<p>Brug ikke lægemidlet efter den udløbsdato, der står på den ydre æske og på etiketten for den fyldte 
...
<p>Lonquex kan fjernes fra køleskabet og opbevares ved temperaturer under 25 °C i en maksimal enkelt 
periode på op til 7 dage. Når det fjernes fra køleskabet, skal lægemidlet anvendes i løbet af denne 
...
<ul>
<li>Aktivt stof: lipegfilgrastim. Hver fyldt injektionssprøjte indeholder 6 mg lipegfilgrastim. Hver 
ml opløsning indeholder 10 mg lipegfilgrastim. </li>
<li>Øvrige indholdsstoffer (hjælpestoffer): iseddikesyre, natriumhydroxid (se punkt 2 "Lonquex 
indeholder natrium"), sorbitol (E420) (se punkt 2 "Lonquex indeholder sorbitol"), polysorbat og vand til injektionsvæsker. </li>
</ul>
<p>Udseende og pakningsstørrelser 
Lonquex er en injektionsvæske, opløsning (injektion) i en fyldt injektionssprøjte med en fast kanyle i 
en blister. Lonquex er en klar og farveløs opløsning. Hvis den indeholder partikler eller er uklar, må 
du ikke bruge den. </p>
<p>Hver fyldt injektionssprøjte indeholder 0,6 ml opløsning. </p>
<p>Lonquex fås i pakninger indeholdende 1 og 4 fyldte injektionssprøjter med sikkerhedsanordning eller 
1 fyldt injektionssprøjte uden sikkerhedsanordning. </p>
...
<p>Lonquex 6 mg/0,6 ml injektionsvæske, opløsning 
lipegfilgrastim </p>
