...
Instance: composition-en-41b3735a6e59fac8a0512a47fdc116bd
...
<ol>
<li>What Lupkynis is and what it is used for </li>
<li>What you need to know before you take Lupkynis </li>
<li>How to take Lupkynis </li>
...
* section[=].section[+]
  * title =  "1. What lupkynis is and what it is used for"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text =  "1. What lupkynis is and what it is used for"
  * text.status = #additional
...
* section[=].section[+]
  * title = "2. What you need to know before you take lupkynis"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "2. What you need to know before you take lupkynis"
  * text.status = #additional
...
recommended in these patients. </p>
<p>This medicine may influence the electrical activity of your heart (QT prolongation). This can result in 
serious heart rhythm disorder. Early symptoms are dizziness and fainting.  </p>
<p>Sunlight and UV light 
This medicine can increase the risk of developing certain types of cancer, particularly of the skin. You 
should avoid or limit your exposure to sunlight and UV light by wearing appropriate protective 
clothing and frequently applying sunscreen with a high protection factor. </p>
<p>Infections 
This medicine can increase your risk of developing infections, some of which may be serious or even 
fatal. Contact your doctor if you have any signs of infection, such as fever, chills or sore throat. Your 
doctor will decide whether you need to stop taking this medicine (see section 4). </p>
<p>Children and adolescents 
Do not take this medicine if you are under the age of 18 years because it has not been studied in this 
age group. </p>
<p>Elderly 
This medicine is not recommended if you are over the age of 75 years because it has not been studied 
in this age group. </p>
...
<p>This medicine is not recommended during pregnancy and in women of childbearing potential not 
using contraception. </p>
<p>Tell your doctor if you are breast-feeding. It is not known if the medicine can pass into breast milk and 
affect your baby. Your doctor will discuss with you whether to stop treatment with this medicine while 
you are breast-feeding, or to stop breast-feeding. </p>
<p>There are no data on the effect of this medicine on human fertility. </p>
<p>Driving and using machines 
Lupkynis is not expected to have any effect on your ability to drive and use machines. </p>
<p>Lupkynis contains alcohol 
This medicine contains 21.6 mg of alcohol (ethanol) in each capsule. Therefore, a dose of 3 capsules 
of Lupkynis contains 64.8 mg ethanol, which is equivalent to less than 2 mL beer or 1 mL wine. This 
small amount of alcohol in this medicine will not have any noticeable effects. </p>
<p>Lupkynis contains sorbitol 
...
* section[=].section[+]
  ...
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "3. How to take lupkynis"
  * text.status = #additional
...
<p>The recommended dose of Lupkynis is three capsules twice daily, taken by mouth. </p>
<p>The capsules must be swallowed whole and can be taken with or without food. </p>
<p>Take the daily doses at around the same time each day, at least 8 hours apart and ideally as close to hours apart as possible (for example, at 8:00 am in the morning and 8:00 pm in the evening). </p>
<p>This medicine should be used in combination with another immunosuppressant medicine, 
mycophenolate mofetil. </p>
<p>If you take more Lupkynis than you should 
If you have accidentally taken too many capsules, contact your doctor or nearest hospital emergency 
department immediately. Symptoms of overdose may include a fast heartbeat and tremors 
(uncontrolled shaking or trembling in one or more parts of the body). </p>
<p>If you forget to take Lupkynis 
If a dose is missed, take it as soon as possible and within 4 hours of missing the dose. If more than 4 
hours have passed since the time you normally take the medicine, just skip that dose and take the next 
...
<p>If any of these occur, seek immediate medical advice as your doctor may advise you to stop taking this 
medicine or reduce the dose. </p>
<p>Very common (may affect more than 1 in 10 people) 
- Symptoms of infection (such as fever, body aches, feeling tired, coughing or sneezing, nausea, 
vomiting or diarrhoea) </p>
<p>Common (may affect up to 1 in 10 people) 
- Newly developing symptoms of nerve or brain problems, such as seizures </p>
...
- Changes in your kidney function which could reduce the amount of urine you produce and may 
cause new or worsening swelling in your legs or feet </p>
<p>Common (may affect up to 1 in 10 people) 
...
- Indigestion 
- Hair loss 
- Excessive and/or abnormal hair growth on any part of the body </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Lupkynis contains 
- The active substance is voclosporin. Each soft capsule of Lupkynis contains 7.9 mg of 
voclosporin. 
- The other ingredients are: 
Capsule content: ethanol, vitamin E (E307) polyethylene glycol succinate (tocofersolan), 
polysorbate 40 and medium-chain triglycerides 
Capsule shell: gelatin, sorbitol, glycerin, purified water, titanium dioxide (E171), iron oxide red 
...
Instance: composition-da-41b3735a6e59fac8a0512a47fdc116bd
InstanceOf: CompositionUvEpi
Title: "Composition for lupkynis Package Leaflet"
Description:  "Composition for lupkynis Package Leaflet"
Usage: #inline
...
2. Det skal du vide, før du begynder at tage Lupkynis 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Lupkynis indeholder det aktive stof voclosporin. Det anvendes til behandling af lupus nefritis 
(inflammation/betændelse i nyrerne forårsaget af lupus) hos voksne i alderen 18 år eller derover. </p>
<p>Det aktive stof i Lupkynis tilhører en gruppe lægemidler, der kaldes calcineurinhæmmere, og som kan 
anvendes til kontrol af kroppens immunforsvar (immunsvækkende stoffer). Ved lupus går kroppens 
...
* section[=].section[+]
  * title = "2. Det skal du vide, før du begynder at tage  lupkynis"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "2. Det skal du vide, før du begynder at tage  lupkynis"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Tag ikke Lupkynis 
- hvis du er allergisk over for voclosporin eller et af de øvrige indholdsstoffer i Lupkynis (angivet 
i punkt 6). 
- hvis du tager andre lægemidler som f.eks. ketoconazol-tabletter (til behandling af Cushings 
syndrom, når kroppen producerer for meget kortisol), itraconazol eller clarithromycin (til 
behandling af visse svampe- og bakterieinfektioner). </p>
<p>Advarsler og forsigtighedsregler 
Kontakt lægen eller apotekspersonalet, før du tager Lupkynis, hvis noget af følgende gælder for dig:</p>
<ul>
<li>Hvis din nyresygdom forværres, skal din dosis af lægemidlet muligvis ændres. Lægen vil 
regelmæssigt kontrollere, hvor godt dine nyrer fungerer. </li>
<li>Hvis du har risikofaktorer for pure red cell aplasia (PRCA), der er en sjælden sygdom, hvor 
knoglemarven ikke danner tilstrækkeligt med røde blodlegemer. Sådanne risikofaktorer er 
tidligere infektion med parvovirus B19 eller andre tidligere behandlinger, der kan medføre 
PRCA. </li>
<li>Hvis du har eller udvikler forhøjet blodtryk. Lægen vil tjekke dit blodtryk hver 2. uge den første 
måned og derefter med regelmæssige mellemrum. Lægen kan give dig blodtrykssænkende 
medicin eller vurdere, at du skal holde op med at tage dette lægemiddel. </li>
<li>Dette lægemiddel kan øge risikoen for lidelser i nervesystemet, herunder hovedpine, skælven, 
synsændringer, krampeanfald, forvirring eller svaghed i et eller flere lemmer. Hvis du får et 
eller flere af disse nye symptomer eller oplever forværring af eksisterende symptomer, kan 
lægen vurdere, at du skal stoppe med at tage dette lægemiddel eller have en lavere dosis 
(se pkt. 4). </li>
<li>Hvis du planlægger at få en vaccination, eller hvis du har fået en vaccination inden for de 
seneste 30 dage. Dette lægemiddel kan påvirke responset på vaccination, idet vacciner, der 
indgives under behandling med dette lægemiddel, kan være mindre effektive. </li>
<li>Hvis du tidligere har haft pludselige og livstruende allergiske reaktioner (anafylaktiske 
reaktioner) over for soja eller jordnødder, må du ikke få dette lægemiddel. </li>
</ul>
<p>Dette lægemiddel kan øge kaliumniveauet i blodet, hvilket kan være alvorligt og kræve behandling. 
Lægen vil regelmæssigt kontrollere dit kaliumniveau under behandlingen. </p>
<p>Dette lægemiddel er ikke undersøgt hos patienter med alvorlige leverproblemer og anbefales derfor 
ikke til disse patienter. </p>
<p>Dette lægemiddel kan påvirke hjertets elektriske aktivitet (QT-forlængelse). Det kan give alvorlige 
hjerterytmeforstyrrelser. Tidlige symptomer er svimmelhed og besvimelse. </p>
<p>Sollys og UV-lys 
Dette lægemiddel øger risikoen for udvikling af visse typer kræft, navnlig hudkræft. Du skal undgå 
eller begrænse eksponering for sollys og UV-lys ved at gå med tilstrækkeligt beskyttende tøj og sørge 
for hyppig påføring af solcreme med høj beskyttelsesfaktor. </p>
<p>Infektioner 
Dette lægemiddel kan øge risikoen for at udvikle infektioner, herunder alvorlige eller dødelige 
infektioner. Kontakt lægen, hvis du får nogen tegn på infektion, f.eks. feber, kulderystelser eller ondt i 
halsen. Lægen vil vurdere, om du skal holde op med at tage lægemidlet (se pkt. 4). </p>
<p>Børn og unge 
Tag ikke dette lægemiddel, hvis du er under 18 år, da det ikke er undersøgt i denne aldersgruppe. </p>
<p>Ældre 
Dette lægemiddel anbefales ikke, hvis du er over 75 år, da det ikke er undersøgt i denne aldersgruppe. </p>
<p>Brug af anden medicin sammen med Lupkynis 
Sig det til lægen eller apotekspersonalet, hvis du tager, for nylig har taget eller planlægger at tage 
andre lægemidler. </p>
<p>Fortæl det navnlig til lægen, hvis du tager:</p>
<ul>
<li>medicin til behandling af svampeinfektioner, f.eks. itraconazol og fluconazol. </li>
<li>medicin til behandling af Cushings syndrom (når kroppen producerer for meget kortisol), f.eks. 
ketoconazol-tabletter. </li>
<li>medicin til behandling af forhøjet blodtryk eller hjerteproblemer, f.eks. digoxin, diltiazem og 
verapamil. </li>
<li>medicin til forebyggelse af blodpropper, f.eks. dabigatranetexilat. </li>
<li>medicin til behandling af epilepsi, f.eks. carbamazepin og phenobarbital. </li>
<li>naturlægemidler, der indeholder prikbladet perikum (til behandling af let depression). </li>
<li>medicin til lindring af symptomer ved sæsonbestemt høfeber, f.eks. fexofenadin. </li>
<li>antibiotiske lægemidler til behandling af bakterieinfektioner, f.eks. rifampicin, clarithromycin 
og erythromycin. </li>
<li>medicin mod forhøjet kolesterol, f.eks. simvastatin, atorvastatin, rosuvastatin og pravastatin. </li>
<li>medicin til behandling af hiv-infektioner, f.eks. det antiretrovirale lægemiddel efavirenz. </li>
</ul>
<p>Brug af Lupkynis sammen med mad og drikke 
Dette lægemiddel kan tages med eller uden mad. Du må ikke spise grapefrugt og drikke 
grapefrugtjuice under behandlingen med dette lægemiddel, da det kan påvirke lægemidlets virkemåde. </p>
<p>Graviditet, amning og frugtbarhed 
Hvis du er gravid eller ammer, har mistanke om, at du er gravid, eller planlægger at blive gravid, skal 
du spørge din læge til råds, før du tager dette lægemiddel. </p>
<p>Dette lægemiddel bør ikke anvendes under graviditet og hos fødedygtige kvinder, der ikke bruger 
prævention. </p>
<p>Sig det til lægen, hvis du ammer. Det vides ikke, om lægemidlet kan udskilles i modermælk og 
påvirke barnet. Lægen vil drøfte med dig, om du skal standse behandlingen med dette lægemiddel, 
mens du ammer, eller om du skal ophøre med at amme. </p>
<p>Der foreligger ingen data om dette lægemiddels indvirkning på forplantningsevnen hos mennesker. </p>
<p>Trafik- og arbejdssikkerhed 
Lupkynis forventes ikke at påvirke din evne til at føre motorkøretøj og betjene maskiner. </p>
<p>Lupkynis indeholder alkohol 
Dette lægemiddel indeholder 21,6 mg alkohol (ethanol) i hver kapsel. En dosis på 3 kapsler Lupkynis 
indeholder således 64,8 mg ethanol, hvilket svarer til under 2 ml øl eller 1 ml vin. Den lille mængde 
alkohol, der er i dette lægemiddel, vil ikke have nogen mærkbar effekt. </p>
<p>Lupkynis indeholder sorbitol 
...
* section[=].section[+]
  * title =  "3. Sådan skal du tage lupkynis"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "3. Sådan skal du tage lupkynis"
  * text.status = #additional
...
apotekspersonalet. </p>
<p>Den anbefalede dosis Lupkynis er tre kapsler to gange dagligt (tages gennem munden). </p>
<p>Kapslerne skal sluges hele og kan tages med eller uden mad. </p>
<p>Tag de daglige doser på omtrent samme tidspunkt hver dag med mindst 8 timers mellemrum og meget 
gerne med 12 timers mellemrum (så tæt på som muligt, f.eks. kl. 8.00 om morgenen og kl. 20.00 om 
aftenen). </p>
<p>Dette lægemiddel bør tages i kombination med et andet immunsvækkende lægemiddel 
(mycophenolatmofetil). </p>
<p>Hvis du har taget for meget Lupkynis 
Hvis du er kommet til at tage for mange kapsler, skal du øjeblikkeligt kontakte lægen eller tage på 
skadestuen. Symptomer på overdosering kan omfatte hurtig hjerterytme og skælven (ukontrollerede 
rystelser i en eller flere dele af kroppen). </p>
<p>Hvis du har glemt at tage Lupkynis 
Hvis du glemmer en dosis, skal du tage den så hurtigt som muligt, hvis der ikke er gået mere end 
4 timer efter det planlagte tidspunkt for den glemte dosis. Hvis der er gået mere end 4 timer, siden du 
skulle have taget dosen, skal du springe den over og tage den næste planlagte dosis på det sædvanlige 
...
Dette lægemiddel kan give følgende bivirkninger: </p>
<p>Alvorlige bivirkninger </p>
<p>Hvis du får en eller flere af disse bivirkninger, skal du kontakte lægen, som kan råde dig til at ophøre 
med at tage dette lægemiddel eller reducere dosen. </p>
<p>Meget almindelig (kan forekomme hos mere end 1 ud af 10 patienter) 
- Symptomer på infektion (f.eks. feber, ømhed i kroppen, træthed, hoste eller nysen, kvalme, 
opkastning eller diarré) </p>
<p>Almindelig (kan forekomme hos op til 1 ud af 10 patienter) 
- Nyopståede symptomer på nerve- eller hjernepåvirkning, f.eks. krampeanfald </p>
<p>Andre bivirkninger </p>
<p>Meget almindelig (kan forekomme hos mere end 1 ud af 10 patienter) 
- Infektion i de øvre luftveje 
- Nedsat antal røde blodlegemer (kan gøre huden bleg og forårsage svaghed eller åndenød 
(anæmi)) 
- Hovedpine 
- Forhøjet blodtryk 
- Hoste 
- Diarré 
- Mavesmerter 
- Ændret nyrefunktion, hvilket kan betyde nedsat mængde urin samt ny eller forværret hævelse i 
benene eller fødderne </p>
<p>Almindelig (kan forekomme hos op til 1 ud af 10 patienter) 
- Infektioner, der enten skyldes bakterier (f.eks. urinvejsinfektion) eller virus (f.eks. helvedesild) 
- Betændelse i mave-tarm-kanalen 
- Influenza 
- Forhøjet kalium i blodprøver 
- Nedsat appetit 
- Skælven 
- Kvalme 
- Unormal hævelse, blødning og/eller betændelse i tandkødet 
- Fordøjelsesbesvær 
- Hårtab 
- Kraftig og/eller unormal hårvækst et eller flere steder på kroppen </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Lupkynis indeholder:</p>
<ul>
<li>Aktivt stof: voclosporin Hver blød kapsel Lupkynis indeholder 7,9 mg voclosporin. </li>
<li>Øvrige indholdsstoffer: 
Kapselindhold: ethanol, E-vitamin (E307)-polyethylenglycolsuccinat (tocofersolan), polysorbat 
40 og mellemlange triglyceridkæder 
Kapselskal: gelatine, sorbitol, glycerin, renset vand, titandioxid (E171), rød jernoxid (E172), gul 
jernoxid (E172) 
Hjælpestof: sojalecitin </li>
</ul>
<p>Udseende og pakningsstørrelser 
Lupkynis 7,9 mg lyserøde/orange bløde kapsler på ca. 13 × 6 mm pakket i blisterkort. Hvert blisterkort 
indeholder 18 bløde kapsler. Én æske indeholder 180 eller 576 bløde kapsler. 
...
Instance: bundlepackageleaflet-da-41b3735a6e59fac8a0512a47fdc116bd
InstanceOf: BundleUvEpi
Title: "ePI document Bundle for lupkynis Package Leaflet for language da"
Description: "ePI document Bundle for lupkynis Package Leaflet for language da"
Usage: #example
...
RuleSet: 41b3735a6e59fac8a0512a47fdc116bdListRuleset

* identifier.system = "http://ema.europa.eu/identifier" 
* identifier.value = "None"
* identifier[+].system = "http://spor.ema.europa.eu/v2/medicine-name"
* identifier[=].value = "lupkynis"
...
* entry[+]
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-en-41b3735a6e59fac8a0512a47fdc116bd) // lupkynis en
...
* entry[+]
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-da-41b3735a6e59fac8a0512a47fdc116bd) // lupkynis da
  * item.extension[0].url = "http://ema.europa.eu/fhir/extension/documentType"
  * item.extension[=].valueCoding = $100000155531#100000155538 "B. PACKAGE LEAFLET"
  * item.extension[+].url = "http://ema.europa.eu/fhir/extension/language"
