...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Luveris is 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not use Luveris 
* if you are allergic to gonadotropins (such as luteinising hormone, follicle stimulating hormone 
or human chorionic gonadotropin), or any of the other ingredients of this medicine (listed in 
section 6). 
...
origin. 
* if you have unexplained vaginal bleeding. </p>
<p>Do not use Luveris if any of the above applies to you. If you are not sure, talk to your doctor or 
pharmacist before using this medicine. </p>
<p>Warnings and precautions 
Talk to your doctor, pharmacist or nurse before using Luveris. 
You and your partner's fertility should be evaluated before the treatment is started. </p>
<p>It is recommended not to use Luveris if you have any condition that usually makes a normal 
pregnancy impossible, such as ovaries that do not work because of a condition called primary ovarian 
failure, or malformations of sexual organs. </p>
<p>Porphyria 
...
<p>Miscarriage 
When undergoing assisted reproductive technologies or stimulation of your ovaries to produce eggs, 
...
Talk to your doctor before using Luveris if you or a member of your family have ever had blood clots 
in the leg or in the lung, or a heart attack or stroke. You may be at a higher risk of serious blood clots 
or existing clots might become worse with Luveris treatment. </p>
<p>Tumours of sexual organs 
There have been reports of tumours in the ovaries and other sex organs, both benign and malignant, in 
women who have undergone multiple drug regimens for infertility treatment. </p>
<p>Birth defects 
Birth defects after assisted reproductive technologies may be slightly higher than after spontaneous 
conceptions. This could be due to differences in parental factors like maternal age, genetics, as well as 
the assisted reproductive technology procedures and multiple pregnancy. </p>
<p>Children and adolescents 
Luveris is not for use in children and adolescents below 18 years of age. </p>
<p>Other medicines and Luveris 
Tell your doctor or pharmacist if you are taking or have recently taken or might take any other 
medicines. </p>
<p>Do not use Luveris as a mixture with other medicines in the same injection, except for follitropin alfa, 
if prescribed by your doctor. </p>
<p>Pregnancy and breast-feeding 
Do not use Luveris if you are pregnant or breast-feeding. 
...
you during this course of treatment. </p>
<p>More user-friendly presentations are available for self-administration by patients at home. Consult 
your doctor to find out if a more suitable alternative may be available for you. </p>
<p>How much to use 
...
* According to your response, your doctor may increase your dose of FSH by preferably 37.5 to 
75 IU at 7- to 14-day intervals. </p>
...
<li>one syringe, </li>
<li>one reconstitution needle for dissolving the powder in the solvent, </li>
<li>a fine-bore needle for subcutaneous injection, </li>
<li>
<p>a sharps container for safe disposal of glass and needles. </p>
</li>
<li>
<p>Open the ampoule of solvent: On the head of the solvent ampoule, you will see a small 
coloured dot. Directly below it is where the neck of the ampoule has been treated to make it  </p>
</li>
</ul>
<p>easier to break. Gently flick the top section of the ampoule 
so that any fluid in the neck of the ampoule drops into the 
bottom chamber. Now press the ampoule firmly over the 
neck, and break the ampoule away from the coloured dot. 
Carefully place the open ampoule upright on the work-
surface. 
* Draw up the solvent: Attach the reconstitution needle to the syringe, with the syringe in  </p>
<p>one hand, pick up the open ampoule, insert the needle and 
draw up all of the solvent. </p>
<p>Carefully set the syringe down on the work-surface, taking 
care not to touch the needle. 
* Prepare the injection solution: Remove the protective cap from the Luveris powder vial, pick  </p>
<p>up your syringe and slowly inject the solvent into the vial 
of Luveris. Swirl gently without removing the syringe. Do 
not shake. </p>
<ul>
<li>After the powder has dissolved (which usually occurs immediately), check that the resulting  </li>
</ul>
<p>solution is clear and does not contain any particles. Turn 
...
the syringe. Inspect for particles as before, and do not use if the solution is not clear. </p>
<p>Up to 3 containers of powder may be dissolved in 1 mL of solvent. </p>
<ul>
<li>Change the needle for the fine-bore needle and remove any air bubbles: If you see air bubbles </li>
</ul>
<p>in the syringe, hold the syringe with the needle pointing 
...
all the solution. Immediately withdraw the needle 
and clean the skin with an alcohol swab using a 
circular motion. </p>
<p>Dispose of all used items: Once you have finished your injection, immediately discard all needles and 
empty glass containers in the sharps container provided. Any unused solution must be discarded. </p>
...
<p>Contact your doctor straight away if you notice any of the below listed side effects. The doctor 
might ask you to stop using Luveris. </p>
<p>Allergic reaction 
Allergic reactions such as rash, red skin, hives, swelling of your face with difficulty breathing can 
sometimes be serious. This side effect is very rare (may affect up to 1 in 10 000 people). </p>
<p>Ovarian hyperstimulation syndrome (OHSS) 
...
<p>Torsion of the ovary and bleeding into the abdomen have not been reported with Luveris, however, 
there have been rare cases reported following treatment with human menopausal gonadotropin (hMG), 
a urine-derived medication also containing LH. </p>
<p>Ectopic pregnancy (embryo implanted outside the womb) may occur especially in women with a 
history of prior tubal disease. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Luveris contains 
* The active substance is lutropin alfa. One vial of powder for injection contains 75 IU 
(International Units). 
* Lutropin alfa is recombinant human Luteinising Hormone (r-hLH), produced by recombinant 
DNA technology. 
* The other ingredients of the powder are polysorbate 20, sucrose, sodium dihydrogen phosphate 
monohydrate, disodium phosphate dihydrate, concentrated phosphoric acid, sodium hydroxide, 
L-methionine and nitrogen. 
* The solvent is water for injections. </p>
<p>What Luveris looks like and contents of the pack 
* Luveris comes as a powder and solvent for solution for injection. 
* Each vial of powder contains 75 IU of lutropin alfa and each ampoule of solvent contains 1 mL 
of water for injections. 
* Luveris is supplied in packs containing 1, 3 or 10 vials of powder, together with the same 
number of solvent ampoules. </p>
