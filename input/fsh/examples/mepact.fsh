...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>MEPACT contains the active substance mifamurtide, similar to a component of the cell wall of 
...
<li>Non-steroidal-anti-inflammatory drugs (NSAIDs), such as acetylsalicylic acid, ibuprofen, or 
diclofenac, used for treatment of headaches, fever or pain. You must not use MEPACT with 
high doses of NSAIDs. </li>
<li>corticosteroids, used to treat inflammations, allergies or asthma. Regular use of 
corticosteroids should be avoided when using MEPACT as this may affect the way the 
medicine works. </li>
</ul>
<p>It is recommended to separate the times of administration of MEPACT and doxorubicin or other 
medicines if used in the same chemotherapy treatment regimen. </p>
...
pregnancy and in women of childbearing potential not using effective contraception.<br />
You should use effective contraception if you are being treated with MEPACT.  </p>
<p>It is not known whether MEPACT passes to human milk. If you are breast-feeding, you should 
...
not sure. </p>
<p>The recommended dose of MEPACT is 2 mg mifamurtide/m2 body surface area. It will be given to 
you twice a week (at least three days apart) for the first 12 weeks, then once a week for 24 more 
weeks.  </p>
<p>The schedule of your MEPACT treatments can be adjusted to fit with your chemotherapy 
...
(intravenous) over about 1 hour. This is done by your doctor or a nurse, who will also monitor you 
during that time. You do not need to be hospitalised to receive MEPACT. It can also be 
administered as an outpatient. </p>
<p>If you use more MEPACT than you should 
You may experience more severe side effects, including fever, chills, fatigue, nausea, vomiting, 
headache and high blood pressure or low blood pressure. In the event of such an overdose, contact 
your doctor or nearest hospital. </p>
...
administration of MEPACT. These are typically mild to moderate and transient and can usually be 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>MEPACT indeholder det aktive stof mifamurtid, der ligner en komponent i cellevæggen hos visse 
bakterier. Det stimulerer dit immunsystem og hjælper dermed din krop med at dræbe svulstceller. </p>
...
<ul>
<li>hvis du er allergisk (overfølsom) over for mifamurtid eller et af de øvrige indholdsstoffer i </li>
</ul>
<p>MEPACT (angivet i punkt 6). 
...
af anden medicin" nedenfor).  </p>
<p>Advarsler og forsigtighedsregler: 
Kontakt lægen, før du bruger MEPACT:</p>
<ul>
<li>hvis du har eller har haft problemer med dit hjerte eller blodkar som f.eks. blodpropper 
(trombose) eller blødninger eller betændelse i venerne (vaskulitis), skal du overvåges mere 
nøje, mens du bliver behandlet med MEPACT. Hvis symptomerne varer længe eller forværres, 
bør du kontakte lægen, da behandlingen med MEPACT i så tilfælde måske skal udsættes eller 
afbrydes. </li>
<li>hvis du har eller har haft astma eller andre åndedrætssygdomme. Før behandlingen, bør du 
spørge din læge, om du skal tage din astmamedicin, mens du behandles med MEPACT. </li>
<li>hvis du har haft en betændelsesagtig eller autoimmun sygdom eller er blevet behandlet med 
kortikosteroider eller anden medicin, som kan påvirke dit immunsystem. </li>
<li>hvis du har oplevet allergiske reaktioner over for lægemidler, såsom udslæt åndenød og 
forhøjet blodtryk. Hvis du har forværrede symptomer, bør du kontakte din læge, da disse 
symptomer muligvis kan have været forårsaget af MEPACT. </li>
<li>hvis du har problemer med maven, såsom kvalme, opkastninger og manglende appetit. Hvis 
dine problemer forværres, bør du kontakte din læge, da disse kan have været forårsaget af 
MEPACT, når det bruges med kemoterapi. </li>
<li>hvis du har oplevet kuldegysninger, kulderystelser eller føles varm. Du bør tage din 
temperatur, da du kan have feber. Feber med et lavt antal hvide blodlegemer (neutropeni) kan 
være et tegn på alvorlig infektion. </li>
</ul>
<p>Punkt 4 indeholder yderligere oplysninger vedrørende advarsler og forsigtighedsregler relateret til 
eventuelle bivirkninger, der kan indtræde, mens du tager lægemidlet. </p>
<p>Børn 
Det er ikke anbefalet at give dette lægemiddel til børn under 2 år, da der ikke er tilgængelige 
oplysninger om sikkerheden og virkningen af dette lægemiddel i den aldersgruppe.  </p>
<p>Brug af anden medicin sammen med MEPACT 
...
det til din læge, hvis du bruger medicin, der indeholder en eller flere af følgende aktive stoffer:</p>
<ul>
<li>ciclosporin eller tacrolimus, som bruges efter transplantationer for at forhindre, at de 
transplanterede organer afstødes, eller andre immunsuppressive stoffer, som f.eks. bruges til at 
behandle hudsygdommen psoriasis. </li>
<li>non-steroide antiinflammatoriske lægemidler (NSAID = non-steroidal-anti-inflammatory 
...
typer medicin. </li>
<li>kortikosteroider, der bruges til behandling af betændelse, allergier eller astma. Du må ikke få 
MEPACT samtidig med regelmæssig brug af kortikosteroider, da dette kan påvirke den måde, 
medicinen virker. </li>
</ul>
<p>Det anbefales at give MEPACT, doxorubicin eller andre typer medicin, der anvendes i samme 
kemoterapibehandling på forskellige tidspunkter. </p>
<p>Graviditet, amning og frugtbarhed 
Hvis du er gravid eller ammer, har mistanke om, at du er gravid, eller planlægger at blive gravid, 
skal du spørge din læge til råds, inden du bruger dette lægemiddel.<br />
MEPACT er ikke blevet undersøgt til gravide kvinder. Derfor må hverken gravide eller kvinder i 
den fødedygtige alder, der ikke bruger sikker prævention, behandles med MEPACT.<br />
Hvis du behandles med MEPACT, skal du bruge sikker prævention. </p>
<p>Man ved ikke, om MEPACT udskilles i modermælk. Hvis du ammer, skal du tale med lægen. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Dosis og behandlingsvarighed 
MEPACT vil kun indgives under overvågning af en speciallæge. Brug altid dette lægemiddel 
nøjagtigt, som din læge har fortalt dig. Spørg din læge, hvis du ikke er sikker.   </p>
<p>Den anbefalede dosis af MEPACT er 2 mg mifamurtid/m2 legemsoverfladeareal. Du skal 
behandles med MEPACT to gange om ugen (med mindst tre dages mellemrum) i de første 
12 uger, derefter én gang om ugen i yderligere 24 uger. </p>
<p>Doseringsplanen kan justeres, så den passer med dine kemoterapibehandlinger. Det er ikke 
nødvendigt at afbryde behandlingen med MEPACT, hvis din kemoterapi udsættes; du skal 
gennemføre 36 ugers (9 måneders) behandling med MEPACT uden afbrydelse. </p>
<p>Sådan bliver du behandlet med MEPACT 
...
<p>Hvis du har brugt for meget MEPACT 
...
<p>De fleste patienter oplever kuldegysninger, feber og træthed, specielt efter første behandling med 
MEPACT. Disse er typisk lette til moderate og forbigående, og de kan som regel behandles af din 
læge, f.eks. med Paracetamol til feber.<br />
Behandling med MEPACT kan ofte give maveproblemer, såsom kvalme, opkastning og 
manglende appetit, når det anvendes sammen med kemoterapi. </p>
<p>Kontakt straks din læge:</p>
<ul>
<li>hvis du har feber eller kuldegysninger, som fortsætter i mere end 8 timer efter din 
behandling med MEPACT. Dette kan være tegn på en infektion, eller </li>
<li>hvis du får udslæt eller problemer med vejrtrækningen (hvæsende åndedræt). </li>
<li>hvis du får maveproblemer. </li>
</ul>
<p>Meget almindelige bivirkninger (kan forekomme hos mere end 1 ud af 10 behandlede):</p>
<ul>
<li>feber, rysten/kulderystelser, svaghed, træthed eller almindeligt ubehag </li>
...
<li>smerte, herunder generel smerte, smerter i muskler og/eller led og smerte i ryg, bryst, mave, 
arme eller ben </li>
...
<ul>
<li>blåfarvet væv i f.eks. hud eller gummer på grund af for lidt ilt </li>
...
<li>rødme, hævelse, infektion på indsprøjtnings- eller kateterstedet eller anden lokal reaktion </li>
<li>udslæt eller rødme, betændelse i huden, kløe, tør hud, blegt eller forbigående rødligt 
udseende </li>
<li>betændelse i hud, sener, muskler eller lignende væv, der understøtter kropsstrukturen </li>
<li>betændelse i en vene </li>
<li>smerter i øverste del af mave eller brystvæg, oppustet mave eller smerter i maven, 
fordøjelsesbesvær eller leversmerter </li>
<li>anden smerte, herunder i hals, nakke, skulder, lysken, knoglesmerter eller halssmerter, 
smerter som efter en operation </li>
<li>muskelkramper eller stivhed </li>
<li>kuldefølelse </li>
<li>træthedfølelse, døsighed eller søvnighed </li>
<li>brænden, prikkende/snurrende følelse, nedsat følesans eller sådanne følelser uden 
stimulation </li>
...
<li>infektioner i de øvre luftveje (som f.eks. en forkølelse) eller urinvejene (som f.eks. en 
blærebetændelse) </li>
<li>generel infektion </li>
<li>forkølelsessår </li>
<li>hoste med slim, hvæsende vejrtrækning eller besværet vejrtrækning ved anstrengelse </li>
<li>blodigt spyt eller næseblod </li>
<li>væske i lungehulrummet </li>
<li>blod i urinen, vanskelighed eller smerter ved vandladning eller hyppig vandladning </li>
...
<li>høretab </li>
<li>et lavt antal hvide blodlegemer med eller uden feber, lavt antal blodplader </li>
</ul>
<p>Ikke kendt(kan ikke beregnes ud fra tilgængelige data): 
kan ikke estimeres ud fra forhåndenværende data 
- unormal ophobning af væske omkring hjertet (perikardieekssudat) </p>
...
<ul>
<li>Aktivt stof: mifamurtid. Hvert hætteglas indeholder 4 mg mifamurtid. Efter blanding 
indeholder hver ml opløsning 0,08 mg mifamurtid. </li>
<li>Øvrige indholdsstoffer: 1-Palmitoyl-2-oleoyl-sn-glycero-3-phosphocholine (POPC) og 
1,2-Dioleoyl-sn-glycero-3-phospho-L-serine mononatriumsalt (OOPS), se pkt. 2 Mepact 
indeholder natrium". </li>
</ul>
<p>Udseende og pakningsstørrelser 
MEPACT er et hvidt eller off-white ensartet pulver til koncentrat til infusionsvæske, dispersion. </p>
<p>MEPACT leveres i en pakning, der indeholder </p>
<ul>
<li>
<p>et 50 ml glashætteglas med en grå butylprop, aluminiumshætte og plastik-afrivningshætte </p>
</li>
<li>
<p>et sterilt filter i en blisterpakning til MEPACT  </p>
</li>
</ul>
...
<p>Materialer leveret i hver pakke - * 1 hætteglas MEPACT (mifamurtid) </p>
<ul>
<li>1 filter til MEPACT </li>
</ul>
<p>Nødvendige materialer, som ikke leveres - * Natriumklorid 9 mg/ml (0,9 %) opløsning til injektion, 100 ml pose </p>
<ul>
<li>
<p>1 steril engangs-luerlock-sprøjte til 60 eller 100 ml </p>
</li>
<li>
<p>2 mellemstore (18)-gauge sterile kanyler til injektion </p>
</li>
</ul>
<p>Det anbefales, at den liposomale suspension blandes i et stinkskab/kabine med laminar-flow 
(LAF) med sterile handsker og under aseptiske forhold. </p>
<p>Det frysetørrede pulver bør inden opløsning, filtrering og fortynding nå en temperatur på mellem 
ca. 20 C - 25 °C. Dette burde vare ca. 30 minutter.  </p>
<ol>
...
<p>Indfør derefter spidsen i hætteglassets skillevæg, indtil den sidder fast. Fjern ikke 
filter-luerlock-forbindelseslåget på dette tidspunkt. 
3. Pak 100 ml natriumklorid 9 mg/ml (0,9 %) opløsning til injektionsposen, kanyle og sprøjte 
ud (følger ikke med pakken). 
4. Rens det sted på posen med den 100 ml natriumklorid 9 mg/ml (0,9 %) injektionsopløsning, 
hvor kanylen skal indføres med en spritpude. 
5. Ved hjælp af kanylen og sprøjten trækkes injektionsopløsningen med 50 ml natriumklorid 
9 mg/ml (0,9 %) ud af posen. 
6. Efter kanylen er fjernet fra sprøjten, fastgøres sprøjten til filteret ved at åbne 
luerlock-forbindelseshætten til filteret (figur 1). </p>
<p>Figur 1 </p>
<ol>
<li>Den 9 mg/ml (0,9 %) injektionsopløsning af natriumklorid føjes til hætteglasset ved at 
trykke sprøjtens stempel ned med en langsom, fast bevægelse. Filteret og sprøjten må ikke 
fjernes fra hætteglasset. </li>
<li>Hætteglasset skal have lov til at stå uforstyrret i 1 minut for at sikre grundig hydrering af det 
tørre stof. </li>
<li>Hætteglasset skal derefter rystes kraftigt i 1 minut, mens filteret og sprøjten sidder 
fast. I løbet af denne tid dannes liposomerne spontant (figur 2). </li>
</ol>
<p>Figur 2 </p>
<ol>
<li>Den ønskede dosis kan herefter trækkes ud af hætteglasset ved at vende glasset om og 
...
<p>Figur 3 </p>
<ol>
<li>Sprøjten fjernes derefter fra filteret, og en ny kanyle sættes på sprøjten, som er fyldt med 
...
<li>Kemisk og fysisk stabilitet under brug er blevet påvist i 6 timer ved stuetemperatur (mellem 
ca. 20 C - 25 °C).  </li>
<li>Fra et mikrobiologisk synspunkt bør produktet anvendes øjeblikkeligt. Hvis det ikke 
