...
Instance: composition-en-2a9a5e18ea12db555fa903817024b9fe
...
* identifier.value = "EU/1/97/051/001-002"
* status = #final
...
<ol>
<li>What MIRAPEXIN is and what it is used for</li>
<li>What you need to know before you take MIRAPEXIN</li>
<li>How to take MIRAPEXIN</li>
...
* section[=].section[+]
  * title =  "1. What mirapexin is and what it is used for"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text =  "1. What mirapexin is and what it is used for"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>MIRAPEXIN contains the active substance pramipexole and belongs to a group of medicines known 
...
* section[=].section[+]
  * title = "2. What you need to know before you take mirapexin"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "2. What you need to know before you take mirapexin"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <h2>Do not take MIRAPEXIN</h2>
<p>if you are allergic to pramipexole or to any of the other ingredients of this medicine (listed in
section 6).
...
regularly, especially at the beginning of treatment. This is to avoid postural hypotension (a fall in 
blood pressure on standing up).
-
Restless legs augmentation syndrome. If you experience that symptoms start earlier than usual in 
the evening (or even the afternoon), are more intense or involve larger parts of the affected limbs 
or involve other limbs. Your doctor may lower your dose or stop the treatment.
...
pain after stopping or reducing your MIRAPEXIN treatment. If the problems persist more than a few 
weeks, your doctor may need to adjust your treatment.
Tell your doctor if you are developing an inability of keeping your body and neck straight and upright 
(axial dystonia). If this happens, your doctor may want to adjust or change your medication.
...
should continue to take MIRAPEXIN.
The effect of MIRAPEXIN on the unborn child is not known. Therefore, do not take MIRAPEXIN if 
you are pregnant unless your doctor tells you to do so.
MIRAPEXIN should not be used during breast-feeding. MIRAPEXIN can reduce the production of 
breast milk. Also, it can pass into the breast milk and can reach your baby. If use of MIRAPEXIN is 
unavoidable, breast-feeding should be stopped.
Ask your doctor or pharmacist for advice before taking any medicine.
Driving and using machines
MIRAPEXIN can cause hallucinations (seeing, hearing or feeling things that are not there). If affected, 
...
* section[=].section[+]
  ...
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "3. How to take mirapexin"
  * text.status = #additional
...
During the first week, the usual dose is 1 tablet MIRAPEXIN 0.088 mg three times a day (equivalent 
to 0.264 mg daily):
1st week
Number of tablets
...
pramipexole a day. A lower maintenance dose of three MIRAPEXIN 0.088 mg tablets a day is also 
possible.
...
usual starting dose is 1 tablet MIRAPEXIN 0.088 mg twice a day. In severe kidney disease, the usual 
starting dose is just 1 tablet MIRAPEXIN 0.088 mg a day.
Restless Legs Syndrome
The dose is usually taken once a day, in the evening, 2-3 hours before bedtime.
During the first week, the usual dose is 1 tablet MIRAPEXIN 0.088 mg once a day (equivalent to 
0.088 mg daily):
1st week
Number of tablets
...
Total daily 
dose (mg)
0.0.0.The daily dose should not exceed 6 tablets MIRAPEXIN 0.088 mg or a dose of 0.54 mg (0.75 mg 
pramipexole salt).
If you stop taking your tablets for more than a few days and want to restart the treatment, you must 
...
Do not stop taking MIRAPEXIN without first talking to your doctor. If you have to stop taking this 
medicine, your doctor will reduce the dose gradually. This reduces the risk of worsening symptoms.
If you suffer from Parkinson s disease you should not stop treatment with MIRAPEXIN abruptly. A 
sudden stop could cause you to develop a medical condition called neuroleptic malignant syndrome 
...
of these side effects is based on the following frequencies:
Very common
...
Not known:
-
After stopping or reducing your MIRAPEXIN treatment: Depression, apathy, anxiety, fatigue, 
...
Nausea (sickness)
-
Symptoms that start earlier than usual, are more intense or involve other limbs (Restless legs
...
Delirium (decreased awareness, confusion, loss of reality)* Not known:
-
After stopping or reducing your MIRAPEXIN treatment: Depression, apathy, anxiety, fatigue, 
sweating or pain may occur (called dopamine agonist withdrawal syndrome or DAWS).
...
* section[=].section[+]
  ...
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "5. How to store mirapexin"
  * text.status = #additional
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What MIRAPEXIN contains
...
The other ingredients are mannitol, maize starch, anhydrous colloidal silica, povidone K 25 and
magnesium stearate.
...
MIRAPEXIN 0.18 mg tablets and MIRAPEXIN 0.35 mg tablets are white, of oval shape, and flat. 
Tablets are scored on both sides and breakable in halves.
MIRAPEXIN 0.7 mg tablets are white, of round shape, and flat. Tablets are scored on both sides and 
breakable in halves.
All tablets have the Boehringer Ingelheim company symbol embossed on one side and the codes P6, 
P7, P8, or P9 on the other side, representing the tablet strengths 0.088 mg, 0.18 mg, 0.35 mg, and
0.7 mg, respectively.
All strengths of MIRAPEXIN are available in aluminium blister strips of 10 tablets per strip, in 
...
Instance: composition-da-2a9a5e18ea12db555fa903817024b9fe
InstanceOf: CompositionUvEpi
Title: "Composition for mirapexin Package Leaflet"
Description:  "Composition for mirapexin Package Leaflet"
Usage: #inline
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Mirapexin indeholder det aktive stof pramipexol, og tilhører en gruppe lægemidler, der kaldes 
...
* section[=].section[+]
  ...
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "2. Det skal du vide, før du begynder at tage  mirapexin"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <h2>Tag ikke Mirapexin</h2>
<p>hvis du er allergisk over for pramipexol eller et af de øvrige indholdsstoffer i Mirapexin
(angivet i punkt 6).
Advarsler og forsigtighedsregler
Kontakt lægen, før du tager Mirapexin. Fortæl det til din læge, hvis du har eller har haft eller udvikler 
...
være risiko for udvikling af dyskinesi, når Mirapexin-dosis øges

...

Synsnedsættelse. Så længe du er i behandling med Mirapexin, anbefales det at få øjnene 
...
smerter, efter at du er stoppet med eller har nedsat dosis i din Mirapexin-behandling. Hvis problemet 
...
Mirapexin-depottabletter er specialfremstillede tabletter, hvor det aktive stof langsomt frigives efter 
...
Brug af andre lægemidler sammen med Mirapexin
...
Du bør undgå at tage medicin mod psykiske lidelser (antipsykotika) sammen med Mirapexin.
...
Hvis du tager levodopa, anbefales det at nedsætte dosis, når du starter behandling med Mirapexin.
Vær forsigtig, hvis du tager beroligende medicin eller drikker alkohol, da Mirapexin kan påvirke din 
evne til at føre motorkøretøj og betjene maskiner.
Brug af Mirapexin sammen med mad, drikke og alkohol
Ved behandling med Mirapexin, skal du være forsigtig med indtagelse af alkohol.
Mirapexin kan enten tages sammen med mad eller alene.
Graviditet og amning
Hvis du er gravid eller ammer, har mistanke om, at du er gravid, eller planlægger at blive gravid, skal 
du spørge din læge til råds, før du tager dette lægemiddel. Din læge vil tale med dig, om du skal 
fortsætte med at tage Mirapexin.
Det er ukendt, hvilken virkning Mirapexin kan have på det ufødte barn. Derfor må du ikke tage 
Mirapexin, hvis du er gravid, medmindre din læge anbefaler dig at gøre det.
Mirapexin må ikke anvendes under amning. Mirapexin kan nedsætte mælkeproduktionen og kan også 
overføres til din baby via brystmælk. Hvis du ikke kan undvære Mirapexin, bør amningen stoppe.
Spørg din læge eller apotekspersonalet til råds, før du tager nogen form for medicin.
Trafik- og arbejdssikkerhed
Mirapexin kan give hallucinationer (du ser, hører eller føler ting, der ikke er der). Hvis du påvirkes af 
...
* section[=].section[+]
  ...
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "3. Sådan skal du tage mirapexin"
  * text.status = #additional
...
Mirapexin-depottabletter skal tages en gang daglig, og hver dag på ca. det samme tidspunkt.
Mirapexin-tabletter bør synkes hele med vand, og kan både tages sammen med eller uden mad.
...
lavere vedligeholdelsesdosis på 1 Mirapexin 0,26 mg depottablet/dag er også mulig.
...
Hvis du skifter fra Mirapexin-tabletter med hurtig udløsning (dine almindelig tabletter)
Din læge vil basere din dosis af Mirapexin-depottabletter på den dosis af Mirapexin-tabletter med 
hurtig udløsning, som du hidtil har taget.
Tag dine Mirapexin-tabletter med hurtig udløsning som normalt dagen før, du skifter. Tag Mirapexin-
depottabletter den næste morgen, og tag så ikke flere Mirapexin-tabletter med hurtig udløsning.
Hvis du har taget for meget Mirapexin
...
Hvis du har glemt at tage en Mirapexin dosis, men kommer i tanke om det inden for 12 timer fra det 
...
Du må ikke holde op med at tage Mirapexin uden først at tale med din læge. Hvis det er nødvendigt at 
...
Hvis du har Parkinsons sygdom, bør du ikke stoppe behandlingen med Mirapexin pludseligt, da det 
kan medføre en sygelig tilstand kaldet malignt neuroleptikasyndrom, der kan udgøre en alvorlig 
...
Uhensigtsmæssig udskillelse af antidiuretisk hormon</em> 84

Rastløshed

Dyspnø (åndenød)
...
Ikke kendt:
-
Efter at du er stoppet med eller har nedsat din Mirapexin-behandling: Depression, apati, angst, 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Mirapexin indeholder:
...
Alle styrker af Mirapexin findes i -blisterstrips af aluminium med 10 tabletter pr. strip. Hver æske
...
Instance: composition-pt-2a9a5e18ea12db555fa903817024b9fe
InstanceOf: CompositionUvEpi
Title: "Composition for mirapexin Package Leaflet"
Description:  "Composition for mirapexin Package Leaflet"
Usage: #inline
...
2. O que precisa de saber antes de tomar MIRAPEXIN
...
* section[=].section[+]
  * title =  "1. O que é mirapexin e para que é utilizado"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text =  "1. O que é mirapexin e para que é utilizado"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>MIRAPEXIN contém a substância ativa pramipexol e pertence ao grupo de fármacos denominados 
...
* section[=].section[+]
  * title = "2. O que precisa de saber antes de tomar mirapexin"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "2. O que precisa de saber antes de tomar mirapexin"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <h2>
Se sofre de doença de Parkinson não deverá interromper o tratamento com MIRAPEXIN
abruptamente. A interrupção súbita pode levar ao desenvolvimento de uma afeção clínica conhecida 
como síndrome neuroléptica maligna, a qual poderá representar um risco maior para a saúde. Os 
sintomas incluem:
-
...
Se parar ou reduzir MIRAPEXIN também poderá desenvolver uma afeção médica denominada 
...
Desconhecido:
-
Depois de parar ou reduzir o seu tratamento com MIRAPEXIN podem ocorrer: depressão, 
apatia, ansiedade, fadiga, transpiração ou dor (chamada síndrome de abstinência dos agonistas 
da dopamina ou SAAD).
...
Soluços
-
Pneumonia (infeção dos pulmões)<em> 75
-
Incapacidade de resistir ao impulso, apelo ou tentação de realizar certas atividades que o 
poderiam prejudicar a si ou aos outros, que podem incluir:
-
...
* section[=].section[+]
  ...
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "5. Como conservar mirapexin"
  * text.status = #additional
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Qual a composição de MIRAPEXIN
...
MIRAPEXIN 0,088 mg comprimidos são brancos, de forma redonda, com superfície plana e sem 
ranhura.
MIRAPEXIN 0,18 mg comprimidos e MIRAPEXIN 0,35 mg comprimidos são brancos, de forma oval 
e com superfície plana. Os comprimidos contêm uma ranhura em ambos os lados que permite a sua 
divisão.
MIRAPEXIN 0,7 mg comprimidos são brancos, de forma redonda e com superfície plana. Os 
comprimidos contêm uma ranhura em ambos os lados que permite a sua divisão.
...
respetivamente.
Todas as dosagens de MIRAPEXIN estão disponíveis em fitas contentoras de blisters de alumínio com 
...
Instance: bundlepackageleaflet-en-2a9a5e18ea12db555fa903817024b9fe
InstanceOf: BundleUvEpi
Title: "ePI document Bundle for mirapexin Package Leaflet for language en"
Description: "ePI document Bundle for mirapexin Package Leaflet for language en"
Usage: #example
...
// Composition
* entry[0].fullUrl = "Composition/composition-en-2a9a5e18ea12db555fa903817024b9fe"
* entry[0].resource = composition-en-2a9a5e18ea12db555fa903817024b9fe

// MPD
* entry[+].fullUrl = "MedicinalProductDefinition/mp2a9a5e18ea12db555fa903817024b9fe"
* entry[=].resource = mp2a9a5e18ea12db555fa903817024b9fe
                            
                    
Instance: bundlepackageleaflet-da-2a9a5e18ea12db555fa903817024b9fe
InstanceOf: BundleUvEpi
Title: "ePI document Bundle for mirapexin Package Leaflet for language da"
Description: "ePI document Bundle for mirapexin Package Leaflet for language da"
Usage: #example
...
// Composition
* entry[0].fullUrl = "Composition/composition-da-2a9a5e18ea12db555fa903817024b9fe"
* entry[0].resource = composition-da-2a9a5e18ea12db555fa903817024b9fe
...
Instance: bundlepackageleaflet-pt-2a9a5e18ea12db555fa903817024b9fe
InstanceOf: BundleUvEpi
Title: "ePI document Bundle for mirapexin Package Leaflet for language pt"
Description: "ePI document Bundle for mirapexin Package Leaflet for language pt"
Usage: #example
...
// Composition
* entry[0].fullUrl = "Composition/composition-pt-2a9a5e18ea12db555fa903817024b9fe"
* entry[0].resource = composition-pt-2a9a5e18ea12db555fa903817024b9fe
...
Instance: mp2a9a5e18ea12db555fa903817024b9fe
InstanceOf: MedicinalProductDefinitionUvEpi
Title: "Medicinal Product MIRAPEXIN 0.088 mg tablets"
Description: "MIRAPEXIN 0.088 mg tablets"
Usage: #inline
...
RuleSet: 2a9a5e18ea12db555fa903817024b9feListRuleset

* identifier.system = "http://ema.europa.eu/identifier" 
* identifier.value = "None"
* identifier[+].system = "http://spor.ema.europa.eu/v2/medicine-name"
* identifier[=].value = "mirapexin"
...
* entry[+]
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-en-2a9a5e18ea12db555fa903817024b9fe) // mirapexin en
...
* entry[+]
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-da-2a9a5e18ea12db555fa903817024b9fe) // mirapexin da
  * item.extension[0].url = "http://ema.europa.eu/fhir/extension/documentType"
  * item.extension[=].valueCoding = $100000155531#100000155538 "B. PACKAGE LEAFLET"
  * item.extension[+].url = "http://ema.europa.eu/fhir/extension/language"
...
* entry[+]
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-pt-2a9a5e18ea12db555fa903817024b9fe) // mirapexin pt
  * item.extension[0].url = "http://ema.europa.eu/fhir/extension/documentType"
  * item.extension[=].valueCoding = $100000155531#100000155538 "B. PACKAGE LEAFLET"
  * item.extension[+].url = "http://ema.europa.eu/fhir/extension/language"
