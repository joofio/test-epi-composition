...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Mixtard is human insulin with both a fast-acting and a long-acting effect.  </p>
<p>Mixtard is used to reduce the high blood sugar level in patients with diabetes mellitus (diabetes). 
...
<p>If any of these apply, do not use Mixtard. Talk to your doctor, pharmacist or nurse for advice. </p>
...
<p>Mixtard Penfill is only suitable for injecting under the skin using a reusable pen. Speak to your 
...
for advice before taking this medicine. Mixtard can be used during pregnancy. Your insulin 
...
<p>There are no restrictions on treatment with Mixtard during breast-feeding. </p>
...
<p>Mixtard is administered by injection under the skin (subcutaneously). You must never inject yourself 
directly into a vein (intravenously) or muscle (intramuscularly). Mixtard Penfill is only suitable for 
...
<p>Mixtard Penfill cartridges are designed to be used with Novo Nordisk insulin delivery systems 
and NovoFine or NovoTwist needles. </p>
<p>If you are treated with Mixtard Penfill and another insulin Penfill cartridge, you should use two 
...
instructions. </p>
<p>Every time you use a new Mixtard Penfill (before you put the cartridge into the insulin 
delivery system). 
...
<p>After each injection, be sure to remove and discard the needle and store Mixtard without the 
...
* Drink alcohol, see Mixtard with alcohol in section 2. Signs of low blood sugar: Cold sweat; cool pale skin; headache; rapid heartbeat; feeling sick; feeling 
...
<p>Serious allergic reaction to Mixtard or one of its ingredients (called a systemic allergic reaction) is a 
...
<p>The active substance is human insulin. Mixtard is a mixture consisting of 30% soluble human 
insulin and 70% isophane human insulin. Each ml contains 100 IU of human insulin. Each 
cartridge contains 300 IU of human insulin in 3 ml suspension for injection. </p>
...
<p>Mixtard is presented as a suspension for injection. After resuspension, the liquid should appear 
...
<p>Mixtard 30 InnoLet 100 IU/ml (international units/ml) suspension for injection in pre-filled pen 
human insulin </p>
...
<p>► 
Hvis du er allergisk over for humant insulin eller et af de øvrige indholdsstoffer i Mixtard, se under 
punkt 6. ► 
...
<p>Hvis noget af ovenstående gør sig gældende, må du ikke bruge Mixtard. Tal med din læge, 
...
► 
Nåle og Mixtard Penfill må ikke deles med andre. 
► 
Mixtard Penfill er kun egnet til indsprøjtning under huden ved hjælp af en genanvendelig pen. Tal 
med lægen, hvis du har behov for at indsprøjte din insulin på en anden måde. </p>
...
skal du spørge din læge til råds, før du tager dette lægemiddel. Mixtard kan anvendes under 
...
helbred.<br />
► 
Der er ingen begrænsninger ved behandling med Mixtard under amning. </p>
...
<p>Mixtard administreres ved injektion under huden (subkutant). Du må aldrig selv injicere direkte i en vene 
(intravenøst) eller muskel (intramuskulært). Mixtard Penfill er kun egnet til indsprøjtning under huden ved 
...
► 
Mixtard Penfill cylinderampuller er beregnet til anvendelse sammen med Novo Nordisk 
insulindispenseringssystemer og NovoFine eller NovoTwist engangsnåle. 
► 
Hvis du behandles med Mixtard Penfill og en anden insulin Penfill cylinderampul, skal du anvende 
to insulindispenseringssystemer, ét system til hver insulintype. 
► 
...
<p>► 
Hver gang du bruger en ny Mixtard Penfill (før du monterer cylinderampullen i 
...
► 
Husk at fjerne og kassere nålen efter hver injektion, og opbevar Mixtard uden nålen påsat. Ellers 
...
<li>
<p>Drikker alkohol, se Brug af Mixtard sammen med alkohol under punkt 2. Tegn på lavt blodsukker: Koldsved, kold bleg hud, hovedpine, hjertebanken, kvalme, usædvanlig stor 
...
<p>Alvorlige allergiske reaktioner over for Mixtard eller et af indholdsstofferne (kaldet systemisk allergisk 
reaktion) er en meget sjælden bivirkning, men den kan være livstruende. Kan forekomme hos færre end 1 
ud af 10.000 behandlede. </p>
...
Symptomer på allergi: Lokale allergiske reaktioner (smerte, rødme, nældefeber (udslæt), inflammation 
...
<ul>
<li>Aktivt stof: Humant insulin. Mixtard er en blanding bestående af 30% opløseligt humant insulin og 
70% humant isophaninsulin. 1 ml indeholder 100 IE humant insulin. Hver cylinderampul 
...
<p>Mixtard er en injektionsvæske, suspension. Efter opblanding skal injektionsvæsken fremstå ensartet hvid 
og uklar. 
...
<p>Mixtard 30 InnoLet 100 IE/ml (internationale enheder/ml) injektionsvæske, suspension i fyldt pen 
humant insulin </p>
...
* identifier[+].system = "http://ema.europa.eu/identifier"
* identifier[=].value = "Mixtard 30 vial (40 international units/ml)"
