...
* identifier.value = "EU/1/18/1277/001"
* status = #final
...
<ol>
<li>What MYLOTARG is and what it is used for </li>
<li>What you need to know before you are given MYLOTARG </li>
<li>How MYLOTARG will be given </li>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>MYLOTARG should not be given if you:  </p>
<p>are allergic to gemtuzumab ozogamicin or any of the other ingredients of this medicine (listed in 
section 6). </p>
...
regular basis. </p>
<p>anaemia: have headaches, feel tired, experience dizziness, or look pale . </p>
<p>infusion reaction: experience during or shortly after MYLOTARG infusion symptoms such as 
...
<p>Bleeding (signs of a low number of blood cells known as platelets) 
...
<p>Infections (signs of a low number of white blood cells known as neutrophils) 
Some infections may be serious and can be due to viruses, bacteria, or other causes that may be 
life-threatening. </p>
<p>Complication known as tumour lysis syndrome 
...
<p>Infections (including serious infections) </p>
<p>Reduced number of blood platelets (cells that help blood to clot) </p>
<p>Reduced number of white blood cells which may result in general weakness and a tendency to 
develop infections </p>
<p>Reduced number of red blood cells (anaemia) which may result in fatigue and shortness of breath </p>
...
<p>Constipation </p>
<p>Abnormalities in liver blood tests (which can be indicators of liver injury) </p>
<p>Skin rash </p>
<p>Fever </p>
<p>Oedema (excess fluid in body tissue, causing swelling of the hands and feet) </p>
<p>Fatigue </p>
<p>Chills </p>
<p>Changes in the levels of different enzymes in the blood (may show in your blood tests) </p>
<p>Prolonged clotting time (which may result in prolonged bleeding)   </p>
<p>High level of uric acid in the blood </p>
<p>Common (may affect up to 1 in 10 people): </p>
<p>Signs of an infusion reaction, such as a rash, shortness of breath, difficulty breathing, a tight chest, 
chills or fever, back pain during or after MYLOTARG infusion </p>
<p>Signs of an enlarged liver (hepatomegaly), such as an enlarged belly </p>
<p>Abnormal liver function  </p>
<p>Excessive accumulation of fluid in the abdomen/stomach </p>
<p>Indigestion </p>
<p>Inflammation of the oesophagus (swallowing tube) </p>
<p>Liver venoocclusive disease (VOD), which includes signs of enlarged liver, pain in the upper right 
belly, yellowing of the skin and the whites of the eyes, accumulation of fluid in the abdomen, weight 
gain, abnormal liver blood tests  </p>
<p>Yellowing of the skin or whites of the eyes caused by liver or blood problems (jaundice) </p>
<p>Redness of the skin </p>
<p>Itchy skin </p>
<p>Organ failure </p>
<p>Uncommon (may affect up to 1 in 100 people): </p>
<p>Liver failure  </p>
<p>Budd-Chiari syndrome, which includes pain in the upper right part of the belly, an abnormally large 
...
<p>Frequency unknown (frequency cannot be estimated from the available data): </p>
<p>Interstitial pneumonia (inflammation of the lungs causing coughing and difficulty breathing) </p>
<p>Inflammation of the bowel in association with low white blood cell counts </p>
<p>Inflammation of the urinary bladder resulting in bleeding from the bladder </p>
...
<p>Following reconstitution, the original vial may be stored up to 16 hours in a refrigerator (2 C 8 C) 
or up to 3 hours at room temperature (below 30 C). </p>
<p>The diluted solution may be stored up to 18 hours in a refrigerator (2 C 8 C) and up to 6 hours at 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What MYLOTARG contains  </p>
<p>The active substance is gemtuzumab ozogamicin.  </p>
<p>One vial contains 5 mg gemtuzumab ozogamicin. </p>
<p>After reconstitution, each ml of the concentrated solution contains 1 mg gemtuzumab ozogamicin. </p>
<p>The other ingredients are dextran 40, sucrose, sodium chloride, sodium dihydrogen phosphate 
...
Instance: composition-da-7cf956e7748c0ba411215481856f48ab
InstanceOf: CompositionUvEpi
Title: "Composition for mylotarg Package Leaflet"
Description:  "Composition for mylotarg Package Leaflet"
Usage: #inline
...
2. Det skal du vide, før du begynder at få MYLOTARG
...
bliver overført til kræftcellerne af det monoklonale antistof. Et monoklonalt antistof er et protein, der 
...

er allergisk over for gemtuzumab ozogamicin eller et af de øvrige indholdsstoffer (angivet i 
afsnit 6).
Advarsler og forsigtighedsregler 
Første gang du får dette lægemiddel og under behandlingsforløbet, bør du fortælle din læge, hvis du:
 har eller har haft leverproblemer: MYLOTARG kan under eller efter behandlingen, forårsage 
en potentiel livstruende tilstand hvor blodårerne i leveren beskadiges og blokeres af 
blodpropper. Dette kaldes veno-okklusiv leversygdom med symptomer som væskeansamling, 
brat vægtøgning, forstørret lever (hvilket kan være smertefuldt) og ophobning af væske i 
bughulen. 
 allergisk reaktion: oplever en højlydt hvæsende lyd ved vejrtrækning, besværet vejrtrækning, 
åndenød eller hoste med eller uden slim, høfeber, kløe, hævelse eller feberfølelse og 
kuldegysninger (tegn på en reaktion som skyldes infusionen) under eller kort efter infusion med 
MYLOTARG.
 infektion: har eller mener, du har en infektion, får kuldegysninger eller skælven, føler dig varm 
eller har feber. Visse infektioner kan være alvorlige og livstruende.
37
 blødning: har unormal blødning, blødende tandkød, let ved at få blå mærker eller 
tilbagevendende næseblod.
 Blodmangel: får hovedpine, bliver træt, svimmel eller ser bleg ud.
 infusionsreaktion: oplever symptomer, under eller kort efter infusion med MYLOTARG, 
såsom svimmelhed, nedsat vandladning, forvirring, opkastning, kvalme, hævelse, åndenød eller 
hjerterytmeforstyrrelser (dette kan skyldes en mulig livstruende komplikation, som kaldes 
tumorlysesyndrom). 
Børn og unge
MYLOTARG må ikke anvendes til børn og unge under 15 år, da der kun er begrænset viden om 
anvendelse til denne aldersgruppe.
Brug af andre lægemidler sammen med MYLOTARG
...
Du skal undgå at blive gravid eller blive far til et barn på grund af de mulige bivirkninger for barnet. 
Kvinder skal bruge 2 sikre præventionsmidler under behandlingen og i mindst 7 måneder efter sidste 
dosis. Mænd og deres partner skal tilsammen bruge 2 sikre præventionsmidler under behandlingen og 
i mindst 4 måneder efter sidste dosis. Kontakt straks lægen, hvis du eller din partner bliver gravid, 
mens du tager dette lægemiddel. 
Søg rådgivning om bevarelse af frugtbarheden, inden du får behandling.
Hvis du skal i behandling med MYLOTARG, skal du stoppe med at amme under behandlingen og i 
mindst 1 måned efter behandlingen. Tal med lægen.
Trafik- og arbejdssikkerhed
Hvis du føler dig usædvanligt træt, svimmel eller har hovedpine (det er meget almindelige 
...
 Lægen eller sygeplejersken vil muligvis ændre din dosis, afbryde eller helt stoppe behandlingen 
med MYLOTARG, hvis du får bivirkninger.
 Lægen vil muligvis nedsætte din dosis ud fra virkningen af din behandling.
 Lægen vil tage blodprøver under behandlingen for at undersøge, om du har bivirkninger, og om 
...
MYLOTARG. Kontakt straks din læge eller sygeplejersken, hvis du oplever nogen af de følgende 
alvorlige bivirkninger (se også afsnit 2 ’Det skal du vide, før du får MYLOTARG’):
 Leverproblemer
Du bør straks fortælle din læge, hvis du oplever brat vægtøgning, smerter i øverste højre side af 
maven, ophobning af væske, der resulterer i en opsvulmet mave. Din læge kan tage blodprøver 
for at undersøge om din lever fungerer normalt og kan finde tegn på en mulig livstruende 
tilstand, der kaldes veno-okklusiv leversygdom.
 Blødning (tegn på lavt antal blodlegemer kaldet blodplader)
Fortæl straks din læge, hvis du let får blå mærker eller tilbagevendende næseblod, eller hvis du 
har sort, tjæreagtig afføring, hoster blod op, har blodigt spyt, føler dig svimmel, besvimer eller 
føler dig forvirret.

Infektioner (tegn på lavt antal hvide blodlegemer kaldet neutrofile leukocytter)
Visse infektioner kan være alvorlige og kan være forårsaget af virus, bakterier eller andre 
årsager, som kan være livstruende.

Komplikation kaldet tumorlysesyndrom
Fortæl straks din læge, hvis du oplever symptomer såsom svimmelhed, nedsat vandladning, 
forvirring, opkastning, kvalme, hævelse, åndenød eller hjerterytmeforstyrrelser.
 Infusionsrelaterede reaktioner
Denne type lægemidler (monoklonale antistoffer) kan forårsage reaktioner i forbindelse med 
infusionen såsom udslæt, åndenød, vejrtrækningsbesvær, trykken for brystet, kuldegysninger 
eller feber og rygsmerter. 
...
 Nedsat antal hvide blodlegemer, hvilket kan medføre generel svækkelse og tendens til at udvikle 
infektioner

...

Blodet er længere om at størkne (hvilket kan resultere i langvarig blødning)

Forhøjet mængde urinsyre i blodet.
Almindelig (kan forekomme hos 1 ud af 10 personer):
 Tegn på en reaktion forårsaget af infusionen såsom udslæt, åndenød, vejrtrækningsbesvær, 
trykken
for brystet, kuldegysninger eller feber og rygsmerter under eller efter infusion med 
MYLOTARG.

...
 Symptomer på forstørret lever, smerter i øverste højre side af maven, gulfarvning af huden og 
det hvide i øjnene, ophobning af væske i bughulen, vægtøgning, unormale levertest (veno-
okklusiv leversygdom)

Gulfarvning af huden eller det hvide i øjnene forårsaget af problemer i levereren eller blodet 
(gulsot)

Rødme i huden

...

Leversvigt.
 Smerter i øverste højre side af maven, unormal stor lever og/ eller ophobning af væske i 
bughulen forbundet med blodpropper i leveren (Budd-Chiaris syndrom). Symptomerne kan være 
at man føler sig syg (kvalme) og/eller kaster op.
...
40
Uåbnede hætteglas: Opbevares i køleskab (2 °C - 8 °C). Må ikke nedfryses. Hætteglasset opbevares i 
den oprindelige æske for at beskytte mod lys. 
Rekonstitueret og fortyndet opløsning: Beskyt den rekonstituerede og fortyndede MYLOTARG-
opløsning mod lys. Opløsningen bør anvendes øjeblikkeligt. Den rekonstituerede eller fortyndede 
opløsning må ikke nedfryses.
Hvis den rekonstituerede opløsning ikke kan anvendes med det samme:
 Efter rekonstitution kan det originale hætteglas opbevares i op til 16 timer i køleskab 
(2°C - 8°C) eller i op til 3 timer ved stuetemperatur (under 30°C).
 Den fortyndede opløsning kan opbevares i op til 18 timer i køleskab (2°C - 8°C) og i op til 
6 timer ved stuetemperatur (under 30°C). Den tilladte opbevaringstid ved stuetemperatur (under 
30°C) inkluderer den nødvendige tid til fremstilling af den fortyndede opløsning, ekvilibrering, 
om nødvendigt, og administration. Den maksimale tid fra fremstilling af den fortyndede 
...

Et hætteglas indeholder 5 mg gemtuzumab ozogamicin.

Efter rekonstitution indeholder hver ml af den koncentrerede opløsning 1 mg gemtuzumab 
ozogamicin.

Øvrige indholdsstoffer: dextran 40, saccharose, natriumchlorid, 
natriumdihydrogenphosfatmonohydrat, vandfri dinatriumphosfat. Se afsnit 2, "Mylotarg 
indeholder natrium"
Udseende og pakningsstørrelser
MYLOTARG er et pulver til koncentrat til infusionsvæske, opløsning. Det leveres som en hvid/råhvid 
substans eller pulver.
Hver æske indeholder et ravgult hætteglas med en gummiprop og flip off-hætte med 
krympeforsegling.
...
Brug passende aseptisk teknik under rekonstitution og fortynding. MYLOTARG er lysfølsomt og skal 
beskyttes mod ultraviolet lys under rekonstitution, fortynding og administration.
Rekonstitution
 Beregn den nødvendige dosis (mg) MYLOTARG.
 Lad hætteglasset nå stuetemperatur (under 30 °C) inden rekonstitution i ca. 5 minutter. 
Rekonstituér hvert hætteglas af 5 mg med 5 ml vand til injektionsvæske for at få en 
engangsopløsning på 1 mg/ml gemtuzumab ozogamicin.
...
rekonstituerede opløsning kan indeholde små hvide/råhvide, uigennemsigtige til gennemsigtige, 
ubestemmelige fiberlignende partikler.
 MYLOTARG indeholder ikke bakteriehæmmende konserveringsmidler. Hvis den 
rekonstituerede opløsning ikke kan anvendes med det samme, kan den opbevares i det 
oprindelige hætteglas i op til 16 timer i køleskab (2°C - 8°C) eller i op til 3 timer ved 
stuetemperatur (under 30°C). Beskyttes mod lys. Må ikke nedfryses.
Fortynding
 Beregn det rekonstituerede opløsningsvolumen, der er nødvendig for at opnå den korrekte dosis 
i forhold til patientens legemsoverflade. Træk denne mængde op af hætteglasset vha. en 
sprøjte. MYLOTARG hætteglas indeholder 5 mg lægemiddel uden overskud. Efter
rekonstitution til en koncentration på 1 mg/ml, som beskrevet, er det muligt at udtage 4,5 mg 
(4,5 ml). Beskyttes mod lys. Eventuelt ubrugt, resterende rekonstitueret opløsning i 
hætteglasset skal kasseres. 
 Doser skal blandes til en koncentration på mellem 0,075 mg/ml og 0,234 mg/ml i henhold til 
efterfølgende instruktion:<em> Doser mindre end 3,9 mg skal fremstilles til administration med sprøjte. Tilsæt 
rekonstitueret MYLOTARG opløsning til en sprøjte med natriumchlorid 9 mg/ml 
(0,9%) opløsning til indsprøjtning til en færdig koncentration på mellem 0,075 mg/ml 
og 0,234 mg/ml. Beskyttes mod lys.
43</em> Doser større end eller lig med 3,9 mg skal fortyndes i en sprøjte eller en infusionspose 
i et passende volumen natriumchlorid 9 mg/ml (0,9%) opløsning til indsprøjtning for 
at sikre en færdig koncentration på mellem 0,075 mg/ml og 0,234 mg/ml. Beskyttes 
mod lys.
 Vend forsigtigt infusionsbeholderen om for at blande den fortyndede opløsning. Må ikke rystes.
 Efter fortynding med natriumchloridopløsning injektionsvæske 9 mg/ml (0,9%) skal 
MYLOTARG opløsningen straks infunderes. Hvis den fortyndede opløsning ikke anvendes 
straks, kan den opbevares i op til 18 timer i køleskab (2°C - 8°C) og i op til 6 timer ved 
stuetemperatur (under 30 °C). Den tilladte opbevaringstid ved stuetemperatur (under 30°C) 
inkluderer den nødvendige tid til fremstilling af den fortyndede opløsning, ekvilibrering, om 
nødvendigt, og administration til patienten. Den maksimale tid fra fremstilling af den 
fortyndede opløsning til og med administration bør ikke overstige 24 timer. Beskyttes mod lys. 
Må ikke nedfryses.
 Det anbefales at bruge en infusionsbeholder fremstillet af polyvinylchlorid (PVC) med DEHP, 
ethylenvinylacetat (EVA) eller polyolefin (polypropylen og/eller polyætylen).
Administration
 Det er nødvendigt at filtrere den fortyndede opløsning. Der skal anvendes et in-line, lavt 
protein-bindende 0,2 mikron polyethersulfon (PES)-filter til infusion med MYLOTARG.
 Doser indgivet med sprøjte skal bruge infusionsslanger med lille diameter (microbore) med in-
line lavt protein-bindende 0,2 mikron polyethersulfon (PES)-filter.
 Under infusionen skal infusionsposen eller sprøjter beskyttes mod lys (også ultraviolet lys) ved 
hjælp af et lysblokerende dække. Infusionsslangen behøver ikke at være beskyttet mod lys.
 Den fortyndede opløsning indgives i 2 timer. Infusionen skal være afsluttet inden for den 
tilladte opbevaringstid på 6 timer for den fortyndede opløsning ved stuetemperatur (under 30
°C).
 Det anbefales at bruge infusionsslanger fremstillet af PVC (med eller uden DEHP), polyurethan
eller polyætylen.
...
Instance: bundlepackageleaflet-en-7cf956e7748c0ba411215481856f48ab
InstanceOf: BundleUvEpi
Title: "ePI document Bundle for mylotarg Package Leaflet for language en"
Description: "ePI document Bundle for mylotarg Package Leaflet for language en"
Usage: #example
...
// Composition
* entry[0].fullUrl = "Composition/composition-en-7cf956e7748c0ba411215481856f48ab"
* entry[0].resource = composition-en-7cf956e7748c0ba411215481856f48ab
...
Instance: bundlepackageleaflet-da-7cf956e7748c0ba411215481856f48ab
InstanceOf: BundleUvEpi
Title: "ePI document Bundle for mylotarg Package Leaflet for language da"
Description: "ePI document Bundle for mylotarg Package Leaflet for language da"
Usage: #example
...
RuleSet: 7cf956e7748c0ba411215481856f48abListRuleset

* identifier.system = "http://ema.europa.eu/identifier" 
* identifier.value = "None"
* identifier[+].system = "http://spor.ema.europa.eu/v2/medicine-name"
* identifier[=].value = "mylotarg"
...
* entry
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-en-7cf956e7748c0ba411215481856f48ab) // mylotarg en
...
* entry
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-da-7cf956e7748c0ba411215481856f48ab) // mylotarg da
  * item.extension[0].url = "http://ema.europa.eu/fhir/extension/documentType"
  * item.extension[=].valueCoding = $100000155531#100000155538 "B. PACKAGE LEAFLET"
  * item.extension[+].url = "http://ema.europa.eu/fhir/extension/language"
