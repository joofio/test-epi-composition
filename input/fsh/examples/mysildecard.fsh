...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Mysildecard contains the active substance sildenafil which belongs to a group of medicines called 
...
<p>If you experience sudden decrease or loss of vision, stop taking Mysildecard and contact your 
...
have an erection, which lasts continuously for more than 4 hours, stop taking Mysildecard and 
contact your doctor immediately (see also section 4).  </p>
<p>Special considerations for patients with kidney or liver problems<br />
You should tell your doctor if you have kidney or liver problems, as your dose may need to be 
adjusted. </p>
<p>Children 
Mysildecard should not be given to children below 1 year of age. </p>
...
your doctor or pharmacist for advice before taking this medicine. Mysildecard should not be used 
during pregnancy unless strictly necessary.<br />
Mysildecard should not be given to women of child bearing potential unless using appropriate 
contraceptive methods.<br />
Mysildecard passes into your breast milk at very low levels and would not be expected to harm your 
baby.   </p>
...
more Mysildecard than you should may increase the risk of known side effects. </p>
<p>If you forget to take Mysildecard 
If you forget to take Mysildecard, take a dose as soon as you remember, then continue to take your 
...
<p>If you experience any of the following side effects you should stop taking Mysildecard and contact a 
doctor immediately (see also section 2):<br />
if you experience sudden decrease or loss of vision (frequency not known)<br />
if you have an erection, which lasts continuously for more than 4 hours. Prolonged and sometimes 
painful erections have been reported in men after taking sildenafil (frequency not known).  </p>
<p>Adults<br />
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Mysildecard contains<br />
...
<p>Mysildecard film-coated tablets are white and round in shape. The tablets are marked with M on one 
side and SL over 20 on the other. The tablets are provided in blisters in packs containing 90, 300 and 
(90 x 1) tablets. Not all pack sizes may be marketed. </p>
