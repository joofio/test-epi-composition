...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>NeoRecormon is a clear, colourless solution for injection under the skin (subcutaneously) or into a 
...
You must talk to your doctor if you do not feel better or if you feel worse. </p>
<p>NeoRecormon is indicated for: </p>
<ul>
<li>Treating symptomatic anaemia caused by chronic kidney disease (renal anaemia) in patients 
on dialysis, or not yet on dialysis. </li>
<li>Preventing anaemia in premature infants (weighing 750 to 1500 g and born at less than 
34 weeks). </li>
<li>Treating anaemia with related symptoms in adult cancer patients receiving chemotherapy </li>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not use NeoRecormon 
...
this case you should not be switched to NeoRecormon. </p>
<p>Take special care with other products that stimulate red blood cell production:<br />
NeoRecormon is one of a group of products that stimulate the production of red blood cells like the 
human protein erythropoietin does. Your doctor will always record the exact product you are using. </p>
<p>Serious skin reaction including Stevens-Johnson syndrome (SJS) and toxic epidermal necrolysis 
(TEN) have been reported in association with epoetin treatment. </p>
<p>SJS/TEN can appear initially as reddish target-like spots or circular patches often with central blisters 
...
<p>If you develop a serious rash or another of these skin symptoms, stop taking NeoRecormon and 
contact your doctor or seek medical attention immediately. </p>
<p>Special Warning: 
During treatment with NeoRecormon </p>
<p>If you are a patient with chronic kidney disease, and particularly if you do not respond properly to 
...
death. </p>
<p>If you are a cancer patient, you should be aware that NeoRecormon may act as a blood cell growth 
...
<p>If you are a nephrosclerotic patient and you are not on dialysis, your doctor will decide whether 
...
<p>Your doctor may do regular blood tests to check:<br />
<em> your potassium levels. If you have high or rising potassium levels your doctor may reconsider 
your treatment<br />
</em> your blood platelet count. The number of platelets can rise slightly to moderately during epoetin 
treatment, and this can cause changes in blood clotting. </p>
<p>If you are a kidney patient under haemodialysis, your doctor may adjust your dose of heparin. This 
should avoid a blockage in the tubing of the dialysis system. </p>
<p>If you are a kidney patient under haemodialysis and at risk of shunt thrombosis, blood clots 
(thromboses) may form in your shunt (vessel used for connection to the dialysis system). Your doctor 
might prescribe acetylsalicylic acid or modify the shunt.  </p>
<p>If you are donating your own blood before surgery, your doctor will need to: 
...
* make sure that only 12% of your blood will be donated at once. </p>
<p>Do not misuse NeoRecormon: 
Misuse of NeoRecormon by healthy people may lead to an increase in blood cells and consequently 
thicken the blood. This can in turn lead to life-threatening complications of the heart or blood vessels. </p>
<p>Other medicines and NeoRecormon 
...
No effects on ability to drive or use machines have been observed. </p>
...
<p>If you do not respond adequately to NeoRecormon, your doctor will check your dose and will inform 
you if you need to change doses. </p>
...
NeoRecormon yourself (see instructions at the end of this leaflet.) </p>
<p>NeoRecormon can be injected under the skin in the abdomen, arm or thigh, or into a vein. Your doctor 
...
doctor will use the lowest effective dose to control the symptoms of your anaemia. </p>
<p>If you do not respond adequately to NeoRecormon, your doctor will check your dose and will inform 
you if you need to change doses of NeoRecormon. </p>
<ul>
<li>Symptomatic anaemia caused by chronic kidney disease </li>
</ul>
<p>Your injections are given under the skin or into a vein. If the solution is given into your vein it 
...
People who are not on haemodialysis will usually have injections under the skin.  </p>
...
<p>The initial dose is 250 IU per injection for every 1 kg the infant weighs, three times a week. </p>
<p>Premature infants who have been transfused before the start of treatment with NeoRecormon are not 
likely to benefit as much as untransfused infants. </p>
<p>The recommended treatment duration is 6 weeks. </p>
<ul>
<li>Adults with symptomatic anaemia receiving chemotherapy for cancer  </li>
</ul>
<p>Injections are given under the skin. </p>
<p>Your doctor may initiate treatment with NeoRecormon if your haemoglobin level is 10 g/dL or less. 
After initiation of therapy, your doctor will maintain your haemoglobin level between 10 and 12 g/dL. </p>
<p>The initial weekly dose is 30,000 IU. This may be given as one injection per week, or in divided 
...
values should not exceed a value of 12 g/dL. </p>
<p>The therapy should be continued for up to 4 weeks after the end of chemotherapy. </p>
<p>The maximum dose should not exceed 60,000 IU per week. </p>
<ul>
<li>People donating their own blood before surgery </li>
</ul>
<p>Injections are given into a vein over 2 minutes, or under the skin. </p>
<p>The dose of NeoRecormon depends on your condition, red blood cell levels and how much blood will 
be donated before surgery. </p>
<p>The dose worked out by your doctor will be given twice per week for 4 weeks. When you donate 
blood, NeoRecormon will be given to you at the end of a donation session. </p>
<p>The maximum dose should not exceed 
* for injections into veins: 1600 IU for every 1 kg of your body weight per week 
* for injections under the skin: 1200 IU for every 1 kg of your body weight per week. </p>
<p>If you inject too much NeoRecormon 
...
blood levels, no symptoms of poisoning have been observed. </p>
...
<p>Side effects which can affect any patient 
...
therapy with NeoRecormon, and determine the best course of action to treat your anaemia. </p>
<p>Additional side effects in adults receiving chemotherapy for cancer 
* Increase in blood pressure and headaches may occasionally occur. Your doctor may treat 
the high blood pressure with drugs. 
* An increase in the occurrence of blood clots has been observed. </p>
<p>Additional side effects in people donating their own blood before surgery 
* A slight increase in the occurrence of blood clots has been observed. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>NeoRecormon er en klar, farveløs opløsning til injektion under huden (subkutant) eller i en vene 
(intravenøst).  NeoRecormon indeholder et hormon, som kaldes epoetin beta, som stimulerer 
...
Kontakt lægen, hvis du får det værre, eller hvis du ikke får det bedre. </p>
<p>NeoRecormon injektion er kun indiceret til: </p>
<ul>
<li>
<p>behandling af symptomgivende blodmangel forårsaget af kronisk nyresygdom (renal anæmi) 
hos patienter i dialyse eller som endnu ikke er i dialyse. </p>
</li>
<li>
<p>forebyggelse af blodmangel hos for tidligt fødte (præmature) spædbørn (som vejer mellem 
750 og 1500 g og født før 34. uge). </p>
</li>
<li>
<p>behandling af blodmangel med relaterede symptomer hos voksne cancerpatienter som 
modtager kemoterapi. </p>
</li>
<li>
<p>behandling af patienter, der tappes for eget blod inden operation. Injektioner af epoetin beta 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Anvend ikke NeoRecormon: 
● 
...
<ul>
<li>
<p>har haft hjerteanfald eller slagtilfælde indenfor måneden op til behandlingen. </p>
</li>
<li>
<p>hvis du har ustabil hjertekrampe (angina pectoris) - nyligt opståede eller flere </p>
</li>
</ul>
<p>smerter i brystet. </p>
<ul>
<li>hvis du har risiko for at udvikle blodpropper i venerne (dyb venetrombose), f.eks. hvis du 
har haft blodpropper før. 
Fortæl det til lægen omgående hvis ovenstående gælder/gælder måske for dig.  </li>
</ul>
<p>Advarsler og forsigtighedsregler: 
Tal med lægen, inden du bruger NeoRecormon 
● 
hvis dit spædbarn behøver behandling med NeoRecormon, vil barnet blive fulgt tæt for potentiel </p>
<p>påvirkning af øjene. 
● 
...
● 
hvis du har udviklet anti-erythropoietin-antistoffer eller pure red cell aplasia (reduceret eller 
ophørt produktion af røde blodlegemer) under tidligere behandling med erytropoietiske 
præparater. I en sådan situation bør du ikke skifte til NeoRecormon. </p>
<p>Vær ekstra forsigtig med at anvende andre lægemidler, som stimulerer produktionen af røde 
blodceller: 
...
(TEN), er blevet rapporteret i forbindelse med epoetinbehandling.<br />
...
udbredt afskalning af huden og livstruende komplikationer.<br />
Hvis du udvikler et alvorligt udslæt eller får andre af disse hudsymptomer, skal du stoppe med at tage 
NeoRecormon og straks kontakte din læge eller søge lægehjælp. </p>
<p>Særlige advarsler </p>
<p>Under behandling med NeoRecormon </p>
<p>Hvis du har en kronisk nyresygdom, og især hvis du ikke reagerer på den dosis af NeoRecormon, du 
...
risiko for at få et hjertetilfælde eller et slagtilfælde eller at dø. </p>
<p>Hvis du er cancerpatient, skal du være opmærksom på, at NeoRecormon kan virke som en blodcelle-
vækstfaktor, og at den i nogle tilfælde kan have en negativ virkning på din cancer. Afhængig af din 
situation kan det være bedre med en blodtransfusion. Diskuter dette med din læge. </p>
<p>Hvis du har skrumpenyre (nefrosklerose), og endnu ikke er i dialysebehandling, vil lægen afgøre, om 
...
det kan betyde ændringer i blodstørkningsprocessen. </p>
<p>Hvis du er nyrepatient og er i hæmodialyse, vil lægen måske ændre din heparindosis. Det sker for at 
forhindre, at blodet størkner i slangerne. </p>
<p>Hvis du er nyrepatient, er i hæmodialyse og har risiko for fisteltrombose, dvs. blodpropper 
(tromboser), som kan dannes i fistlen (anordning til forbindelse med dialysesystemet). Lægen vil 
måske ordinere acetylsalicylsyre eller ændre på fistlen. </p>
<p>Hvis du prædonerer dit eget blod før operation, vil lægen: </p>
<ul>
<li>
<p>Kontrollere at du er i stand til at give blod, især hvis du vejer mindre end 50 kg. </p>
</li>
<li>
<p>Kontrollere at du har et tilstrækkeligt niveau af røde blodlegemer (hæmoglobin på mindst 
11 g/dl). </p>
</li>
<li>
<p>Sikre sig, at kun 12% af dit blod doneres på en gang. </p>
</li>
</ul>
<p>Misbrug ikke NeoRecormon 
Misbrug af NeoRecormon af raske personer kan medføre et øget antal blodplader som derved kan gøre 
blodet mere tyktflydende. Det kan medføre livstruende komplikationer i hjertet eller i blodkarrene. </p>
<p>Brug af anden medicin sammen med NeoRecormon 
...
Ingen effekt på evnen til at køre bil eller anvende maskiner er observeret. </p>
...
apotekspersonalet. </p>
<p>Lægen vil bruge den laveste effektive dosis for at kontrollere symptomerne på din anæmi. </p>
<p>Hvis du ikke respondere tilstrækkeligt på NeoRecormon, vil din læge tjekke din dosis og informere dig 
om, hvis du skal ændre dosis af NeoRecormon.  </p>
<p>Behandling skal opstartes under supervision af din læge. 
Yderligere injektioner gives af din læge eller du kan selv injicere NeoRecormon efter du er blev trænet (se 
brugsanvisning til sidst i denne indlægsseddel). </p>
<p>NeoRecormon kan injiceres under huden i maven, armen, låret eller ind i en blodåre. Din læge vil beslutte 
hvad der er bedst for dig.  </p>
<p>Din læge vil tage regelmæssige blodprøver for at overvåge, hvordan din anæmi responderer til 
behandlingen ved at måle dit hæmoglobinniveau. </p>
<p>Dosering af NeoRecormon 
...
Din læge vil bruge den laveste effektive dosis til at kontrollere symptomerne på din anæmi. </p>
<p>Hvis du ikke reagerer tilstrækkeligt på behandlingen med NeoRecormon, vil din læge kontrollere din 
dosis. Du vil blive informeret, hvis du har behov for ændringer i din NeoRecormon-dosis. </p>
<p>● 
Symptomgivende blodmangel forårsaget af kronisk nyresygdom </p>
<p>Injektionerne gives under huden eller i en vene. Hvis injektionsvæsken skal gives i en vene, skal 
injektionen indgives over ca. 2 minutter, f.eks. vil patienter i hæmodialyse få injektionen via A-V fistlen i 
slutningen af dialysen.<br />
Patienter, som ikke er i hæmodialyse, vil som regel få injektionerne under huden. </p>
<p>Behandling med NeoRecormon forløber i to faser: </p>
<p>a) 
Korrektion af blodmanglen 
Begyndelsesdosis for injektion under huden er 20 IE pr. injektion for hvert kg legemsvægt, givet 3 
gange om ugen. 
Efter 4 uger vil lægen kontrollere behandlingen, og hvis resultatet af behandlingen ikke er tilstrækkeligt, 
...
For begge typer af injektioner må maksimumdosis ikke overskride 720 IE pr. kg legemsvægt pr. uge. </p>
<p>b) 
Vedligeholdelse af niveauet af røde blodlegemer 
Vedligeholdelsesdosis: Når niveauet af røde blodlegemer har nået et acceptabelt niveau, bliver dosis 
...
Børn starter med at følge de samme retningslinjer. I studier har børn som regel haft behov for større doser 
...
helst, hvis det er nødvendigt. </p>
<p>● 
Blodmangel hos for tidligt fødte (præmature) spædbørn </p>
<p>Injektionerne gives under huden </p>
<p>Begyndelsesdosis er 250 IE for hvert kg legemsvægt for barnet, givet 3 gange om ugen. </p>
<p>For tidlig fødte spædbørn som har fået blodtransfusioner før behandling med NeoRecormon vil nok ikke 
få så meget ud af behandlingen som børn, der ikke har fået blodtransfusion. </p>
<p>Den anbefalede behandlingslængde er 6 uger. </p>
<p>● 
Voksne med symptomgivende blodmangel i behandling med kemoterapi for cancer </p>
<p>Injektionerne gives under huden </p>
<p>Din læge vil måske påbegynde behandling med NeoRecormon, hvis dit hæmoglobinniveau er 10 g/dl 
eller mindre. Efter påbegyndt behandling vil din læge opretholde dit hæmoglobinniveau på mellem 10 og 
12 g/dl. </p>
<p>Den ugentlige begyndelsesdosis er 30.000 IE. Denne kan gives som én injektion ugentligt, eller deles 
og gives i 3 til 7 injektioner ugentligt. Din læge vil tage regelmæssige blodprøver. Afhængigt af 
prøveresultaterne kan lægen øge eller nedsætte dosis eller afbryde din behandling. 
Hæmoglobinniveauet må ikke overstige en værdi på 12 g/dl. </p>
<p>Behandlingen skal fortsætte i op til 4 uger efter endt kemoterapibehandling. </p>
<p>Maksimumdosis bør ikke overskride 60.000 IE pr. uge. </p>
<p>● 
Patienter, der donerer blod til sig selv før operation </p>
<p>Injektionerne gives i en vene over 2 minutter eller under huden </p>
<p>Dosis af NeoRecormon afhænger af sygdommen, antallet af røde blodlegemer og hvor meget blod, der 
skal doneres før operation. </p>
<p>Den dosis, som skal gives, udregnes af lægen og vil blive givet 2 gange ugentligt i 4 uger. Når du donerer 
blod vil NeoRecormon blive indgivet efter hver bloddonation. </p>
<p>Den maksimale dosis bør ikke overskride:<br />
• Ved injektion i venerne: 1600 IE pr. kg legemsvægt pr. uge 
• Ved injektion under huden: 1200 IE pr. kg legemsvægt pr. uge </p>
<p>Hvis du tager for meget NeoRecormon 
...
set symptomer på forgiftning. </p>
...
<p>Bivirkninger som kan ramme enhver patient 
● 
De fleste patienter (meget almindeligt, forekommer hos flere end 1 ud af 10 personer) får 
et lavere niveau af jern i blodet. Næsten alle patienter skal have jernsupplement når de 
...
for allergisk reaktion er set, specielt lige efter en injektion. Det skal behandles med det 
samme. Hvis du oplever udsædvanlig hvæsen eller hiven efter vejret, opsvulmet tunge, 
...
influenzalignende symptomer, specielt lige ved behandlingens start. Det omfatter feber, 
...
symptomer, og kontakt straks din læge eller søg lægehjælp. Se også punkt 2. Yderligere bivirkninger hos patienter med kronisk nyresygdom (renal anæmi) 
● 
Forhøjelse af blodtrykket, forværring af eksisterende højt blodtryk og hovedpine er de 
...
en tid. 
● 
Tilkald lægen med det samme, hvis du oplever hovedpine, især pludselig, stikkende, 
migrænelignende hovedpine, forvirring, taleforstyrrelser, besværet gang, anfald og 
kramper. Dette kan være tegn på alvorligt, forhøjet blodtryk (hypertensiv krise), selvom dit 
blodtryk som regel er lavt eller normalt. Det skal behandles med det samme. 
● 
Hvis du har et lavt blodtryk eller fistelkomplikationer, kan du risikere at udvikle 
fisteltromboser (en blodprop i den slange, der forbinder dig med dialysesystemet). 
● 
Meget sjældent (forekommer hos op til 1 ud af 10.000 personer) har patienter oplevet 
forhøjede niveauer af kalium eller phosphat i blodet. Det kan behandles af lægen. 
● 
Pure red cell aplasia forårsaget af neutraliserende antistoffer er blevet observeret under 
erythropoietinbehandling, inklusive isolerede tilfælde ved behandling med NeoRecormon. 
Pure red cell aplasia betyder, at kroppen har stoppet eller nedsat produktionen af røde 
...
behandlingen med NeoRecormon og afgøre den bedste metode til at behandle din blodmangel. </p>
<p>Yderligere bivirkninger hos voksne, som får kemoterapi for cancer 
● 
Forhøjelse af blodtrykket og hovedpine kan forekomme en gang imellem. Lægen vil måske 
behandle det forhøjede blodtryk med lægemidler. 
● 
En forøgelse af forekomsten af blodpropper er observeret. </p>
<p>Yderligere bivirkninger hos patienter, som donerer deres eget blod før operation 
● 
En lille forøgelse af forekomsten af blodpropper er observeret. </p>
...
● 
Opbevar lægemidlet i køleskab (ved 2 °C - 8 °C).<br />
● 
...
<ul>
<li>
<p>Det aktive stof er epoetin beta.  </p>
</li>
<li>
<p>1 fyldt injektionssprøjte indeholder enten 500, 2.000, 3.000, 4.000, 5.000, 6.000, 10.000, 
20.000 eller 30.000 IE (internationale enheder) epoetin beta i 0,3 ml eller 0,6 ml opløsning. </p>
</li>
<li>
<p>De øvrige indholdsstoffer er: </p>
</li>
<li>
<p>urea, natriumchlorid, polysorbat 20, natriumdihydrogenphosphatdihydrat, 
dinatriumphosphatdodecahydrat, calciumchloriddihydrat, glycin, L-Leucin, L-Isoleucin, L-
Threonin, L-Glutaminsyre og L-Phenylalanin og vand til injektionsvæsker (se afsnit 
2 "NeoRecormon indeholder phenylalanin og natrium"). </p>
</li>
</ul>
...
<p>NeoRecormon 500 IE, 2.000 IE, 3.000 IE, 4.000 IE, 5.000 IE og 6.000 IE: Hver fyldt injektionsprøjte 
indeholder 0,3 ml opløsning. 
NeoRecormon 10.000 IE, 20.000 IE og 30.000 IE: Hver fyldt injektionsprøjte indeholder 0,6 ml 
opløsning. </p>
<p>NeoRecormon 500 IE 
1 fyldt injektionssprøjte og 1 nål (30G1/2) eller 
6 fyldte injektionssprøjter og 6 nåle (30G1/2). </p>
<p>NeoRecormon 2.000 IE, 3.000 IE, 4.000 IE, 5.000 IE, 6.000 IE,10,000 IE og 20.000 IE 
1 fyldt injektionssprøjte og 1 nål (27G1/2) eller 
6 fyldte injektionssprøjter og 6 nåle (27G1/2). </p>
<p>NeoRecormon 30.000 IE 
1 fyldt injektionssprøjte og 1 nål (27G1/2) eller 
4 fyldte injektionssprøjter og 4 nåle (27G1/2). </p>
...
D-79639 Grenzach-Wyhlen 
Tyskland </p>
<p>Hvis du ønsker yderligere oplysninger om NeoRecormon, skal du henvende dig til den lokale 
...
Brugsanvisning </p>
<p>Den følgende brugsanvisning forklarer hvordan en injektion af NeoRecormon skal gives. Vær sikker 
...
korrekt, inden du tager det for første gang.  </p>
<p>Injicer ikke dig selv medmindre du har modtaget træning. Kontakt sundhedspersonalet, hvis du har 
brug for yderligere information. </p>
<p>Følg altid alle anvisninger i denne brugsanvisning, da de kan være forskellige fra dine egne oplevelser. 
Disse anvisninger vil mindske risici såsom utilsigtede nålestik og forhindre forkert brug.  </p>
<p>NeoRecormon kan indgives via 2 administrationsveje, din læge vil beslutte hvilken vej, der er den 
rigtige for dig: 
● 
Intravenøs administration (ind i en blodåre eller via venflon), må kun udføres af 
sundhedspersonale. 
● 
Subkutan administration (under huden). </p>
<p>Før du begynder 
● <br />
Tag ikke nålehætten af indtil du er klar til at injicere NeoRecormon. 
● <br />
Forsøg ikke at skille injektionssprøjten fra hinanden på noget tidspunkt. 
● <br />
Genbrug ikke den samme injektionssprøjte. 
● <br />
Brug ikke injektionssprøjten, hvis den er blevet tabt eller beskadiget. 
● <br />
Forlad ikke injektionssprøjten uden opsyn. 
● <br />
...
<p>Opbevaringsvejledning 
● 
Opbevar din(e) ubrugte injektionssprøjte(r) og nåle i den originale æske, og opbevar i 
...
Må ikke fryses. 
● 
Brug ikke injektionssprøjten, hvis den har været frosset. 
● 
Opbevar altid injektionssprøjten og nål tørt </p>
<p>Forsyninger, der er nødvendige, for at give din injektion 
Inkluderet i æsken: 
●<br />
...
medicinen). </p>
<p>OBS: En NeoRecormon æske indeholder enten 1 injektionssprøjte/1 nål, 4 injektionssprøjter/4 nåle 
eller 6 injektionssprøjter/6 nåle. 
●<br />
Brugsanvisning og en indlægsseddel. </p>
<p>Ikke inkluderet i æsken: 
●<br />
1 alkoholserviet 
●<br />
...
af gummiprop, nålehætte og brugt injektionssprøjte. </p>
<p>Forberedelse af injektion </p>
<ol>
<li>
<p>Find en velbelyst, ren, flad overflade til at arbejde på. 
● Tag æsken med injektionssprøjte(r) og nål(e) ud af køleskab </p>
</li>
<li>
<p>Undersøg æskens perforeringer på forsiden og ved forseglingen. Undersøg også udløbsdatoen. </p>
</li>
</ol>
<p>● Brug den ikke, hvis udløbsdatoen er overskredet, eller hvis æsken ser beskadiget ud. I 
dette tilfælde, gå videre til pkt. 20 og kontakt sundhedspersonalet. </p>
<p>● Brug den ikke, hvis perforeringerne eller forseglingen er beskadiget. I dette tilfælde, gå 
videre til pkt. 20 og kontakt sundhedspersonalet. </p>
<ol>
<li>
<p>Åben æsken ved at presse perforeringen ved forseglingen igennem. </p>
</li>
<li>
<p>Tag en injektionssprøjte ud af æsken og en nål fra nåle-æsken. Vær forsigtig, når 
...
<p>Nålehætte 
Beskyttelseshylster 
● Vend ikke æsken på hovedet for at fjerne injektionssprøjten. 
● Håndter ikke injektionssprøjten ved at holde på stemplet eller nålehætten. 
Bemærkning: Hvis du har en multipakning, så sæt æsken med den(de) resterende injektionssprøjte(r) 
tilbage i køleskab </p>
<ol>
<li>Undersøg injektionssprøjten og nålen<br />
● Undersøg injektionssprøjten og nålen for enhver beskadigelse. Brug ikke 
injektionssprøjten, hvis du har tabt injektionssprøjten eller hvis dele af injektionssprøjten 
synes beskadiget. 
● Undersøg udløbsdatoen på injektionssprøjten og nålen. Brug ikke injektionssprøjten eller 
nålen, hvis udløbsdatoen er overskredet.<br />
● Undersøg væsken i injektionssprøjten. Væsken skal være klar og farveløs. Brug ikke 
injektionssprøjten, hvis væsken er uklar, misfarvet eller indeholder partikler. </li>
<li>
<p>Placer injektionssprøjten på en ren, flad overflade. 
● Læg injektionssprøjten til side i 30 minutter, så den kan varme op til stuetemperatur. Lad 
nålehætten sidde på mens den varmer op.<br />
● Fremskynd ikke opvarmningen på nogen måde og kom ikke injektionssprøjten i en 
...
gøre det svært at presse stemplet. </p>
</li>
<li>
<p>Fastgør nålen til injektionssprøjten 
...
genstande. 
● Rør ikke ved spidsen af injektionssprøjten. 
● Skub eller træk ikke i stemplet. 
● Hold injektionssprøjten om glasbeholderen og skub nålen på injektionssprøjten (B). 
● Vrid forsigtigt indtil den er fuldt fastgjort (C). </p>
</li>
</ol>
<p>A)  </p>
<p>B)  </p>
...
C) </p>
<ol>
<li>Placer injektionssprøjten på en ren, flad overflade indtil den er klar til brug. </li>
<li>Vask dine hænder med sæbe og vand. </li>
<li>
...
● Injicer ikke ind i modermærker, ar, blå mærker eller områder hvor huden er øm, rød, hård 
eller ikke intakt. 
● Injicer ikke ind i en blodåre eller ind i en muskel. </p>
</li>
<li>
<p>Tør injektionsstedet med en alkoholserviet og lad det lufttørre i 10 sekunder. 
● Ventiler eller pust ikke på det rengjorte område. 
● Rør ikke ved injektionsstedet igen inden indgivelse af injektionen. </p>
</li>
</ol>
<p>Administration af subkutan injektion </p>
<ol>
<li>
<p>Fjern beskyttelseshylstret fra nålen i retning mod injektionssprøjtens glasbeholder. </p>
</li>
<li>
<p>Hold injektionssprøjten og nålen tæt på spidsen og træk forsigtigt injektionsnålehætten væk 
fra injektionssprøjten. Brug injektionssprøjten inden for 5 minutter efter fjernelse af hætten, 
ellers kan nålen tilstoppe. 
● Hold ikke på stemplet mens du fjerner nålehætten. 
● Rør ikke ved nålen efter fjernelse af nålehætten. 
● Sæt ikke hætten på nålen igen. 
● Ret ikke nålen ud, hvis nålen er bøjet eller beskadiget. 
Smid straks nålehætten i en beholder til skarpe genstande. </p>
</li>
<li>
<p>Hold injektionssprøjten med nålen pegende opad. Fjern de større luftbobler ved forsigtigt at 
...
<li>
<p>Juster til din ordinerede dosis ved langsomt at skubbe stemplet. </p>
</li>
<li>
<p>Klem det valgte injektionssted og sæt nålen helt ind med en 45° til 90° vinkel med en hurtig 
og fast bevægelse. 
● Rør ikke ved stemplet mens nålen indsættes i huden. 
● Indsæt ikke nålen gennem tøj 
Så snart nålen er indsat, frigør klemmet og hold injektionssprøjten stramt på plads. </p>
</li>
<li>
<p>Injicer langsomt din ordinerede dosis ved forsigtigt at skubbe stemplet helt i bund. 
...
<ol>
<li>
<p>Der kan være lidt blødning på injektionsstedet. Du kan presse en tør steril serviet på 
...
medicinen, med vand. </p>
</li>
<li>
<p>Bevæg beskyttelseshylstret fremad 90°, væk fra injektionssprøjtens glasbeholder (A). 
...
<p>B) </p>
<ol>
<li>Kom din brugte injektionssprøjte i en beholder til skarpe genstande lige efter brug. 
● Forsøg ikke at fjerne den brugte injektionsnål fra den brugte injektionssprøjte. 
● Kom ikke hætten tilbage på injektionsnålen igen. 
● Smid ikke injektionssprøjten i dit husholdningsaffald. 
Vigtigt: Opbevar altid beholderen til skarpe genstande utilgængeligt for børn. </li>
</ol>
<p>&lt;--------------------------------------------------------------------------------------------------------------------------
---&gt; 
Brugsanvisning til intravenøs injektion beregnet kun til sundhedspersoner </p>
<p>Følgende brugsanvisning forklarer, hvordan en intravenøs injektion af NeoRecormon gives. Vær 
sikker på, at du læser, forstår og følger brugsanvisningen samt indlægssedlen inden du injicerer 
NeoRecormon. </p>
<p>Administration af intravenøs injektion (kun til sundhedspersoner)  </p>
<p>Forberedelse af injektion: følg pkt. 1 til 9 for subkutan injektion (ovenfor). 
10. Udvælg en blodåre. Skift blodåre ved hver injektion for at undgå ømhed på ét sted. 
● Injicer ikke ind i et rødt eller hævet område. 
● Injicer ikke ind i en muskel. 
Rengør huden over blodåren med en alkoholserviet og lad det tørre. 
● Ventiler eller pust ikke på det rengjorte område. 
● Rør ikke ved injektionsstedet igen inden indgivelse af injektionen. </p>
<ol>
<li>
<p>Forbered injektionssprøjten og nålen: følg pkt. 12 til 15 for subkutan injektion (ovenfor). </p>
</li>
<li>
<p>Indsæt nålen i blodåren. 
● Hold eller skub ikke stemplet mens nålen indsættes. </p>
</li>
<li>Injicer langsomt den ordinerede dosis ved forsigtigt at skubbe stemplet helt i bund. Fjern      <br />
nålen og injektionssprøjten fra injektionsstedet i den samme vinkel, som den blev sat ind. </li>
</ol>
<p>Efter injektionen følg pkt. 18 til 20 for subkutan injektion (ovenfor). </p>
<p>Administration af intravenøs injektion via venflon (kun til sundhedspersoner) </p>
<p>Forberedelse af injektion: følg pkt. 1 til 9 for subkutan injektion (ovenfor). </p>
<ol>
<li>
<p>Rengør huden omkring venflon med en alkoholserviet og lad det tørre. 
...
<li>
<p>Indsæt nålen i venflon (følg instruktionen fra fabrikanten af venflon) 
● Hold eller skub ikke stemplet mens nålen indsættes. </p>
</li>
