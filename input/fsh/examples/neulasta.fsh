...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Neulasta contains the active substance pegfilgrastim. Pegfilgrastim is a protein produced by 
...
<p>Neulasta is used to reduce the duration of neutropenia (low white blood cell count) and the occurrence 
...
<ul>
<li>if you are allergic to pegfilgrastim, filgrastim, or any of the other ingredients of this medicine. </li>
</ul>
...
skin that itch. </li>
<li>
<p>if you have an allergy to latex. The needle cap on the pre-filled syringe contains a derivative of 
...
<li>if you are a patient with breast cancer or lung cancer, Neulasta in combination with 
...
<li>if you have symptoms of inflammation of aorta (the large blood vessel which transports blood 
...
<p>Your doctor will check your blood and urine regularly as Neulasta can harm the tiny filters inside your 
...
<p>Ask your doctor or pharmacist for advice before taking any medicine. Neulasta has not been tested in 
pregnant women. It is important to tell your doctor if you: 
* are pregnant; 
* think you may be pregnant; or 
* are planning to have a baby. </p>
<p>Unless your doctor directs you otherwise, you must stop breast-feeding if you use Neulasta. </p>
<p>Driving and using machines </p>
<p>Neulasta has no or negligible effect on the ability to drive or use machines. </p>
...
<p>Your doctor may decide that it would be more convenient for you to inject Neulasta yourself. Your 
doctor or nurse will show you how to inject yourself. Do not try to inject yourself if you have not been 
trained. </p>
<p>For further instructions on how to inject yourself with Neulasta, please read the section at the end of 
this leaflet. </p>
<p>Do not shake Neulasta vigorously as this may affect its activity. </p>
<p>If you use more Neulasta than you should </p>
<p>If you use more Neulasta than you should contact your doctor, pharmacist or nurse. </p>
...
see section 2. * bleeding from the lung (pulmonary haemorrhage). 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Neulasta indeholder det aktive stof pegfilgrastim. Pegfilgrastim er et protein, der produceres ved hjælp 
...
selv producerer. </p>
<p>Neulasta anvendes til at reducere varigheden af neutropeni (få hvide blodlegemer) og forekomsten af 
...
<ul>
<li>hvis De er allergisk over for pegfilgrastim, filgrastim eller et af de øvrige indholdsstoffer i 
Neulasta. </li>
</ul>
<p>Advarsler og forsigtighedsregler </p>
<p>Kontakt lægen, apotekspersonalet eller sygeplejersken, før De bruger Neulasta, hvis De: </p>
<ul>
<li>
...
<li>
<p>er klar over, at De har ændrede blodtal (for eksempel en stigning i hvide blodlegemer eller 
anæmi) eller fald i antallet af blodplader, hvilket reducerer blodets evne til at størkne 
(trombocytopeni). Deres læge vil muligvis overvåge Dem nøjere. </p>
</li>
<li>
<p>har seglcelleanæmi. Deres læge vil muligvis overvåge Deres tilstand nøjere. </p>
</li>
<li>
<p>er patient med bryst- eller lungekræft, da Neulasta i kombination med kemoterapi og/eller 
...
<li>
<p>pludselig får symptomer på allergi, for eksempel udslæt, kløe eller nældefeber på huden, 
...
betændelsesmarkører. Fortæl det til lægen, hvis De oplever disse symptomer. </p>
</li>
</ul>
<p>Deres læge vil regelmæssigt kontrollere Deres blod og urin, da Neulasta kan beskadige de bittesmå 
filtre i nyrerne (glomerulonefritis). </p>
<p>Der er rapporteret om alvorlige hudreaktioner (Stevens-Johnsons syndrom) ved brug af Neulasta. Hold 
...
<p>Hvis De oplever tab af virkningen af pegfilgrastim, eller hvis virkningen ikke opretholdes, vil Deres 
...
<p>Spørg Deres læge eller apotekspersonalet til råds, før De bruger nogen form for medicin. Neulasta er 
ikke blevet testet på gravide kvinder. Det er vigtigt at fortælle Deres læge, hvis De: </p>
<ul>
<li>
<p>er gravid, </p>
</li>
...
<p>Medmindre Deres læge har sagt andet, skal De holde op med at amme, hvis De bruger Neulasta. </p>
...
<p>Brug altid Neulasta nøjagtigt efter lægens anvisning. De bør konsultere Deres læge eller apotek, hvis 
...
<p>Deres læge kan beslutte, at det vil være praktisk for Dem, hvis De selv indsprøjter Neulasta. Deres 
læge eller sygeplejerske vil vise Dem, hvordan De tager en indsprøjtning. Prøv ikke selv at indsprøjte, 
hvis De ikke er blevet undervist heri. </p>
<p>Læs sidste pkt. i denne indlægsseddel for at få yderligere vejledning i, hvordan De selv indsprøjter 
Neulasta. </p>
<p>Ryst ikke Neulasta kraftigt, da dette kan have negativ indflydelse på dets virkning. </p>
<p>Hvis De har brugt for meget Neulasta </p>
<p>Kontakt Deres læge, sygeplejerske eller apotek hvis De har taget mere Neulasta, end De skal. </p>
...
<p>Fortæl det straks til Deres læge, hvis De får en eller flere af følgende bivirkninger: </p>
<ul>
...
<ul>
<li>
<p>smerter i knoglerne. Deres læge vil fortælle Dem, hvad De kan tage for at lindre 
knoglesmerterne. </p>
</li>
<li>
...
<li>
<p>bristet milt (miltruptur). Nogle tilfælde af miltruptur var dødelige. Det er vigtigt, at De kontakter 
...
<li>
<p>åndedrætsproblemer. Hvis De får hoste, feber og åndedrætsbesvær, skal De kontakte lægen. </p>
</li>
<li>
...
<ul>
<li>
<p>betændelse i aorta (den store pulsåre, der transporterer blod fra hjertet ud i kroppen). Se afsnit 2. * blødning i lungerne (pulmonal blødning). </p>
</li>
<li>
...
kontakt Deres læge. Se også afsnit 2. Indberetning af bivirkninger </p>
</li>
</ul>
...
<p>Brug ikke lægemidlet efter den udløbsdato, der står på kartonen og på injektionssprøjtens etiket efter 
EXP. Udløbsdatoen er den sidste dag i den nævnte måned. </p>
<p>Opbevares i køleskab (2 °C - 8 °C). </p>
<p>De må tage Neulasta ud af køleskabet og opbevare det ved stuetemperatur (ikke over 30 °C) i højst 
3 dage. I det øjeblik en injektionssprøjte tages ud af køleskabet, og har nået stuetemperatur (ikke 
over 30 °C), skal den anvendes indenfor 3 dage eller bortskaffes. </p>
<p>Må ikke nedfryses. Neulasta kan anvendes, hvis det ved et uheld har været nedfrosset en enkelt gang i 
...
injektionsvæsker. Se afsnit 2. Udseende og pakningsstørrelser </li>
</ul>
<p>Neulasta er en klar, farveløs injektionsvæske, opløsning i en fyldt injektionssprøjte (6 mg/0,6 ml). </p>
<p>Hver pakning indeholder 1 fyldt injektionssprøjte af glas med en påsat kanyle af rustfrit stål og 
nålehætte. </p>
<p>Den fyldte injektionssprøjte (med eller uden blisterpakning) kan også fås med en automatisk 
kanylebeskyttelse. </p>
...
<hr />
<p>Instruktioner til injektion med den fyldte injektionssprøjte med Neulasta </p>
<p>Dette pkt. giver information om, hvordan De selv kan foretage indsprøjtning med Neulasta. Det er 
...
De skal foretage indsprøjtningen, så spørg Deres læge, sygeplejerske eller apoteket om hjælp. </p>
<p>Hvordan skal jeg selv eller en anden bruge den fyldte injektionssprøjte med Neulasta? </p>
<p>De skal foretage indsprøjtningen i vævet lige under huden. Dette betegnes som en subkutan 
indsprøjtning. </p>
<p>Udstyr De skal bruge </p>
<p>For at foretage en subkutan indsprøjtning skal De bruge: </p>
<ul>
<li>
<p>en fyldt injektionssprøjte med Neulasta, og </p>
</li>
<li>
<p>afspritningsservietter eller lignende. </p>
</li>
</ul>
<p>Hvad skal jeg gøre, før jeg selv foretager subkutan indsprøjtning med Neulasta? </p>
<ol>
<li>
...
<li>
<p>Fjern ikke nålehætten fra injektionssprøjten, før De er klar til at indsprøjte. </p>
</li>
<li>
...
<li>
<p>Kontroller udseendet af Neulasta. Det skal være en klar og farveløs væske. Hvis der er partikler 
i, må De ikke bruge den. </p>
</li>
<li>
<p>For at gøre indsprøjtningen mere behagelig kan De lade den fyldte injektionssprøjte ligge i 
30 minutter og lade den få stuetemperatur, eller De kan holde den fyldte injektionssprøjte 
forsigtigt i Deres hånd i et par minutter. Opvarm ikke Neulasta på nogen anden måde (De bør 
for eksempel ikke opvarme den i mikrobølgeovn eller i varmt vand). </p>
</li>
<li>
<p>Vask Deres hænder grundigt. </p>
</li>
<li>
<p>Find et behageligt, godt oplyst sted og læg alt, hvad De skal bruge i Deres nærhed. </p>
</li>
</ol>
...
<ol>
<li>
<p>Hold på injektionssprøjtens cylinder, og fjern forsigtigt 
kanylehætten uden at vride. Træk lige som vist på 
billederne 1 og 2. Rør ikke ved kanylen, og skub ikke til 
stemplet. </p>
</li>
<li>
<p>Man kan se en lille luftboble i den fyldte sprøjte. De behøver ikke fjerne luftboblen inden 
...
<li>
<p>maveregionen, undtagen området omkring navlen. 
...
<ol>
<li>
<p>Rengør Deres hud ved at benytte en afspritningsserviet. </p>
</li>
<li>
<p>Tag fast i huden (uden at klemme) med tommeltot og pegefinger. Stik kanylen ind i huden. </p>
</li>
<li>
...
<li>
<p>Hvis De bemærker blod på injektionsstedet, duppes med en tot vat eller serviet. Gnid ikke på 
injektionsstedet. De kan om nødvendigt dække injektionsstedet med et plaster. </p>
</li>
<li>
<p>Anvend ikke eventuel resterende Neulasta i injektionssprøjten. </p>
</li>
</ol>
<p>Husk </p>
<p>Anvend kun hver injektionssprøjte til én indsprøjtning. Hvis De har problemer, spørg Deres læge eller 
sygeplejerske om hjælp og råd. </p>
<p>Bortskaffelse af brugte sprøjter </p>
<ul>
<li>
<p>Sæt ikke nålehætten tilbage på brugte kanyler. </p>
</li>
<li>
<p>Opbevar de brugte sprøjter utilgængeligt for børn. </p>
</li>
<li>
<p>Bortskaf den brugte sprøjte i overensstemmelse med de lokale bestemmelser. Spørg på apoteket, 
hvordan De skal aflevere medicinrester. Disse forholdsregler er med til at beskytte miljøet. </p>
</li>
</ul>
<hr />
...
<ul>
<li>
<p>Det er vigtigt, at De ikke forsøger at give Dem selv injektionen, medmindre De har fået 
instruktioner af Deres læge eller sundhedspersonalet. </p>
</li>
<li>
<p>Neulasta gives som en injektion i vævet lige under huden (subkutan injektion). </p>
</li>
<li>
<p>Fortæl det til Deres læge, hvis De er allergisk over for latex. Nålehætten på den fyldte 
injektionssprøjte indeholder et derivat af latex og kan medføre alvorlige allergiske reaktioner. </p>
</li>
</ul>
<p>Tag ikke den grå kanylehætte af den fyldte injektionssprøjte, før De er klar til at tage 
injektionen. </p>
<p>Brug ikke den fyldte injektionssprøjte, hvis De har tabt den på en hård overflade. Brug en ny 
fyldt injektionssprøjte og kontakt Deres læge eller sundhedspersonalet. </p>
<p>Forsøg ikke at aktivere den fyldte injektionssprøjte inden injektionen. </p>
<p>Forsøg ikke at tage den gennemsigtige kanylebeskyttelse af den fyldte injektionssprøjte. </p>
<p>Forsøg ikke at fjerne den aftagelige etiket på den fyldte beholder, inden injektionen gives. 
Kontakt Deres læge eller sundhedspersonalet, hvis De har spørgsmål. </p>
...
mere behagelig. Vask Deres hænder grundigt med vand og sæbe. </p>
<p>Anbring den fyldte injektionssprøjte og de øvrige materialer på en ren overflade, hvor lyset er godt.  </p>
...
<ul>
<li>
<p>Medicinen er grumset, eller der er partikler i den. Det skal være en klar og farveløs væske. </p>
</li>
<li>
<p>Der er dele, som ser ud til at være revnede eller ødelagte. </p>
</li>
<li>
<p>Den grå kanylehætte mangler eller ikke er sat ordentligt på. </p>
</li>
<li>
<p>Udløbsdatoen, der er trykt på etiketten, er overskredet (den sidste dag i den viste måned er 
passeret). 
Hvis noget af ovenstående er tilfældet, skal De kontakte Deres læge eller sundhedspersonalet. </p>
</li>
</ul>
<p>Trin 2: Klargøring 
A 
...
<li>
<p>forsiden af overarmen (kun, hvis en anden person giver Dem injektionen) 
Afrens injektionsstedet med en afspritningsserviet. Lad huden tørre. </p>
</li>
</ul>
<p>Rør ikke ved injektionsstedet inden injektionen </p>
<p>Giv ikke injektionen på steder, hvor huden er øm, ødelagt, rød eller hård. Undgå at injicere på 
steder, hvor der er ar eller strækmærker. </p>
<p>B 
...
<p>“KLIK" </p>
<p>For at tilføre hele dosen er det vigtigt, at De trykker ned gennem “klikket". </p>
<p>C 
...
<p>Drej på stemplet for at få etiketten i en position, hvor den kan tages af. </p>
<p>Trin 4: Afslut 
A 
Kassér den brugte injektionssprøjte og andre materialer i en kanylebøtte. </p>
<p>Medicin skal bortskaffes i overensstemmelse med lokale retningslinjer. Spørg på apoteket, hvordan De 
skal aflevere medicinrester. Disse forholdsregler er med til at beskytte miljøet. </p>
