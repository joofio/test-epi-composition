...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>- Further helpful information </p>         </div>"""   
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not take Nexium Control<br />
...
- If you are taking a medicine containing nelfinavir (used to treat HIV infection). </p>
...
reduces stomach acid.<br />
* You are due to have an endoscopy or a urea breath test. 
* You are due to have a specific blood test (Chromogranin A). </p>
...
* You lose a lot of weight for no reason.<br />
...
mention any other ill-effects like pain in your joints. </p>
<p>Seek urgent medical attention if you experience chest pain with light-headedness, sweating, dizziness 
or shoulder pain with shortness of breath. This could be a sign of a serious condition with your heart. </p>
<p>If any of the above apply to you (or you are not sure), talk to your doctor straight away. </p>
<p>Children and adolescents 
This medicine should not be used by children and adolescents under 18 years of age. </p>
<p>Other medicines and Nexium Control 
Tell your doctor or pharmacist if you are taking, have recently taken or might take any other 
medicines. This is because this medicine can affect the way some medicines work and some medicines 
can have an effect on it. </p>
<p>Do not take this medicine if you are also taking a medicine containing nelfinavir (used to treat HIV 
infection). </p>
<p>You should specifically tell your doctor or pharmacist if you are taking clopidogrel (used to prevent 
blood clots). </p>
<p>Do not take this medicine with other medicines that limit the amount of acid produced in your stomach 
such as proton pump inhibitors (e.g. pantoprazole, lansoprazole, rabeprazole or omeprazole) or an H2 
antagonist (e.g. ranitidine or famotidine). </p>
<p>You may take this medicine with antacids (e.g. magaldrate, alginic acid, sodium bicarbonate, 
aluminium hydroxide, magnesium carbonate or combinations of these) if needed. </p>
...
<p>Nexium Control contains sucrose and sodium 
...
row, you should consult a doctor. </p>
<p>If you have persistent or longstanding, frequently recurring symptoms even after treatment with this 
medicine, you should contact your doctor. </p>
...
the acid in your stomach. It is important not to damage the pellets. </p>
<p>Alternative method of taking this medicine 
...
and weakness.   </p>
<p>If you forget to take Nexium Control 
...
* Benign growths (polyps) in the stomach. </p>
...
* Skin rash, lumpy rash (hives) and itchy skin. </p>
...
* Rash, possibly with pain in the joints. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Nexium Control contains<br />
...
GlaxoSmithKline Dungarvan Limited, Knockbrack, Dungarvan, Co. Waterford,<br />
Ireland  </p>
<p>Manufacturer<br />
