...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>NovoNorm is an oral antidiabetic medicine containing repaglinide which helps your pancreas 
produce more insulin and thereby lower your blood sugar (glucose). </p>
<p>Type 2 diabetes is a disease in which your pancreas does not make enough insulin to control the 
sugar in your blood or where your body does not respond normally to the insulin it produces. </p>
<p>NovoNorm is used to control type 2 diabetes in adults as an add-on to diet and exercise: treatment is 
usually started if diet, exercise and weight reduction alone have not been able to control (or lower) 
your blood sugar. NovoNorm can also be given with metformin, another medicine for diabetes. </p>
<p>NovoNorm has been shown to lower the blood sugar, which helps to prevent complications from your 
diabetes. </p> </div>"""   
...
<ul>
<li>If you are allergic to repaglinide or any of the other ingredients in this medicine (listed in 
section 6). </li>
<li>If you have type 1 diabetes. </li>
<li>If the acid level in your blood is raised (diabetic ketoacidosis). </li>
...
Talk to your doctor before taking NovoNorm: </p>
<ul>
<li>If you have liver problems. NovoNorm is not recommended in patients with moderate liver 
disease. NovoNorm should not be taken if you have a severe liver disease (see Do not take 
NovoNorm). </li>
<li>If you have kidney problems. NovoNorm should be taken with caution. </li>
...
<li>If you are under 18 or over 75 years of age. NovoNorm is not recommended. It has not been 
studied in these age groups. </li>
</ul>
<p>Talk to your doctor if any of the above applies to you. NovoNorm may not be suitable for you. Your 
...
of NovoNorm, food or exercise may need to be adjusted. </p>
<p>If your blood sugar gets too high </p>
<p>Your blood sugar may get too high (hyperglycaemia). This may happen: 
* If you take too little NovoNorm 
* If you have an infection or a fever 
* If you eat more than usual 
* If you exercise less than usual. </p>
<p>The warning signs of too high blood sugar appear gradually. They include: increased urination; 
feeling thirsty; dry skin and dry mouth. Talk to your doctor. The amount of NovoNorm, food or 
exercise may need to be adjusted. </p>
...
<p>You should not take NovoNorm if you are pregnant or you are planning to become pregnant. </p>
<p>You should not take NovoNorm if you are breast-feeding. </p>
<p>Driving and using machines </p>
<p>Your ability to drive or use a machine may be affected if your blood sugar is low or high. Bear in 
...
sure. 
Your doctor will work out your dose. </p>
<ul>
<li>The normal starting dose is 0.5 mg before each main meal. Swallow the tablets with a glass of 
water immediately before or up to 30 minutes before each main meal. </li>
<li>The dose may be adjusted by your doctor by up to 4 mg to be taken immediately before or up to 
30 minutes before each main meal. The maximum recommended daily dose is 16 mg. </li>
</ul>
<p>Do not take more NovoNorm than your doctor has recommended.  </p>
<p>If you take more NovoNorm than you should </p>
<p>If you take too many tablets, your blood sugar may become too low, leading to a hypo. Please see If 
you get a hypo on what a hypo is and how to treat it. </p>
<p>If you forget to take NovoNorm </p>
<p>If you miss a dose, take the next dose as usual - do not double the dose. </p>
...
develop into hypoglycaemic unconsciousness or coma. If this happens, medical assistance is needed 
immediately. </p>
<p>Allergy 
...
* Stomach pain 
* Diarrhoea. </p>
<p>Rare (may affect up to 1 in 1,000 patients) 
* Acute coronary syndrome (but it may not be due to the medicine). </p>
<p>Very rare (may affect up to 1 in 10,000 patients) 
* Vomiting 
* Constipation 
* Visual disturbances 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>NovoNorm er en tablet, som indeholder repaglinid, til behandling af sukkersyge til oral anvendelse, 
som får bugspytkirtlen til at producere mere insulin og derved sænker dit blodsukker (glukose). </p>
<p>Type 2-diabetes er en sygdom, hvor bugspytkirtlen ikke producerer tilstrækkelig insulin til at 
regulere dit blodsukker, eller hvor din krop ikke reagerer normalt på insulinet, den producerer.  </p>
<p>NovoNorm bruges til behandling af type 2-diabetes hos voksne som et supplement til kost og motion: 
...
andet lægemiddel mod sukkersyge. </p>
<p>NovoNorm er i stand til at sænke blodsukkeret, hvilket kan hjælpe med til at forhindre komplikationer 
...
<ul>
<li>
<p>Hvis du er allergisk over for repaglinid eller et af de øvrige indholdsstoffer i dette lægemiddel 
(angivet i punkt 6). </p>
</li>
<li>
<p>Hvis du har type 1-diabetes. </p>
</li>
<li>
<p>Hvis syreniveauet i dit blod er forhøjet (diabetisk ketoacidose). </p>
</li>
<li>
<p>Hvis du har en alvorlig leversygdom. </p>
</li>
<li>
<p>Hvis du tager gemfibrozil (et lægemiddel der anvendes til at sænke kolesterolniveauet i 
blodet). </p>
</li>
</ul>
<p>Advarsler og forsigtighedsregler 
Kontakt lægen før du tager NovoNorm: </p>
<ul>
<li>
<p>Hvis du har problemer med din lever. NovoNorm anbefales ikke til patienter med moderat 
leversygdom. Du må ikke tage NovoNorm, hvis du har en alvorlig leversygdom (se Tag ikke 
NovoNorm). </p>
</li>
<li>
<p>Hvis du har problemer med dine nyrer. NovoNorm skal tages med forsigtigthed. </p>
</li>
<li>
<p>Hvis du står over for en stor operation eller lige har overstået en alvorlig sygdom eller 
infektion. I sådanne tilfælde kan diabetesreguleringen muligvis gå tabt. </p>
</li>
<li>
<p>Hvis du er under 18 eller over 75 år gammel, anbefales det ikke at tage NovoNorm, da der 
ikke er lavet studier med disse aldersgrupper. </p>
</li>
</ul>
<p>Fortæl det til din læge, hvis noget af ovennævnte gælder for dig. NovoNorm er måske ikke den 
rigtige løsning for dig. Lægen vil rådgive dig. </p>
<p>Børn og teenagere </p>
<p>Tag ikke dette lægemiddel hvis du er under 18 år. </p>
<p>Hvis du får hypoglykæmi (lavt blodsukker) </p>
<p>Du kan få hypoglykæmi hvis dit blodsukker bliver for lavt. Dette kan ske: </p>
<ul>
<li>
<p>Hvis du tager for mange NovoNorm </p>
</li>
<li>
<p>Hvis du motionerer mere end normalt </p>
</li>
<li>
<p>Hvis du tager anden medicin eller lider af lever- eller nyreproblemer (se andre afsnit under 
punkt </p>
</li>
</ul> </div>"""   
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Advarselstegn på hypoglykæmi kan opstå pludseligt og kan medføre: koldsved, kold og bleg hud, 
...
lægehjælp. Du må ikke få mad eller drikke, da du kan blive kvalt. </p>
<ul>
<li>
<p>Hvis alvorlig hypoglykæmi ikke behandles, kan det forårsage hjerneskade (midlertidig eller 
permanent) og endog død. </p>
</li>
<li>
<p>Hvis du har hypoglykæmi, som får dig til at besvime, eller hvis du har mange tilfælde af 
...
<ul>
<li>
<p>Hvis du har taget for få NovoNorm </p>
</li>
<li>
<p>Hvis du har en infektion eller feber </p>
</li>
<li>
<p>Hvis du spiser mere end normalt </p>
</li>
<li>
<p>Hvis du motionerer mindre end normalt. </p>
</li>
</ul>
<p>Advarselstegnene på for højt blodsukker optræder gradvist. De inkluderer: øget vandladningstrang, 
tørstfornemmelse, tør hud og tør mund. Tal med din læge, da mængden af NovoNorm, mad eller 
motion muligvis skal justeres. </p>
<p>Brug af anden medicin sammen med NovoNorm </p>
<p>Fortæl det altid til lægen eller apotekspersonalet, hvis du bruger anden medicin eller har gjort det 
for nylig. 
...
NovoNorm.  </p>
<p>Din krops reaktion på NovoNorm kan ændres, hvis du tager anden medicin, især følgende: </p>
<ul>
<li>
<p>Monoaminooxidasehæmmere eller (MAOI) (mod depression)  </p>
</li>
<li>
<p>Betablokkere (mod forhøjet blodtryk eller hjertelidelser) </p>
</li>
<li>
<p>ACE-hæmmere (mod hjertelidelser) </p>
</li>
<li>
<p>Salicylater (f.eks. aspirin) </p>
</li>
<li>
<p>Oktreotid (mod kræft) </p>
</li>
<li>
<p>Nonsteroide antiinflammatoriske midler (NSAID) (en gruppe af smertestillende midler) </p>
</li>
<li>
<p>Steroider (anaboliske steroider og kortikosteroider - mod blodmangel eller mod inflammation) </p>
</li>
<li>
<p>Orale kontraceptiva (p-piller) </p>
</li>
<li>
<p>Thiazider (vanddrivende tabletter) </p>
</li>
<li>
<p>Danazol (mod brystcyster og endometriose) </p>
</li>
<li>
<p>Thyreoideapræparater (mod lavt niveau af skjoldbruskkirtlens hormoner) </p>
</li>
<li>
<p>Sympatomimetika (mod astma) </p>
</li>
<li>
<p>Clarithromycin, trimethoprim, rifampicin (antibiotiske lægemidler) </p>
</li>
<li>
<p>Itraconazol, ketokonazol (svampehæmmende lægemidler) </p>
</li>
<li>
<p>Gemfibrozil (mod kolesterol i blodet) </p>
</li>
<li>
<p>Ciclosporin (anvendes til at undertrykke immunsystemet) </p>
</li>
<li>
<p>Deferasirox (anvedes til at mindske kronisk jernoverskud) </p>
</li>
<li>
<p>Clopidogrel (forebygger blodpropper)  </p>
</li>
<li>
<p>Phenytoin, carbamazepin, phenobarbital (mod epilepsi) </p>
</li>
<li>
<p>Perikum (naturlægemiddel). </p>
</li>
</ul>
<p>Brug af NovoNorm sammen med alkohol </p>
<p>Alkohol kan ændre den virkning, som NovoNorm har til at sænke blodsukkeret. Vær opmærksom på 
hypoglykæmiske tegn. </p>
...
<p>Du må ikke tage NovoNorm, hvis du er gravid eller planlægger at blive det. </p>
<p>Du må ikke tage NovoNorm, hvis du ammer. </p>
<p>Trafik- og arbejdssikkerhed </p>
<p>Din evne til at føre motorkøretøj eller betjene maskiner kan muligvis være påvirket, hvis dit 
blodsukker er for lavt eller for højt. Husk, at du kan bringe dig selv og andre i fare. Spørg venligst din 
læge om du kan køre bil, hvis du: </p>
<ul>
<li>
<p>Ofte har hypoglykæmi </p>
</li>
<li>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Tag altid NovoNorm nøjagtigt efter lægens anvisning. Er du i tvivl, så spørg lægen eller på apoteket. </p>
<p>Lægen vil bestemme din dosis. </p>
<ul>
<li>
<p>Den sædvanlige startdosis er 0,5 mg før hvert hovedmåltid. Tabletterne sluges sammen med et 
glas vand umiddelbart før eller op til 30 minutter før hvert hovedmåltid. </p>
</li>
<li>
<p>Dosis kan derefter justeres af lægen med op til 4 mg, som skal tages umiddelbart før eller op til 
30 minutter før hvert hovedmåltid. Den maksimale anbefalede daglige dosis er 16 mg.  </p>
</li>
</ul>
<p>Tag aldrig en større mængde NovoNorm, end lægen har anbefalet.  </p>
<p>Hvis du har taget for mange NovoNorm </p>
<p>Hvis du tager for mange tabletter, kan det sænke blodsukkerniveauet for meget og medføre 
hypoglykæmi. Se venligst Hvis du får hypoglykæmi med hensyn til hvad hypoglykæmi er, og hvordan 
det behandles. </p>
<p>Hvis du har glemt at tage NovoNorm </p>
<p>Hvis du glemmer at tage en dosis, skal du tage den næste dosis som sædvanligt - Du må ikke tage en 
dobbeltdosis som erstatning for den glemte dosis.  </p>
<p>Hvis du holder op med at tage NovoNorm </p>
<p>Vær opmærksom på, at den ønskede virkning ikke opnås, hvis du stopper med at tage NovoNorm. Din 
...
<p>Hypoglykæmi 
Hypoglykæmi er den mest almindelige bivirkning og kan forekomme hos mellem 1 og 10 ud af behandlede (se Hvis du får hypoglykæmi, under punkt 2). Hypoglykæmiske reaktioner er sædvanligvis 
milde til moderate, men kan i nogle tilfælde udvikle sig til hypoglykæmisk bevidstløshed eller koma. 
Hvis dette sker, har du brug for øjeblikkelig lægehjælp. </p>
<p>Allergi 
...
anafylaktisk reaktion. Kontakt straks en læge. </p>
<p>Andre bivirkninger 
Almindelige bivirkninger (kan forekomme hos mellem 1 og 10 ud af 100 behandlede) </p>
<ul>
<li>
<p>Mavesmerter </p>
</li>
...
<p>Sjældne bivirkninger (kan forekomme hos færre end 1 ud af 1.000 behandlede) </p>
<ul>
<li>Akut koronarsyndrom (men det behøver ikke være forårsaget af lægemidlet). </li>
</ul>
<p>Meget sjældne bivirkninger (kan forekomme hos færre end 1 ud af 10.000 behandlede) </p>
<ul>
<li>
<p>Opkastning </p>
</li>
...
<li>
<p>Alvorlige leverproblemer, unormal leverfunktion såsom stigning af leverenzymer i blodet. </p>
</li>
</ul>
<p>Bivirkninger med ukendt frekvens </p>
<ul>
<li>
<p>Hypersensitivitet (såsom udslæt, kløe, rødmen, hævelse af huden) </p>
</li>
<li>
<p>Kvalme. </p>
</li>
...
<p>Brug ikke lægemidlet efter den udløbsdato, der står på pakningen og blisterfolien efter EXP. 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>NovoNorm é um medicamento antidiabético oral contendo repaglinida, que ajuda o seu pâncreas a 
...
produz.  </p>
<p>NovoNorm é utilizado para controlar a diabetes tipo 2 nos adultos, sendo adicionado à dieta e ao 
exercício: o tratamento é, geralmente, iniciado se a dieta, o exercício físico e a redução de peso por si 
só não foram suficientes para controlar (ou diminuir) o seu açúcar no sangue. NovoNorm também 
pode ser administrado com metformina, que é outro medicamento para a diabetes. </p>
<p>Foi demonstrado que NovoNorm baixa o açúcar no sangue, o que ajuda a prevenir as complicações da 
sua diabetes. </p> </div>"""   
...
Fale com o seu médico antes de tomar NovoNorm: </p>
<ul>
<li>
<p>Se tiver problemas de fígado. NovoNorm não é recomendado em doentes com doença 
moderada do fígado. NovoNorm não deve ser tomado se tiver uma doença grave do fígado (ver 
Não tome NovoNorm) </p>
</li>
<li>
<p>Se tiver problemas renais. NovoNorm deve ser tomado com precaução </p>
</li>
<li>
...
<li>
<p>Se tiver menos de 18 anos ou mais de 75 anos de idade. A utilização de NovoNorm não é 
recomendada. O medicamento não foi estudado nestes grupos etários. </p>
</li>
</ul>
<p>Informe o seu médico se qualquer das situações acima referidas se aplica a si. NovoNorm pode não 
ser o medicamento adequado ao seu caso. O seu médico aconselhá-lo-à. </p>
...
<ul>
<li>
<p>Se tomar demasiado NovoNorm </p>
</li>
<li>
...
açúcar no sangue, continue o tratamento com NovoNorm. 
...
com o seu médico. A dose de NovoNorm, a quantidade de alimentos ou de exercício podem 
...
da frequência urinária; pele seca e boca seca. Fale com o seu médico. A quantidade de NovoNorm, de 
...
Pode tomar NovoNorm com metformina, que é outro medicamento para a diabetes, se o seu médico o 
prescrever. 
Se tomar gemfibrozil (utilizado para baixar os níveis elevados de gordura no sangue), não deve tomar 
NovoNorm. </p>
<p>A resposta do seu corpo a NovoNorm pode mudar se estiver a tomar outros medicamentos, em 
especial os seguintes: </p>
<ul>
<li>
...
<p>O álcool pode alterar a capacidade de NovoNorm para reduzir o açúcar no sangue. A resposta do seu 
corpo a NovoNorm pode alterar-se se ingerir bebidas alcoólicas. Fique alerta aos sintomas de 
hipoglicemia. </p>
...
<p>Não deve tomar NovoNorm se estiver grávida ou a planear engravidar.  </p>
...
<p>Tenha em conta que o efeito desejado não será alcançado se deixar de tomar NovoNorm. A sua 
diabetes pode piorar. Caso seja necessário alterar o seu tratamento fale primeiro com o seu médico. </p>
...
<p>Os comprimidos de NovoNorm são redondos, convexos e gravados com o logótipo da Novo Nordisk 
(boi Apis). As dosagens são 0,5 mg, 1 mg e 2 mg. Os comprimidos de 0,5 mg são brancos, os 
comprimidos de 1 mg são amarelos e os comprimidos de 2 mg são cor de pêssego. Estão disponíveis 
quatro embalagens em blister. Cada embalagem contém 30, 90, 120 ou 270 comprimidos.<br />
