...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>NovoRapid is a modern insulin (insulin analogue) with a rapid-acting effect. Modern insulin products 
are improved versions of human insulin. </p>
<p>NovoRapid is used to reduce the high blood sugar level in adults, adolescents and children aged 1 year 
...
inject into a lumpy, shrunken or thickened area (see section 3, How to use NovoRapid). Tell your 
...
<p>Do not give this medicine to children below 1 year of age since no clinical studies have been carried 
...
<p>NovoRapid has a rapid onset of effect therefore if hypoglycaemia occurs, you may experience it earlier 
...
<p>NovoRapid is generally taken immediately before a meal. Eat a meal or snack within 10 minutes of the 
injection to avoid low blood sugar. When necessary, NovoRapid can be given soon after a meal. See 
How and where to inject below for information. </p>
...
<p>NovoRapid can be used in adolescents and children aged 1 year and above instead of soluble human 
...
<p>NovoRapid is for injection under the skin (subcutaneously) or for continuous infusion in a pump 
...
by physicians or other healthcare staff. </p>
...
of your thighs. The insulin will work more quickly if injected into the front of your waist. You should 
always measure your blood sugar regularly. </p>
<p>NPH (Neutral Protamine Hagedorn) insulin is the only type of insulin that can be mixed with 
