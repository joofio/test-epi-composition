...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>NovoSeven is a blood coagulation factor. It works by making the blood clot at the site of bleeding, 
when the body's own clotting factors are not working. </p>
<p>NovoSeven is used to treat bleeding, and to prevent excessive bleeding after surgery or other 
important treatments. Early treatment with NovoSeven reduces how much you bleed and for how long. 
It works in all types of bleeds, including joint bleeds. This reduces the need for hospitalisation and 
...
medicines. </p>
<p>Do not use NovoSeven at the same time as prothrombin complex concentrates or rFXIII. You should 
talk to your doctor before using NovoSeven if you also use Factor VIII or IX products. </p>
<p>There is limited experience of using NovoSeven together with medicines called antifibrinolytic drugs 
(such as aminocaproic acid or tranexamic acid) which are also used to control bleeding. You should 
...
your doctor for advice before you use NovoSeven. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>The NovoSeven powder must be reconstituted with its solvent and injected into a vein. See overleaf 
for detailed instructions. </p>
<p>When to treat yourself 
Start treatment of a bleed as early as possible, ideally within 2 hours. 
* In cases of a mild or moderate bleed, you should treat yourself as early as possible, ideally at 
home. 
* In case of a severe bleed you should contact your doctor. Usually severe bleeds are treated at the 
hospital and you can give yourself the first NovoSeven dose on the way there. </p>
<p>Do not treat yourself for longer than 24 hours without consulting your doctor. 
* Each time you use NovoSeven, tell your doctor or hospital as soon as possible. 
* If bleeding is not controlled within 24 hours, contact your doctor immediately. You will usually 
need hospital care. </p>
<p>Dose 
The first dose should be given as early as possible after bleeding has started. Talk to your doctor about 
when to use the injections and how long to keep using them. 
...
* Allergic, hypersensitivity or anaphylactic reactions. Signs may include skin rashes, itching, 
flushing and hives; wheezing or difficulty breathing; feeling faint or dizzy; and severe swelling 
...
(which could lead to a stroke) or in the intestine and kidneys. Signs may include severe pain in 
the chest, breathlessness, confusion, difficulty with speech or movement (paralysis) or 
abdominal pain. </p>
<p>Uncommon (may affect up to 1 in 100 treatment episodes) 
...
<p>Other rare side effects 
(may affect up to 1 in 1,000 treatment episodes)<br />
* Nausea (feeling sick) 
* Headache 
* Changes in some liver and blood tests. </p>
<p>Other uncommon side effects 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What NovoSeven contains 
...
<p>The powder for solution for injection contains: 1 mg/vial (corresponding to 50 KIU/vial), 2 mg/vial 
...
1 KIU equals 1,000 IU (International Units). </p>
<p>What NovoSeven looks like and contents of the pack 
The powder vial contains white powder and the pre-filled syringe contains a clear colourless solution. 
The reconstituted solution is colourless. Do not use the reconstituted solution if you notice particles in 
it or if it is discoloured. </p>
<p>Each NovoSeven pack contains: 
* 1 vial with white powder for solution for injection 
* 1 vial adapter 
* 1 pre-filled syringe with solvent for reconstitution 
* 1 plunger rod </p>
<p>Pack sizes: 1 mg (50 KIU), 2 mg (100 KIU), 5 mg (250 KIU) and 8 mg (400 KIU). </p>
...
<p>NovoSeven is supplied as a powder. Before injection (administration) it must be reconstituted with the solvent 
supplied in the syringe. The solvent is a histidine solution. The reconstituted NovoSeven must be injected into 
your vein (intravenous injection). The equipment in this package is designed to reconstitute and inject 
NovoSeven. </p>
<p>You will also need an administration set (tubing and butterfly needle, sterile alcohol swabs, gauze pads and 
plasters). These devices are not included in the NovoSeven package. </p>
<p>Do not use the equipment without proper training from your doctor or nurse. </p>
<p>Always wash your hands and ensure that the area around you is clean. </p>
<p>When you prepare and inject medication directly into the vein, it is important to use a clean and germ free 
...
Protective 
paper </p>
<p>Pre-filled syringe with solvent 
Syringe tip 
(under syringe 
cap) 
Scale 
...
2. Det skal du vide, før du begynder at bruge NovoSeven 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>NovoSeven er en blodkoagulationsfaktor. Det virker hos patienter, hvis egne koagulationsfaktorer ikke 
virker, ved at få blodet til at koagulere på det sted, hvor blødningen er opstået. </p>
<p>NovoSeven anvendes til behandling af blødninger og til forebyggelse af kraftig blødning efter kirurgi 
...
Det anvendes hos bestemte grupper af mennesker: </p>
<ul>
<li>
<p>Hvis du blev født med hæmofili og ikke reagerer normalt på faktor VIII eller IX behandling </p>
</li>
<li>
<p>Hvis du har erhvervet hæmofili </p>
</li>
<li>
<p>Hvis du har faktor VII-mangel </p>
</li>
<li>
<p>Hvis du har Glanzmanns trombasteni (en blødersygdom), og din tilstand ikke kan behandles 
med blodpladetransfusion, eller hvis blodpladerne ikke er tilgængelige. </p>
</li>
</ul>
...
<ul>
<li>
<p>Hvis du er allergisk over for eptacog alfa (det aktive stof i NovoSeven) eller et af de øvrige 
indholdsstoffer i dette lægemiddel (angivet i punkt 6). </p>
</li>
<li>
<p>Hvis du er allergisk over for muse-, hamster- eller okseproteiner (såsom komælk).  </p>
</li>
</ul>
<p>► 
...
Inden behandling med NovoSeven, skal du sikre dig, at din læge har kendskab til: </p>
<ul>
<li>
<p>Hvis du netop har gennemgået en operation </p>
</li>
<li>
<p>Hvis du for nylig har haft en knusningsskade </p>
</li>
<li>
<p>Hvis dine pulsårer er forsnævrede på grund af sygdom (åreforkalkning) </p>
</li>
<li>
<p>Hvis du har en forhøjet risiko for blodpropper (trombose) </p>
</li>
<li>
<p>Hvis du har en alvorlig leversygdom </p>
</li>
<li>
<p>Hvis du har en alvorlig blodforgiftning </p>
</li>
<li>
<p>Hvis du har vist tendens til dissemineret intravaskulær koagulation (DIC, en tilstand, hvor der 
udvikles blodpropper overalt i blodbanen), skal du være under omhyggelig overvågning. </p>
</li>
</ul>
<p>► 
Hvis nogle af disse tilfælde gør sig gældende, kontakt din læge, før du tager en injektion. </p>
<p>Brug af anden medicin sammen med NovoSeven 
Fortæl det altid til lægen eller på apoteket, hvis du bruger anden medicin eller har brugt det for nylig.  </p>
<p>Brug ikke NovoSeven samtidigt med protrombin-kompleks-koncentrater eller rFXIII. Fortæl det altid 
til lægen, inden du bruger NovoSeven, hvis du også bruger factor VIII eller IX produkter. </p>
<p>Der er kun begrænset erfaring med samtidig brug af NovoSeven og antifibrinolytisk medicin (såsom 
aminocapronsyre eller tranexamsyre), som også bruges til at kontrollere blødninger. Kontakt din læge 
inden du bruger NovoSeven med denne type medicin. </p>
<p>Graviditet, amning og frugtbarhed 
Hvis du er gravid eller ammer, har mistanke om, at du er gravid, eller planlægger at blive gravid, skal 
du spørge din læge til råds, før du anvender NovoSeven. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>NovoSeven pulveret skal opblandes med solvensen og injiceres i en vene. Se næste side for en 
detaljeret instruktion. </p>
<p>Ved egenbehandling 
Påbegynd behandling af en blødning så hurtigt som muligt, ideelt indenfor 2 timer. </p>
<ul>
<li>
<p>I tilfælde af svag eller moderat blødning, skal du behandle dig selv så hurtigt som muligt, ideelt 
i hjemmet. </p>
</li>
<li>
<p>I tilfælde af alvorlig blødning skal du kontakte din læge. Normalt behandles alvorlige 
blødninger på hospitalet, og du kan injicere den første NovoSeven dosis på vejen dertil. </p>
</li>
</ul>
<p>Din behandling hjemme må ikke overskride 24 timer uden konsultation hos en læge. </p>
<ul>
<li>
<p>Hver gang du bruger NovoSeven skal du hurtigst muligt indberette dette til din læge eller 
hospitalet. </p>
</li>
<li>
<p>Hvis blødningen ikke er under kontrol indenfor 24 timer, skal du straks kontakte din læge. 
Hospitalsbehandling vil normalt være nødvendig. </p>
</li>
</ul>
<p>Dosis 
...
For at opnå den bedste behandling, skal du følge den ordinerede dosis nøje. Din læge kan ændre dosis. </p>
<p>Hvis du har hæmofili: 
...
erfaring med patienter over 65 år, der anvender denne dosis. </p>
<p>Hvis du har faktor VII-mangel: 
Den normale dosis er 15 til 30 mikrogram per. kilo legemsvægt i hver injektion.  </p>
<p>Hvis du har Glanzmanns trombasteni: 
Den normale dosis er 90 mikrogram (80 til 120 mikrogram) per kilo legemsvægt for hver injektion. </p>
...
<ul>
<li>
<p>Allergi, overfølsomhed eller anafylaktiske reaktioner. Symptomer kan inkludere udslæt på 
huden, kløe, rødme og nældefeber, hiven efter vejret eller vejrtrækningsproblemer, føle sig svag 
eller svimmel, og alvorlig hævelse af læber eller hals, eller ved injektionsstedet. </p>
</li>
<li>
<p>Blodpropper i hjertets årer (som kan føre til hjertetilfælde eller hjertekrampe), i hjernen (som 
...
<ul>
<li>
<p>Blodpropper i venerne i lungerne, benene, leveren, nyrerne eller ved injektionsstedet. 
Symptomer kan inkludere vejrtrækningsproblemer, rød og smertefuld hævelse af benet og 
mavesmerte. </p>
</li>
<li>
<p>Manglende virkning eller nedsat respons på behandling. </p>
</li>
</ul>
<p>► 
Hvis du opdager nogle af disse alvorlige bivirkninger, skal du søge lægehjælp øjeblikkeligt. 
Fortæl at du har brugt NovoSeven. </p>
<p>Fortæl altid lægen, hvis du tidligere har haft allergiske reaktioner, da du måske skal følges mere 
omhyggeligt. I de fleste tilfælde af blodpropper havde patienterne i forvejen tendens til 
blodpropslidelser. </p>
<p>Andre sjældne bivirkninger 
(kan forekomme ved 1 ud af 1.000 behandlinger) </p>
<ul>
<li>
<p>Kvalme (opkast) </p>
</li>
...
<li>
<p>Forandringer i nogle lever- og blodanalyser. </p>
</li>
</ul>
<p>Andre ikke almindelige bivirkninger 
(kan forekomme ved 1 ud af 100 behandlinger) </p>
<ul>
<li>
<p>Allergiske hudreaktioner inklusiv udslæt, kløe og nældefeber </p>
</li>
<li>
<p>Feber. </p>
</li>
...
<li>
<p>Brug ikke dette lægemiddel efter den udløbsdato, der står på pakningen. Udløbsdatoen er den 
sidste dag i den nævnte måned. </p>
</li>
<li>
<p>Pulver og solvens opbevares under 25°C. </p>
</li>
<li>
<p>Pulver og solvens opbevares beskyttet mod lys. </p>
</li>
<li>
<p>Må ikke fryses. </p>
</li>
<li>
<p>Brug NovoSeven straks efter pulveret er opblandet med solvensen for at undgå infektion. Hvis 
...
opbevare opløsningen, hvis du har rådført dig med en læge eller sygeplejerske. </p>
</li>
<li>
...
<ul>
<li>
<p>Aktivt stof: rekombinant koagulationsfaktor VIIa (aktiveret eptacog alfa). </p>
</li>
<li>
<p>Øvrige indholdsstoffer i pulveret: natriumchlorid, kalciumchloriddihydrat, glycylglycin, 
polysorbat 80, mannitol, saccharose, methionin, saltsyre, natriumhydroxid. </p>
</li>
</ul>
<p>Indholdsstoffer i solvensen: histidin, saltsyre, natriumhydroxid, vand til injektionsvæsker. </p>
<p>Pulveret til injektionsvæske, opløsning, indeholder: 1mg/hætteglas (svarende til 50 KIE/hætteglas), 2 
...
1 KIE svarer til 1.000 IE (internationale enheder). </p>
...
opløsning, hvis du opdager, at den indeholder partikler eller hvis den er misfarvet. </p>
<p>Hver NovoSeven pakning indeholder: </p>
<ul>
<li>
<p>1 hætteglas med hvidt pulver til injektionsvæske, opløsning </p>
</li>
<li>
<p>1 hætteglasadaptor </p>
</li>
<li>
<p>1 fyldt sprøjte med solvens til opblanding (rekonstitution) </p>
</li>
<li>
<p>1 stempelstang </p>
</li>
</ul>
<p>Pakningsstørrelser: 1mg (50 KIE), 2 mg (100 KIE), 5 mg (250 KIE) og 8 mg (400 KIE). </p>
...
<p>NovoSeven leveres som pulver. Før injektion (administration) skal det blandes (rekonstitueres) med solvens, 
der leveres i en sprøjte. Solvensen er en histidin opløsning. Det opblandede NovoSeven skal injiceres i en vene 
(intravenøs injektion). Udstyret i denne pakning er designet til at opblande og injicere NovoSeven. </p>
<p>Du behøver desuden et administrationssæt (slange og sommerfuglenål, sterile alkoholservietter, 
gazekompresser og plaster). Dette udstyr er ikke inkluderet i pakningen med NovoSeven. </p>
...
<p>Når du klargør og injicerer et lægemiddel direkte ind i venen, er det vigtigt at anvende en ren og bakteriefri 
(aseptisk) fremgangsmetode. Forkert fremgangsmåde kan forårsage en bakterieinfektion i blodet. </p>
<p>Åbn ikke udstyret, før du er klar til at bruge det.  </p>
<p>Brug ikke udstyret hvis det har været tabt, eller er blevet beskadiget. Tag i stedet en ny pakning i brug. </p>
<p>Brug ikke udstyret hvis udløbsdatoen er overskredet. Tag i stedet en ny pakning i brug. Udløbsdatoen står 
på etiketten efter ’EXP’ på den ydre karton, på hætteglasset, på hætteglasadapteren og på den fyldte sprøjte. </p>
<p>Brug ikke udstyret hvis du har mistanke om, at det er forurenet. Tag i stedet en ny pakning i brug. </p>
<p>Smid ikke nogle af delene ud før du har afsluttet injektionen af den opblandede opløsning. </p>
<p>Udstyret er kun til engangsbrug.  </p>
<p>Indhold </p>
<p>Pakningen indeholder: </p>
<ul>
<li>
<p>1 hætteglas med NovoSeven pulver </p>
</li>
<li>
<p>1 hætteglasadaptor  </p>
</li>
...
<ol>
<li>
<p>Klargøring af hætteglasset og sprøjten </p>
</li>
<li>
<p>Tag det antal NovoSeven pakninger, du behøver.  </p>
</li>
<li>
<p>Kontrollér udløbsdatoen.  </p>
</li>
<li>
<p>Kontrollér navn, styrke og farve på pakningen for 
at sikre at den indeholder det rigtige produkt.  </p>
</li>
<li>
<p>Vask dine hænder og tør dem i et rent håndklæde 
eller lufttør dem. </p>
</li>
<li>
<p>Tag hætteglasset, hætteglasadapteren og den fyldte 
sprøjte ud af kartonen. Lad stempelstangen forblive 
urørt i kartonen. </p>
</li>
<li>
<p>Hætteglasset og den fyldte sprøjte skal have 
stuetemperatur (ikke over 37°C). Du kan gøre dette </p>
</li>
</ol>
<p>A </p>
<p>ved at holde dem i dine hænder, indtil de føles lige så 
varme som dine hænder.  </p>
<ul>
<li>
<p>Der må ikke benyttes andre metoder til at varme 
hætteglasset og den fyldte sprøjte. </p>
</li>
<li>
<p>Fjern plastikhætten fra hætteglasset.<br />
Brug ikke hætteglasset, hvis plastikhætten 
mangler eller sidder løst. </p>
</li>
<li>
<p>Tør gummiproppen på hætteglasset af med en steril 
alkoholserviet og lad den lufttørre i nogle sekunder 
før brug, for at sikre at den er så bakteriefri som 
muligt. </p>
</li>
<li>
<p>Rør ikke ved gummiproppen med dine fingre, da 
dette kan overføre bakterier.  </p>
</li>
</ul>
<p>B </p>
<ol>
<li>
<p>Påsæt hætteglasadaptoren </p>
</li>
<li>
<p>Fjern beskyttelsespapiret fra hætteglasadaptoren. </p>
</li>
</ol>
<p>Brug ikke hætteglasadaptoren, hvis 
beskyttelsespapiret ikke er helt forseglet eller er 
ødelagt.  </p>
<p>Fjern ikke beskyttelseshætten på 
hætteglasadaptoren med dine fingre. Hvis du rører 
spidsen af hætteglasadaptoren, kan det overføre 
bakterier fra dine fingre. </p>
<p>C </p>
<ul>
<li>
<p>Placér hætteglasset på en flad og fast overflade. </p>
</li>
<li>
<p>Drej beskyttelseshætten på og klik 
hætteglasadaptoren fast på hætteglasset.  </p>
</li>
</ul>
<p>Fjern ikke hætteglasadaptoren fra hætteglasset, 
efter den er påsat.  </p>
<p>D </p>
<ul>
<li>Tryk let på beskyttelseshætten med tommel- og 
pegefinger som vist på figuren. 
Fjern beskyttelseshætten fra hætteglasadaptoren. </li>
</ul>
<p>Løft ikke hætteglasadaptoren op fra hætteglasset, 
når du fjerner beskyttelseshætten. </p>
<p>E </p>
<ol>
<li>
...
<li>
<p>Tag fat i stempelstangen ved den brede ende, og tag 
...
<p>Sæt straks stempelstangen ind i sprøjten, ved at dreje 
den med uret ind i den fyldte sprøjte, indtil der 
mærkes modstand. </p>
<p>F </p>
<ul>
<li>Fjern hætten fra sprøjten ved at bøje den ned, indtil 
perforeringen knækker. </li>
</ul>
<p>Rør ikke ved sprøjtens spids. Hvis du rører ved 
sprøjtens spids, kan det overføre bakterier fra dine 
fingre. </p>
<p>Brug ikke sprøjten, hvis hætten er løs eller 
mangler. </p>
<p>G </p>
<ul>
<li>Skru den fyldte sprøjte fast på hætteglasadaptoren, 
indtil der mærkes modstand. </li>
</ul>
<p>H </p>
<ol>
<li>
...
<li>
<p>Pres stempelstangen ned for at injicere al solvensen 
ind i hætteglasset. </p>
</li>
</ol>
<p>I </p>
<ul>
...
hvirvles forsigtigt rundt, indtil alt pulveret er opløst.<br />
Ryst ikke hætteglasset, da dette vil medføre 
skumdannelse. </p>
</li>
<li>
<p>Tjek den opblandede injektionsvæske. Den skal 
være farveløs. Brug den ikke, hvis der er visuelle 
partikler eller misfarvning. Brug en ny pakning i 
stedet.  </p>
</li>
</ul>
<p>J </p>
