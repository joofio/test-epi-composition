...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What NovoThirteen is 
NovoThirteen contains the active substance catridecacog, which is identical to human coagulation 
factor XIII, an enzyme necessary for blood clotting. NovoThirteen replaces the missing factor XIII and 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>It is important that you use NovoThirteen for injection immediately after preparation. </p>
<p>Do not use NovoThirteen 
* If you are allergic to catridecacog or any of the other ingredients of this medicine (listed in 
section 6). </p>
<p>If you are not sure, ask your doctor before using this medicine. </p>
<p>Warnings and precautions 
Talk to your doctor before using NovoThirteen: 
* If you have or have ever had a higher risk of blood clots forming (thrombosis), as NovoThirteen 
may increase the severity of a pre-existing blood clot. 
* If you have or have ever had liver damage. </p>
<p>Contact your doctor immediately: 
* If you experience bleeding during your treatment with NovoThirteen occurring spontaneously 
and/or requiring treatment. 
* If you experience an allergic reaction to NovoThirteen. The signs may include: hives, itching, 
swelling, difficulty breathing, low blood pressure (signs include paleness and coldness of skin, 
rapid heartbeat), feeling dizzy and sweating. </p>
<p>Other medicines and NovoThirteen 
Tell your doctor if you are using, have recently used or might use any other medicines. 
It is not recommended to use NovoThirteen and recombinant coagulation factor VIIa (another blood 
clotting factor) together. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Your treatment with NovoThirteen should be initiated by a doctor experienced in the treatment of rare 
bleeding disorders. 
Always use this medicine exactly as your doctor has told you. Check with your doctor if you are not 
sure. </p>
<p>Before you can use NovoThirteen for injection you need to reconstitute the product. Please see 
...
can be calculated from this formula:<br />
Dose volume in millilitres = 0.042 x your body weight in kilograms. </p>
<p>You should only use the prescribed dose calculated by your doctor from this formula considering that 
the usual dose and the concentration of NovoThirteen are different from those of the other products 
which contain factor XIII.<br />
...
NovoThirteen can be used in children and adolescents in the same way as in adults for both prevention 
of bleeds and if you experience a bleed. </p>
<p>If you use more NovoThirteen than you should 
There is limited information on overdose with NovoThirteen. None of the reported cases have shown 
any signs of illness. Contact your doctor if you have injected more NovoThirteen than you have been 
instructed. </p>
<p>If you forget to use NovoThirteen 
If you forget an injection of NovoThirteen, talk to your doctor. Do not take a double dose to make up 
for a forgotten dose. </p>
<p>If you stop using NovoThirteen 
...
* A drop in the number of some types of white blood cells. This means your body may be more 
prone to infections 
* Development of antibodies against factor XIII which have no influence on the effect of the drug. </p>
<p>Side effects in children: 
The side effects observed in children are the same as also observed in adults but the side effects may 
be more common in children than in adults. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What NovoThirteen contains 
* The active substance is catridecacog (recombinant coagulation factor XIII: 2500 IU/3 ml, after 
reconstitution, corresponding to a concentration of 833 IU/ml. 
* The other ingredients are for the powder sodium chloride, sucrose and polysorbate 20, 
L-histidine, hydrochloric acid (for pH-adjustment), sodium hydroxide (for pH adjustment) and 
for the solvent water for injections. </p>
