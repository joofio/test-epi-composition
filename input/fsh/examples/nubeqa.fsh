...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not take NUBEQA if 
- you are allergic to darolutamide or any of the other ingredients of this medicine (listed in 
section 6) 
- you are a woman who is or may become pregnant. </p>
<p>Warnings and precautions 
Talk to your doctor or pharmacist before taking NUBEQA if 
- you have problems with your kidneys 
- you have problems with your liver 
- you have any heart conditions including heart rhythm problems or if you are using medicines 
for these conditions 
- you had a surgery to treat blood vessel conditions. </p>
<p>Taking this medicine may affect your liver tests. If your blood tests show abnormal results of your 
liver function, your doctor may decide to stop treatment permanently. </p>
<p>Children and adolescents 
This medicine is not for use in children and adolescents under 18 years. Prostate cancer does not occur 
in this age group. </p>
<p>Other medicines and NUBEQA 
...
Continue the treatment with the next dose as scheduled. </p>
<p>If you forget to take NUBEQA 
Take your missed dose as soon as you remember before the next scheduled dose. Do not take a double 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>NUBEQA indeholder det aktive stof darolutamid.
Det anvendes til at behandle voksne mænd med prostatakræft, som:
-
ikke har spredt sig til andre dele af kroppen, og som ikke længere reagerer på medicinsk eller 
kirurgisk behandling, der sænker testosteron (også kaldet ikke-metastatisk kastrationsresistent 
prostatakræft)
-
har spredt sig til andre dele af kroppen og reagerer på medicinsk eller kirurgisk behandling, der 
sænker testosteron (også kaldet metastatisk hormonfølsom prostatakræft).
Sådan virker NUBEQA
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <h2>Tag ikke NUBEQA, hvis</h2>
<p>du er allergisk over for darolutamid eller et af de øvrige indholdsstoffer i NUBEQA (angivet i 
punkt 6).
-
...
- du har en hjertesygdom, herunder problemer med hjerterytmen, eller hvis du tager lægemidler 
mod sådanne sygdomme 
- du har fået en operation for at behandle blodkarsygdomme. </p>
<p>Dette lægemiddel kan påvirke dine leverprøver. Hvis dine blodprøver viser unormale resultater for din 
leverfunktion, kan din læge beslutte at stoppe behandlingen permanent. </p>
<p>Børn og unge 
Dette lægemiddel må ikke anvendes til børn og unge under 18 år. Prostatakræft forekommer ikke hos 
denne aldersgruppe. </p>
<p>Brug af andre lægemidler sammen med NUBEQA 
...
<p>De følgende lægemidler kan påvirke NUBEQAs virkning, eller NUBEQA kan påvirke disse 
lægemidler virkning ved behandling af:</p>
<ul>
<li>bakterieinfektioner, såsom rifampicin </li>
<li>epilepsi, såsom carbamazepin, phenobarbital, phenytoin </li>
<li>symptomer på let nedtrykthed og mild angst: prikbladet perikon (et naturlægemiddel) </li>
<li>højt kolesterol, såsom rosuvastatin, fluvastatin, atorvastatin, pitavastatin </li>
<li>svær ledbetændelse, svære tilfælde af hudsygdommen psoriasis og kræftformer: methotrexat </li>
...
- Anvend en meget sikker præventionsmetode for at undgå graviditet, hvis du dyrker sex med en 
kvinde, der kan blive gravid. 
- Brug et kondom for at beskytte det ufødte barn, hvis du dyrker sex med en gravid kvinde. </p>
...
2 tabletter 2 gange dagligt </p>
<p>Lægen kan nedsætte din dosis til 1 tablet 2 gange dagligt, hvis du har lever- eller nyreproblemer. </p>
<p>Anvendelsesmåde 
Slug tabletterne hele, tag dem sammen med mad og et glas vand. </p>
<p>Lægen kan også ordinere andre lægemidler, mens du tager NUBEQA. </p>
<p>Hvis du har taget for meget NUBEQA 
Fortsæt behandlingen med den næste planlagte dosis. </p>
<p>Hvis du har glemt at tage NUBEQA 
Tag din glemte dosis så snart du husker det, før den næste planlagte dosis. Du må ikke tage en 
...
<ul>
<li>træthed </li>
<li>blodprøver viser et nedsat antal af hvide blodlegemer af typen, der kaldes for neutrofiler </li>
<li>blodprøver viser forhøjede niveauer af stoffer, der dannes af leveren: bilirubin, 
aspartattransaminase </li>
</ul>
...
<p>Hos patienter med metastatisk hormonfølsom prostatakræft 
Meget almindelige bivirkninger (kan forekomme hos flere end 1 ud af 10 personer):</p>
<ul>
<li>forhøjet blodtryk </li>
<li>udslæt </li>
<li>blodprøver viser et nedsat antal hvide blodlegemer af typen, der kaldes for neutrofiler </li>
<li>blodprøver viser forhøjede niveauer af stoffer, der dannes af leveren: bilirubin, 
alanintransaminase og aspartattransaminase </li>
</ul>
<p>Almindelige bivirkninger (kan forekomme hos op til 1 ud af 10 personer):</p>
<ul>
<li>knoglebrud </li>
...
<p>Brug ikke lægemidlet efter den udløbsdato, der står på æsken og hver blister efter EXP. Udløbsdatoen 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>NUBEQA indeholder: 
...
De filmovertrukne tabletter (tabletter) er hvide til råhvide, ovale tabletter med en længde på 16 mm og 
en bredde på 8 mm. De er præget med "300 "på den ene side, og med "BAYER "på den anden side. </p>
...
BETINGELSERNE 
FOR MARKEDSFØRINGSTILLADELSEN </p>
<p>Videnskabelige konklusioner </p>
<p>Under hensyntagen til PRAC's vurderingsrapport om PSUR'en/PSUR'erne for darolutamid er PRAC 
nået frem til følgende videnskabelige konklusioner: </p>
<p>I lyset af tilgængelige data om hepatotoksicitet og leverfunktionsprøver fra kliniske studier og 
spontane indberetninger mener PRAC, at den nuværende advarsel om hepatotoksicitet og beskrivelse 
af leverfunktionsprøver bør styrkes. PRAC har konkluderet, at produktinformationen for produkter, 
der indeholder darolutamid, skal ændres i henhold hertil. </p>
