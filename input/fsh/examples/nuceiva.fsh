...
Instance: composition-en-1fbb86a1ee3583c2169c9930c1d58b96
...
* subject = Reference(mp1a48eccd0a6ff68f8eb4829a401a2d93)
...
* title = "TEST PURPOSES ONLY - nuceiva"
...
<ol>
<li>What NUCEIVA is and what it is used for  </li>
<li>What you need to know before NUCEIVA is used </li>
<li>How to use NUCEIVA  </li>
<li>Possible side effects  </li>
<li>How to store NUCEIVA  </li>
<li>Contents of the pack and other information </li>
</ol>         </div>"""   
          

* section[=].section[+]
  * title =  "1. What nuceiva is and what it is used for"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text =  "1. What nuceiva is and what it is used for"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>NUCEIVA contains the active substance botulinum toxin type A. 
It prevents muscles from contracting, leading to a temporary paralysis. It works by blocking the nerve 
impulses to the muscles in which it has been injected. </p>
<p>NUCEIVA is used for the temporary improvement in the appearance of vertical lines between the 
eyebrows. It is used in adults less than 65 years of age in whom those facial lines have an important 
psychological impact. </p>         </div>"""   
          

             
* section[=].section[+]
  * title = "2. What you need to know before you take nuceiva"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
...
receiving recommended doses may have exaggerated muscle weakness. </p>
<p>Visit your doctor immediately if you find it difficult to swallow, to speak or to breathe after treatment.  </p>
<ul>
<li>NUCEIVA is not recommended in patients who have had problems swallowing (dysphagia) and 
breathing. </li>
<li>Too frequent or excessive dosing may lead to antibody formation. Antibody formation can stop 
...
medicines.  </p>
<p>The use of botulinum toxin is not recommended in association with aminoglycoside antibiotics, 
spectinomycin or other medicines that interfere with nerve impulses to the muscle. </p>
<p>Tell your doctor if you have recently been injected with a medicine containing botulinum toxin (the 
active substance of NUCEIVA), as this may increase the effect of NUCEIVA excessively. </p>
...
<p>The use of NUCEIVA is not recommended during pregnancy and in women able to have children who 
are not using contraception.  </p>
<p>NUCEIVA is not recommended in breast-feeding women. </p>
<p>Driving and using machines </p>
<p>Muscle weakness, dizziness, and visual disturbance with this medicine could make driving or the use 
...
* section[=].section[+]
  ...
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "3. How to take nuceiva"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Unit doses for NUCEIVA are not interchangeable with those used for other preparations of botulinum 
toxin. </p>
...
effects are of mild to moderate severity. </p>
<p>If you have any difficulty in breathing, swallowing or speaking after receiving NUCEIVA contact 
your doctor immediately.  </p>
<p>If you get hives, swelling, including swelling of the face or throat, wheezing, feeling faint or shortness 
of breath, contact your doctor immediately. </p>
<p>The chance of having a side effect is described by the following categories: </p>
<p>Common </p>
<p>(May affect up to 1 
in 10 people) 
Headache, muscle imbalance resulting in elevated or asymmetrical eyebrows, 
eyelid drooping, injection site bruise 
Uncommon  </p>
<p>(May affect up to 1 
in 100 people) 
Sensory disturbance, head discomfort, dry eye, eyelid swelling, eye swelling, 
muscle twitching, injection site: redness, pain, tingling </p>
...
Instance: mp1a48eccd0a6ff68f8eb4829a401a2d93
InstanceOf: MedicinalProductDefinitionUvEpi
Title: "Medicinal Product NUCEIVA 50 Units powder for solution for injection"
Description: "NUCEIVA 50 Units powder for solution for injection"
Usage: #inline

 
* identifier[+].system = "http://ema.europa.eu/identifier"
* identifier[=].value = "EU/1/19/1364/001"
...
* indication = "NUCEIVA is indicated for the temporary improvement in the appearance of moderate to severe"
...
* name
  * productName = "NUCEIVA 50 Units powder for solution for injection"
...
// MPD
* entry[+].fullUrl = "MedicinalProductDefinition/mp1a48eccd0a6ff68f8eb4829a401a2d93"
* entry[=].resource = mp1a48eccd0a6ff68f8eb4829a401a2d93
