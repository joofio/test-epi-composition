...
* ezetimibe works in your bowel by reducing the amount of cholesterol absorbed from food. </p>
<p>What Nustendi is used for </p>
<p>Nustendi is given to adults with primary hypercholesterolaemia or mixed dyslipidaemia, which are 
...
cholesterol) together with ezetimibe and this does not lower your LDL-cholesterol sufficiently; 
* if you have been using ezetimibe and this does not lower your LDL-cholesterol sufficiently; 
* to replace bempedoic acid and ezetimibe if you have been using these medicines as separate 
tablets. </p> </div>"""   
...
<ul>
<li>if you are allergic to bempedoic acid, ezetimibe or any of the other ingredients of this medicine 
...
<li>Nustendi contains ezetimibe. When Nustendi is given together with a statin, you should also 
read the information relating to ezetimibe in the Package leaflet of that specific statin. </li>
</ul>
<p>Warnings and precautions </p>
<p>Talk to your doctor or pharmacist before taking Nustendi: 
* if you ever had gout; 
* if you have severe kidney problems; 
* if you have moderate or severe liver problems. Nustendi is not recommended in this case. </p>
<p>Your doctor should do a blood test before you start taking Nustendi with a statin. This is to check how 
well your liver is working. </p>
<p>Children and adolescents </p>
<p>Do not give Nustendi to children and adolescents under 18 years of age. The use of Nustendi has not 
...
The risk of muscle disease may increase when taking both a statin and Nustendi. Tell your 
...
No information is available on the effects of using Nustendi with cholesterol-lowering 
...
* medicines to prevent blood clots, such as warfarin as well as acenocoumarol, fluindione, and 
phenprocoumon. </p>
...
call your doctor immediately and stop taking Nustendi. </p>
<ul>
<li>Pregnancy 
...
<p>If, after you have started treatment with Nustendi, you decide that you would like to become 
pregnant, tell your doctor, as your treatment will need to be changed. </p>
<ul>
<li>Breast-feeding 
Do not take Nustendi if you are breast-feeding because it is not known if Nustendi passes into 
milk. </li>
</ul>
<p>Driving and using machines </p>
<p>Nustendi has minor influence on the ability to drive and use machines. </p>
<p>However, some people may get dizzy after taking Nustendi. Avoid driving or using machines if you 
think your ability to react is reduced. </p>
...
<p>If you are taking colestyramine, take Nustendi either at least 2 hours before or at least 4 hours after 
taking colestyramine. </p>
...
<p>Contact your doctor immediately if you have any of the following serious side effects (frequencies 
are unknown): 
* muscle pain or weakness 
* yellowish skin and eyes, abdominal pain, dark urine, swollen ankles, decreased appetite, and 
feeling tired that could be signs of liver problems 
* allergic reactions including rash and hives; raised red rash, sometimes with target-shaped lesions 
(erythema multiforme) 
* gallstones or inflammation of the gallbladder (which may cause abdominal pain, nausea, 
vomiting), inflammation of the pancreas often with severe abdominal pain 
* reduction in blood platelets, which may cause bruising/bleeding (thrombocytopenia) </p>
...
* muscle spasm, muscle pain, pain in shoulders, legs or arms, back pain, blood test showing raised 
creatine kinase (a laboratory test of muscle damage), muscle weakness, joint pain (arthralgia) 
* raised creatinine and blood urea nitrogen (laboratory tests of kidney function) 
* unusual tiredness or weakness </p>
