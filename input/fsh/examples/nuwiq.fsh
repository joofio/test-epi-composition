...
Instance: composition-en-79541d402cce9addf4bbd477616da529
...
* title = "TEST PURPOSES ONLY - nuwiq"
...
* section[=].section[+]
  * title =  "1. What nuwiq is and what it is used for"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text =  "1. What nuwiq is and what it is used for"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Nuwiq contains the active substance human recombinant coagulation factor VIII (simoctocog alfa). 
...
with haemophilia A and can be used for all age groups.  </p>         </div>"""   
          

             
* section[=].section[+]
  * title = "2. What you need to know before you take nuwiq"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "2. What you need to know before you take nuwiq"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not use Nuwiq 
...
Talk to your doctor before using Nuwiq. </p>
...
you or your child s bleeding is not being controlled with Nuwiq, tell your doctor immediately. </p>
...
<p>It is important to keep a record of the batch number of your Nuwiq. </p>
<p>So, every time you get a new package of Nuwiq, note down the date and the batch number (which is 
on the packaging after Lot) and keep this information in a safe place. </p>
<p>Other medicines and Nuwiq 
...
Nuwiq has no influence on your ability to drive and use machines.  </p>
<p>Nuwiq contains sodium 
...
* section[=].section[+]
  * title =  "3. How to take nuwiq"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "3. How to take nuwiq"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Treatment with Nuwiq will be started by a doctor who is experienced in the care of patients with 
...
<p>Nuwiq is usually injected into a vein (intravenously) by your doctor or a nurse who are experienced in 
the care of patients with haemophilia A. You or someone else might also give your Nuwiq injection, 
but only after receiving adequate training. </p>
<p>Your doctor will calculate your dose of Nuwiq (in international units = IU) depending on your 
...
haemophilia A is a life-long treatment. </p>
...
increase the total dose of Nuwiq to control your bleeding without consulting your doctor. </p>
...
access to the bloodstream through a catheter without injection through the skin. </p>
<p>If you use more Nuwiq than you should 
No symptoms of overdose have been reported. If you have injected more Nuwiq than you should, 
please inform your doctor. </p>
<p>If you forget to use Nuwiq 
...
<p>If you stop using Nuwiq 
Do not stop using Nuwiq without consulting your doctor. </p>
...
* section[=].section[+]
  * title = "5. How to store nuwiq"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "5. How to store nuwiq"
  * text.status = #additional
...
<p>Before the Nuwiq powder is reconstituted, it may be kept at room temperature (up to 25  C) for a 
...
at room temperature. 
Use the reconstituted solution immediately after reconstitution. </p>
<p>Do not use the medicine in case you notice visible signs of deterioration of the tamper proof of 
packaging especially of the syringe and/or the vial. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Nuwiq contains 
Powder:</p>
<ul>
<li>The active substance is recombinant human coagulation factor VIII (simoctocog alfa).<br />
Each powder vial contains 250, 500, 1000, 1500, 2000, 2500, 3000 or 4000 IU of simoctocog 
alfa. 
Each reconstituted solution contains approximately 100, 200, 400, 600, 800, 1000, 1200 or 
...
<p>What Nuwiq looks like and contents of the pack 
...
<p>Each pack of Nuwiq contains:</p>
<ul>
<li>1 powder vial with 250, 500, 1000, 1500, 2000, 2500, 3000 or 4000 IU simoctocog alfa </li>
...
rubber stopper. Do not remove the gray stopper or metal ring around the top of the vial.  </p>
</li>
<li>
<p>Wipe the top of the vial with an alcohol swab. Allow the alcohol to dry.  </p>
</li>
<li>
<p>Peel back the paper cover from the vial adapter package. Do not remove the adapter from the 
package.  </p>
</li>
<li>
...
plunger. Turn the plunger rod clockwise until a slight resistance is felt. </p>
</li>
<li>
<p>Break off the tamper-proof plastic tip from the solvent syringe by snapping the perforation of 
the cap. Do not touch the inside of the cap or the syringe tip. In case the solution is not used 
immediately close the filled syringe with the tamper-proof plastic tip for storage. </p>
</li>
<li>
...
<li>Visually inspect the final solution for particles before administration. The solution should be 
clear and colourless, practically free from visible particles. Do not use solutions that are 
cloudy or have deposits. </li>
<li>
...
<li>
<p>Detach the filled syringe from the vial adapter by turning counter clockwise and discard the 
empty vial. </p>
</li>
<li>The solution is now prepared for immediate use. Do not refrigerate. </li>
...
No blood must flow into the syringe due to the risk of formation of fibrin clots. </li>
...
Instance: composition-da-79541d402cce9addf4bbd477616da529
InstanceOf: CompositionUvEpi
Title: "Composition for nuwiq Package Leaflet"
Description:  "Composition for nuwiq Package Leaflet"
Usage: #inline
...
<li>Det skal du vide, før du begynder at bruge Nuwiq </li>
<li>Sådan skal du bruge Nuwiq </li>
<li>Bivirkninger </li>
<li>Opbevaring </li>
...
* section[=].section[+]
  ...
  * code.text =  "1. What nuwiq is and what it is used for"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Nuwiq indeholder det aktive stof human rekombinant koagulationsfaktor VIII (simoctocog alfa). 
...
patienter med hæmofili A og kan anvendes til alle aldersgrupper.  </p>         </div>"""   
...
* section[=].section[+]
  ...
  * code.text = "2. What you need to know before you take nuwiq"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Brug ikke Nuwiq </p>
<ul>
...
Kontakt lægen, før du bruger Nuwiq. </p>
...
straks til lægen, hvis din eller dit barns blødning ikke holdes under kontrol med Nuwiq. </p>
...
<p>Det er vigtigt at registrere batchnummeret for dit Nuwiq. 
Så hver gang, du får en ny pakning med Nuwig, skal du registrere datoen og batchnummeret (som er 
på emballagen efter Lot, og gemme disse oplysninger på et sikkert sted). </p>
<p>Brug af anden medicin sammen med Nuwiq 
...
Nuwiq påvirker ikke eller kun i ubetydelig grad evnen til at føre motorkøretøj og betjene maskiner.  </p>
<p>Nuwiq indeholder natrium 
...
* section[=].section[+]
  ...
  * code.text = "3. How to take nuwiq"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Behandlingen med Nuwiq iværksættes af en læge, der har erfaring med behandlingen af hæmofili A-
...
<p>Nuwiq sprøjtes normalt ind i en blodåre (intravenøst) af lægen eller sygeplejersken, der har erfaring 
med behandlingen af hæmofili A-patienter. Du, eller en anden, kan også selv foretage indsprøjtningen 
af Nuwiq, men kun efter at have modtaget passende instruktion. </p>
<p>Lægen udregner din Nuwiq-dosis i internationale enheder (IE) i forhold til din helbredstilstand og din 
...
behandling for hæmofili A en livslang behandling. </p>
...
befinder sig.  </p>
<p>Hvis du har indtryk af, at virkningen af Nuwiq ikke er tilstrækkelig, skal du kontakte lægen. Lægen 
foretager passende laboratorieundersøgelser for at sikre sig, at du har de ønskede faktor VIII-niveauer. 
Dette er især vigtigt, hvis du skal have foretaget et større kirurgisk indgreb. </p>
...
til blodbanen gennem et kateter, uden at der skal injiceres gennem huden. </p>
<p>Hvis du har brugt for meget Nuwiq 
Der er ikke indberettet nogen symptomer på overdosering. Hvis du har injiceret for meget Nuwiq, skal 
du kontakte lægen. </p>
<p>Hvis du har glemt at tage Nuwiq 
...
<p>Hvis du holder op med at bruge Nuwiq 
Du må ikke holde op med at bruge Nuwiq uden at have rådført dig med lægen. </p>
...
eller der opstår hyppige blødninger) 
...
<p>Inden rekonstitution kan Nuwiq pulveret opbevares ved stuetemperatur (op til 25 °C) i en enkelt 
periode på højst 1 måned. Notér datoen for, hvornår opbevaring af Nuwiq ved stuetemperatur 
påbegyndes, på æsken. Opbevar ikke Nuwiq i køleskab, efter at det har været opbevaret ved 
stuetemperatur. 
...
* section[=].section[+]
  ...
  * code.text = "6. Contents of the pack and other information"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Nuwiq indeholder: 
Pulver:</p>
<ul>
<li>Aktivt stof: rekombinant human koagulationsfaktor VIII (simoctocog alfa).<br />
Hvert hætteglas med pulver indeholder 250, 500, 1000, 1500, 2000, 2500, 3000 eller 4000 IE 
simoctocog alfa. 
Hver rekonstitueret opløsning indeholder ca. 100, 200, 400, 600, 800, 1.000, 1.200 eller 
1.600 IE/ml simoctocog alfa. </li>
...
<p>Hver pakning Nuwiq indeholder:</p>
<ul>
<li>1 hætteglas med pulver indeholder 250, 500, 1000, 1500, 2000, 2500, 3000 eller 4000 IE 
simoctocog alfa </li>
...
<li>
<p>Fjern beskyttelsespapiret fra pakningen med hætteglasadapteren. Fjern ikke adapteren fra 
pakningen.  </p>
</li>
<li>
...
stempel. Drej stempelstangen med uret, indtil du føler lidt modstand. </p>
</li>
<li>
<p>Fjern den forseglede plastspids på solvenssprøjten ved at bryde perforeringen på låget. Rør 
ikke indersiden af låget eller spidsen af injektionssprøjten. Hvis opløsningen ikke bruges 
straks, skal den fyldte injektionssprøjte lukkes med den forseglede plastspids til opbevaring. </p>
</li>
<li>
<p>Pakningen til adapteren fjernes og kasseres. </p>
</li>
<li>
...
<li>Efterse den færdige opløsning for partikler, før den indgives. Opløsningen skal være klar og 
...
<li>
<p>Fjern den fyldte injektionssprøjte fra hætteglasadapteren ved at dreje mod uret, og kassér 
det tomme hætteglas. </p>
</li>
<li>Opløsningen er nu klar til brug med det samme. Må ikke opbevares i køleskab. </li>
...
Før kanylen på infusionssættet ind i den valgte blodåre. Hvis du har brugt en staseslange 
...
injektionskanyle. Adapteren til hætteglasset og injektionssprøjten er kun til engangsbrug. </p>         </div>"""      
...
// MPD
* entry[+].fullUrl = "MedicinalProductDefinition/mp79541d402cce9addf4bbd477616da529"
* entry[=].resource = mp79541d402cce9addf4bbd477616da529
                            
                    
Instance: bundlepackageleaflet-da-79541d402cce9addf4bbd477616da529
InstanceOf: BundleUvEpi
Title: "ePI document Bundle for nuwiq Package Leaflet for language da"
Description: "ePI document Bundle for nuwiq Package Leaflet for language da"
Usage: #example
...
// Composition
* entry[0].fullUrl = "Composition/composition-da-79541d402cce9addf4bbd477616da529"
* entry[0].resource = composition-da-79541d402cce9addf4bbd477616da529
...
Instance: mp79541d402cce9addf4bbd477616da529
InstanceOf: MedicinalProductDefinitionUvEpi
Title: "Medicinal Product nuwiq"
Description: "nuwiq"
Usage: #inline
...
RuleSet: 79541d402cce9addf4bbd477616da529ListRuleset

* identifier.system = "http://ema.europa.eu/identifier" 
* identifier.value = "None"
* identifier[+].system = "http://spor.ema.europa.eu/v2/medicine-name"
* identifier[=].value = "nuwiq"
...
* entry
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-en-79541d402cce9addf4bbd477616da529) // nuwiq en
...
* entry
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-da-79541d402cce9addf4bbd477616da529) // nuwiq da
  * item.extension[0].url = "http://ema.europa.eu/fhir/extension/documentType"
  * item.extension[=].valueCoding = $100000155531#100000155538 "B. PACKAGE LEAFLET"
  * item.extension[+].url = "http://ema.europa.eu/fhir/extension/language"
...
Instance: List-79541d402cce9addf4bbd477616da529
InstanceOf: List

* insert 79541d402cce9addf4bbd477616da529ListRuleset
