...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Onbrez Breezhaler is 
Onbrez Breezhaler contains the active substance indacaterol which belongs to a group of medicines 
...
<p>What Onbrez Breezhaler is used for 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not use Onbrez Breezhaler 
- if you are allergic to indacaterol or any of the other ingredients of this medicine (listed in 
section 6). </p>
<p>Warnings and precautions 
Talk to your doctor or pharmacist before using Onbrez Breezhaler </p>
<p>if you have asthma (in this case you should not use Onbrez Breezhaler). </p>
...
not improve or get worse. </p>
<p>Children and adolescents 
Onbrez Breezhaler should not be given to children or adolescents below the age of 18 years. </p>
<p>Other medicines and Onbrez Breezhaler 
Tell your doctor or pharmacist if you are taking, have recently taken or might take any other 
medicines. 
In particular, please tell your doctor if you are using: </p>
<p>medicines for breathing problems that are similar to Onbrez Breezhaler (i.e. medicines such as 
...
<p>You should not use Onbrez Breezhaler unless your doctor tells you so. </p>
...
<p>In this pack, you will find an inhaler and capsules (in blisters) that contain the medicine as 
inhalation powder. The Onbrez Breezhaler inhaler enables you to inhale the medicine contained 
in a capsule. </p>
<p>Only use the capsules with the inhaler provided in this pack (Onbrez Breezhaler inhaler). The 
capsules should remain in the blister until you need to use them. </p>
<p>When you start a new pack, use the new Onbrez Breezhaler inhaler that is supplied in the pack. </p>
...
use the inhaler. </p>
<p>If you use more Onbrez Breezhaler than you should 
If you have inhaled too much Onbrez Breezhaler or if someone else uses your capsules, tell your 
doctor immediately or go to the nearest emergency unit. Show the pack of Onbrez Breezhaler. Medical 
attention may be needed. You may notice that your heart is beating faster than usual, or you may have 
a headache, feel drowsy, feel nauseous or have to vomit. </p>
<p>If you forget to use Onbrez Breezhaler 
...
<p>Keep using your treatment with Onbrez Breezhaler for as long as your doctor tells you. </p>
<p>COPD is a long-term disease and you should use Onbrez Breezhaler every day and not only 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Onbrez Breezhaler contains 
- Each Onbrez Breezhaler 150 microgram capsule contains 150 microgram indacaterol as 
indacaterol maleate. The other ingredients include lactose and the capsule is made of gelatin. 
- Each Onbrez Breezhaler 300 microgram capsule contains 300 microgram indacaterol as 
indacaterol maleate. The other ingredients include lactose and the capsule is made of gelatin. </p>
<p>What Onbrez Breezhaler looks like and content of the pack 
...
<p>Onbrez Breezhaler 150 microgram capsules have a black product code  IDL 150  printed 
above a black bar and a black company logo (
) printed below the black bar. </p>
<p>Onbrez Breezhaler 300 microgram capsules have a blue product code  IDL 300  printed above 
a blue bar and a blue company logo (
...
Onbrez Breezhaler indeholder det aktive stof indacaterol, som tilhører en gruppe lægemidler, der 
...
<p>Anvendelse 
Onbrez Breezhaler bruges til at lette vejrtrækningen hos voksne patienter, som lider af 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Tag ikke Onbrez Breezhaler 
- hvis du er allergisk over for indacaterol eller et af de øvrige indholdsstoffer i Onbrez Breezhaler 
(angivet i punkt 6). </p>
...
<p>Under behandling med Onbrez Breezhaler: 
 
...
<p>Børn og unge 
Onbrez Breezhaler må ikke gives til børn eller unge under 18 år. </p>
<p>Brug af anden medicin sammen med Onbrez Breezhaler 
...
 
medicin mod åndedrætsbesvær, som svarer til Onbrez Breezhaler (fx medicin, såsom salmeterol 
...
<p>Du må ikke tage Onbrez Breezhaler, medmindre du har aftalt det med din læge. </p>
...
apotekspersonalet. </p>
<p>Så meget Onbrez Breezhaler skal du tage 
 
...
<p>Sådan skal du tage Onbrez Breezhaler 
 
Denne pakning indeholder en inhalator og kapsler (i blister), som indeholder medicinen i form 
af et inhalationspulver. Onbrez Breezhaler-inhalatoren skal du bruge til at inhalere medicinen i 
kapslen. 
 
Brug kun kapslerne sammen med den vedlagte inhalator (Onbrez Breezhaler-inhalator). 
Kapslerne skal forblive i blisteren, indtil de skal bruges. 
 
Når du starter på en ny pakning, skal du bruge den nye Onbrez Breezhaler-inhalator, som er 
vedlagt pakningen. 
 
...
<p>Hvis du har taget for meget Onbrez Breezhaler 
Hvis du har inhaleret for meget Onbrez Breezhaler, eller hvis en anden person bruger dine kapsler, 
skal du straks fortælle det til din læge eller henvende dig på den nærmeste skadestue. Vis dem 
pakningen med Onbrez Breezhaler. Lægebehandling kan være nødvendig. Du kan opleve, at dit hjerte 
slår hurtigere end normalt, eller du kan få hovedpine, føle dig sløv, have kvalme eller kaste op. </p>
<p>Hvis du har glemt at tage Onbrez Breezhaler 
...
<p>Så længe skal du fortsætte med Onbrez Breezhaler-behandling 
 
Fortsæt med Onbrez Breezhaler-behandlingen, så længe din læge siger, at du skal gøre det. 
 
KOL er en langtidssygdom, og du skal bruge Onbrez Breezhaler hver dag og ikke blot, når du 
...
<ul>
<li>Hver Onbrez Breezhaler 150 mikrogram kapsel indeholder 150 mikrogram indacaterol i form af 
indacaterolmaleat. Øvrige indholdsstoffer: lactose og kapslen er lavet af gelatine. </li>
<li>Hver Onbrez Breezhaler 300 mikrogram kapsel indeholder 300 mikrogram indacaterol i form af 
indacaterolmaleat. Øvrige indholdsstoffer: lactose og kapslen er lavet af gelatine. </li>
</ul>
...
<p> 
Onbrez Breezhaler 150 mikrogram kapsler har påtrykt en sort produktkode "IDL 150" over en 
sort bjælke og et sort virksomhedslogo (
) påtrykt under den sorte bjælke. 
 
Onbrez Breezhaler 300 mikrogram kapsler har påtrykt en blå produktkode "IDL 300" over en 
...
<p>Læs venligst den fulde anvisning for brug inden du bruger Onbrez Breezhaler. </p>
<p>Læg en kapsel i 
Perforer og slip 
Inhaler dybt 
...
<p>Trin 1e: 
Luk inhalatoren </p>
<p>Din Onbrez Breezhaler inhalatorpakning indeholder: 
 
En Onbrez Breezhaler inhalator 
 
Et eller flere blisterkort, som hver indeholder 
enten 6 eller 10 Onbrez Breezhaler kapsler til 
