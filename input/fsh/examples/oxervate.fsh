...
This medicine should not be used in children and adolescents below 18 years of age, as there is not 
enough information about its use in this age group. </p>
<p>Other medicines and OXERVATE 
Tell your doctor or pharmacist if you are using, have recently used or might use any other medicines. </p>
<p>You should wait at least 15 minutes before or after using OXERVATE if you use any other eye 
drops. This will help to avoid one eye drop diluting the other eye drop. If you also use an eye ointment 
or gel or an eye drop with a thick consistency, you should use OXERVATE first, and then wait at 
least 15 minutes before using the other medicine. </p>
<p>Pregnancy and breast-feeding 
If you are pregnant or breast-feeding, think you may be pregnant or are planning to have a baby, ask 
your doctor or pharmacist for advice before using this medicine. </p>
<p>The use of this medicine should be avoided during pregnancy. Talk to your doctor if you are pregnant 
or think you may be pregnant. </p>
<p>It is not known if this medicine passes into breast milk. Talk to your doctor before breast-feeding your 
baby, as a decision must be made whether to stop breast-feeding or to avoid or stop OXERVATE 
therapy. </p>
...
<p>The recommended dose is 1 drop in the affected eye 6 times a day at 2-hourly intervals, starting in 
the morning (i.e. 6 drops per day within 12 hours). You should continue your treatment for 8 weeks. </p>
...
understand. 
Ocular use.<br />
You will receive an insulated container containing a weekly carton of OXERVATE and a separate 
delivery system (composed of medical devices intended for withdrawing and administering the 
medicine). </p>
<p>The weekly carton contains 7 vials of OXERVATE (1 vial per day of the week). Remove the weekly 
carton of OXERVATE from the insulated container and store it in a fridge as soon as you can (and in 
any case no later than 5 hours from when you receive the medicine from your pharmacist). Since at the 
...
the vial adapter (picture 4). After cleaning, wait for approximately 1 minute to allow the valve 
to dry. 
* Take a pipette (dropper) and remove it from its protective packaging. 
* Screw the pipette (clockwise) into the connector part of the vial adapter (picture 5). 
* Ensure that the pipette plunger is pushed all the way down. 
* Turn the vial upside-down (with the pipette still connected) and gently pull the plunger until it 
stops, to draw the solution into the pipette. Ensure the plunger has reached the stop point 
(picture 6). </p>
<p>4 </p>
<p>5 </p>
<p>6 </p>
...
<p>If you use drops in both eyes, repeat the above instructions for your other eye using a new pipette (in 
this case, you will need to use 2 vials per day). </p>
<p>Discard the used vial at the end of each day (even if there is still some liquid left in it), and in any case 
no later than 12 hours from the time you connected the vial adapter to it. </p>
<p>You will receive a new supply of OXERVATE each week, for the duration of the treatment period. 
To ensure accurate dosing every 2 hours, you could set an alarm as a reminder for dosing. </p>
<p>To control that six doses have been taken at the end of each treatment day, you should use the weekly 
dose recording card provided with the delivery system. On that card you should write down the date of 
the first use of the weekly supply, the time of the vial opening (i.e. when you connect the vial adapter 
to the vial) and track each time you use an eye drop of this medicine, over the week. </p>
<p>If you use more OXERVATE than you should 
If you use more than you should, flush the affected eye with lukewarm water. Do not put in any more 
drops until it is time for your next regular dose. Using more OXERVATE than is recommended is not 
likely to be harmful.  Continue with your next dose as scheduled. </p>
<p>If you forget to use OXERVATE 
...
<p>The majority of side effects occur generally in and around the eyes. </p>
...
* pain in the eyelid; 
* abnormal sensation and discomfort in the eye, including feeling that there is something in the 
eye; 
...
* redness of the conjunctiva (mucous membrane that covers the front of the eye and lines the 
inside of the eyelids); 
* sensitivity to light; 
* irritation in or around the eye;<br />
* deposit of foreign substance in the eye 
* headache. </p>
<p>Uncommon (may affect up to 1 in 100 people) 
* excessive ingrowth of blood vessels into the cornea; 
* infection of the cornea with pus and swelling. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What OXERVATE contains 
- The active substance is cenegermin. 1 ml of OXERVATE contains 20 micrograms of 
cenegermin. 
- The other ingredients are trehalose dihydrate, mannitol, disodium hydrogen phosphate 
anhydrous, sodium dihydrogen phosphate dihydrate, hydroxypropylmethyl cellulose, 
polyethylene glycol 6000, L-methionine and water for injections, hydrochloric acid and sodium 
hydroxide and nitrogen. </p>
<p>What OXERVATE looks like and contents of the pack 
OXERVATE is a clear, colourless eye drops, solution. </p>
<p>It is supplied in multi-dose glass vials. 
Each vial contains 1 ml eye drops, solution. 
The vials are contained in a weekly cardboard carton containing 7 vials. 
7 vial adapters, 42 pipettes, 42 disinfectant wipes and a dose recording card are provided separately 
