...
Instance: composition-en-8e38350ad4085562476adf145c0f9fae
InstanceOf: CompositionUvEpi
Title: "Composition for peyona Package Leaflet"
Description:  "Composition for peyona Package Leaflet"
Usage: #inline

* identifier.system = "http://ema.europa.eu/identifier"

* identifier.value = "EU/1/09/528/002 1 mL ampoules"
* status = #final
...
<ol>
<li>What Peyona is and what it is used for</li>
<li>What you need to know before your baby is given Peyona </li>
<li>How to use Peyona </li>
...
* section[=].section[+]
  * title =  "1. What peyona is and what it is used for"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text =  "1. What peyona is and what it is used for"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Peyona contains the active substance caffeine citrate, which is a stimulant of the central nervous 
...
* section[=].section[+]
  * title = "2. What you need to know before you take peyona"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "2. What you need to know before you take peyona"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not use Peyona</p>
<p>If your newborn is allergic to caffeine citrate or any of the other ingredients of this medicine 
(listed in section 6). 
...
Peyona should be used with caution. Please inform your baby s doctor:</p>
<p>If your newborn suffers from seizures</p>
<p>If your newborn suffers from any heart disease</p>
<p>If your newborn has kidney or liver problems</p>
<p>If your newborn has frequent regurgitation</p>
<p>If your newborn produces more urine than usual</p>
<p>If your newborn has a reduced weight gain or food intake</p>
<p>If you (the mother) consumed caffeine prior to delivery
...
Do not use the following medicines during the treatment with Peyona without talking to your baby s 
...
* section[=].section[+]
  ...
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "3. How to take peyona"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Peyona should only be used in a neonatal intensive care unit in which adequate facilities are 
...
The following other side effects may also be considered serious by your baby s doctor in the context 
of the global clinical evaluation.
Other side effects
...
* section[=].section[+]
  ...
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "5. How to store peyona"
  * text.status = #additional
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Peyona contains
...
Angelini Farmac utica, Lda
Tel: + 351 214 148 Hrvatska
Providens d.o.o.
Tel.: +385 (1) 48 74 Rom nia
...
Instance: composition-da-8e38350ad4085562476adf145c0f9fae
InstanceOf: CompositionUvEpi
Title: "Composition for peyona Package Leaflet"
Description:  "Composition for peyona Package Leaflet"
Usage: #inline
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Peyona indeholder det aktive stof caffeincitrat, som stimulerer centralnervesystemet og tilhører en 
...
* section[=].section[+]
  ...
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "2. Det skal du vide, før du begynder at tage  peyona"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Brug ikke Peyona

...
* section[=].section[+]
  ...
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "3. Sådan skal du tage peyona"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Peyona bør kun anvendes i en intensivafdeling for nyfødte, hvor passende faciliteter til 
...
Vedligeholdelsesdosen er 5 mg per kg legemsvægt (svarende til 0,25 ml per kg legemsvægt) hver 24. time. 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Peyona indeholder:
...
Chiesi  Farmaceutici S.p.A.
Tel: + 39 0521 2Denne indlægsseddel blev senest ændret.
...
Instance: bundlepackageleaflet-en-8e38350ad4085562476adf145c0f9fae
InstanceOf: BundleUvEpi
Title: "ePI document Bundle for peyona Package Leaflet for language en"
Description: "ePI document Bundle for peyona Package Leaflet for language en"
Usage: #example
...
// Composition
* entry[0].fullUrl = "Composition/composition-en-8e38350ad4085562476adf145c0f9fae"
* entry[0].resource = composition-en-8e38350ad4085562476adf145c0f9fae

// MPD
* entry[+].fullUrl = "MedicinalProductDefinition/mp8e38350ad4085562476adf145c0f9fae"
* entry[=].resource = mp8e38350ad4085562476adf145c0f9fae
                            
                    
Instance: bundlepackageleaflet-da-8e38350ad4085562476adf145c0f9fae
InstanceOf: BundleUvEpi
Title: "ePI document Bundle for peyona Package Leaflet for language da"
Description: "ePI document Bundle for peyona Package Leaflet for language da"
Usage: #example
...
// Composition
* entry[0].fullUrl = "Composition/composition-da-8e38350ad4085562476adf145c0f9fae"
* entry[0].resource = composition-da-8e38350ad4085562476adf145c0f9fae
...
RuleSet: 8e38350ad4085562476adf145c0f9faeListRuleset

* identifier.system = "http://ema.europa.eu/identifier" 
* identifier.value = "None"
* identifier[+].system = "http://spor.ema.europa.eu/v2/medicine-name"
* identifier[=].value = "peyona"
...
* entry[+]
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-en-8e38350ad4085562476adf145c0f9fae) // peyona en
...
* entry[+]
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-da-8e38350ad4085562476adf145c0f9fae) // peyona da
  * item.extension[0].url = "http://ema.europa.eu/fhir/extension/documentType"
  * item.extension[=].valueCoding = $100000155531#100000155538 "B. PACKAGE LEAFLET"
  * item.extension[+].url = "http://ema.europa.eu/fhir/extension/language"
