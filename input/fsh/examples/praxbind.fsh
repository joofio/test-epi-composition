...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Praxbind is
Praxbind contains the active substance idarucizumab. Idarucizumab is a reversal agent specific for 
dabigatran (Pradaxa), a blood thinner medicine that blocks a substance in the body, which is involved 
...
Praxbind is used in adults in emergency situations where your doctor decides that rapid inactivation of 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Warnings and precautions
...
if you have a genetic disease called hereditary fructose intolerance. In this case, the substance 
sorbitol contained in this medicine may cause serious adverse reactions.
They will take this into account before treating you with Praxbind.
This medicine will only remove dabigatran from your body. It will not remove other medicines used to 
prevent the formation of blood clots.
After dabigatran has been removed from your body, you are not protected from the formation of blood 
clots. Your doctor will continue treating you with medicines used to prevent the formation of blood 
clots as soon as your medical condition allows.
Children and adolescents
There is no information on the use of Praxbind in children.
Other medicines and Praxbind
Tell your doctor if you are taking, have recently taken or might take any other medicines.
This medicine has been designed to only bind to dabigatran. It is unlikely that Praxbind will influence 
the effect of other medicines or that other medicines will influence Praxbind.
Pregnancy and breast-feeding
If you are pregnant or breast-feeding, think you may be pregnant or are planning to have a baby, ask 
your doctor for advice before receiving this medicine.
There is no information on the effects of this medicine in pregnant or breast-feeding women. Praxbind 
does not affect any functions in the body as such, so your doctor may decide to give you this 
...
In rare cases you may still have too much dabigatran in your blood after a first dose of this medicine 
and your doctor may decide to give you a second 5 g dose in specific situations.
Your doctor or nurse will give you this medicine by injection or infusion into a vein.
After you have received this medicine, your doctor will decide on the continuation of your treatment 
to prevent blood clot formation. Dabigatran can be given again 24 hours after administration of this 
medicine.
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Like all medicines, this medicine may cause side effects, although not everybody gets them.
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <h2>What Praxbind contains</h2>
<h2>The active substance is idarucizumab.</h2>
<p>The other ingredients are: sodium acetate trihydrate (E262), acetic acid (E260, for pH 
adjustment), sorbitol (E420), polysorbate 20 (E432) and water for injections.
What Praxbind looks like and contents of the pack
Praxbind is a clear to slightly opalescent, colourless to slightly yellow solution supplied in a glass vial 
closed with a butyl rubber stopper and an aluminium cap.
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Advarsler og forsigtighedsregler
...
26
Brug af andre lægemidler sammen med Praxbind
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Dette lægemiddel er kun til brug på hospitaler.
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <h2>Praxbind indeholder</h2>
<h2>Aktivt stof: idarucizumab.</h2>
<p>Øvrige indholdsstoffer: natriumacetattrihydrat (E262), eddikesyre (E260, til pH-justering), 
