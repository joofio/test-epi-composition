...
Instance: composition-en-78e33c6ca57a9089f2dae156018ba8d2
...
* identifier.value = "EU/1/02/215/001-005, 011, 013"
* status = #final
...
<ol>
<li>What PritorPlus is and what it is used for</li>
<li>What you need to know before you take PritorPlus</li>
<li>How to take PritorPlus</li>
...
* section[=].section[+]
  * title =  "1. What pritorplus is and what it is used for"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text =  "1. What pritorplus is and what it is used for"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>PritorPlus is a combination of two active substances, telmisartan and hydrochlorothiazide in one 
...
* section[=].section[+]
  * title = "2. What you need to know before you take pritorplus"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "2. What you need to know before you take pritorplus"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not take PritorPlus</p>
...
<p>if you are more than 3 months pregnant. (It is also better to avoid PritorPlus in early pregnancy 
...
Talk to your doctor before taking PritorPlus if you are suffering or have ever suffered from any of the 
...
to weeks of taking PritorPlus. This can lead to permanent vision impairment, if not treated.
-
...
from sun exposure and UV rays while taking PritorPlus.
Talk to your doctor before taking PritorPlus:</p>
...
or difficulty breathing after taking PritorPlus, seek medical attention immediately.
...
to the medicines listed below taken at the same time with PritorPlus:
-
...
take PritorPlus  and  Warnings and precautions ).
-
Digoxin.
PritorPlus may increase the blood pressure lowering effect of other medicines used to treat high blood 
...
The effect of PritorPlus may be reduced when you take NSAIDs (non steroidal anti-inflammatory 
...
* section[=].section[+]
  ...
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "3. How to take pritorplus"
  * text.status = #additional
...
take PritorPlus with or without food. The tablets should be swallowed with some water or other non-
alcoholic drink. It is important that you take PritorPlus every day until your doctor tells you otherwise.
...
with PritorPlus, even if not observed in clinical trials with this product.
Telmisartan
...
Progressive scarring of lung tissue (interstitial lung disease)</em><em> </em>The event may have happened by chance or could be related to a mechanism currently not known.
...
signs of fluid accumulation in the vascular layer of the eye (choroidal effusion) or acute myopia or<br />
...
* section[=].section[+]
  ...
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "5. How to store pritorplus"
  * text.status = #additional
...
package in order to protect from moisture. Remove your PritorPlus tablet from the blister only directly 
prior to intake.
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What PritorPlus contains</p>
...
PritorPlus 40 mg/12.5 mg tablets are red and white, oblong-shaped two-layer tablets engraved with the 
code number 'H4'.
...
Instance: composition-da-78e33c6ca57a9089f2dae156018ba8d2
InstanceOf: CompositionUvEpi
Title: "Composition for pritorplus Package Leaflet"
Description:  "Composition for pritorplus Package Leaflet"
Usage: #inline
...
2. Det skal du vide, før du begynder at tage PritorPlus 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>PritorPlus er en kombination af to aktive stoffer - telmisartan og hydrochlorthiazid - i én tablet. Begge 
...
* section[=].section[+]
  * title = "2. Det skal du vide, før du begynder at tage  pritorplus"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "2. Det skal du vide, før du begynder at tage  pritorplus"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Tag ikke PritorPlus

...
timer til uger, efter behandling med PritorPlus er startet. Hvis det ikke behandles, kan det føre til 
permanent synstab.

...
vejrtrækningsbesvær efter at have taget PritorPlus, skal du straks søge lægehjælp.
...
og/eller tage andre forholdsregler. Muligvis vil det være nødvendigt at stoppe brugen af anden medicin 
specielt, hvis det er noget af følgende:
-
...
Man kan føle sig svimmel eller blive træt, når man tager PritorPlus. Hvis du føler dig svimmel eller 
træt, må du ikke føre motorkøretøj eller betjene maskiner.
PritorPlus indeholder natrium
Dette lægemiddel indeholder mindre end 1 mmol (23 mg) natrium pr. tablet, dvs. det er i det 
væsentlige natriumfrit.
PritorPlus indeholder mælkesukker (lactose)
...
* section[=].section[+]
  * title =  "3. Sådan skal du tage pritorplus"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "3. Sådan skal du tage pritorplus"
  * text.status = #additional
...
alene. Tabletten synkes sammen med vand eller en anden væske. Det er vigtigt, at du tager PritorPlus 
hver dag, så længe din læge ikke siger andet.
...
urinvejsinfektion, blodmangel (anæmi), høje kaliumniveauer, langsom hjerterytme (bradykardi), hoste, 
nedsat nyrefunktion inklusive akut nyresvigt, svaghed.
Sjældne bivirkninger (kan forekomme hos op til 1 ud af 1.000 brugere)
...
(hos diabetes patienter), søvnighed, maveproblemer, eksem, slidgigt, senebetændelse, nedsat 
hæmoglobin (et blodprotein).
...
originale yderpakning for at beskytte mod fugt. Tag først din PritorPlus-tablet ud af blisteren lige før 
indtagelse.
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>PritorPlus indeholder:

...
PritorPlus er pakket i blisterpakninger med 14, 28, 30, 56, 90 eller 98 tabletter eller enkeltdosis-
...
Instance: bundlepackageleaflet-en-78e33c6ca57a9089f2dae156018ba8d2
InstanceOf: BundleUvEpi
Title: "ePI document Bundle for pritorplus Package Leaflet for language en"
Description: "ePI document Bundle for pritorplus Package Leaflet for language en"
Usage: #example
...
// Composition
* entry[0].fullUrl = "Composition/composition-en-78e33c6ca57a9089f2dae156018ba8d2"
* entry[0].resource = composition-en-78e33c6ca57a9089f2dae156018ba8d2
...
Instance: bundlepackageleaflet-da-78e33c6ca57a9089f2dae156018ba8d2
InstanceOf: BundleUvEpi
Title: "ePI document Bundle for pritorplus Package Leaflet for language da"
Description: "ePI document Bundle for pritorplus Package Leaflet for language da"
Usage: #example
...
Instance: mp78e33c6ca57a9089f2dae156018ba8d2
InstanceOf: MedicinalProductDefinitionUvEpi
Title: "Medicinal Product PritorPlus 40 mg/12.5 mg tablets"
Description: "PritorPlus 40 mg/12.5 mg tablets"
Usage: #inline
...
RuleSet: 78e33c6ca57a9089f2dae156018ba8d2ListRuleset

* identifier.system = "http://ema.europa.eu/identifier" 
* identifier.value = "None"
* identifier[+].system = "http://spor.ema.europa.eu/v2/medicine-name"
* identifier[=].value = "pritorplus"
...
* entry[+]
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-en-78e33c6ca57a9089f2dae156018ba8d2) // pritorplus en
...
* entry[+]
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-da-78e33c6ca57a9089f2dae156018ba8d2) // pritorplus da
  * item.extension[0].url = "http://ema.europa.eu/fhir/extension/documentType"
  * item.extension[=].valueCoding = $100000155531#100000155538 "B. PACKAGE LEAFLET"
  * item.extension[+].url = "http://ema.europa.eu/fhir/extension/language"
