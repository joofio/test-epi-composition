...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Protaphane is human insulin with a gradual onset and long duration of action. </p>
<p>Protaphane is used to reduce the high blood sugar level in patients with diabetes mellitus (diabetes). 
Diabetes is a disease where your body does not produce enough insulin to control the level of your 
blood sugar. Treatment with Protaphane helps to prevent complications from your diabetes.  </p>
<p>Protaphane will start to lower your blood sugar about 1  hours after you inject it, and the effect will 
last for approximately 24 hours. Protaphane is often given in combination with fast-acting insulin 
preparations. </p> </div>"""   
...
<p>If any of these apply, do not use Protaphane. Talk to your doctor, pharmacist or nurse for advice. </p>
...
<p>Protaphane Penfill is only suitable for injecting under the skin using a reusable pen. Speak to 
...
for advice before taking this medicine. Protaphane can be used during pregnancy. Your insulin 
...
<p>There are no restrictions on treatment with Protaphane during breast-feeding. </p>
...
<p>Protaphane contains less than 1 mmol sodium (23 mg) per dose, i.e. Protaphane is essentially  sodium-
free . </p> </div>"""   
...
<p>Protaphane is administered by injection under the skin (subcutaneously). You must never inject 
yourself directly into a vein (intravenously) or muscle (intramuscularly). Protaphane Penfill is only 
...
<p>Protaphane Penfill cartridges are designed to be used with Novo Nordisk insulin delivery 
systems and NovoFine or NovoTwist needles. </p>
<p>If you are treated with Protaphane Penfill and another insulin Penfill cartridge, you should use 
...
instructions. </p>
<p>Every time you use a new Protaphane Penfill (before you put the cartridge into the insulin 
delivery system). 
...
<p>After each injection, be sure to remove and discard the needle and store Protaphane without the 
...
* Drink alcohol, see Protaphane with alcohol in section 2. Signs of low blood sugar: Cold sweat; cool pale skin; headache; rapid heartbeat; feeling sick; feeling 
...
<p>Serious allergic reaction to Protaphane or one of its ingredients (called a systemic allergic reaction) 
...
<p>The active substance is human insulin. Protaphane is an isophane (NPH) human insulin 
...
<p>What Protaphane looks like and contents of the pack 
Protaphane is presented as a suspension for injection. After resuspension, the liquid should appear 
...
<p>Protaphane InnoLet 100 IU/ml (international units/ml) suspension for injection in pre-filled pen 
human insulin </p>
