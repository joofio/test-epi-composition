...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Relvar Ellipta contains two active substances: fluticasone furoate and vilanterol. Two different 
strengths of Relvar Ellipta are available: fluticasone furoate 92 micrograms/vilanterol 22 micrograms 
...
<p>Relvar Ellipta should be used every day and not only when you have breathing problems or 
...
and include shortness of breath, wheezing, chest tightness and cough. Relvar Ellipta has been shown to 
reduce flare-ups and symptoms of asthma.  </p>
...
section 6). 
-if you think the above applies to you, do not use Relvar Ellipta until you have checked with your 
doctor. </p>
...
severe liver disease, your doctor will limit your dose to the lower strength of Relvar Ellipta 
(92/22 micrograms once daily).<br />
...
-if you have ever been told you have diabetes or high blood sugar.<br />
...
feeding, you must check with your doctor before you use Relvar Ellipta. Do not use this medicine if 
you are breast-feeding unless your doctor tells you that you can.  </p>
...
22 micrograms of vilanterol) once daily at the same time each day. </p>
<p>The higher strength of Relvar Ellipta (184 micrograms fluticasone furoate and 22 micrograms of 
vilanterol) is not suitable for the treatment of COPD. </p>
<p>Relvar Ellipta is for oral inhalation.  </p>
<p>Use Relvar Ellipta at the same time each day as it is effective over 24 hours<br />
...
<p>Relvar Ellipta should not be used to relieve a sudden attack of breathlessness or wheezing. If you 
get this sort of attack you must use a quick-acting inhaler (such as salbutamol). </p>
...
<p>Relvar Ellipta is for oral inhalation. You do not need to prepare Relvar Ellipta in any special way, not 
even the first time you use it. </p>
...
If you accidentally use more Relvar Ellipta than your doctor has instructed, talk to your doctor or 
...
you ask your doctor or pharmacist for advice. This is because larger doses of Relvar Ellipta may 
...
If you have any of the following symptoms after taking Relvar Ellipta stop taking this medicine and 
...
Tell your doctor if you have any of the following while taking Relvar Ellipta   they could be 
...
mouth out with water immediately after using Relvar Ellipta may help stop this side effect 
developing. 
...
These may affect up to 1 in 1,000 people:<br />
  ...
  awareness of heart beat (palpitations)<br />
  tremor 
  anxiety. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Relvar Ellipta contains<br />
...
mouthpiece) of 92 micrograms of fluticasone furoate and 22 micrograms of vilanterol (as 
trifenatate).<br />
- For the 184/22 mcg dose: each single inhalation provides a delivered dose (the dose leaving the 
mouthpiece) of 184 micrograms of fluticasone furoate and 22 micrograms of vilanterol (as 
trifenatate).<br />
- The other ingredients are lactose monohydrate (See section 2 under  Relvar Ellipta contains lactose ) 
...
been opened.<br />
Relvar Ellipta is available in packs of 1 inhaler containing either 14 or 30 doses (14 or 30 day supply) 
