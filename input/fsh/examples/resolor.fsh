...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Resolor contains the active substance prucalopride.
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <h2>Do not take Resolor:</h2>
<p>if you are allergic to prucalopride or any of the other ingredients of this medicine (listed in 
section 6).
-
if you are on renal dialysis,
-
if you suffer from perforation or obstruction of the gut wall, severe inflammation of the 
intestinal tract, such as Crohn s disease, ulcerative colitis or toxic megacolon/megarectum.
...
-
are currently under supervision by a doctor for a serious medical problem such as lung or heart 
disease, nervous system or mental health problems, cancer, AIDS or a hormonal disorder.
...
When breast-feeding, prucalopride can pass into breast milk. Breast-feeding is not recommended 
during treatment with Resolor. Talk to your doctor about this.
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Always take this medicine exactly as described in this leaflet or as your doctor has told you. Check 
with your doctor or pharmacist if you are not sure. Take Resolor every day for as long as your doctor 
prescribes it.
The doctor may want to reassess your condition and the benefit of continued treatment after the first 
4 weeks and thereafter at regular intervals.
The usual dose of Resolor for most patients is one 2 mg tablet once a day.
If you are older than 65 years or have severe liver disease, the starting dose is one 1 mg tablet once a 
day, which your doctor may increase to 2 mg once a day if needed.
Your doctor may also recommend a lower dose of one 1 mg tablet daily if you have severe kidney
disease.
...
effects mostly occur at the start of treatment and usually disappear within a few days with continued 
treatment.
The following side effects have been reported very commonly (may affect more than 1 in 10 people): 
headache, feeling sick, diarrhoea and abdominal pain.
The following side effects have been reported commonly (may affect up to 1 in 10 people): decreased 
appetite, dizziness, vomiting, disturbed digestion (dyspepsia), windiness, abnormal bowel sounds, 
tiredness.
The following uncommon side effects have also been seen (may affect up to 1 in 100 people): tremors, 
pounding heart, rectal bleeding, increase in frequency of passing urine (pollakiuria), fever and feeling 
unwell. If pounding heart occurs, please tell your doctor.
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Resolor contains
...
Lactose monohydrate (see section 2), microcrystalline cellulose, colloidal silicon dioxide, magnesium 
stearate, hypromellose, triacetin, titanium dioxide (E171), macrogol. The 2 mg tablet also contains 
iron oxide red (E172), iron oxide yellow (E172), indigo carmine aluminium lake (E132).
What Resolor looks like and contents of the pack
Resolor 1 mg film-coated tablets are white to off-white round shaped tablets marked  PRU 1  on one 
side.
...
7 tablets. Each pack contains 7x1, 14x1, 28x1 or 84x1 film-coated tablets.
...
2. Det skal du vide, før du begynder at tage Resolor
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Resolor indeholder det aktive stof prucaloprid.
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <h2>Tag ikke Resolor:</h2>
<p>hvis du er allergisk over for prucaloprid eller et af de øvrige indholdsstoffer i Resolor (angivet i 
punkt 6).
-
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Tag altid dette lægemiddel nøjagtigt som beskrevet i denne indlægsseddel eller efter lægens anvisning.
...
Følgende almindelige bivirkninger er blevet rapporteret (kan forekomme hos op til 1 ud af personer): nedsat appetit, svimmelhed, opkastning, fordøjelsesforstyrrelser (dyspepsi), luft i maven, 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Resolor indeholder:
