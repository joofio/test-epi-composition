...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Revinty Ellipta contains two active substances: fluticasone furoate and vilanterol. Two different 
strengths of Revinty Ellipta are available: fluticasone furoate 92 micrograms/vilanterol 22 micrograms 
and fluticasone furoate 184 micrograms/vilanterol 22 micrograms.  </p>
<p>The 92/22 micrograms strength is used for the regular treatment of chronic obstructive pulmonary 
disease (COPD) in adults, and asthma in adults and adolescents 12 years and over.  </p>
<p>The 184/22 micrograms strength is used to treat asthma in adults and adolescents aged 12 years and 
older. The 184/22 micrograms strength is not approved for the treatment of COPD. </p>
<p>Revinty Ellipta should be used every day and not only when you have breathing problems or 
other symptoms of COPD and asthma. It should not be used to relieve a sudden attack of 
breathlessness or wheezing. If you get this sort of attack you must use a quick-acting inhaler (such as 
salbutamol). If you do not have a quick-acting inhaler contact your doctor. </p>
<p>Fluticasone furoate belongs to a group of medicines called corticosteroids, often simply called 
steroids. Corticosteroids reduce inflammation. They reduce the swelling and irritation in the small air 
passages in the lungs and so gradually ease breathing problems. Corticosteroids also help to prevent 
attacks of asthma and aggravation of COPD. </p>
<p>Vilanterol belongs to a group of medicines called long acting bronchodilators. It relaxes the muscles of 
...
discomfort and coughing up mucus. Revinty Ellipta has been shown to reduce flare-ups of COPD 
symptoms. </p> </div>"""   
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not use Revinty Ellipta<br />
- if you are allergic to fluticasone furoate, vilanterol or any other ingredients of this medicine (listed in 
section 6). 
- if you think the above applies to you, do not use Revinty Ellipta until you have checked with your 
doctor. </p>
<p>Warnings and precautions 
Talk to your doctor before using Revinty Ellipta: 
-if you have liver disease, as you may be more likely to have side effects. If you have moderate or 
severe liver disease, your doctor will limit your dose to the lower strength of Revinty Ellipta 
(92/22 micrograms once daily). 
...
<p>Check with your doctor before you use this medicine if you think any of these applies to you. </p>
...
<ul>
<li>Contact your doctor if you experience blurred vision or other visual disturbances. </li>
<li>Contact your doctor if you experience increased thirst, frequent urination or unexplained tiredness 
(signs of high blood sugar). </li>
</ul>
<p>Infection of the lung 
If you are using this medicine for COPD you may be at an increased risk of developing an infection of 
the lungs known as pneumonia. See section 4 for information on symptoms to look out for while you 
...
your doctor for advice before taking this medicine. Do not use this medicine if you are pregnant unless 
your doctor tells you that you can.  </p>
<p>It is not known whether the ingredients of this medicine can pass into breast milk. If you are breast-
feeding, you must check with your doctor before you use Revinty Ellipta. Do not use this medicine 
if you are breast-feeding unless your doctor tells you that you can.  </p>
...
If you have been told by your doctor that you have an intolerance to some sugars, contact to your 
doctor before using this medicine. </p> </div>"""   
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Always use this medicine exactly as your doctor has told you. Check with your doctor or 
pharmacist if you are not sure. </p>
<p>Asthma 
The recommended dose to treat asthma is one inhalation (92 micrograms of fluticasone furoate and 
22 micrograms of vilanterol) once daily at the same time each day. </p>
<p>If you have severe asthma, your doctor may decide that you should use one inhalation of the higher 
strength inhaler (184 micrograms fluticasone furoate and 22 micrograms of vilanterol). This dose is 
also used once daily at the same time each day. </p>
<p>COPD 
The recommended dose to treat COPD is one inhalation (92 micrograms of fluticasone furoate and 
22 micrograms of vilanterol) once daily at the same time each day. </p>
...
you get this sort of attack you must use a quick-acting inhaler (such as salbutamol). </p>
...
If your symptoms (breathlessness, wheezing, cough) do not improve or get worse, or if you are using 
your quick-acting inhaler more often:<br />
 contact your doctor as soon as possible. </p>
<p>If you use more Revinty Ellipta than you should<br />
If you accidentally use more Revinty Ellipta than your doctor has instructed, talk to your doctor or 
pharmacist. If possible, show them the inhaler, the package or this leaflet. You may notice that your 
heart is beating faster than usual, you feel shaky or have a headache.  </p>
<p>If you have used more than instructed for a long period of time, it is particularly important that 
you ask your doctor or pharmacist for advice. This is because larger doses of Revinty Ellipta may 
reduce the amount of steroid hormones produced naturally by your body.  </p>
<p>If you forget to use Revinty Ellipta<br />
Do not inhale a double dose to make up for a forgotten dose. Just take your next dose at the usual 
time. </p>
<p>If you become wheezy or breathless, or develop any other symptoms of an asthma attack, use your 
quick-acting inhaler (e.g. salbutamol), then seek medical advice.  </p>
...
<p>Do not use this medicine after the expiry date which is stated on the carton, tray and inhaler after EXP. 
The expiry date refers to the last day of that month. </p>
<p>Keep the inhaler inside the sealed tray to protect from moisture and only remove immediately before 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Revinty Ellipta contains<br />
- The active substances are fluticasone furoate and vilanterol.<br />
- For the 92/22 mcg dose: each single inhalation provides a delivered dose (the dose leaving the 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Revinty Ellipta indeholder to aktive stoffer: fluticasonfuroat og vilanterol. Revinty Ellipta findes i to 
...
<p>Revinty Ellipta skal tages hver dag og ikke kun, når du har problemer med vejrtrækningen eller 
andre symptomer på KOL og astma. Det kan ikke anvendes til lindring ved pludselige anfald af 
åndenød eller hvæsende vejrtrækning. Hvis du får et anfald af den type, skal du inhalere et lægemiddel 
med hurtig virkning (f.eks. salbutamol). Kontakt din læge, hvis du ikke har en hurtigtvirkende inhalator. </p>
...
ophostning af slim. Det er påvist, at Revinty Ellipta reducerer opblussen af KOL-symptomer. </p> </div>"""   
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Tag ikke Revinty Ellipta<br />
- hvis du er allergisk over for fluticasonfuroat, vilanterol eller et af de øvrige indholdsstoffer i dette 
lægemiddel (angivet i punkt 6). 
- Hvis du tror, at ovenstående gælder for dig, må du ikke tage Revinty Ellipta, før du har talt med 
lægen. </p>
...
<p>Kontakt lægen, før du begynder at tage dette lægemiddel, hvis du tror, at noget af det<br />
ovenstående 
gælder for dig.  </p>
...
Hvis du tager dette lægemiddel mod KOL, kan du have en øget risiko for at få lungebetændelse. Se punkt 4<br />
...
unge, uanset alder. </p>
<p>Brug af anden medicin sammen med Revinty Ellipta 
...
vælge at følge dig tæt, hvis du tager et af disse lægemidler, da de kan øge bivirkningerne af Revinty Ellipta. </p>
...
maskiner. </p>
<p>Revinty Ellipta indeholder lactose 
...
22 mikrogram vilanterol) én gang dagligt på samme tidspunkt hver dag. </p>
<p>Den høje styrke af Revinty Ellipta (184 mikrogram fluticasonfuroat og 22 mikrogram vilanterol) er ikke 
egnet til behandling af KOL. </p>
<p>Revinty Ellipta er til oral inhalation. </p>
<p>Tag Revinty Ellipta på samme tidspunkt hver dag, da det virker i 24 timer 
...
<p>Revinty Ellipta kan ikke anvendes til lindring af pludselige anfald af åndenød eller hvæsende 
...
Sådan skal du tage Revinty Ellipta<br />
Du kan finde en udførlig beskrivelse i ’Brugervejledning’ efter punkt 6 i denne indlægsseddel. </p>
<p>Revinty Ellipta er til oral inhalation. Du behøver ikke at klargøre Revinty Ellipta på nogen særlig måde, ikke 
...
Kontakt lægen eller apoteket, hvis du ved et uheld har taget mere Revinty Ellipta, end lægen har foreskrevet.<br />
...
kontakter lægen eller apoteket med henblik på rådgivning. Det skyldes, at store doser af Revinty 
Ellipta kan nedsætte mængden af det steroidhormon, du danner naturligt i kroppen.  </p>
...
Hvis du oplever nogle af de følgende symptomer efter at have taget Revinty Ellipta, skal du stoppe med at 
...
<p>Akutte vejrtrækningsproblemer efter brug af Revinty Ellipta er sjældne. 
...
Fortæl lægen, hvis du oplever nogle af følgende symptomer, mens du tager Revinty Ellipta - det kan være 
tegn på lungebetændelse:</p>
<ul>
...
<li>hovedpine </li>
<li>
<p>almindelig forkølelse.<br />
Almindelige bivirkninger<br />
Kan forekomme hos op til 1 ud af 10 personer:</p>
</li>
<li>
<p>ømme, hævede pletter i munden eller svælget på grund af en svampeinfektion (candidiasis). Hvis du 
skyller munden med vand, og spytter vandet ud, umiddelbart efter, du har taget Revinty Ellipta, kan 
det være med til at forebygge, at du får denne bivirkning. </p>
</li>
<li>bronkitis </li>
<li>bihulebetændelse eller halsbetændelse </li>
<li>influenza  </li>
<li>smerte og irritation bagest i munden og svælget </li>
<li>pandehulebetændelse </li>
<li>kløende, løbende eller tilstoppet næse  </li>
<li>hoste </li>
<li>ændring af stemme </li>
<li>svækkelse af knoglerne, hvilket kan medføre knoglebrud </li>
<li>mavesmerter  </li>
<li>rygsmerter </li>
<li>feber </li>
<li>ledsmerter </li>
<li>muskelsammentrækninger. </li>
</ul>
...
<p>Hvis inhalatoren opbevares inhalatoren på køl, skal den ligge ved stuetemperatur i mindst én time før 
brug. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Revinty Ellipta indeholder<br />
- Aktive stoffer: fluticasonfuroat og vilanterol.<br />
- 92/22 mikrogram dosis: Hver enkelt inhalation afgiver en leveret dosis (den dosis, der afgives fra 
mundstykket) på 92 mikrogram fluticasonfuroat og 22 mikrogram vilanterol (som trifenatat).<br />
- 184/22 mikrogram dosis: Hver enkelt inhalation afgiver en leveret dosis (den dosis, der afgives fra 
mundstykket) på 184 mikrogram fluticasonfuroat og 22 mikrogram vilanterol (som trifenatat). <br />
- Øvrige indholdsstoffer: lactosemonohydrat (se punkt 2 ‘Revinty Ellipta indeholder lactose’) og 
magnesiumstearat.  </p>
...
efter åbning.   </p>
<p>Revinty Ellipta fås i pakninger med 1 inhalator som indeholder enten 14 eller 30 doser (14 eller 30 dages 
...
Det er ikke nødvendigt at kontrollere, om inhalatoren virker korrekt, før du bruger Revinty Ellipta første 
gang, ligesom det heller ikke er nødvendigt på anden måde at klargøre den til brug. Bare følg denne trinvise 
brugervejledning. </p>
...
<p>Det er ikke sikkert, at du kan smage eller mærke medicinen, selvom du bruger inhalatoren korrekt. 
Hvis du vil rengøre mundstykket, så brug en tør serviet, før du lukker beskyttelseshætten. </p>
<ol>
<li>
...
<li>
<p>Efter brug af inhalatoren skylles munden med vand uden at synke det. </p>
</li>
</ol>
<p>Det nedsætter sandsynligheden for udvikling af bivirkninger i form af ømhed i mund eller hals.  </p> </div>"""      
