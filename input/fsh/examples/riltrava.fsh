...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Riltrava Aerosphere contains three active substances: formoterol fumarate dihydrate, glycopyrronium,
and budesonide. </p>
<p>Formoterol fumarate dihydrate and glycopyrronium belong to a group of medicines called 
 bronchodilators . They work in different ways to prevent tightening of the muscles around 
the airways, making it easier for air to get in and out of the lungs.</p>
<p>Budesonide belongs to a group of medicines called  corticosteroids . These work by reducing 
inflammation in your lungs.
Riltrava Aerosphere is an inhaler that is used for adults with a lung disease called  chronic obstructive 
pulmonary disease  (or  COPD ), a long-term disease of the airways in the lungs.
Riltrava Aerosphere is used to make breathing easier and improve symptoms of COPD such as 
shortness of breath, wheezing and cough. Riltrava Aerosphere can also prevent flare-ups 
(exacerbations) of COPD.
Riltrava Aerosphere delivers the active substances into your lungs as you breathe in. If you use this 
...
Riltrava Aerosphere is used as a long-term maintenance treatment for COPD. Do not use it to treat a 
...
Riltrava Aerosphere, stop using it and tell your doctor straight away (see  Serious side effects  at 
...
Riltrava Aerosphere, you should continue to use Riltrava Aerosphere but contact your doctor as soon 
as possible, as you may need additional treatment.
Talk to your doctor before using Riltrava Aerosphere if:</p>
...
Riltrava Aerosphere has not been studied in children and adolescents. Do not give this medicine to 
...
because Riltrava Aerosphere can affect the way some medicines work. Also some medicines can 
affect how Riltrava Aerosphere works, or make it more likely that you will have side effects.
...
some medicines used to treat breathing problems (such as theophylline)   called 
 methylxanthines ,</p>
<p>any medicines that work in the same way as Riltrava Aerosphere   such as tiotropium, 
ipratropium, aclidinium, umeclidinium or salmeterol, arformoterol, vilanterol, olodaterol or 
indacaterol. Do not use Riltrava Aerosphere if you already use these medicines.</p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Always use this medicine exactly as your doctor has told you. Check with your doctor or pharmacist 
if you are not sure.
How much to use
The recommended dose is two puffs twice a day   two puffs in the morning and two puffs in the 
evening.
It is important to use Riltrava Aerosphere every day   even if you have no COPD symptoms at the 
time.
Remember: Always rinse your mouth with water after using Riltrava Aerosphere. This is to remove 
any medicine which is left in the mouth. Spit this water out   do not swallow.
How to use
Riltrava Aerosphere is for inhalation use.
Please read the  Instructions for Use  at the end of this leaflet. If you are not sure how to use Riltrava
...
If you have used more Riltrava Aerosphere than you should, talk to a doctor or pharmacist straight 
...
However, if it is nearly time for your next dose, skip the missed dose. Do not take more than two
puffs twice a day on the same day.
...
<p>if you get breathing difficulties straight after using Riltrava Aerosphere, such as tightness of the 
...
using Riltrava Aerosphere may help prevent this.</p>
<p>feeling anxious</p>
...
Tell your doctor if you have any of the following while using Riltrava Aerosphere, they could be 
...
Do not use Riltrava Aerosphere after the expiry date which is stated on the carton, pouch and 
...
Keep the inhaler inside the sealed pouch   only remove the inhaler from the sealed pouch 
immediately before first use. On the day the pouch is opened, write the date on the inhaler label in the 
space provided.
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Riltrava Aerosphere contains 
The active substances are formoterol fumarate dihydrate, glycopyrronium and budesonide.
Each single inhalation provides a delivered dose (the dose leaving the mouthpiece) of 5 micrograms 
of formoterol fumarate dihydrate, 9 micrograms glycopyrronium bromide equivalent to 
7.2 micrograms glycopyrronium and 160 micrograms of budesonide.
...
Riltrava Aerosphere comes as a canister with a dose indicator, supplied with a yellow plastic actuator 
body and white mouthpiece. The mouthpiece is covered with a removable grey protective cap.
Riltrava Aerosphere is supplied in a foil pouch that contains a drying packing (desiccant) and packed 
into a carton.
Each inhaler contains 120 puffs. Additionally, there are multipacks containing 3 pressurised 
containers with 120 puffs, each.
