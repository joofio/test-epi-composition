...
<ol>
<li>What Rimmyrah is and what it is used for </li>
<li>What you need to know before you are given Rimmyrah </li>
<li>How Rimmyrah is given </li>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Rimmyrah is 
Rimmyrah is a solution which is injected into the eye. Rimmyrah belongs to a group of medicines 
called antineovascularisation agents. It contains the active substance called ranibizumab. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>You must not receive Rimmyrah 
...
- Rimmyrah is given as an injection into the eye. Occasionally, an infection in the internal portion 
...
clouding of the lens (cataract) may occur after Rimmyrah treatment. It is important to identify 
...
recommended. </p>
<p>Other medicines and Rimmyrah 
...
at least three further months after the last injection of Rimmyrah. 
- There is no experience of using Rimmyrah in pregnant women. Rimmyrah should not be used 
...
your doctor before treatment with Rimmyrah. 
- Small amounts of ranibizumab may pass into breast milk, therefore Rimmyrah is not 
recommended during breast-feeding. Ask your doctor or pharmacist for advice before 
...
<p>Detailed instructions for use are given at the end of the leaflet.  </p>
<p>Elderly (age 65 years and over) 
Rimmyrah can be used for people of 65 years of age and over without dose adjustment. </p>
<p>Before stopping Rimmyrah treatment 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Rimmyrah contains 
...
polysorbate 20 (E432), water for injections. </p>
<p>What Rimmyrah looks like and contents of the pack 
Rimmyrah is a solution for injection in a vial (0.23 ml). The solution is clear to slightly opalescent, 
colourless to brownish and aqueous. </p>
...
to RVO the recommended dose for Rimmyrah is 0.5 mg given as a single intravitreal injection. This 
...
there are no signs of disease activity i.e., no change in visual acuity and in other signs and symptoms 
of the disease under continued treatment. In patients with wet AMD, DME, PDR and RVO, initially, 
...
<p>Ranibizumab and laser photocoagulation in DME and macular oedema secondary to BRVO 
There is some experience of ranibizumab administered concomitantly with laser photocoagulation. 
When given on the same day, ranibizumab should be administered at least 30 minutes after laser 
photocoagulation. ranibizumab can be administered in patients who have received previous laser 
photocoagulation. </p>
<p>Ranibizumab and verteporfin photodynamic therapy in CNV secondary to PM 
There is no experience of concomitant administration of ranibizumab and verteporfin. </p>
<p>Rimmyrah should be inspected visually to ensure there is no particulate matter, discolouration or 
disturbance prior to the administration. If particulate matter, discolouration or disturbance is observed, 
...
* section[=].section[+]
  * title = "2. Det skal du vide, før du begynder at tage  rimmyrah"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "2. Det skal du vide, før du begynder at tage  rimmyrah"
  * text.status = #additional
...
* section[=].section[+]
  * title =  "3. Sådan skal du tage rimmyrah"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "3. Sådan skal du tage rimmyrah"
  * text.status = #additional
