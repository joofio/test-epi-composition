...
Instance: composition-en-d3bf47e7430f03a3543b0c027649dc7a
...
* identifier.value = "EU/1/16/1152/001-002"
* status = #final
...
<ol>
<li>What Roteas is and what it is used for  </li>
<li>What you need to know before you take Roteas  </li>
<li>How to take Roteas  </li>
...
* section[=].section[+]
  * title =  "1. What roteas is and what it is used for"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text =  "1. What roteas is and what it is used for"
  * text.status = #additional
...
* section[=].section[+]
  * title = "2. What you need to know before you take roteas"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "2. What you need to know before you take roteas"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not take Roteas </p>
<ul>
...
<p>Talk to your doctor or pharmacist before taking Roteas, 
...
- it is very important to take Roteas before and after the operation exactly at the times you have 
been told by your doctor. If possible, Roteas should be stopped at least 24 hours before an 
operation. Your doctor will determine when to restart Roteas. 
In emergency situations your physician will help determine the appropriate actions regarding 
Roteas. </p>
<p>Children and adolescents </p>
<p>Roteas is not recommended in children and adolescents under 18 years of age. </p>
<p>Other medicines and Roteas </p>
...
<p>If any of the above apply to you, tell your doctor before taking Roteas, because these medicines 
may increase the effects of Roteas and the chance of unwanted bleeding. Your doctor will decide, if 
...
<p>Do not take Roteas if you are pregnant or breast-feeding. If there is a chance that you could become 
...
Roteas can be taken with or without food. </p>
<p>If you have difficulty swallowing the tablet whole, talk to your doctor about other ways to take Roteas. 
The tablet may be crushed and mixed with water or apple puree immediately before you take it. If 
necessary, your doctor may also give you the crushed Roteas tablet through a tube via the nose 
...
<p>Changing from vitamin K antagonists (e.g. warfarin) to Roteas 
Stop taking the vitamin K antagonist (e.g. warfarin). Your doctor will need to do blood measurements 
and will instruct you when to start taking Roteas. </p>
<p>Changing from non-VKA oral anticoagulants (dabigatran, rivaroxaban, or apixaban) to Roteas 
Stop taking the previous medicines (e.g. dabigatran, rivaroxaban, or apixaban) and start Roteas at the 
time of the next scheduled dose. </p>
<p>Changing from parenteral anticoagulants (e.g. heparin) to Roteas 
Stop taking the anticoagulant (e.g. heparin) and start Roteas at the time of the next scheduled 
anticoagulant dose. </p>
<p>Changing from Roteas to vitamin K antagonists (e.g. warfarin) 
If you currently take 60 mg Roteas: 
Your doctor will tell you to reduce your dose of Roteas to a 30 mg tablet once daily and to take it 
together with a vitamin K antagonist (e.g. warfarin). Your doctor will need to do blood measurements 
and will instruct you when to stop taking Roteas. 
If you currently take 30 mg (dose reduced) Roteas: 
Your doctor will tell you to reduce your dose of Roteas to a 15 mg tablet once daily and to take it 
together with a vitamin K antagonist (e.g. warfarin). Your doctor will need to do blood measurements 
and will instruct you when to stop taking Roteas. </p>
<p>Changing from Roteas to non-VKA oral anticoagulants (dabigatran, rivaroxaban, or apixaban) 
Stop taking Roteas and start the non-VKA anticoagulant (e.g. dabigatran, rivaroxaban, or apixaban) at 
the time of the next scheduled dose of Roteas. </p>
<p>Changing from Roteas to parenteral anticoagulants (e.g. heparin) 
Stop taking Roteas and start the parenteral anticoagulant (e.g. heparin) at the time of the next 
scheduled dose of Roteas. </p>
...
Roteas at the times your doctor tells you to prevent blood clots in the brain and other blood vessels in 
your body. </p>
<p>If you take more Roteas than you should </p>
<p>Tell your doctor immediately if you have taken too many Roteas tablets. 
If you take more Roteas than recommended, you may have an increased risk of bleeding. </p>
<p>If you forget to take Roteas </p>
...
Instance: composition-da-d3bf47e7430f03a3543b0c027649dc7a
InstanceOf: CompositionUvEpi
Title: "Composition for roteas Package Leaflet"
Description:  "Composition for roteas Package Leaflet"
Usage: #inline
...
2. Det skal du vide, før du begynder at tage Roteas 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Roteas indeholder det aktive stof edoxaban og tilhører en gruppe lægemidler, som kaldes 
...
<p>Roteas anvendes til voksne til at:</p>
<ul>
...
* section[=].section[+]
  ...
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "2. Det skal du vide, før du begynder at tage  roteas"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Tag ikke Roteas </p>
<ul>
<li>hvis du er allergisk over for edoxaban eller et af de øvrige indholdsstoffer i Roteas (angivet i 
punkt 6), </li>
...
<p>Kontakt lægen eller apotekspersonalet, før du tager Roteas, 
...
* section[=].section[+]
  ...
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "3. Sådan skal du tage roteas"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Vær ekstra forsigtig med at tage Roteas, 
...
med hensyn til Roteas. </p>
<p>Børn og unge </p>
<p>Roteas bør ikke anvendes til børn og unge under 18 år. </p>
<p>Brug af andre lægemidler sammen med Roteas </p>
...
<p>Hvis noget af det ovenstående gælder for dig, skal du fortælle det til lægen, før du tager Roteas, da 
disse lægemidler kan øge virkningen af Roteas og risikoen for uønsket blødning. Lægen vil beslutte, 
om du skal behandles med Roteas, og om du skal holdes under observation. </p>
<p>Hvis du tager noget af følgende: </p>
<ul>
<li>
...
Roteas, og om du skal overvåges.  </p>
<p>Graviditet og amning </p>
<p>Tag ikke Roteas hvis du er gravid eller ammer. Hvis der er en mulighed for, at du kan blive gravid, 
...
Roteas kan tages sammen med eller uden mad. </p>
...
Hvis det er nødvendigt, kan lægen også give dig den knuste Roteas-tablet via en sonde gennem næsen 
...
<p>Ændring fra K-vitaminantagonister (f.eks. warfarin) til Roteas 
Hold op med at tage K-vitaminantagonisten (f.eks. warfarin). Det er nødvendigt for din læge at tage 
blodprøver og vil instruere dig i, hvornår du skal begynde at tage Roteas. </p>
<p>Skift fra non-VKA orale antikoagulantia (dabigatran, rivaroxaban eller apixaban) til Roteas 
Hold op med at tage tidligere lægemidler (f.eks. dabigatran, rivaroxaban eller apixaban), og begynd 
med at tage Roteas på tidspunktet for den næste planlagte dosis. </p>
<p>Ændring fra parenteral antikoagulation (f.eks. heparin) til Roteas 
...
<p>Skift fra Roteas til K-vitaminantagonister (f.eks. warfarin) 
...
dagligt og tage den sammen med en K-vitaminantagonist (f.eks. warfarin). Det er nødvendigt for din 
læge at tage blodprøver og vil instruere dig i, hvornår du skal holde op med at tage Roteas. </p>
<p>Skift fra Roteas til non-VKA orale antikoagulantia (dabigatran, rivaroxaban eller apixaban) 
Hold op med at tage Roteas, og start non-VKA antikoagulation (f.eks. dabigatran, rivaroxaban eller 
apixaban) på tidspunktet for den næste planlagte dosis Roteas. </p>
<p>Skift fra Roteas til parenteral antikoagulation (f.eks. heparin) 
Hold op med at tage Roteas, og start parenteral antikoagulation (f.eks. heparin) på tidspunktet for den 
næste planlagte dosis Roteas. </p>
...
at forebygge blodpropper i hjernen og andre blodkar i kroppen. </p>
<p>Hvis du har taget for meget Roteas </p>
<p>Fortæl det straks til din læge, hvis du har taget for mange tabletter med Roteas. 
Hvis du tager mere Roteas end anbefalet, kan du have en øget blødningsrisiko. </p>
<p>Hvis du har glemt at tage Roteas </p>
...
<p>Roteas kan som andre lignende lægemidler (lægemidler, der reducerer blodstørkningen) forårsage 
...
Instance: bundlepackageleaflet-da-d3bf47e7430f03a3543b0c027649dc7a
InstanceOf: BundleUvEpi
Title: "ePI document Bundle for roteas Package Leaflet for language da"
Description: "ePI document Bundle for roteas Package Leaflet for language da"
Usage: #example
...
RuleSet: d3bf47e7430f03a3543b0c027649dc7aListRuleset

* identifier.system = "http://ema.europa.eu/identifier" 
* identifier.value = "None"
* identifier[+].system = "http://spor.ema.europa.eu/v2/medicine-name"
* identifier[=].value = "roteas"
...
* entry[+]
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-en-d3bf47e7430f03a3543b0c027649dc7a) // roteas en
...
* entry[+]
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-da-d3bf47e7430f03a3543b0c027649dc7a) // roteas da
  * item.extension[0].url = "http://ema.europa.eu/fhir/extension/documentType"
  * item.extension[=].valueCoding = $100000155531#100000155538 "B. PACKAGE LEAFLET"
  * item.extension[+].url = "http://ema.europa.eu/fhir/extension/language"
