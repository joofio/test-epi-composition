...
Instance: composition-en-cd1253bc1e51a6309a46a454334120e0
...
* subject = Reference(mp26cdcb597779e4e179a95172e055a37e)
...
* title = "TEST PURPOSES ONLY - sancuso"
...
<ol>
<li>What SANCUSO is and what it is used for </li>
<li>What you need to know before you use SANCUSO </li>
<li>How to use SANCUSO </li>
<li>Possible side effects </li>
<li>How to store SANCUSO </li>
<li>Contents of the pack and other information </li>
</ol>         </div>"""   
          

* section[=].section[+]
  * title =  "1. What sancuso is and what it is used for"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text =  "1. What sancuso is and what it is used for"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>The active substance in SANCUSO is granisetron, which belongs to a group of medicines called 
antiemetics and antinauseants. </p>
<p>SANCUSO is a transdermal (skin) patch used to prevent nausea (feeling sick) and vomiting (being 
sick) in adults receiving chemotherapy treatments (medicines to treat cancer) lasting 3 to 5 days and 
who have difficulty swallowing tablets (for example due to soreness, dryness or inflammation of the 
mouth or throat). </p>
<p>You must talk to a doctor if you do not feel better or if you feel worse after the first day of 
chemotherapy. </p>         </div>"""   
          

             
* section[=].section[+]
  * title = "2. What you need to know before you take sancuso"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
...
<p>External heat, for example from hot water bottles or heat pads, should be avoided on the area of the 
transdermal patch. </p>
<p>Children and adolescents 
This medicine should not be used by children or adolescents under 18 years. </p>
...
- Buprenorphine, Opioids or other serotonergic medicines. </p>
<p>Pregnancy and breast-feeding 
Do not use this medicine if you are pregnant unless your doctor has specifically recommended it. </p>
<p>Stop breast-feeding while wearing the patch. </p>
...
SANCUSO has no or negligible effect on your ability to drive or use any machines. </p>         </div>"""   
                    
* section[=].section[+]
  * title =  "3. How to take sancuso"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "3. How to take sancuso"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Always use this medicine exactly as your doctor has told you. Check with your doctor or nurse if you 
are not sure. </p>
<p>The recommended dose is one single transdermal patch. The medicine in the transdermal patch passes 
gradually through your skin into your body and, therefore, the patch is applied 1 to 2 days (24 to 
48 hours) before the start of chemotherapy treatment. </p>
<p>This medicine is for transdermal use. This medicine delivers the active substance slowly and 
constantly through your skin and into your blood stream for the duration that you are wearing the 
transdermal patch. </p>
<p>Things to remember when using the transdermal patch 
...
- When you remove the transdermal patch, check your skin and tell your doctor if you notice a 
serious skin reaction (if your skin is very red, itchy or you notice any blisters). 
- The transdermal patch may be affected by direct sunlight or exposure to sunlamps. While you 
are wearing the transdermal patch you must keep it covered, e.g. under clothing, if there is a risk 
of exposure to sunlight or sunlamps. Continue to keep the application site covered for a further 
10 days after removing the transdermal patch. 
- Contact with water during bathing or showering will not change the way SANCUSO works. 
- However, the transdermal patch may become partially unstuck. Try to avoid wearing the 
transdermal patch in water for long periods of time. 
- There is no information on the effect on the transdermal patch of activities such as strenuous 
exercise or the use of sauna or whirlpools; therefore, you should avoid these activities while 
wearing this transdermal patch. 
- You should avoid external heat (for example hot water bottles or heat pads) on the area of the 
transdermal patch. </p>
<p>When to apply and remove the transdermal patch 
Do not remove the transdermal patch from the sachet until you are ready to use it. Apply a transdermal 
patch at least 1 day (24 hours) before you are scheduled to have chemotherapy treatment. The 
transdermal patch may be applied up to a maximum of 2 days (48 hours) before chemotherapy. Wear 
the transdermal patch all the time during your chemotherapy. The transdermal patch can be worn for 
up to 7 days depending on the duration of your chemotherapy treatment. Remove the transdermal 
patch at least 1 day (24 hours) after completing your chemotherapy. </p>
<p>Where to apply the transdermal patch 
Put the transdermal patch on a clean, dry, healthy area of skin on the outside part of your upper arm. If 
your arms are not suitable areas to apply the transdermal patch your doctor may ask you to put it on 
your abdomen. The area you choose should not be oily, recently shaved or have any skin problems 
...
Instance: mp26cdcb597779e4e179a95172e055a37e
InstanceOf: MedicinalProductDefinitionUvEpi
Title: "Medicinal Product SANCUSO 3.1 mg/24 hours transdermal patch"
Description: "SANCUSO 3.1 mg/24 hours transdermal patch"
Usage: #inline

 
* identifier[+].system = "http://ema.europa.eu/identifier"
* identifier[=].value = "EU/1/12/766/001"
...
* indication = "SANCUSO transdermal patch is indicated in adults for the prevention of nausea and vomiting"
...
* name
  * productName = "SANCUSO 3.1 mg/24 hours transdermal patch"
...
Instance: bundlepackageleaflet-en-cd1253bc1e51a6309a46a454334120e0
InstanceOf: BundleUvEpi
Title: "ePI document Bundle for sancuso Package Leaflet for language en"
Description: "ePI document Bundle for sancuso Package Leaflet for language en"
Usage: #example
...
// Composition
* entry[0].fullUrl = "Composition/composition-en-cd1253bc1e51a6309a46a454334120e0"
* entry[0].resource = composition-en-cd1253bc1e51a6309a46a454334120e0

// MPD
* entry[+].fullUrl = "MedicinalProductDefinition/mp26cdcb597779e4e179a95172e055a37e"
* entry[=].resource = mp26cdcb597779e4e179a95172e055a37e
