...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Sivextro is an antibiotic that contains the active substance tedizolid phosphate. It belongs to a group of
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not take Sivextro 
...
Talk to your doctor or nurse before taking Sivextro if any of the following apply to you:</p>
<ul>
<li>are suffering from diarrhoea, or have suffered from diarrhoea whilst (or up to 2 months after)
taking antibiotics in the past.</li>
<li>are allergic to other medicines belonging to the group  oxazolidinones  (e.g., linezolid,
cycloserine).</li>
<li>have a history of bleeding or easy bruising (which may be a sign of low numbers of platelets,
the small cells involved in clotting in your blood).</li>
<li>have kidney problems.</li>
<li>are taking certain medicines to treat depression, known as tricyclics, SSRIs (selective serotonin
reuptake inhibitors) or MAOIs (monoamine oxidase inhibitors). See Other medicines and
Sivextro for examples.</li>
<li>are taking certain medicines to treat migraine known as  triptans . See Other medicines and
...
Certain side effects have been observed with Sivextro or another member of the oxazolidinone class
when administered over a duration exceeding that recommended for Sivextro. Tell your doctor straight
away if you suffer from any of the following while taking Sivextro:</li>
<li>a low white blood cell count </li>
<li>anaemia (low red blood cells) </li>
<li>bleeding or bruising easily</li>
<li>loss of sensitivity in your hands or feet (such as numbness, prickling/tingling, or sharp pains)</li>
<li>any problems with your eyesight such as blurred vision, changes in colour vision, difficulty in
...
medicines. It is especially important that you tell your doctor if you are also taking:</li>
<li>amitriptyline, citalopram, clomipramine, dosulepin, doxepin, fluoxetine, fluvoxamine,
imipramine, isocarboxazid, lofepramine, moclobemide, paroxetine, phenelzine, selegiline and
sertraline (used to treat depression)</li>
<li>sumatriptan, zolmitriptan (used to treat migraine)</li>
<li>imatinib, lapatinib (used to treat cancer)</li>
<li>methotrexate (used to treat cancer, rheumatoid arthritis or psoriasis)</li>
<li>sulfasalazine (used to treat inflammatory bowel diseases)</li>
<li>topotecan (used to treat cancer)</li>
<li>statins such as pitavastatin, rosuvastatin (used to lower blood cholesterol)
...
and can be taken with or without food or drink.<br />
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Sivextro contains
