...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>This medicine is a radiopharmaceutical for diagnostic use only. It contains the active substance 
edotreotide. Before it can be used, the powder in the vial is mixed with a radioactive substance called 
gallium (68Ga) chloride to make gallium (68Ga) edotreotide (this procedure is called radiolabelling). </p>
<p>Gallium (68Ga) edotreotide contains a small amount of radioactivity. After injection into a vein, it can 
make parts of the body visible to doctors during a medical imaging procedure called positron emission 
tomography (PET). This medical procedure obtains images of your organs to help locate abnormal 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>SomaKit TOC must not be used 
...
You should drink plenty of water before the start of the examination in order to urinate as often as 
possible during the first hours after the procedure to ensure that SomaKit TOC is removed as quickly 
as possible from your body. </p>
<p>Children and adolescents 
This medicine is not recommended in patients under 18 years of age because its safety and efficacy 
have not been established in this patient population. </p>
<p>Other medicines and SomaKit TOC 
Tell your nuclear medicine doctor if you are taking, have recently taken or might take any other 
medicines, including somatostatin analogues or glucocorticoids (also called corticosteroids), since they 
may interfere with the interpretation of the images. If you are taking somatostatin analogues you might 
be asked to stop your treatment for a short period of time. </p>
<p>Pregnancy and breast-feeding 
If you are pregnant or breast-feeding, think you may be pregnant or are planning to have a baby, ask 
your nuclear medicine doctor for advice before you are given this medicine. </p>
<p>You must inform the nuclear medicine doctor before the administration of SomaKit TOC if there is a 
...
procedure. </p>
<p>There is no information about the safety and the efficacy of the use of this medicine during pregnancy. 
Only essential investigations should be carried out during pregnancy, when the likely benefit far 
exceeds any risk to the mother and foetus. </p>
<p>If you are breast-feeding the nuclear medicine doctor may either delay the medical procedure until you 
are no longer breast-feeding or ask you to stop breast-feeding and to discard your milk until there is no 
radioactivity in your body (12 hours after the administration of SomaKit TOC). 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>There are strict laws on the use, handling and disposal of radiopharmaceutical products. SomaKit TOC 
will only be used in special controlled areas. This medicine will only be handled and given to you by 
...
<p>The nuclear medicine doctor supervising the procedure will decide on the quantity of SomaKit TOC to 
be used in your case. It will be the smallest quantity necessary to get the desired information. 
The quantity to be administered usually recommended for an adult ranges from 100 MBq to 200 MBq 
(megabecquerel, the unit used to express radioactivity). </p>
<p>Administration of SomaKit TOC and conduct of the procedure 
...
After injection, you will be offered something to drink and asked to urinate immediately preceding the 
test. </p>
...
An overdose is unlikely because you will only receive a single dose under controlled conditions by the 
nuclear medicine doctor supervising the procedure. However, in the case of an overdose, you will 
...
<p>Although no side effects have been reported, a potential risk of allergic reactions (hypersensitivity) 
...
splenosis visible during medical imaging. There have been reports where this has been mistaken for a 
tumour. Your doctor may therefore perform additional scans and tests to confirm the findings on 
gallium (68Ga) edotreotide imaging (see section 2). </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What SomaKit TOC contains 
- The active substance is edotreotide. Each vial of powder for solution for injection contains 
40 micrograms of edotreotide. 
- The other ingredients are: 1,10-phenanthroline, gentisic acid, mannitol, formic acid, sodium 
...
substans, som hedder gallium (68Ga)-chlorid, for at fremstille gallium (68Ga)-edotreotid (dette kaldes 
radioaktiv mærkning). </p>
<p>Gallium (68Ga)-edotreotid indeholder en lille mængde radioaktivitet. Efter injektion i en vene kan det 
gøre dele af kroppen synlige for læger under en billeddannelsesprocedure (skanning), der kaldes 
positron-emissions-tomografi (PET). Ved denne skanning tages der billeder af dine organer som en 
hjælp til at lokalisere unormale celler eller tumorer, hvilket giver værdifulde oplysninger om din 
sygdom. </p>
...
Tal med den nuklearmedicinske læge, før du får SomaKit TOC:</p>
<ul>
<li>hvis du oplevede nogen som helst tegn på en allergisk reaktion (anført i punkt 4), efter du sidst 
fik SomaKit TOC; </li>
<li>hvis du har problemer med dine nyrer eller din lever (nyre- eller leversygdomme); </li>
<li>hvis du er under 18 år; </li>
<li>hvis du har tegn på dehydrering (væskemangel) før eller efter undersøgelsen; </li>
<li>hvis du har andre helbredsproblemer, såsom højt niveau af kortisol i kroppen (Cushings 
...
andet) eller sygdom i milten (herunder tidligere traume eller operation som involverer milten). 
Sådanne tilstande kan være synlige og påvirke tolkningen af billederne. Din læge kan derfor 
udføre yderligere scanninger og test for at bekræfte fundene på gallium (68Ga)-edotreotid-
billeddiagnostik; </li>
<li>hvis du for nylig er blevet vaccineret. Forstørrede lymfeknuder som resultat af vaccination kan 
blive synlige under gallium (68Ga)-edotreotid-billeddiagnostik; </li>
<li>hvis du har taget andre lægemidler, såsom somatostatin-analoger og glukokortikoider, som kan 
interagere med SomaKit TOC; </li>
<li>hvis du er gravid eller tror, at du måske er gravid; </li>
<li>hvis du ammer. </li>
</ul>
<p>Den nuklearmedicinske læge vil oplyse dig om, hvorvidt du skal tage andre særlige forholdsregler før 
eller efter, at du har fået SomaKit TOC. </p>
<p>Før du får SomaKit TOC 
...
fastslået hos denne patientgruppe. </p>
<p>Brug af anden medicin sammen med SomaKit TOC 
Fortæl den nuklearmedicinske læge hvis du tager anden medicin, for nylig har taget anden medicin 
eller planlægger at tage anden medicin, herunder somatostatin-analoger eller glukokortikoider (også 
kaldet kortikosteroider), da de kan forstyrre tolkningen af billederne. Hvis du tager somatostatin-
analoger, kan du blive bedt om at stoppe behandlingen i en kort periode. </p>
<p>Graviditet og amning 
Hvis du er gravid eller ammer, har mistanke om, at du er gravid, eller planlægger at blive gravid, skal 
du spørge den nuklearmedicinske læge til råds, før du får dette lægemiddel. </p>
<p>Du skal fortælle den nuklearmedicinske læge, før du får SomaKit TOC, hvis der en mulighed for, at du 
...
med undersøgelsen. </p>
<p>Der foreligger ingen oplysninger om sikkerheden og virkningen ved at få denne medicin under 
graviditet. Undersøgelsen må kun udføres hos gravide, hvis den forventede fordel langt overstiger 
risikoen for moderen og fosteret. </p>
<p>Hvis du ammer, vil den nuklearmedicinske læge enten udsætte undersøgelsen, indtil du ikke længere 
ammer, eller bede dig om at stoppe med at amme og kassere din udmalkede mælk, indtil der ikke 
længere er nogen radioaktivitet i din krop (12 timer efter, du har fået SomaKit TOC). 
...
sikker måde. Disse personer vil drage særlig omsorg for, at dette lægemiddel anvendes på en sikker 
måde og vil orientere dig om, hvad de foretager sig. </p>
<p>Den nuklearmedicinske læge, der har tilsyn med undersøgelsen, vil fastsætte den mængde 
...
måleenheden for radioaktivitet). </p>
<p>Administration af SomaKit TOC og gennemførelse af undersøgelsen 
...
Den nuklearmedicinske læge vil oplyse dig om, hvor læge undersøgelsen normalt varer. </p>
<p>Efter du har fået SomaKit TOC, bør du:</p>
<ul>
<li>undgå tæt kontakt med små børn og gravide kvinder i 12 timer efter injektionen </li>
<li>lade vandet hyppigt for at udskille lægemidlet fra din krop. </li>
</ul>
<p>Den nuklearmedicinske læge vil oplyse dig om, hvorvidt du skal tage nogen særlige forholdsregler 
efter, at du har fået denne medicin. Kontakt den nuklearmedicinske læge, hvis du har spørgsmål. </p>
<p>Hvis du har fået for meget SomaKit TOC 
...
hævelse, kløe, kvalme og åndedrætsbesvær. I tilfælde af en allergisk reaktion vil sundhedspersonalet 
give dig den rette behandling. </p>
<p>Ikke kendt (hyppigheden kan ikke beregnes ud fra forhåndenværende data):</p>
<ul>
<li>Svien omkring injektionsstedet </li>
</ul>
<p>Milten er et organ, der sidder i maveregionen. Nogle mennesker er født med en ekstra milt (en bimilt). 
Ekstra miltvæv kan også findes i maveregionen efter operation eller skade på milten (dette er kendt 
som splenose). Gallium (68Ga)-edotreotid kan gøre en bimilt eller splenose synlig under medicinsk 
billeddiagnostik. Der har været indrapporteringer, hvor dette er blevet forvekslet med en tumor. Din 
læge kan derfor udføre yderligere scanninger og test for at bekræfte fundene på gallium (68Ga)-
edotreotid-billeddiagnostik (se afsnit 2). </p>
<p>Dette radioaktive lægemiddel vil afgive små mængder ioniserende stråling forbundet med den mindst 
mulige risiko for kræft og arvelige defekter. </p>
...
national lovgivning om radioaktive materialer. </p>
...
<p>SomaKit TOC må ikke anvendes efter den udløbsdato, som er anført på pakningen. Udløbsdatoen er 
...
<p>Efter radioaktiv mærkning skal SomaKit TOC anvendes inden for 4 timer. Må ikke opbevares ved 
temperaturer over 25°C efter radioaktiv mærkning. </p>
...
<ul>
<li>Aktivt stof: edotreotid Hvert hætteglas med pulver til injektionsvæske, opløsning indeholder 
40 mikrogram edotreotid. </li>
<li>Øvrige indholdsstoffer: 1,10-phenanthroline, gentisinsyre, mannitol, myresyre, 
natriumhydroxid, vand til injektionsvæsker. </li>
</ul>
<p>Efter radioaktiv mærkning indeholder injektionsvæsken også saltsyre. </p>
<p>Udseende og pakningsstørrelse 
SomaKit TOC er et radiofarmaceutisk præparationssæt indeholdende:</p>
<ul>
<li>Et hætteglas af glas med sort flip-off hætte indeholdende et hvidt pulver. </li>
<li>Et hætteglas af cyklisk olefin-polymer med gul flip-off hætte indeholdende en klar og farveløs 
opløsning. </li>
</ul>
<p>Den radioaktive substans er ikke en del af sættet og skal tilsættes under de forberedende trin forud for 
injektion. </p>
