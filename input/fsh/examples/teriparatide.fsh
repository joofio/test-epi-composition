...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Teriparatide SUN contains the active substance teriparatide that is used to make the bones stronger, 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not use Teriparatide SUN 
...
- if you suffer from kidney stones or have a history of kidney stones </p>
<ul>
...
Teriparatide SUN where you can sit or lie down right away if you get dizzy. 
The recommended treatment time of 24 months should not be exceeded. </p>
<p>Teriparatide SUN should not be used in growing adults. </p>
<p>Children and adolescents 
Teriparatide SUN should not be used in children and adolescents (less than 18 years). </p>
<p>Other medicines and Teriparatide SUN 
Tell your doctor or pharmacist if you are taking, have recently taken or might take any other 
medicines, because occasionally they may interact (e.g. digoxin/digitalis, a medicine used to treat 
heart disease). </p>
<p>Pregnancy and breast-feeding 
Do not use Teriparatide SUN if you are pregnant, think you may be pregnant, or if you are breast-
feeding. 
If you are a woman of child-bearing potential, you should use effective methods of contraception 
during use of Teriparatide SUN. If you become pregnant, Teriparatide SUN should be discontinued. 
...
<p>Inject Teriparatide SUN each day for as long as your doctor prescribes it for you. The total duration of 
treatment with Teriparatide SUN should not exceed 24 months. You should not receive more than one 
treatment course of 24 months over your lifetime. 
Teriparatide SUN can be injected at meal times. </p>
<p>Carefully read how to use the pre-filled pen at the end of this package leaflet. </p>
<p>Injection needles are not included with the pen. Pen needles of 31 Gauge, 5 mm length can be used.  </p>
<p>You should use your Teriparatide SUN injection shortly after you take the pen out of the refrigerator 
as described in Pen User Manual  at the end of this package leaflet. For instructions for use video, 
please scan the QR code included in the Pen User Manual or use the link: 
https://www.pharmaqr.info/tptemaen. Put the pen back into the refrigerator immediately after you 
have used it. Use a new injection needle of 31 Gauge, 5 mm length for each injection and dispose of it 
after each use. Never store your pen with the needle attached. Never share your Teriparatide SUN pen 
with others. </p>
<p>Your doctor may advise you to use Teriparatide SUN with calcium and vitamin D. Your doctor will 
tell you how much you should take each day. </p>
<p>Teriparatide SUN can be given with or without food. </p>
<p>If you use more Teriparatide SUN than you should 
If, by mistake, you have used more Teriparatide SUN than you should, contact your doctor or 
pharmacist. The effects of overdose that might be expected include nausea, vomiting, dizziness, and 
headache. </p>
<p>If you forget or cannot take Teriparatide SUN at your usual time, use it as soon as possible on that 
day. Do not use a double dose to make up for a forgotten dose. Do not use more than one injection in 
the same day. Do not try to make up for a missed dose. </p>
...
10 people) and feeling sick, headache and dizziness (frequency is common, may affect up to 1 in 
10 people). If you become dizzy (light-headed) after your injection, you should sit or lie down until 
you feel better. If you do not feel better, you should call a doctor before you continue treatment. Cases 
of fainting have been reported in association with teriparatide use. </p>
...
breathlessness, swelling of the face, rash and chest pain (frequency is rare, may affect up to 1 in 
1,000 people). In rare cases, serious and potentially life-threatening allergic reactions including 
anaphylaxis can occur. </p>
...
- chest pain 
- low blood pressure 
- heartburn (painful or burning sensation just below the breast bone) </p>
<ul>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Teriparatide SUN contains 
- The active substance is teriparatide. Each dose of 80 microliters contains 
20 micrograms of teriparatide. 
Each pre-filled pen of 2.4 ml contains 600 micrograms of teriparatide (corresponding to 
250 micrograms per ml.<br />
The other ingredients are glacial acetic acid (E260), anhydrous sodium acetate (E262), mannitol 
(E421), metacresol, and water for injections. In addition, hydrochloric acid (E507) and/or 
sodium hydroxide (E524) solution may have been added for pH adjustment. (See section 
2 Teriparatide SUN contains sodium) </p>
<p>What Teriparatide SUN looks like and contents of the pack 
Teriparatide SUN is a clear and colourless solution. It is supplied in a cartridge contained in a 
disposable pre-filled pen. Each pen contains 2.4 ml of solution enough for 28 doses.  </p>
<p>It is available in packs of 1 pre-filled pen or 3 pre-filled pens. </p>
...
button 
PEN USER MANUAL </p>
<p>Teriparatide SUN 20 micrograms/80 microliters solution for injection in pre-filled pen </p>
<p>Instructions for use </p>
<p>Before you use your new pen, please read the section Instructions for use completely. Follow the 
directions carefully when using the pen. Also read the package leaflet provided. 
For instructions for use video, please scan the QR code or use the link: 
https://www.pharmaqr.info/tptemaen. </p>
<p>Do not share your pen or your needles as this may risk transmission of infectious agents. </p>
<p>Your pen contains 28 days of medicine. </p>
<p>Teriparatide SUN Parts* </p>
<p>*Needles not included. The needle of 31 Gauge, 5 mm length can be used.<br />
                                        Ask your doctor or pharmacist which needle gauge and length are best for you. </p>
<p>Always wash your hands before every injection. Prepare the injection site as directed by your doctor or 
pharmacist. </p>
...
Large Needle Cover </p>
<p>Step 2 Attach a new needle </p>
<p>a)
         b)
          c)
         d)</p>
<p>Pull off paper tab             Push needle straight                  Screw on needle clockwise    Pull off large needle 
                                         onto medicine cartridge.            firmly attached.                      cover and save it. </p>
<p>Step 3 Set dose 
           e)
                   f)
            g)</p>
...
<p>If you cannot pull out the black injection button            Note: After removal of inner needle protector, 
see Troubleshooting Problem E.                                     you may see drop(s) of medicine coming out 
of the needle. 
                                                                                          It is normal and will not affect your dose. </p>
...
<p>Red stripe 
Small needle protector 
Large needle protector </p>
<p>IMPORTANT 
Step 5 Confirm dose 
                 j)</p>
<p>After completing the injection 
Once the needle is removed from the skin, check to make sure the black injection button is all the 
way in. If the yellow shaft does not show, you have completed the injection steps correctly. 
                     k)</p>
<p>You should NOT see any of the yellow shaft. If you do and have already injected, do not inject 
yourself a second time on the same day. Instead, you MUST reset Teriparatide SUN (See 
Troubleshooting Problem A). </p>
<p>Step 6 Remove needle </p>
<p>l)
     m)
           n)
           o)</p>
<p>Put large needle         Unscrew the needle anti-clockwise   Pull off needle and throw       Push white cap back on. 
cover on needle.         all the way by giving the large          away as directed by                Place Teriparatide SUN<br />
                                   needle cover 3 to 5 complete           your doctor or pharmacist.     in the refrigerator 
                                   turns.                                                                                               immediately after use. </p>
<p>The directions regarding needle handling are not intended to replace local, healthcare professional or 
...
Teriparatide SUN?  </p>
<p>Solution  </p>
<p>To reset the Teriparatide SUN, follow the steps 
below. 
1) The recommended dose is 20 micrograms given 
once daily. If you have already injected, DO 
NOT inject yourself a second time on the same 
day. 
2) Remove the needle. 
3) Attach a new needle, pull off the large needle 
cover and save it. 
4) Pull out the black injection button until it stops. 
Check to make sure the red stripe shows. (See 
step 3) 
...
Hold it in and count to 5 s-l-o-w-l-y. You may 
see a small stream or drop of fluid. When you 
have finished, the black injection button 
should be all the way in. 
7) If you still see the yellow shaft showing, please 
contact your doctor or pharmacist 
8) Put the large needle cover on needle. Unscrew 
the needle all the way by giving the needle 
cover 3 to 5 complete turns. Pull off needle 
cover and throw away as directed by your 
doctor or pharmacist. Push the white cap back 
on, and place Teriparatide SUN in the 
refrigerator. (See step 6) </p>
<p>You can prevent this problem by always using a 
NEW needle for each injection, and by pushing 
the black injection button all the way in and 
counting to 5 s-l-o-w-l-y. </p>
<p>B. How do I know if my 
Teriparatide SUN 
works? </p>
<p>The Teriparatide SUN is designed to inject the full 
dose every time it is used according to the 
directions in the section How to use. The black 
injection button will be all the way in to show that 
the full dose has been injected from the 
Teriparatide SUN. </p>
<p>Remember to use a new needle every time you 
inject to be sure your Teriparatide SUN will work 
properly. </p>
<p>C. I see an air bubble in 
my Teriparatide SUN. </p>
<p>A small air bubble will not affect your dose nor 
will it harm you. You can continue to take your 
dose as usual. </p>
<p>D. I cannot get the 
needle off. </p>
<p>1) Put the large needle cover on the needle. (See 
step 6) 
...
<p>E. What should I do if I 
cannot pull out the black 
injection button? </p>
<p>Change to a new Teriparatide SUN to take your 
dose as directed by your doctor or pharmacist. </p>
<p>This indicates that you have now used all the medicine 
