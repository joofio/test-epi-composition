...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Tesavel contains the active substance sitagliptin which is a member of a class of medicines called
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not take Tesavel
- if you are allergic to sitagliptin or any of the other ingredients of this medicine (listed in
section 6).
Warnings and precautions
Cases of inflammation of the pancreas (pancreatitis) have been reported in patients receiving Tesavel
(see section 4).
If you encounter blistering of the skin it may be a sign for a condition called bullous pemphigoid.
Your doctor may ask you to stop Tesavel.
...
<li>an allergic reaction to Tesavel (see section 4)
...
exercise recommended by your doctor while taking Tesavel.
...
STOP taking Tesavel and contact a doctor immediately if you notice any of the following serious side
effects:
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Tesavel contains
- The active substance is sitagliptin:<em> 
Each Tesavel 25 mg film-coated tablet (tablet) contains sitagliptin phosphate
monohydrate, equivalent to 25 mg sitagliptin.</em> 
Each Tesavel 50 mg film-coated tablet (tablet) contains sitagliptin phosphate
monohydrate, equivalent to 50 mg sitagliptin.<em> 
Each Tesavel 100 mg film-coated tablet (tablet) contains sitagliptin phosphate
