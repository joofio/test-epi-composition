...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Tevagrastim is 
...
<p>What Tevagrastim is used for 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not use Tevagrastim 
- if you are allergic to filgrastim or any of the other ingredients of this medicine (listed in 
section 6). </p>
<p>Warnings and precautions 
Talk to your doctor, pharmacist or nurse before using Tevagrastim. </p>
...
<p>Talk to your doctor immediately during treatment with Tevagrastim, if you:</p>
<ul>
<li>have sudden signs of allergy such as rash, itching or hives on the skin, swelling of the face, 
lips, tongue or other parts of the body, shortness of breath, wheezing or trouble breathing as 
these could be signs of a severe allergic reaction (hypersensitivity). </li>
<li>experience puffiness in your face or ankles, blood in your urine or brown-coloured urine or 
you notice you urinate less than usual (glomerulonephritis). </li>
...
<p>Your doctor may want to monitor you closely, see section 4 of the package leaflet.<br />
...
develop cancers of the blood, you should not use Tevagrastim, unless instructed by your doctor. </p>
...
<p>Tevagrastim is one of a group of products that stimulate the production of white blood cells. Your 
healthcare professional should always record the exact product you are using. </p>
<p>Other medicines and Tevagrastim 
Tell your doctor or pharmacist if you are using have recently used or might use any other medicines. </p>
<p>Pregnancy and breast-feeding 
Tevagrastim has not been tested in pregnant or breast-feeding women.  </p>
<p>Tevagrastim is not recommended during pregnancy. </p>
<p>It is important to tell your doctor if you: 
* are pregnant or breast-feeding 
* think you may be pregnant 
* are planning to have a baby 
If you become pregnant during Tevagrastim treatment, please inform your doctor.  </p>
<p>Unless your doctor directs you otherwise, you must stop breast-feeding if you use Tevagrastim. </p>
...
<p>Tevagrastim contains sorbitol 
...
<p>Tevagrastim is usually given as a daily injection into the tissue just under the skin (known as a 
...
tell you how much Tevagrastim you should take. </p>
<p>Patients having a bone marrow transplant after chemotherapy: 
You will normally receive your first dose of Tevagrastim at least 24 hours after your chemotherapy 
...
<p>How long will I have to take Tevagrastim? 
...
you will need to take Tevagrastim. </p>
<p>Use in children 
...
adults. </p>
<p>If you use more Tevagrastim than you should 
...
<p>If you forget to use Tevagrastim 
...
<p>A common side effect of Tevagrastim use is pain in your muscles or bones (musculoskeletal pain), 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Tevagrastim contains 
...
for injections. </p>
<p>What Tevagrastim looks like and contents of the pack 
Tevagrastim is a solution for injection/infusion in a pre-filled syringe. Tevagrastim is a clear and 
colourless solution. Each pre-filled syringe contains either 0.5 mL or 0.8 mL of solution. </p>
<p>Tevagrastim is supplied in packs of 1, 5 or 10 pre-filled syringes or multipacks of 10 (2 packs of 5) 
