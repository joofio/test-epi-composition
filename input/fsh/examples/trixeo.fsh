...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Trixeo Aerosphere contains three active substances: formoterol fumarate dihydrate, glycopyrronium,
and budesonide.</p>
<p>Formoterol fumarate dihydrate and glycopyrronium belong to a group of medicines called 
 bronchodilators . They work in different ways to prevent tightening of the muscles around the 
airways, making it easier for air to get in and out of the lungs.</p>
<p>Budesonide belongs to a group of medicines called  corticosteroids . These work by reducing 
inflammation in your lungs.
Trixeo Aerosphere is an inhaler that is used for adults with a lung disease called  chronic obstructive 
pulmonary disease  (or  COPD ), a long-term disease of the airways in the lungs.
Trixeo Aerosphere is used to make breathing easier and improve symptoms of COPD such as 
...
<p>if you are allergic to formoterol fumarate dihydrate, glycopyrronium, budesonide or any of the 
other ingredients of this medicine (listed in section 6).
Warnings and precautions
Trixeo Aerosphere is used as a long-term maintenance treatment for COPD. Do not use it to treat a 
sudden attack of breathlessness or wheezing.
Immediate breathing difficulties
If you get tightness of the chest, coughing, wheezing or breathlessness immediately after using Trixeo 
Aerosphere, stop using it and tell your doctor straight away (see  Serious side effects  at the top of 
Section 4 for more information).
If your breathlessness, tightness of the chest, wheezing or coughing is getting worse while using 
Trixeo Aerosphere, you should continue to use Trixeo Aerosphere but contact your doctor as soon as 
...
<p>you have kidney or liver problems.
Talk to your doctor if you think any of these may apply to you.
Children and adolescents
Trixeo Aerosphere has not been studied in children and adolescents. Do not give this medicine to 
...
because Trixeo Aerosphere can affect the way some medicines work. Also some medicines can affect 
how Trixeo Aerosphere works, or make it more likely that you will have side effects.
Tell your doctor or pharmacist if you are taking any of the following:</p>
<p>medicines called beta-blockers (such as atenolol or propranolol), that may be used for high blood 
pressure or heart problems, or to treat glaucoma (such as timolol)</p>
<p>medicines which are used to treat fungal infections   such as ketoconazole or itraconazole</p>
<p>medicines which are used to treat HIV infection   such as ritonavir or cobicistat</p>
<h2>medicines that lower the amount of potassium in your blood, such as:</h2>
<h2>corticosteroids that you take by mouth (such as prednisolone),</h2>
<p>diuretics   medicines that increase urine production (such as furosemide or 
hydrochlorothiazide), which can be used for treating high blood pressure,
-
some medicines used to treat breathing problems (such as theophylline)   called 
 methylxanthines ,</p>
<p>any medicines that work in the same way as Trixeo Aerosphere   such as tiotropium, ipratropium, 
aclidinium, umeclidinium or salmeterol, arformoterol, vilanterol, olodaterol or indacaterol. Do not
use Trixeo Aerosphere if you already use these medicines.</p>
<p>medicines which are used to treat heart rhythm problems   such as amiodarone</p>
<p>medicines which can change some electrical activity of the heart (called the  QT interval )   such 
as medicines for:
-
...
you are not sure.
How much to use
The recommended dose is two puffs twice a day   two puffs in the morning and two puffs in the 
evening.
It is important to use Trixeo Aerosphere every day   even if you have no COPD symptoms at the time.
Remember: Always rinse your mouth with water after using Trixeo Aerosphere. This is to remove 
any medicine which is left in the mouth. Spit this water out   do not swallow.
How to use
Trixeo Aerosphere is for inhalation use.
Please read the  Instructions for Use  at the end of this leaflet. If you are not sure how to use Trixeo 
Aerosphere, talk to your doctor or pharmacist.
Using Trixeo Aerosphere with a spacer
You may find it difficult breathing in and pressing the inhaler at the same time. If this happens, talk to
your doctor or pharmacist. It may help to use a  spacer  with your inhaler.
If you use more Trixeo Aerosphere than you should
If you have used more Trixeo Aerosphere than you should, talk to a doctor or pharmacist straight 
away. You may need medical attention. You may notice that your heart is beating faster than usual, 
you feel shaky, you have problems with your sight, you have a dry mouth or you have a headache or 
feel sick (nausea).
...
twice a day on the same day.
If you stop using Trixeo Aerosphere
This medicine is for long-term use. Use this medicine for as long as your doctor tells you to. It will 
...
Immediate breathing difficulties:</p>
<p>if you get breathing difficulties straight after using Trixeo Aerosphere, such as tightness of the 
chest, coughing, wheezing or feeling breathless, stop using this medicine and tell your doctor 
straight away.
Allergic reactions:</p>
<p>swelling of your face, particularly around your mouth (swelling of your tongue or throat may 
make it difficult to swallow)</p>
<p>rash or hives together with difficulty breathing</p>
<p>suddenly feeling faint
These symptoms may be signs of an allergic reaction which may become serious. Stop using this 
medicine and call for medical help straight away if you notice the serious side effects above.
Other side effects
Tell your doctor or pharmacist if you notice any of the following side effects:
Common (may affect up to 1 in 10 people)</p>
<p>thrush in the mouth (a fungal infection). Rinsing your mouth out with water immediately after 
using Trixeo Aerosphere may help prevent this.</p>
<p>feeling anxious</p>
...
<p>painful and frequent urination (may be signs of a urinary tract infection)</p>
<p>pneumonia (infection of the lung).
Tell your doctor if you have any of the following while using Trixeo Aerosphere, they could be 
symptoms of a lung infection:</p>
<p>fever or chills,</p>
<p>increased mucus production, change in mucus colour,</p>
<p>increased cough or increased breathing difficulties.
...
<p>chest pain or tightening in the chest (angina pectoris)
Very rare (may affect up to 1 in 10,000 people)</p>
<p>changes in behaviour</p>
<p>an effect on the adrenal gland
...
Do not use Trixeo Aerosphere after the expiry date which is stated on the carton, pouch and 
...
Keep the inhaler inside the sealed pouch   only remove the inhaler from the sealed pouch immediately 
before first use. On the day the pouch is opened, write the date on the inhaler label in the space 
provided. 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Trixeo Aerosphere contains
The active substances are formoterol fumarate dihydrate, glycopyrronium and budesonide.
Each single inhalation provides a delivered dose (the dose leaving the mouthpiece) of 5 micrograms of 
formoterol fumarate dihydrate, 9 micrograms glycopyrronium bromide equivalent to 7.2 micrograms 
glycopyrronium and 160 micrograms of budesonide.
...
Trixeo Aerosphere comes as a canister with a dose indicator, supplied with a yellow plastic actuator 
body and white mouthpiece. The mouthpiece is covered with a removable grey protective cap.
Trixeo Aerosphere is supplied in a foil pouch that contains a drying packing (desiccant) and packed 
into a carton.
Each inhaler contains 120 puffs. Additionally, there are multipacks containing 3 pressurised containers 
with 120 puffs, each.
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Trixeo Aerosphere indeholder tre aktive stoffer: formoterolfumaratdihydrat, glycopyrronium og 
budesonid.

...
Trixeo Aerosphere er en inhalator, der anvendes til voksne med en lungesygdom, der kaldes "kronisk 
obstruktiv lungesygdom" (eller "KOL"), en langvarig sygdom i lungernes luftveje.
Trixeo Aerosphere bruges til at lette vejrtrækningen og til at forbedre symptomer på KOL såsom 
åndenød, hvæsende vejrtrækning og hoste. Trixeo Aerosphere kan også forebygge opblusning 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Brug ikke Trixeo Aerosphere

hvis du er allergisk over for formoterolfumaratdihydrat, glycopyrronium, budesonid eller et af 
de øvrige indholdsstoffer i Trixeo Aerosphere (angivet i punkt 6).
Advarsler og forsigtighedsregler
Trixeo Aerosphere bruges som langtidsbehandling af KOL. Brug det ikke til at behandle et 
...
Trixeo Aerosphere, skal du stoppe med at bruge det og straks kontakte lægen (se "Alvorlige 
...
Trixeo Aerosphere, skal du fortsætte med at bruge Trixeo Aerosphere, men kontakte lægen hurtigst 
...
Børn og unge
Trixeo Aerosphere er ikke blevet undersøgt hos børn og unge. Giv ikke denne medicin til børn eller 
unge under 18 år.
...
recept, og naturlægemidler. Det skyldes, at Trixeo Aerosphere kan påvirke den måde, hvorpå noget 
medicin virker. Noget medicin kan også påvirke, hvordan Trixeo Aerosphere virker, eller gøre det 
...
apotekspersonalet, før du bruger Trixeo Aerosphere.
33
Graviditet og amning
Hvis du er gravid eller ammer, har mistanke om, at du er gravid, eller planlægger at blive gravid, skal 
du spørge din læge eller apotekspersonalet til råds, før du tager dette lægemiddel.
Brug ikke Trixeo Aerosphere, hvis du er gravid, medmindre din læge har fortalt dig, at du kan bruge 
det.
...
bruger Trixeo Aerosphere, skal du tale med lægen eller apotekspersonalet.
...
Hvis du har brugt mere Trixeo Aerosphere end du skal, skal du straks tale med lægen eller 
...

hvis du får vejrtrækningsbesvær umiddelbart efter brug af Trixeo Aerosphere, såsom trykken for 
brystet, hoste, hvæsende vejrtrækning eller åndenød, skal du stoppe med at bruge denne 
...

svamp i mundhulen. Skyl munden med vand umiddelbart efter brug af Trixeo Aerosphere, 
...
Fortæl det til lægen, hvis du få noget af følgende, mens du bruger Trixeo Aerosphere, da det kan være 
symptomer på en lungeinfektion:

...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <h2>Trixeo Aerosphere indeholder:</h2>
...
Trixeo Aerosphere leveres som en beholder med dosisindikator, forsynet med et gult plasthylster og et 
hvidt mundstykke. Mundstykket er dækket af en aftagelig grå beskyttelseshætte.
Trixeo Aerosphere leveres i en foliepose, der indeholder et tørremiddel, og er pakket i en karton.
...
Din Trixeo Aerosphere (kaldet “inhalator" i denne indlægsseddel) kan være forskellig fra de 
...
Gul zone
Bestil en ny inhalator, når pilen er i den 
gule zone
Rød zone
Smid din inhalator væk, når pilen er på 0 
i den røde zone
...
40
Klargøring 2
Ryst inhalatoren godt, og spray 1 klargøringspust ud i luften, mens den vender væk fra dig. Gentag
med i alt 4 klargøringspust, og ryst inhalatoren før hvert klargøringspust.
...
hvis du taber den

hvis du ikke har brugt den i mere end 
7 dage
...
Trin 1
Tag hætten af mundstykket. Kontrollér mundstykket for fremmedobjekter, og fjern disse før 
brug.
...
Skylning 5
Skylning 6
Se ind i plasthylsteret og mundstykket for at se, 
om der stadig er en medicinrest. Hvis der er 
mere medicin, skal du gentage trinnene 
Skylning 3 til 5. Lufttør, helst natten over. Du må ikke sætte 
...
mundstykket, og derefter trykkes 
trykbeholderen forsigtigt på plads i 
plasthylsteret.
Klargør inhalatoren på ny ved at spraye
2 klargøringspust, og ryst før hvert 
klargøringspust.
I alt 2 klargøringspust
Ryst og klargøringspust
30
...
1. O que é Trixeo Aerosphere e para que é utilizado
2. O que precisa de saber antes de utilizar Trixeo Aerosphere
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Trixeo Aerosphere contém três substâncias ativas: fumarato de formoterol di-hidratado, glicopirrónio e
budesonida.

...
Trixeo Aerosphere é um inalador utilizado em adultos com uma doença dos pulmões designada
“doença pulmonar obstrutiva crónica" (ou “DPOC"), uma doença crónica das vias respiratórias nos 
pulmões.
Trixeo Aerosphere é utilizado para facilitar a respiração e melhorar os sintomas da DPOC, tais como 
falta de ar, pieira e tosse. Trixeo Aerosphere pode também prevenir agudizações (exacerbações) da
DPOC.
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Não utilize Trixeo Aerosphere

...
Trixeo Aerosphere é utilizado como tratamento de manutenção prolongado da DPOC. Não o utilize 
para tratar uma crise súbita de falta de ar ou pieira.
Dificuldades respiratórias imediatas
Se sentir aperto no peito, tosse, pieira ou falta de ar imediatamente após utilizar Trixeo Aerosphere,
...
Se a sua falta de ar, aperto no peito, pieira ou tosse se agravaram com a utilização de Trixeo 
Aerosphere, deverá continuar a usar Trixeo Aerosphere mas fale com o seu médico logo que possível, 
pois pode necessitar de tratamento adicional.
Fale com o seu médico antes de utilizar Trixeo Aerosphere se:

...
Trixeo Aerosphere não foi estudado em crianças e adolescentes. Não utilize este medicamento em 
...
à base de plantas. Isto porque Trixeo Aerosphere pode afetar o mecanismo de ação de alguns 
medicamentos. Além disso, alguns medicamentos podem afetar a forma como Trixeo Aerosphere atua, 
ou aumentar a probabilidade de efeitos indesejáveis.
...

qualquer medicamento que funcione de forma semelhante a Trixeo Aerosphere - tais como 
tiotrópio, ipratrópio, aclidínio, umeclidínio ou salmeterol, arformoterol, vilanterol, olodaterol ou 
indacaterol. Não se recomenda a utilização de Trixeo Aerosphere se já utiliza estes medicamentos.

...
farmacêutico antes de utilizar Trixeo Aerosphere.
Gravidez e amamentação
Se está grávida ou a amamentar, se pensa estar grávida ou planeia engravidar, consulte o seu médico 
ou farmacêutico antes de utilizar este medicamento.
Não utilize Trixeo Aerosphere se está grávida, a não ser que o seu médico lhe diga que o pode fazer.
...
noite.
É importante que utilize Trixeo Aerosphere todos os dias - mesmo que não tenha sintomas da DPOC 
nesse momento.
Lembre-se: Bocheche sempre com água depois de utilizar Trixeo Aerosphere. Desta forma remove
qualquer vestígio de medicamento que possa ficar na boca. Deve deitar fora a água - não engolir.
Como utilizar
Trixeo Aerosphere é para utilização por via inalatória.
Por favor leia as “Instruções de Utilização" no final deste folheto. Se tiver dúvidas sobre como utilizar 
Trixeo Aerosphere, contacte o seu médico ou farmacêutico.
Utilizar Trixeo Aerosphere com uma câmara expansora
...
Se utilizar mais Trixeo Aerosphere do que deveria
Se tiver utilizado mais Trixeo Aerosphere do que deveria, consulte o seu médico ou farmacêutico 
...
(náuseas).
Caso se tenha esquecido de utilizar Trixeo Aerosphere
...
35
Se parar de utilizar Trixeo Aerosphere
...
Dificuldades respiratórias imediatas:

se sentir dificuldades respiratórias logo após utilizar Trixeo Aerosphere, tais como aperto no 
...
imediatamente após utilizar Trixeo Aerosphere.

sentir-se ansioso

...
Informe o seu médico se tiver qualquer uma das seguintes situações enquanto utilizar Trixeo
...
Não utilize Trixeo Aerosphere após o prazo de validade impresso na embalagem exterior, bolsa e 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Qual a composição de Trixeo Aerosphere
...
Qual o aspeto de Trixeo Aerosphere e conteúdo da embalagem
Trixeo Aerosphere é uma suspensão pressurizada para inalação.
Trixeo Aerosphere apresenta-se como um recipiente com um indicador de dose, fornecido com um
...
Trixeo Aerosphere é embalado numa bolsa de alumínio contendo um agente dessecante (exsicante) e 
