...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Truxima is 
Truxima contains the active substance  rituximab . This is a type of protein called a  monoclonal 
...
<p>What Truxima is used for 
Truxima may be used for the treatment of several different conditions in adults and children. Your 
doctor may prescribe Truxima for the treatment of: </p>
<p>a) 
...
In adult patients where the treatment is working, Truxima may be used as a maintenance treatment 
for 2 years after completing the initial treatment. 
In children and adolescents, Truxima is given in combination with  chemotherapy . </p>
<p>b) 
Chronic lymphocytic leukaemia 
Chronic lymphocytic leukaemia (CLL) is the most common form of adult leukaemia. CLL affects a 
particular lymphocyte, the B cell, which originates from the bone marrow and develops in the lymph 
nodes. Patients with CLL have too many abnormal lymphocytes, which accumulate mainly in the bone 
marrow and blood. The proliferation of these abnormal B-lymphocytes is the cause of symptoms you 
may have. Truxima in combination with chemotherapy destroys these cells which are gradually 
removed from the body by biological processes. </p>
<p>c) 
Rheumatoid arthritis 
Truxima is used for the treatment of rheumatoid arthritis. Rheumatoid arthritis is a disease of the 
joints. B-lymphocytes are involved in the cause of some of the symptoms you have. Truxima is used 
to treat rheumatoid arthritis in people who have already tried some other medicines which have either 
stopped working, have not worked well enough or have caused side effects. Truxima is usually taken 
together with another medicine called methotrexate. </p>
<p>Truxima slows down the damage to your joints caused by rheumatoid arthritis and improves your 
ability to do normal daily activities. </p>
<p>Truxima works best in those who have a positive blood test to rheumatoid factor (RF) and/or 
anti-cyclic citrullinated peptide (anti-CCP). Both tests are commonly positive in rheumatoid arthritis 
and aid in confirming the diagnosis. </p>
<p>d) 
Granulomatosis with polyangiitis or microscopic polyangiitis 
Truxima is used for the treatment of adults and children 2 years of age and older with granulomatosis 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not take Truxima if: 
...
* you have severe heart failure or severe uncontrolled heart disease and have rheumatoid arthritis, 
granulomatosis with polyangiitis, microscopic polyangiitis or pemphigus vulgaris. </p>
<p>Do not have Truxima if any of the above apply to you. If you are not sure, talk to your doctor, 
pharmacist or nurse before you are given Truxima. </p>
<p>Warnings and precautions 
Talk to your doctor, pharmacist or nurse before you are given Truxima if: </p>
<ul>
<li>you have ever had or might now have a hepatitis infection. This is because in a few cases, 
Truxima could cause hepatitis B to become active again, which can be fatal in very rare cases. 
Patients who have ever had hepatitis B infection will be carefully checked by their doctor for 
signs of this infection. </li>
<li>you have ever had heart problems (such as angina, palpitations or heart failure) or breathing 
problems. </li>
</ul>
<p>If any of the above apply to you (or you are not sure), talk to your doctor, pharmacist or nurse before 
you are given Truxima. Your doctor may need to take special care of you during your treatment with 
Truxima. </p>
<p>If you have rheumatoid arthritis, granulomatosis with polyangiitis, microscopic polyangiitis or 
pemphigus vulgaris also tell your doctor 
* if you think you may have an infection, even a mild one like a cold. The cells that are affected 
by Truxima help to fight infection and you should wait until the infection has passed before you 
are given Truxima. Also please tell your doctor if you had a lot of infections in the past or suffer 
...
Truxima can be used for treatment of children and adolescents, 2 years of age and older, with 
granulomatosis with polyangiitis (formerly called Wegener s granulomatosis) or microscopic 
polyangiitis. There is not much information about the use of Truxima in children and adolescents with 
other diseases. 
Talk to your doctor, pharmacist or nurse before you are given this medicine if you, or your child, are 
under 18 years of age. </p>
<p>Other medicines and Truxima 
...
because Truxima can affect the way some other medicines work. Also some other medicines can affect 
the way Truxima works. </p>
<p>In particular, tell your doctor: 
* if you are taking medicines for high blood pressure. You may be asked not to take these other 
medicines 12 hours before you are given Truxima. This is because some people have a fall in 
their blood pressure while they are being given Truxima. 
* if you have ever taken medicines which affect your immune system   such as chemotherapy or 
immune-suppressive medicines. </p>
<p>If any of the above apply to you (or you are not sure), talk to your doctor, pharmacist or nurse before 
you are given Truxima. </p>
<p>Pregnancy and breast-feeding 
You must tell your doctor or nurse if you are pregnant, think that you might be pregnant or are 
planning to become pregnant. This is because Truxima can across the placenta and may affect 
your baby. </p>
<p>If you can get pregnant, you and your partner must use an effective method of contraception 
while using Truxima. You must also do this for 12 months after your last treatment with 
Truxima. </p>
<p>Truxima passes into breast milk in very small amounts. As the long-term effects on breastfed 
infants are not known, for precautionary reasons, breast-feeding is not recommended during 
treatment with Truxima and for 6 months after the treatment. </p>
<p>Driving and using machines 
Rituximab has no or negligible influence on the ability to drive and use machines. </p>
<p>Truxima contains sodium 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>How Truxima is given 
...
side effects. 
You will always be given Truxima as a drip (intravenous infusion). </p>
<p>Medicines given before each Truxima administration 
Before you are given Truxima, you will be given other medicines (pre-medication) to prevent or 
...
Truxima will be given to you once a week for 4 weeks. Repeated treatment courses with 
Truxima are possible. 
* If you are having Truxima with chemotherapy 
Truxima will be given to you on the same day as your chemotherapy. This is usually given 
every 3 weeks up to 8 times. 
* If you respond well to treatment, you may be given Truxima as a maintenance treatment 
every 2 or 3 months for two years. Your doctor may change this, depending on how you 
respond to the medicine. 
* If you are less than 18 years of age, you will be given Truxima with chemotherapy.  You will 
receive Truxima up to 6 times over a 3.5   5.5 month period. </p>
<p>b) 
...
infusions on day 0 cycle 1 then day 1 of each cycle for 6 cycles in total. Each cycle has a duration of 
28 days. The chemotherapy should be given after the Truxima infusion. Your doctor will decide if 
you should receive concomitant supportive therapy. </p>
<p>c) 
...
Repeated courses of treatment with Truxima are possible. Depending on the signs and symptoms of 
your disease, your doctor will decide when you should receive more Truxima. This may be months 
from now. </p>
<p>d) 
If you are being treated for granulomatosis with polyangiitis or microscopic polyangiitis<br />
Treatment with Truxima uses four separate infusions given at weekly intervals. Corticosteroids will 
usually be given by injection before the start of Truxima treatment. Corticosteroids given by mouth 
may be started at any time by your doctor to treat your condition. If you are 18 years of age and 
older and respond well to treatment, you may be given Truxima as a maintenance treatment. This 
will be administered as 2 separate infusions which are given 2 weeks apart, followed by 1 infusion 
every 6 months for at least 2 years. Your doctor may decide to treat you longer with Truxima (up to 
5 years), depending on how you respond to the medicine. </p>
<p>e) 
...
<p>Most side effects are mild to moderate but some may be serious and require treatment. Rarely, some of 
these reactions have been fatal. </p>
<p>Infusion reactions 
During or within the first 24 hours of the infusion you may develop fever, chills and shivering. Less 
frequently, some patients may experience pain at the infusion site, blisters, itching, sickness 
(nausea), tiredness, headache, breathing difficulties, blood pressure raised, wheezing, throat 
discomfort, tongue or throat swelling, itchy or runny nose, vomiting, flushing or palpitations, heart 
attack or low number of platelets. If you have heart disease or angina, these reactions might get 
worse. Tell the person giving you the infusion immediately if you or your child develops any of 
these symptoms, as the infusion may need to be slowed down or stopped. You may require 
...
infusion. Your doctor may decide to stop your Truxima treatment if these reactions are serious. </p>
<p>Infections 
...
<p>You might get infections more easily during your treatment with Truxima. 
...
the genital areas or the eyelids, and fever may be present. Tell your doctor immediately if you have 
...
<p>b) 
If you are being treated for rheumatoid arthritis </p>
<p>Very common side effects (may affect more than 1 in 10 people): 
* infections such as pneumonia (bacterial) 
* pain on passing water (urinary tract infection) 
* allergic reactions that are most likely to occur during an infusion, but can occur up 
to 24-hours after infusion 
* changes in blood pressure, nausea, rash, fever, feeling itchy, runny or blocked nose 
and sneezing, shaking, rapid heart beat, and tiredness 
* headache 
* changes in laboratory tests carried out by your doctor. These include a decrease in the 
amount of some specific proteins in the blood (immunoglobulins) which help protect 
against infection. </p>
<p>Common side effects (may affect up to 1 in 10 people): 
* infections such as bronchial tube inflammation (bronchitis) 
* a feeling of fullness or a throbbing pain behind the nose, cheeks and eyes (sinusitis), pain 
in the abdomen, vomiting and diarrhoea, breathing problems 
* fungal foot infection (athlete s foot) 
* high cholesterol levels in the blood 
* abnormal sensations of the skin, such as numbness, tingling, pricking or burning, 
sciatica, migraine, dizziness 
* loss of hair 
* anxiety, depression 
* indigestion, diarrhoea, acid reflux, irritation and /or ulceration of the throat and the mouth 
* pain in the tummy, back, muscles and/or joints </p>
<p>Uncommon side effects (may affect up to 1 in 100 people): 
...
* allergic reactions including wheezing or shortness of breath, swelling of the face and 
tongue, collapse </p>
<p>Very rare side effects (may affect up to 1 in 10,000 people): 
* a complex of symptoms occurring within a few weeks of an infusion of Truxima including 
allergic like reactions such as rash, itching, joint pain, swollen lymph glands and fever 
...
mouth, the genital areas or the eyelids, and fever may be present. </p>
...
* changes in the rhythm of the heart, or the heart beating faster than normal </p>
<p>Very rare side effects (may affect up to 1 in 10,000 people): 
* severe blistering skin conditions that can be life-threatening. Redness, often associated 
with blisters, may appear on the skin or on mucous membranes, such as inside the 
mouth, the genital areas or the eyelids, and fever may be present. 
* recurrence of a previous Hepatitis B infection </p>
<p>Not known (frequency cannot be estimated from the available data): 
* serious viral infection<br />
* brain and meningeal infection/inflammation (enteroviral meningoencephalitis) </p>
<p>Children and adolescents with granulomatosis with polyangiitis or microscopic polyangiitis 
In general, side effects in children and adolescents with granulomatosis with polyangiitis or 
microscopic polyangiitis were of a similar type to those in adults with granulomatosis with 
polyangiitis or microscopic polyangiitis. Most common side effects seen were infections, allergic 
reactions and feeling sick (nausea). </p>
...
* brain and meningeal infection/inflammation (enteroviral meningoencephalitis) </p>
<p>Truxima may also cause changes in laboratory tests carried out by your doctor. 
If you are having Truxima with other medicines, some of the side effects you may get may be due to 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Truxima contains 
* The active ingredient in Truxima is called rituximab.<br />
...
water for injections (see section 2  Truxima contains sodium ). </li>
</ul>
<p>What Truxima looks like and contents of the pack </p>
<p>Truxima is a clear, colourless solution, supplied as a concentrate for solution for infusion.<br />
...
2. Det skal du vide, før du begynder at få Truxima 
...
<p>Anvendelse 
Truxima kan anvendes til behandling af flere forskellige tilstande hos voksne og børn. Din læge kan 
ordinere Truxima til behandling for: </p>
<p>a) 
Non-Hodgkin-lymfom 
...
Hvis behandlingen virker, kan Truxima fortsættes i 2 år efter, den første behandling er givet. 
Hos børn og unge anvendes Truxima sammen med kemoterapi. </p>
<p>b) 
...
kan have. Truxima anvendt sammen med kemoterapi ødelægger disse celler, som gradvis fjernes fra 
...
regel sammen med et andet lægemiddel, kaldet methotrexat. </p>
<p>Truxima bremser beskadigelsen af dine led forårsaget af reumatoid artrit og forbedrer din evne til at 
udføre normale daglige aktiviteter. </p>
<p>Den bedste virkning af Truxima ses hos dem, som har en positiv blodprøve for reumafaktor (RF) 
...
indholdsstoffer i Truxima (angivet i punkt 6). </p>
</li>
<li>
...
<li>
<p>du har svært nedsat hjertefunktion eller svær, ukontrolleret hjertesygdom og har reumatoid artrit, 
granulomatose med polyangiitis, mikroskopisk polyangiitis eller pemfigus vulgaris. </p>
</li>
</ul>
<p>Du må ikke få Truxima, hvis ét eller flere af ovenstående punkter gælder for dig. Hvis du er i tvivl, 
skal du kontakte lægen, apotekspersonalet eller sundhedspersonalet, inden du får Truxima. </p>
<p>Advarsler og forsigtighedsregler 
Kontakt lægen, apotekspersonalet eller sundhedspersonalet, inden du får Truxima, hvis: </p>
<ul>
<li>
<p>du nogensinde har haft leverbetændelse eller måske har leverbetændelse nu. Det er vigtigt, fordi 
Truxima i enkelte tilfælde har forårsaget, at en tidligere leverbetændelse (hepatitis B) er blevet 
...
<p>Hvis du har reumatoid artrit, granulomatose med polyangiitis, mikroskopisk polyangiitis fortæl 
da også din læge eller pemfigus vulgaris </p>
<ul>
<li>
<p>hvis du tror, du måske har en infektion, selv en mild form som for eksempel en forkølelse. 
Cellerne, der påvirkes af Truxima hjælper med at bekæmpe infektioner, og du bør vente med 
behandling med Truxima, indtil infektionen er forsvundet. Fortæl også lægen, hvis du tidligere 
...
<p>Børn og unge 
Non-Hodgkin-lymfom 
Truxima kan bruges til behandling af børn og unge i alderen 6 måneder og derover, som har non-
...
Truxima kan anvendes til behandling af børn og unge på 2 år og opefter, med granulomatose med 
polyangiitis (tidligere kaldet Wegeners granulomatose) eller mikroskopisk polyangiitis. Der er ikke 
meget information om brugen af Truxima hos børn og unge med andre sygdomme. </p>
...
<p>Brug af anden medicin sammen med Truxima 
...
Det er vigtigt, da Truxima kan påvirke virkningen af anden medicin, og anden medicin kan påvirke 
virkningen af Truxima. </p>
...
12 timer inden, du får Truxima. Nogle har oplevet, at blodtrykket faldt, mens de fik Truxima </p>
</li>
<li>
...
eller planlægger at blive gravid. Truxima kan overføres til moderkagen og påvirke barnet. 
Hvis du er i den fødedygtige alder, skal du og din partner bruge sikker prævention, mens du er i 
behandling med Truxima. I skal fortsætte med sikker prævention i 12 måneder efter din sidste 
behandling med Truxima. 
Truxima udskilles i modermælk i meget små mængder. Idet langtidseffekten på ammende spædbørn er 
ukendt, anbefales amning, af forsigtighedsmæssige årsager, i ikke under behandling med Truxima og  i 
...
Truxima gives altid i et drop (intravenøs infusion). </p>
<p>Medicin, der gives inden hver behandling med Truxima 
...
<ul>
<li>
<p>Hvis du får Truxima alene 
Truxima gives en gang ugentligt i 4 uger. Gentagne behandlingsforløb med Truxima er mulige. </p>
</li>
<li>
<p>Hvis du får Truxima sammen med kemoterapi 
Truxima gives samme dag som kemoterapien. Det vil sædvanligvis sige hver 3. uge, op til 
8 gange. </p>
</li>
<li>
<p>Hvis medicinen virker godt hos dig, kan du få Truxima hver 2. eller 3. måned i op til 2 år. 
...
Hvis du behandles med Truxima i kombination med kemoterapi, vil du få en infusion med Truxima på 
dag 0 i serie 1 og derefter på dag 1 i hver af i alt 6 serier. Hver serie varer 28 dage. Kemoterapien skal 
gives efter infusionen med Truxima. Din læge vil tage stilling til, om du samtidig skal have 
...
behandlingsforløb med Truxima er mulige. Afhængigt af kliniske fund og symptomer på din sygdom, 
vil din læge bedømme, om du skal have mere Truxima. Dette kan være om flere måneder. </p>
<p>d) 
...
tilstand. Hvis du er 18 år eller derover og reagerer godt på behandlingen kan du få Truxima som 
...
tid med Truxima (op til 5 år), alt efter hvor godt du reagerer på medicinen. </p>
<p>e)        Hvis du behandles for pemfigus vulgaris 
...
Sjældent har nogle af disse bivirkninger været dødelige. </p>
...
<p>Risikoen for infektioner kan øges under behandling med Truxima. Det vil ofte dreje sig om forkølelser, 
...
<p>Hvis du behandles for reumatoid artritis, granulomatose med polyangiitis, mikroskopisk polyangiitis 
eller pemfigus vulgaris vil du også finde denne information i patientkortet, som du har fået af lægen. 
Det er vigtigt, at du gemmer dette kort og viser det til din partner eller hjælper. </p>
<p>Hudsygdomme 
...
<p>b) 
Hvis du behandles for reumatoid artrit </p>
<p>Meget almindelige bivirkninger (kan forekomme hos flere end 1 ud af 10 patienter): </p>
<ul>
<li>
<p>infektioner som f.eks. lungebetændelse (bakteriel) </p>
</li>
<li>
<p>smerte ved vandladning (urinvejsinfektion) </p>
</li>
<li>
<p>allergiske reaktioner, som højst sandsynligt forekommer under infusion, men kan forekomme 
i op til 24 timer efter infusion </p>
</li>
<li>
<p>ændringer i blodtryk, kvalme, udslæt, feber, en følelse af kløe, løbende eller stoppet næse og 
nysen, rysten, hurtig hjerterytme (puls) og træthed </p>
</li>
<li>
<p>hovedpine </p>
</li>
<li>
<p>ændringer i laboratorieundersøgelser udført af din læge. Disse ændringer inkluderer nedsat 
indhold af nogle specifikke proteiner i blodet (immunglobuliner), som hjælper med at 
beskytte mod infektioner </p>
</li>
</ul>
<p>Almindelige bivirkninger (kan forekomme hos op til 1 ud af 10 patienter): </p>
<ul>
<li>
<p>infektioner som f.eks. inflammation i bronkierne (bronkitis) </p>
</li>
<li>
<p>en trykkende følelse eller en dunkende smerte bag næse, kinder og øjne (bihulebetændelse), 
ondt i maven, opkastning og diarré, vejrtrækningsproblemer </p>
</li>
<li>
<p>fodsvamp </p>
</li>
<li>
<p>høje kolesterolniveauer i blodet </p>
</li>
<li>
<p>unormal fornemmelse i huden, såsom følelsesløshed, snurren, prikken eller brænden, iskias, 
migræne, svimmelhed </p>
</li>
<li>
<p>hårtab </p>
</li>
<li>
<p>angst, depression </p>
</li>
<li>
<p>fordøjelsesbesvær, diarré, sure opstød, irritation og/eller sårdannelse i halsen og munden </p>
</li>
<li>
<p>smerter i maven, ryg, muskler og/eller led </p>
</li>
</ul>
<p>Ikke almindelige bivirkninger (kan forekomme hos op til 1 ud af 100 patienter): </p>
<ul>
<li>
<p>væskeophobning i ansigtet og kroppen </p>
</li>
<li>
<p>vævsirritation, irritation og/eller tæthed i lunger og hals, hoste </p>
</li>
<li>
<p>hudreaktioner herunder nældefeber, kløe og udslæt </p>
</li>
<li>
<p>allergiske reaktioner herunder hvæsende vejrtrækning og åndenød, hævelse af ansigt og 
tunge, kollaps </p>
</li>
</ul>
<p>Meget sjældne bivirkninger (kan forekomme hos op til 1 ud af 10.000 patienter): </p>
<ul>
<li>
<p>et kompleks af symptomer, som forekommer inden for nogle få uger efter en infusion med 
Truxima, herunder allergiske reaktioner, såsom udslæt, kløe, ledsmerter, hævede lymfekirtler 
og feber  </p>
</li>
<li>
...
<ul>
<li>hjerne- og hjernehinde infektion/betændelse (enteroviral meningoencefalitis) </li>
</ul>
<p>Andre sjældent rapporterede bivirkninger af Truxima inkluderer nedsættelse i antallet af hvide 
blodlegemer (neutrofiler), som hjælper med at bekæmpe infektioner. Nogle infektioner kan være 
alvorlige (se venligst information om Infektioner i dette afsnit). </p>
<p>c) 
...
<p>Truxima kan også ændre resultaterne på de blodprøver, som lægen har bestilt. 
Hvis du får Truxima sammen med anden medicin, kan nogle bivirkninger være forårsaget af den 
anden medicin. </p>
...
injektionsvæsker(se afsnit 2 “Truxima indeholder natrium"). </p>
</li>
</ul>
<p>Udseende og pakningsstørrelser </p>
<p>Truxima er en klar, farveløs opløsning, leveret som koncentrat til infusionsvæske, opløsning.<br />
...
* identifier[+].system = "http://ema.europa.eu/identifier"
* identifier[=].value = "Truxima 100 mg concentrate for solution for infusion"
