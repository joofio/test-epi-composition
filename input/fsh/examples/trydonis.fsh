...
<ol>
<li>What Trydonis is and what it is used for </li>
<li>What you need to know before you use Trydonis </li>
<li>How to use Trydonis </li>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Trydonis is a medicine to help breathing that contains the three active substances: 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not use Trydonis </p>
...
<p>Trydonis is used as a maintenance treatment for your obstructive lung disease. Do not use this 
...
after inhaling your medicine, stop using Trydonis inhaler and use your quick-acting  reliever  inhaler 
...
<p>Talk to your doctor or pharmacist before using Trydonis: </p>
<ul>
<li>
...
<li>
<p>if you have low blood levels of potassium (hypokalaemia). The combination of Trydonis with 
...
to stop using Trydonis at least 12 hours before the anaesthesia. </p>
</li>
<li>
...
<p>If any of the above applies to you, tell your doctor before you use Trydonis.<br />
If you have or have had any medical problems or any allergies or if you are not sure if you can use 
Trydonis, talk to your doctor or pharmacist before using the inhaler.  </p>
<p>If you are already using Trydonis  </p>
<p>If you are using Trydonis or high doses of other inhaled corticosteroids over long periods and you 
...
<p>Other medicines and Trydonis 
Tell your doctor or pharmacist if you are taking, have recently taken or might take any other 
medicines. This includes medicines similar to Trydonis used for your lung disease.  </p>
<p>Some medicines may increase the effects of Trydonis and your doctor may wish to monitor you 
...
<p>Using Trydonis together with:  </p>
<ul>
...
sick, being sick, stomach pain) due to the small amount of alcohol in Trydonis. </p>
</li>
</ul>
<p>Pregnancy and breast-feeding<br />
If you are pregnant or breast-feeding, think you may be pregnant or are planning to have a baby, ask 
your doctor or pharmacist for advice before using this medicine.  </p>
<p>You should only use Trydonis during pregnancy if you are advised to do so by your doctor. It is 
preferable to avoid the use of Trydonis during labour due to the inhibitory effects of formoterol on 
uterine contractions. 
You should not use Trydonis during breast-feeding. You and your doctor must make a decision 
whether to discontinue breast-feeding or to discontinue/abstain from Trydonis therapy taking into 
account the benefit of breast-feeding for your child and the benefit of therapy for you. </p>
<p>Driving and using machines 
Trydonis is unlikely to affect your ability to drive and use machines. </p>
<p>Trydonis contains ethanol 
...
doctor for advice, as the effective dose of beclometasone dipropionate in Trydonis for the treatment of 
...
<p>Trydonis is available in three container sizes:<br />
...
you press the pressurised container, a puff of medicine is released and the dose indicator rotates by a </p>
<p>small amount. The number of puffs remaining is displayed in intervals of 20. Take care not to drop the 
...
<p>Cleaning of the Trydonis inhaler 
...
<p>If you use more Trydonis than you should 
It is important that you take your dose as advised by your doctor. Do not exceed your prescribed dose 
without talking to your doctor. 
If you use more Trydonis than you should, side effects, as described in section 4, may occur.<br />
Tell your doctor if you have used more Trydonis than you should and if you experience any of these 
symptoms. Your doctor may wish to carry out some blood tests. </p>
<p>If you forget to use Trydonis 
...
should stop using Trydonis and use your quick-acting  reliever  inhaler straightaway to treat the 
...
<p>Tell your doctor if you have any of the following while using Trydonis as they could be symptoms of 
...
<p>Trydonis does not contain a high-dose inhaled corticosteroid, but your doctor may wish to measure the 
...
* section[=].section[+]
  ...
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "2. Det skal du vide, før du begynder at tage  trydonis"
  * text.status = #additional
...
* section[=].section[+]
  ...
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "3. Sådan skal du tage trydonis"
  * text.status = #additional
