...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Instructions for use of Ulunar Breezhaler inhaler </p>  </div>"""   
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Ulunar Breezhaler is 
...
<p>What Ulunar Breezhaler is used for 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not use Ulunar Breezhaler 
...
Talk to your doctor, pharmacist or nurse before using Ulunar Breezhaler if any of the following 
applies to you:</p>
<ul>
...
(same class) to those in Ulunar Breezhaler (see section  Other medicines and Ulunar 
Breezhaler ). </li>
...
<p>During treatment with Ulunar Breezhaler 
...
<p>Ulunar Breezhaler is used as an ongoing treatment for your COPD. Do not use this medicine to treat a 
...
<p>Other medicines and Ulunar Breezhaler 
Tell your doctor or pharmacist if you are using, have recently used or might use any other medicines. 
In particular, please tell your doctor or pharmacist if you are using:</p>
<ul>
<li>any medicines that may be similar to Ulunar Breezhaler (contain similar active substances). </li>
...
Ulunar Breezhaler, may prevent labour due to its effect on the uterus. </p>
<p>If you are pregnant or breast-feeding, think you may be pregnant or are planning to have a baby, ask 
your doctor or pharmacist for advice before using this medicine. You should not use Ulunar 
...
<p>Ulunar Breezhaler contains lactose 
...
<p>How much Ulunar Breezhaler to use 
...
<p>When to inhale Ulunar Breezhaler 
Use this medicine at the same time each day. This will also help you to remember to use it. 
You can inhale Ulunar Breezhaler any time before or after food or drink. </p>
<p>How to inhale Ulunar Breezhaler 
...
inhalation powder. Only use the capsules with the inhaler provided in this pack (Ulunar 
...
inhaler. </p>
<p>If you use more Ulunar Breezhaler than you should 
If you have inhaled too much of this medicine or if someone else accidentally uses your capsules, you 
must immediately either tell your doctor or go to the nearest emergency unit. Show the pack of Ulunar 
...
visual disturbances, feel constipated or have difficulty when passing urine. </p>
<p>If you forget to use Ulunar Breezhaler 
...
<p>Keep using Ulunar Breezhaler for as long as your doctor tells you. </p>
<p>COPD is a long-term disease and you should use Ulunar Breezhaler every day and not only 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Ulunar Breezhaler contains 
...
(see section 2 under  Ulunar Breezhaler contains lactose ). </p>
<p>What Ulunar Breezhaler looks like and contents of the pack </p>
<p>Ulunar Breezhaler 85 micrograms/43 micrograms inhalation powder, hard capsules are transparent and 
yellow and contain a white to almost white powder. They have the product code  IGP110.50  printed 
in blue under two blue bars on the body and the company logo (
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Brugsanvisning til Ulunar Breezhaler-inhalator </p>  </div>"""   
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Tag ikke Ulunar Breezhaler 
...
Kontakt lægen, apotekspersonalet eller sygeplejersken, før du tager Ulunar Breezhaler hvis noget af 
...
klasse) som dem i Ulunar Breezhaler (se under "Brug af anden medicin sammen med Ulunar 
Breezhaler"). </li>
...
<p>Under behandling med Ulunar Breezhaler 
...
<p>Ulunar Breezhaler anvendes som en vedvarende behandling af din KOL. Brug ikke dette lægemiddel 
...
<p>Brug af anden medicin sammen med Ulunar Breezhaler 
...
 
medicin som kan være tilsvarende Ulunar Breezhaler (indeholder lignende aktive stoffer). 
 
...
aktive stof i denne medicin udskilles i human mælk. Indacaterol, et af de aktive stoffer i Ulunar 
...
Ulunar Breezhaler, medmindre du har aftalt det med din læge. </p>
...
<p>Ulunar Breezhaler indeholder lactose 
...
<p>Så meget Ulunar Breezhaler skal du tage 
...
<p>Tidspunkt for inhalering af Ulunar Breezhaler 
Tag dette lægemiddel på samme tidspunkt hver dag. Det hjælper dig også med at huske at tage 
medicinen. 
Du kan inhalere Ulunar Breezhaler på hvilket som helst tidspunkt før og efter indtagelse af mad og 
drikke. </p>
<p>Sådan skal du inhalere Ulunar Breezhaler 
- Ulunar Breezhaler tages ved indånding. 
- Denne pakning indeholder en inhalator og kapsler (i blister), som indeholder medicinen i form 
af et inhalationspulver. Brug kun kapslerne sammen med den vedlagte inhalator (Ulunar 
...
- Når du starter på en ny pakning, skal du bruge den nye Ulunar Breezhaler-inhalator, som er 
vedlagt pakningen. 
...
<p>Hvis du har taget for meget Ulunar Breezhaler 
...
Vis dem pakken med Ulunar Breezhaler. Behandling kan være nødvendig. Du kan muligvis opleve, at 
dit hjerte slår hurtigere end normalt, eller du kan have hovedpine, føle dig døsig, have kvalme eller 
blive nødt til at kaste op. Du kan også opleve synsforstyrrelser, føle dig forstoppet eller have 
problemer med at lade vandet. </p>
<p>Hvis du har glemt at tage Ulunar Breezhaler 
...
 
Fortsæt med at bruge Ulunar Breezhaler så længe din læge siger du skal gøre det. 
- KOL er en kronisk sygdom, og du skal tage Ulunar Breezhaler hver dag og ikke blot, når du 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Ulunar Breezhaler indeholder 
...
afsnit 2 under "Ulunar Breezhaler indeholder lactose"). </p>
<p>Udseende af Ulunar Breezhaler og pakningsstørrelser </p>
<p>Ulunar Breezhaler 85 mikrogram/43 mikrogram inhalationspulver, hårde kapsler, er gennemsigtige og 
gule og indeholder et hvidt til næsten hvidt pulver. De har produktkoden "IGP110.50" trykt med blåt 
under to blå streger på underdelen og virksomhedens logo (
...
<p>Læs venligst den fulde anvisning for brug inden du bruger Ulunar Breezhaler. </p>
<p>Læg en kapsel i 
Perforer og slip 
Inhaler dybt 
...
<p>Trin 1e: 
Luk inhalatoren </p>
<p>Din Ulunar Breezhaler inhalatorpakning indeholder: 
 En Ulunar Breezhaler inhalator 
 Et eller flere blisterkort, som hver indeholder 
enten 6 eller 10 Ulunar Breezhaler kapsler til 
