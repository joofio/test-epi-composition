...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>You must not be given Vaborem if 
* you are allergic to meropenem, vaborbactam or the other ingredients of this medicine (listed in 
section 6). 
* you are allergic to other carbapenem antibiotics (the group to which meropenem belongs). 
* you have ever had a severe allergic reaction to related antibiotics belonging to the beta-lactam group 
(including penicillins, cephalosporins or monobactams).  </p>
<p>Warnings and precautions<br />
Talk to your doctor or nurse before receiving Vaborem if: 
* you have ever had any allergic reaction to other antibiotics belonging to the beta-lactam group 
(including carbapenems, penicillins, cephalosporins, or monobactams) 
* you have ever developed severe diarrhoea during or after antibiotic treatment 
* you have ever suffered from seizures </p>
<p>If any of the above apply to you or you are not sure, talk to your doctor or nurse before using Vaborem. </p>
<p>You may develop signs and symptoms of severe skin reactions (see section 4). If this happens talk to your 
doctor or nurse immediately so that they can treat the symptoms. </p>
<p>Talk to your doctor or nurse if you suffer from diarrhoea during your treatment. </p>
<p>This medicine can affect your liver. Your doctor may take some blood to check how well your liver is 
working while taking the medicine. </p>
<p>New infection 
Although Vaborem can fight certain bacteria, there is a possibility that you may get a different infection 
caused by another organism during or after your treatment. Your doctor will monitor you closely for any 
...
Vaborem should not be used in children or adolescents under 18 years of age. This is because it is not 
known if the medicine is safe to use in these age groups. </p>
<p>Other medicines and Vaborem 
Tell your doctor if you are using, have recently used or might use any other medicines. </p>
<p>It is particularly important to tell your doctor if you are taking any of the following medicines: 
* medicines used to treat epilepsy called valproic acid, sodium valproate or valpromide because 
Vaborem may decrease their effect<br />
<em> a medicine for gout called probenecid 
* oral anticoagulant medicines, such as warfarin (used to treat or prevent blood clots) 
* hormonal oral contraceptives containing oestrogen and/or progesterone because Vaborem may 
decrease their effect. Women of childbearing potential should be advised to use alternative effective 
contraceptive methods during treatment with Vaborem and for a period of 28 days after 
discontinuation of treatment.<br />
</em> medicines predominantly metabolised by CYP1A2 (e.g theophylline), CYP3A4 (e.g alprazolam, 
midazolam, tacrolimus, sirolimus, cyclosporine, simvastatin, omeprazole, nifedipine, quinidine and 
ethinylestradiol) and/or CYP2C (e.g. warfarin, phenytoin) and/or transported by P-gp (e.g. 
dabigatran, digoxin) because Vaborem may decrease their effect.  </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>The recommended dose is 2 vials (a total of 2 g meropenem and 2 g vaborbactam), given every 8 hours. 
Your doctor will decide how many days of treatment are needed, depending on the type of infection. </p>
<p>Vaborem will be given to you by a doctor or nurse by infusion (a drip) into a vein, lasting 3 hours.  </p>
<p>Patients with kidney problems 
If you have kidney problems, your doctor may lower your dose. Your doctor may also want to do some 
blood tests to see how well your kidneys are working. </p>
<p>If you are given more Vaborem than you should 
Vaborem will be given to you by a doctor or a nurse, so it is unlikely you will be given the wrong dose. If 
...
* The following reactions may develop, alone or in combination, where Vaborem is given into a 
vein: reddened skin (erythema); hot, tender and swollen vein around the needle (phlebitis); a blood 
...
* Sudden onset of a severe rash with bullseye-like spots or blistering or peeling skin, possibly with a 
high fever, joint pain, abnormal function of your liver, kidney or lung (these may be signs of more 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Vaborem contains<br />
* The active substances are meropenem and vaborbactam. Each vial contains 1 g meropenem (as 
meropenem trihydrate) and 1 g vaborbactam. 
* The other ingredient is sodium carbonate. </p>
<p>What Vaborem looks like and contents of the pack 
Vaborem is a white to light yellow powder for concentrate for solution for infusion supplied in a vial.  </p>
...
<p>Vaborem is intended for intravenous (IV) administration, only after reconstitution and dilution. 
Standard aseptic techniques must be used for solution preparation and administration. </p>
<p>The number of vials used for a single dose will depend on the creatinine clearance (CrCl) of the patient.  </p>
<p>Reconstitution:<br />
20 ml of sodium chloride 9 mg/ml (0.9%) solution for injection (normal saline) should be withdrawn from 
