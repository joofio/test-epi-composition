...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>VEGZELMA contains the active substance bevacizumab, which is a humanised monoclonal antibody 
(a type of protein that is normally made by the immune system to help defend the body from infection 
...
<p>VEGZELMA is a medicine used for the treatment of adult patients with advanced cancer in the large 
bowel, i.e., in the colon or rectum. VEGZELMA will be administered in combination with 
chemotherapy treatment containing a fluoropyrimidine medicine. </p>
<p>VEGZELMA is also used for the treatment of adult patients with metastatic breast cancer. When used 
...
<p>VEGZELMA is also used for the treatment of adult patients with advanced non-small cell lung cancer. 
VEGZELMA will be administered together with a chemotherapy regimen containing platinum. </p>
<p>VEGZELMA is also used for the treatment of adult patients with advanced non-small cell lung cancer 
when cancer cells have specific mutations of a protein called epidermal growth factor receptor 
(EGFR). VEGZELMA will be administered in combination with erlotinib. </p>
<p>VEGZELMA is also used for treatment of adult patients with advanced kidney cancer. When used for 
patients with kidney cancer, it will be administered with another type of medicine called interferon. </p>
<p>VEGZELMA is also used for the treatment of adult patients with advanced epithelial ovarian, 
fallopian tube, or primary peritoneal cancer. When used for patients with epithelial ovarian, fallopian 
tube, or primary peritoneal cancer, it will be administered in combination with carboplatin and 
paclitaxel. </p>
...
with a chemotherapy regimen containing a platinum agent, VEGZELMA will be administered in 
...
cancer. These therapies in combination with VEGZELMA may increase the risk of severe side effects.  </p>
...
<p>You must not use this medicine if you are pregnant. VEGZELMA may cause damage to your unborn 
baby as it may stop the formation of new blood vessels. You should be advised by your doctor about 
using contraception during treatment with VEGZELMA and for at least 6 months after the last dose of 
VEGZELMA.  </p>
...
<p>You must not breast-feed your baby during treatment with VEGZELMA and for at least 6 months 
after the last dose of VEGZELMA, as this medicine may interfere with the growth and development of 
your baby. </p>
<p>VEGZELMA may impair female fertility. Please consult your doctor for more information.  </p>
<p>Ask your doctor, pharmacist or nurse for advice before taking any medicine.  </p>
<p>Driving and using machines<br />
VEGZELMA has not been shown to reduce your ability to drive or to use any tools or machines. 
However, sleepiness and fainting have been reported with VEGZELMA use. If you experience 
...
<p>The dose of VEGZELMA needed depends on your body weight and the kind of cancer to be treated. 
The recommended dose is 5 mg, 7.5 mg, 10 mg or 15 mg per kilogram of your body weight. Your 
doctor will prescribe a dose of VEGZELMA that is right for you. You will be treated with 
VEGZELMA once every 2 or 3 weeks. The number of infusions that you receive will depend on how 
you are responding to treatment; you should continue to receive this medicine until VEGZELMA fails 
to stop your tumour growing. Your doctor will discuss this with you. </p>
<p>Method and route of administration  </p>
<p>VEGZELMA is a concentrate for solution for infusion. Depending on the dose prescribed for you, 
some or all of the contents of the VEGZELMA vial will be diluted with sodium chloride solution 
before use. A doctor or nurse will give you this diluted VEGZELMA solution by intravenous infusion 
...
<p>The side effects listed below were seen when VEGZELMA was given together with chemotherapy. 
This does not necessarily mean that these side effects were strictly caused by VEGZELMA.  </p>
...
<p>VEGZELMA has been developed and made to treat cancer by injecting it into the bloodstream. It has 
...
brown liquid in a glass vial with a rubber stopper. Each vial contains 100 mg bevacizumab in 4 mL of 
solution or 400 mg bevacizumab in 16 mL of solution. Each pack of VEGZELMA contains 1 vial or 
10 vials.  </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>VEGZELMA indeholder det aktive stof bevacizumab, som er et humaniseret monoklonalt antistof (et 
type protein, som normalt laves af immunsystemet, og som hjælper med at beskytte kroppen mod 
infektioner og kræft). Bevacizumab bindes selektivt til et protein, som kaldes human vaskulær 
endotelial vækstfaktor (VEGF), som findes på indersiden af blod- og lymfekar i kroppen. 
VEGF-proteinet får blodkarrene i kræftknuden til at vokse. Disse blodkar forsyner tumoren med 
...
<p>VEGZELMA er medicin som anvendes hos voksne til behandling af fremskreden kræft i tyktarmen 
eller endetarmen. VEGZELMA vil blive givet i kombination med kemoterapibehandling, der 
indeholder fluoropyrimidin. </p>
<p>VEGZELMA anvendes også hos voksne til behandling af metastatisk brystkræft. Når det anvendes til 
...
<p>VEGZELMA bruges også hos voksne til behandling af fremskreden ikke-småcellet lungekræft. 
VEGZELMA vil blive givet sammen med kemoterapibehandling, der indeholder platin. </p>
<p>VEGZELMA bruges også hos voksne til behandling af fremskreden ikke-småcellet lungekræft, når 
kræftcellerne har bestemte mutationer i et protein, der kaldes epidermal vækstfaktor-receptor (EGFR). 
VEGZELMA vil blive givet sammen med erlotinib. </p>
<p>VEGZELMA bruges også hos voksne til behandling af fremskreden nyrekræft. Når det anvendes til 
patienter med nyrekræft, bliver det givet sammen med en anden type medicin, som kaldes interferon. </p>
<p>VEGZELMA bruges også hos voksne til behandling af fremskreden kræft i æggestokkene, kræft i 
...
sidste kemoterapi, som indeholdt platin, vil VEGZELMA blive givet sammen med carboplatin og 
...
efter sidste kemoterapi, som indeholdt platin, vil VEGZELMA blive givet sammen med paclitaxel 
eller topotecan eller pegyleret liposomal doxorubicin. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Brug ikke VEGZELMA: 
● 
...
Kontakt lægen, apotekspersonalet eller sygeplejersken, før du bruger VEGZELMA: </p>
<p>● 
Det er muligt, at VEGZELMA kan øge risikoen for, at der dannes huller i tarmvæggen. Tal med 
din læge, hvis du har tilstande, som forårsager betændelse i maveregionen (f.eks. diverticulitis, 
mavesår, tyktarmsbetændelse forbundet med kemoterapi). </p>
<p>● 
VEGZELMA kan øge risikoen for, at der dannes abnorme forbindelser eller passager mellem to 
...
<p>● 
VEGZELMA kan øge risikoen for blødning eller problemer med sårhelingen efter operation. 
Hvis du skal opereres, hvis du har fået foretaget en større operation indenfor de sidste 28 dage, 
eller hvis du har et sår efter en operation, som ikke er helet, må du ikke få VEGZELMA. </p>
<p>● 
VEGZELMA kan øge risikoen for udvikling af alvorlige infektioner i huden eller i de 
dybereliggende lag under huden, især hvis du har haft hul i tarmen eller problemer med 
sårheling. </p>
<p>● 
VEGZELMA kan øge hyppigheden af forhøjet blodtryk. Hvis du har forhøjet blodtryk, som 
ikke er velbehandlet med blodtrykssænkende medicin, skal du kontakte din læge, fordi det er 
vigtigt at sikre, at dit blodtryk er under kontrol, før du starter i behandling med VEGZELMA. </p>
<p>● 
Hvis du har eller har haft et aneurisme (udvidelse og svækkelse af en blodårevæg) eller en rift i 
en blodårevæg. </p>
<p>● 
VEGZELMA kan øge risikoen for at få protein i urinen, især hvis du har forhøjet blodtryk. </p>
<p>● 
...
<p>● 
VEGZELMA kan også øge risikoen for at udvikle blodpropper i venerne (en type blodkar), </p>
<p>● 
VEGZELMA kan forårsage blødning, især tumor-relateret blødning. Kontakt din læge, hvis du 
eller din familie har tendens til blødningsproblemer, eller hvis du tager blodfortyndende 
medicin. </p>
<p>● 
Det er muligt, at VEGZELMA kan forårsage blødning i og omkring hjernen. Tal med din læge, 
hvis du har kræftspredning, som påvirker hjernen. </p>
<p>● 
Det er muligt, at VEGZELMA kan øge risikoen for blødning i lungerne, herunder blodig hoste 
eller spyt. Tal med din læge, hvis du tidligere har bemærket dette. </p>
<p>● 
VEGZELMA kan øge risikoen for at udvikle et svagt hjerte. Det er vigtigt, at din læge ved, om 
du tidligere har fået antracykliner (for eksempel doxorubicin, en speciel slags kemoterapi, som 
bruges mod nogle kræfttyper), om du har fået strålebehandling af brystet, eller om du har en 
hjertesygdom. </p>
<p>● 
VEGZELMA kan forårsage infektioner og nedsætte antallet af neutrofiler (en type blodceller, 
som er vigtige for at beskytte dig mod bakterier). </p>
<p>● 
Det er muligt, at VEGZELMA kan forårsage overfølsomhed (herunder anafylaktisk shock) 
og/eller infusionsrelaterede reaktioner. Fortæl lægen, apotekspersonalet eller sygeplejersken, 
hvis du tidligere har oplevet problemer efter injektioner, såsom svimmelhed/fornemmelse af at 
...
har været knyttet til VEGZELMA-behandling. Hvis du får hovedpine, synsforstyrrelser, bliver 
...
fortælle din tandlæge, at du er i behandling med VEGZELMA (bevacizumab), især hvis du også 
bliver eller er blevet behandlet med bisfosfonater, som injektion i blodet. </p>
<p>Du kan blive rådet til at få foretaget et tandeftersyn, før du starter i behandling med VEGZELMA. </p>
<p>Børn og unge 
Det frarådes at anvende VEGZELMA til børn og unge under 18 år, da sikkerheden og fordelene ved 
VEGZELMA ikke er fastlagt hos denne patientgruppe. </p>
<p>Der er rapporteret tilfælde af dødt knoglevæv (nekrose) i andre knogler end i kæben hos patienter 
under 18 år, som blev behandlet med bevacizumab. </p>
<p>Brug af anden medicin sammen med VEGZELMA 
...
<p>Kombination af VEGZELMA med en anden medicin, sunitinibmalat (ordineret for kræft i nyrerne 
eller mave-tarmkanalen) kan forårsage alvorlige bivirkninger. Tal med din læge for at sikre, at du ikke 
...
som har spredt sig. Kombination af VEGZELMA og disse behandlinger kan øge risikoen for alvorlige 
bivirkninger. </p>
<p>Fortæl det til din læge, hvis du får eller for nylig har fået strålebehandling. </p>
<p>Graviditet, amning og frugtbarhed 
Du må ikke anvende denne medicin, hvis du er gravid. VEGZELMA kan skade det ufødte barn, da det 
kan standse dannelsen af nye blodkar. Din læge bør vejlede dig om anvendelsen af prævention under 
behandlingen med VEGZELMA og i mindst 6 måneder efter sidste VEGZELMA-dosis. </p>
<p>Fortæl straks din læge, hvis du er gravid, bliver gravid under behandling med VEGZELMA eller har 
planer at blive gravid. 
Du må ikke amme under behandling med VEGZELMA og i mindst 6 måneder efter sidste 
VEGZELMA-dosis, da VEGZELMA kan påvirke væksten og udviklingen af dit barn. </p>
<p>VEGZELMA kan nedsætte kvinders frugtbarhed. Kontakt din læge for at få yderligere information.  </p>
<p>Spørg lægen, apotekspersonalet eller sygeplejersken til råds, før du tager nogen form for medicin. </p>
<p>Trafik- og arbejdssikkerhed 
Det er ikke påvist, at VEGZELMA nedsætter din evne til at køre bil eller betjene maskiner. 
Alligevel er der rapporteret søvnighed og besvimelse ved anvendelse af VEGZELMA. Hvis du 
oplever symptomer, som påvirker dit syn eller din koncentrationsevne eller din reaktionsevne, skal du 
...
<p>Dosis af VEGZELMA afhænger af din legemsvægt og af den type kræft, der skal behandles. Den 
anbefalede dosis er 5 mg, 7,5 mg, 10 mg eller 15 mg pr. kilo legemsvægt. Din læge vil ordinere den 
dosis VEGZELMA, som passer til dig. Du vil blive behandlet med VEGZELMA én gang hver 2. eller 
3. uge. Antallet af infusioner, som du skal have, afhænger af, hvordan du reagerer på behandlingen. 
Du skal fortsætte med VEGZELMA, indtil VEGZELMA ikke længere hindrer tumoren i at vokse. Din 
læge vil diskutere det med dig. </p>
<p>Indgivelsesmetode og indgivelsesvej </p>
<p>VEGZELMA er et koncentrat til opløsning til infusion. Afhængig af den dosis, som er foreskrevet til 
dig, vil en del af indholdet i VEGZELMA-hætteglasset eller hele indholdet blive fortyndet med 
natriumchloridopløsning (saltvandsopløsning) før anvendelsen. Du vil få den fortyndede 
VEGZELMA-opløsning af en læge eller sygeplejerske ved intravenøs infusion (et drop i din vene). 
Den første infusion vil vare 90 minutter. Hvis den tåles godt, vil den næste infusion vare 60 minutter. 
...
<p>● 
Din læge beslutter, hvornår du skal have den næste VEGZELMA-dosis. Du bør tale med din 
læge herom. </p>
...
<p>De bivirkninger, der er vist nedenfor, blev observeret, når VEGZELMA blev givet sammen med 
kemoterapi. Det betyder ikke at disse bivirkninger nødvendigvis kun skyldes VEGZELMA. </p>
...
træthed, 
● 
diarré, kvalme, opkastning og mavesmerte. </p>
<p>Alvorlige bivirkninger, som kan være almindelige (kan påvirke op til 1 ud af 10 patienter), omfatter: 
● 
huller i tarmen, 
● 
...
<p>Alvorlige bivirkninger, som kan være sjældne (kan påvirke op til 1 ud af 1 000), omfatter: 
● 
pludselige alvorlige allergiske reaktioner med vejrtrækningsproblemer, hævelse, ørhed, hurtig 
hjerterytme, svedudbrud og bevidstløshed (anafylaktisk shock). </p>
...
● 
hul i galdeblæren (symptomer kan være mavesmerter, feber og kvalme/opkastning). </p>
...
● 
næseblod. </p>
<p>Almindelige bivirkninger (kan påvirke op til 1 ud af 10), som ikke er alvorlige, omfatter: 
● 
ændringer i stemmen og hæshed. </p>
...
● 
forhøjet blodtryk. </p>
<p>VEGZELMA kan også forårsage ændringer i de laboratorieundersøgelser, som din læge foretager. 
Disse inkluderer: Nedsat antal hvide blodceller, specielt neutrofile (en type hvide blodceller, som 
hjælper mod infektioner), protein i urinen, nedsat kalium, nedsat natrium eller nedsat fosfor (mineral) i 
...
(findes i røde blodceller, og som transporterer ilt), som kan være alvorlig. </p>
...
<p>VEGZELMA er blevet udviklet og fremstillet til behandling af kræft efter injektion i blodbanen. Det 
er ikke blevet udviklet eller fremstillet til injektion i øjet. Det er derfor ikke godkendt til anvendelse på 
denne måde. Hvis bevacizumab injiceres direkte i øjet (ikke-godkendt brug), kan følgende 
...
fortyndingen har fundet sted under sterile forhold, er VEGZELMA stabil i 60 dage ved 2 ºC - 8 ºC og 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>VEGZELMA indeholder: 
● 
Aktivt stof; bevacizumab. Hver ml koncentrat indeholder 25 mg bevacizumab svarende til 1,4 
...
VEGZELMA er et koncentrat til infusionsvæske, opløsning. Koncentratet er en klar, farveløs til 
lysebrun væske i et hætteglas af glas med gummilukke. Hvert hætteglas indeholder 100 mg 
bevacizumab i 4 ml opløsning eller 400 mg bevacizumab i 16 ml opløsning. Hver pakning med 
VEGZELMA indeholder 1 eller 10 hætteglas. </p>
