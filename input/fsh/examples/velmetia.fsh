...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Velmetia contains two different medicines called sitagliptin and metformin.
* sitagliptin belongs to a class of medicines called DPP-4 inhibitors (dipeptidyl
peptidase-4 inhibitors)
* metformin belongs to a class of medicines called biguanides.
They work together to control blood sugar levels in adult patients with a form of diabetes called
 type 2 diabetes mellitus . This medicine helps to increase the levels of insulin produced after a meal
and lowers the amount of sugar made by your body.
Along with diet and exercise, this medicine helps lower your blood sugar. This medicine can be used
alone or with certain other medicines for diabetes (insulin, sulphonylureas, or glitazones).
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not take Velmetia
...
nausea, vomiting, diarrhoea, rapid weight loss, lactic acidosis (see  Risk of lactic acidosis 
below) or ketoacidosis. Ketoacidosis is a condition in which substances called  ketone bodies 
accumulate in the blood and which can lead to diabetic pre-coma. Symptoms include stomach
...
taking Velmetia at the time of the X-ray and for 2 or more days after as directed by your doctor,
...
Do not take Velmetia if any of the above apply to you and talk with your doctor about other ways of
managing your diabetes. If you are not sure, talk to your doctor, pharmacist or nurse before taking
Velmetia.
Warnings and precautions
Cases of inflammation of the pancreas (pancreatitis) have been reported in patients receiving Velmetia
(see section 4).
If you encounter blistering of the skin it may be a sign for a condition called bullous pemphigoid.
Your doctor may ask you to stop Velmetia.
Risk of lactic acidosis
Velmetia may cause a very rare, but very serious side effect called lactic acidosis, particularly if your
...
Stop taking Velmetia for a short time if you have a condition that may be associated with
...
Stop taking Velmetia and contact a doctor or the nearest hospital immediately if you experience
...
Talk to your doctor or pharmacist before taking Velmetia:</p>
</li>
<li>
<p>if you have or have had a disease of the pancreas (such as pancreatitis)</p>
</li>
<li>if you have or have had gallstones, alcohol dependence or very high levels of triglycerides (a
form of fat) in your blood. These medical conditions can increase your chance of getting
pancreatitis (see section 4)</li>
<li>if you have type 1 diabetes. This is sometimes called insulin-dependent diabetes</li>
<li>if you have or have had an allergic reaction to sitagliptin, metformin, or Velmetia (see section 4)</li>
<li>if you are taking a sulphonylurea or insulin, diabetes medicines, together with Velmetia, as you
may experience low blood sugar levels (hypoglycaemia). Your doctor may reduce the dose of
your sulphonylurea or insulin
If you need to have major surgery you must stop taking Velmetia during and for some time after the
...
Velmetia. 
During treatment with Velmetia, your doctor will check your kidney function at least once a year or
...
example, in the context of an X-ray or scan, you must stop taking Velmetia before or at the time of the
...
need to adjust the dose of Velmetia. It is especially important to mention the following:</li>
<li>medicines (taken by mouth, inhalation, or injection) used to treat diseases that involve
inflammation, like asthma and arthritis (corticosteroids) </li>
...
<li>specific medicines for the treatment of bronchial asthma ( -sympathomimetics)</li>
<li>iodinated contrast agents or alcohol-containing medicines</li>
<li>certain medicines used to treat stomach problems such as cimetidine </li>
<li>ranolazine, a medicine used to treat angina</li>
<li>dolutegravir, a medicine used to treat HIV infection</li>
<li>vandetanib, a medicine used to treat a specific type of thyroid cancer (medullary thyroid cancer)</li>
<li>digoxin (to treat irregular heartbeat and other heart problems). The level of digoxin in your
blood may need to be checked if taking with Velmetia.
Velmetia with alcohol
Avoid excessive alcohol intake while taking Velmetia since this may increase the risk of lactic
...
during pregnancy. Do not take this medicine if you are breast-feeding. See section 2, Do not take
Velmetia.
...
You should continue the diet recommended by your doctor during treatment with this medicine and
take care that your carbohydrate intake is equally distributed over the day.
This medicine alone is unlikely to cause abnormally low blood sugar (hypoglycaemia). When this
medicine is used with a sulphonylurea medicine or with insulin, low blood sugar can occur and your
doctor may reduce the dose of your sulphonylurea or insulin.
If you take more Velmetia than you should
If you take more than the prescribed dose of this medicine, contact your doctor immediately. Go to the
hospital if you have symptoms of lactic acidosis such as feeling cold or uncomfortable, severe nausea
or vomiting, stomach ache, unexplained weight loss, muscular cramps, or rapid breathing (see section
 Warnings and precautions ).
...
STOP taking Velmetia and contact a doctor immediately if you notice any of the following serious
side effects:
...
(pancreatitis).
Velmetia may cause a very rare (may affect up to 1 in 10,000 people), but very serious side effect
called lactic acidosis (see section  Warnings and precautions ). If this happens, you must stop taking
Velmetia and contact a doctor or the nearest hospital immediately, as lactic acidosis may lead to
coma.
...
Some patients have experienced diarrhoea, nausea, flatulence, constipation, stomach ache or vomiting
when starting the combination of sitagliptin and metformin together (frequency is common).
Some patients have experienced the following side effects while taking this medicine with a
sulphonylurea such as glimepiride:
...
Some patients have experienced the following side effects during clinical studies while taking
sitagliptin alone (one of the medicines in Velmetia) or during post-approval use of Velmetia or
sitagliptin alone or with other diabetes medicines:
...
Very common: nausea, vomiting, diarrhoea, stomach ache and loss of appetite. These symptoms may
happen when you start taking metformin and usually go away
Common: a metallic taste, decreased or low vitamin B12 levels in the blood (symptoms may include
extreme tiredness (fatigue), a sore and red tongue (glossitis), pins and needles (paraesthesia) or pale or
yellow skin). Your doctor may arrange some tests to find out the cause of your symptoms because
some of these may also be caused by diabetes or due to other unrelated health problems.
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Velmetia contains
- The active substances are sitagliptin and metformin.<em> 
Each Velmetia 50 mg/850 mg film-coated tablet (tablet) contains sitagliptin phosphate
monohydrate equivalent to 50 mg of sitagliptin and 850 mg of metformin hydrochloride.</em> 
Each Velmetia 50 mg/1,000 mg film-coated tablet (tablet) contains sitagliptin phosphate
monohydrate equivalent to 50 mg of sitagliptin and 1,000 mg of metformin
hydrochloride.
- The other ingredients are:<em> 
Tablet core: microcrystalline cellulose (E460), povidone K 29/32 (E1201), sodium lauryl
sulfate, and sodium stearyl fumarate.</em> 
Film coating: poly(vinyl alcohol), macrogol 3350, talc (E553b), titanium dioxide (E171),
...
84) film-coated tablets. Pack of 50 x 1 film-coated tablets in perforated unit dose blisters.
...
MSD Belgium
T l: +32 (0)27766dpoc_belux@msd.com
 esk  republika
Merck Sharp &amp; Dohme s.r.o.
Tel.: +420 233 010 dpoc_czechslovak@merck.com
Magyarorsz g
MSD Pharma Hungary Kft. 
Tel.: +36 1 8885hungary_msd@merck.com
Danmark
MSD Danmark ApS
...
Tel: +39 02891regulatory@neogen.it
Suomi/Finland
MSD Finland Oy
...
2. Det skal De vide, før De begynder at tage Velmetia
...
<ul>
<li>
<p>Sitagliptin tilhører en klasse af medicin, som kaldes DPP-4-hæmmere (dipeptylpeptidase-4-
hæmmere).</p>
</li>
<li>
<p>Metformin tilhører en klasse af medicin, der kaldes biguanider. 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Tag ikke Velmetia
...
sygeplejersken, før De tager Velmetia.
...
Velmetia kan forårsage en meget sjælden, men meget alvorlig bivirkning, som kaldes laktacidose, især
...
Symptomerne på laktacidose omfatter:</p>
<ul>
<li>opkastning</li>
<li>mavesmerter</li>
<li>muskelkramper</li>
<li>almen utilpashed med udpræget træthed</li>
<li>vejrtrækningsbesvær</li>
<li>
<p>nedsat kropstemperatur og langsommere puls
Laktacidose er en alvorlig tilstand, der skal behandles på et hospital.
Kontakt lægen, apotekspersonalet eller sygeplejersken, før De tager Velmetia:</p>
</li>
<li>
<p>Hvis De har eller har haft en sygdom i bugspytkirtlen (f.eks. pankreatitis).</p>
</li>
<li>Hvis De har eller har haft galdesten, alkoholafhængighed eller et meget højt indhold af
triglycerider (en fedtstoftype) i blodet. Disse sygdomme kan forøge risikoen for at få
pankreatitis (se punkt 4).</li>
<li>Hvis De har type 1-diabetes. Dette kaldes også insulin-afhængig diabetes.</li>
<li>Hvis De har eller har haft en allergisk reaktion over for sitagliptin, metformin eller Velmetia (se
punkt 4).
41</li>
<li>
<p>Hvis De tager anden diabetesmedicin, sulfonylurinstof eller insulin, sammen med Velmetia, da
...
nogen tid herefter. Lægen vil beslutte, hvornår De skal stoppe behandlingen med Velmetia, og hvornår
De kan genoptage den igen.
...
Brug af andre lægemidler sammen med Velmetia
Hvis De skal have sprøjtet et kontrastmiddel, som indeholder jod, ind i Deres blod, for eksempel i
forbindelse med en røntgenundersøgelse eller scanning, skal De stoppe med at tage Velmetia forud for
...
lægemidler eller planlægger at bruge andre lægemidler. De skal eventuelt have kontrolleret Deres
blodsukker eller Deres nyrefunktion hyppigere, eller lægen kan ændre Deres dosis af Velmetia. Det er
især vigtigt, at De nævner følgende:</p>
</li>
<li>
<p>Lægemidler (der tages gennem munden, som inhalation eller injektion) som anvendes til
behandling af sygdomme, der kan medføre betændelsestilstande, som astma og gigt
(kortikosteroider).</p>
</li>
<li>
<p>Lægemidler, som øger urinproduktionen (vanddrivende medicin).</p>
</li>
<li>
<p>Lægemidler mod smerter og betændelseslignende tilstande (NSAID’er og COX-2-hæmmere,
såsom ibuprofen og celecoxib).</p>
</li>
<li>
<p>Visse lægemidler, der nedsætter blodtrykket (ACE-hæmmere og angiotensin II-
receptorantagonister).</p>
</li>
<li>
<p>Særlige lægemidler til behandling af bronkial astma (beta-sympatomimetika).</p>
</li>
<li>
<p>Jodholdige kontraststoffer eller lægemidler, der indeholder alkohol.</p>
</li>
<li>
<p>Visse typer lægemidler, der anvendes til at behandle maveproblemer, fx cimetidin.</p>
</li>
<li>
<p>Ranolazin, et lægemiddel til behandling af brystsmerter (angina pectoris).</p>
</li>
<li>
<p>Dolutegravir, et lægemiddel til behandling af hiv-infektion.</p>
</li>
<li>
<p>Vandetanib, et lægemiddel til behandling af en særlig type kræft i skjoldbruskkirtlen (medullær
thyroideacancer).</p>
</li>
<li>
<p>Digoxin (til behandling af uregelmæssig hjerterytme og andre hjerteproblemer). Det kan være
...
De spørge lægen eller apotekspersonalet til råds, før De tager dette lægemiddel. De må ikke tage dette
42
lægemiddel under graviditet. Tag ikke dette lægemiddel, hvis De ammer. Se punkt 2, Tag ikke
Velmetia.
...
<li>
<p>to gange dagligt gennem munden.</p>
</li>
<li>
<p>sammen med et måltid for at undgå at få problemer med maven.</p>
</li>
<li>
<p>Det kan være nødvendigt, at lægen øger dosis for at kontrollere Deres blodsukker.</p>
</li>
<li>
<p>Hvis De har nedsat nyrefunktion, vil lægen eventuelt ordinere en lavere dosis.
...
meget alvorlig bivirkning, der kaldes laktacidose (se punktet "Advarsler og forsigtighedsregler"). Hvis
dette sker for Dem, skal De omgående stoppe med at tage Velmetia og kontakte læge eller
...
44
Almindelig: Metalsmag i munden, nedsat eller lavt niveau af B12-vitamin i blodet (symptomer kan
omfatte ekstrem træthed (fatigue), øm og rød tunge (glossitis), prikkende og stikkende fornemmelse
(paræstesi) eller bleg eller gullig hud). Lægen kan sørge for tests til at finde årsagen til dine
symptomer, da nogle af disse også kan være forårsaget af diabetes eller være på grund af andre
urelaterede helbredsmæssige problemer.
Meget sjældne: Leverbetændelse (hepatitis), nældefeber, rødme af huden (udslæt) eller kløe. 
Indberetning af bivirkninger
Hvis De oplever bivirkninger, bør De tale med lægen, apotekspersonalet eller sygeplejersken. Dette
...
Brug ikke Velmetia efter den udløbsdato, der står på blister og karton efter EXP. Udløbsdatoen er den
...
<ul>
<li>Aktive stoffer: sitagliptin og metformin. * 
Hver Velmetia 50 mg/850 mg filmovertrukken tablet (tablet) indeholder
sitagliptinphosphatmonohydrat svarende til 50 mg sitagliptin og 850 mg
metforminhydrochlorid.* 
Hver Velmetia 50 mg/1.000 mg filmovertrukken tablet (tablet) indeholder
sitagliptinphosphatmonohydrat svarende til 50 mg sitagliptin og 1.000 mg
metforminhydrochlorid.</li>
<li>Øvrige indholdsstoffer: * 
Tabletkerne: mikrokrystallinsk cellulose (E460), povidon K 29/32 (E1201),
natriumlaurilsulfat, og natriumstearylfumarat. * 
...
<li>Velmetia 50 mg/850 mg filmovertrukne tabletter er kapselformede, lyserøde, filmovertrukne
tabletter med "515" præget på den ene side.</li>
<li>Velmetia 50 mg/1.000 mg filmovertrukne tabletter er kapselformede, røde, filmovertrukne
tabletter med "577" præget på den ene side.
...
Latvija 
SIA “Merck Sharp &amp; Dohme Latvija" 
Tel: +371 67364 msd_lv@merck.com </li>
</ul>
...
1. O que é Velmetia e para que é utilizado
2. O que precisa de saber antes de tomar Velmetia
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Velmetia contém dois medicamentos diferentes denominados sitagliptina e metformina.</p>
<ul>
<li>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Não tome Velmetia
...
tratamento com Velmetia no momento em que realizar o raio-X e só retomar o tratamento 2 ou
...
- se está a amamentar 
Não tome Velmetia se qualquer uma das situações atrás indicadas se aplica a si e fale com o seu
médico sobre outras formas de gerir a sua diabetes. Em caso de dúvidas, fale com o seu médico,
farmacêutico ou enfermeiro antes de tomar Velmetia.
Advertências e precauções 
Foram comunicados casos de inflamação do pâncreas (pancreatite) em doentes a tomar Velmetia (ver
secção 4). 
Se tiver formação de bolhas na pele, pode ser um sinal de uma situação chamada penfigoide bolhoso.
O seu médico pode pedir-lhe para parar de tomar Velmetia.
Risco de acidose láctica
Velmetia pode causar um efeito indesejável muito raro, mas muito grave, chamado acidose láctica,
...
Pare de tomar Velmetia durante um curto intervalo de tempo se tiver algum problema que
...
Pare de tomar Velmetia e contacte imediatamente um médico ou o hospital mais próximo se
...
Fale com o seu médico ou farmacêutico antes de tomar Velmetia:
...
42
- se tem ou teve uma reação alérgica à sitagliptina, metformina ou Velmetia (ver secção 4)
- se está a tomar uma sulfonilureia ou insulina, medicamentos para a diabetes, juntamente com o
Velmetia, visto que poderá apresentar níveis baixos de açúcar no sangue (hipoglicemia). O seu
médico poderá reduzir a dose da sua sulfonilureia ou da insulina
Se necessitar de efetuar uma grande cirurgia, tem de parar de tomar Velmetia durante a intervenção e
por algum tempo depois desta. O seu médico decidirá quando tem de parar e quando prosseguir o seu
tratamento com Velmetia.
Caso tenha dúvidas se alguma destas situações se aplica a si, fale com o seu médico ou farmacêutico
antes de tomar Velmetia. 
Durante o tratamento com Velmetia, o médico irá verificar o funcionamento dos seus rins uma vez por
...
por exemplo, no contexto de uma radiografia ou cintigrafia, tem de parar de tomar Velmetia antes ou
...
ou o médico pode necessitar de ajustar a dose de Velmetia. É especialmente importante mencionar o
seguinte:</p>
<ul>
<li>
...
<li>
<p>digoxina (para tratar o batimento irregular e outros problemas de coração). Os valores de
digoxina no sangue podem ter de ser verificados se estiver a tomar Velmetia. 
Velmetia com álcool
Evite o consumo excessivo de álcool enquanto estiver a tomar Velmetia, uma vez que tal pode
...
gravidez. Não tome este medicamento se estiver a amamentar. Ver secção 2, Não tome Velmetia.
43
...
Se tomar mais Velmetia do que deveria
...
de náusea e vómito graves, dor de estômago, perda de peso inexplicável, cãibras musculares ou
respiração rápida (ver secção “Advertências e precauções").
Caso se tenha esquecido de tomar Velmetia
...
falar primeiro com o seu médico. Se parar de tomar Velmetia, o seu açúcar do sangue pode voltar a
subir.
...
PARE de tomar Velmetia e contacte um médico imediatamente se sentir algum dos seguintes efeitos
...
Velmetia pode causar um efeito indesejável muito raro (pode afetar até 1 utilizador em cada 10 000),
mas muito grave, chamado acidose láctica (ver secção “Advertências e precauções"). Se isto
acontecer, tem de parar de tomar Velmetia e contactar imediatamente um médico ou o hospital
...
sitagliptina isoladamente (uma das substâncias ativas de Velmetia) ou durante a utilização
pós-aprovação de Velmetia ou sitagliptina isoladamente ou com outros medicamentos para a diabetes:
...
podem aparecer com o início da toma de metformina e normalmente desaparecem
Frequentes: sabor metálico, níveis diminuídos ou baixos de vitamina B12 no sangue (os sintomas
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Qual a composição de Velmetia 
- As substâncias ativas são a sitagliptina e a metformina.
o 
Cada comprimido revestido por película (comprimido) de Velmetia 50 mg/850 mg contém
fosfato de sitagliptina mono-hidratado equivalente a 50 mg de sitagliptina e 850 mg de
cloridrato de metformina.
o 
Cada comprimido revestido por película (comprimido) de Velmetia 50 mg/1000 mg contém
...
Qual o aspeto de Velmetia e conteúdo da embalagem
- Velmetia 50 mg/850 mg comprimidos revestidos por película são comprimidos revestidos por
película em forma de cápsula, de cor rosa, com a gravação “515" numa das faces.
- Velmetia 50 mg/1000 mg comprimidos revestidos por película são comprimidos revestidos por
película em forma de cápsula, de cor vermelha, com a gravação “577" numa das faces.
46
Blisters opacos (PVC/PE/PVDC e alumínio). Embalagens de 14, 28, 56, 60, 112, 168, 180,
196 comprimidos revestidos, embalagens múltiplas com 196 (2 embalagens de 98) e
168 (2 embalagens de 84) comprimidos revestidos por película. Embalagem de 50 x 1 comprimidos
revestidos em blisters destacáveis para dose unitária.
