...
Instance: composition-en-91532a0bac4066c0d200269dda7e0b3f
...
* section[=].section[+]
  * title =  "1. What vipdomet is and what it is used for"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
...
decrease the amount of sugar in the body.  </li>
<li>metformin belongs to a group of medicines called biguanides which also help to lower blood 
...
<p>Vipdomet is taken when your blood sugar cannot be adequately controlled by diet, exercise and other 
anti-diabetic medicines such as metformin alone; insulin alone; or metformin and pioglitazone taken 
together.  </p>
...
* section[=].section[+]
  * title = "2. What you need to know before you take vipdomet"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "2. What you need to know before you take vipdomet"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not take Vipdomet 
...
- if you have severe breathing difficulties<br />
...
Vipdomet may cause a very rare, but very serious side effect called lactic acidosis, particularly if your 
...
reduced supply of oxygen (such as acute severe heart disease). If any of the above apply to you, talk to 
your doctor for further instructions. </p>
<p>Stop taking Vipdomet for a short time if you have a condition that may be associated with 
...
<p>Stop taking Vipdomet and contact a doctor or the nearest hospital immediately if you experience 
...
<p>During treatment with Vipdomet, your doctor will check your kidney function at least once a year or 
more frequently if you are elderly and/or if have worsening kidney function </p>
<p>Children and adolescents 
Vipdomet is not recommended for children and adolescents under 18 years due to the lack of data in 
these patients.  </p>
<p>Other medicines and Vipdomet 
If you need to have an injection of a contrast medium that contains iodine into your bloodstream, for 
example in the context of an X-ray or scan, you must stop taking Vipdomet before or at the time of the 
...
are pregnant. </p>
<p>Vipdomet is not recommended during breast-feeding since metformin passes into breast milk. </p>
...
may prescribe a lower dose, which may need to be given as separate tablets of alogliptin and 
metformin. </p>
<p>Swallow your tablet(s) whole with water. You should take this medicine with food to reduce your 
chance of an upset stomach. </p>
<p>If you take more Vipdomet than you should 
...
<p>If you forget to take Vipdomet 
...
* section[=].section[+]
  ...
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "5. How to store vipdomet"
  * text.status = #additional
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Vipdomet contains<br />
- The active substances are alogliptin and metformin hydrochloride. 
Each 12.5 mg/850 mg film-coated tablet contains alogliptin benzoate equivalent to 12.5 mg alogliptin 
and 850 mg metformin hydrochloride. 
...
- The other ingredients are mannitol, microcrystalline cellulose, povidone K30, 
crospovidone Type A, magnesium stearate, hypromellose, talc, titanium dioxide (E171) and 
...
Instance: composition-da-91532a0bac4066c0d200269dda7e0b3f
InstanceOf: CompositionUvEpi
Title: "Composition for vipdomet Package Leaflet"
Description:  "Composition for vipdomet Package Leaflet"
Usage: #inline
...
<li>Det skal du vide, før du begynder at tage Vipdomet </li>
<li>Sådan skal du tage Vipdomet </li>
<li>Bivirkninger  </li>
<li>Opbevaring </li>
...
Vipdomet indeholder to forskellige lægemidler, alogliptin og metformin, i én tablet:</p>
<ul>
<li>alogliptin tilhører en gruppe af lægemidler, der kaldes DPP-4-hæmmere 
(dipeptidyl peptidase-4-hæmmere). Formålet med alogliptin er at øge insulinniveauet i kroppen 
efter et måltid og sænke mængden af sukker i kroppen.  </li>
<li>metformin tilhører en gruppe af lægemidler, som kaldes biguanider, og som også hjælper med at 
sænke blodets sukkerindhold ved at sænke mængden af sukker, der produceres i leveren, og får 
insulinen til at virke mere effektivt. </li>
</ul>
<p>Begge disse lægemidler kaldes orale antidiabetika (diabetesmedicin, der indtages gennem munden). </p>
<p>Anvendelse 
Vipdomet sænker blodsukkeret hos voksne med type 2-diabetes. Type 2-diabetes kaldes også 
ikke-insulinkrævende diabetes mellitus eller gammelmandssukkersyge. </p>
<p>Du kan tage Vipdomet, hvis dit blodsukker ikke kan styres godt nok gennem kost, motion og andre 
...
* section[=].section[+]
  * title = "2. Det skal du vide, før du begynder at tage  vipdomet"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "2. Det skal du vide, før du begynder at tage  vipdomet"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Tag ikke Vipdomet 
- hvis du er allergisk over for alogliptin, metformin eller et af de øvrige indholdsstoffer i dette 
lægemiddel (angivet i punkt 6).<br />
...
områder på huden (nældefeber) og hævelse af ansigtet, læber, tunge eller svælg, som kan gøre 
det svært for dig at trække vejret eller synke. Andre symptomer kan være kløe, en følelse af 
varme især i hovedbund, mund, svælg, håndfladerne og fodsålerne (Stevens-Johnsons 
syndrom).<br />
...
- hvis du har en svær infektion eller alvorlig væskemangel (er stærkt dehydreret).<br />
- hvis du for nyligt har haft et hjerteanfald eller har svære kredsløbsproblemer, herunder shock.<br />
- hvis du har alvorligt åndedrætsbesvær.<br />
- hvis du har en leversygdom.<br />
- hvis du har et overdrevet alkoholforbrug (enten drikker hver dag eller drikker store mængder en 
gang imellem). </p>
<p>Advarsler og forsigtighedsregler<br />
Kontakt lægen eller apotekspersonalet, før du tager Vipdomet:</p>
<ul>
<li>hvis du har type 1-diabetes (din krop kan ikke producere insulin).  </li>
<li>hvis du tager Vipdomet sammen med insulin eller et thiazolidindion. Din læge vil muligvis 
nedsætte din insulin- eller thiazolidindion-dosis, hvis du også tager Vipdomet, så du undgår at 
få for lavt blodsukker (hypoglykæmi).  </li>
<li>hvis du tager et andet lægemiddel mod diabetes, som indeholder et såkaldt sulfonylurinstof. I så 
fald må du ikke begynde at tage Vipdomet.  </li>
<li>hvis du har eller har haft sygdom i bugspytkirtlen. </li>
<li>hvis du får symptomer, der tyder på en leverskade, mens du tager Vipdomet. </li>
</ul>
...
<p>Stop med at tage Vipdomet i en kort periode, hvis du har en tilstand, som kan være forbundet 
...
<p>Stop med at tage Vipdomet og kontakt omgående læge eller nærmeste hospital, hvis du får et 
...
<p>Hvis du skal have en større operation, skal du stoppe med at tage Vipdomet under indgrebet og i 
...
<p>Under behandlingen med Vipdomet vil lægen kontrollere din nyrefunktion mindst en gang om året 
...
<p>Brug af anden medicin sammen med Vipdomet 
...
eller din nyrefunktion hyppigere, eller lægen kan ændre din dosis af Vipdomet. Det er især vigtigt, at 
du nævner følgende:</p>
<ul>
<li>hydrokortison og prednisolon (kortikosteroider), som bruges til at behandle sygdomme, hvor der 
er en betændelsestilstand, f.eks. astma og gigt  </li>
<li>cimetidin, som bruges til at behandle maveproblemer  </li>
<li>bronkodilatatorer (beta-2-antagonister), som bruges til at behandle astma </li>
...
<li>visse lægemidler, der nedsætter blodtrykket (ACE-hæmmere og angiotensin 
II-receptorantagonister) </li>
<li>lægemidler, der indeholder alkolhol.  </li>
</ul>
<p>Brug af Vipdomet sammen med alkohol 
Du skal undgå at indtage store mængder alkohol, mens du er i behandling med Vipdomet, da det kan 
øge risikoen for laktatacidose (se afsnittet "Advarsler og forsigtighedsregler"). </p>
...
Vipdomet, hvis du er gravid. </p>
<p>Det frarådes, at du tager Vipdomet, hvis du ammer, da indholdsstoffet metformin udskilles i 
modermælken. </p>
...
* section[=].section[+]
  * title =  "3. Sådan skal du tage vipdomet"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "3. Sådan skal du tage vipdomet"
  * text.status = #additional
...
<p>Lægen vil fortælle dig, præcis hvor mange Vipdomet-tabletter du skal tage. Antallet afhænger af din 
tilstand, og af hvor stor en dosis du i forvejen tager af metformin alene eller kombineret med 
pioglitazon, af insulin og/eller separate tabletter med alogliptin og metformin.  </p>
<p>Den anbefalede dosis er 1 tablet to gange dagligt. Hvis du har nedsat nyrefunktion, vil lægen eventuelt 
ordinere en lavere dosis, som eventuelt skal gives som separate tabletter med alogliptin og metformin. </p>
<p>Synk tabletten hel sammen med vand. Du bør tage Vipdomet sammen med et måltid for at mindske 
risikoen for maveproblemer. </p>
<p>Hvis du har taget for meget Vipdomet 
...
<p>Hvis du har glemt at tage Vipdomet 
...
<p>STOP med at tage Vipdomet, og kontakt lægen eller det nærmeste hospital med det samme, hvis 
du får nogen af symptomerne på de følgende alvorlige bivirkninger:  </p>
<p>Meget sjældne bivirkninger (kan forekomme hos op til 1 ud af 10.000 personer):</p>
<ul>
<li>Laktatacidose (ophobning af mælkesyre i blodet) er en meget alvorlig bivirkning, som kan føre 
til koma. For symptomer se punktet “Advarsler og forsigtighedsregler".  </li>
</ul>
<p>Bivirkninger med ukendt hyppighed (hyppigheden kan ikke bestemmes ud fra de foreliggende 
data):</p>
<ul>
<li>Allergisk reaktion. Tegnene kan være udslæt, nældefeber, synke- eller åndedrætsbesvær, 
hævelse af læber, ansigt, svælg eller tunge og besvimelsesfornemmelse.  </li>
<li>En alvorlig overfølsomhedsreaktion: hudlæsioner eller pletter på huden, der kan udvikle sig 
til et sår omgivet af blege eller røde ringe, blæredannelse og/eller afskalning af huden eventuelt 
...
<ul>
<li>Tegn på lavt blodsukker (hypoglykæmi), som kan opstå, hvis Vipdomet tages i kombination 
...
<li>Forkølelsessymptomer som ondt i halsen, tilstoppet næse, træthed, feber, kulderystelser og tør 
hoste </li>
<li>Udslæt  </li>
<li>Kløende hud med eller uden nældefeber </li>
<li>Hovedpine </li>
<li>Fordøjelsesbesvær, opstød </li>
<li>Opkastning og/eller diarré </li>
<li>Metalsmag i munden </li>
<li>Nedsat eller lavt B12-vitaminniveau i blodet (symptomerne kan omfatte ekstrem træthed 
(udmattelse), øm og rød tunge (glossitis), en prikkende eller snurrende fornemmelse (paræstesi) 
eller bleg eller gullig hud). Lægen vil måske tage prøver for at finde årsagen til dine symptomer, 
da nogle af disse også kan skyldes diabetes eller andre helbredsproblemer uden forbindelse 
hermed. </li>
</ul>
<p>Meget sjældne bivirkninger:</p>
<ul>
<li>Problemer med leveren (hepatitis eller unormale leverfunktionstest) </li>
<li>Erytem (hudrødme).  </li>
</ul>
<p>Bivirkninger med ukendt hyppighed:</p>
<ul>
<li>Leverproblemer, der viser sig som kvalme, opkastning, mavesmerter, usædvanlig eller 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Vipdomet indeholder 
...
Hver 12,5 mg/1.000 mg filmovertrukken tablet indeholder alogliptinbenzoat svarende til 12,5 mg 
alogliptin og 1.000 mg metforminhydrochlorid. 
- Øvrige indholdsstoffer: mannitol, mikrokrystallinsk cellulose, povidon K30, 
crospovidon type A, magnesiumstearat, hypromellose, talkum, titandioxid (E171) og gul 
jernoxid (E172). </p>
...
- Vipdomet 12,5 mg/1.000 mg filmovertrukne tabletter (tabletter) er svagt gule, aflange (ca. 
22,3 x 10,7 mm), bikonvekse filmovertrukne tabletter, der er præget med "12.5/1000" på den 
ene side og "322M" på den anden side. </p>
<p>Vipdomet fås i blisterpakninger med 10, 14, 20, 28, 56, 60, 98, 112, 120, 180, 196 eller 200 tabletter 
samt i multipakninger bestående af 2 pakninger med hver 98 filmovertrukne tabletter. </p>
...
Title: "ePI document Bundle for vipdomet Package Leaflet for language en"
Description: "ePI document Bundle for vipdomet Package Leaflet for language en"
Usage: #example
...
Instance: bundlepackageleaflet-da-91532a0bac4066c0d200269dda7e0b3f
InstanceOf: BundleUvEpi
Title: "ePI document Bundle for vipdomet Package Leaflet for language da"
Description: "ePI document Bundle for vipdomet Package Leaflet for language da"
Usage: #example
...
RuleSet: 91532a0bac4066c0d200269dda7e0b3fListRuleset

* identifier.system = "http://ema.europa.eu/identifier" 
* identifier.value = "None"
* identifier[+].system = "http://spor.ema.europa.eu/v2/medicine-name"
* identifier[=].value = "vipdomet"
...
* entry[+]
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-en-91532a0bac4066c0d200269dda7e0b3f) // vipdomet en
...
* entry[+]
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-da-91532a0bac4066c0d200269dda7e0b3f) // vipdomet da
  * item.extension[0].url = "http://ema.europa.eu/fhir/extension/documentType"
  * item.extension[=].valueCoding = $100000155531#100000155538 "B. PACKAGE LEAFLET"
  * item.extension[+].url = "http://ema.europa.eu/fhir/extension/language"
