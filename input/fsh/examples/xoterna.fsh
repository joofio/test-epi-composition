...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Instructions for use of Xoterna Breezhaler inhaler </p>  </div>"""   
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Xoterna Breezhaler is 
This medicine contains two active substances called indacaterol and glycopyrronium. These belong to 
a group of medicines called bronchodilators. </p>
<p>What Xoterna Breezhaler is used for 
...
in the lungs, making it easier for air to get in and out of the lungs. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not use Xoterna Breezhaler 
...
Talk to your doctor, pharmacist or nurse before using Xoterna Breezhaler if any of the following 
applies to you:</p>
<ul>
...
(same class) to those in Xoterna Breezhaler (see section  Other medicines and Xoterna 
Breezhaler ). </li>
...
<p>During treatment with Xoterna Breezhaler 
...
<p>Xoterna Breezhaler is used as an ongoing treatment for your COPD. Do not use this medicine to treat 
...
<p>Other medicines and Xoterna Breezhaler 
Tell your doctor or pharmacist if you are using, have recently used or might use any other medicines. 
In particular, please tell your doctor or pharmacist if you are using:</p>
<ul>
<li>any medicines that may be similar to Xoterna Breezhaler (contain similar active substances). </li>
...
Xoterna Breezhaler, may prevent labour due to its effect on the uterus. </p>
<p>If you are pregnant or breast-feeding, think you may be pregnant or are planning to have a baby, ask 
your doctor or pharmacist for advice before using this medicine. You should not use Xoterna 
...
<p>Xoterna Breezhaler contains lactose 
This medicine contains lactose (23.5 mg per capsule). If you have been told by your doctor that you 
have an intolerance to some sugars, contact your doctor before using this medicine. </p>
<p>Ask your doctor or pharmacist for advice before using any medicine. </p> </div>"""   
...
<p>How much Xoterna Breezhaler to use 
...
more than your doctor tells you to use. </p>
<p>Elderly (age 75 years and over) 
You can use this medicine if you are aged 75 years and over at the same dose as for other adults. </p>
<p>When to inhale Xoterna Breezhaler 
Use this medicine at the same time each day. This will also help you to remember to use it. 
You can inhale Xoterna Breezhaler any time before or after food or drink. </p>
<p>How to inhale Xoterna Breezhaler 
...
inhalation powder. Only use the capsules with the inhaler provided in this pack (Xoterna 
...
inhaler. </p>
<p>If you use more Xoterna Breezhaler than you should 
If you have inhaled too much of this medicine or if someone else accidentally uses your capsules, you 
must immediately either tell your doctor or go to the nearest emergency unit. Show the pack of 
Xoterna Breezhaler. Medical attention may be needed. You may notice that your heart is beating faster 
than usual, or you may have a headache, feel drowsy, feel nauseous or have to vomit, or you may 
notice visual disturbances, feel constipated or have difficulty when passing urine. </p>
<p>If you forget to use Xoterna Breezhaler 
...
<p>Keep using Xoterna Breezhaler for as long as your doctor tells you. </p>
<p>COPD is a long-term disease and you should use Xoterna Breezhaler every day and not only 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Xoterna Breezhaler contains 
...
(see section 2 under  Xoterna Breezhaler contains lactose ). </p>
<p>What Xoterna Breezhaler looks like and contents of the pack </p>
<p>Xoterna Breezhaler 85 micrograms/43 micrograms inhalation powder, hard capsules are transparent 
...
blister contains either 6 or 10 hard capsules. </p>
<p>The following pack sizes are available: 
Single pack containing 6x1, 10x1, 12x1, 30x1 or 90x1 hard capsules, together with 1 inhaler. </p>
<p>Multipacks containing 96 (4 packs of 24x1) hard capsules and 4 inhalers. 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Brugsanvisning til Xoterna Breezhaler-inhalator </p>  </div>"""   
...
en gruppe af lægemidler, der kaldes bronkodilatatorer. </p>
<p>Anvendelse 
...
<p>Hvis du tager dette lægemiddel én gang daglig, vil det hjælpe med at mindske påvirkningen af KOL i 
din dagligdag. </p> </div>"""   
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Tag ikke Xoterna Breezhaler 
...
<li>hvis du tager medicin mod din lungesygdom, som indeholder lignende aktive stoffer (samme 
...
<li>hvis du har vandladningsbesvær. 
Hvis noget af ovenstående passer på dig (eller du er usikker) så tal med din læge, apotekspersonalet 
eller sygeplejerske, før du tager denne medicin. </li>
</ul>
<p>Under behandling med Xoterna Breezhaler 
- Stop med at tage medicinen og søg lægehjælp øjeblikkeligt, hvis du oplever en af følgende 
tilstande:</p>
<ul>
<li>øjensmerter eller -ubehag, midlertidig sløring af synet, visuelle ringe eller farvet syn i 
...
<p>Xoterna Breezhaler anvendes som en vedvarende behandling af din KOL. Brug ikke dette lægemiddel 
til behandling af pludselige anfald af åndenød eller hvæsen. </p>
<p>Børn og unge 
Denne medicin må ikke gives til børn eller unge under 18 år. Dette skyldes, at medicinen ikke har 
været undersøgt i denne aldersgruppe. </p>
<p>Brug af anden medicin sammen med Xoterna Breezhaler 
Fortæl altid lægen eller apotekspersonalet, hvis du tager anden medicin, for nylig har taget anden 
medicin eller hvis du planlægger at tage anden medicin. Dette gælder også medicin, som ikke er købt 
på recept. 
...
timolol). 
 
medicin, som nedsætter mængden af kalium i blodet. Dette gælder:</p>
<ul>
<li>steroider (fx prednisolon), </li>
<li>diuretika (vanddrivende tabletter), som bruges mod for højt blodtryk, såsom 
hydrochlorthiazid, </li>
...
Breezhaler, kan muligvis forhindre veer på grund af effekten på livmoderen. </p>
...
Xoterna Breezhaler, medmindre du har aftalt det med din læge. </p>
...
lægemiddel, må du ikke køre bil eller betjene maskiner. </p>
<p>Xoterna Breezhaler indeholder lactose 
Dette lægemiddel indeholder lactose (23,5 mg pr. kapsel). Kontakt lægen, før du tager dette 
lægemiddel, hvis lægen har fortalt dig, at du ikke tåler visse sukkerarter. </p>
<p>Spørg din læge eller apoteket til råds, før du tager nogen form for medicin. </p> </div>"""   
...
<p>Så meget Xoterna Breezhaler skal du tage 
...
Tag ikke mere end den dosis lægen anbefaler dig at bruge. </p>
<p>Ældre (75 år og derover) 
Du kan tage denne medicin ved samme dosis som for andre voksne, hvis du er 75 år eller ældre. </p>
<p>Tidspunkt for inhalering af Xoterna Breezhaler 
...
drikke. </p>
<p>Sådan skal du inhalere Xoterna Breezhaler 
...
<p>Hvis du har taget for meget Xoterna Breezhaler 
...
at lade vandet. </p>
<p>Hvis du har glemt at tage Xoterna Breezhaler 
Hvis du har glemt at inhalere en dosis til sædvanlig tid, så inhalér én så hurtigt som muligt samme dag. 
Inhalér derefter næste dosis til sædvanlig tid næste dag. Inhalér ikke mere end én dosis på samme dag. </p>
...
 
prikken eller følelsesløshed. </p>
...
<p>Tag ikke lægemidlet efter den udløbsdato, der står på pakningen og blisteren efter "EXP". 
Udløbsdatoen er den sidste dag i den nævnte måned. </p>
<p>Må ikke opbevares ved temperaturer over 25 °C. </p>
<p>Opbevar kapslerne i den originale blister for at beskytte mod fugt og må først tages ud lige før brug. </p>
<p>Smid inhalatoren i hver pakning ud når alle kapsler i pakningen er brugt. </p>
<p>Tag ikke lægemidlet, hvis pakningen er beskadiget eller viser tegn på at have været åbnet. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Xoterna Breezhaler indeholder 
...
afsnit 2 under "Xoterna Breezhaler indeholder lactose"). </p>
<p>Udseende af Xoterna Breezhaler og pakningsstørrelser </p>
<p>Xoterna Breezhaler 85 mikrogram/43 mikrogram inhalationspulver, hårde kapsler, er gennemsigtige 
...
) trykt i sort på hætten. </p>
<p>Denne pakning indeholder en inhalator, samt kapsler i blister. Hver blister indeholder enten 6 eller 
10 kapsler. </p>
<p>Følgende pakningsstørrelser er tilgængelige: 
Enkeltpakninger med 6x1, 10x1, 12x1, 30x1 eller 90x1 kapsler og 1 inhalator. </p>
<p>Multipakning bestående af 96 (4 pakninger af 24x1) hårde kapsler og 4 inhalatorer. 
Multipakning bestående af 150 (15 pakninger af 10x1) hårde kapsler og 15 inhalatorer. 
Multipakning bestående af 150 (25 pakninger af 6x1) hårde kapsler og 25 inhalatorer. </p>
...
Novartis Pharma B.V. 
Tel: +31 88 04 52 Eesti 
SIA Novartis Baltics Eesti filiaalTel: +372 66<br />
Norge 
Novartis Norge AS 
...
<p>Læs venligst den fulde anvisning for brug inden du bruger Xoterna Breezhaler. </p>
<p>Læg en kapsel i 
Perforer og slip 
Inhaler dybt 
...
<p>Trin 1e: 
Luk inhalatoren </p>
<p>Din Xoterna Breezhaler inhalatorpakning indeholder: 
 En Xoterna Breezhaler inhalator 
 Et eller flere blisterkort, som hver indeholder 
enten 6 eller 10 Xoterna Breezhaler kapsler til 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Instruções para utilização do inalador Xoterna Breezhaler </p>  </div>"""   
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>O que é Xoterna Breezhaler 
...
<p>Para que é utilizado Xoterna Breezhaler 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Não utilize Xoterna Breezhaler 
...
Fale com o seu médico, farmacêutico ou enfermeiro antes de utilizar Xoterna Breezhaler, se alguma 
...
substâncias ativas semelhantes (mesma classe) às que se encontram em Xoterna Breezhaler (ver 
secção “Outros medicamentos e Xoterna Breezhaler"). 
...
<p>Durante o tratamento com Xoterna Breezhaler 
...
<p>Xoterna Breezhaler é usado como tratamento continuado para a sua DPOC. Não utilize este 
...
<p>Outros medicamentos e Xoterna Breezhaler 
...
-<br />
quaisquer medicamentos que possam ser semelhantes a Xoterna Breezhaler (que contenham 
...
inibidores da monoamino oxidase). </p>
...
substâncias ativas de Xoterna Breezhaler, pode impedir o trabalho de parto devido ao seu efeito sobre 
o útero. </p>
<p>Se está grávida ou a amamentar, se pensa estar grávida ou planeia engravidar, consulte o seu médico 
ou farmacêutico antes de tomar este medicamento. Não deve utilizar Xoterna Breezhaler a não ser que 
...
<p>Xoterna Breezhaler contém lactose 
...
<p>Que quantidade de Xoterna Breezhaler utilizar 
...
adultos. </p>
<p>Quando utilizar Xoterna Breezhaler 
Utilize este medicamento à mesma hora em cada dia. Isto irá ajudá-lo a lembrar-se de tomar o 
medicamento. 
Pode inalar Xoterna Breezhaler em qualquer altura, antes ou após alimentos ou bebidas. </p>
<p>Como inalar Xoterna Breezhaler 
- Xoterna Breezhaler é para utilização por inalação. 
...
embalagem (inalador Xoterna Breezhaler). As cápsulas devem manter-se no blister até que 
necessite de as utilizar. 
- Destaque a parte de trás do blister para o abrir - não pressione a cápsula através da película de 
alumínio. 
- Quando iniciar uma nova embalagem, utilize o novo inalador Xoterna Breezhaler fornecido na 
embalagem. 
...
inalador. </p>
<p>Se utilizar mais Xoterna Breezhaler do que deveria 
...
a embalagem de Xoterna Breezhaler. Podem ser necessários cuidados médicos. Pode notar que o seu 
...
em urinar. </p>
<p>Caso se tenha esquecido de utilizar Xoterna Breezhaler 
...
<p>Durante quanto tempo deve continuar o seu tratamento com Xoterna Breezhaler 
- Continue a utilizar Xoterna Breezhaler durante o tempo que o seu médico lhe disser. 
- A DPOC é uma doença de longa duração e deve utilizar Xoterna Breezhaler diariamente e não 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Qual a composição de Xoterna Breezhaler 
...
(ver secção 2 sob “Xoterna Breezhaler contém lactose"). </p>
<p>Qual o aspeto de Xoterna Breezhaler e conteúdo da embalagem 
Xoterna Breezhaler 85 microgramas/43 microgramas pó para inalação, as cápsulas são transparentes e 
