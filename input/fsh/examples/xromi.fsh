...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Xromi contains hydroxycarbamide, a substance which reduces the growth and multiplication of some 
cells in the bone marrow. These effects lead to a reduction of circulating red, white and coagulation 
blood cells. In Sickle Cell Disease, hydroxycarbamide also helps to prevent red blood cells from 
...
<ul>
<li>if you are allergic to hydroxycarbamide or any of the other ingredients of Xromi (listed in 
section 6). </li>
<li>if you suffer from severe liver disease </li>
<li>if you suffer from severe kidney disease </li>
<li>if you have decreased production of red, white, or coagulating blood cells ( myelosuppressed ) 
as described in section 3  How to take Xromi, Treatment follow-up  </li>
<li>if you are pregnant or breast-feeding (see section  Pregnancy, breast-feeding and fertility ). </li>
<li>if you take antiretroviral medicines for the treatment of Human Immunodeficiency Virus (HIV), 
the virus which causes AIDS </li>
</ul>
<p>Warnings and precautions  </p>
<p>Test and checks </p>
<p>Your doctor will run blood tests:</p>
<ul>
<li>to check your blood count before and during treatment with Xromi </li>
...
<ul>
<li>if you have extreme tiredness, weakness and shortness of breath, which may be symptoms of a 
lack of red blood cells (anaemia). </li>
<li>if you have bleeding or bruise easily, which may be symptoms of low levels of cells in the blood 
known as platelets. </li>
<li>if you have a liver disease (additional monitoring may be needed) </li>
...
Xromi. </p>
<p>Skin cancer has been reported in patients receiving long term hydroxycarbamide. You should protect 
your skin from the sun and regularly inspect your skin yourself during the treatment and after 
discontinuation of the therapy with hydroxycarbamide. Your doctor will also inspect your skin during 
routine follow-up visits. </p>
<p>Children </p>
<p>Do not give this medicine to children from birth to 2 years of age because it is unlikely to be safe. </p>
...
<ul>
<li>other myelosuppressive medicines (those that decrease production of red, white, or coagulating 
blood cells) </li>
<li>radiation therapy or chemotherapy </li>
<li>any medicines for cancer treatment, especially interferon therapy - when used with Xromi there 
is a greater chance of side effects, such as anaemia </li>
<li>antiretroviral medicines (those that inhibit or destroy a retrovirus such as HIV), e.g. didanosine, 
stavudine, and indinavir (a drop in your white cell count may occur) </li>
<li>live vaccines, e.g. measles, mumps, rubella (MMR), chicken pox </li>
</ul>
<p>Pregnancy, breast-feeding and fertility </p>
<p>Do not take Xromi if you are planning to have a baby without first speaking to your doctor for advice. 
...
while taking Xromi. Ask your doctor or pharmacist for advice. </p>
<p>Driving and using machines </p>
<p>Xromi can make you feel drowsy. You should not drive or operate any machinery unless it has been 
...
<p>Xromi should only be given to you by a specialist doctor who is experienced in treating blood 
problems. </p>
<ul>
<li>When you take Xromi your doctor will take regular blood tests. This is to check the number and 
type of cells in your blood and to check your liver and kidney. </li>
<li>Depending on the dose you take, these tests may be performed initially once a month and then 
every 2-3 months. </li>
<li>Depending on these results your doctor may change your dose of Xromi. </li>
</ul>
<p>Check with your doctor or pharmacist if you are not sure. The usual starting dose for adults, 
adolescents and children over the age of 2 years is 15 mg/kg each day and the usual maintenance dose 
is between 20-25 mg/kg. Your doctor will prescribe the correct dose for you. Sometimes the doctor 
may change your dose of Xromi, for example as a result of different tests. If you are not sure how 
much medicine to take, always ask your doctor or nurse. </p>
<p>Xromi with food and drink 
You can take this medicine with or after meals at any time of the day. However, the choice of method 
and time of day should be consistent from day to day. </p>
<p>Use in elderly 
You may be more sensitive to the effects of Xromi and your doctor may need to give you a lower 
dose. </p>
<p>If you have kidney disease 
Your doctor may need to give you a lower dose. 
You should not take Xromi if you have severe kidney disease. </p>
<p>Handling 
Your pack of Xromi contains a bottle of medicine, a cap, a bottle adaptor and two dosing syringes (a 
3 ml and a 10 ml syringe). Always use the syringes provided to take your medicine. </p>
...
<p>The smaller 3 ml syringe, marked from 0.5 ml to 3 ml, is for measuring doses of less than or equal to 
3 ml. You should use this one if the total amount you have to take is less than or equal to 3 ml (each 
graduation of 0.1 ml contains 10 mg of hydroxycarbamide). 
The larger 10 ml syringe, marked from 1 ml to 10 ml, is for measuring doses of more than 3 ml. 
You should use this one if the total amount you have to take is more than 3 ml (each graduation of 
0.5 ml contains 50 mg of hydroxycarbamide). </p>
...
gloves should be used when handling Xromi. To minimise air bubbles, do not shake the bottle before 
administering a dose. </p>
<p>If Xromi comes into contact with skin, eyes or nose, it should be washed immediately and thoroughly 
...
<li>Remove the bottle cap (figure 1) and push the adaptor firmly into the top of the bottle and leave 
in place for future doses (figure 2). </li>
<li>Push the tip of the dosing syringe into the hole in the adaptor (figure 3). Your doctor or 
pharmacist will advise you of the correct syringe to use, either the 3 ml or the 10 ml 
syringe in order to give the correct dose. </li>
...
(figure 4). If you are not sure about how much medicine to draw into the syringe, always ask 
...
<li>Swallow the dose of oral solution then drink some water, making sure no medicine is left in 
your mouth. </li>
...
the syringe dry completely before you use that syringe again for dosing. Store the syringe in a 
...
<p>If you take more Xromi than you should, tell your doctor or go to a hospital immediately. Take the 
medicine pack and this leaflet with you. The most common symptoms of overdose with Xromi are:</p>
<ul>
...
<p>If you get any of the following side effects, talk to your doctor or go to hospital immediately: </p>
...
<ul>
<li>Inflammation of the skin causing red scaly patches and possibly occurring together with pain in 
the joints </li>
</ul>
<p>Other side effects which are not mentioned above are listed below. Speak to your doctor if you 
are concerned by any of these side effects. </p>
<p>Very common: may affect more than 1 in 10 people </p>
<ul>
<li>Absence or low amount of sperm in the semen (azoospermia or oligospermia). </li>
</ul>
<p>Common: may affect up to 1 in 10 people </p>
<ul>
<li>Nausea </li>
...
<li>Keep this medicine out of the sight and reach of children. Accidental ingestion can be lethal for 
children. </li>
...
<li>After first opening of the bottle, discard any unused contents after 12 weeks. </li>
...
<p>The active substance is hydroxycarbamide. One ml of solution contains 100 mg of hydroxycarbamide. </p>
<p>The other ingredients are xanthan gum, sucralose (E955), strawberry flavour, methyl 
parahydroxybenzoate (E218), sodium hydroxide, and purified water. See section 2  Xromi contains 
methyl parahydroxybenzoate . </p>
<p>What Xromi looks like and contents of the pack </p>
<p>Xromi is a clear, colourless to pale yellow, oral solution. It comes in glass bottles of 150 ml capped 
with a child-resistant closure. Each pack contains one bottle, a bottle adaptor and two dosing syringes 
(a syringe graduated to 3 ml and a syringe graduated to 10 ml). 
