...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Yesafili is a solution which is injected into the eye to treat eye conditions in adults called </p>
<ul>
<li>neovascular (wet) age-related macular degeneration (wet AMD), </li>
<li>impaired vision due to macular oedema secondary to retinal vein occlusion (branch RVO 
(BRVO) or central RVO (CRVO)), </li>
<li>impaired vision due to diabetic macular oedema (DME), </li>
<li>impaired vision due to myopic choroidal neovascularisation (myopic CNV). </li>
</ul>
<p>Aflibercept, the active substance in Yesafili, blocks the activity of a group of factors, known as 
vascular endothelial growth factor A (VEGF-A) and placental growth factor (PlGF). </p>
...
<p>In patients with CRVO, a blockage occurs in the main blood vessel that transports blood away from the 
retina. VEGF levels are elevated in response causing the leakage of fluid into the retina and thereby 
causing a swelling of the macula, (the portion of the retina responsible for fine vision), which is called 
macular oedema. When the macula swells with fluid, central vision becomes blurry. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>You will not be given Yesafili 
- if you are allergic to aflibercept or any of the other ingredients of this medicine (listed in 
section 6). 
- if you have an active or suspected infection in or around the eye (ocular or periocular </p>
<p>infection). 
...
size and number of floaters. </li>
<li>if surgery was performed or is planned on your eye within the previous or next four weeks. </li>
...
<li>injections with Yesafili may cause an increase in eye pressure (intraocular pressure) in some 
patients within 60 minutes of the injection. Your doctor will monitor this after each injection. </li>
<li>if you develop an infection or inflammation inside the eye (endophthalmitis) or other 
...
diagnosed and treated as soon as possible. </li>
...
retinal pigment epithelial detachment or tear), in which case Aflibercept must be given with 
caution. </li>
<li>Aflibercept should not be used in pregnancy unless the potential benefit outweighs the 
potential risk to the unborn child. </li>
<li>women of childbearing potential have to use effective contraception during treatment and for 
at least three further months after the last injection of Yesafili. </li>
</ul>
<p>The systemic use of VEGF inhibitors, substances similar to those contained in Yesafili, is potentially 
related to the risk of blood clots blocking blood vessels (arterial thromboembolic events) which may 
lead to heart attack or stroke. There is a theoretical risk of such events following injection of Yesafili 
...
within the last 6 months. If any of these apply to you, Yesafili will be given with caution. </p>
<p>There is only limited experience in the treatment of 
...
not relevant. </p>
<p>Other medicines and Yesafili 
Tell your doctor if you are using, have recently used or might use any other medicines. </p>
<p>Pregnancy and breast-feeding 
Women of childbearing potential have to use effective contraception during treatment and for at least 
three further months after the last injection of Yesafili. </p>
<p>There is no experience of using aflibercept in pregnant women. Yesafili should not be used during 
pregnancy unless the potential benefit outweighs the potential risk to the unborn child. If you are 
pregnant or planning to become pregnant, discuss this with your doctor before treatment with Yesafili. </p>
<p>Yesafili is not recommended during breast-feeding as it is not known whether aflibercept passes into 
human milk. Ask your doctor for advice before starting Yesafili treatment. </p>
<p>Driving and using machines 
After your injection with Yesafili, you may experience some temporary visual disturbances. Do not 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>A doctor experienced in giving eye injections will inject Yesafili into your eye under aseptic (clean and 
sterile) conditions. </p>
<p>The recommended dose is 2 mg aflibercept (0.05 mL). 
Yesafili is given as an injection into your eye (intravitreal injection). </p>
...
<p>wet AMD </p>
<p>Patients with wet AMD will be treated with one injection per month for three consecutive doses, 
...
<p>Your doctor will determine the most appropriate treatment schedule for you. You will start your 
treatment with a series of monthly Yesafili injections. </p>
<p>The interval between two injections should not be shorter than one month. </p>
<p>Your doctor may decide to stop treatment with Yesafili, if you are not benefiting from continued 
treatment. </p>
...
<p>If a dose of Yesafili is missed 
...
<p>With administration of aflibercept, there may be some side effects affecting the eyes which are due to 
the injection procedure. Some of these may be serious and include blindness, a serious infection or 
...
<p>The systemic use of VEGF inhibitors, substances similar to those contained in Yesafili, is potentially 
related to the risk of blood clots blocking blood vessels (arterial thromboembolic events) which may 
lead to heart attack or stroke. There is a theoretical risk of such events following injection of 
aflibercept into the eye. </p>
