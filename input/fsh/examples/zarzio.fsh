...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Zarzio is a white blood cell growth factor (granulocyte colony stimulating factor) and belongs to a 
group of proteins called cytokines. Growth factors are proteins that are produced naturally in the body 
but they can also be made using biotechnology for use as a medicine. Zarzio works by encouraging the 
...
your body less able to fight infection. Zarzio stimulates the bone marrow to produce new white cells 
quickly.
Zarzio can be used:</p>
<p>to increase the number of white blood cells after treatment with chemotherapy to help prevent 
infections;</p>
<p>to increase the number of white blood cells after a bone marrow transplant to help prevent 
infections;</p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <h2>Do not use Zarzio</h2>
<p>if you are allergic to filgrastim or any of the other ingredients of this medicine (listed in 
section 6).
...
-
have symptoms of inflammation of the aorta (the large blood vessel which transports blood 
from the heart to the body); this was reported in rare cases in cancer patients and healthy donors. 
...
develop cancers of the blood, you should not use Zarzio unless instructed by your doctor.
...
Zarzio is one of a group of products that stimulate the production of white blood cells. Your healthcare 
...
It is important to tell your doctor if you:</p>
...
Zarzio may have a minor influence on your ability to drive and use machines. This medicine may 
cause dizziness. It is advisable to wait and see how you feel after taking Zarzio and before driving or 
operating machinery.
...
down fructose, which may cause serious side effects.
...
Zarzio is usually given as a daily injection into the tissue just under the skin (known as a subcutaneous 
injection). It can also be given as a daily slow injection into the vein (known as an intravenous 
infusion). The usual dose varies depending on your illness and weight. Your doctor will tell you how 
much Zarzio you should take.
Patients having a bone marrow transplant after chemotherapy:
You will normally receive your first dose of Zarzio at least 24 hours after your chemotherapy and at 
...
You will need to take Zarzio until your white blood cell count is normal. Regular blood tests will be 
taken to monitor the number of white blood cells in your body. Your doctor will tell you how long you 
will need to take Zarzio.
Use in children
Zarzio is used to treat children who are receiving chemotherapy or who suffer from severe low white 
...
Do not increase the dose your doctor has given you. If you think you have injected more than you 
...
Please tell your doctor immediately during treatment:</p>
<p>if you experience an allergic reaction including weakness, drop in blood pressure, difficulty 
breathing, swelling of the face (anaphylaxis), skin rash, itchy rash (urticaria), swelling of the 
face, lips, mouth, tongue or throat (angioedema) and shortness of breath (dyspnoea). </p>
<p>if you experience a cough, fever and difficulty breathing (dyspnoea) as this can be a sign of 
Acute Respiratory Distress Syndrome (ARDS). </p>
<p>if you get left upper belly (abdominal) pain, pain below the left rib cage or pain at the tip of 
your shoulder, as there may be a problem with your spleen [enlargement of the spleen 
(splenomegaly) or rupture of the spleen].</p>
<p>if you are being treated for severe chronic neutropenia and you have blood in your urine 
...
to leak from the small blood vessels into your body and needs urgent medical attention.</p>
<h2>if you have a combination of any of the following symptoms:</h2>
<p>fever, or shivering, or feeling very cold, high heart rate, confusion or disorientation, 
...
<p>if you experience kidney injury (glomerulonephritis). Kidney injury has been seen in patients 
...
A common side effect of filgrastim use is pain in your muscles or bones (musculoskeletal pain), which 
...
lungs, vagina and joints. Very commonly seen in normal stem cell donors is increase in white blood 
cells (leukocytosis) and decrease of platelets which reduces the ability of blood to clot 
(thrombocytopenia), these will be monitored by your doctor.
Very common side effects (may affect more than 1 in 10 people)</p>
<p>decrease of platelets which reduces the ability of blood to clot (thrombocytopenia)</p>
...
<p>soreness and swelling of the digestive tract lining which runs from the mouth to the anus 
(mucosal inflammation)</p>
<p>fever (pyrexia)
...
<p>dizziness</p>
<p>decreased feeling of sensitivity, especially in the skin (hypoaesthesia)</p>
...
<p>high uric acid levels in the blood, which may cause gout (hyperuricaemia) (Blood uric acid 
increased)</p>
<p>liver damage caused by blocking of the small veins within the liver (veno-occlusive disease)</p>
<p>lungs do not function as they should, causing breathlessness (respiratory failure)</p>
...
<p>disease which causes bones to become less dense, making them weaker, more brittle and likely 
to break (osteoporosis)</p>
<p>injection site reaction
Rare side effects (may affect up to 1 in 1,000 people):</p>
<p>severe pain in the bones, chest, gut or joints (sickle cell anaemia with crisis)</p>
...
<p>a change in how your body regulates fluids within your body and may result in puffiness (fluid 
volume disturbances)</p>
<p>inflammation of the blood vessels in the skin (cutaneous vasculitis)</p>
<p>plum-coloured, raised, painful sores on the limbs and sometimes the face and neck with a fever 
(Sweets syndrome)</p>
...
body), see section 2. Reporting of side effects
...
maximum 8 days (but not above 25  C). At the end of this period, the product should not be put back 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <h2>What Zarzio contains</h2>
<p>The active substance is filgrastim.
...
-
The other ingredients are glutamic acid, sorbitol (E420), polysorbate 80, sodium hydroxide and 
water for injections. See section 2  Zarzio contains sorbitol and sodium .
...
Zarzio is available in packs containing 1, 3, 5 or 10 pre-filled syringes with injection needle and a 
needle safety guard.
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Zarzio er en vækstfaktor for hvide blodlegemer (granulocytkoloni-stimulerende faktor) og tilhører en 
...
ved at anspore knoglemarven, så den producerer flere hvide blodlegemer. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Brug ikke Zarzio 
- hvis du er allergisk over for filgrastim eller et af de øvrige indholdsstoffer i Zarzio (angivet i 
punkt 6). </p>
<p>Advarsler og forsigtighedsregler 
Kontakt lægen, apotekspersonalet eller sygeplejersken, før du bruger Zarzio. </p>
...
<p>Du skal straks fortælle det til din læge, hvis du i løbet af behandlingen med Zarzio:</p>
<ul>
...
du vil udvikle leukæmi, bør du ikke anvende Zarzio, medmindre din læge har anvist det. </p>
...
<p>Brug af andre lægemidler sammen med Zarzio 
...
Zarzio bør ikke anvendes under graviditeten. </p>
...
<p>Hvis du bliver gravid, mens du er i behandling med Zarzio, skal du fortælle det til din læge. </p>
...
du fører motorkøretøj eller betjener maskiner. </p>
...
<p>Zarzio gives normalt som en daglig indsprøjtning i vævet lige under huden (det kaldes en subkutan 
...
fortælle dig, hvor meget Zarzio du skal tage. </p>
...
har gennemgået din knoglemarvstransplantation. </p>
...
<p>Du skal tage Zarzio indtil antallet af dine hvide blodlegemer er normalt. Der vil tages regelmæssige 
blodprøver for at overvåge antallet af hvide blodlegemer i din krop. Din læge vil fortælle dig, hvor 
længe du skal tage Zarzio. </p>
<p>Brug til børn </p>
<p>Zarzio anvendes til at behandle børn, som får kemoterapi, eller som har et meget lavt antal hvide 
...
<p>Du må ikke øge den dosis, lægen har ordineret. Hvis du mener, du har indsprøjtet for meget Zarzio, 
skal du kontakte din læge så snart som muligt. </p>
...
Utilsigtet frysning vil ikke ødelægge Zarzio. </p>
...
fyldt injektionssprøjte indeholder 48 mill. E filgrastim i 0,5 ml svarende til 96 mill. E/ml. </li>
<li>Øvrige indholdsstoffer: glutaminsyre, sorbitol (E420), polysorbat 80, natriumhydroxid og vand 
til injektionsvæske. Se punkt  2 "Zarzio indeholder sorbitol og natrium" </li>
</ul>
<p>Udseende og pakningsstørrelser </p>
<p>Zarzio er en klar, farveløs til let gullig opløsning til injektion eller infusion i fyldt injektionssprøjte. </p>
<p>Zarzio fås i pakninger med 1, 3, 5 eller 10 fyldte injektionssprøjter med kanyle og kanylebeskyttelse. </p>
...
<p>Dette afsnit indeholder information om, hvordan du kan give dig selv en indsprøjtning med Zarzio. 
Det er vigtigt, at du ikke prøver at give dig selv indsprøjtningen, medmindre du er blevet 
instrueret af lægen eller sygeplejersken. Zarzio leveres med kanylebeskyttelse, og lægen eller </p>
<p>sygeplejersken viser dig, hvordan du anvender den. Hvis du føler dig usikker, eller hvis du har 
spørgsmål, skal du bede lægen eller sygeplejersken om hjælp. </p>
...
med Zarzio som din læge har vist dig. Er du i tvivl, så spørg lægen eller 
...
frysepunktet. </p>
<p>Zarzio indeholder ingen konserveringsmidler. For at undgå risiko for mikrobiel kontaminering er 
Zarzio injektionssprøjterne kun til engangsbrug. </p>
<p>Fortynding før administration (valgfri) </p>
<p>Om nødvendigt kan Zarzio fortyndes i 50 mg/ml (5 %) glucoseopløsning. Zarzio må ikke fortyndes 
med natriumchloridopløsninger. </p>
<p>Zarzio bør aldrig fortyndes til en slutkoncentration &lt; 0,2 mill. E/ml (2 mikrogram/ml). </p>
...
24 timer ved 2 °C til 8 °C. Fra et mikrobielt synspunkt bør produktet anvendes omgående. Hvis det </p>
<p>ikke anvendes omgående, er opbevaringstid og -betingelser før brug brugerens ansvar og bør normalt 
