...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Instructions for use of Zimbus Breezhaler inhaler </p>  </div>"""   
...
<p>What Zimbus Breezhaler is used for 
Zimbus Breezhaler is used regularly as treatment for asthma in adults. </p>
...
<p>You should use Zimbus Breezhaler every day and not only when you have breathing problems or other 
symptoms of asthma. This will ensure that it controls your asthma properly. Do not use this medicine 
to relieve a sudden attack of breathlessness or wheezing. </p>
<p>If you have any questions about how Zimbus Breezhaler works or why this medicine has been 
...
<p>How much Zimbus Breezhaler to inhale 
...
<p>You should use Zimbus Breezhaler every day, even when your asthma is not troubling you. </p>
<p>When to inhale Zimbus Breezhaler 
Inhale Zimbus Breezhaler at the same time each day. This will help control your symptoms throughout 
the day and night. It will also help you to remember to use it. </p>
<p>How to inhale Zimbus Breezhaler 
...
<p>If your pack contains a sensor for Zimbus Breezhaler 
...
inhaler in the next Zimbus Breezhaler pack. </p>
<p>If your symptoms do not improve 
If your asthma is not getting better or if it gets worse after you have started using Zimbus Breezhaler, 
talk to your doctor. </p>
<p>If you use more Zimbus Breezhaler than you should 
...
<p>If you forget to use Zimbus Breezhaler 
...
<p>If you stop using Zimbus Breezhaler 
Do not stop using Zimbus Breezhaler unless your doctor tells you to. Your asthma symptoms may 
...
Stop using Zimbus Breezhaler and get medical help immediately if you have any of the following: </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Zimbus Breezhaler contains 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Brugsanvisning til Zimbus Breezhaler-inhalator </p>  </div>"""   
...
Zimbus Breezhaler indeholder tre aktive stoffer:</p>
<ul>
<li>indacaterol </li>
<li>glycopyrronium </li>
...
<p>Anvendelse 
Zimbus Breezhaler anvendes regelmæssigt som behandling ved astma hos voksne. </p>
...
<p>Du bør tage Zimbus Breezhaler hver dag og ikke kun, når du har problemer med at trække vejret eller 
...
<p>Tal med lægen, hvis du har spørgsmål til, hvordan Zimbus Breezhaler virker, eller hvorfor denne 
...
<p>Tag ikke Zimbus Breezhaler 
- hvis du er allergisk over for indacaterol, glycopyrronium, mometasonfuroat eller et af de øvrige 
indholdsstoffer i Zimbus Breezhaler (angivet i punkt 6). Rådfør dig med lægen, hvis du tror, at 
du kan være allergisk. </p>
<p>Advarsler og forsigtighedsregler 
Kontakt lægen, apotekspersonalet eller sygeplejersken, før du tager Zimbus Breezhaler, hvis noget af 
...
<p>Under behandling med Zimbus Breezhaler 
...
brugt Zimbus Breezhaler (tegn på at lægemiddlet mod forventning trækker luftvejene sammen, 
...
<p>Brug af anden medicin sammen med Zimbus Breezhaler 
...
<li>lægemidler, der kan ligne Zimbus Breezhaler (indeholder lignende aktive stoffer); tages de 
sammen med Zimbus Breezhaler, kan der være større risiko for bivirkninger. </li>
...
<p>Så meget Zimbus Breezhaler skal du inhalere 
...
<p>Du bør tage Zimbus Breezhaler hver dag, også selvom din astma ikke generer dig. </p>
<p>Tidspunkt for inhalering af Zimbus Breezhaler 
Inhaler Zimbus Breezhaler på samme tidspunkt hver dag. Dette vil hjælpe med at styre dine 
symptomer igennem dagen og natten. Det vil også hjælpe dig med at huske at tage medicinen. </p>
<p>Sådan skal du inhalere Zimbus Breezhaler 
...
<p>Hvis din pakning indeholder en sensor til Zimbus Breezhaler 
...
- Den elektroniske sensor til Zimbus Breezhaler, skal fastgøres på underdelen af 
Zimbus Breezhaler inhalatoren. 
- Sensoren bekræfter at du har brugt Zimbus Breezhaler inhalatoren ved at registrere og 
...
oplysninger om, hvordan sensoren til Zimbus Breezhaler og appen skal bruges. 
- Når alle Zimbus Breezhaler-kapsler i en pakning er brugt, skal sensoren flyttes til den nye 
inhalator i den næste Zimbus Breezhaler-pakning. </p>
...
Zimbus Breezhaler, skal du tale med lægen. </p>
<p>Hvis du har taget for meget Zimbus Breezhaler 
...
<p>Hvis du har glemt at tage Zimbus Breezhaler 
...
<p>Hvis du holder op med at tage Zimbus Breezhaler 
Du må ikke holde op med at tage Zimbus Breezhaler, medmindre lægen siger, at du skal stoppe. Dine 
...
Stop med at tage Zimbus Breezhaler, og søg lægehjælp øjeblikkeligt, hvis du har en af følgende 
tilstande: </p>
...
<li>Hvis din pakning indeholder en elektronisk sensor til Zimbus Breezhaler, kan du finde nærmere 
...
<li>Øvrige indholdsstoffer: lactosemonohydrat og magnesiumstearat (se “Zimbus Breezhaler 
...
omgivet af en sort streg på hætten. </p>
...
<p>Læs hele brugsanvisningen til Zimbus Breezhaler inhalatoren før brug.  </p>
<p>Læg en kapsel i 
Perforer og slip 
Inhaler dybt 
...
<p>Trin 1e: 
Luk inhalatoren </p>
<p>Din Zimbus Breezhaler-inhalator-pakning 
indeholder: </p>
<ul>
<li>
<p>En Zimbus Breezhaler inhalator </p>
</li>
<li>
<p>Et eller flere blisterkort, som hver indeholder 
10 Zimbus Breezhaler-kapsler til brug i 
inhalatoren. </p>
</li>
</ul>
