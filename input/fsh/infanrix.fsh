...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What you need to know before your child receives Infanrix hexa  </p>
<p>Infanrix hexa should not be given </p>
<p>• if your child is allergic to: 
- Infanrix hexa or any of the ingredients of this vaccine (listed in section 6).<br />
- formaldehyde. 
...
A minor infection such as a cold should not be a problem, but talk to your doctor first. </p>
...
monitoring for 48-72h following the administration of the first two or three doses of Infanrix hexa. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>How Infanrix hexa is given  </p>
<p>How much is given 
...
<p>Like all medicines, this vaccine can cause side effects, although not everybody gets them. The following 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>How to store Infanrix hexa  </p>
<ul>
...
<p>What Infanrix hexa contains </p>
...
<p>1adsorbed on aluminium hydroxide, hydrated (Al(OH)3) </p>         </div>"""      
