...
<li>What IVEMEND is and what it is used for
...
chemotherapy (cancer treatment) that is a strong or moderate trigger of nausea and vomiting.</li>
</ol>         </div>"""   
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not use IVEMEND
 
if you are allergic to fosaprepitant, aprepitant, or to polysorbate 80 or any of the other
...
used during treatment with IVEMEND and for up to 2 months after using IVEMEND,
...
effects, which may be serious, and for which you may need urgent medical treatment:
...
allergic reaction. 
- Infusion site reactions (ISR) at or near the infusion site. Most severe ISR have happened with a
...
- severe constipation, stomach ulcer, inflammation of the small intestine and colon, sores in
mouth, bloating,
...
Instructions of how to reconstitute and dilute IVEMEND 150 mg</p>         </div>"""      
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>sodium chloride 9 mg/ml (0.9 %) solution for injection is added to the vial along the vial wall
in order to prevent foaming. Swirl the vial gently. Avoid shaking and jetting sodium chloride
9 mg/ml (0.9 %) solution for injection into the vial.</p>         </div>"""      
