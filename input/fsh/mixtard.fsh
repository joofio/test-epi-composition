...
► 
Mixtard Penfill is only suitable for injecting under the skin using a reusable pen. Speak to your 
...
► 
There are no restrictions on treatment with Mixtard during breast-feeding. </p>
...
► 
Mixtard Penfill cartridges are designed to be used with Novo Nordisk insulin delivery systems 
and NovoFine or NovoTwist needles. 
► 
If you are treated with Mixtard Penfill and another insulin Penfill cartridge, you should use two 
...
instructions. </p>
<p>► 
Every time you use a new Mixtard Penfill (before you put the cartridge into the insulin 
delivery system). 
...
► 
After each injection, be sure to remove and discard the needle and store Mixtard without the 
...
* Drink alcohol, see Mixtard with alcohol in section 2.<br />
