...
Neuraceq is not intended for use in children and adolescents below the age of 18 years old. </p>
<p>Other medicines and Neuraceq 
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>How Neuraceq will be used </p>
<p>There are strict laws on the use, handling and disposal of radiopharmaceutical products.<br />
