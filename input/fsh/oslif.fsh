...
<p>During treatment with Oslif Breezhaler, 
 
Stop using the medicine and tell your doctor immediately if you get tightness of the chest, 
...
 
Tell your doctor immediately if your COPD symptoms (breathlessness, wheezing, cough) do 
...
 
medicines for breathing problems that are similar to Oslif Breezhaler (i.e. medicines such as 
salmeterol and formoterol). You may be more likely to get side effects. 
 
...
you are not sure. </p>
<p>How much Oslif Breezhaler to use 
 
...
<p>How to use Oslif Breezhaler 
 
In this pack, you will find an inhaler and capsules (in blister) that contain the medicine as 
...
capsules should remain in the blister until you need to use them. 
 
...
<p>How long to continue your treatment with Oslif Breezhaler 
 
Keep using your treatment with Oslif Breezhaler for as long as your doctor tells you. 
 
COPD is a long-term disease and you should use Oslif Breezhaler every day and not only when 
...
<p>Some side effects may be serious. Tell your doctor immediately 
 
...
hungry (without gaining weight) and will pass more urine than usual (common). 
 
if you get irregular heart beat (uncommon). 
 
if you get symptoms of an allergic reaction such as rash, itching, hives, difficulty breathing or 
swallowing, dizziness (uncommon). 
 
if you have difficulty breathing with wheezing or coughing (uncommon). </p>
...
chest pain 
 
pain in muscles, bones or joints </p>
...
<p> 
Oslif Breezhaler 150 microgram capsules have a black product code “IDL 150” printed above a 
black bar and a black company logo (
) printed below the black bar. 
 
Oslif Breezhaler 300 microgram capsules have a blue product code “IDL 300” printed above a 
...
<p>Step 1e: 
Close inhaler </p>
<p>Your Oslif Breezhaler Inhaler pack contains: 
 
