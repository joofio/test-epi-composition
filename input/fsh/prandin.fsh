...
* If you take other medicines or suffer from liver or kidney problems (see other sections of 2. What you need to know before you take Prandin). </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>What Prandin contains </p>
<p>– 
...
<p>What Prandin looks like and contents of the pack </p>
<p>Prandin tablets are round and convex and engraved with the Novo Nordisk logo (Apis bull). The 
