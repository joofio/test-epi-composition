...
► 
Protaphane Penfill is only suitable for injecting under the skin using a reusable pen. Speak to 
...
► 
There are no restrictions on treatment with Protaphane during breast-feeding. </p>
...
► 
Protaphane Penfill cartridges are designed to be used with Novo Nordisk insulin delivery 
systems and NovoFine or NovoTwist needles. 
► 
If you are treated with Protaphane Penfill and another insulin Penfill cartridge, you should use 
...
instructions. </p>
<p>► 
Every time you use a new Protaphane Penfill (before you put the cartridge into the insulin 
delivery system). 
...
► 
After each injection, be sure to remove and discard the needle and store Protaphane without the 
...
* Drink alcohol, see Protaphane with alcohol in section 2.<br />
