...
- if you are elderly.<br />
- if you have low weight (60 kg or less). 
- if you have heart failure. </p>
<p>Your doctor may decide to give you a lower dose or take other precautions if any of these apply to 
you. </p>
...
depression (nefazodone), or heart rhythm disorders (e.g. quinidine, dofetilide, or sotalol). </p>
<p>Tell your doctor or pharmacist before you take Ranexa if you use: 
...
Ranexa (see section 4). Your doctor may decide to give you a lower dose.<br />
...
(cyclophosphamide).<br />
- certain medicines to treat high levels of cholesterol in the blood (e.g. simvastatin, lovastatin, 
...
- certain medicines used to prevent transplanted organ rejection (e.g. tacrolimus, ciclosporin, 
