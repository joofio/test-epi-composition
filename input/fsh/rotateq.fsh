...
<li>What RotaTeq is and what it is used for
...
gastroenteritis caused by these types of rotavirus.</li>
</ol>         </div>"""   
...
equivalent to 1.88% of the recommended maximum daily dietary intake of sodium for an adult.
25</p>         </div>"""   
...
symptoms:
 
Allergic reactions (frequency cannot be estimated from the available data), which may be severe
(anaphylaxis), and may include: allergic swelling that may affect the face, lips, tongue or throat.
 
Bronchospasm (rare, may affect up to 1 in 1000 infants). This may present as wheezing,
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>G2 </p>         </div>"""      
