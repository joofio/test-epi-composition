...
<li>What Stimufend is and what it is used for 
Stimufend contains the active substance pegfilgrastim. Pegfilgrastim is a protein produced by 
...
blood cells) to produce more white blood cells that help your body fight infection. </li>
</ol>         </div>"""   
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not use Stimufend 

...
skin that itch. 

if you have an allergy to latex. The needle cap on the pre-filled syringe contains a derivative of<br />
latex and may cause severe allergic reactions. 

...

if you are a patient with breast cancer or lung cancer, Stimufend in combination with 
...
Uncommon side effects (may affect up to 1 in 100 people):<br />

...

blood disorders (myelodysplastic syndrome [MDS] or acute myeloid leukaemia [AML]).<br />
...
<p>The active substance is pegfilgrastim. Each pre-filled syringe contains 6 mg of pegfilgrastim in </p>         </div>"""      
