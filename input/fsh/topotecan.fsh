...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>You should not receive Topotecan Hospira: 
 
...
 
if you have any kidney or liver problems. Your dose of Topotecan Hospira may need to be 
adjusted. 
 
if you are pregnant or plan to become pregnant. See section “Pregnancy and breast-feeding” 
below. 
 
if you plan to father a child. See section “Pregnancy and breast-feeding” below.  </p>
<p>Tell your doctor if any of these applies to you. </p>
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>The dose of topotecan you are given will be worked out by your doctor, based on: 
 
your body size (surface area measured in square metres) 
 
the results of blood tests carried out before treatment<br />
 
...
<p>This rare side effect may affect up to 1 in 1,000 people treated with Topotecan Hospira: 
 
...
cannot be estimated from the available data):<br />
 
...
Tel: +44 (0)1304 616Slovenská republika 
...
Τηλ.: +357 22817United Kingdom (Northern Ireland) 
Pfizer Limited 
Tel: +44 (0) 1304 616 
Latvija 
...
<p>Storage, Use, Handling &amp; Disposal of Topotecan Hospira </p>
<p>Storage 
...
<p>Use 
Refer to the SmPC for full details. </p>
<p>Topotecan Hospira 4 mg/4 ml concentrate for solution for infusion requires dilution to a final 
...
infusion.  </p>
<p>Parenteral products should be visually inspected for particulate matter and discolouration prior to 
administration. Topotecan Hospira is a yellow/yellow green solution.  </p>
<p>Prior to administration of the first course of topotecan, patients must have a baseline neutrophil count 
of ≥1.5 x 109/l, a platelet count of ≥100 x 109/l and a haemoglobin level of ≥9 g/dl (after transfusion if 
necessary).  Neutropenia and thrombocytopenia should be managed. For further details, refer to the 
SPC. </p>
<p>Dosage: Ovarian and Small Cell Lung Carcinoma<br />
Initial dose: 1.5 mg/m2 body surface area/day, administered by intravenous infusion over 30 minutes 
for 5 consecutive days, with a 3 week interval between the start of each course.  </p>
<p>Subsequent doses: Topotecan should not be re-administered unless the neutrophil count is ≥1 x 109/l, 
the platelet count is ≥100 x 109/l, and the haemoglobin level is ≥9 g/dl (after transfusion if necessary).  </p>
<p>Dosage: Cervical Carcinoma 
Initial dose: 0.75 mg/m2/day administered as 30 minute intravenous infusion daily, on days 1, 2 and 3. Cisplatin is administered as an intravenous infusion on day 1 at a dose of 50 mg/m2/day and following 
the topotecan dose. This treatment schedule is repeated every 21 days for 6 courses or until 
progressive disease. </p>
<p>Subsequent doses: Topotecan should not be re-administered unless the neutrophil count is ≥1.5 x 109/l, 
the platelet count is ≥100 x 109/l, and the haemoglobin level is ≥9 g/dl (after transfusion if necessary).  </p>
<p>Dosage: Renally impaired patients 
Limited data indicate that the dose should be reduced in patients with moderate renal impairment. 
Please refer to the SPC for further details. </p>
<p>Dosage: Paediatric population 
Limited data available.  Use not recommended. </p>
<p>Chemical and physical in-use stability has been demonstrated for 24 hours at 25°C under normal light 
conditions and at 2°C-8°C when protected from light. From a microbiological point of view, the 
product should be used immediately. If not used immediately, in-use storage times and conditions 
prior to use are the responsibility of the user and would normally not be longer than 24 hours at 
2°C to 8°C, unless reconstitution/dilution has taken place in controlled and validated aseptic 
conditions. </p>
<p>Handling and disposal<br />
...
including gloves, should be placed in high-risk, waste disposal bags for high-temperature 
incineration. Liquid waste may be flushed with large amounts of water. 
 
