...
(accumulation of fluid in the lungs). </p>
...
<p>Tractocile will be given into a vein (intravenously) in three stages: 
...
- Each vial of Tractocile 6.75 mg/0.9 ml solution for injection contains atosiban acetate equivalent to </p>         </div>"""      
