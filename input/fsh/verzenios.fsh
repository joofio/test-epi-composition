...
therapies, such as aromatase inhibitors or fulvestrant. </p>         </div>"""   
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Do not take Verzenios:<br />
...
loperamide. Drink plenty of fluids. </p>
...
o Digoxin (used to treat heart disorders)<br />
...
o St. John’s wort (a herbal product used to treat mild depression and anxiety) </p>
...
- Diarrhoea (which may affect more than 1 in 10 people).  </p>
